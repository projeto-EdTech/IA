...
Não crie ou modifique nenhum nome de campo. Respeite os tipos de dados e a estrutura de array/objeto conforme o JSON Schema da ferramenta.
 `];
  ...
  console.log("Iniciando upload e processamento dos arquivos...");
    ...
    let file1 = await uploadRemotePDF("https://www.curso-objetivo.br/vestibular/resolucao-comentada/alberteinstein/2016/alberteinstein2016_prova.pdf", "PDF Da Prova");
    ...
    let file2 = await uploadRemotePDF("https://www.curso-objetivo.br/vestibular/resolucao-comentada/alberteinstein/2016/alberteinstein2016_gabarito.pdf", "PDF Do Gabarito");
