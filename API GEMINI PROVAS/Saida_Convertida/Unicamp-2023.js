...
createQuestion({
    ...
    options: ["catálise ($1_{8}_{}$), economia atômica ($1_{2}_{}$), matérias-primas reno-váveis ($1_{7}_{}$), prevenção de resíduos ($1_{1}_{}$).","matérias-primas renováveis ($1_{7}_{}$), catálise ($1_{8}_{}$), economia atômica ($1_{2}_{}$), prevenção de resíduos ($1_{1}_{}$).","catálise ($1_{8}_{}$), matérias-primas renováveis ($1_{7}_{}$), economia atômica ($1_{2}_{}$), prevenção de resíduos ($1_{1}_{}$).","matérias-primas renováveis ($1_{7}_{}$), prevenção de resíduos ($1_{1}_{}$), catálise ($1_{8}_{}$), economia atômica ($1_{2}_{}$)."],
    correctAnswer: 0,
    materia: "Química – Química ambiental (Química Verde)",
    conteudo: "Língua Portuguesa – Interpretação de texto",
    imageNames: []
