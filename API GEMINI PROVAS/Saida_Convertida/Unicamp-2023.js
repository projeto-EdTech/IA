...
createQuestion({
    ...
    options: ["a modalidade declamada dos poemas de Stella do Patrocí-nio.","uma prática discursiva oral nomeada por Stella do Patrocí-nio.","a denominação, usada no manicômio, para conversas tera-pêuticas.","um gênero de poesia transcrita produzida por Stella do Pa-trocínio."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Interpretação de texto",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2023,
    text: {
      principal: "Paulo Bruno\n@_paulo_bruno\nAchei o momento bonito e fiquei imaginando como teria ficado essa selfie, então desenhei uma interpretação minha\n\n(Fonte: Twitter. https://twitter.$\\\\frac{com}{_paulo_bruno}$/$\\\\frac{status}{1513855458456616969}$. Aces-so em $\\\\frac{03}{06}$/2022.)\nO texto apresenta a reprodução de uma postagem em Twitter do ilustrador e quadrinista Paulo Bruno. Considerando o texto e as duas imagens do tuíte, assinale a alternativa que melhor descreve o sentido de \"interpretação\" nesse contexto particular de uso.",
      subItens: []
    },
    options: ["A imaginação, em desenho, do ponto de vista da selfie que é tematizada na foto.","A adulteração, no desenho, do significado da foto pela mu-dança de perspectiva.","A cópia, em ilustração, de uma fotografia que mostra a pro-dução de uma selfie.","A recriação, em fotografia, da ilustração que simula uma selfie em grupo."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Interpretação de texto",
    conteudo: "Arte – Leitura de imagem",
    imageNames: []
...
createQuestion({
    ...
    text: {
      principal: "",
      subItens: [{"titulo":"Texto 1","conteudo":"\"Desde que, naufragado, se salvara, o marinheiro vivia ali... Como ele não tinha meio de voltar à pátria, e cada vez que se lembrava dela sofria, pôs-se a sonhar uma pátria que nun-ca tivesse tido: pôs-se a fazer ter sido sua uma outra pátria, uma outra espécie de país com outras espécies de paisagens, e outra gente, e outro feitio de passarem pelas ruas e de se debruçarem das janelas (...)\"\n(PESSOA, Fernando. O Marinheiro. Campinas: Editora da UNICAMP, p. 59, 2020.)"},{"titulo":"Texto 2","conteudo":"\"Na capacidade para amoldar-se a todos os meios, em pre-juízo, muitas vezes de suas próprias características raciais e culturais, revelou o português melhores aptidões de coloni-zador do que os demais povos (...). Os portugueses precisa-ram anular-se durante o longo tempo para afinal vencerem. Como o grão de trigo dos Evangelhos, o qual há de primei-ramente morrer para depois crescer e dar muitos frutos.\"\n(HOLANDA, Sérgio Buarque de. Raízes do Brasil. São Paulo: Companhia das Letras, p. 224, 2016.)\n\nLevando em conta os textos 1 e 2, assinale a alternativa correta."}]
    },
    options: ["O marinheiro e o colonizador português são capazes de criar valores e paisagens, reinventando-se, a ponto de forjarem outra realidade e outra memória do passado.","O marinheiro e o colonizador português constroem novos mundos e valores no além-mar, mas são incapazes de anular sua identidade original.","O marinheiro e o colonizador português, apesar do esforço de construção cultural, limitam-se a transpor integralmen-te o que aprenderam no passado para as configurações do futuro.","O marinheiro e o colonizador português acabam anulando suas identidades originais, representando, assim, figuras in-questionáveis de niilismo."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Literatura Portuguesa (Fernando Pessoa)",
    conteudo: "História – Formação do Brasil (Sérgio Buarque de Holanda)",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["a reiteração de um mesmo tipo de frase no final de cada estrofe acentua o idealismo e a rememoração.","a metáfora da árvore faz uso de um vocabulário botânico, que evoca o cientificismo da época.","as frases nominais do início das estrofes contradizem os sen-tidos de cada estrofe anterior.","o paralelismo estrutural entre as estrofes de \"Ciclo\" evoca o desgaste dos recursos do poeta."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["à influência do cristianismo na dinâmica das comunidades periféricas.","ao colapso planetário entrevisto já na origem do mundo na-tural.","à origem divina do mundo contraposta aos problemas cria-dos pelo homem.","à origem religiosa dos conflitos armados e da violência social no Brasil."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Literatura Brasileira (Racionais MC's)",
...
createQuestion({
    ...
    year: 2023,
    text: {
      principal: "Um artigo científico relata a construção e a eficiência de um re-ator fotocatalítico de fluxo contínuo para a degradação de hor-mônios presentes em águas tratadas para consumo humano. Num trecho desse estudo, os autores afirmam: \"é interessante notar que 80% de estrogênio foram removidos numa alimen-tação a 200 $\\\\frac{ng}{L}$, 25 $\\\\frac{mW}{cm}$² e 300 L/(m² h), enquanto que as remoções de progesterona e testosterona ficaram em 44% e 33%, respectivamente\".\n\nDe acordo com essas informações, pode-se inferir que o reator é capaz de degradar",
      subItens: []
    },
    options: ["dois hormônios femininos e um masculino, sendo que de-grada melhor um feminino.","dois hormônios femininos e um masculino, sendo que de-grada melhor o masculino.","somente hormônios masculinos, sendo que degrada melhor o estrogênio.","somente hormônios femininos, sendo que degrada melhor o estrogênio."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["catálise (G8), economia atômica (G2), matérias-primas reno-váveis (G7), prevenção de resíduos (G1).","matérias-primas renováveis (G7), catálise (G8), economia atômica (G2), prevenção de resíduos (G1).","catálise (G8), matérias-primas renováveis (G7), economia atômica (G2), prevenção de resíduos (G1).","matérias-primas renováveis (G7), prevenção de resíduos (G1), catálise (G8), economia atômica (G2)."],
    correctAnswer: 0,
    materia: "Química – Química ambiental (Química Verde)",
    conteudo: "Língua Portuguesa – Interpretação de texto",
    imageNames: []
...
createQuestion({
    ...
    options: ["dióxido de carbono em etanol, sendo que A, B, C e D repre-sentam, respectivamente: biocatálise, catálise homogênea, catálise heterogênea e fotocatálise.","dióxido de carbono em etanol, sendo que A, B, C e D repre-sentam, respectivamente: biocatálise, catálise homogênea, fotocatálise e catálise heterogênea.","metano em metanol, sendo que A, B, C e D representam, respectivamente: biocatálise, catálise homogênea, catálise heterogênea e fotocatálise.","metano em metanol, sendo que A, B, C e D representam, respectivamente: biocatálise, catálise homogênea, fotocatá-lise e catálise heterogênea."],
    correctAnswer: 2,
    materia: "Química – Química orgânica (Combustíveis)",
    conteudo: "Química – Cinética química (Catálise)",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2023,
    text: {
      principal: "No ano de 2020, iniciou-se um conflito interno na Etiópia, com complexas implicações humanitárias, econômicas e geopolíti-cas, adicionando novas tensões à frágil estabilidade política na região do Chifre da África.\n(Adaptado de YARED, Tegbaru. Institute for Security Studies - ISS. Acesso em $\\\\frac{09}{06}$/2022.)\n\nAs causas do atual conflito na Etiópia resultam",
      subItens: []
    },
    options: ["da instabilidade das instituições estatais gerada pelo proces-so de colonização europeia no século XVIII.","do conflito bélico com a Eritreia em razão da disputa pela saída para o Mar Mediterrâneo.","da tentativa de secessão da região do Tigré em função dos conflitos étnico-religiosos e políticos.","da participação de interesses estrangeiros na gestão dos re-cursos naturais etíopes, a exemplo do petróleo."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2023,
    text: {
      principal: "Subsidência é um tipo de colapso em uma superfície, caracte-rizado por deformação quase vertical do terreno ou pela rea-comodação dos materiais em subsuperfície. Os solos muito ar-gilosos estão entre os materiais mais suscetíveis à subsidência. Na cidade de Maceió (AL), esse fenômeno tem afetado diversos bairros da cidade.\n(Image: Subsidência vs. Zona Estável, showing molecular changes in argila with water and $\\\\frac{expansion}{contraction}$)\n\nA partir do texto e da figura anterior, é correto afirmar que a",
      subItens: []
    },
    options: ["água se infiltra sem grandes dificuldades em solos muito argilosos, por isso o processo de expansão das argilas é per-manente, tornando a área ideal para o desenvolvimento de cultivos permanentes.","subsidência em solos muito argilosos é um processo rever-sível, pois ocorre apenas nos períodos secos quando o solo se contrai na ausência de água. A reversão acontece nos períodos úmidos.","mecanização das lavouras e a construção de edificações podem ocorrer sem restrições em áreas em que ocorrem a contração e expansão das argilas decorrentes da variação da umidade do solo.","subsidência em solos muito argilosos é um processo irrever-sível, pois uma vez que a superfície é rebaixada, o processo reverso de soerguimento não acontece por conta da força gravitacional."],
    correctAnswer: null,
...
createQuestion({
    ...
    options: ["A é uma planície formada por processos exógenos que oca-sionam a acumulação de materiais de fontes diversas. As planícies podem sofrer a influência de falhamentos das ro-chas que servem de substrato ao processo deposicional.","B é um planalto formado por rochas ígneas extrusivas, e apresenta formas de relevo esculpidas pela atuação dos pro-cessos exógenos, a exemplo das chapadas, dos morros, das serras e das depressões.","A é uma planície formada por depósitos arenosos e argilo-sos de origem exclusivamente fluvial. A presença dos me-andros abandonados indica que as formas de relevo desse compartimento não evoluem.","B é um planalto formado por rochas ígneas, metamórficas ou sedimentares. Sua principal característica está na ativida-de ativa dos processos tectônicos responsáveis pelo soergui-mento das elevações e manutenção das formas."],
    correctAnswer: 0,
    materia: "Geografia – Geomorfologia",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["(1) Oeste catarinense; (2) indústria frigorífica.","(1) Vale dos Sinos (RS); (2) indústria de laticínios.","(1) Oeste paranaense; (2) indústria de confecção.","(1) Vale do Itajaí (SC); (2) indústria carbonífera."],
    correctAnswer: 0,
    materia: "Geografia – Geografia humana (Migrações)",
    conteudo: "Geografia – Geografia econômica (Economia regional)",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2023,
    text: {
      principal: "A tabela a seguir destaca, para o ano de 2019, os 11 municípios brasileiros que mais emitiram gases do efeito estufa causadores do aquecimento global, conforme o total emitido de CO₂ em toneladas.\n(Table: Município, Emissão de CO_{2} (em toneladas), Área territorial (em km_{2}), Densidade Demográfica (pop/área) for selected Brazilian municipalities)\n(Fonte: www. seeg.eco.br; IBGE Cidades - Acessado em: $\\\\frac{24}{06}$/2022.)\n\nA partir da análise dos dados anteriores e de seu conhecimento, é correto afirmar que os municípios com",
      subItens: []
    },
    options: ["menor extensão territorial e alta densidade demográfica fo-ram responsáveis pela maior emissão de CO₂ decorrente da decomposição dos resíduos sólidos em aterros sanitários.","grande extensão territorial e baixa densidade demográfica foram responsáveis pela maior emissão de CO₂, o que se correlaciona com o avanço da mineração e a construção de hidrelétricas.","menor extensão territorial e alta densidade demográfica fo-ram responsáveis pela maior emissão de CO₂ decorrente da instalação de novas indústrias de bens de capital.","grande extensão territorial e baixa densidade demográfica foram responsáveis pela maior emissão de CO₂, o que se correlaciona com o avanço do desmatamento e incêndio florestal."],
    correctAnswer: 3,
    materia: "Geografia – Geografia ambiental (Desmatamento)",
    conteudo: "Química – Química ambiental (Gases de efeito estufa)",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2023,
    text: {
      principal: "A Amazônia brasileira ganhou destaque nos últimos anos nos noticiários da mídia nacional e estrangeira, face ao avanço de graves problemas socioambientais. Nesse contexto, as unidades de conservação, como as Reservas Extrativistas (RESEX), intro-duzidas pela Lei 9.985 em $\\\\frac{18}{07}$/2000, cumprem um papel im-portante na preservação ambiental e na proteção social.\n\nSobre as RESEX no bioma amazônico, é correto afirmar que são áreas",
      subItens: []
    },
    options: ["coletivas, demarcadas para populações indígenas, podendo ser usadas economicamente por meio de pequenas ativi-dades de extrativismo vegetal, mineral e animal. Crescem dentro das RESEX a exploração turística e as atividades ga-rimpeiras.","públicas, destinadas ao usufruto das populações tradicionais ribeirinhas para moradia e atividades econômicas de baixo impacto ambiental. Aumentam no entorno das RESEX a ex-ploração de madeira e o desmatamento para a implantação de atividades pecuárias.","coletivas, concedidas para uso misto das populações indíge-nas e quilombolas, que exploram comercialmente as rique-zas existentes com atividades extrativistas e agropecuária. Aumentam no entorno das RESEX núcleos urbanos e ativi-dades de exploração madeireira.","públicas, destinadas às populações tradicionais para resi-dência e extrativismo sustentável; quando autorizado pelo Estado, grandes empresas podem explorar recursos naturais em larga escala. Crescem dentro das RESEX os impactos am-bientais e a expulsão de população."],
    correctAnswer: 1,
    materia: "Geografia – Geografia ambiental (Unidades de conservação)",
...
createQuestion({
    ...
    options: ["do indivíduo como problema existencial.","da família como problema reprodutivo.","da escola como problema disciplinar.","da população como problema político."],
    correctAnswer: 3,
    materia: "Filosofia – Filosofia contemporânea (Michel Foucault)",
...
createQuestion({
    ...
    options: ["2,0 m/s².","4,0 m/s².","0,05 m/s².","0,1 m/s²."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["2,0 x 10⁴ J.","1,6 x 10⁵ J.","2,0 x 10⁵ J.","1,6 x 10⁶ J."],
    correctAnswer: 3,
    materia: "Física – Dinâmica (Trabalho e energia)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2023,
    text: {
      principal: "Leia o texto a seguir para responder às questões 30, 31 e 32.\nO balonismo, um esporte aeronáutico com adeptos em todo o mundo, oferece um belo espetáculo para os observadores no solo. Um maçarico é usado para aquecer o ar no interior do balão, o que faz variar a densidade do ar, permitindo o controle do movimento de subida e descida do balão.\n\nUm balão tem um volume V = 1,6 x 10³ m³ de ar quente no seu interior na temperatura T = 400 K e na pressão atmosférica po = 1,0 atm = 1,0 × 10⁵ Pa. Sabendo-se que o ar quente se comporta como um gás ideal e que a constante universal dos gases é R = 8 $\\\\frac{J}{mol}$.K, quantos mols de ar n há no interior do balão?",
      subItens: []
    },
    options: ["5,0 x 10⁻¹ mol.","4,0 x 10⁰ mol.","5,0 x 10⁴ mol.","4,0 x 10⁵ mol."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2023,
    text: {
      principal: "A pele humana detecta simultaneamente, com uma sensibilida-de que sistemas artificiais não conseguem reproduzir, vibrações, forças estáticas, textura e escorregamento de objetos sobre sua superfície. Sensores tácteis que apresentassem respostas análo-gas à pele humana seriam muito desejáveis. A figura a seguir ilustra um modelo simples, utilizado no estudo da resposta da pele humana. Na referida figura, estão representados o peso P do bloco, a força normal Ñ, a força de atrito, aplicada pela superfície da pele no bloco de massa m e uma força exter-na F aplicada na mola. A constante de mola é k = 10 $\\\\frac{N}{m}$, e a massa do bloco é m = 4 g. Na iminência de movimento, a deformação da mola é Δx = 3 mm em relação ao seu comprimento de equilíbrio. Qual é o coeficiente de atrito estático entre o bloco e a pele?\n(Image: Diagram of a block on a surface labeled 'pele' with forces P, N, fat, F and spring)",
      subItens: []
    },
    options: ["8,8 x 10⁻⁷.","1,1 x 10⁻⁶.","7,5 x 10⁻¹.","1,3 x 10⁰."],
    correctAnswer: 2,
    materia: "Física – Mecânica (Leis de Newton, Forças de atrito)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["1,00 ano.","2,77 anos.","4,62 anos.","21,3 anos."],
    correctAnswer: 2,
    materia: "Física – Astronomia (Leis de Kepler)",
...
createQuestion({
    ...
    options: ["0,800 A.","1,25 A.","10,0 A.","11,25 A."],
    correctAnswer: 1,
    materia: "Física – Eletrodinâmica (Lei de Ohm, Diferença de potencial)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["oxigênio e NADPH.","gás carbônico e ATP.","água e NADPH.","glicose e ATP."],
    correctAnswer: 2,
...
createQuestion({
    ...
    options: ["A transcrição ocorre inicialmente no citoplasma celular; posteriormente, o enovelamento da proteína MRTFA-GFP mostra-se completo no núcleo celular, exceto nas regiões dos nucléolos.","A tradução ocorre inicialmente no núcleo celular, exceto nas regiões dos nucléolos; posteriormente, o enovelamento da proteína MRTFA-GFP mostra-se completo no citoplasma ce-lular.","A transcrição ocorre inicialmente no núcleo celular; poste-riormente, após o enovelamento, a proteína MRTFA-GFP transloca-se gradualmente ao citoplasma celular pelo com-plexo de poro nuclear.","A tradução ocorre inicialmente no citoplasma celular; pos-teriormente, após o enovelamento, a proteína MRTFA-GFP transloca-se gradualmente ao núcleo celular pelo complexo de poro nuclear."],
    correctAnswer: 3,
    materia: "Biologia – Biologia celular (Organelas, Transporte de proteínas)",
    conteudo: "Biologia – Biologia molecular (Expressão gênica)",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Mata Atlântica tem área de mineração industrial maior do que de garimpo. Nesse bioma, ocorre exploração de minério de ferro, causando o cinturão do desmatamento e o assore-amento dos rios da maior bacia hidrográfica do país.","Amazônia tem área de garimpo maior do que a de mine-ração industrial. Nesse bioma, ocorre exploração de ouro e grande desmatamento nas unidades de conservação e terri-tórios indígenas, com contaminação do rio Tapajós.","Cerrado tem área de garimpo maior do que a de mineração industrial. Nesse bioma, ocorre exploração de minério de ferro, causando o soterramento de nascentes e comprome-tendo o potencial hidroelétrico na região.","Caatinga tem área de mineração industrial maior do que a de garimpo. Nesse bioma, ocorre exploração de níquel, cau-sando a escassez de água na região, água essa utilizada para lavar o metal, o que contamina o rio Tocantins."],
    correctAnswer: 1,
    materia: "Geografia – Geografia ambiental (Biomas brasileiros, Impactos da mineração)",
...
createQuestion({
    ...
    options: ["8 litros.","10 litros.","12 litros.","14 litros."],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: ["(i) e g(x); (ii) e h(x); (iii) e p(x); (iv) e f(x).","(i) e h(x); (ii) e g(x); (iii) e f(x); (iv) e p(x).","(i) e p(x); (ii) e h(x); (iii) e g(x); (iv) e f(x).","(i) e f(x); (ii) e g(x); (iii) e p(x); (iv) e h(x)."],
    correctAnswer: 1,
    materia: "Matemática – Funções trigonométricas (Gráficos de funções)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["o gênero que teve maior quantidade de obras vendidas, considerando os dois anos, foi Biografias, cuja venda foi o triplo da venda do gênero que teve menos obras vendidas.","os únicos gêneros que venderam mais obras em 2021, quando em comparação com as vendas de 2020, foram os gêneros Ficção e Infantil.","o número de obras do gênero Romance que foram vendidas em 2021 é o dobro do que foi vendido em 2020 para este mesmo gênero.","a quantidade de obras vendidas, do gênero Infantil, nos dois anos, é a mesma quantidade de obras vendidas, no mesmo período de tempo, do gênero Biografias."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["7.","8.","17.","18."],
    correctAnswer: 1,
    materia: "Matemática – Funções (Propriedades de logaritmos)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["2R.","R.","R/3.","2R/3."],
    correctAnswer: 2,
    materia: "Matemática – Geometria espacial (Volume de sólidos)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["f⁻¹(x) = f(x), para x≠1 .","f⁻¹(x)=1/f(x), para x ≠ ±1.","f⁻¹(x) = -f(x), para x≠1.","f⁻¹(x) = f(-x), para x≠1."],
    correctAnswer: 0,
    materia: "Matemática – Funções (Função inversa)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["140.","370.","600.","740."],
    correctAnswer: 1,
    materia: "Matemática – Sequências (Recorrência)",
...
createQuestion({
    ...
    options: ["1.","2.","-1.","-2."],
    correctAnswer: 2,
    materia: "Matemática – Sistemas lineares (Discussão de sistemas)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Todas as afirmações são verdadeiras.","Apenas a afirmação I é verdadeira.","Apenas a afirmação II é verdadeira.","Apenas as afirmações I e III são verdadeiras."],
    correctAnswer: 1,
    materia: "Matemática – Combinatória (Princípio da inclusão-exclusão)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["-7,5.","-7.","-6,5.","-6."],
    correctAnswer: 1,
    materia: "Matemática – Geometria analítica (Funções quadráticas e lineares)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["a gravura traz elementos greco-romanos para representar a descoberta do Novo Mundo. Nela, o continente foi simbo-lizado pela paisagem típica da América e pela presença de Américo Vespúcio.","o código visual da gravura, produzido em um contexto me-dieval, traz o encontro de Américo Vespúcio com as terras americanas, representado pelos artefatos europeus, como, por exemplo, a rede.","a gravura alude ao encontro entre Américo Vespúcio e a América, representados, na imagem, pelo navegador e pela indígena nua. Essa representação resultava dos relatos escri-tos sobre o Novo Mundo e da tradição imagética europeia.","a gravura usa elementos visuais da cultura europeia para apresentar a Europa como detentora de civilidade e a Amé-rica indígena, grotesca, armada e opositora aos domínios europeus."],
    correctAnswer: 2,
    materia: "História – História do Brasil (Descobrimento)",
    conteudo: "Arte – Leitura de imagem (Iconografia)",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["As duas telas encenam dois fatos históricos fundamentais da memória nacional: o descobrimento do Brasil e a funda-ção da nação independente. Inseridas no panteão histórico nacional, elas valorizam a história global e a Europa.","Prática do ideário nacionalista oitocentista, a celebração, na pintura histórica, dos fatos nacionais estava associada à pro-dução - do ponto de vista dos trabalhadores retratados na tela - de uma visão de passado da nação.","Celebrar eventos do passado foi estratégico para as identidades coloniais criadas no século XIX. Assim, pertencer a uma nação significava herdar um passado de valorização da diversidade étnica e igualdade social.","Estas pinturas inseriam-se em políticas de memória que construíam e traduziam valores fundamentais das identida-des nacionais. Elas ensinavam sobre as origens da nação e estabeleciam referências identitárias para os cidadãos."],
    correctAnswer: 3,
    materia: "História – História do Brasil (Império, Construção da Nação)",
    conteudo: "Arte – Pintura histórica",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["A serve de exemplo e justificativa para o que B noticia.","B serve de exemplo e justificativa para o que A noticia.","A e B são, ambos, notícias sobre mudanças na política de porte de armas.","A e B são, ambos, notícias sobre a ausência de leis para porte de armas."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Interpretação de texto",
    conteudo: "Sociologia – Violência",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["poder e tentação.","feminismo e violência.","poder e perdão.","perdão e feminismo."],
    correctAnswer: 2,
...
createQuestion({
    ...
    text: {
      ...
      subItens: [{"titulo":"Texto 1","conteudo":"In history, the rise of street art around the world has mirrored multiple waves of political unrest. The use of this avant-garde art style for political activism has spread to the Bay Area, California. As an influx of white upper-class residents displaced low-income households, the anger of local people fueled a movement to take back the streets via spray paint, video projections, stenciling any street art medium. Bay Area activists are weaponizing street art to unite the masses and reclaim their communities' stolen narratives, re-imagining better futures alongside comrades across the nation. Their freeing and colorful art combats the virulent systems of oppression that white supremacy has entrenched in our society, those same systems which mark their craft as illegal under the guise of vandalism. Street art democratizes public spaces and takes back the streets as effectively as physical protests. As a street artist, Nancypili Hernandez says that her art transforms \"locations that feel like a parking lot or private property, to feeling like a collective community commons.\"\n(Adaptado de: https://harvardpolitics.com/street-art-activism/. Acesso em 20/06/2022.)"},{"titulo":"Texto 2","conteudo":"(Image: Street sign that reads \"PARKING\" but has \"ART\" written below it, creating a new meaning.)\n\nSegundo o"},{"titulo":"Texto 1","conteudo":", é correto afirmar que a arte de rua é"}]
    },
    options: ["uma representação vanguardista de arte, originada na Cali-fórnia, que busca combater o preconceito que associa essa manifestação artística ao vandalismo.","um movimento político no qual os artistas buscam difundir a diversidade através da união entre diferentes classes da sociedade.","uma manifestação artística, com motivações políticas, que busca defender os direitos de pessoas em situação de rua.","um estilo artístico que materializa a luta de alguns grupos contra mecanismos sociais que buscam apagar suas vozes."],
    correctAnswer: 3,
    materia: "Inglês – Interpretação de texto",
...
createQuestion({
    ...
    text: {
      principal: "Leia os textos a seguir para responder às questões 68 e 69.",
      subItens: [{"titulo":"Texto 1","conteudo":"In history, the rise of street art around the world has mirrored multiple waves of political unrest. The use of this avant-garde art style for political activism has spread to the Bay Area, California. As an influx of white upper-class residents displaced low-income households, the anger of local people fueled a movement to take back the streets via spray paint, video projections, stenciling any street art medium. Bay Area activists are weaponizing street art to unite the masses and reclaim their communities' stolen narratives, re-imagining better futures alongside comrades across the nation. Their freeing and colorful art combats the virulent systems of oppression that white supremacy has entrenched in our society, those same systems which mark their craft as illegal under the guise of vandalism. Street art democratizes public spaces and takes back the streets as effectively as physical protests. As a street artist, Nancypili Hernandez says that her art transforms \"locations that feel like a parking lot or private property, to feeling like a collective community commons.\"\n(Adaptado de: https://harvardpolitics.com/street-art-activism/. Acesso em 20/06/2022.)"},{"titulo":"Texto 2","conteudo":"(Image: Street sign that reads \"PARKING\" but has \"ART\" written below it, creating a new meaning.)\n\nConsiderando os Textos 1 e 2, assinale a alternativa que preen-che corretamente as lacunas do trecho a seguir. A construção de sentidos na fotografia ("},{"titulo":"Texto 2","conteudo":") se dá, entre outras coisas, por meio da (i) _______ da palavra pintada no muro. Além disso, a fotografia retrata (ii) _______ citada no texto apresentado anteriormente ("},{"titulo":"Texto 1","conteudo":")."}]
    },
    options: ["(i) composição imagética; (ii) a desigualdade social","(i) exploração da polissemia; (ii) uma prática","(i) supressão dos afixos; (ii) a supremacia branca","(i) mudança de tempo verbal; (ii) uma localidade"],
    correctAnswer: 1,
    materia: "Inglês – Interpretação de texto",
    conteudo: "Língua Portuguesa – Semântica (Polissemia)",
    imageNames: []
  }),
