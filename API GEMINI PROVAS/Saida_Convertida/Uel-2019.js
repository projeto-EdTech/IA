createQuestion({
    ...
    year: 2019,
    text: {
      principal: "O tema desta prova é: (Des)encantamento do Mundo.\nAnalise as imagens e leia o texto a seguir.\n[Imagem: Rosana Paulino, Bastidores 1997 - mariaseseverinas.wordpress.com]\n[Imagem: Pintura facial - Kadiwéu - br.pinterest.com]\nOlhos e bocas aparecem costurados grosseiramente como um símbolo. O segredo guardado dentro do universo doméstico: os olhos que não podem ver, a boca que não pode falar, gritar. A artista faz da trama um elemento questionador e ao tempo mesmo criador de novos sentidos, como no trabalho Bastidores, 1997.\nAdaptado de afreaka.com.br\nA pintura indígena é individual, única e possui diversos significados segundo as diferenciações sociais, traduzindo a dignidade do ser humano e exprimindo a sua função sociológica.\nCom base nas imagens, no texto e nos conhecimentos de arte indígena e da arte contemporânea brasileira de Rosana Paulino, considere as afirmativas a seguir.\nI. A obra Bastidores apropria-se de objetos usuais das mulheres para abordar questões que remetem à opressão, ao racismo, à feminilidade, articulando significados.\nII. Obras indígenas trazem, também, o corpo como suporte e base das atividades artísticas, representando a beleza, a vida e suas diferenças na forma humana.\nIII. A arte dos Kadiwéu apresenta uma produção abstrata na pintura do corpo e do rosto com detalhes, simetria, equilíbrio e beleza.\nIV. A produção da obra Bastidores aborda o problema da relação entre o meio ambiente e a religião e prioriza a posição da mulher na natureza e a força do pensamento místico.\nAssinale a alternativa correta.",
      subItens: []
    },
    ...
    conteudo: "Arte – Multiculturalismo",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "As reflexões liberais tenderam a acentuar, até o século XIX, a compreensão de que o Estado era a expressão da Razão. Nessa forma de compreensão liberal, é correto afirmar que o Estado",
      subItens: []
    },
    options: ["deveria intervir na economia, uma vez que a liberdade de negociar reconduziria a sociedade ao princípio do \"homem como lobo do homem\", destacado por Rousseau.","atingiria seu maior grau de eficiência se comandado pelas classes industriais, em detrimento das demais frações que compõem a burguesia, isto é, proprietários de terra e comerciantes.","seria a instância a partir da qual as desigualdades formais entre os indivíduos se transformariam em igualdade real entre os homens.","tenderia a desaparecer, na medida em que o sistema produtivo dividisse as riquezas produzidas pelas classes sociais, como expressão da Razão.","representaria os interesses do conjunto da sociedade, pairando, portanto, acima das classes sociais e de suas demandas específicas."],
    correctAnswer: 4,
    materia: "Sociologia – Política/Estado",
    conteudo: "Sociologia – Dominação e Poder",
    imageNames: []
  }),
...
createQuestion({
    ...
    conteudo: "Química – Estudo Geral dos Líquidos e Sólidos",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Celso Furtado identifica que as origens da desigualdade brasileira decorrem de nossa tradição autocrática, que impediu a formação de uma burguesia autônoma.","Malthus atribui a causa da pobreza à baixa taxa de natalidade, o que reduziria a massa salarial das famílias de baixa renda.","Amartya Sen considera que a eliminação da pobreza depende diretamente do crescimento econômico, pois este assegura benefício a todos os grupos sociais.","Hayek propõe a redução do Estado como meio de gerar maior eficiência econômica, contrapondo-se assim às políticas do Welfare State.","Keynes aponta que a redução dos gastos públicos é uma variável essencial para o estabelecimento do crescimento econômico e do bem-estar social."],
    correctAnswer: 3,
    materia: "Sociologia – Estrutura e Estratificação Social",
    conteudo: "Sociologia – As Desigualdades Sociais",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Somente as afirmativas I e II são corretas.","Somente as afirmativas I e IV são corretas.","Somente as afirmativas III e IV são corretas.","Somente as afirmativas I, II e III são corretas.","Somente as afirmativas II, III e IV são corretas."],
    correctAnswer: 1,
    materia: "Sociologia – Relação homem/natureza: a questão do trabalho na perspectiva antropológica e sociológica",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["A instauração da propriedade decorre de um ato legítimo da sociedade civil, na medida em que busca atender às necessidades do homem em estado de natureza.","A instauração da propriedade e da sociedade civil cria uma ruptura radical do homem consigo mesmo e de distanciamento da natureza.","A fundação da sociedade civil é legitimada pela racionalidade e pela universalidade do ato de instauração da propriedade privada.","O sentimento mais primitivo do homem, que o leva a instituir a propriedade, é o reconhecimento da necessidade da propriedade para garantir a subsistência.","A sociedade civil e a propriedade são expressões da perfectibilidade humana, ou seja, da sua capacidade de aperfeiçoamento."],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: ["1e2","2e3","2e4","3e6","4e8"],
    correctAnswer: 0,
    materia: "Matemática – Conjuntos Numéricos: números naturais e números inteiros: operações e propriedades",
    conteudo: "Matemática – Funções, Equações e Inequações: relações e funções: domínio",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["O ser humano deve superar o estado de natureza fundando a sociedade civil e o Estado, cedendo seus direitos em prol da paz social.","Os indivíduos, no estado de natureza, são juízes de si mesmos, fundam o Estado para garantir segurança e direitos individuais por meio das leis.","O poder do Estado deve ser absoluto para a garantia dos direitos naturais da humanidade, como a vida, a liberdade e a propriedade.","O pacto ou contrato social é o garantidor das liberdades e direitos, sendo o poder legislativo o menos importante, já que é possível sua revogação por aqueles que participam do poder executivo.","O ser humano se realiza como um ser possuidor de bens, sendo sua posse o que garante tolerância religiosa, livre-iniciativa econômica e liberdade individual."],
    correctAnswer: 1,
    materia: "Filosofia – Problemas Políticos e Éticos na Filosofia",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Relacione as imagens às manifestações artísticas a seguir.\n[Imagem: (I) \"Ttéia\", 2002]\n[Imagem: (II) Cambuí, 2011]\n[Imagem: (III) Escultura do monumento do emissário de Santos, 2008]\n[Imagem: (IV) Linda do rosário, 2004]\n(A) Adriana Varejão. Faz parte do movimento da arte contemporânea brasileira e destaca-se pela mistura de materiais, como um bricoleur, coleta fragmentos de histórias e os traduz em outros, ocupando uma sala no museu aberto de Inhotim.\n(B) Tomie Otake. Ligada à estética não figurativa contemporânea, apresenta fortes contornos das formas com equilíbrio, luz e sombra, movimento e curvas vertiginosas, sombreados em algumas superfícies, transcendendo a realidade e ocupando espaços públicos.\n(C) Ligia Pape. Reinterpreta o modernismo europeu no contexto brasileiro, dentro e além do movimento neoconcreto, trabalhando com os mais diversos suportes, como fios, experimentando uma ampla gama de linguagens e formatos.\n(D) Caciporé. Faz parte da arte da segunda metade do século XX. Suas obras proporcionam uma leitura de esculturas de grandes dimensões, com construções de aspecto maciço, em ferro fundido, não figurativas.\nAssinale a alternativa que contém a associação correta.",
      subItens: []
    },
    options: ["I-B, II-D, III-A, IV-C.","I-C, II-B, III-D, IV-A.","I-C, II-D, III-B, IV-A.","I-A, II-D, III-C, IV-B.","I-B, II-C, III-D, IV-A."],
    correctAnswer: 1,
    materia: "Arte – Arte Contemporânea",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["Somente as afirmativas I e II são corretas.","Somente as afirmativas I e IV são corretas.","Somente as afirmativas III e IV são corretas.","Somente as afirmativas I, II e III são corretas.","Somente as afirmativas II, III e IV são corretas."],
    correctAnswer: 3,
    materia: "Sociologia – Mudança/transformação social/movimentos sociais/direitos/cidadania",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["O mito revela uma constituição irracional, na medida em que lhe é impossível apresentar uma explicação convincente sobre o seu modo próprio de ser.","A regressão do esclarecimento à mitologia revela um processo estratégico da razão, com o objetivo de ampliar e intensificar seus poderes explicativos.","A explicação da natureza, instaurada pela racionalidade instrumental, pressupõe uma compreensão holística, em que as partes são incorporadas, na sua especificidade, ao todo.","O esclarecimento implica a libertação humana da submissão à natureza, atestada pelo poder racional de diagnosticar, prever e corrigir as limitações naturais.","O esclarecimento se caracteriza por uma explicação baseada no cálculo, do que resulta uma compreensão da natureza como algo a ser conhecido e dominado."],
    correctAnswer: 4,
    materia: "Filosofia – Problemas Epistemológicos na Filosofia",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["15 m/s devido à aplicação de um impulso resultante de 0,12 x 10² N/s.","40 m/s quando o jogador aplica uma força de 1,6 x 10² N durante um intervalo de tempo de 0,1 s.","60 m/s quando uma força de 1,2 x 10² N é aplicada durante um intervalo de tempo de 0,1 s.","90 km/h devido à aplicação de um impulso de 0,12 x 10² N/s.","108 km/h quando o jogador aplica uma força de 1,6 x 10² N durante um intervalo de tempo de 0,1 s."],
    correctAnswer: 1,
    materia: "Física – Mecânica",
    conteudo: "Física – Leis de Newton",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "O acetato de etila (CH3COOCH2CH3) é um éster simples, usado, no passado, como antiespasmódico e hoje como solvente industrial e removedor de esmalte de unha. A acetona (CH_{3}(CO)CH_{3}) também é usada como removedor de esmaltes, mas devido a sua elevada solubilidade em água, quando em contato com a pele, pode desidratá-la. Sabe-se que estes solventes possuem cheiros parecidos, tornando difícil a identificação pelo olfato.\nConsiderando um frasco contendo acetato de etila e acetona em quantidades equimolares, assinale a alternativa que apresenta, corretamente, o procedimento para a separação da mistura.\nDados:\nPonto de ebulição do acetato de etila a 1 atm =77,1 °C e densidade = 902 $\\\\frac{Kg}{m}$³\nPonto de ebulição da acetona a 1 atm = 56,0 °C e densidade = 784 $\\\\frac{Kg}{m}$³",
      subItens: []
    },
    options: ["Empregar funil de separação, em que a acetona ficará na fase inferior do funil.","Empregar destilação simples, pois a diferença dos pontos de ebulição dos solventes é elevada.","Empregar destilação fracionada, em que o primeiro solvente a ser destilado será a acetona.","Empregar destilação simples, pois se trata de uma mistura eutética, em que os solventes são imiscíveis.","Empregar separação fracionada, aquecendo a mistura a 80 °C, sendo que o primeiro solvente a ser destilado será o acetato de etila."],
    correctAnswer: 2,
    materia: "Química – Substâncias Puras e Misturas: Métodos de separação de misturas",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Somente as afirmativas I e II são corretas.","Somente as afirmativas I e IV são corretas.","Somente as afirmativas III e IV são corretas.","Somente as afirmativas I, II e III são corretas.","Somente as afirmativas II, III e IV são corretas."],
    correctAnswer: 0,
    materia: "História – Mundo Contemporâneo: Os impasses sociais do século XX: guerras, revoluções, totalitarismo, populismos e autoritarismos",
    conteudo: "História – Culturas de massa e vanguardas artísticas: as relações entre o erudito e o popular",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Leia o texto a seguir.\nOs corcéis que me transportam, tanto quanto o ânimo me impele, conduzem-me, depois de me terem dirigido pelo caminho famoso da divindade [...] E a deusa acolheu-me de bom grado, mão na mão direita tomando, e com estas palavras se me dirigiu: [...] Vamos, vou dizer-te – e tu escuta e fixa o relato que ouviste – quais os únicos caminhos de investigação que há para pensar, um que é, que não é para não ser, é caminho de confiança (pois acompanha a realidade): o outro que não é, que tem de não ser, esse te indico ser caminho em tudo ignoto, pois não poderás conhecer o não-ser, não é possível, nem indicá-lo [...] pois o mesmo é pensar e ser.\nPARMENIDES. Da Natureza, frags. 1-3. Trad. José Trindade Santos. 2. ed. São Paulo: Loyola, 2009. p. 13-15.\nCom base no texto e nos conhecimentos sobre a filosofia de Parmênides, assinale a alternativa correta.",
      subItens: []
    },
    options: ["Pensar e ser se equivalem, por isso o pensamento só pode tratar e expressar o que é, e não o que não é – o não ser.","A percepção sensorial nos possibilita conhecer as coisas como elas verdadeiramente são.","O ser é mutável, eterno, divisível, móvel e, por isso, a razão consegue conhecê-lo e expressá-lo.","A linguagem pode expressar tanto o que é como o que não é, pois ela obedece aos princípios de contradição e de identidade.","O ser é e o não ser não é indica que a realidade sensível é passível de ser conhecida pela razão."],
    correctAnswer: 0,
    materia: "Filosofia – Tema Introdutório Básico (A passagem do Mito para o Logos no surgimento da Filosofia)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["A maneira como Homero constrói seus personagens retratando reações humanas deve ser imitada pelos demais poetas, pois é eticamente aprovada na Cidade Ideal platônica.","O fato de mostrar as emoções de maneira exagerada em seus personagens faz de Homero e de autores de tragédia excelentes formadores na Cidade Ideal pensada por Platão.","Reagir como os personagens homéricos e trágicos é digno de elogio, pois Platão considera que a descarga das emoções é benéfica para a formação ética dos cidadãos.","Poetas como Homero e autores de tragédia provocam emoções de modo exagerado em quem os lê ou assiste, não sendo bons para a formação do cidadão na Cidade Ideal platônica.","A imitação de Homero e dos trágicos das reações humanas difere da dos pintores, pois, segundo Platão, não estão distantes em graus da essência, por isso podem fazer parte da cidade justa."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Na figura 1, que se assemelha ao bulbo de um olho humano, é possível perceber algumas das suas estruturas, como a pupila e a íris.\nCom base nos conhecimentos sobre a óptica da visão, é correto afirmar que o olho com",
      subItens: []
    },
    options: ["hipermetropia é caracterizado pela formação da imagem num ponto antes da retina.","miopia é semelhante a uma lente de vidro plano-côncavo mergulhada em meio aquoso.","hipermetropia é semelhante a uma lente de vidro côncavo-convexo mergulhada em meio aquoso.","miopia tem a imagem formada depois da retina, e sua correção deve ser feita com lentes convergentes.","miopia é caracterizado por apresentar uma convergência acentuada do cristalino."],
    correctAnswer: 4,
    materia: "Física – Óptica e Ondas: lentes e instrumentos ópticos",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Uma das características mais fundamentais dos metazoários são os olhos, que se apresentam em uma variedade de tipos. Quase todos são sensíveis à luz, e a maioria possui algum tipo de fotorreceptor, porém somente os representantes de alguns filos desenvolveram olhos capazes de formar imagens.\nOs olhos compostos compreendem de poucas a muitas unidades fotorreceptoras cilíndricas denominadas omatídios. Cada omatídio contribui com a imagem de uma parte do objeto, de modo que o conjunto forma a sua imagem total.\nAssinale a alternativa que indica, corretamente, qual grupo animal é caracterizado pelos olhos descritos acima.",
      subItens: []
    },
    options: ["Artrópodes","Anelídeos","Cnidários","Moluscos","Platelmintos"],
    correctAnswer: 0,
    materia: "Biologia – Diversidade dos Seres Vivos",
    conteudo: "Biologia – Classificação e características morfológicas dos seres vivos",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Em 2017, a ANVISA aprovou a administração de um medicamento antirretroviral composto pela combinação das substâncias entricitabina (FTC) e fumarato (molécula contendo ácido carboxílico como função orgânica) de tenofovir desoproxila (TDF) para pessoas com alto risco de infecção pelo vírus HIV. O medicamento apresenta Profilaxia Pré-Exposição (PrEP), ou seja, evita que uma pessoa que não tem HIV adquira a infecção quando se expõe ao vírus.\nAs estruturas químicas da FTC e do TDF são apresentadas:\n[Imagens: Estruturas químicas de FTC e TDF]\nDados:\nMassa molar da FTC = 247,24 g mol⁻¹\nMassa molar do TDF = 635,52 g mol⁻¹\nSabe-se que a solubilidade em água a 25 °C da FTC é 13,4 mg L⁻¹ e do TDF é 112,0 mg mL⁻¹ e que a constante de ionização da FTC é de 5,12 x 10⁻¹⁵, cujo hidrogênio ácido é aquele pertencente à hidroxila.\nCom base nas estruturas químicas e nas informações apresentadas sobre as moléculas, assinale a alternativa correta.",
      subItens: []
    },
    options: ["A espécie de FTC que estaria em maior concentração no intestino (pH igual a 8) é a espécie carregada negativamente.","Supondo que o TDF seja mais solúvel em solvente apolar do que em meio aquoso, pode-se afirmar que sua solubilidade será maior na forma neutra.","Na estrutura do TDF, o fumarato possui isomeria óptica e carbono quaternário e a função fosfato possui isomeria plana.","Analisando a solubilidade das substâncias, em 1 litro de água a quantidade de matéria (mols) de FTC será maior que de moléculas de TDF.","A estrutura do TDF possui funções amida e aldeído; já a estrutura da FTC possui funções fenol e amida."],
    correctAnswer: 1,
    materia: "Química – Equilíbrio químico: aspectos gerais",
    conteudo: "Química – Compostos de carbono: aspectos gerais",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Conforme um fármaco é injetado, a partir do instante t = 0, sua concentração no sangue aumenta até atingir um máximo C em t = Tm. Considere que, na sequência, o rim inicie o processo de excreção do fármaco, fazendo com que sua concentração no sangue caia progressivamente. Suponha que a função f : R+ → R determine a concentração f (t) desse fármaco no sangue em um instante de tempo t ≥ 0. Sabendo que f(t) = C($\\\\frac{t}{Tm}$)² se t < Tm, e considerando que f(t) = C_{2}Tm⁻²t se t ≥ Tm, com Tm e C constantes positivas, assinale a alternativa que apresenta, corretamente, os dois instantes de tempo em que a concentração desse fármaco no sangue é $\\\\frac{C}{2}$.",
      subItens: []
    },
    options: ["Tm e Tm/2","Tm e C/2","2Tm e Tm-2","Tm/√2 e 1 + Tm","1-Tm e log(√2Tm)"],
    correctAnswer: 3,
    materia: "Matemática – Funções, Equações e Inequações: Relações e funções: domínio, contradomínio e imagem",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Escândalos recentes sobre a exposição de dados dos usuários do Facebook alimentaram os debates sobre a privacidade nas redes sociais, um tema que se conecta com a questão do poder e suscita preocupações sobre o quanto as pessoas e suas relações tornam-se expostas ou protegidas com o uso das novas tecnologias de informação.\nCom base nos conhecimentos sociológicos sobre redes sociais e sociedade contemporânea, assinale a alternativa correta.",
      subItens: []
    },
    options: ["A revolução tecnológica atual originou-se da resistência social à reestruturação global do capitalismo e moldou- -se pela lógica da liberdade em oposição aos interesses mercantis.","O novo das redes sociais é que, diferentemente das mídias tradicionais, são empreendimentos anticapitalistas por não cobrarem dos usuários o acesso aos serviços de informação.","As interações via redes sociais tornam mais fluidas as fronteiras entre as esferas pública e privada no mundo contemporâneo.","A força política das fake news, nas recentes eleições presidenciais nos EUA, teve como motor a ausência de medidas estatais e privadas para regular os termos de uso das redes sociais.","Os sistemas de comunicações digitais, ao criarem novos espaços de diálogo sobre os problemas sociais, retiram do Estado sua principal função: o uso do monopólio legítimo da violência."],
    correctAnswer: 2,
    materia: "Sociologia – Indivíduo, Identidade e Socialização",
    conteudo: "Sociologia – Mudança/Transformação Social/Movimentos Sociais/Direitos/Cidadania",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A partir dos conhecimentos sobre arte contemporânea na tridimensionalidade, relacione as obras com os seus artistas.\n[Imagem: (I) \"Ttéia\", 2002]\n[Imagem: (II) Cambuí, 2011]\n[Imagem: (III) Escultura do monumento do emissário de Santos, 2008]\n[Imagem: (IV) Linda do rosário, 2004]\n(A) Adriana Varejão. Faz parte do movimento da arte contemporânea brasileira e destaca-se pela mistura de materiais, como um bricoleur, coleta fragmentos de histórias e os traduz em outros, ocupando uma sala no museu aberto de Inhotim.\n(B) Tomie Otake. Ligada à estética não figurativa contemporânea, apresenta fortes contornos das formas com equilíbrio, luz e sombra, movimento e curvas vertiginosas, sombreados em algumas superfícies, transcendendo a realidade e ocupando espaços públicos.\n(C) Ligia Pape. Reinterpreta o modernismo europeu no contexto brasileiro, dentro e além do movimento neoconcreto, trabalhando com os mais diversos suportes, como fios, experimentando uma ampla gama de linguagens e formatos.\n(D) Caciporé. Faz parte da arte da segunda metade do século XX. Suas obras proporcionam uma leitura de esculturas de grandes dimensões, com construções de aspecto maciço, em ferro fundido, não figurativas.\nAssinale a alternativa que contém a associação correta.",
      subItens: []
    },
    options: ["I-C, II-A, III-B, IV-D.","I-C, II-B, III-D, IV-A.","I-C, II-D, III-B, IV-A.","I-A, II-D, III-C, IV-B.","I-B, II-C, III-D, IV-A."],
    correctAnswer: 2,
    materia: "Arte – Arte Contemporânea",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Um dos temas mais controversos da história da ciência diz respeito à origem da vida, pois existia a dúvida se ela teria surgido pela abiogênese (geração espontânea) ou pela biogênese. Por séculos, inúmeros pesquisadores propuseram e desenvolveram explicações, por meio de experimentos, como consequência de diferentes olhares.\nCom base nos conhecimentos sobre abiogênese e biogênese, assinale a alternativa que relaciona, corretamente, o pesquisador, a hipótese por ele defendida e o experimento que deu sustentação para sua defesa.",
      subItens: []
    },
    options: ["John Tuberville Needham defendeu a abiogênese por meio de experimentos que demonstraram o surgimento de microrganismos em um caldo de carne aquecido e mantido em recipientes fechados.","Jean-Baptiste van Helmont defendeu a biogênese por meio de experimentos que demonstraram o surgimento de larvas em pedaços de carne em putrefação.","Lazzaro Spallanzani defendeu a biogênese por meio de estudos que demonstraram a origem da matéria que permitia o crescimento das plantas em vasos.","Felix Pouchet defendeu a biogênese por meio de experimentos a partir dos quais surgiam microrganismos pela fervura de um caldo nutritivo em frascos de vidro.","Louis Pasteur defendeu a abiogênese por meio de experimentos com uma mistura aquecida de água, feno e gás oxigênio (O2), a partir da qual surgiam microrganismos."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Em 1968, os jovens foram protagonistas de manifestações em diferentes países como França, Estados Unidos, Tchecoslováquia, México e Brasil, com rebeliões que expressaram vários e diferentes ideais.\nSobre as manifestações de 1968, atribua V (verdadeiro) ou F (falso) às afirmativas a seguir.\n( ) Nos Estados Unidos, os jovens se colocaram contrários à guerra do Vietnã, na geração que ficou conhecida como flower power.\n( ) Na Tchecoslováquia, durante a Primavera de Praga, os jovens insurgiram-se contra o poderio soviético, reclamando, dentre outras coisas, por mais liberdade individual.\n( ) A descoberta da pílula anticoncepcional impulsionou a ideia de amor livre, e a roupa unissex passou a caracterizar o jovem.\n( ) Em São Paulo, estudantes da USP invadiram o Palácio do Governo exigindo \"Diretas Já\" e a anistia geral aos perseguidos políticos.\n( ) Os jovens lutaram contra as drogas químicas, apontando que eram produtos da indústria capitalista criados para aliená-los.\nAssinale a alternativa que contém, de cima para baixo, a sequência correta.",
      subItens: []
    },
    options: ["V, F, V, F, V.","V, V, V, F, F.","V, V, F, V, F.","F, V, F, V, V.","F, F, V, F, V."],
    correctAnswer: 1,
    materia: "História – O Mundo Contemporâneo: A consolidação do capitalismo: dominação, conflitos e resistências",
    conteudo: "História – Os impasses sociais do século XX: guerras, revoluções, totalitarismos, populismos e autoritarismos",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["A língua vulgar, o francês, expressa de modo mais adequado o espírito da modernidade por estar livre dos preconceitos da língua dos doutos, o latim.","Redigir o Discurso do Método em francês teve propósito similar à tradução da bíblia para o alemão feita por Lutero: facilitar o acesso à sacralidade do texto em língua vulgar.","O desencantamento do mundo, resultante da radical crítica cartesiana à tradição, teve como consequência o abandono da referência à divindade.","As ideias expressas por Descartes em seu Discurso do Método refletem a postura tipicamente moderna de ruptura total com o passado.","A razão natural inteiramente pura é um atributo inerente à natureza humana, independentemente da tradição ou da cultura à qual o humano se vincula."],
    correctAnswer: 4,
    materia: "Filosofia – Problemas Epistemológicos na Filosofia",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A hipoglicemia é caracterizada por uma concentração de glicose abaixo de 0,70 g L⁻¹ no sangue. O quadro de hipoglicemia em situações extremas pode levar a crises convulsivas, perda de consciência e morte do indivíduo, se não for revertido a tempo. Entretanto, na maioria das vezes, o indivíduo, percebendo os sinais de hipoglicemia, consegue reverter este déficit, consumindo de 15 a 20 gramas de carboidratos, preferencialmente simples, como a glicose.\nA metabolização da glicose, C_{6}H12O6, durante a respiração, pode ser representada pela equação química de combustão:\nC_{6}H12O6(S) + 6O2(g) → 6CO2(g) + 6H2O(l)\nNo quadro a seguir, são informadas reações químicas e seus respectivos calores de formação a 25 °C e 1 atm:\nReações químicas | ΔHƒ°(kJmol⁻¹)\nC(s, grafite) + O_{2}(g) → CO_{2}(g) | -394\nH_{2}(g) + ½O_{2}(g) → H_{2}O(l) | -286\n6C(s) + 6H2(g) + 3O2(g) → C_{6}H12O6 (S) | -1260\nSabendo que a Massa Molar (MM) da glicose é igual a 180,0 g mol⁻¹, determine a quantidade aproximada de energia liberada em kJ mol⁻¹ no estado padrão, ΔH°, na combustão da glicose, consumida em 350 mL de refrigerante do tipo Cola, o qual possui, em sua composição, 35 g de glicose.",
      subItens: []
    },
    options: ["- 315","- 113","- 471","- 257","- 548"],
    correctAnswer: 4,
    materia: "Química – Termoquímica: Aditividade dos calores de reação e Lei de Hess",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "O movimento artístico da década de 1960 conhecido como \"Land Art\" (Arte da Terra) parte da conexão e integração entre arte e natureza, em que a natureza é, além de suporte, a criação artística.\nCom base na figura e nos conhecimentos sobre o movimento Land Art, atribua V (verdadeiro) ou F (falso) às afirmativas a seguir.\n( ) Destaca a relação entre espaço e mundo, em que um se realiza através do outro; opõe-se à arte apresentada nos museus, criticando a indústria cultural e a racionalidade formal.\n( ) Enfatiza a grandeza e a efemeridade da arte na sua fusão com a natureza; os espaços das obras se comunicam e interagem uns com os outros.\n( ) Utiliza objetos do cotidiano para a obra de arte comunicar e interagir no fazer artístico e baseia-se na relação entre a arte e o espaço limitado, fazendo deles o seu local de ocupação e produção.\n( ) Traz a natureza como material e faz do espaço a arte, enfatizando os conceitos sobre ecologia, meio ambiente e sustentabilidade.\n( ) Está ligado a uma estética baseada em sua bidimensionalidade circunscrita e na elaboração de obras que perduram por gerações.\nAssinale a alternativa que contém, de cima para baixo, a sequência correta.",
      subItens: []
    },
    options: ["V, F, V, V, V.","V, V, F, V, F.","V, V, F, F, V.","F, V, F, V, F.","F, F, V, F, V."],
    correctAnswer: 1,
    materia: "Arte – Arte Contemporânea",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Na figura 2, é possível observar esculturas construídas com a sobreposição de pedras. Com base nos conhecimentos sobre equilíbrio e estática, é correto afirmar que cada uma das esculturas está em equilíbrio estático",
      subItens: []
    },
    options: ["instável, pois o momento de força atuante na pedra superior varia com o tempo.","estável, pois a resultante das forças que atuam sobre a última pedra é positiva.","instável, pois a resultante das forças que atuam sobre o conjunto das pedras é nula.","estável, pois a resultante das forças que atuam sobre a primeira pedra é positiva.","instável, pois a resultante das forças que atuam sobre o conjunto das pedras é negativa."],
    correctAnswer: 2,
    materia: "Física – Mecânica: Equilíbrio estático: forças em equilíbrio",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["F, V, F, V, V.","F, V, V, F, F.","V, F, F, V, F.","V, F, V, F, V.","V, V, F, F, V."],
    correctAnswer: 3,
    materia: "Geografia – A apropriação e exploração dos diferentes elementos da natureza, a partir de conceitos básicos relativos a: características, dinâmicas e interações climáticas",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["As práticas toyotistas foram incorporadas pelo modelo econômico neoliberal para potencializar a produtividade do trabalho.","A política econômica de Hegel de estatização da economia impediu os trabalhadores de escolherem livremente seus empregos.","O Plano Marshall foi implementado pelos EUA para reconstruir sua infraestrutura econômica de indústria nacional devastada pela Segunda Guerra Mundial.","A Glasnost, criada por Gorbatchev na U.R.S.S., representou a salvação da bancarrota da economia soviética.","Mahatma Gandhi, ao fiar o algodão para produzir seu próprio tecido, incentivou os indianos a participarem do mercado britânico."],
    correctAnswer: 0,
    materia: "História – O Mundo Contemporâneo",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "O filme Jumanji (1995) é uma obra de ficção que retrata a história de um jogo de tabuleiro mágico que empresta seu nome ao longa-metragem. O jogo é composto de dois dados distinguíveis de 6 lados, um tabuleiro com um visor de cristal no centro e peças que representam cada jogador. No filme, Alan Parrish é um garoto que encontra o jogo em um local de construção e o leva para casa. Assim que chega, Alan convida Sarah Whittle, uma garota da vizinhança, para jogar. Quando Alan lança os dados, aparece no visor a seguinte mensagem:\n[Imagem: Tela do jogo Jumanji com a mensagem \"NA SELVA VOCÊ DEVE ESPERAR ATÉ CINCO OU OITO ALGUÉM TIRAR.\"]\nAdaptado de google.com.br\nAlan então é sugado pelo visor de cristal e transportado magicamente até a selva de Jumanji.\nSupondo que os dois dados do jogo sejam independentes e honestos, assinale a alternativa que apresenta, corretamente, a probabilidade de algum jogador lançar os dois dados e obter a soma de 5 ou 8, de modo a tirar Alan da selva.",
      subItens: []
    },
    options: ["15%","22%","25%","62%","66%"],
    correctAnswer: 2,
    materia: "Matemática – Análise Combinatória: Princípios de contagem",
    conteudo: "Matemática – Noções de Estatística e Probabilidade: conceituação de probabilidade",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Numa sala com temperatura de 18 °C, estão dispostos um objeto metálico e outro plástico, ambos com a mesma temperatura desse ambiente. Um indivíduo com temperatura corporal média de 36 °C segura esses objetos, um em cada mão, simultaneamente. Neste caso, é correto afirmar que há rápida transferência de calor",
      subItens: []
    },
    options: ["da mão para o objeto metálico e lenta da mão para o plástico, por isso a sensação de frio maior proveniente do objeto metálico.","do objeto metálico para a mão e lenta do plástico para a mão, por isso a sensação de frio maior proveniente do plástico.","da mão para o plástico e lenta da mão para o objeto metálico, por isso a sensação de frio maior proveniente do plástico.","do plástico para a mão e lenta do objeto metálico para a mão, por isso a sensação de calor maior proveniente do objeto metálico.","da mão para o plástico e lenta da mão para o objeto metálico, por isso a sensação de calor maior proveniente do objeto metálico."],
    correctAnswer: 0,
    materia: "Física – Fluidos e Termodinâmica",
    conteudo: "Física – Termodinâmica: Lei zero, processos termodinâmicos",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Somente as afirmativas I e II são corretas.","Somente as afirmativas I e IV são corretas.","Somente as afirmativas III e IV são corretas.","Somente as afirmativas I, II e III são corretas.","Somente as afirmativas II, III e IV são corretas."],
    correctAnswer: 0,
    materia: "Matemática – Conjuntos Numéricos: números naturais e números inteiros: operações e propriedades, divisibilidade",
    conteudo: "Matemática – Noções Elementares de Números Complexos: operações simples",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["A secularização da vida moderna e o consequente desencantamento do mundo são expressões da racionalização ocidental.","O homem moderno detém menor controle sobre as forças da natureza, em comparação com o domínio que possuía o \"selvagem\".","O avanço da racionalidade produz, também, uma maior revitalização da cultura clássica, dado que amplia o alcance das escolhas efetivas disponíveis.","O desencantamento do mundo é um fato social que atua como força coercitiva sobre as vontades individuais, visando à construção da consciência coletiva.","O desencantamento do mundo destitui o Ocidente de um elemento diferenciador em relação ao Oriente: as ações sociais dotadas de sentido."],
    correctAnswer: 0,
    materia: "Sociologia – O Conhecimento em Ciências Sociais: introdução ao estudo da sociedade – teoria e método",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["luta de classes.","anomia social.","fetichismo social.","indústria cultural.","fim da história."],
    correctAnswer: 2,
    materia: "Sociologia – O conhecimento em Ciências Sociais: introdução ao estudo da sociedade – teoria e método",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["a transgenia aplicada na produção agrícola permitiu aos produtores rurais a geração de suas próprias sementes transgênicas, dando-lhes autonomia produtiva.","a biopirataria praticada pelos povos nativos prejudicou os lucros das corporações transnacionais envolvidas diretamente nos direitos sobre as patentes de suas pesquisas tecno-científicas.","a partir do desenvolvimento científico da biotecnologia, os profissionais vinculados a essa área se tornaram responsáveis a cumprir os preceitos da bioética.","o projeto de pesquisa científico e tecnológico de mapeamento genético denominado Genoma Humano foi desenvolvido pela Bayer e teve sua patente reconhecida pela ONU.","o patrimônio genético dos povos nativos e seus conhecimentos de práticas milenares de cultivo e de relação com seu habitat gerou-lhes rendimentos lucrativos no Banco Mundial."],
    correctAnswer: 2,
    materia: "Geografia – O Mundo Contemporâneo: globalização, neoliberalismos, a questão ambiental e a sociedade do conhecimento",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["I-A, II-B, III-C, IV-E, V-D.","I-A, II-D, III-C, IV-B, V-E.","I-B, II-A, III-D, IV-E, V-C.","I-B, II-D, III-A, IV-C, V-E.","I-E, II-A, III-B, IV-C, V-D."],
    correctAnswer: 2,
    materia: "Geografia – A apropriação e exploração dos diferentes elementos da natureza, a partir de conceitos básicos",
    conteudo: "Geografia – Os processos sociais e culturais e suas expressões territoriais",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["V, V, F, V, F.","V, F, V, F, F.","V, F, F, V, V.","F, V, V, F, V.","F, F, V, F, V."],
    correctAnswer: 3,
    materia: "História – O Mundo contemporâneo: os Impassses sociais do século XX: guerras, revoluções, totalitarismos, populismos e autoritarismos",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "No texto, estão expressos os horrores causados na população de Hiroshima pela explosão da bomba nuclear. Em relação ao princípio físico de seu funcionamento, assinale a alternativa correta.",
      subItens: []
    },
    options: ["A bomba de fissão nuclear, conhecida como bomba H, libera energia quando ocorre o processo de fragmentação de núcleos de U238.","A bomba de fissão nuclear, conhecida como bomba A, libera energia quando ocorre o processo de fragmentação de núcleos de U235.","A bomba de fissão nuclear, conhecida como bomba H, absorve energia quando ocorre o processo de fragmentação de núcleos de U238.","A bomba de fusão nuclear, conhecida como bomba A, libera energia quando ocorre o processo de fragmentação de núcleos de U238.","A bomba de fusão nuclear, conhecida como bomba H, absorve energia quando ocorre o processo de fragmentação de núcleos de U235."],
    correctAnswer: 1,
    materia: "Física – Física, Cosmos e Vida: transformações dos materiais e radioatividade",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Da quantidade total de água que recobre o planeta, cerca de 97% encontram-se nos mares e nos oceanos e o restante, 3%, são de água-doce. No entanto, a hidrosfera, tanto nos ambientes de água salgada quanto de água doce, se apresenta diversa em relação aos organismos que dela fazem parte.\nCom base nos conhecimentos sobre a hidrosfera, assinale a alternativa correta.",
      subItens: []
    },
    options: ["Do vapor da água oriundo de áreas continentais, mais de 90% origina-se da evaporação diretamente do solo e o restante se dá pela respiração das plantas.","A região bentônica dos ecossistemas marinhos caracteriza-se pela intensa penetração de luz, alta atividade fotossintética, grande disponibilidade de nutrientes e muitos animais.","O acúmulo de partículas na água de rios e lagos aumenta a penetração de luz, o que implica aumento da biodiversidade de espécies fotossintetizantes aquáticas.","A eutrofização indica que um determinado ambiente aquático alcançou o seu clímax, porque nele são encontradas situações favoráveis para o desenvolvimento dos mais diferentes tipos de seres vivos.","Os néctons constituem um grupo de organismos aquáticos, do qual fazem parte os animais com capacidade de deslocamento e natação, como moluscos, cefalópodes, peixes, golfinhos, tartarugas e baleias."],
    correctAnswer: 4,
    materia: "Biologia – Ecologia",
    conteudo: "Biologia – Diversidade dos seres vivos",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["As águas subterrâneas podem ser captadas e ter seu uso imediato no consumo diário, já que sua principal característica é a potabilidade em toda a extensão do aquífero.","O conhecimento hidrogeológico deste Aquífero é amplo, o que permite uma gestão adequada de seus recursos, possibilitando a exploração racional e equitativa por parte dos países da borda oriental.","Com o desenvolvimento dos planos diretores de uso do solo, todos os municípios localizados sobre o Aquífero são obrigados a aplicar a Política Nacional de Resíduos Sólidos, o que garante a qualidade das águas infiltradas.","Os aquíferos estão protegidos da poluição, já que seu processo de formação impede que os agentes poluidores cheguem às suas águas, o que permite manter sua qualidade.","Os aquíferos abastecem a região em que estão inseridos e colaboram com a dinâmica ambiental, econômica e social, mantendo a quantidade de água subterrânea e superficial do planeta."],
    correctAnswer: 4,
    materia: "Geografia – A apropriação e exploração dos diferentes elementos da natureza, a partir de conceitos básicos relativos: à gênese e transformação do relevo",
    conteudo: "Geografia – dinâmica das bacias hidrográficas e sua utilização",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Somente as afirmativas I e II são corretas.","Somente as afirmativas I e IV são corretas.","Somente as afirmativas III e IV são corretas.","Somente as afirmativas I, II e III são corretas.","Somente as afirmativas II, III e IV são corretas."],
    correctAnswer: 4,
    materia: "Geografia – Os processos sociais e culturais e suas expressões territoriais: atividades econômicas e dinâmicas populacionais",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Leia o texto a seguir.\nA ocorrência de verminoses, como as causadas por platelmintos parasitas, está relacionada a situações socioeconômicas desfavoráveis. Frequentemente essas doenças afetam pessoas que vivem em condições precárias de habitação, saneamento e de maus hábitos de higiene.\nAdaptado de LINHARES, S.; GEWANDSZNAJDER, F. Biologia hoje. São Paulo: Ática. 2. ed. 2013, p. 132. v.2.\nCom base nos conhecimentos sobre teníase, assinale a alternativa correta.",
      subItens: []
    },
    options: ["Uma característica da Taenia é a presença de tubo digestório, uma vez que esses parasitas precisam digerir o alimento retirado do intestino do hospedeiro.","O hospedeiro intermediário da Taenia solium é o boi e o da Taenia saginata é o porco e, em ambos os casos, a tênia adulta vive presa à parede do intestino grosso desses animais, de onde são eliminados os ovos produzidos por reprodução sexuada.","Uma parte importante do ciclo da teníase é quando as fezes do porco ou do boi, contaminadas por cisticercos, acidentalmente caem na água e são ingeridas pelos humanos.","O ser humano contamina-se ao ingerir carne crua ou mal cozida que contém cisticercos, os quais, no intestino delgado, sofrem algumas alterações e prendem-se à mucosa intestinal através do escólex.","A teníase, quando comparada com a cisticercose humana, é a forma mais grave da parasitose, porque neste caso, o ser humano fica por muito tempo liberando ovos de Taenia saginata no ambiente, podendo contaminar outras pessoas."],
    correctAnswer: 3,
    materia: "Biologia – Diversidade dos seres vivos",
    conteudo: "Biologia – Ecologia: Desequilíbrios ambientais (poluição)",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "O infográfico a seguir apresenta dados referentes ao saneamento básico nos quesitos coleta e tratamento de esgotos nas macrorregiões brasileiras.\n[Infográfico: PANORAMA GERAL DA COLETA E TRATAMENTO DE ESGOTOS, mostrando porcentagens para as regiões brasileiras e total, com \"atendimento adequado\" e \"precário ou sem atendimento\"]\nAdaptado de Atlas esgotos: despoluição de bacias hidrográficas. Brasília: ANA, Agência Nacional de Águas, Secretaria Nacional de Saneamento Ambiental, 2017, p. 41.\nCom base nos dados do infográfico, nos conhecimentos sobre as desigualdades regionais e a deficiência de infraestrutura urbana, assinale a alternativa correta.",
      subItens: []
    },
    options: ["As regiões Sul e Nordeste possuem uma cobertura de esgotamento (coletado e tratado) que atinge 87% das pessoas demonstrando a redução das desigualdades inter-regionais da infraestrutura urbana.","O esgoto coletado e tratado, juntamente com os da solução individual, nas regiões Norte (63%) e Nordeste (52%), demonstram que a existência dos rios de grande volume de água serve para diluir os esgotos, diminuindo o impacto nos canais, nos rios urbanos e na saúde da população.","A modernização do território nacional e o padrão de desenvolvimento econômico concentrador contribuem para a baixíssima remoção de carga orgânica advinda do tratamento do esgoto doméstico com atendimento adequado presente nas regiões Sudeste e Centro-Oeste, correspondendo a 33% e 48%, respectivamente.","O panorama geral da coleta e do tratamento de esgotos das macrorregiões brasileiras indica que 57% da população nacional convive com uma paisagem urbana com esgotos a céu aberto e despejado nos córregos e nos rios.","O atendimento precário ou inexistente de coleta e tratamento de esgoto ocorre de forma heterogênea, no território inter-regional, afetando 43% da população brasileira."],
    correctAnswer: 4,
    materia: "Geografia – A apropriação e exploração dos diferentes elementos da natureza, a partir de conceitos básicos relativos: à dinâmica das bacias hidrográficas e sua utilização",
    conteudo: "Geografia – impactos ambientais e suas implicações no mundo moderno",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A contaminação de ecossistemas em função do crescimento populacional e da industrialização tem sido cada vez maior ao longo dos anos, mesmo com o advento de tecnologias voltadas à descontaminação ambiental. Um dos efeitos deletérios ao ambiente é a elevada acidez da chuva e de solos. A figura a seguir mostra o efeito que a acidez do solo causa na velocidade de lixiviação de íons Cd_{2}+.\n[Gráfico: Velocidade de lixiviação (u.a.) vs. pH da água do solo, com curvas para Solos urbanos e Solos agrícolas]\nDados: Kps para Cd(OH)2(s) = 2,5 x 10⁻¹⁴\nQuanto maior a velocidade de lixiviação, maior o transporte de Cd²⁺ para os lagos por meio da corrente superficial ou subsuperficial, transferido para os aquíferos ou absorvido pela vegetação, com efeitos tóxicos.\nCom base na figura e nos conhecimentos sobre solubilidade de metais e equilíbrio químico, é correto afirmar que a lixiviação de cádmio",
      subItens: []
    },
    options: ["em solos agrícolas é menor porque a concentração de íons H⁺ na água do solo é maior se comparada à água do solo urbano.","em solos urbanos é maior porque o solo retém mais cádmio na forma de Cd²⁺ e porque a concentração de H⁺ na água do solo é baixa se comparada ao solo agrícola.","em solos urbanos é maior porque a concentração de cádmio na forma Cd²⁺ na água do solo é elevada se comparada ao solo agrícola.","em solos agrícolas é menor porque usualmente esses solos são tratados com ureia (fertilizante com caráter básico), o que pode reduzir o pH da água do solo e, por consequência, tornar os íons Cd²⁺ mais móveis na água do solo.","em solos agrícolas é menor porque usualmente esses solos são tratados com CaCO₃, o que pode elevar o pH da água do solo e, por consequência, precipitar os íons Cd²⁺ na forma de Cd(OH)₂(s), tornando-os menos móveis."],
    correctAnswer: 4,
    materia: "Química – Equilíbrio Químico: aspectos gerais",
    conteudo: "Química – Sistemas Heterogêneos",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A crescente contaminação ambiental pelas indústrias tem sido combatida com o desenvolvimento de novas técnicas de tratamento de efluentes tóxicos. O processo Fenton, conforme reação 1 a seguir, é um dos procedimentos utilizados no tratamento de efluentes orgânicos.\nReação 1: Fe²⁺(aq) + H_{2}O_{2}(aq) → Fe³⁺(aq) + OH⁻(aq) + OH• (aq) k = 76 (mol L⁻¹)⁻¹ s⁻¹\nNa reação 1, há a formação de OH• (radical hidroxila) com potencial oxidante superior ao H_{2}O_{2}. Assim, a eficiência deste processo se dá pela produção de OH•, capaz de oxidar uma ampla variedade de compostos orgânicos gerando CO_{2}, H_{2}O e íons inorgânicos provenientes de heteroátomos. Além da reação 1, é possível ocorrer a reação 2, em que há a formação de HO_{2}⁻, que, por sua vez, é um oxidante menos reativo que o OH•, diminuindo assim a eficiência do processo Fenton.\nReação 2: H_{2}O_{2}(aq) + OH⁻ (aq) → HO_{2}⁻(aq) + H_{2}O(l) k = 2,7 x 10⁷ (mol L⁻¹)⁻¹ s⁻¹\nConsiderando as reações químicas envolvidas e os fatores que podem influenciar na eficiência do processo e com base nos conhecimentos sobre equilíbrio químico cinética química e eletroquímica, assinale a alternativa correta.",
      subItens: []
    },
    options: ["Na Reação 1, Fe²⁺ é o agente oxidante e H2O2 é o agente redutor.","A eficiência do processo Fenton é maior em meio básico (alcalino).","O excesso de H2O2 em relação a Fe²⁺ diminui a eficiência do processo Fenton.","Sendo a Reação 1 de segunda ordem, e a concentração de Fe²⁺ e de H2O2 iguais a 2,0 mol L⁻¹, a velocidade será de 504 mol L⁻¹ s⁻¹.","A molecularidade de cada uma das equações químicas, reações 1 e 2, é 4."],
    correctAnswer: 2,
    materia: "Química – Equilíbrio químico: aspectos gerais",
