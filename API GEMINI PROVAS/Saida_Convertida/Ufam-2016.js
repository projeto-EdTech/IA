...
createQuestion({
    ...
    options: ["\"Chovem propagandas de produtos comerciais\" Oração sem sujeito, pois o verbo expressa um fenômeno da natureza","\"Passam um filme certamente desinteressante\" Sujeito indeterminado, pois o verbo na 3ª pessoa do plural torna desconhecida a identidade de quem praticou a ação","\"lembra?\" Sujeito implícito, mas facilmente identificável pela forma verbal","\"É tarde no planeta\" Oração sem sujeito, pois o verbo ser está empregado no sentido de tempo","\"E as pessoas tão inconscientes ouvindo uma musiquinha\" Sujeito simples, pois possui apenas um núcleo"],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Sintaxe (Sujeito)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["carnaval","irresponsabilidade","escandinavo","indecência","tropical"],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Assinale a frase em que o pronome pessoal está empregado corretamente:",
      subItens: []
    },
    options: ["Entre eu e tu, não existe mais a antiga e sólida amizade.","Os problemas surgidos na empresa têm de ser resolvidos por eu e você.","Quando tornei a si, não percebi de imediato onde estava.","A palestra de abertura do ano letivo era para mim proferir.","Para mim, entrar num elevador é um martírio, pois sofro de claustrofobia."],
    correctAnswer: 4,
    materia: "Língua Portuguesa – Morfologia (Pronomes)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Leia o texto abaixo, extraído e adaptado do livro \"Amazônia de Euclides\", do jornalista Daniel Piza, para responder às questões 06 e 07, que a ele se referem:\nEuclides da Cunha ansiava pela Amazônia e, mais especificamente, pelo Acre. Recordemos que o novo território era boliviano até poucos anos antes. Leitor apaixonado de naturalistas e viajantes, Euclides escreveu ao amigo amazonense José Veríssimo, grande crítico literário da época, que uma viagem para a região seria um meio de ampliar a vida ao analisar a natureza. Saber que o barão do Rio Branco, ministro das Relações Exteriores, organizava novas comissões demarcadoras dos limites brasileiros animara o autor de \"Os Sertões\", que trabalhava então como engenheiro em obras de saneamento no litoral de São Paulo.\nO seu desejo pelo majestoso sertão amazônico combinava uma vontade de fuga, uma vocação de desbravador e um desejo de não ficar paralizado. E remetia diretamente à experiência de Canudos, no sertão baiano, em 1897, quando marchou desorientado para a frente de batalha e viu o inferno de uma guerra. Viu não como mero espectador, mas como alguém que sentiu os problemas em seu íntimo, sem jamais os extravasar, como seria necessário.\nAssinale a opção que apresenta predicado verbo-nominal:",
      subItens: []
    },
    options: ["que trabalhava como engenheiro em obras de saneamento","o novo território era boliviano","quando marchou desorientado para a frente de batalha","alguém que sentiu os problemas em seu íntimo","Euclides escreveu ao amigo amazonense José Veríssimo"],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Sintaxe (Tipos de Predicado)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Uma das afirmativas abaixo, feitas a respeito da formação e difusão da língua portuguesa, bem como da incorporação de palavras de origem indígena e africana ao seu vocabulário, NÃO está correta. Assinale-a:",
      subItens: []
    },
    options: ["A língua portuguesa é um dos resultados do latim, idioma que foi levado à Península Ibérica pelo Império Romano.","A presença de palavras indígenas no português se deve aos jesuítas, que procuraram criar uma síntese entre o tupi e o nosso idioma.","Foi Portugal, entre os séculos 15 e 16, no ciclo das grandes navegações, quem difundiu a língua portuguesa em várias partes do mundo.","\"Abacaxi”, “bauru” e “curumim” são palavras que, dadas como de origem indígena, se incorporaram ao português do Brasil.","A aquisição de palavras como “jiló” e “dendê” se deu graças à presença da mão de obra africana em terras brasileiras."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Leia os versos abaixo, de autoria de Tomás Antônio Gonzaga:\nEu, Marília, não sou algum vaqueiro,\nQue viva de guardar alheio gado,\nDe tosco trato, de expressões grosseiro,\nDos frios gelos e dos sóis queimado.\nTenho próprio casal e nele assisto:\nDá-me vinho, legume, fruta, azeite;\nDas brancas ovelhinhas tiro o leite\nE mais as finas lãs, de que me visto.\nGraças, Marília bela,\nGraças à minha estrela!\nAssinale a alternativa que contém um verso decassílabo sáfico:",
      subItens: []
    },
    options: ["\"Das brancas ovelhinhas tiro o leite\"","\"Eu, Marília, não sou algum vaqueiro\"","\"De tosco trato, de expressões grosseiro\"","\"Dá-me vinho, legume, fruta, azeite\"","\"E mais as finas lãs, de que me visto\""],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Literatura (Arcadismo, Versificação)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Dentre as alternativas abaixo, assinale aquela que apresenta uma narração e, por isso, exemplifica o gênero épico:",
      subItens: []
    },
    options: ["Faz a imaginação de um bem amado, Que nele se transforme o peito amante; Daqui vem, que a minha alma delirante Se não distingue já do meu cuidado.","Anjo no nome, Angélica na cara! Isso é ser flor, e anjo juntamente: Ser angélica flor e anjo florente, Em quem, senão em vós, se uniformara?","Este lugar delicioso e triste, Cansada de viver, tinha escolhido Para morrer a mísera Lindoia. Lá, reclinada, como que dormia, Na branda relva, e nas mimosas flores, Tinha a face na mão e a mão no tronco De um fúnebre cipreste, que espalhava Melancólica sombra.","Ó que pão, ó que comida, Ó que divino manjar, Se nos dá no santo altar Cada dia! Filho da Virgem Maria, Que Deus-Padre cá mandou","Eu sou aquele que os passados anos Cantei na minha lira maldizente Torpezas do Brasil, vícios e enganos. E bem que os descantei bastantemente, Canto segunda vez na mesma lira O mesmo assunto em plectro diferente."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Literatura (Gêneros Literários - Épico)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Leia o poema \"Buscando a Cristo\", de Gregório de Matos:\nA vós, correndo vou, Braços sagrados,\nNessa Cruz sacrossanta descobertos;\nQue, para receber-me, estais abertos\nE, por não castigar-me, estais cravados.\nA vós, divinos Olhos, eclipsados,\nDe tanto sangue e lágrimas cobertos,\nPois, para perdoar-me, estais despertos\nE, por não condenar-me, estais fechados.\nA Vós, pregados Pés por não deixar-me;\nA Vós, Sangue vertido para ungir-me;\nA Vós, Cabeça baixa por chamar-me;\nA Vós, Lado patente, quero unir-me;\nA Vós, Cravos preciosos, quero atar-me;\nPara ficar unido, atado e firme.\nAssinale a alternativa INCORRETA:",
      subItens: []
    },
    options: ["O último verso exemplifica o desejo de união espiritual com Cristo, ou seja, da manifestação do desejo humano de ligar-se a Deus.","O poema apresenta, de acordo com o estilo barroco, situações ambivalentes, o que se observa em relação aos braços e aos pés de Cristo.","O sangue vertido adquire sentido simbólico, pois é através dele que o pecador será salvo.","O texto é feito basicamente de metonímias, o que permite ao eu lírico não mencionar o nome de Cristo, deixando implícita, no entanto, a sua presença.","O soneto é feito em versos decassílabos heroicos, com o seguinte esquema de rimas: ABBA / ABBA / CDC / DCD."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Literatura (Barroco, Gregório de Matos)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Assinale a alternativa correta sobre Manuel Botelho de Oliveira:",
      subItens: []
    },
    options: ["\"Música do Parnaso\", seu principal livro, é um poema camoniano que busca louvar Jorge de Albuquerque Coelho, donatário da capitania de Pernambuco.","Escreveu o documento mais representativo do período de informação, no caso, os “Diálogos das grandezas do Brasil\".","É autor de “À Ilha de Maré”, poemeto em que descreve, pela primeira vez, a natureza tropical, com suas frutas, peixes e legumes.","Integra, junto com José de Anchieta, a chamada literatura jesuítica, tendo escrito o \"Diálogo sobre a conversão do gentio\".","Sua principal obra trata da guerra que portugueses e espanhóis moveram contra índios e jesuítas em Sete Povos das Missões do Uraguai."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Literatura (Barroco, Manuel Botelho de Oliveira)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "\"No antigo Oriente existiram, certamente, um ordenamento e uma atividade políticos. Sem eles não teria sido possível o desenvolvimento da cultura, já que esta deve ter como sujeito histórico uma sociedade politicamente organizada. Mas não é menos certo que a política não formava uma realidade clara e distinta, isto é, não estava rigorosamente delimitada diante de outras realidades nem era concebida como se estivesse. Só com os gregos começou-se a percebê-la como realidade autônoma, e só no mundo moderno e por obra da cultura ocidental se levará a cabo sua radical secularização: em todas as culturas restantes a política, a religião e, em geral, os empreendimentos econômicos aparecem como três dimensões de uma mesma realidade.\"\nO texto de García Pelayo enfatiza que, ao longo de toda a história do antigo Oriente Próximo, política e religião andaram de mãos dadas. No entanto, a ideologia político-religiosa de Israel representa uma exceção devido à sua dificuldade em assimilar a própria instituição monárquica e sua radical separação entre a divindade e os demais planos da realidade. Acerca da história hebraica, podemos afirmar que:",
      subItens: []
    },
    options: ["No centro das concepções político-religiosas israelitas estavam as noções de escolha e aliança: o povo de Israel fora escolhido por Iawch, que com ele pactuara uma aliança.","A evolução em direção a um verdadeiro Estado de Israel ocorreu devido a ameaça crescente representada pelos cassitas, que repelidos no Egito, instalaram-se na Palestina, formando uma federação de cidades-Estados.","A religião hebraica estava firmemente ancorada na noção de continuidade e homogeneidade entre as esferas do humano, do natural e do divino.","Após o Êxodo e o retorno à Palestina, as tribos hebraicas foram conduzidas pelos Patriarcas, que possuíam atribuições políticas, civis, religiosas e judiciárias.","Após a união do sul e do norte do território dos israelitas, Davi se tornou o primeiro rei, consolidando assim uma monarquia teocrática e garantindo um Estado de porte médio, suficientemente forte para enfrentar a expansão dos povos vizinhos à Palestina."],
    correctAnswer: 0,
    materia: "História – Antiguidade Oriental (Israel/Hebreus)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Péricles","Sólon","Psístrato","Temístocles","Clístenes"],
    correctAnswer: 1,
    materia: "História – Grécia Antiga (Sólon, Reformas)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: null,
    materia: "História – Império Bizantino (Constantinopla/Istambul)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Somente as afirmativas I, II e III estão corretas","Somente as afirmativas II, III e IV estão corretas","Somente as afirmativas III, IV e V estão corretas","Todas as afirmativas estão corretas","Todas as afirmativas estão erradas"],
    correctAnswer: 3,
    materia: "Arte – Arquitetura Medieval",
    conteudo: "História – Idade Média (Arte Românica e Gótica)",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Com relação aos solos eluviais, é correto afirmar que:",
      subItens: []
    },
    options: ["São formados em depósitos aluviais recentes.","São típicos das planícies fluviais.","Formam-se no próprio local onde a rocha matriz se decompôs.","Sofrem a sedimentação e o transporte fluvial ou eólico para ser formado.","São constituídos por material decomposto, encontrado no sopé de encostas, transportado por gravidade."],
    correctAnswer: 2,
    materia: "Geografia – Pedologia (Tipos de Solo)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Uma pessoa está numa cidade A, de longitude 30° leste, e faz um telefonema às 10 horas para seu amigo que mora na cidade B, situada a 30° oeste. A que horas a pessoa que mora na cidade B atendeu a ligação telefônica?",
      subItens: []
    },
    options: ["2 horas","6 horas","9 horas","16 horas","21 horas"],
    correctAnswer: 1,
    materia: "Geografia – Cartografia (Fusos Horários)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Observe a figura a seguir:\nCom base na figura e em seus conhecimentos sobre os principais biomas do mundo, a paisagem pertence ao bioma:",
      subItens: []
    },
    options: ["Estepe","Taiga","Savana","Pradaria","Floresta tropical decídua"],
    correctAnswer: 2,
    materia: "Geografia – Biomas (Savana)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: null,
    materia: "Geografia – Geotecnologias (GPS)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "A imagem apresentada a seguir retrata uma cena recorrente no Brasil. Sobre a ocorrência deste problema é INCORRETO afirmar que:",
      subItens: []
    },
    options: ["Os movimentos de massa devem ser analisados considerando-se basicamente dois fatores: o material movimentado e a velocidade do movimento, que pode atingir desde alguns centímetros até 5 km/hora.","Este tipo de desastre é recorrente nas regiões metropolitanas, onde é comum a ocupação de morros para a moradia de populações de baixa renda, que se torna a mais atingida pelos movimentos de massa.","A Defesa Civil pode fazer esclarecimentos para impedir novas ocupações em áreas de encostas e monitorar os índices pluviométricos locais para a prevenção de acidentes.","Geralmente, ocorrem em vertentes e encostas, que apresentam declives não acentuados, tipicamente nas zonas constituídas por latossolos de regiões serranas situadas no Sudeste do Brasil.","Uma grande parte destes movimentos está associada à ação antrópica, em atividades como desmatamento e regiões de depósitos de lixo."],
    correctAnswer: 3,
    materia: "Geografia – Geomorfologia (Movimentos de Massa, Desastres Naturais)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: "Geografia – Climatologia Urbana (Ilhas de Calor)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Um professor de Biologia levou seus alunos ao laboratório, para o desenvolvimento de uma atividade sobre osmose. Sobre a bancada, havia três frascos, cada um contendo uma solução salina de concentração diferente. Cada frasco (01, 02 e 03) recebeu um fragmento de tecido vegetal e após alguns minutos, o fragmento de tecido foi observado ao microscópio, onde os alunos puderam observar o resultado a seguir:\n• Frasco 01: as células apresentaram-se túrgidas\n• Frasco 02: as células apresentaram-se plasmolisadas\n• Frasco 03: as células apresentaram-se inalteradas\nCom base no resultado observado, assinale a alternativa CORRETA:",
      subItens: []
    },
    options: ["As soluções dos frascos 01 e 02 são hipotônica e hipertônica, respectivamente, em relação ao meio intracelular.","As soluções dos frascos 02 e 03 são hipotônica e isotônica, respectivamente, em relação ao meio intracelular.","As soluções dos frascos 01 e 03 são hipertônica e isotônica, respectivamente, em relação ao meio intracelular.","As soluções dos frascos 01 e 02 são hipertônica e hipotônica, respectivamente, em relação ao meio intracelular.","As soluções dos frascos 02 e 03 são hipotônica e hipertônica, respectivamente, em relação ao meio intracelular."],
    correctAnswer: 0,
    materia: "Biologia – Citologia (Osmose)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "A multicelularidade adquire sua maior expressão nos animais, onde ocorre a associação de células em tecidos. Esses, por sua vez, definem a formação de órgãos especializados e funcionalmente integrados. Analise as seguintes informações sobre os tecidos animais:\nI. O tecido epitelial é encontrado, dentre outros locais: na camada superficial da pele, na mucosa do intestino e nas glândulas salivares.\nII. As células mais comuns e abundantes do tecido conjuntivo propriamente dito são os fibroblastos, cuja principal função é a síntese dos componentes proteicos e a manutenção da matriz extracelular.\nIII. O tecido sanguíneo é constituído pela fração líquida (plasma), pelas células (hemácias e leucocitos) e pelas plaquetas, sendo essas últimas, responsáveis pela defesa do organismo contra alérgenos.\nIV. As células musculares são células muito longas (no músculo esquelético e no músculo liso) ou fusiformes (no músculo cardíaco), apresentando a capacidade de contração graças à ação conjunta de proteínas especializadas.\nV. As células nervosas apresentam-se morfologicamente muito diversificadas. No entanto, apresentam partes reconhecíveis e diferenciáveis, que compreendem: dendritos, corpo celular e axônio. Nesse último, está localizado o núcleo das células.\nAssinale a alternativa correta:",
      subItens: []
    },
    options: ["Somente as afirmativas I e II estão corretas.","Somente as afirmativas I e V estão corretas.","Somente as afirmativas II e III estão corretas.","Somente as afirmativas III e IV estão corretas.","Somente as afirmativas IV e V estão corretas."],
    correctAnswer: 0,
    materia: "Biologia – Histologia Animal (Tecidos)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "A figura a seguir ilustra duas células diferentes. Observe-as com atenção e analise as afirmações:\nFonte: http://educador.brasilescola.com. Acesso em 11-08-2014.\nI. A célula (a) é uma célula vegetal, porque apresenta, diferentemente da célula (β), parede celular, cloroplastos e ribossomos.\nII. A célula (a) é uma célula procariótica, enquanto a célula (ẞ) é uma célula eucariótica.\nIII. A célula (a) é uma célula heterotrófica, enquanto a célula (ẞ) é uma célula autotrófica.\nAssinale a alternativa correta:",
      subItens: []
    },
    options: ["Somente as afirmativas I e Il estão corretas.","Somente as afirmativas I e III estão corretas.","Somente as afirmativas II e III estão corretas.","Todas as afirmativas estão corretas.","Todas as afirmativas estão incorretas."],
    correctAnswer: 4,
    materia: "Biologia – Citologia (Tipos de Células: Procarióticas, Eucarióticas, Vegetal, Animal)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "A Biologia é uma ciência que busca explicações para os fenômenos da natureza, estabelecendo relações entre os fatos observados. O cientista é o indivíduo que busca sistematicamente, a aquisição de mais conhecimento através da investigação científica. Sobre a investigação científica, é INCORRETO afirmar que:",
      subItens: []
    },
    options: ["A partir da observação, o pesquisador buscará respostas a perguntas, como por exemplo: \"Por quê ocorre?\" ou \"Como ocorre?\" ou \"Qual a relação entre essa e aquela ocorrência?\". A curiosidade move o cientista na busca de respostas.","Para tentar responder aos questionamentos, o pesquisador traçará algumas respostas, as quais são chamadas, no conjunto, de hipóteses. As hipóteses são baseadas no conhecimento já adquirido e devem ser passíveis de teste.","As deduções preveem o que pode acontecer se a hipótese estiver correta. Assim, testes experimentais e/ou novas observações são feitas para testar as hipóteses e averiguar se as deduções podem ser confirmadas ou refutadas.","Teoria é um conjunto de conhecimentos que visam explicar e interpretar fenômenos abrangentes da natureza.","Hipóteses podem ser confirmadas ou refutadas por meio de testes experimentais. A confiabilidade dos resultados obtidos tanto é maior quanto menores forem as repetições aplicadas aos testes."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Em abril de 1953, James Watson e Francis Crick agitaram a comunidade científica com um elegante modelo de dupla-hélice para a estrutura do DNA, o ácido desoxirribonucléico, cuja “linguagem” química codifica a informação hereditária. Sobre o DNA, assinale a alternativa CORRETA:",
      subItens: []
    },
    options: ["Uma fita de DNA em dupla hélice apresenta 10% de bases do tipo citosina. Logo, a concentração de bases do tipo guanina é de 90%.","A replicação de DNA ocorre conforme o modelo conservativo, onde as duas fitas parentais se associam novamente após servirem de moldes para a síntese das novas fitas, restaurando a dupla-hélice parental.","Uma fita de DNA em dupla hélice apresenta 10% de bases do tipo adenina. Logo, a concentração de bases do tipo guanina nessa fita é de 40%.","A sequência de bases no DNA é a “linguagem\" química que, após transcrita, originará a sequência de nucleotídeos em uma proteína.","A complementaridade de bases no DNA permite que uma base purínica (C ou G) de uma fita seja pareada com uma base pirimidínica (A e T) na outra fita."],
    correctAnswer: 2,
    materia: "Biologia – Genética Molecular (Estrutura do DNA)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: "Química – Tabela Periódica (Propriedades Periódicas, Energia de Ionização)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: "Química – Ligações Químicas (Geometria Molecular, Polaridade)",
    conteudo: "Química – Química Ambiental (Efeito Estufa)",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Grande parte dos elementos químicos ocorre na natureza como mistura de isótopos. Sabendo que um elemento hipotético X possui massa atômica igual a 69,8u e dois isótopos com as características descritas no quadro a seguir:\nIsotopo | Massa (u)\n69X | 69\n71X | 71\nAs abundâncias relativas dos isótopos 69X e 71x, são respectivamente:",
      subItens: []
    },
    options: ["35% e 75%","45% e 65%","50% e 50%","60% e 40%","70% e 30%"],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "O sulfato de alumínio $Al_{2}$($SO_{4}$)3 é um produto químico amplamente utilizado na indústria de papel e nas estações de tratamento de água. O $Al_{2}$($SO_{4}$)3 pode ser produzido reagindo bauxita, rica em Al2O3 com ácido sulfúrico H2SO4, de acordo com a reação não balanceada:\nAl2O3 + H2SO4 → $Al_{2}$($SO_{4}$)3 + H2O\nPartindo-se de 306g de Al2O3 e quantidade de H2SO4 suficiente, a quantidade máxima de $Al_{2}$($SO_{4}$)3 formada é:",
      subItens: []
    },
    options: ["536g","684g","898g","1026g","1280g"],
    correctAnswer: 3,
    materia: "Química – Estequiometria (Balanceamento, Rendimento de Reação)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: "Física – Dinâmica (Lançamento Oblíquo)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Analise as afirmativas:\nI. O centro de massa de um corpo nem sempre coincide com seu centro geométrico (ou centroide), mas deve necessariamente estar dentro do corpo.\nII. O movimento do centro de massa de um corpo somente se altera se houver força externa resultante agindo sobre este.\nIII. Ao saltar com um braço erguido, um jogador de vôlei atinge uma altura maior do que com os dois braços erguidos porque, nas duas situações, seu centro de massa deve atingir a mesma altura máxima.\nIV. Nos locais onde o campo gravitacional é constante, o centro de gravidade de um corpo coincide com seu centro de massa.\nAssinale a alternativa correta:",
      subItens: []
    },
    options: ["Somente as afirmativas I, II e III estão corretas.","Somente as afirmativas I, II e IV estão corretas","Somente as afirmativas I, III e IV estão corretas.","Somente as afirmativas II e III estão corretas.","Somente as afirmativas II, III e IV estão corretas"],
    correctAnswer: 4,
    materia: "Física – Estática (Centro de Massa, Centro de Gravidade)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "O princípio físico que se aplica, por exemplo, aos elevadores hidráulicos dos postos de gasolina e ao sistema de freios e amortecedores dos veículos automotores, deve-se ao físico e matemático francês Blaise Pascal (1623-1662). No caso dos veículos automotores, os freios constituem um importante item de segurança, pois seu mau funcionamento, geralmente por falta de manutenção adequada, pode acarretar acidentes graves. Considere as seguintes afirmativas:\nI. Os sistemas hidráulicos baseiam-se no fato de os líquidos serem praticamente incompressíveis. Uma pressão aplicada em qualquer ponto de um líquido contido num recipiente fechado transmite-se integralmente a todos os pontos desse líquido.\nII. A força exercida pelo motorista no pedal do freio é aplicada ao pistão do cilindro mestre e depois transmitida pelo fluido de freio até aos pistões dos cilindros do freio, onde é novamente multiplicada, em virtude de o diâmetro destes ser superior ao diâmetro do cilindro mestre.\nIII. Se as áreas dos pistões de um elevador hidráulico mantêm a relação 80:1, então é possível equilibrar o peso de um carro pequeno, com uma tonelada de massa, aplicando uma força de 125N no pistão menor.\nAssinale a alternativa correta:",
      subItens: []
    },
    options: ["Somente a afirmativa I está correta.","Somente a afirmativa III está correta.","Somente as afirmativas I e II estão corretas.","Somente as afirmativas I e III estão corretas.","Todas as afirmativas estão corretas."],
    correctAnswer: 4,
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: "Matemática – Funções Exponenciais (Logaritmos, Aplicações)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Uma função quadrática possui a soma e o produto de suas raízes iguais a 5 e -3 respectivamente. A lei que melhor representa esta função é dada por:",
      subItens: []
    },
    options: ["f(x) = x² - 3x-5","f(x) = x² - 5x-3","f(x) = x² + 5x − 3","f(x) = x² + 3x – 5","f(x) = x² + 5x + 3"],
    correctAnswer: 1,
    materia: "Matemática – Funções Quadráticas (Soma e Produto das Raízes)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: "Matemática – Funções Afins (Gráficos)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Uma empresa contratou um empregado para trabalhar de segunda a sexta durante duas semanas. O dono da empresa pagou R$ 1,00 pelo primeiro dia de trabalho e nos dias seguintes o dobro do que ele recebeu no dia anterior. Quanto o empregado recebeu pelos 10 dias que trabalhou?",
      subItens: []
    },
    options: ["R$ 511,00","R$ 660,00","R$ 830,00","R$ 941,00","R$ 1.023,00"],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Em uma fábrica 12 máquinas produziram 120 peças em 4 dias. O tempo necessário para que 8 máquinas iguais às primeiras produzam 300 peças será de:",
      subItens: []
    },
    options: ["8 dias","10 dias","12 dias","14 dias","15 dias"],
    correctAnswer: 4,
    materia: "Matemática – Razão e Proporção (Regra de Três Composta)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: "Matemática – Geometria Plana (Área de Paralelogramo)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Somente as afirmativas II e III são verdadeiras.","Somente as afirmativas II e IV são verdadeiras.","Somente as afirmativas III e V são verdadeiras.","Somente as afirmativas I e V são falsas.","Somente as afirmativas IV e V são falsas."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Seja f: * → ° uma função definida por f(x) = 2x + 4. O valor de f(1)+f(2)+f(3)+L +f(n) é:",
      subItens: []
    },
    options: ["n+n²","n + 2n²","5n+n²","5n-n²","10n + 2n²"],
    correctAnswer: 2,
    materia: "Matemática – Funções (Soma de Séries, PA)",
    conteudo: "",
    imageNames: []
  }),