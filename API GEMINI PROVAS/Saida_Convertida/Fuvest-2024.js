...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "Em 2023, a imprensa mundial anunciou a criação da almôndega de carne de mamute. A ilustração a seguir resume a biotecnologia envolvida nesse processo.\n\nImagem: Fluxograma \"Como a almôndega de mamute foi criada?\".\$1_{1}$. O gene que codifica a mioglobina do mamute é sequenciado. A mioglobina é uma proteína da célula muscular que confere sabor característico à carne.\$1_{2}$. As partes não recuperadas do gene da mioglobina do mamute foram completadas com a sequência do gene da mioglobina do elefante.\$1_{3}$. A sequência do gene da mioglobina é inserida em uma célula-tronco de ovelha.\$1_{4}$. As células se multiplicam em laboratório até chegarem ao número suficiente para a produção da almôndega.\nDisponível em https://www.dailymail.co.uk/. Adaptado.\n\nA almôndega de mamute possui células",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "O gráfico apresentado mostra as concentrações atmosféricas dos principais gases de efeito estufa até o ano 2000, sendo eles: $1_{2}$, quantificado em partes por milhão (ppm), $1_{2}O_{}$ e $1_{4}$, ambos quantificados em partes por bilhão (ppb). Em junho de 2022, a Administração Nacional Oceânica e Atmosférica (NOAA) reportou que, naquela data, os níveis de $1_{2}$ na atmosfera encontravam-se em torno de 420 ppm. Esse valor é muito superior à concentração média de aproximadamente 280 ppm, existente antes da Revolução Industrial. Com base nessas informações e em seus conhecimentos, é correto afirmar:\n\nGráfico: Concentrações de $1_{2}$ (ppm), $1_{2}O_{}$ (ppb) e $1_{4}$ (ppb) ao longo dos anos, de 0 a 2000. Mostra um aumento significativo de $1_{2}$, $1_{4}$ e $1_{2}O_{}$ a partir da Revolução Industrial.\n\nIPCC 4th Report Main Findings. Disponível em: https://www.inforse.org/. Adaptado.",
      subItens: []
    },
    options: ["Apesar do grande aumento nas quantidades dos três principais gases de efeito estufa a partir da Revolução Industrial, seus níveis passaram a estabilizar por volta do ano 2000.","A mecanização resultante da Revolução Industrial, iniciada no século XVIII, causou grandes mudanças nos meios de produção, com a utilização de energias renováveis.","O plantio de árvores em grande escala acentua o aquecimento global, devido à liberação de gases do efeito estufa na atmosfera.","O aquecimento global é um fenômeno recente, já que a Terra teve um clima com temperaturas constantes durante sua existência.","O efeito estufa é um fenômeno intensificado a partir da Revolução Industrial, devido às atividades humanas emissoras de $1_{2}$, que contribuem para o aquecimento global."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "A foto a seguir mostra um circuito com três resistores ($1_{1}_{}$, $1_{2}_{}$ e $1_{3}_{}$) conectados em uma protoboard (base de contatos). Nesse tipo de placa, os cinco furos de uma mesma linha (indicados pelos retângulos amarelos) estão em curto, formando os nós do circuito. Os cabos vermelho e preto, por sua vez, estão conectados aos terminais de uma fonte contínua de 5V.\n\nImagem: Foto de um circuito em protoboard com três resistores ($1_{1}_{}$, $1_{2}_{}$, $1_{3}_{}$) e uma fonte de 5V. Os retângulos amarelos destacam as linhas em curto na protoboard, mostrando que $1_{2}_{}$ e $1_{3}_{}$ estão em paralelo e o conjunto em série com $1_{1}_{}$.\n\nSe $1_{1}_{}$ = 150 kΩ e $1_{2}_{}$ = $1_{3}_{}$ = 100 kΩ, a corrente elétrica que passa pelo resistor $1_{1}_{}$ será de:",
      subItens: []
    },
