...
createQuestion({
    ...
    options: ["a crítica às reações da nossa sociedade frente aos problemas que ficaram no passado.","as justificativas para a segregação social no mundo contemporâneo.","as tensões sociais presentes há tempos, sob a luz dos embates do momento atual.","a importância de contornar os problemas sociais do passado.","as peculiaridades das diferentes classes sociais ao enfrentar os problemas sociais atuais."],
    correctAnswer: 2,
    materia: "Literatura Brasileira – Poesia Contemporânea",
    conteudo: "Linguagens – Análise de Texto",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["prontidão.","esperteza.","valorização.","apelo.","experimento."],
    correctAnswer: 2,
    materia: "Língua Inglesa – Vocabulário",
    conteudo: "Língua Inglesa – Compreensão de Texto",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["a mão de obra de escravizados de origem africana e indígena era empregada nos canaviais, na pecuária e na lavoura de subsistência.","a distribuição de terras baseava-se na concessão, pela Coroa portuguesa, de privilégios e pequenos lotes a donatários.","os privilégios concentravam-se nas mãos dos senhores de engenho, em detrimento da população escravizada ou livre e pobre.","o desenvolvimento de relações socioeconômicas fundadas na horizontalidade recebia estímulos governamentais.","o modo de produção feudal prevaleceu na exploração agrícola pela metrópole."],
    correctAnswer: 2,
...
createQuestion({
    ...
    options: ["endossa a defesa, pelos setores políticos liberais, do emprego de trabalhadores brancos, representados nas laterais do monumento.","critica a concepção de independência manifesta na estátua equestre de Pedro I e a defesa da extinção do tráfico de escravizados.","expõe a contradição entre a liberdade expressa na estátua equestre de Pedro I e as mazelas enfrentadas pelos escravizados.","defende a manutenção da escravidão, em oposição à exploração do trabalho compulsório de indígenas e de imigrantes europeus.","expressa a indignação dos proprietários rurais, grupo social hegemônico, diante da redução gradual do trabalho escravo."],
    correctAnswer: 2,
    materia: "História – Segundo Reinado",
    conteudo: "História – Abolicionismo",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["o regime de apartheid em vigor na África do Sul na época em que o romance se passa, que mantinha alunos e professores negros fora da universidade.","a segregação formal das mulheres no acesso à educação, conforme estabelecido pela Constituição promulgada no pós-apartheid.","as eficazes estratégias de apoio aos estudantes pobres para assegurar a boa qualidade da educação básica e superior na época do apartheid.","as incertezas sobre as estratégias adotadas para enfrentar desigualdades sociais e educacionais legadas pelo regime do apartheid na África do Sul.","o reconhecimento consensual do sucesso do projeto de inclusão educacional no cenário sul-africano pós-apartheid."],
    correctAnswer: 3,
    materia: "História – Apartheid",
    conteudo: "Geografia Humana – Desigualdades Socioeconômicas",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["é privilégio de minorias, pois são bens que exigem reflexão.","deve ser reivindicado como um direito, e não como um privilégio.","vitimiza as pessoas que não têm acesso a bens fundamentais para viver.","humaniza as minorias privilegiadas, incentivando-as a compartilhar seu conhecimento.","é indispensável para quem luta pelos direitos humanos."],
    correctAnswer: 1,
    materia: "Sociologia – Direitos Humanos",
    conteudo: "Filosofia – Ética e Moral",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["a manipulação digital das imagens exibidas pelos usuários do TikTok.","o emprego das obras de arte para fins publicitários ilícitos.","a cobrança pelo uso de equipamentos para simular a experiência de imersão nas obras.","a falta de informação para o público leigo nos catálogos das exibições.","o investimento necessário para a criação da tecnologia usada nas instalações."],
    correctAnswer: 2,
    materia: "Língua Inglesa – Compreensão de Texto",
    conteudo: "Arte – Crítica de Arte",
    imageNames: []
...
createQuestion({
    ...
    options: ["autossômica dominante, porque se apresenta somente em mulheres.","autossômica recessiva, sendo todos os homens homozigóticos dominantes.","ligada ao X recessiva, e os filhos homens inativam esse cromossomo.","ligada ao X recessiva, porque aparece em todas as gerações.","ligada ao X dominante, sendo letal para fetos masculinos com o alelo dominante."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["A prosperidade econômica de ambos.","A reconstrução dos laços entre eles.","A ida de Nael a São Paulo para viver com Yaqub.","A morte de Rânia, a irmã dos gêmeos.","A desagregação e a ruína da família."],
    correctAnswer: 4,
    materia: "Literatura Brasileira – Romance Contemporâneo",
    conteudo: "Literatura Brasileira – Milton Hatoum",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Nenhum dos dois irmãos assumiu a paternidade de Nael, nem Nael os reconheceu como pais.","Nael é filho de Rochiram, de quem ganha a casa no fundo do terreno para escrever suas memórias.","Nael gostaria que Yaqub fosse seu pai, pelos projetos e visão de mundo que compartilhava com ele.","A cena final do romance, na qual Omar e Nael se encontram, confirma a paternidade de Omar.","Embora não quisesse ter tido filhos, Halim é o pai de Nael, Omar e Yaqub."],
    correctAnswer: 0,
    materia: "Literatura Brasileira – Romance Contemporâneo",
    conteudo: "Literatura Brasileira – Milton Hatoum",
    imageNames: []
...
createQuestion({
    ...
    options: ["mutações no DNA das células epiteliais, o que pode alterar seu ciclo celular.","alterações no DNA mitocondrial que levam à redução do metabolismo celular.","ativação dos processos de reparo do DNA e bloqueio da diferenciação celular.","aumento da divisão meiótica decorrente do processo de crossing-over.","processos de evolução desencadeados por mutações aleatórias."],
    correctAnswer: 0,
    materia: "Biologia – Citologia",
    conteudo: "Biologia – Divisão Celular",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["com mitocôndrias de elefante.","musculares recriadas de mamute.","que produzem gordura de mamute.","com mais genes de ovelha que de mamute.","de diferentes tecidos do elefante."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["digestão da substância I é feita por amilases presentes no duodeno.","digestão da substância II é feita por lipases presentes da boca.","substância III é um amido digerido por amilases presentes boca.","substância IV é uma proteína digerida pela bile no estômago.","substâncias I, II e III são digeridas, respectivamente, na boca, no estômago e no duodeno."],
    correctAnswer: 2,
    materia: "Biologia – Sistema Digestório",
    conteudo: "Biologia – Enzimas",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["errada, pois pH negativo refere-se à concentração de H+ maior que 1 mol/L, resultando em um valor de pH menor que zero.","correta, pois pH negativo refere-se à concentração de OH- maior que 1 mol/L, resultando em um valor de pH menor que zero.","correta, assim como é possível existir pH maior que 14 em soluções com concentração de H⁺ maior que 14 mol/L.","errada, pois a escala de pH é fixa entre 0 e 14, independentemente da concentração de H+.","correta, pois o pH tende a diminuir e tornar-se negativo em soluções com concentração de íons H+ extremamente baixa."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["conexão com um modelo de saber que justificava a hierarquia social do Antigo Regime.","revelação de que o conhecimento filosófico oferecia as bases políticas para o absolutismo.","valorização do mecenato como forma de proteção aos novos pensadores.","aclamação dos pensadores como defensores da neutralidade científica.","legitimação dos filósofos enquanto portadores de virtudes derivadas do culto do conhecimento empírico."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["Entre os opostos, é possível inferir uma relação principal de complementariedade.","Entre os opostos, é possível inferir uma relação principal de alternância.","Entre os opostos, é possível inferir uma relação principal de exclusão.","Entre os opostos, é possível inferir uma relação principal de anulação.","Entre os opostos, é possível inferir uma relação principal de geração."],
    correctAnswer: 4,
    materia: "Filosofia – Platão",
    conteudo: "Filosofia – Metafísica",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "\"Os experimentos de difração e interferência da luz realizados no período de 1800 a 1803, em analogia com os processos de interferência das ondas acústicas, corroboraram a natureza ondulatória da luz. Por outro lado, Einstein introduziu, em 1905, o conceito de fóton, em que cada componente monocromática de frequência ƒ da radiação seria equivalente a um sistema de partículas idênticas sem massa, cada qual com energia hf, sendo h≈$1 \\\\times 10^{-34}$ J.s a constante de Planck. A hipótese da existência de fótons só teve ampla aceitação após os experimentos de Compton, em 1922, sobre o espalhamento da radiação eletromagnética na faixa dos raios X por alvos de elementos leves, como o grafite.\"\nAdaptado de F. Caruso e V. Oguri, Sobre a necessidade do conceito de fóton, RBEF 43, e_{20210011} (2021).\n\nDe acordo com o texto e seus conhecimentos, é correto afirmar:",
      subItens: []
    },
    options: ["A radiação eletromagnética apresenta somente comportamento ondulatório.","Os experimentos de Compton mostraram que feixes de raios X exibem comportamento corpuscular.","A energia de um fóton independe de seu comprimento de onda.","A hipótese da natureza corpuscular da radiação está em desacordo com os resultados experimentais.","Einstein demonstrou que os experimentos de difração e interferência da luz deveriam estar incorretos."],
    correctAnswer: 1,
    materia: "Física – Física Moderna",
    conteudo: "Física – Dualidade Onda-Partícula",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Na figura (I), a chama é amarela devido à absorção de luz pelos átomos de Na; enquanto, em (II), a chama está preta porque o Na deixa de absorver quando a chama é irradiada pela lâmpada de sódio.","Na figura (I), a chama é amarela porque esta é a cor de qualquer chama; enquanto, em (II), a chama está preta porque o Na absorve a energia da chama.","Na figura (I), a chama é amarela porque esta é a cor de qualquer chama; enquanto, em (II), a chama está preta devido à combustão incompleta.","Na figura (I), a chama é amarela devido à emissão de luz pelos átomos de Na; enquanto, em (II), a chama está preta devido à combustão incompleta.","Na figura (I), a chama é amarela devido à emissão de luz pelos átomos de Na; enquanto, em (II), a chama está preta porque os átomos de Na da chama absorvem a luz proveniente da lâmpada de Na."],
    correctAnswer: 4,
    materia: "Física – Óptica",
    conteudo: "Química – Espectroscopia de Emissão e Absorção",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["a fuligem advinda do processo de combustão incompleta da lenha deposita-se nas paredes e, com o aumento da temperatura, reage com o oxigênio do ar e produz gás carbônico, permitindo ver a cor mais clara da parede interna do forno.","a coloração preta é originada pela fuligem da combustão completa da lenha, o que causa o aumento da temperatura até que a parede do forno se torne incandescente, revelando sua cor mais clara.","a coloração preta é observada por conta da baixa quantidade de luz gerada pelas chamas da lenha em combustão a baixas temperaturas e essa quantidade de luz aumenta à medida que a temperatura se torna elevada.","o material particulado se funde, escorrendo pelas paredes do forno quando a temperatura ideal é atingida, revelando a coloração mais clara do interior do forno.","a alta quantidade de gás carbônico produzida em baixas temperaturas forma uma névoa que não permite a passagem de luz, o que torna o interior escuro."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "Fogareiros abastecidos com pequenos botijões de gás são equipamentos corriqueiros em trilhas e escaladas de duração prolongada para possibilitar o cozimento de alimentos. Em geral, esses botijões são abastecidos com propano, isobutano ou n-butano. A tabela mostra a temperatura de ebulição e o calor liberado na combustão desses três gases, à pressão atmosférica.\n\nTabela: Temperatura de ebulição (°C) e Calor liberado na combustão ($\\\\frac{kcal}{m}$³ de substância na fase gasosa) para Propano, Isobutano e n-Butano.\nPropano: -42 °C, 5065 $\\\\frac{kcal}{m}$³\nIsobutano: -12 °C, 8211 $\\\\frac{kcal}{m}$³\nn-Butano: -1 °C, 8411 $\\\\frac{kcal}{m}$³\n\nCom base nessas informações, qual seria o gás mais indicado para a utilização em um ambiente com temperatura típica de -6 °C, considerando a viabilidade e o consumo de gás necessário para o preparo de alimentos?",
      subItens: []
    },
    options: ["Propano, por estar líquido em -6 °C e, dentre as substâncias líquidas nessa temperatura, sua combustão fornecer mais calor por volume de gás.","Isobutano, por estar gasoso em -6 °C e, dentre as substâncias gasosas nessa temperatura, sua combustão fornecer mais calor por volume de gás.","n-Butano, por estar gasoso em -6 °C e, dentre as substâncias gasosas nessa temperatura, sua combustão fornecer mais calor por volume de gás.","n-Butano, por estar líquido em -6°C e, dentre as substâncias gasosas nessa temperatura, sua combustão fornecer menos calor por volume de gás.","Isobutano, por estar gasoso em -6 °C e, dentre as substâncias gasosas nessa temperatura, sua combustão fornecer menos calor por volume de gás."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "Para gerar hidrogênio, foi utilizado o aparato ilustrado na figura.\n\nImagem 1: Aparato de geração de H_{2} durante o processo. Frasco com reagentes, tubulação submersa em uma proveta com água, coletando gás.\nImagem 2: Aparato após o processo de geração de H_{2}. A proveta está cheia de gás, com o nível da água abaixo do inicial.\n\nAo frasco à esquerda adicionou-se uma quantidade pré-determinada de raspas de zinco metálico e ácido clorídrico. Em seguida, o frasco foi fechado com uma rolha conectada a uma tubulação. À medida que o hidrogênio é produzido pela reação Zn(s) + 2H+(aq) → Zn_{2}+(aq) + H_{2}(g), o gás se acumula em uma proveta previamente cheia de água. Dado que a solubilidade do hidrogênio na água é desprezível, o volume ocupado pelo gás na proveta corresponde ao volume de hidrogênio produzido durante a reação.\nConsiderando que, nas condições do experimento, foram gerados 49,8 mL de hidrogênio, qual a quantidade de Zn metálico, em gramas, que de fato reagiu?\n\nNote e adote:\nVolume molar do gás ideal nas condições do experimento = 24,9 L.\nMassa molar do Zn = 65,4 $\\\\frac{g}{mol}$.",
      subItens: []
    },
    options: ["0,07","0,13","0,26","0,29","0,48"],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: ["leptospirose, influenza, amebíase, cólera.","COVID, teníase, tétano, tuberculose.","hepatite B, amebíase, cólera, leptospirose.","influenza, teníase, pneumonia, COVID.","tuberculose, poliomielite, hepatite B, amebíase."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["9,25","12,00","12,75","36,00","86,00"],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["a falta de acuidade visual não lhe permite distinguir as épocas.","o desamor ao pai o faz romper com a infância cedo demais.","o aprendizado da morte embaralha os planos da memória.","a sensação de vazio o leva a se sentir seguro no presente.","os dias vividos no Mutum mostram-se cada vez mais curtos."],
    correctAnswer: 2,
    materia: "Literatura Brasileira – Modernismo",
    conteudo: "Literatura Brasileira – João Guimarães Rosa",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Os narradores e os protagonistas são crianças.","São narrados em primeira pessoa, por narradores-protagonistas.","Os protagonistas são oprimidos socialmente, e a reação deles não é endereçada aos opressores.","São fábulas, e os protagonistas são animais.","O espaço representado é o das grandes cidades moçambicanas."],
    correctAnswer: 2,
    materia: "Literatura Lusófona – Literatura Moçambicana",
    conteudo: "Literatura – Análise de Conto",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["adjetivação de tempos.","diálogo entre narradores.","referenciação de espaços.","descrição de personagens.","sequência de ações."],
    correctAnswer: 4,
    materia: "Linguagens – Gêneros Textuais",
    conteudo: "Linguagens – Narrativa",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["representa uma história paralela ligada a uma história principal.","há apenas um conflito que se resolve em pouco tempo.","possui estrutura simples e apresenta um cunho pedagógico.","é uma narrativa breve que comenta um evento do cotidiano.","compõe uma crítica indireta a alguém ou a algum fato."],
    correctAnswer: 3,
    materia: "Linguagens – Gêneros Textuais",
...
createQuestion({
    ...
    options: ["esse jardim de chuva pode ser considerado um ecossistema, no qual componentes bióticos e abióticos interagem numa dinâmica de autorregulação e autossustentação.","nesse jardim de chuva é possível identificar uma teia alimentar com dois níveis tróficos, no qual todos os animais ocupam o nível dos consumidores secundários.","esse jardim contém plantas dicotiledôneas e monocotiledôneas, caracterizadas por possuírem raízes pivotantes, que aumentam a eficiência na absorção de água.","o uso de plantas com grande superfície foliar pode prejudicar a eficiência de um jardim de chuva, diminuindo a evapotranspiração da água.","a decomposição que ocorre no jardim de chuva é feita por organismos parasitas, que transformam os detritos em nutrientes, resultando, na etapa final, em moléculas orgânicas complexas."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["Em períodos de alta pluviosidade, as primeiras precipitações da nuvem são isotopicamente mais leves e a nuvem de chuva se enriquece, relativamente, em 18O.","Em períodos de baixa pluviosidade, a constituição isotópica das nuvens pouco se altera ao longo do tempo, e a pouca chuva dessas nuvens é relativamente enriquecida em 18O.","No período atual, em função do aquecimento global, as temperaturas elevadas fazem com que o fracionamento isotópico de 16O e 18O resultante da evaporação e da precipitação da água não ocorra.","Em períodos glaciais, em função da maior temperatura do planeta, as chuvas são enriquecidas em 18O, enquanto, nos oceanos, a água é enriquecida em 16O.","Em períodos interglaciais, em função da menor temperatura do planeta, as chuvas são enriquecidas em 16O, enquanto, nos oceanos, a água é enriquecida em 18O."],
    correctAnswer: 1,
    materia: "Geografia – Climatologia",
    conteudo: "Química – Isótopos",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["A variação da intensidade do campo magnético terrestre ao longo da linha do Equador é menor do que 10^-6 T.","O campo magnético terrestre é constante em módulo ao longo do meridiano de Greenwich.","O campo magnético terrestre é uniforme e esférico, tal como o campo gerado por um dipolo magnético.","Embora atualmente o campo magnético terrestre tenha intensidade maior nas regiões dos polos, esta é consideravelmente menor na região do Brasil e adjacências.","A geração do campo magnético é naturalmente explicada por uma distribuição estática de cargas no núcleo interno do planeta."],
    correctAnswer: 3,
    materia: "Física – Eletromagnetismo",
    conteudo: "Geografia Física – Estrutura da Terra",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "O gráfico apresentado mostra as concentrações atmosféricas dos principais gases de efeito estufa até o ano 2000, sendo eles: CO_{2}, quantificado em partes por milhão (ppm), N_{2}O e CH_{4}, ambos quantificados em partes por bilhão (ppb). Em junho de 2022, a Administração Nacional Oceânica e Atmosférica (NOAA) reportou que, naquela data, os níveis de CO_{2} na atmosfera encontravam-se em torno de 420 ppm. Esse valor é muito superior à concentração média de aproximadamente 280 ppm, existente antes da Revolução Industrial. Com base nessas informações e em seus conhecimentos, é correto afirmar:\n\nGráfico: Concentrações de CO_{2} (ppm), N_{2}O (ppb) e CH_{4} (ppb) ao longo dos anos, de 0 a 2000. Mostra um aumento significativo de CO_{2}, CH_{4} e N_{2}O a partir da Revolução Industrial.\n\nIPCC 4th Report Main Findings. Disponível em: https://www.inforse.org/. Adaptado.",
      subItens: []
    },
    options: ["Apesar do grande aumento nas quantidades dos três principais gases de efeito estufa a partir da Revolução Industrial, seus níveis passaram a estabilizar por volta do ano 2000.","A mecanização resultante da Revolução Industrial, iniciada no século XVIII, causou grandes mudanças nos meios de produção, com a utilização de energias renováveis.","O plantio de árvores em grande escala acentua o aquecimento global, devido à liberação de gases do efeito estufa na atmosfera.","O aquecimento global é um fenômeno recente, já que a Terra teve um clima com temperaturas constantes durante sua existência.","O efeito estufa é um fenômeno intensificado a partir da Revolução Industrial, devido às atividades humanas emissoras de CO2, que contribuem para o aquecimento global."],
    correctAnswer: 4,
    materia: "Química – Química Ambiental",
    conteudo: "Geografia – Questões Ambientais",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["de grandes investimentos na educação básica e na fundação de centros de pesquisa.","de incentivos à diversificação e mecanização da produção agrícola.","da implantação de formas racionais de organização do trabalho.","da ação governamental embasada em concepção nacionalista e trabalhista.","de um projeto desenvolvimentista amparado por incentivos e captação de recursos estrangeiros."],
    correctAnswer: 4,
    materia: "História – Brasil República",
    conteudo: "História – Governo JK",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "\"Em uma onda sem precedentes de medo, confusão e pânico, hoje quase 13 milhões de ações mudaram de mãos na Bolsa de Valores de Nova York. Corretores atordoados atravessaram um mar de papel segurando ordens de investidores assustados para 'vender a qualquer preço'.\"\n\"Wall Street cai\". The Guardian (Londres), $\\\\frac{24}{10}$/1929, p.1.\n\n\"O mercado esteve ontem numa situação de verdadeiro pânico. Em São Paulo pedem-se a moratória e a emissão de papel-moeda. O presidente da República receberá hoje uma comissão do comércio de Santos.\"\n\"A crise do café\". Correio da Manhã (Rio de Janeiro), $\\\\frac{29}{10}$/1929, p.1.\n\nOs excertos, extraídos de matérias jornalísticas publicadas à época, relatam reações ante a Crise de 1929. Essa crise",
      subItens: []
    },
    options: ["atingiu as atividades agrícolas, incentivou a mecanização do processo produtivo e a absorção dos trabalhadores pelo setor industrial.","afetou as bases do liberalismo econômico, obrigando a intervenção do Estado por meio de regulações e investimentos.","impulsionou a indústria do entretenimento, responsável por forjar comportamentos que se opunham ao pessimismo.","favoreceu a substituição do dólar pela libra esterlina enquanto moeda empregada no comércio internacional.","contribuiu para o desenvolvimento industrial com a substituição de importações e a ampliação do crédito para investimentos."],
    correctAnswer: 1,
    materia: "História – Crise de 1929",
    conteudo: "História – Economia Mundial",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Iniciada no Vale do Paraíba do Sul, entre São Paulo e Rio de Janeiro, na década de 1830, a cafeicultura teve pouco êxito nessa região pelas dificuldades de cultivo, em função do clima frio e da escassez de trabalho escravizado.","A expansão da produção cafeeira no estado de São Paulo se deu em direção à zona oriental do estado, na década de 1850, em decorrência da infraestrutura de transporte existente na região e da presença de trabalho assalariado.","O início da cafeicultura no estado de São Paulo se deu na região oeste, na década de 1930, em decorrência da expansão da produção no norte do Paraná, com expansão para o oeste paulista, aproveitando-se da qualidade do solo.","A produção cafeeira, nos séculos XIX e XX, concentrava-se nos estados de Minas Gerais e Espírito Santo, com a introdução de novas variedades altamente produtivas e resistentes ao clima frio dessas regiões.","Expandindo-se na direção oeste do território paulista, a produção cafeeira impulsionou, nos séculos XIX e XX, a estruturação econômica do estado de São Paulo, impactando o desenvolvimento da malha ferroviária e portuária."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["O modal aquaviário, com menor custo e maior capacidade de carga, predomina em mais da metade dos países representados no gráfico.","Nos EUA, em decorrência da baixa necessidade de transporte de cargas, predomina o modal rodoviário, com menor custo no transporte de pessoas.","Predominante no país, o modal aquaviário no Canadá tem alto custo, em decorrência das condições climáticas que mantêm os cursos d'águas de todo o país congelados na maior parte do ano.","Apesar de possuir maior custo, a matriz brasileira, assentada no modal rodoviário, é mais eficiente considerando a capacidade de transporte em grandes quantidades e longos percursos.","A predominância do modal aquaviário na China faz parte da estratégia do país de aliar a diminuição dos custos de transporte à busca de modais menos poluentes."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["Curva a.","Curva b.","Curva c.","Curva d.","Curva e."],
    correctAnswer: 0,
    materia: "Física – Cinemática",
    conteudo: "Física – Gráficos de Movimento",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["O skate adentrou o mundo esportivo, entre outros motivos, por pressão dos praticantes da modalidade. No entanto, práticas esportivas que surgem pautadas pelo lazer ou por atividades cotidianas não deveriam ser consideradas modalidades esportivas por não terem sido institucionalizadas desde sua origem.","Eventos esportivos de grande alcance, tal qual a Olimpíada, deveriam considerar as estruturas normativas que dão origem aos esportes para inseri-los nas competições. Apenas dessa forma, seria possível garantir a autenticidade das modalidades e justificar a inserção do skate como esporte olímpico.","Os esportes são uma forma de representação das práticas sociais. Sendo assim, as transformações sociais podem resultar em alterações de regras esportivas, na esportivização de práticas de lazer e até na extinção de modalidades esportivas.","Os esportes podem sofrer alterações normativas ao longo dos tempos. Com tal efeito, torna-se equivocado datar a criação de um esporte, pois ele já pode ter sofrido alterações que descaracterizaram sua origem.","O skate, bem como outras práticas esportivas, foi criado de modo discreto, por grupos pequenos, e ganhou força e ascensão a partir do aumento de incentivo financeiro para sua realização, o que é determinante para um esporte alcançar reconhecimento mundial."],
    correctAnswer: 2,
    materia: "Sociologia – Esporte e Sociedade",
    conteudo: "História – Brasil Contemporâneo",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["no abismo persistente entre as notas de estudantes ricos e pobres.","no corte de gastos e mudanças de prioridades em algumas escolas públicas.","na preferência por jogadores com potencial superior para competição.","na redução de bolsas de estudos para adolescentes de famílias abaixo da linha de pobreza.","na realização de campeonatos contemplados com doações de ONGs."],
    correctAnswer: 1,
    materia: "Língua Inglesa – Compreensão de Texto",
...
createQuestion({
    ...
    options: ["temporalidade.","distância.","antecipação.","intensidade.","progresso."],
    correctAnswer: 3,
    materia: "Língua Inglesa – Vocabulário",
    conteudo: "Língua Inglesa – Interpretação de Texto",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Vetor para a direita (→).","Vetor para cima (↑).","Vetor para a esquerda (←).","Vetor para baixo (↓).","nulo."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "A foto a seguir mostra um circuito com três resistores (R_{1}, R_{2} e R_{3}) conectados em uma protoboard (base de contatos). Nesse tipo de placa, os cinco furos de uma mesma linha (indicados pelos retângulos amarelos) estão em curto, formando os nós do circuito. Os cabos vermelho e preto, por sua vez, estão conectados aos terminais de uma fonte contínua de 5V.\n\nImagem: Foto de um circuito em protoboard com três resistores (R_{1}, R_{2}, R_{3}) e uma fonte de 5V. Os retângulos amarelos destacam as linhas em curto na protoboard, mostrando que R_{2} e R_{3} estão em paralelo e o conjunto em série com R_{1}.\n\nSe R_{1} = 150 kΩ e R_{2} = R_{3} = 100 kΩ, a corrente elétrica que passa pelo resistor R_{1} será de:",
      subItens: []
    },
    options: ["12,5 µA","14,3 µA","25,0 µA","37,5 µA","50,0 µA"],
    correctAnswer: 2,
...
createQuestion({
    ...
    options: ["5/6","1","5/8","13/5","18/5"],
    correctAnswer: 3,
    materia: "Matemática – Funções Exponenciais",
    conteudo: "Matemática – Funções Inversas",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Duas retas que se intersectam no ponto (2,1).","Duas retas que se intersectam no ponto (2,1).","Duas retas que se intersectam no ponto (2,1).","Duas retas que se intersectam no ponto (2,1).","Duas retas que se intersectam no ponto (2,1)."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "O gráfico a seguir representa a curva de biomassa e biodiversidade em diferentes partes do globo.\n\nGráfico: Balanço de Radiação ($\\\\frac{kcal}{cm}$²) versus Índice de Aridez. A curva mostra o pico de biomassa e biodiversidade em índice de aridez próximo de 0,5 e balanço de radiação alto, caindo para ambos os lados. Legenda: 0-1: umidade alta, 1-2: umidade moderada, 2-3: umidade baixa.\n\nGRIGORIEV, A.A. The theoretical fundaments of modern physical Geography. In: The interaction of sciences in the Earth, Moscou, 1968. Adaptado.\n\nSobre os ambientes do globo terrestre que podem ser exemplificados pelos dados demonstrados no gráfico, é correto afirmar que, onde o índice de aridez é igual a",
      subItens: []
    },
    options: ["1 e o balanço de radiação é igual a 70 kcal/cm², a curva de biomassa e biodiversidade atinge o ápice, caracterizando, por exemplo, o ambiente de uma floresta equatorial.","2 e o balanço de radiação é igual a 40 kcal/cm², é possível inferir os ambientes compostos por savanas ou cerrados, com crescimento da curva de biomassa e biodiversidade.","0 e o balanço de radiação é igual também a 0, encontram-se os ambientes desérticos muito quentes, a exemplo do deserto do Saara.","3 e o balanço de radiação é igual a 0, a curva de biomassa e biodiversidade indica exemplo típico de ambiente tropical úmido.","1,5 e o balanço de radiação é igual a 55 kcal/cm², a curva de biomassa e biodiversidade diminui, caracterizando os ambientes com presença de neve eterna."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["Caatingas, Cerrado e Araucárias.","Pradarias, Caatingas e Amazônico.","Cerrado, Caatingas e Pradarias.","Mares de Morros, Pradarias e Amazônico.","Cerrado, Araucárias e Mares de Morros."],
    correctAnswer: 0,
    materia: "Geografia – Domínios Morfoclimáticos",
    conteudo: "Geografia – Biomas Brasileiros",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "\"Pesquisadores realizaram em 2022 uma expedição que promete fazer história. Destino: Serra do Imeri, um conjunto de montanhas no norte do Amazonas. O objetivo da missão foi a realização de um inventário de biodiversidade para saber que tipos de animais e plantas ocorrem na região e de que forma eles se relacionam, ou não, com as espécies que habitam as partes mais baixas do bioma. O Pico da Neblina, o mais alto do Brasil, com 2.995 m, faz parte da Serra do Imeri, mas integra maciço rochoso diferente, fisicamente separado da área da expedição. Do ponto de vista ecológico, são como dois arquipélagos distintos, separados por um grande mar de floresta verde.\"\n\nMapa: Localização da Serra do Imeri, mostrando o Pico da Neblina e a Área da Expedição, separados por \"mar de floresta verde\".\n\nDisponível em https://jornal.usp.$\\\\frac{br}{ciencias}$/rumo-a-amazonia-$\\\\frac{desconhecida}{21}$/$\\\\frac{10}{2022}$. Adaptado.\n\nCom base nas informações fornecidas e em seus conhecimentos, assinale a alternativa correta.",
      subItens: []
    },
    options: ["As barreiras naturais da Serra do Imeri tornam possível o desenvolvimento do endemismo, pois há potencialização da formação de novas espécies em função do grande isolamento geográfico.","A área de estudo homogênea e contínua permitiu a comunicação e o desenvolvimento de riqueza ímpar quanto à biodiversidade, em especial por conter condições ambientais típicas do ecossistema amazônico.","O isolamento da Serra do Imeri provoca a menor ocorrência de espécies endêmicas na região, cujos animais e plantas não possuem relação direta com o extenso bioma Amazônico.","O conhecimento de espécies biológicas e seus ecossistemas, assim como a compreensão de seus habitats, acelera a extinção de plantas e outros seres vivos, diminuindo a biodiversidade.","A Serra do Imeri representa comunidade ecológica ameaçada de extinção em razão dos problemas comuns ao bioma Amazônico, tais como expansão da agropecuária, instalação de garimpos e extração de madeira."],
    correctAnswer: 0,
    materia: "Biologia – Ecologia",
    conteudo: "Biologia – Biodiversidade",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "Em fevereiro de 2023, ocorreu uma precipitação pluviométrica extrema no litoral norte de São Paulo, com volume que excedeu os 600 mm de chuva em menos de 24 horas. Foi um dos maiores índices pluviométricos já registrados no Brasil para um dia. Essa grande quantidade de chuva provocou muitos deslizamentos de terra, como o retratado na imagem.\n\nImagem: Foto de um deslizamento de terra em uma encosta entre Camburi e Boiçucanga, SP, com vegetação removida e solo exposto.\n\nDisponível em Portal g_{1}.globo.com $\\\\frac{22}{2}$/2023 - Foto: CREATIVE PRODUÇÕES/ Cristian Santos.\n\nConsiderando o contexto socioambiental em que esse episódio ocorreu, é correto afirmar:",
      subItens: []
    },
    options: ["Apesar das altas declividades nas encostas da Serra do Mar, eventos como esse são raros, uma vez que os solos profundos e a vegetação primária dificultam os deslizamentos de terra.","No local do deslizamento de terra, ocorrerá um processo de sucessão primária e, após poucos anos, uma floresta madura estará estabelecida.","A baixa umidade da região e a indisponibilidade de nutrientes no solo retardarão a instalação de organismos pioneiros, como os líquens, que iniciarão o processo de sucessão nesse local.","Fenômenos desse tipo são causados por fatores naturais da região, relacionados ao clima, à geologia e ao relevo, mas são agravados pela ocupação desordenada das encostas.","No local do deslizamento de terra, a biomassa vegetal aumentará ao longo da sucessão ecológica graças a um equilíbrio energético no sistema, em que as taxas de fotossíntese e respiração permanecerão equivalentes."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "Observe as ilustrações.\n\nImagem 1: Vista de satélite mostrando grandes ravinas ou voçorocas em uma área urbana.\nImagem 2: Foto terrestre de uma grande voçoroca, com desmatamento visível ao redor.\n\nDisponível em https://g_{1}.globo.$\\\\frac{com}{ma}$/$\\\\frac{maranhao}{noticia}$/$\\\\frac{2023}{03}$/29/.\n\nA imagem de satélite e a foto retratam fenômeno que aconteceu em Buriticupu, no oeste maranhense. Com base nas figuras e em seus conhecimentos, assinale a alternativa correta.",
      subItens: []
    },
    options: ["O fenômeno é caracterizado pela formação de voçorocas, feições erosivas de grandes proporções que podem ser evitadas por meio do controle do fluxo das águas superficiais e subsuperficiais, plantio de vegetação e terraceamento.","Trata-se de uma feição erosiva ocasionada pelas fortes chuvas que assolam a região, sendo um processo natural que não é afetado pela ação humana, pois é um fenômeno associado à origem de solos e às nascentes de rios.","O fenômeno caracteriza a formação de voçorocas, feições erosivas profundas que têm sua origem na ascensão do lençol freático e no acúmulo de lixo. Podem ser evitadas por meio do saneamento básico e da confecção de aterros.","Trata-se de um fenômeno associado a tremores de terra e fluxos subterrâneos de água que resultam na feição erosiva chamada de voçoroca, caracterizada por abrir grandes crateras no solo sem haver acúmulo de sedimentos.","O fenômeno mostra a formação de fluxos de lama na direção da área urbana do município. Podem ser vistos o desmatamento do seu entorno e arruamento precário em estradas de terra vicinais que causaram o processo erosivo."],
    correctAnswer: 0,
    materia: "Geografia – Geomorfologia",
...
createQuestion({
    ...
    options: ["os entraves à plenitude lírica são removidos.","os trovadores ainda inspiram os enamorados.","a sabedoria controla o poder das máquinas.","os heróis sempre ressuscitam neste mundo.","a poesia resiste à negatividade do seu tempo."],
    correctAnswer: 4,
    materia: "Literatura Brasileira – Modernismo",
    conteudo: "Literatura Brasileira – Carlos Drummond de Andrade",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["a lampreia é o ancestral comum de todos os vertebrados incluídos no cladograma.","o tubarão surgiu da lampreia e deu origem aos vertebrados tetrápodes.","os peixes (lampreia e tubarão) possuem um ancestral compartilhado com os tetrápodes.","o lagarto é mais proximamente relacionado ao tubarão que ao ser humano.","o ser humano é o mais evoluído dentre todos os vertebrados incluídos no cladograma."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "Observe o mapa da distribuição da pesca no globo em toneladas por quilômetro quadrado, por ano.\n\nMapa: \"Onde se pescam mais peixes, moluscos e crustáceos\". O mapa-múndi mostra as áreas de maior produtividade pesqueira, com uma escala de cores de 0,05 a 10 $\\\\frac{toneladas}{km}$²/ano. Áreas costeiras e de ressurgência são as mais produtivas.\n\nDisponível em https://animalbusiness.com.$\\\\frac{br}{negocios}$-e-mercado/.\n\nBaseado em seus conhecimentos sobre correntes marítimas quentes e frias em superfície, bem como nos dados representados no mapa, assinale a alternativa correta.",
      subItens: []
    },
    options: ["No Hemisfério Sul, as regiões de maior potencial de pesca são aquelas que margeiam a costa leste dos continentes americano, africano e asiático, marcadas pela presença de correntes marítimas quentes.","No Hemisfério Norte, as regiões de maior potencial de pesca são registradas na costa leste e oeste do continente americano, margeadas pelas correntes marítimas frias do Labrador e do Golfo, respectivamente.","Em todo o globo, as áreas que demarcam as águas internacionais ou alto-mar são as mais piscosas independentemente da presença de correntes marítimas quentes ou frias.","No Hemisfério Sul, as regiões de maior potencial de pesca ocorrem na costa oeste do continente americano e do continente africano, com a presença, respectivamente, das correntes marítimas de Humboldt e de Benguela.","As regiões polares apresentam potencial reduzido de pesca em função das dificuldades de acesso, baixa reprodução das espécies nesses locais e presença de correntes marítimas frias."],
    correctAnswer: 3,
    materia: "Geografia – Oceanografia",
    conteudo: "Geografia – Correntes Marítimas",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["14°C","28°C","40°C","60°C","84°C"],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: ["Ciclo com compressão adiabática, aquecimento isovolumétrico, expansão adiabática e resfriamento isovolumétrico.","Ciclo com compressão adiabática, aquecimento isovolumétrico, expansão adiabática e resfriamento isovolumétrico.","Ciclo com compressão adiabática, aquecimento isovolumétrico, expansão adiabática e resfriamento isovolumétrico.","Ciclo com compressão adiabática, aquecimento isovolumétrico, expansão adiabática e resfriamento isovolumétrico.","Ciclo com compressão adiabática, aquecimento isovolumétrico, expansão adiabática e resfriamento isovolumétrico."],
    correctAnswer: 0,
    materia: "Física – Termodinâmica",
    conteudo: "Física – Ciclos Termodinâmicos",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["1,2 cm","5,1 cm","6,8 cm","11,3 cm","18,1 cm"],
    correctAnswer: 2,
    materia: "Física – Ondas",
    conteudo: "Física – Ondas Estacionárias",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["todos os processos químicos são extremamente rápidos e não podem ser estudados por técnicas que não sejam em femtossegundos.","as reações químicas podem passar por espécies instáveis e com pouco tempo de vida.","o tempo existente para analisar os produtos de uma reação depende apenas da quantidade de produtos formada.","permite entender como reagentes específicos se comportam frente a processos reacionais que são extremamente lentos.","apenas com uma técnica tão rápida é possível analisar o grau de pureza dos reagentes isolados."],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: ["o comércio praticado no nordeste da África isolava a região de outras áreas do continente.","os comerciantes do Egito participavam apenas de rotas comerciais marítimas.","as atividades mercantis do Reino de Axum conectavam o Mediterrâneo ao Oceano Índico.","as rotas terrestres e marítimas na África e na Península Arábica não se conectavam umas às outras.","a cidade de Berenice se colocava como obstáculo ao comércio do Mediterrâneo com o interior da África."],
    correctAnswer: 2,
...
createQuestion({
    ...
    options: ["à indecisão de Fidel Castro sobre o alinhamento político de Cuba na Guerra Fria e ao isolamento da ilha em relação a outros debates políticos da época.","às garantias do governo revolucionário em Cuba aos capitais norte-americanos e à salvaguarda dos direitos civis da população negra na ilha.","à aliança entre Cuba e URSS selada na origem da guerrilha em Sierra Maestra e à consequente oposição dos EUA ao movimento insurgente.","ao gradual alinhamento entre Cuba e a URSS e ao aceno dos dois governantes de apoio ao movimento negro norte-americano.","à articulação entre os governos da URSS e dos EUA para enfraquecer Fidel Castro e os movimentos sociais no Harlem."],
    correctAnswer: 3,
    materia: "História – Guerra Fria",
    conteudo: "História – Revolução Cubana",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["uma intervenção norte-americana em território iraniano.","a integração do Irã aos países do bloco socialista soviético.","a laicização integral do Estado iraniano.","o estabelecimento de uma república teocrática no Irã.","uma cooperação militar entre Irã e Iraque contra o Ocidente."],
    correctAnswer: 3,
    materia: "História – Oriente Médio",
    conteudo: "História – Revolução Iraniana",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["O Tratado de Lausanne estabeleceu as fronteiras da Turquia moderna, incluindo a existência de um Estado curdo após o fim do Império Turco Otomano, concedendo aos curdos o domínio do território entre as atuais Turquia e Síria.","Os curdos formam uma população estimada em dezenas de milhões de pessoas e parte habita uma região montanhosa que se espalha pelos territórios fronteiriços de cinco países: Turquia, Iraque, Síria, Irã e Rússia.","Falantes de várias línguas, dentre as quais árabe, curdo, turco e persa, e compostos por diferentes grupos étnicos e religiosos, os curdos são considerados a maior população apátrida do mundo.","Entre os anos de 2013 e 2019, as forças curdas desempenharam um papel central no enfrentamento ao Estado Islâmico na região, o que levou ao reconhecimento do estado independente do Curdistão.","Em 2022, foi aprovada uma resolução no Conselho de Segurança da ONU reconhecendo a independência do Curdistão e definindo suas fronteiras em territórios que pertenciam à Síria, Turquia e Iraque."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "\"A China enviou ontem navios de guerra e dezenas de caças para Taiwan, em retaliação a uma reunião entre a presidente da ilha, Tsai Ing-Wen, e o presidente da Câmara dos Deputados do EUA, Kevin McCarty, na Califórnia\".\nO Estado de São Paulo, $\\\\frac{08}{04}$/2023. Adaptado.\n\nA reportagem faz alusão ao aumento das tensões geopolíticas entre China e Taiwan. Sobre esse tema, é correto afirmar:",
      subItens: []
    },
    options: ["As tensões iniciaram-se no final de década de 1970, em decorrência das mudanças políticas e econômicas perpetradas pelo então presidente chinês Deng Xiaoping, que resultaram na declaração de independência de Taiwan em relação à China.","Iniciadas ainda na primeira metade do século XX, as tensões entre China e Taiwan aumentaram desde então em decorrência da presença militar dos EUA no território taiwanês, o que contraria os interesses geopolíticos chineses na região.","As tensões decorreram do aumento da influência russa sobre o território taiwanês, com foco na exploração do potencial mercado consumidor, considerado estratégico para o aumento das exportações do gás natural russo.","Com apoio soviético, Taiwan conseguiu independência do território chinês no final da década de 1960. Após o fim da Guerra Fria, tornou-se uma potência tecnológica, o que ampliou o interesse geopolítico chinês na retomada desse território.","Taiwan é reconhecido como país independente pelos EUA e tem emergido na rota dos conflitos entre os governos estadunidense e chinês, o que pode ser interpretado como indício do deslocamento do eixo geopolítico do mundo para o sudeste asiático."],
    correctAnswer: 1,
    materia: "Geografia – Geopolítica",
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "A figura mostra dados do Fundo Monetário Internacional (FMI) sobre a série histórica (1992 e 2010) e uma projeção (2028) dos 10 países com o maior Produto Interno Bruto (PIB).\n\nGráfico: Ranking dos 10 maiores PIBs do mundo em 1992, 2010 e 2028 (projeção). Mostra a ascensão de China e Índia e a queda de países como Japão e Alemanha, e a permanência dos EUA no topo.\n\nDisponível em https://www.statista.$\\\\frac{com}{chart}$/22256/. Adaptado.\n\nSobre esses dados, é correto afirmar:",
      subItens: []
    },
    options: ["Entre 2010 e 2028, a Indonésia, que não figurava entre os dez maiores PIBs, aparecerá no ranking em razão da produção agrícola e do extrativismo mineral, enquanto que a Itália sofrerá queda na economia devido à instabilidade política do país.","Entre 1992 e 2028, o Brasil apresentou elevação na sua produção e sofrerá declínio no ranking, assim como o Reino Unido, em razão desses países terem declinado de tratados econômicos globais.","Entre 1992 e 2010, China e Índia apresentaram crescimento de suas economias em razão do aumento da capacidade produtiva, do potencial de consumo interno e da infraestrutura na produção industrial.","Entre 1992 e 2010, Japão e Alemanha sofreram queda e estabilização no seu Produto Interno Bruto justificada pelo fato de ambos os países serem potências hegemônicas na produção de tecnologia.","Entre 2010 e 2028, Rússia e França terão declínio nas suas economias por se encontrarem enfraquecidas por conflitos bélicos, dependência energética e redução populacional em seus países."],
    correctAnswer: 2,
    materia: "Geografia – Economia Global",
    conteudo: "Geografia – PIB",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Os conceitos de reprodução social e de economia do cuidado são contraditórios porque o primeiro se refere a todo trabalho doméstico e o segundo apenas ao trabalho doméstico pago e que é possível contabilizar.","Ambos os conceitos se referem a um tipo de trabalho cuja importância é socialmente reconhecida, fato que pode ser comprovado pela porcentagem expressiva que ele representava do PIB brasileiro no ano de 2015.","As definições de reprodução social e de economia do cuidado excluem, necessariamente, a possibilidade de que o Estado seja responsável por parte das tarefas envolvidas na reprodução das pessoas.","A contabilização no PIB dos valores dos afazeres domésticos no contexto da economia do cuidado abarca apenas uma parte da reprodução social, pois não inclui o trabalho doméstico remunerado e os trabalhos de reprodução executados fora do ambiente doméstico.","Os dados estimados sobre a participação das atividades domésticas não remuneradas no PIB do Brasil mostram que a reprodução social acontece apenas quando não há uma relação salarial entre quem executa e quem se beneficia desse tipo de trabalho."],
    correctAnswer: 3,
    materia: "Sociologia – Gênero e Trabalho",
    conteudo: "Sociologia – Economia do Cuidado",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["No texto I, machamba refere-se a um matagal, em sentido denotativo; no texto II, ao papel de esposa de Sarnau, em sentido conotativo.","No texto I, machamba possui sentido literal, referindo-se às terras para cultivo; no texto II, o sentido é figurado, referindo-se ao útero de Sarnau.","No texto I, machamba possui sentido figurado, referindo-se à colheita; no texto II, o sentido é literal, referindo-se a um problema.","Em ambos os textos, machamba apresenta sentido literal e refere-se a um terreno agrícola de produção familiar.","Em ambos os textos, machamba possui sentido figurado e refere-se às terras férteis ocupadas pelos portugueses."],
    correctAnswer: 1,
    materia: "Literatura Lusófona – Literatura Moçambicana",
    conteudo: "Linguagens – Semântica (Denotação e Conotação)",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Luís Bernardo Honwana descreve uma cena de violência psicológica velada do capataz contra a mulher, sem que ela perceba a agressão sofrida.","Luís Bernardo Honwana expõe a violência social de que a mulher é vítima ao relatar uma discussão acalorada que ela trava com o capataz.","Luís Bernardo Honwana narra uma luta física entre o capataz e a mulher, a qual tenta resistir à agressão sofrida, mas acaba por consentir com a relação.","Paulina Chiziane apresenta elementos narrativos que permitem identificar a agressão psicológica e física praticada, pelo marido, contra a mulher.","Paulina Chiziane associa a violência contra a mulher a um processo educativo que visa zelar pela estabilidade da relação conjugal e pela felicidade do casal."],
    correctAnswer: 3,
    materia: "Literatura Lusófona – Literatura Moçambicana",
    conteudo: "Sociologia – Violência de Gênero",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["162 é o 15º número triangular.","O 13º número triangular é primo e o 30º número oblongo é ímpar.","156 não é um número oblongo, nem triangular.","210 é um número triangular e oblongo.","A diferença entre dois números triangulares consecutivos são termos de uma progressão geométrica."],
    correctAnswer: 3,
    materia: "Matemática – Teoria dos Números",
    conteudo: "Matemática – Progressões",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["praticavam o canibalismo devido à escassez de alimentos nas regiões em que viviam.","desenvolviam uma cultura agrícola de subsistência que não abolia a existência de sistemas de troca.","cultivavam produtos agrícolas que deixaram de ser consumidos após a chegada dos colonizadores.","organizavam-se em unidades políticas autônomas, que evitavam contatos comerciais entre si.","realizavam rituais em que homens e mulheres desempenhavam funções idênticas."],
    correctAnswer: 1,
    materia: "História – Brasil Colônia",
    conteudo: "História – Sociedades Indígenas",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["reconheceu a necessidade de tradução mútua entre as línguas.","considerou as línguas indígenas como expressão de outras culturas.","interpretou as diferenças linguísticas como estratégia de resistência dos nativos.","mostrou-se disposto a estudar e compreender as línguas dos indígenas.","entendeu o ensino do castelhano aos indígenas como forma de civilização."],
    correctAnswer: 4,
    materia: "História – Expansão Marítima Europeia",
    conteudo: "História – América Pré-Colonial",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["A língua falada é um instrumento de sobrevivência em sociedade.","A língua varia tão rapidamente quanto as mudanças que ocorrem na sociedade.","Existem muitas maneiras de se expressar a mesma ideia.","Os habitantes de uma cidade grande não possuem sotaque na língua falada.","Todo falante nativo de uma língua a conhece plenamente."],
    correctAnswer: 3,
    materia: "Linguagens – Sociolinguística",
    conteudo: "Linguagens – Preconceito Linguístico",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Pessoas egressas do sistema prisional têm dificuldade de conseguir emprego no mercado de trabalho porque são estigmatizadas.","Pessoas egressas do sistema prisional têm a mesma chance de conseguir empregos que o restante da população, razão pela qual não devem ser privilegiadas pelos empregadores.","Pessoas egressas do sistema prisional já foram condenadas e cumpriram pena pelo crime cometido e merecem a oportunidade de trabalhar para recomeçarem a vida.","Pessoas egressas do sistema prisional voltarão a cometer crimes e, por isso, não devem ser contratadas para trabalhar.","Pessoas egressas do sistema prisional conseguem somente trabalhos informais e de baixa remuneração por terem pouca qualificação e dificuldades para conseguir seus documentos."],
    correctAnswer: 3,
