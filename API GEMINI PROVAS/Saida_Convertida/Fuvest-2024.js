...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "O gráfico apresentado mostra as concentrações atmosféricas dos principais gases de efeito estufa até o ano 2000, sendo eles: $CO_{2}$, quantificado em partes por milhão (ppm), N2O e $CH_{4}$, ambos quantificados em partes por bilhão (ppb). Em junho de 2022, a Administração Nacional Oceânica e Atmosférica (NOAA) reportou que, naquela data, os níveis de $CO_{2}$ na atmosfera encontravam-se em torno de 420 ppm. Esse valor é muito superior à concentração média de aproximadamente 280 ppm, existente antes da Revolução Industrial. Com base nessas informações e em seus conhecimentos, é correto afirmar:\n\nGráfico: Concentrações de $CO_{2}$ (ppm), N2O (ppb) e $CH_{4}$ (ppb) ao longo dos anos, de 0 a 2000. Mostra um aumento significativo de $CO_{2}$, $CH_{4}$ e N2O a partir da Revolução Industrial.\n\nIPCC 4th Report Main Findings. Disponível em: https://www.inforse.org/. Adaptado.",
      subItens: []
    },
