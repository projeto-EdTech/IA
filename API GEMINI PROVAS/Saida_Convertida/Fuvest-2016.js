createQuestion({
    ...
    year: 2016,
    text: {
      principal: "De 1869 até hoje, ocorreram as seguintes mudanças de moeda no Brasil: (1) em 1942, foi criado o cruzeiro, cada cruzeiro valendo mil réis; (2) em 1967, foi criado o cruzeiro novo, cada cruzeiro novo valendo mil cruzeiros; em 1970, o cruzeiro novo voltou a se chamar apenas cruzeiro; (3) em 1986, foi criado o cruzado, cada cruzado valendo mil cruzeiros; (4) em 1989, foi criado o cruzado novo, cada um valendo mil cruzados; em 1990, o cruzado novo passou a se chamar novamente cruzeiro; (5) em 1993, foi criado o cruzeiro real, cada um valendo mil cruzeiros; (6) em 1994, foi criado o real, cada um valendo 2.750 cruzeiros reais. Quando morreu, em 1869, Brás Cubas possuía 300 contos. Se esse valor tivesse ficado até hoje em uma conta bancária, sem receber juros e sem pagar taxas, e se, a cada mudança de moeda, o depósito tivesse sido normalmente convertido para a nova moeda, o saldo hipotético dessa conta seria, aproximadamente, de um décimo de\nDados:\nUm conto equivalia a um milhão de réis.\nUm bilhão é igual a 10⁹ e um trilhão é igual a 10¹².",
      subItens: []
    },
    options: ["real.","milésimo de real.","milionésimo de real.","bilionésimo de real.","trilionésimo de real."],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Os pontos A, B e C são colineares, AB = 5, BC = 2 e B está entre A e C. Os pontos C e D pertencem a uma circunferência com centro em A. Traça-se uma reta r perpendicular ao segmento BD passando pelo seu ponto médio. Chama-se de P a interseção de r com AD. Então, AP + BP vale",
      subItens: []
    },
    options: ["4","5","6","7","8"],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "No plano cartesiano, um círculo de centro P = (a, b) tangencia as retas de equações y = x e x = 0. Se P pertence à parábola de equação y = x² e a > 0, a ordenada b do ponto P é igual a",
      subItens: []
    },
    options: ["2 + 2√2","3 + 2√2","4 + 2√2","5 + 2√2","6 + 2√2"],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Em uma classe com 14 alunos, 8 são mulheres e 6 são homens. A média das notas das mulheres no final do semestre ficou 1 ponto acima da média da classe. A soma das notas dos homens foi metade da soma das notas das mulheres. Então, a média das notas dos homens ficou mais próxima de",
      subItens: []
    },
    options: ["4,3","4,5","4,7","4,9","5,1"],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "No quadrilátero plano ABCD, os ângulos ABC e ADC são retos, AB = AD = 1, BC = CD = 2 e BD é uma diagonal. O cosseno do ângulo BCD vale",
      subItens: []
    },
    options: ["√3 / 5","2 / 5","3 / 5","2√3 / 5","4 / 5"],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Cada aresta do tetraedro regular ABCD mede 10. Por um ponto P na aresta AC, passa o plano α paralelo às arestas AB e CD. Dado que AP = 3, o quadrilátero determinado pelas interseções de α com as arestas do tetraedro tem área igual a",
      subItens: []
    },
    options: ["21","21√2 / 2","30","30√2 / 2","30√3 / 2"],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Dispõe-se de 2 litros de uma solução aquosa de soda cáustica que apresenta pH 9. O volume de água, em litros, que deve ser adicionado a esses 2 litros para que a solução resultante apresente pH 8 é",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Existem vários modelos para explicar as diferentes propriedades das substâncias químicas, em termos de suas estruturas submicroscópicas. Considere os seguintes modelos: I. moléculas se movendo livremente; II. íons positivos imersos em um \"mar\" de elétrons deslocalizados; III. íons positivos e negativos formando uma grande rede cristalina tridimensional. Assinale a alternativa que apresenta substâncias que exemplificam, respectivamente, cada um desses modelos.\nQuadro:\nI           II                  III\na) gás nitrogênio  ferro sólido        cloreto de sódio sólido\nb) água líquida    iodo sólido         cloreto de sódio sólido\nc) gás nitrogênio  cloreto de sódio sólido  iodo sólido\nd) água líquida    ferro sólido        diamante sólido\ne) gás metano     água líquida        diamante sólido",
      subItens: []
    },
    options: ["gás nitrogênio, ferro sólido, cloreto de sódio sólido","água líquida, iodo sólido, cloreto de sódio sólido","gás nitrogênio, cloreto de sódio sólido, iodo sólido","água líquida, ferro sólido, diamante sólido","gás metano, água líquida, diamante sólido"],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Fenol e metanal (aldeído fórmico), em presença de um catalisador, reagem formando um polímero que apresenta alta resistência térmica. No início desse processo, pode-se formar um composto com um grupo – CH₂OH ligado no carbono 2 ou no carbono 4 do anel aromático. O esquema a seguir apresenta as duas etapas iniciais do processo de polimerização para a reação no carbono 2 do fenol.\n(Diagrama de reações de polimerização)\nConsidere que, na próxima etapa desse processo de polimerização, a reação com o metanal ocorra no átomo de carbono 4 de um dos anéis de I. Assim, no esquema A e B podem ser, respectivamente,\nNote e adote:\nNumeração dos átomos de carbono do anel aromático do fenol",
      subItens: []
    },
    options: ["Estrutura A e Estrutura B","Estrutura A e Estrutura B","Estrutura A e Estrutura B","Estrutura A e Estrutura B","Estrutura A e Estrutura B"],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Uma bola de massa m é solta do alto de um edifício. Quando está passando pela posição y = h, o módulo de sua velocidade é v. Sabendo-se que o solo, origem para a escala de energia potencial, tem coordenada y = h₀, tal que h > h₀ > 0, a energia mecânica da bola em y = (h−h₀)/2 é igual a\nNote e adote:\nDesconsidere a resistência do ar.\ng é a aceleração da gravidade.",
      subItens: []
    },
    options: ["(1/4)mg(h-ho) + (1/2)mv²","(1/2)mg(h-ho) + (1/2)mv²","(1/2)mg(h-ho) + 2mv²","mgh + (1/2)mv²","mg(h-ho) + (1/2)mv²"],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Os centros de quatro esferas idênticas, I, II, III e IV, com distribuições uniformes de carga, formam um quadrado. Um feixe de elétrons penetra na região delimitada por esse quadrado, pelo ponto equidistante dos centros das esferas III e IV, com velocidade inicial v na direção perpendicular à reta que une os centros de III e IV, conforme representado na figura.\n(Diagrama de quatro esferas carregadas e trajetória de elétrons)\nA trajetória dos elétrons será retilínea, na direção de v, e eles serão acelerados com velocidade crescente dentro da região plana delimitada pelo quadrado, se as esferas I, II, III e IV estiverem, respectivamente, eletrizadas com cargas\nNote e adote:\nQ é um número positivo.",
      subItens: []
    },
    options: ["+Q,-Q,-Q,+Q","+2Q,-Q,+Q,-2Q","+Q,+Q,-Q,-Q","-Q,-Q,+Q,+Q","+Q,+2Q,-2Q,-Q"],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["nula.","g_R (R_T/h)²","g_R (R_T/(R_T+h))²","g_R (R_T/(R_T+h))²","g_R ((R_T-h)/(R_T+h))²"],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["θ = 20°","θ = 30°","θ = 45°","θ = 60°","θ = 70°"],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Uma gota de chuva se forma no alto de uma nuvem espessa. À medida que vai caindo dentro da nuvem, a massa da gota vai aumentando, e o incremento de massa Δm, em um pequeno intervalo de tempo Δt, pode ser aproximado pela expressão: Δm = αvSΔt, em que α é uma constante, v é a velocidade da gota, e S, a área de sua superfície. No sistema internacional de unidades (SI), a constante α é",
      subItens: []
    },
    options: ["expressa em kg.m³","expressa em kg.m⁻³","expressa em m³.s.kg⁻¹","expressa em m³.s⁻¹","adimensional."],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "No heredograma ao lado, a menina II-1 tem uma doença determinada pela homozigose quanto a um alelo mutante de gene localizado num autossomo. A probabilidade de que seu irmão II-2, clinicamente normal, possua esse alelo mutante é\n(Diagrama de heredograma)",
      subItens: []
    },
    options: ["0","1/4","1/3","1/2","2/3"],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Tatuzinhos-de-jardim, escorpiões, siris, centopeias e borboletas são todos artrópodes. Compartilham, portanto, as seguintes características:",
      subItens: []
    },
    options: ["simetria bilateral, respiração traqueal e excreção por túbulos de malpighi.","simetria bilateral, esqueleto corporal externo e apêndices articulados.","presença de cefalotórax, sistema digestório incompleto e circulação aberta.","corpo não segmentado, apêndices articulados e respiração traqueal.","corpo não segmentado, esqueleto corporal externo e excreção por túbulos de malpighi."],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Atualmente, os seres vivos são classificados em três domínios: Bacteria, Archaea e Eukarya. Todos os eucariotos estão incluídos no domínio Eukarya, e os procariotos estão distribuídos entre os domínios Bacteria e Archaea. Estudos do DNA ribossômico mostraram que os procariotos do domínio Archaea compartilham, com os eucariotos, sequências de bases nitrogenadas, que não estão presentes nos procariotos do domínio Bacteria. Esses resultados apoiam as relações evolutivas representadas na árvore",
      subItens: []
    },
    options: ["(Árvore filogenética A)","(Árvore filogenética B)","(Árvore filogenética C)","(Árvore filogenética D)","(Árvore filogenética E)"],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "A cobra-coral – Erythrolamprus aesculapii – tem hábito diurno, alimenta-se de outras cobras e é terrícola, ou seja, caça e se abriga no chão. A jararaca – Bothrops jararaca – tem hábito noturno, alimenta-se de mamíferos e é terrícola. Ambas ocorrem, no Brasil, na floresta pluvial costeira. Essas serpentes",
      subItens: []
    },
    options: ["disputam o mesmo nicho ecológico.","constituem uma população.","compartilham o mesmo hábitat.","realizam competição intraespecífica.","são comensais."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Nos mamíferos, o óvulo é uma célula que constitui o gameta feminino. Nas fanerógamas (gimnospermas e angiospermas), denomina-se óvulo a estrutura multicelular que contém o gameta feminino. Em mamíferos e fanerógamas, o resultado da fecundação normal quanto ao número de conjuntos cromossômicos é",
      subItens: []
    },
    options: ["embrião diploide e embrião diploide + tecido de reserva diploide ou triploide","embrião diploide e embrião triploide + tecido de reserva triploide","embrião diploide e embrião triploide + tecido de reserva diploide","embrião triploide e embrião diploide + tecido de reserva diploide ou triploide","embrião triploide e embrião diploide ou triploide + tecido de reserva triploide"],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "No contexto do cartum, a presença de numerosos animais de estimação permite que o juízo emitido pela personagem seja considerado",
      subItens: []
    },
    options: ["incoerente.","parcial.","anacrônico.","hipotético.","enigmático."],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "A estratégia de dominação empregada pelo governo Médici, tal como descrita no texto, assemelha-se, sobretudo, à seguinte recomendação feita ao príncipe – ou ao governante – por um célebre pensador da política:",
      subItens: []
    },
    options: ["\"Deve o príncipe fazer-se temer, de maneira que, se não se fizer amado, pelo menos evite o ódio, pois é fácil ser ao mesmo tempo temido e não odiado\".","\"O mal que se tiver que fazer, deve o príncipe fazê-lo de uma só vez; o bem, deve fazê-lo aos poucos (...)\".","“Não se pode deixar ao tempo o encargo de resolver todas as coisas, pois o tempo tudo leva adiante e pode transformar o bem em mal e o mal em bem\".","\"Engana-se quem acredita que novos benefícios podem fazer as grandes personagens esquecerem as antigas injúrias (...)\".","\"Deve o príncipe, sobretudo, não tocar na propriedade alheia, porque os homens esquecem mais depressa a morte do pai que a perda do patrimônio\"."],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Nos trechos \"acabou com o primeiro setor\" (L. 6) e \"alcançar praticamente o controle do setor\" (L. 16-17), a palavra sublinhada refere-se, respectivamente, a",
      subItens: []
    },
    options: ["aliados; população.","adversários; telecomunicações.","população; residências urbanas.","maiorias; classe média.","repressão; facilidades de crédito."],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Considere as seguintes afirmações sobre os dois provérbios citados no terceiro parágrafo do texto. I. A origem do primeiro, de acordo com o autor, está ligada à história do povo que o usa. II. Em seu sentido literal, o segundo expressa costumes peculiares dos húngaros. III. A observação das diferenças de expressão entre esses provérbios pode, segundo o pensamento do autor, ter interesse etnográfico. Está correto apenas o que se afirma em",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Costuma-se reconhecer que Capitães da Areia pertence ao assim chamado \"romance de 1930\", que registra importantes transformações pelas quais passava o Modernismo no Brasil, à medida que esse movimento se expandia e diversificava. No excerto, considerado no contexto do livro de que faz parte, constitui marca desse pertencimento",
      subItens: []
    },
    options: ["o experimentalismo estético, de caráter vanguardista, visível no abundante emprego de neologismos.","o tratamento preferencial de realidades bem determinadas, com foco nos problemas sociais nelas envolvidos.","a utilização do determinismo geográfico e racial, na interpretação dos fatos narrados.","a adoção do primitivismo da \"Arte Negra\" como modelo formal, à semelhança do que fizera o Cubismo europeu.","o uso de recursos próprios dos textos jornalísticos, em especial, a preferência pelo relato imparcial e objetivo."],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "As informações contidas no texto permitem concluir corretamente que a doença de que nele se fala caracteriza-se como",
      subItens: []
    },
    options: ["moléstia contagiosa, de caráter epidêmico, causada por vírus.","endemia de zonas tropicais, causada por vírus, prevalente no período chuvoso do ano.","surto infeccioso de etiologia bacteriana, decorrente de más condições sanitárias.","infecção bacteriana que, em regra, apresenta-se simultaneamente sob uma forma branda e uma grave.","enfermidade endêmica que ocorre anualmente e reflui de modo espontâneo."],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Apesar das diferenças notáveis que existem entre estas obras, um aspecto comum ao texto de Capitães da Areia, considerado no contexto do livro, e Vidas secas, de Graciliano Ramos, é",
      subItens: []
    },
    options: ["a consideração conjunta e integrada de questões culturais e conflitos de classe.","a reprodução fiel da variante oral-popular da linguagem, como recurso principal na caracterização das personagens.","o engajamento nas correntes literárias nacionalistas, que rejeitavam a opção por temas regionais.","o emprego do discurso doutrinário, de caráter panfletário e didatizante, próprio do \"realismo socialista\".","o tratamento enfático e conjugado da mestiçagem racial e da desigualdade social."],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Das propostas de substituição para os trechos sublinhados nas seguintes frases do texto, a única que faz, de maneira adequada, a correção de um erro gramatical presente no discurso do narrador é:",
      subItens: []
    },
    options: ["\"Assim mesmo morrera negro, morrera pobre.\": havia morrido negro, havia morrido pobre.","\"Mas Omolu dizia que não fora o alastrim que matara.\": Omolu dizia, no entanto, que não fora.","\"Eles tinham dinheiro, léguas e léguas de terra, mas não sabiam tampouco da vacina.\": mas tão pouco sabiam da vacina.","\"Mas para que seus filhos negros não o esqueçam [...].\": não lhe esqueçam.","\"E numa noite que os atabaques batiam nas macumbas [...].\": numa noite em que os atabaques."],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Tal como se encontra caracterizado no excerto, o destino alcançado pela personagem Jacinto contrasta de modo mais completo com a maneira pela qual culmina a trajetória de vida da personagem",
      subItens: []
    },
    options: ["Leonardo (filho), de Memórias de um sargento de milícias.","Jão Fera, de Til.","Brás Cubas, de Memórias póstumas de Brás Cubas.","Jerônimo, de O cortiço.","Pedro Bala, de Capitães da Areia."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "TEXTO PARA AS QUESTÕES DE 61 A 63.\nConfidência do Itabirano\nAlguns anos vivi em Itabira.\nPrincipalmente nasci em Itabira.\nPor isso sou triste, orgulhoso: de ferro.\nNoventa por cento de ferro nas calçadas.\nOitenta por cento de ferro nas almas.\nE esse alheamento do que na vida é porosidade e comunicação.\nA vontade de amar, que me paralisa o trabalho,\nvem de Itabira, de suas noites brancas, sem mulheres e sem [horizontes.\nE o hábito de sofrer, que tanto me diverte,\né doce herança itabirana.\nDe Itabira trouxe prendas diversas que ora te ofereço:\neste São Benedito do velho santeiro Alfredo Duval;\nesta pedra de ferro, futuro aço do Brasil;\neste couro de anta, estendido no sofá da sala de visitas;\neste orgulho, esta cabeça baixa...\nTive ouro, tive gado, tive fazendas.\nHoje sou funcionário público.\nItabira é apenas uma fotografia na parede.\nMas como dói!\nCarlos Drummond de Andrade, Sentimento do mundo.\nTendo em vista que o poema de Drummond contém referências a aspectos geográficos e históricos determinados, considere as seguintes afirmações: I. O poeta é \"de ferro\" na medida em que é nativo de região caracterizada pela existência de importantes jazidas de minério de ferro, intensamente exploradas. II. O poeta revela conceber sua identidade como tributária não só de uma geografia, mas também de uma história, que é, igualmente, a da linhagem familiar a que pertence. III. A ausência de mulheres de que fala o poeta refere-se à ampla predominância de população masculina, na zona de mineração intensiva de que ele é originário. Está correto o que se afirma em",
      subItens: []
    },
    options: ["I, somente.","III, somente.","I e II, somente.","II e III, somente.","I, II e III."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "No texto de Drummond, o eu lírico",
      subItens: []
    },
    options: ["considera sua origem itabirana como causadora de deficiências que ele almeja superar.","revela-se incapaz de efetivamente comunicar-se, dado o caráter férreo de sua gente.","ironiza a si mesmo e satiriza a rusticidade de seu passado semirrural mineiro.","dirige-se diretamente ao leitor, tornando assim patente o caráter confidencial do poema.","critica, em chave modernista, o bucolismo da poesia árcade mineira."],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Na última estrofe, a expressão que justifica o uso da conjunção sublinhada no verso \"Mas como dói!\" é:",
      subItens: []
    },
    options: ["\"Hoje\".","\"funcionário público\".","\"apenas\".","\"fotografia”.","\"parede\"."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["A situação verificada deve-se aos efeitos das ondas e marés que comandam a deposição de sedimentos no delta, sem haver influência continental no processo, já que a topografia costeira permite que o oceano alcance o interior do continente.","A modificação na morfologia deve-se às grandes chuvas que ocorrem a montante desse delta e, por tratar-se de drenagem endorreica, o rio carrega considerável volume de sedimentos grosseiros e blocos rochosos, que, aos poucos, depositam-se ao longo da costa.","Além de haver nesse sistema deltaico uma característica carga detrítica fina que, praticamente, excede a capacidade do rio de transportar material erodido e carregado, a modificação verificada foi ampliada pela ocupação antrópica, influenciando o regime deposicional.","O delta é resultante de mudanças climáticas provocadas pela ação humana na exploração de recursos no golfo chinês, nas estações mais quentes e chuvosas, ocasionando a retração da foz e o rebaixamento dos níveis das marés, com o aparecimento dos bancos de areia sobressalentes.","As modificações no delta devem-se ao fato de essa região caracterizar-se como um sistema lacustre, onde há acumulação de matéria orgânica decorrente das inundações provocadas pela construção da barragem da usina hidrelétrica de Três Gargantas."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Há dois lados na divisão internacional do trabalho [DIT]: um em que alguns países especializam-se em ganhar, e outro em que se especializaram em perder. Nossa comarca do mundo, que hoje chamamos de América Latina, foi precoce: especializou-se em perder desde os remotos tempos em que os europeus do Renascimento se abalançaram pelo mar e fincaram os dentes em sua garganta. Passaram os séculos, e a América Latina aperfeiçoou suas funções. Este já não é o reino das maravilhas, onde a realidade derrotava a fábula e a imaginação era humilhada pelos troféus das conquistas, as jazidas de ouro e as montanhas de prata. Mas a região continua trabalhando como um serviçal. Continua existindo a serviço de necessidades alheias, como fonte e reserva de petróleo e ferro, cobre e carne, frutas e café, matérias-primas e alimentos, destinados aos países ricos que ganham, consumindo-os, muito mais do que a América Latina ganha produzindo-os. Eduardo Galeano. As Veias Abertas da América Latina. Rio de Janeiro: Paz e Terra, 1981. Adaptado. Sobre a atual Divisão Internacional do Trabalho (DIT), no que diz respeito à mineração na América Latina, é correto afirmar:",
      subItens: []
    },
    options: ["O México é o país com maior produção de carvão, cuja exportação é controlada por capital canadense. Para tal situação, o padrão de dominação Norte/Sul na DIT, mencionado pelo autor, é praticado no mesmo continente.","A Colômbia ocupa o primeiro lugar na produção mundial de manganês, por meio de empresas privatizadas nos dois últimos governos bolivarianos, o que realça sua posição no cenário econômico internacional, rompendo a dominação Norte/Sul.","O Chile destaca-se pela extração de cobre, principalmente na sua porção centro-norte, que é, em parte, explorado por empresas transnacionais, o que reitera o padrão da DIT mencionado pelo autor.","A Bolívia destaca-se como um dos maiores produtores de ferro da América Latina, e, recentemente, o controle de sua produção passou a ser feito por Conselhos Indígenas. Essa autonomia do País permitiu o rompimento da dominação estadunidense.","O Uruguai é o principal produtor mundial de prata, e o controle de sua extração é feito por empresas transnacionais. Nesse caso, mantém-se o padrão da inserção do país na DIT mencionada pelo autor."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "AS 20 AGLOMERAÇÕES URBANAS MAIS POPULOSAS DO MUNDO\n(Gráfico de barras mostrando as 20 aglomerações urbanas mais populosas do mundo e suas populações em milhões de habitantes)\nAtlas des Migrations. Paris: Éditions Autrement, 2012. Adaptado.\nSobre as 20 aglomerações urbanas mais populosas do mundo, conforme gráfico ao lado, é correto afirmar:",
      subItens: []
    },
    options: ["A maioria delas se encontra na Ásia, e, dentre estas, predominam as localizadas em países com economias desenvolvidas ou em desenvolvimento.","Mais de 50% delas encontram-se em países desenvolvidos, com alto PIB e alta distribuição de renda.","50% delas estão localizadas na América Latina, em países subdesenvolvidos e pouco industrializados.","25% delas estão em países da Europa Oriental, em que há boa distribuição de renda e serviços públicos essenciais gratuitos.","O segundo maior número dessas aglomerações encontra-se em países da África, as quais se caracterizam por baixo IDH."],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Observe o mapa.\nBRASIL - REGIÃO SUDESTE - TURISMO E LAZER\n(Mapa da Região Sudeste do Brasil com pontos turísticos e uma legenda incompleta)\nIBGE, 2012. Adaptado.\nIdentifique a alternativa que completa corretamente a legenda do mapa.",
      subItens: []
    },
    options: ["Histórico-cultural, Ecoturismo, Hidromineral","Ecoturismo, Histórico-cultural, Hidromineral","Hidromineral, Ecoturismo, Histórico-cultural","Ecoturismo, Hidromineral, Histórico-cultural","Hidromineral, Histórico-cultural, Ecoturismo"],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "O mapa representa um dos possíveis trajetos da chamada Ferrovia Transoceânica, planejada para atender, entre outros interesses, ao transporte de produtos agrícolas e de minérios, tornando as exportações possíveis tanto pelo Oceano Atlântico quanto pelo Oceano Pacífico.\nFERROVIA TRANSOCEÂNICA\n(Mapa mostrando o trajeto da Ferrovia Transoceânica no Brasil e Peru, com localidades)\nRevista Agro DBO. São Paulo, junho de 2015.\nConsiderando-se o trajeto indicado no mapa e levando em conta uma sobreposição aos principais Domínios Morfoclimáticos da América do Sul e as faixas de transição entre eles, definidos pelo geógrafo Aziz Ab'Sáber, pode-se identificar a seguinte sequência de Domínios, do Brasil ao Peru:",
      subItens: []
    },
    options: ["Chapadões Florestados, Cerrados, Caatingas, Pantanal, Andes Equatoriais.","Mares de Morros, Pantanal, Chaco Central, Andes Equatoriais.","Chapadões Florestados, Chaco Central, Cerrados, Punas.","Mares de Morros, Cerrados, Amazônico, Andes Equatoriais.","Mares de Morros, Cerrados, Caatingas, Amazônico, Punas."],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "O aparecimento da pólis constitui, na história do pensamento grego, um acontecimento decisivo. Certamente, no plano intelectual como no domínio das instituições, só no fim alcançará todas as suas consequências; a pólis conhecerá etapas múltiplas e formas variadas. Entretanto, desde seu advento, que se pode situar entre os séculos VIII e VII a.C., marca um começo, uma verdadeira invenção; por ela, a vida social e as relações entre os homens tomam uma forma nova, cuja originalidade será plenamente sentida pelos gregos. Jean-Pierre Vernant. As origens do pensamento grego. Rio de Janeiro: Difel, 1981. Adaptado. De acordo com o texto, na Antiguidade, uma das transformações provocadas pelo surgimento da pólis foi",
      subItens: []
    },
    options: ["o declínio da oralidade, pois, em seu território, toda estratégia de comunicação era baseada na escrita e no uso de imagens.","o isolamento progressivo de seus membros, que preferiam o convívio familiar às relações travadas nos espaços públicos.","a manutenção de instituições políticas arcaicas, que reproduziam, nela, o poder absoluto de origem divina do monarca.","a diversidade linguística e religiosa, pois sua difusa organização social dificultava a construção de identidades culturais.","a constituição de espaços de expressão e discussão, que ampliavam a divulgação das ações e ideias de seus membros."],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Os impérios do mundo antigo tinham ampla abrangência territorial e estruturas politicamente complexas, o que implicava custos crescentes de administração. No caso do Império Romano da Antiguidade, são exemplos desses custos:",
      subItens: []
    },
    options: ["as expropriações de terras dos patrícios e a geração de empregos para os plebeus.","os investimentos na melhoria dos serviços de assistência e da previdência social.","as reduções de impostos, que tinham a finalidade de evitar revoltas provinciais e rebeliões populares.","os gastos cotidianos das famílias pobres com alimentação, moradia, educação e saúde.","as despesas militares, a realização de obras públicas e a manutenção de estradas."],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["respeito estrito aos princípios do livre-comércio, que determinavam a obediência às regras internacionais de circulação de mercadorias.","crescimento das relações mercantis, que passaram a envolver territórios mais amplos e distâncias mais longas.","aumento da navegação oceânica, que permitiu o estabelecimento de relações comerciais regulares com a América.","avanço das superstições na Europa ocidental, que se difundiram a partir de contatos com povos do leste desse continente e da Ásia.","aparecimento dos relógios, que foram inventados para calcular a duração das viagens ultramarinas."],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "A exploração da mão de obra escrava, o tráfico negreiro e o imperialismo criaram conflitivas e duradouras relações de aproximação entre os continentes africano e europeu. Muitos países da África, mesmo depois de terem se tornado independentes, continuaram usando a língua dos colonizadores. O português, por exemplo, é língua oficial de",
      subItens: []
    },
    options: ["Camarões, Angola e África do Sul.","Serra Leoa, Nigéria e África do Sul.","Angola, Moçambique e Cabo Verde.","Cabo Verde, Serra Leoa e Sudão.","Camarões, Congo e Zimbábue."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Jacques-Louis David. Governo inglês - o inglês nascido livre, 1794. A imagem pode ser corretamente lida como uma",
      subItens: []
    },
    options: ["defesa do mercantilismo e do protecionismo comercial ingleses, ameaçados pela cobiça de outros impérios, sobretudo o francês.","crítica à monarquia inglesa, vista, no contexto da expansão revolucionária francesa, como opressora da própria sociedade inglesa.","alegoria das pretensões francesas sobre a Inglaterra, já que Napoleão Bonaparte era frequentemente considerado, pela burguesia, um líder revolucionário ateu.","apologia da monarquia e da igreja inglesas, contrárias à laicização da política e dos costumes típicos da Europa da época.","propaganda de setores comerciais ingleses, defensores dos monopólios comerciais e contrários ao livre-cambismo que, à época, ganhava força no país."],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["luta de independência contra a Espanha, no início do século XIX, que erradicou o trabalho livre indígena e fundou a primeira república na América.","colonização francesa do território mexicano, entre os séculos XVI e XIX, que implantou o trabalho escravo indígena na mineração.","reforma liberal, na metade do século XX, quando a Igreja Católica passou a controlar quase todo o território mexicano.","guerra entre Estados Unidos e México, em meados do século XIX, em que o México perdeu quase metade de seu território.","ditadura militar, no final do século XIX, que devolveu às comunidades indígenas do México as terras expropriadas e rompeu com o capitalismo internacional."],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Examine o gráfico.\nVARIAÇÃO DA QUANTIDADE DE NAVIOS NEGREIROS QUE ATRACARAM NO PORTO DO RIO DE JANEIRO, 1796-1830\n(Gráfico de linhas mostrando a variação da quantidade de navios negreiros no Rio de Janeiro entre 1796 e 1830)\nManolo Florentino. Em costas negras. São Paulo: Companhia das Letras, 1997. Adaptado.\nO gráfico fornece elementos para afirmar:",
      subItens: []
    },
    options: ["A despeito de uma ligeira elevação, o tráfico negreiro em direção ao Brasil era pouco significativo nas primeiras décadas do século XIX, pois a mão de obra livre já estava em franca expansão no país.","As grandes turbulências mundiais de finais do século XVIII e de começos do XIX prejudicaram a economia do Brasil, fortemente dependente do trabalho escravo, mas incapaz de obter fornecimento regular e estável dessa mão de obra.","Não obstante pressões britânicas contra o tráfico negreiro em direção ao Brasil, ele se manteve alto, contribuindo para que a ordem nacional surgida com a Independência fosse escravista.","Desde o final do século XVIII, criaram-se as condições para que a economia e a sociedade do Império do Brasil deixassem de ser escravistas, pois o tráfico negreiro estava estagnado.","Rapidamente, o Brasil aderiu à agenda antiescravista britânica formulada no final do século XVIII, firmando tratados de diminuição e extinção do tráfico negreiro e acatando as imposições favoráveis ao trabalho livre."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Na Belle Époque brasileira, que difusamente coincidiu com a transição para o regime republicano, surgiram aquelas perguntas cruciais, envoltas no oxigênio mental da época, muitas das quais, contudo, nos incomodam até hoje: como construir uma nação se não tínhamos uma população definida ou um tipo definido? Frente àquele amálgama de passado e futuro, alimentado e realimentado pela República, quem era o brasileiro? (...) Inúmeras tentativas de respostas a todas estas questões mobilizaram os intelectuais brasileiros durante várias décadas. Elias Thomé Saliba. Raízes do riso. São Paulo: Companhia das Letras, 2002. Entre as tentativas de responder, durante a Belle Époque brasileira, às dúvidas mencionadas no texto, é correto incluir",
      subItens: []
    },
    options: ["as explicações positivistas e evolucionistas sobre o impacto da mistura de raças na formação do caráter nacional brasileiro.","os projetos de valorização dos vínculos entre o caráter nacional brasileiro e os produtos da indústria cultural norte-americana.","o reconhecimento e a celebração da origem africana da maioria dos brasileiros e a rejeição das tradições europeias.","a percepção de que o país estava plenamente inserido na modernidade e havia assumido a condição de potência mundial.","o desejo de retornar ao período anterior à chegada dos europeus e de recuperar padrões culturais e cotidianos indígenas."],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Paralelamente à abertura da Transamazônica processa-se o trabalho da colonização, realizado pelo INCRA (Instituto Nacional de Colonização e Reforma Agrária). As pequenas agrovilas se sucedem de vinte em vinte quilômetros à margem da estrada, e nos cem hectares que cada colono recebeu são plantados milho, feijão e arroz. Já no próximo mês começará a plantação de cana-de-açúcar, cujas primeiras mudas, vindas dos canaviais de Sertãozinho, em São Paulo, acabaram de ser distribuídas. Jovens agrônomos, recém-saídos da universidade, orientam os colonos... No meio da selva começam a surgir as agrovilas. Vindos de diferentes regiões do país, os colonos povoam as margens da Transamazônica e espalham pelo chão virgem o verde disciplinado das culturas pioneiras. Os pastos da região são excelentes. Revista Manchete, 15 de abril de 1972. Segundo o texto, é correto afirmar que a Transamazônica, cuja construção se iniciou no regime militar (1964-1985), representou, inclusive,",
      subItens: []
    },
    options: ["um projeto para eliminar o controle nacional e estatal dos recursos naturais da Amazônia, facilitando o avanço de interesses britânicos na região.","um esforço de ampliar as áreas de ocupação na Amazônia e de construir a ideia de que se vivia um período de avanço, integração e crescimento nacional.","uma superação das dificuldades de comunicação e deslocamento entre o Sul e o Norte do país, facilitando a migração e permitindo plena integração entre os oceanos Atlântico e Pacífico.","uma tentativa de reaquecer a economia da borracha, com a criação de rotas de escoamento rápido da produção em direção aos portos do Sudeste.","um projeto de utilização dessa estrada para delimitar as fronteiras entre os estados da região."],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Segundo o texto, a bactéria Wolbachia, se inoculada nos mosquitos, bloqueia a transmissão da dengue porque",
      subItens: []
    },
    options: ["torna os machos estéreis.","interfere no período de acasalamento dos mosquitos.","impede a multiplicação do vírus nas fêmeas.","impede a eclosão dos ovos que contêm o vírus.","diminui a quantidade de ovos depositados pelas fêmeas."],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Um dos resultados da pesquisa realizada com prestadores de serviços de empresas do tipo \"on-demand\" mostra que esses trabalhadores",
      subItens: []
    },
    options: ["consideram a flexibilidade do horário de trabalho o ponto alto de sua opção profissional.","pagam seus próprios seguros-saúde e planos de aposentadoria.","investem no seu aprimoramento profissional para obter melhores ganhos no futuro.","têm a opção de tirar férias quando desejarem, com o apoio das empresas e dos familiares.","desejam ter os mesmos benefícios sociais que trabalhadores assalariados."],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "Outro resultado da mesma pesquisa indica que",
      subItens: []
    },
    options: ["grande parte dos trabalhadores em empresas \"on-demand\" não pensa em ter um registro formal de trabalho.","nem todos os trabalhadores em empresas \"on-demand\" estão preparados para arcar com o custo de sua flexibilidade no trabalho.","muitos dos entrevistados que prestam serviços nas empresas \"on-demand\" também têm um trabalho formal.","vários dos entrevistados buscam o trabalho “on-demand\" por conta do status que ele proporciona.","as vantagens de um emprego formal são menores se comparadas com as vantagens envolvidas no trabalho \"on-demand\"."],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
