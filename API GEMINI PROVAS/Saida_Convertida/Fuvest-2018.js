...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Na figura, A e B representam duas placas metálicas; a diferença de potencial entre elas é VB - VA = 2,0 x 10⁴ V. As linhas tracejadas 1 e 2 representam duas possíveis trajetórias de um elétron, no plano da figura.\nB\$1_{2}$\$1_{1}$\nA\nX\nConsidere a carga do elétron igual a -1,6 x 10⁻¹⁹ C e as seguintes afirmações com relação à energia cinética de um elétron que sai do ponto X na placa A e atinge a placa B:\nI. Se o elétron tiver velocidade inicial nula, sua energia cinética, ao atingir a placa B, será 3,2 × 10⁻¹⁵ J.\nII. A variação da energia cinética do elétron é a mesma, independentemente de ele ter percorrido as trajetórias 1 ou 2.\nIII. O trabalho realizado pela força elétrica sobre o elétron na trajetória 2 é maior do que o realizado sobre o elétron na trajetória 1.\nApenas é correto o que se afirma em",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Atualmente são usados LEDs (Light Emitting Diode) na iluminação doméstica. LEDs são dispositivos semicondutores que conduzem a corrente elétrica apenas em um sentido. Na figura, há um circuito de alimentação de um LED (L) de 8 W, que opera com 4 V, sendo alimentado por uma fonte (F) de 6 V.\nR\nF L\nO valor da resistência do resistor (R), em Ω, necessário para que o LED opere com seus valores nominais é, aproximadamente,",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Uma das substâncias utilizadas em desinfetantes comerciais é o perácido de fórmula CH₃CO₃H. A formulação de um dado desinfetante encontrado no comércio consiste em uma solução aquosa na qual existem espécies químicas em equilíbrio, como representado a seguir. (Nessa representação, a fórmula do composto 1 não é apresentada.)\nH₃C\nOOH\n+ H₂O\ncomposto 1 + H₂O₂\nAo abrir um frasco desse desinfetante comercial, é possível sentir o odor característico de um produto de uso doméstico. Esse odor é de",
      subItens: []
    },
    options: ["amônia, presente em produtos de limpeza, como limpa-vidros.","álcool comercial, ou etanol, usado em limpeza doméstica.","acetato de etila, ou etanoato de etila, presente em removedores de esmalte.","cloro, presente em produtos alvejantes.","ácido acético, ou ácido etanoico, presente no vinagre."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "A mandioca, uma das principais fontes de carboidratos da alimentação brasileira, possui algumas variedades conhecidas popularmente como \"mandioca brava\", devido a sua toxicidade. Essa toxicidade se deve à grande quantidade de cianeto de hidrogênio (HCN) liberado quando o tecido vegetal é rompido. Após cada etapa do processamento para a produção de farinha de mandioca seca, representado pelo esquema a seguir, quantificou-se o total de HCN nas amostras, conforme mostrado no gráfico que acompanha o esquema.\nAmostra I\n(Mandioca fresca\ne descascada)\nEtapa 1:\nTrituração\nAmostra II\n(Mandioca fresca\ntriturada)\nEtapa 2: Prensagem e extração do\nlíquido residual (manipueira)\nAmostra III\n(Massa prensada)\nEtapa 3:\nTorração (160 °C)\nAmostra IV\n(Farinha torrada)\nQuantidade total de HCN (mg/kg)\$1_{160}$\$1_{140}$-\$1_{120}$\$1_{100}$\$1_{80}$\$1_{60}$\$1_{40}$\$1_{20}$-\$1_{0}$\nAmostra II\nAmostra III\nAmostra IV\nEtapas do processamento da mandioca\nO que ocorre com o HCN nas Etapas 2 e 3?",
      subItens: []
    },
    options: ["Etapa 2: HCN é insolúvel em água, formando um precipitado. Etapa 3: HCN é volatilizado durante a torração, sendo liberado no ar.","Etapa 2: HCN é insolúvel em água, formando uma única fase na manipueira. Etapa 3: HCN permanece na massa torrada, não sendo afetado pela temperatura.","Etapa 2: HCN é solúvel em água, sendo levado na manipueira. Etapa 3: HCN permanece na massa torrada, não sendo afetado pela temperatura.","Etapa 2: HCN é solúvel em água, sendo levado na manipueira. Etapa 3: HCN é volatilizado durante a torração, sendo liberado no ar.","Etapa 2: HCN é insolúvel em água, formando um precipitado. Etapa 3: A 160 °C, a ligação C≡N é quebrada, degradando as moléculas de HCN."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["oxidação; semifino.","neutralização; virgem fino.","oxidação, virgem fino.","neutralização; extra virgem.","neutralização, semifino."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Analise a tabela periódica e as seguintes afirmações a respeito do elemento químico enxofre (S):\$1_{1}$\$1_{1}$ Η 2\$1_{2}$ Li Be\$1_{3}$ Na Mg 3 4\$1_{4}$ K Ca Sc Ti\$1_{5}$ Rb Sr Y\$1_{6}$ Cs Ba\$1_{6}$ 5\$1_{18}$\$1_{13}$ 14 15 16 17 He\nBCNO F Ne\$1_{7}$ 8 9 10 11 12 Al Si P S Cl Ar\nV Cr Mn Fe Co Ni Cu Zn Ga Ge As Se Br Kr\nZr Nb Mo Tc Ru Rh Pd Ag Cd In Sn Sb Te I Xe\nHf Ta W Re Os Ir Pt Au Hg Tl Pb Bi Po At Rn\$1_{7}$ Fr Ra ** Rf Db Sg Bh Hs Mt Ds Rg Cn Nh Fl Mc Lv Ts Og\n*\n*\nLa Ce Pr Nd Pm Sm Eu Gd Tb Dy Ho Er Tm Yb Lu\n** Ac Th Pa U Np Pu Am Cm Bk Cf Es Fm Md No Lr\nI. Tem massa atômica maior do que a do selênio (Se).\nII. Pode formar com o hidrogênio um composto molecular de fórmula H₂S.\nIII. A energia necessária para remover um elétron da camada mais externa do enxofre é maior do que para o sódio (Na).\nIV. Pode formar com o sódio (Na) um composto iônico de fórmula Na₃S.\nSão corretas apenas as afirmações",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Considere as figuras pelas quais são representados diferentes sistemas contendo determinadas substâncias químicas. Nas figuras, cada círculo representa um átomo, e círculos de tamanhos diferentes representam elementos químicos diferentes.\$1_{1}$\$1_{2}$\$1_{3}$\$1_{4}$\$1_{5}$\$1_{6}$\nA respeito dessas representações, é correto afirmar que os sistemas",
      subItens: []
    },
    options: ["3, 4 e 5 representam misturas.","1, 2 e 5 representam substâncias puras.","2 e 5 representam, respectivamente, uma substância molecular e uma mistura de gases nobres.","6 e 4 representam, respectivamente, uma substância molecular gasosa e uma substância simples.","1 e 5 representam substâncias simples puras."],
    correctAnswer: 2,
    materia: "Química – Estudo da Matéria",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Considere um aquário tampado contendo apenas água e plantas aquáticas, em grande quantidade, e iluminado somente por luz solar. O gráfico que melhor esboça a variação de pH da água em função do horário do dia, considerando que os gases envolvidos na fotossíntese e na respiração das plantas ficam parcialmente dissolvidos na água, é:\n(A) Aumento de pH Noite Dia Noite\n(D) Aumento de pH Noite Dia Noite\n(B) Aumento de pH Noite Dia Noite\n(E) Aumento de pH Noite Dia Noite\n(C) Aumento de pH Noite Dia Noite",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Neste texto, o autor descreve o fascínio que as descobertas em Química exerciam sobre ele, durante sua infância.\nEu adorava Química em parte por ela ser uma ciência de transformações, de inúmeros compostos baseados em algumas dúzias de elementos, eles próprios fixos, invariáveis e eternos. A noção de estabilidade e de invariabilidade dos elementos era psicologicamente crucial para mim, pois eu os via como pontos 5 fixos, como âncoras em um mundo instável. Mas agora, com a radioatividade, chegavam transformações das mais incríveis.\n(...)\nA radioatividade não alterava as realidades da Química ou a noção de elementos; não abalava a ideia de sua 10 estabilidade e identidade. O que ela fazia era aludir a duas esferas no átomo uma esfera relativamente superficial e acessível, que governava a reatividade e a combinação química, e uma esfera mais profunda, inacessível a todos os agentes químicos e físicos usuais e suas energias relativamente 15 pequenas, onde qualquer mudança produzia uma alteração fundamental de identidade.\nOliver Sacks, Tio Tungstênio: Memórias de uma infância química.\nDe acordo com o autor,",
      subItens: []
    },
    options: ["o trecho \"eles próprios fixos, invariáveis e eternos\" (L. 3) remete à dificuldade para a quebra de ligações químicas, que são muito estáveis.","\"esfera relativamente superficial\" (L. 12) e \"esfera mais profunda\" (L. 14) dizem respeito, respectivamente, à eletrosfera e ao núcleo dos átomos.","\"esfera relativamente superficial\" (L. 12) e \"esfera mais profunda\" (L. 14) referem-se, respectivamente, aos elétrons da camada de valência, envolvidos nas reações químicas, e aos elétrons das camadas internas dos átomos, que não estão envolvidos nas reações químicas.","as energias envolvidas nos processos de transformação de um átomo em outro, como ocorre com materiais radioativos, são \"relativamente pequenas\" (L. 15-16).","a expressão \"uma alteração fundamental de identidade\" (L. 16-17) relaciona-se à capacidade que um mesmo átomo tem de fazer ligações químicas diferentes, formando compostos com propriedades distintas das dos átomos isolados."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Doze pontos são assinalados sobre quatro segmentos de reta de forma que três pontos sobre três segmentos distintos nunca são colineares, como na figura.\nO número de triângulos distintos que podem ser desenhados com os vértices nos pontos assinalados é",
      subItens: []
    },
    options: ["200.","204.","208.","212.","220."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Sejam Df e Dg os maiores subconjuntos de R nos quais estão definidas, respectivamente, as funções reais\nf(x) = x³+2x²-4x-8 / x-2 e g(x) = √(x³+2x²-4x-8) / x-2\nConsidere, ainda, If e Ig as imagens de f e de g, respectivamente.\nNessas condições,",
      subItens: []
    },
    options: ["Df = Dg e If = Ig.","tanto Df e Dg quanto If e Ig diferem em apenas um ponto.","Df e Dg diferem em apenas um ponto, If e Ig diferem em mais de um ponto.","Df e Dg diferem em mais de um ponto, If e Ig diferem em apenas um ponto.","tanto Df e Dg quanto If e Ig diferem em mais de um ponto."],
    correctAnswer: 4,
    materia: "Matemática – Funções",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Prolongando-se os lados de um octógono convexo ABCDEFGH, obtém-se um polígono estrelado, conforme a figura.\nα₃\nα₅\nE D\nα₆\nF\nC\nB\nG\nα₇ H A\nα₈\nα₂\nA soma α₁ + ⋯ + α₈ vale",
      subItens: []
    },
    options: ["180°.","360°.","540°.","720°.","900°."],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: ["0 < a < 1 e 0 < β <1.","a > 1 e 0 < β <1.","a = 1 e β > 1.","0 < a < 1 e β > 1.","0 < a < 1 e β = 1."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Considere o polinômio\nP(x) = xⁿ + aₙ₋₁xⁿ⁻¹ + ... + a₁x + a₀,\nem que a₀,..., aₙ₋₁ ∈ R. Sabe-se que as suas n raízes estão sobre a circunferência unitária e que a₀ < 0.\nO produto das n raízes de P(x), para qualquer inteiro n ≥ 1, é:",
      subItens: []
    },
    options: ["-1","iⁿ","iⁿ⁺¹","(-1)ⁿ","(-1)ⁿ⁺¹"],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "O quadrilátero da figura está inscrito em uma circunferência de raio 1. A diagonal desenhada é um diâmetro dessa circunferência.\nx\ny\nSendo x e y as medidas dos ângulos indicados na figura, a área da região cinza, em função de x e y, é:",
      subItens: []
    },
    options: ["π + sen(2x) + sen(2y)","π – sen(2x) – sen(2y)","π – cos(2x) – cos(2y)","π - (cos(2x) + cos(2y))/2","π - (sen(2x) + sen(2y))/2"],
    correctAnswer: 1,
    materia: "Matemática – Geometria Plana",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Dois atletas correm com velocidades constantes em uma pista retilínea, partindo simultaneamente de extremos opostos, A e B. Um dos corredores parte de A, chega a B e volta para A. O outro corredor parte de B, chega a A e volta para B. Os corredores cruzam-se duas vezes, a primeira vez a 800 metros de A e a segunda vez a 500 metros de B. O comprimento da pista, em metros, é",
      subItens: []
    },
    options: ["1.000.","1.300.","1.600.","1.900.","2.100."],
    correctAnswer: 3,
    materia: "Física – Cinemática",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Borboleta, lula e avestruz têm como principal excreta nitrogenado, respectivamente,",
      subItens: []
    },
    options: ["ácido úrico, amônia e ácido úrico.","ácido úrico, ureia e amônia.","amônia, ácido úrico e amônia.","amônia, ureia e ácido úrico.","ureia, amônia e ácido úrico."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "No sistema circulatório humano,",
      subItens: []
    },
    options: ["a veia cava superior transporta sangue pobre em oxigênio, coletado da cabeça, dos braços e da parte superior do tronco, e chega ao átrio esquerdo do coração.","a veia cava inferior transporta sangue pobre em oxigênio, coletado da parte inferior do tronco e dos membros inferiores, e chega ao átrio direito do coração.","a artéria pulmonar transporta sangue rico em oxigênio, do coração até os pulmões.","as veias pulmonares transportam sangue rico em oxigênio, dos pulmões até o átrio direito do coração.","a artéria aorta transporta sangue rico em oxigênio para o corpo, por meio da circulação sistêmica, e sai do ventrículo direito do coração."],
    correctAnswer: 1,
    materia: "Biologia – Fisiologia Humana",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "No grupo dos fungos, são conhecidas perto de 100 mil espécies. Esse grupo tão diverso inclui espécies que",
      subItens: []
    },
    options: ["são sapróbias, fundamentais na ciclagem dos nutrientes, pois sintetizam açúcares a partir do dióxido de carbono do ar.","são parasitas, procariontes heterotróficos que absorvem compostos orgânicos produzidos pelos organismos hospedeiros.","são comestíveis, pertencentes a um grupo de fungos primitivos que não formam corpos de frutificação.","formam, com as raízes de plantas, associações chamadas micorrizas, mutuamente benéficas, pela troca de nutrientes.","realizam respiração, na presença de oxigênio, e fotossíntese, na ausência desse gás, sendo, portanto, anaeróbias facultativas."],
    correctAnswer: 3,
    materia: "Biologia – Reinos",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "A surdez é geneticamente heterogênea: pode ser causada por mutações em diferentes genes, localizados nos autossomos ou no cromossomo X ou, ainda, por mutações em genes mitocondriais.\nOs heredogramas representam quatro famílias, em que ocorrem pessoas com surdez (quadrado escuro e círculo escuro):\nFamília 1\nFamília 2\nFamília 3\nFamília 4\nA(s) família(s) em que o padrão de herança permite afastar a possibilidade de que a surdez tenha herança mitocondrial é(são) apenas",
      subItens: []
    },
    options: ["1.","2 e 3.","3.","3 e 4.","4."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Células de embrião de drosófila (2n=8), que estavam em divisão, foram tratadas com uma substância que inibe a formação do fuso, impedindo que a divisão celular prossiga. Após esse tratamento, quantos cromossomos e quantas cromátides, respectivamente, cada célula terá?",
      subItens: []
    },
    options: ["4 e 4.","4 e 8.","8 e 8.","8 e 16.","16 e 16."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "O botulismo provocou a morte de 1,1 mil cabeças de gado, no último mês de agosto, numa fazenda em Mato Grosso do Sul. A suspeita clínica inicial foi confirmada pelo exame das amostras de grãos úmidos de milho fornecidos aos animais, demonstrando a presença da toxina botulínica, que é produzida pela bactéria Clostridium botulinum. Considerando que a toxina botulínica bloqueia a transmissão neuromuscular, a morte dos animais deve ter sido decorrente de",
      subItens: []
    },
    options: ["infecção generalizada.","hemorragia interna.","desidratação provocada por diarreia.","acidente vascular cerebral.","parada respiratória."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "A levedura Saccharomyces cerevisiae pode obter energia na ausência de oxigênio, de acordo com a equação\nC₆H₁₂O₆ → 2 CO₂ + 2 CH₃CH₂OH + 2 ATP.\nProdutos desse processo são utilizados na indústria de alimentos e bebidas. Esse processo ocorre _________ da levedura e seus produtos são utilizados na produção de _________.\nAs lacunas dessa frase devem ser preenchidas por:",
      subItens: []
    },
    options: ["nas mitocôndrias; cerveja e vinagre.","nas mitocôndrias; cerveja e pão.","no citosol; cerveja e pão.","no citosol; iogurte e vinagre.","no citosol e nas mitocôndrias; cerveja e iogurte."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Considere estas três reações químicas realizadas por seres vivos:\nI. Fotossíntese\nluz\$1_{6}$ H₂O + 6 CO₂→6 O₂ + C₆H₁₂O₆\nII. Quimiossíntese metanogênica\nCO₂ + 4 H₂ → CH₄ + 2 H₂O\nIII. Respiração celular\$1_{6}$ O₂ + C₆H₁₂O₆ → 6 H₂O + 6 CO₂\nA mudança no estado de oxidação do elemento carbono em cada reação e o tipo de organismo em que a reação ocorre são:",
      subItens: []
    },
    options: ["I: redução; autotrófico. II: redução; autotrófico. III: oxidação; heterotrófico e autotrófico.","I: oxidação; autotrófico. II: oxidação; heterotrófico. III: oxidação; autotrófico.","I: redução; autotrófico. II: oxidação; autotrófico. III: oxidação; heterotrófico e autotrófico.","I: oxidação; autotrófico e heterotrófico. II: redução; autotrófico. III: oxidação; autotrófico.","I: oxidação; heterotrófico. II: oxidação; autotrófico. III: redução; heterotrófico."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Nas últimas décadas, descobriu-se que os volumosos e inadequados descartes de resíduos plásticos e de outros materiais sintéticos, mesmo quando realizados nos continentes, podem resultar em consideráveis depósitos em áreas distantes nos oceanos e mares, seja em seu fundo, na coluna d'água, ou na sua superfície. Como consequência, ocorrem mudanças físicas, químicas e ecológicas nesses oceanos e mares, em que alguns desses depósitos já atingem a escala planetária, como é o caso dos materiais plásticos flutuantes representados na figura.\nwww.revistapesquisafapesp.br, maio de 2016.\nDEPÓSITOS FLUTUANTES DE RESÍDUOS\nPLÁSTICOS NOS OCEANOS\nLEGENDA\nPresença esparsa de material.\nÁrea de moderada acumulação.\nÁrea de média acumulação.\nÁrea de alta acumulação.\nGiro oceânico.\nOcean Trash Map - National Geographic.\nwww.news.nationalgeographic.com. Adaptado.\nOs depósitos flutuantes representados na figura apresentam-se",
      subItens: []
    },
    options: ["com padrões concentrados na parte interna dos giros oceânicos do Pacífico norte e sul, locais de menor atividade das grandes correntes marinhas.","com maior acumulação no litoral de ambos os hemisférios, devido à atuação de importantes correntes marinhas nessas áreas.","mais volumosos no hemisfério norte, em função das menores temperaturas de suas águas, o que faz aumentar a velocidade de correntes, como a do Peru e a do Japão.","com concentrações idênticas em ambos os hemisférios, devido à forte atuação de importantes correntes marinhas que transitam do hemisfério norte ao sul.","mais concentrados e abundantes no hemisfério norte, devido à grande mobilidade de importantes correntes marinhas, como a de Humboldt e a de Madagascar."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Contemporaneamente, pode-se definir a sociedade mundial como a do petróleo, devido à participação desta matéria-prima em inúmeros produtos e atividades humanas. A utilização deste recurso natural data de muitos séculos, mas sua exploração e beneficiamento se expandiram somente a partir do século XX. A respeito desse recurso natural, é correto afirmar:",
      subItens: []
    },
    options: ["Houve uma forte redução do preço do barril, no início da década de 1970, por conta dos resultados das pesquisas envolvendo novos procedimentos de extração e refino.","A estatização, no Brasil, do transporte e do refino de petróleo iniciou-se no final dos anos 1930 sob o governo de Juscelino Kubitschek.","O início de seu uso como fonte de energia se deu em 1920, na Inglaterra, com a descoberta de reservas pouco profundas.","No final dos anos 1920, sete empresas petrolíferas mundiais constituíram um cartel controlador da extração, transporte, refino e distribuição do petróleo.","Os Estados Unidos possuem reservas ilimitadas de petróleo, o que ocasiona independência em relação aos países participantes da OPEP."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Observe os mapas referentes à delimitação da bacia hidrográfica do rio Xingu, com o detalhamento da parte sul, onde fica o Parque Indígena do Xingu (PIX).\nMASSAS DE AR QUE ATUAM NO TERRITÓRIO BRASILEIRO\nEQUADOR\nD\nX\nW\nZ\nV\nTRÓPICO DE CAPRICÓRNIO\nOCEANO\nPACÍFICO\nOCEANO\nATLÂNTICO\nY\$1_{0}$ 801 km\nM.E. Simielli. Geoatlas, 2010. Adaptado.\nO Brasil possui um território extenso, com 92% pertencentes à zona intertropical. As massas de ar que atuam em território brasileiro possuem influências oceânicas e continentais. Sobre as características dessas massas de ar, é correto afirmar:",
      subItens: []
    },
    options: ["W representa a Massa Equatorial Atlântica de ar quente e úmido, responsável pela grande umidade na Amazônia.","Y indica a Massa Polar Atlântica, que se desloca a partir do sul em direção ao norte do território brasileiro e tem como característica a presença de ar frio, podendo atingir a região Centro-Oeste no inverno.","Z indica a Massa Tropical Continental, que tem como característica a presença de ar quente e úmido, ocasionando alagamentos no Centro-Oeste no inverno.","X indica a Massa Equatorial Continental de ar quente e seco, que atua no nordeste do litoral brasileiro.","V representa a Massa Temperada Atlântica de ar frio e seco, que atua no sul do litoral brasileiro."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "No mundo virtual, milhões de pessoas falam, compram, compartilham dados e se reúnem para tratar dos mais variados assuntos.\nNas figuras, os números mostram a movimentação média, em 1 minuto, de algumas das principais empresas e ferramentas de internet nos anos de 2015 e 2017.\$1_{2015}$\nYou Tube\$1_{2}$,78 milhões 204 milhões de\nde visualizações e-mails enviados\nGoogle\nUBER\$1_{2}$,4 milhões\nde buscas\$1_{694}$\ncorridas\nUS$119.760,00\nem vendas\$1_{13}$.300\nmúsicas ouvidas\nSpotify\$1_{123}$.060\nnovas postagens\$1_{547}$.200\nnovos tweets\namazon\$1_{2017}$\nYou Tube\nde visualizações e-mails enviados\namazon\$1_{4}$,1 milhões 156 milhões de\nUBER\$1_{3833}$\ncorridas\nGoogle\$1_{3}$,5 milhões\nde buscas\$1_{46}$.875\nmúsicas ouvidas\nSpotify\$1_{41}$.666\nnovas postagens\nUS$265.273,00\$1_{350}$.000\nem vendas\nnovos tweets\nwww.excelacom.com. Adaptado.\nSobre a internet e os números mostrados nas figuras, é correto afirmar:",
      subItens: []
    },
    options: ["Após um crescimento até a primeira década do século XXI, as ferramentas na internet apresentaram estagnação de utilização nos últimos anos.","Para todos os governos do mundo, independentemente do regime, a democratização da internet é uma ação estratégica.","O controle de dados e informações é descentralizado, o que confere equanimidade aos países membros da ONU.","A internet está em constante e rápida mudança, com novas ferramentas aparecendo com contribuições relevantes, enquanto outras vão perdendo espaço.","Empresas do ramo de serviços têm apresentado crescimento acentuado, o que não é observado em relação a empresas do ramo de entretenimento."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "As casinhas eram alugadas por mês e as tinas por dia; e tudo pago adiantado. O preço de cada tina, metendo a água, quinhentos réis; sabão à parte. As moradoras do cortiço tinham preferência e não pagavam nada para lavar.\n(...) E, mal vagava uma das casinhas, ou um quarto, um canto onde coubesse um colchão, surgia uma nuvem de pretendentes a disputá-los.\nE aquilo se foi constituindo numa grande lavanderia, agitada e barulhenta, com as suas cercas de varas, as suas hortaliças verdejantes e os seus jardinzinhos de três e quatro palmos, que apareciam como manchas alegres por entre a negrura das limosas tinas transbordantes e o revérbero das claras barracas de algodão cru, armadas sobre os lustrosos bancos de lavar.\nAluísio Azevedo, O cortiço.\nNas cidades brasileiras, particularmente no último quartel do século XIX, novas formas urbanas são constituídas, como os cortiços e as favelas. Sobre esse fenômeno, é correto afirmar:",
      subItens: []
    },
    options: ["A expansão periférica no século XIX, na zona sul da cidade do Rio de Janeiro, teve significativa presença de cortiços, devido à chegada massiva de imigrantes japoneses.","A primeira favela carioca teve sua origem no forte empobrecimento da população no contexto da crise cafeeira na região serrana do Rio de Janeiro.","A maior concentração dos cortiços da cidade de São Paulo, presentes no último quartel do século XIX, localizava-se na porção mais central da aglomeração urbana.","As primeiras favelas brasileiras se originaram devido à expansão da atividade industrial, no centro da cidade de São Paulo, no início do último quartel do século XIX.","Nas cidades do Vale do Paraíba, durante a expansão cafeeira, os cortiços eram muito frequentes, por conta da presença de imigrantes italianos empobrecidos."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "As primeiras práticas de agricultura datam de, aproximadamente, 10.000 anos. Neste período, ocorreram inúmeras transformações na sua base técnica, mas é, no decorrer da segunda metade do século XX, que a revolução agrícola contemporânea, fundada na elevada motorização-mecanização, na seleção de variedades de plantas e de raças de animais e na ampla utilização de corretores de pH dos solos, de fertilizantes, de ração animal e de insumos químicos para as plantas e para os animais domésticos, progrediu vigorosamente nos países desenvolvidos e em alguns setores limitados dos países subdesenvolvidos.\nMarcel Mazoyer & Laurence Roudart. História das agriculturas no mundo: do neolítico à crise contemporânea,\nSão Paulo: Unesp; Brasília: NEAD, 2010. Adaptado.\nAs transformações ocorridas na agricultura após meados do século XX foram reconhecidas como revolução verde, sobre a qual se pode afirmar:",
      subItens: []
    },
    options: ["Sua concepção foi desenvolvida no Japão e nos Tigres Asiáticos após a II Guerra Mundial.","Contribuiu para a ampliação da diversificação das espécies e do controle das sementes pelos pequenos agricultores.","Seus parâmetros produtivos estavam fundados, desde sua origem, em preservar e proteger a biodiversidade nas áreas de cultivo.","Com sua expansão, na África e no sudeste Asiático, as populações rurais puderam alcançar padrões de consumo semelhantes aos das grandes metrópoles.","Foi baseada na inovação científica e está atrelada à grande produção de grãos em extensas áreas de monocultura."],
    correctAnswer: 4,
    materia: "Geografia – Geografia Agrária",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Observe os mapas referentes à delimitação da bacia hidrográfica do rio Xingu, com o detalhamento da parte sul, onde fica o Parque Indígena do Xingu (PIX).\nDELIMITAÇÃO DA PARTE SUL DA\nBACIA DO RIO XINGU - DESMATAMENTO\nPIX\nLOCALIZAÇÃO DA BACIA\nHIDROGRÁFICA DO RIO XINGU\nLEGENDA\nPIX - Parque Indígena do Xingu.\nDemais terras indígenas e unidades\nde conservação.\nVegetação nativa.\nÁreas com desmatamento.\$1_{0}$ 103 km\nA Bacia do Rio Xingu em Mato Grosso. Cartô Brasil Socioambiental.\nInstituto Socioambiental. São Paulo, 2010. Adaptado.\nCom relação às áreas delimitadas nos mapas, está correto o que se afirma em:",
      subItens: []
    },
    options: ["Devido ao avanço do desmatamento nessa bacia hidrográfica nas últimas quatro décadas, processo iniciado pela atividade pecuária ao longo dos rios e seguido pelo avanço da monocultura de eucalipto, inviabilizam-se quaisquer ações de recuperação e de conservação do bioma Amazônico.","O Parque Indígena do Xingu, criado principalmente para proteger diversas etnias indígenas, atua hoje como inibidor do avanço do desmatamento, função esperada para as diversas unidades de conservação previstas pelo Sistema Nacional de Unidades de Conservação.","Dentre as grandes bacias hidrográficas amazônicas, a bacia hidrográfica do rio Xingu, na disposição leste-oeste, é uma das bacias da margem esquerda do rio Amazonas com importante conectividade entre dois biomas brasileiros: a Caatinga e o bioma Amazônico, ambos biológica e geologicamente diversos.","O desmatamento, observado no mapa, é resultado da monocultura de babaçu, praticada pelos indígenas que extraem seu óleo e vendem-no para indústrias de cosméticos.","O avanço do desmatamento nessa área deve-se às monoculturas de cana-de-açúcar e laranja, ambas cultivadas com variedades transgênicas adaptadas ao bioma Amazônico."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Os Impérios helenísticos, amálgamas ecléticas de formas gregas e orientais, alargaram o espaço da civilização urbana da Antiguidade clássica, diluindo-lhe a substância [...].\nDe 200 a.C. em diante, o poder imperial romano avançou para leste [...] e nos meados do século II as suas legiões haviam esmagado todas as barreiras sérias de resistência do Oriente.\nP. Anderson. Passagens da Antiguidade ao feudalismo.\nPorto: Afrontamento, 1982.\nNa região das formações sociais gregas,",
      subItens: []
    },
    options: ["a autonomia das cidades-estado manteve-se intocável, apesar da centralização política implementada pelos imperadores helenísticos.","essas formações e os impérios helenísticos constituíram-se com o avanço das conquistas espartanas no período posterior às guerras no Peloponeso, ao final do século V a.C.","a conquista romana caracterizou-se por uma forte ofensiva frente à cultura helenística, impondo a língua latina e cerceando as escolas filosóficas gregas.","o Oriente tornou-se área preponderante do Império Romano a partir do século III d.C., com a crise do escravismo, que afetou mais fortemente sua parte ocidental.","os espaços foram conquistados pelas tropas romanas, na Grécia e na Ásia Menor, em seu período de apogeu, devido às lutas intestinas e às rivalidades entre cidades-estado."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["o cristianismo se desenvolveu a partir do mundo rural, enquanto a religião muçulmana teve como base inicial as cidades e os povoados da península arábica.","a concentração humana assemelhava-se nas clareiras e nos oásis, que se constituíam como células econômicas, sociais e culturais, tanto da Cristandade quanto do Islã.","a Cristandade é considerada o negativo do Islã, pela ausência de cidades, circuitos mercantis e transações monetárias, que abundavam nas formações sociais islâmicas.","o clero cristão, defensor do monoteísmo estrito, combateu as práticas pagās muçulmanas, arraigadas nas florestas e nas regiões desérticas da Cristandade ocidental.","a expansão econômica islâmica caracterizou-se pela ampliação das fronteiras de cultivo, em detrimento das florestas, em um movimento inverso àquele verificado no Ocidente medieval."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "A respeito dos espaços econômicos do açúcar e do ouro no Brasil colonial, é correto afirmar:",
      subItens: []
    },
    options: ["A pecuária no sertão nordestino surgiu em resposta às demandas de transporte da economia mineradora.","A produção açucareira estimulou a formação de uma rede urbana mais ampla do que a atividade aurífera.","O custo relativo do frete dos metais preciosos viabilizou a interiorização da colonização portuguesa.","A mão de obra escrava indígena foi mais empregada na exploração do ouro do que na produção de açúcar.","Ambas as atividades produziram efeitos similares sobre a formação de um mercado interno colonial."],
    correctAnswer: 2,
    materia: "História – História do Brasil",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Na edição de julho de 1818 do Correio Braziliense, o jornalista Hipólito José da Costa, residente em Londres, publicou a seguinte avaliação sobre os dilemas então enfrentados pelo Império português na América:\nA presença de S.M. [Sua Majestade Imperial] no Brasil lhe dará ocasião para ter mais ou menos influência naqueles acontecimentos; a independência em que el-rei ali se acha das intrigas europeias o deixa em liberdade para decidir-se nas ocorrências, segundo melhor convier a seus interesses. Se volta para Lisboa, antes daquela crise se decidir, não poderá tomar parte nos arranjamentos que a nova ordem de coisas deve ocasionar na América.\nNesse excerto, o autor referia-se",
      subItens: []
    },
    options: ["aos desdobramentos da Revolução Pernambucana do ano anterior, que ameaçara o domínio português sobre o centro-sul do Brasil.","às demandas da Revolução Constitucionalista do Porto, exigindo a volta imediata do monarca a Portugal.","à posição de independência de D. João VI em relação às pressões da Santa Aliança para que interviesse nas guerras do rio da Prata.","às implicações que os movimentos de independência na América espanhola traziam para a dominação portuguesa no Brasil.","ao projeto de D. João VI para que seu filho D. Pedro se tornasse imperador do Brasil independente."],
    correctAnswer: 3,
    materia: "História – História do Brasil",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Aqui no Chile estava se construindo, entre imensas dificuldades, uma sociedade verdadeiramente justa, erguida sobre a base de nossa soberania, de nosso orgulho nacional, do heroísmo dos melhores habitantes do Chile. Do nosso lado, do lado da revolução chilena, estavam a constituição e a lei, a democracia e a esperança.\nPablo Neruda. Confesso que vivi. Memórias. Rio de Janeiro: Difel, 1980.\nNesse texto,",
      subItens: []
    },
    options: ["\"soberania\" está relacionada às campanhas de privatização das minas de estanho e salitre, que até então eram mantidas por capitais anglo-americanos.","\"heroísmo\" refere-se aos embates armados, travados com setores da democracia cristã e com as comunidades indígenas dos araucanos.","\"a constituição e a lei\" é uma referência ao novo ordenamento jurídico implantado após o golpe promovido pela Unidade Popular.","\"democracia\" alude a um traço peculiar da via chilena para o socialismo, pois o presidente Salvador Allende chegou ao poder pelo voto.","\"esperança\" traduz a expectativa resultante do apoio econômico e estratégico que havia sido obtido junto aos Estados Unidos e França."],
    correctAnswer: 3,
    materia: "História – História Contemporânea",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "O futurismo de Marinetti e o fascismo de Benito Mussolini têm em comum",
      subItens: []
    },
    options: ["a constatação da falência cultural da Itália, que se agarrou ao passado romano e ignorou os grandes avanços da Primeira Revolução Industrial.","o desejo de proporcionar aos cidadãos italianos o acesso aos bens de consumo e a implantação do Estado de bem-estar social.","o esforço de modernização cultural e a tentativa de demolir as edificações que restaram do passado romano.","a valorização e a adoção das bases e dos princípios das teorias revolucionárias anarquistas e socialistas.","a glorificação da ideologia da guerra e da velocidade proporcionada pelos avanços técnicos e militares."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Examine o cartum.\n• GPS NÃO VAI\nRESOLVER NOSSO\nPROBLEMA DE\n\"LOCALIZAÇÃO\"\nLINGUÍSTICA.\nE-mail:ThavesOne@aol.com\n©2017 Thaves/Dist. by Andrews McMeel Synd.\$1_{8}$-22\nTHAVES\nFrank e Ernest - Bob Thaves. O Estado de S. Paulo. 22.08.2017.\nO efeito de humor presente no cartum decorre, principalmente, da",
      subItens: []
    },
    options: ["semelhança entre a língua de origem e a local.","falha de comunicação causada pelo uso do aparelho eletrônico.","falta de habilidade da personagem em operar o localizador geográfico.","discrepância entre situar-se geograficamente e dominar o idioma local.","incerteza sobre o nome do ponto turístico onde as personagens se encontram."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "TEXTO PARA AS QUESTÕES 70 E 71\nUma obra de arte é um desafio; não a explicamos, ajustamo-nos a ela. Ao interpretá-la, fazemos uso dos nossos próprios objetivos e esforços, dotamo-la de um significado que tem sua origem nos nossos próprios modos de viver e de pensar. 5 Numa palavra, qualquer gênero de arte que, de fato, nos afete, torna-se, deste modo, arte moderna.\nAs obras de arte, porém, são como altitudes inacessíveis. Não nos dirigimos a elas diretamente, mas contornamo-las. Cada geração as vê sob um ângulo diferente e sob uma nova 10 visão; nem se deve supor que um ponto de vista mais recente é mais eficiente do que um anterior. Cada aspecto surge na sua altura própria, que não pode ser antecipada nem prolongada; e, todavia, o seu significado não está perdido porque o significado que uma obra assume para uma geração posterior 15 é o resultado de uma série completa de interpretações anteriores.\nArnold Hauser, Teorias da arte. Adaptado.\nDe acordo com o texto, a compreensão do significado de uma obra de arte pressupõe",
      subItens: []
    },
    options: ["o reconhecimento de seu significado intrínseco.","a exclusividade do ponto de vista mais recente.","a consideração de seu caráter imutável.","o acúmulo de interpretações anteriores.","a explicação definitiva de seu sentido."],
    correctAnswer: 3,
    materia: "Língua Portuguesa – Interpretação de Texto",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "No trecho \"Numa palavra, qualquer gênero de arte que, de fato, nos afete, torna-se, deste modo, arte moderna\" (L. 5-6), as expressões sublinhadas podem ser substituídas, sem prejuízo do sentido do texto, respectivamente, por",
      subItens: []
    },
    options: ["realmente; portanto.","invariavelmente; ainda.","com efeito; todavia.","com segurança; também.","possivelmente; até."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "De acordo com Alexandre Eulálio, a protagonista do romance Minha vida de menina",
      subItens: []
    },
    options: ["vivencia um conflito uma ideia fortalecida por \"a bem dizer\" (L. 5).","apresenta certo vínculo com o protestantismo uma ideia sintetizada por \"ecos de uma formação britânica\" (L. 7-8).","formou-se num meio alheio ao trabalho escravo um fato referido por \"num ambiente de corte ibérico e católico\" (L. 8-9).","rejeita as influências do meio em que vive uma característica revelada por \"precisão e finura notáveis\" (L. 14).","tem a sua lucidez psicológica abalada pelas ambivalências de sua educação um traço reiterado por \"equilíbrio mesmo de suas contradições” (L. 17-18)."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Literatura",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "TEXTO PARA AS QUESTÕES 76 E 77\nO rumor crescia, condensando-se; o zunzum de todos os dias acentuava-se; já se não destacavam vozes dispersas, mas um só ruído compacto que enchia todo o cortiço. Começavam a fazer compras na venda; ensarilhavam-se* discussões e rezingas**; ouviam-se gargalhadas e pragas; já se não falava, 5 gritava-se. Sentia-se naquela fermentação sanguínea, naquela gula viçosa de plantas rasteiras que mergulham os pés vigorosos na lama preta e nutriente da vida, o prazer animal de existir, a triunfante satisfação de respirar sobre a terra.\nDa porta da venda que dava para o cortiço iam e vinham 10 como formigas; fazendo compras.\nDuas janelas do Miranda abriram-se. Apareceu numa a Isaura, que se dispunha a começar a limpeza da casa.\nNhá Dunga! gritou ela para baixo, a sacudir um pano de mesa; se você tem cuscuz de milho hoje, bata na porta, 15 ouviu?\n* ensarilhar-se: emaranhar-se.\n** rezinga: resmungo.\nAluísio Azevedo, O cortiço.\nUma característica do Naturalismo presente no texto é:",
      subItens: []
    },
    options: ["forte apelo aos sentidos.","idealização do espaço.","exaltação da natureza.","realce de aspectos raciais.","ênfase nas individualidades."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Literatura",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "No texto de Sarapalha, constitui exemplo de personificação o seguinte trecho:",
      subItens: []
    },
    options: ["\"No rio ninguém não anda\" (L. 10).","\"só a maleita é quem sobe e desce\" (L. 10-11).","“O senhor já sabe as palavras todas de cabeça\" (L. 17).","\"e com a viola enfeitada de fitas\" (L. 19).","\"ajuntou suas roupinhas melhores numa trouxa\" (L. 32)."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "A comparação entre os fragmentos, respectivamente, da Carta e de Vidas secas, permite afirmar que",
      subItens: []
    },
    options: ["“será que há mesmo” e “acordaria feliz\" sugerem dúvida.","\"procurei adivinhar\" e \"precisava vigiar\" significam necessidade.","\"no fundo todos somos\" e \"andar pelas ribanceiras\" indicam lugar.","\" padre Zé Leite pretende\" e \"Baleia queria dormir\" indicam intencionalidade.","\"todos nós desejamos\" e \"dormiam na esteira\" indicam possibilidade."],
    correctAnswer: 3,
    materia: "Língua Portuguesa – Interpretação de Texto",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Tendo como base o trecho \"só a maleita é quem sobe e desce, olhando seus mosquitinhos e pondo neles a benção...\", o termo em destaque foi empregado ironicamente por aludir ao inseto",
      subItens: []
    },
    options: ["causador da malária.","causador da febre amarela.","transmissor da doença de Chagas.","transmissor da malária.","transmissor da febre amarela."],
    correctAnswer: 3,
    materia: "Língua Portuguesa – Estilística",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Examine esta propaganda.\nCOMBUSTIVEL\nLEGAL\nPróximo passo:\numa lei que puna\no sonegador\nSonegar e adulterar é ir na contramão do Brasil\nhonesto e justo. Os sonegadores de impostos\ndevem bilhões de reais para todos nós. Os\ndevedores contumazes, que adotam o calote\ntributário como modelo de negócio, não podem\nficar impunes. Juntos podemos acabar com eles.\nChegou a vez de dizer não à sonegação.\nwww.combustivellegal.com.br\nPor ser empregado tanto na linguagem formal quanto na linguagem informal, o termo \"legal\" pode ser lido, no contexto da propaganda, respectivamente, nos seguintes sentidos:",
      subItens: []
    },
    options: ["lícito e bom.","aceito e regulado.","requintado e excepcional.","viável e interessante.","jurídico e autorizado."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "No texto, a figura da rainha Vitória é associada ao conceito de",
      subItens: []
    },
    options: ["firmeza.","eloquência.","longevidade.","beleza.","maternidade."],
    correctAnswer: 0,
    materia: "Inglês – Reading Comprehension",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "No texto, a referência ao número de estátuas expostas em espaços públicos na Grã-Bretanha indica",
      subItens: []
    },
    options: ["ênfase em personalidades alegóricas.","escassez de monumentos do gênero feminino.","despreço por esculturas de corpo inteiro.","falta de espaço em museus para peças de grande porte.","preferência por figuras de destaque em batalhas."],
    correctAnswer: 1,
    materia: "Inglês – Reading Comprehension",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Segundo o texto, a execução de um algoritmo consiste em um processo que",
      subItens: []
    },
    options: ["prevê a memorização de tabelas e fórmulas.","envolve mecanismos de seleção e detecção de erros.","se apoia em um número infinito de etapas.","é incompatível com análises subjetivas e imprecisas.","alterna níveis altos e baixos de esforço intelectual."],
    correctAnswer: 3,
    materia: "Inglês – Reading Comprehension",
    conteudo: "",
    imageNames: []
