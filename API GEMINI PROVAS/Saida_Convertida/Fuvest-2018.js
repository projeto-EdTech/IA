createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Um fabricante de acessórios de montanhismo quer projetar um colchão de espuma apropriado para ser utilizado por alpinistas em regiões frias. Considere que a taxa de transferência de calor ao solo por uma pessoa dormindo confortavelmente seja 90 $\\\\frac{kcal}{hora}$ e que a transferência de calor entre a pessoa e o solo se dê exclusivamente pelo mecanismo de condução térmica através da espuma do colchão. Nestas condições, o gráfico representa a taxa de transferência de calor, em $\\\\frac{J}{s}$, através da espuma do colchão, em função de sua espessura, em cm.\nTaxa de transferência de calor ($\\\\frac{J}{s}$)\n400\n300\n200\n100\n0\n0 1 2 3 4 5 6\nEspessura (cm)\nConsiderando 1 cal = 4 J, a menor espessura do colchão, em cm, para que a pessoa durma confortavelmente é",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Uma caminhonete, de massa 2.000 kg, bateu na traseira de um sedã, de massa 1.000 kg, que estava parado no semáforo, em uma rua horizontal. Após o impacto, os dois veículos deslizaram como um único bloco. Para a perícia, o motorista da caminhonete alegou que estava a menos de 20 $\\\\frac{km}{h}$ quando o acidente ocorreu. A perícia constatou, analisando as marcas de frenagem, que a caminhonete arrastou o sedã, em linha reta, por uma distância de 10 m. Com este dado e estimando que o coeficiente de atrito cinético entre os pneus dos veículos e o asfalto, no local do acidente, era 0,5, a perícia concluiu que a velocidade real da caminhonete, em $\\\\frac{km}{h}$, no momento da colisão era, aproximadamente,\nNote e adote:\nAceleração da gravidade: 10 $\\\\frac{m}{s}$².\nDesconsidere a massa dos motoristas e a resistência do ar.",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Considere as figuras pelas quais são representados diferentes sistemas contendo determinadas substâncias químicas. Nas figuras, cada círculo representa um átomo, e círculos de tamanhos diferentes representam elementos químicos diferentes.\n1\n2\n3\n4\n5\n6\nA respeito dessas representações, é correto afirmar que os sistemas",
      subItens: []
    },
