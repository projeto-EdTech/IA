...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "No desenvolvimento de (x.$sen_{2}$β + 1/x $cos_{2}$β)¹⁰ o valor do termo independente de x é igual a 63/256. Considerando que β é um número real, com 0 < β < π/8 e x ≠ 0, o valor de β é:",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "Calcule o valor de $\\sin$⁴α+cos⁴α / $\\sin$⁶α+cos⁶α, sabendo-se que $\\sin$α cosα = 1/5.",
      subItens: []
    },
