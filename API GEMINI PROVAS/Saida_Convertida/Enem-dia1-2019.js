...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "In this life\nSitting on a park bench\nThinking about a friend of mine\nHe was only twenty-three\nGone before he had his time.\nIt came without a warning\nDidn't want his friends to see him cry\nHe knew the day was dawning\nAnd I didn't have a chance to say goodbye.\nMADONNA. Erotica. Estados Unidos: Maverick, 1992.\nA canção, muitas vezes, é uma forma de manifestar sentimentos e emoções da vida cotidiana. Por exemplo, o sofrimento retratado nessa canção foi causado",
      subItens: []
    },
    options: ["pela morte precoce de um amigo jovem.","pelo término de um relacionamento amoroso.","pela mudança de um amigo para outro país.","pelo fim de uma amizade de mais de vinte anos.","pela traição por parte de pessoa próxima."],
    correctAnswer: 0,
    materia: "Inglês – Interpretação de Letra de Música",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "BACK TO SCHOOL! MISS IDLER\nPSSST. HOW DO YOU TURN THIS THING ON?\nKEEFER, M. Disponível em: www.nj.com. Acesso em: 3 dez. 2018.\nNo cartum, o estudante faz uma pergunta usando turn this thing on por",
      subItens: []
    },
    options: ["suspeitar que o colega está com seu material por engano.","duvidar que o colega possa se tornar um bom aluno.","desconfiar que o livro levado é de outra matéria.","entender como desligada a postura do colega.","desconhecer como usar um livro impresso."],
    correctAnswer: 4,
    materia: "Inglês – Leitura de Cartum",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Faz com que o BULLYING passe à história!\nSTOP Bullying\nÉs vítima:\n• Fica calmo(a). Os bullies adoram reações nervosas. Finge que não é contigo!\n• Não dês troco. Lembra-te: o agressor é ele, não és tu.\n• Evita ficar sozinho(a) com o bullie, junta-te com os teus amigos.\n• Mostra-te confiante, não demonstres medo e acredita em ti!\n• Conta a uma pessoa de confiança o que está a acontecer contigo.\nConheces alguma vítima:\n• Nunca deixes o teu amigo(a) sozinho(a).\nAssim farás com que ele(a) se sinta seguro(a).\n• Ajuda-o(a) a contar a alguém de confiança o que se passa!\nConheces o(a) agressor(a):\n•Tenta convencê-lo(a) a mudar o seu comportamento.\n•Caso não tenhas sucesso, denuncia o caso às autoridades.\nDisponível em: www.essl.pt. Acesso em: 9 maio 2019 (adaptado).\nEssa campanha se destaca pela maneira como utiliza a linguagem para conscientizar a sociedade da necessidade de se acabar com o bullying. Tal estratégia está centrada no(a)",
      subItens: []
    },
    options: ["chamamento de diferentes atores sociais pelo uso recorrente de estruturas injuntivas.","variedade linguística caracterizadora do português europeu.","restrição a um grupo específico de vítimas ao apresentar marcas gráficas de identificação de gênero como “o(a)”.","combinação do significado de palavras escritas em línguas inglesa e portuguesa.","enunciado de cunho esperançoso \"passe à história\" no título do cartaz."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["saudade como experiência de apatia.","presença da fragmentação da identidade.","negação do desejo como expressão de culpa.","persistência da memória na valorização do passado.","revelação de rumos projetada pela vivência da solidão."],
    correctAnswer: 4,
    materia: "Língua Portuguesa – Poesia",
    conteudo: "Língua Portuguesa – Interpretação de Texto Poético",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Os tipos cheios de si\nO difícil é encontrar quem nunca cruzou com (ou se passou por) um desses on-line\nO TURISTA EM TEMPO INTEGRAL: Posta o ano inteiro fotos das férias (deste e de outros anos). Parece viver viajando.\nO BALADEIRO VIDA LOUCA: Quase dá para escutar o \"Uhuuu!!!\", pelas fotos de bebidas e pistas de dança.\nO BEM RELACIONADO DE OCASIÃO: Descobriu quem é o \"famoso\" que aparece na foto naquela hora. Mas não deixa passar.\nA MÃE ORGULHOSA DEMAIS: Faz questão de contar todas as gracinhas. Até as que só têm graça para a mãe.\nA ÚNICA BEM-AMADA: Só ela tem o parceiro mais especial. Porque momentos a dois são mesmo para divulgar.\nO EXIBIDO HUMILDE: Ele (acha que) disfarça ao dar dicas do próprio sucesso. Não engana ninguém.\nO GOURMET DE APARÊNCIAS: Por que ir a um restaurante se ninguém souber? É clique no prato.\nO(A) LINDO(A) DEMAIS PARA NÃO MOSTRAR: Acha que o dia de cabelo bom desculpa um autorretrato (selfie). Quem nunca, não é?\nDisponível em: http://epoca.globo.com. Acesso em: 20 mar. 2014.\nDe acordo com esse infográfico, as redes sociais estimulam diferentes comportamentos dos usuários que revelam",
      subItens: []
    },
    options: ["exposição exagerada dos indivíduos.","comicidade ingênua dos usuários.","engajamento social das pessoas.","disfarce do sujeito por meio de avatares.","autocrítica dos internautas."],
    correctAnswer: 0,
    materia: "Sociologia – Cultura Digital e Comportamento",
    conteudo: "Língua Portuguesa – Leitura de Infográfico",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["auditoria das ações de governo.","publicidade das entidades públicas.","obtenção de informações estratégicas.","disponibilidade de ambientes coletivos.","comunicação entre órgãos administrativos."],
    correctAnswer: 2,
    materia: "Geografia – Tecnologia da Informação Geográfica",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "VAMOS CALÇAR OS SAPATOS DOS REFUGIADOS E DAR O PRIMEIRO PASSO PARA ENTENDER SUA SITUAÇÃO\nwww.ensuszapatos.org\nUNHCR ACNUR Agência da ONU para Refugiados\nPREFEITURA DE SÃO PAULO\nSHUM\nMETRÔ\nUV JESUITAS\nDisponível em: www.acnur.org. Acesso em: 11 dez. 2018.\nNesse cartaz, o uso da imagem do calçado aliada ao texto verbal tem o objetivo de",
      subItens: []
    },
    ...
    correctAnswer: 4,
    materia: "Língua Portuguesa – Linguagem Publicitária",
    conteudo: "Sociologia – Questões Humanitárias",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Blues da piedade\nVamos pedir piedade\nSenhor, piedade\nPra essa gente careta e covarde\nVamos pedir piedade\nSenhor, piedade\nLhes dê grandeza e um pouco de coragem\nCAZUZA. Cazuza: o poeta não morreu. Rio de Janeiro: Universal Music, 2000 (fragmento).\nTodo gênero apresenta elementos constitutivos que condicionam seu uso em sociedade. A letra de canção identifica-se com o gênero ladainha, essencialmente, pela utilização da sequência textual",
      subItens: []
    },
    options: ["expositiva, por discorrer sobre um dado tema.","narrativa, por apresentar uma cadeia de ações.","injuntiva, por chamar o interlocutor à participação.","descritiva, por enumerar características de um personagem.","argumentativa, por incitar o leitor a uma tomada de atitude."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Gêneros Textuais (Canção)",
    conteudo: "Língua Portuguesa – Funções da Linguagem",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Com o enredo que homenageou o centenário do Rei do Baião, Luiz Gonzaga, a Unidos da Tijuca foi coroada no Carnaval 2012.\nA penúltima escola a entrar na Sapucaí, na segunda noite de desfiles, mergulhou no universo do cantor e compositor brasileiro e trouxe a cultura nordestina com criatividade para a Avenida, com o enredo O dia em que toda a realeza desembarcou na Avenida para coroar o Rei Luiz do Sertão.\nDisponível em: www.cultura.rj.gov.br. Acesso em: 15 maio 2012 (adaptado).\nA notícia relata um evento cultural que marca a",
      subItens: []
    },
    options: ["primazia do samba sobre a música nordestina.","inter-relação entre dois gêneros musicais brasileiros.","valorização das origens oligárquicas da cultura nordestina.","proposta de resgate de antigos gêneros musicais brasileiros.","criatividade em compor um samba-enredo em homenagem a uma pessoa."],
    correctAnswer: 1,
    materia: "Arte – Cultura Brasileira (Carnaval)",
    conteudo: "Arte – Música Regional",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Os subúrbios do Rio de Janeiro foram a primeira coisa a aparecer no mundo, antes mesmo dos vulcões e dos cachalotes, antes de Portugal invadir, antes do Getúlio Vargas mandar construir casas populares. O bairro do Queím, onde nasci e cresci, é um deles. Aconchegado entre o Engenho Novo e Andaraí, foi feito daquela argila primordial, que se aglutinou em diversos formatos: cães soltos, moscas e morros, uma estação de trem, amendoeiras e barracos e sobrados, botecos e arsenais de guerra, armarinhos e bancas de jogo do bicho e um terreno enorme reservado para o cemitério.\nMas tudo ainda estava vazio: faltava gente.\nNão demorou. As ruas juntaram tanta poeira que o homem não teve escolha a não ser passar a existir, para varrê-las. À tardinha, sentar na varanda das casas e reclamar da pobreza, falar mal dos outros e olhar para as calçadas encardidas de sol, os ônibus da volta do trabalho sujando tudo de novo.\nHERINGER, V. O amor dos homens avulsos. São Paulo: Cia. das Letras, 2016.\nTraçando a gênese simbólica de sua cidade, o narrador imprime ao texto um sentido estético fundamentado na",
      subItens: []
    },
    options: ["excentricidade dos bairros cariocas de sua infância.","perspectiva caricata da paisagem de traços deteriorados.","importância dos fatos relacionados à história dos subúrbios.","diversidade dos tipos humanos identificados por seus hábitos.","experiência do cotidiano marcado pelas necessidades e urgências."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Gêneros Narrativos (Prosa)",
    conteudo: "Língua Portuguesa – Análise de Texto Literário",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: "Sociologia – Tecnologia e Conhecimento",
...
createQuestion({
    ...
    options: ["a presença de elementos de outras línguas no português foi historicamente avaliada como um índice de riqueza.","o estudioso da língua pode identificar com precisão os elementos deixados por outras línguas na transformação da língua portuguesa.","o português é o resultado da influência de outras línguas no passado e carrega marcas delas em suas múltiplas camadas.","o árabe e o latim estão na formação escolar e na memória dos falantes brasileiros.","a influência de outras línguas no português ocorreu de maneira uniforme ao longo da história."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – História da Língua Portuguesa",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "PICASSO, P. Cabeça de touro. Bronze, 33,5 cm x 43,5 cm x 19 cm. Musée Picasso, Paris. França, 1945.\nJANSON, H. W. Iniciação à história da arte. São Paulo: Martins Fontes, 1988.\nNa obra Cabeça de touro, o material descartado torna-se objeto de arte por meio da",
      subItens: []
    },
    options: ["reciclagem da matéria-prima original.","complexidade da combinação de formas abstratas.","perenidade dos elementos que constituem a escultura.","mudança da funcionalidade pela integração dos objetos.","fragmentação da imagem no uso de elementos diversificados."],
    correctAnswer: 3,
    materia: "Arte – Escultura Moderna",
    conteudo: "Arte – Materialidade na Arte",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "No Brasil, a disseminação de uma expectativa de corpo com base na estética da magreza é bastante grande e apresenta uma enorme repercussão, especialmente, se considerada do ponto de vista da realização pessoal.\nEm pesquisa feita na cidade de São Paulo, aparecem os percentuais de 90% entre as mulheres pesquisadas que se dizem preocupadas com seu peso corporal, sendo que 95% se sentem insatisfeitas com \"seu próprio corpo\".\nSILVA, A. M. Corpo, ciência e mercado: reflexões acerca da gestação de um novo arquétipo da felicidade. Campinas: Autores Associados; Florianópolis: UFSC, 2001.\nA preocupação excessiva com o “peso” corporal pode provocar o desenvolvimento de distúrbios associados diretamente à imagem do corpo, tais como",
      subItens: []
    },
    options: ["anorexia e bulimia.","ortorexia e vigorexia.","ansiedade e depressão.","sobrepeso e fobia social.","sedentarismo e obesidade."],
    correctAnswer: 0,
    materia: "Biologia – Distúrbios Alimentares",
    conteudo: "Sociologia – Corpo e Sociedade",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["apropriação parodística das técnicas e materiais utilizados.","reflexão acerca dos sistemas de circulação da arte.","simplificação dos traços da composição pictórica.","contraposição de linguagens artísticas distintas.","crítica ao advento do abstracionismo."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Essa lua enlutada, esse desassossego\nA convulsão de dentro, ilharga\nDentro da solidão, corpo morrendo\nTudo isso te devo. E eram tão vastas\nAs coisas planejadas, navios,\nMuralhas de marfim, palavras largas\nConsentimento sempre. E seria dezembro.\nUm cavalo de jade sob as águas\nDupla transparência, fio suspenso\nTodas essas coisas na ponta dos teus dedos\nE tudo se desfez no pórtico do tempo\nEm lívido silêncio. Umas manhãs de vidro\nVento, a alma esvaziada, um sol que não vejo\nTambém isso te devo.\nHILST, H. Júbilo, memória, noviciado da paixão. São Paulo: Cia. das Letras, 2018.\nNo poema, o eu lírico faz um inventário de estados passados espelhados no presente. Nesse processo, aflora o",
      subItens: []
    },
    options: ["cuidado em apagar da memória os restos do amor.","amadurecimento revestido de ironia e desapego.","mosaico de alegrias formado seletivamente.","desejo reprimido convertido em delírio.","arrependimento dos erros cometidos."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Poesia Contemporânea",
    conteudo: "Língua Portuguesa – Interpretação de Texto Poético",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "1. Nós queremos cantar o amor ao perigo, o hábito da energia e da temeridade.\$1_{2}$. A coragem, a audácia, a rebelião serão elementos essenciais de nossa poesia.\$1_{3}$. A literatura exaltou até hoje a imobilidade pensativa, o êxtase, o sono. Nós queremos exaltar o movimento agressivo, a insônia febril, o passo de corrida, o salto mortal, o bofetão e o soco.\$1_{4}$. Nós afirmamos que a magnificência do mundo enriqueceu-se de uma beleza nova: a beleza da velocidade. Um automóvel de corrida com seu cofre enfeitado com tubos grossos, semelhantes a serpentes de hálito explosivo... um automóvel rugidor, que parece correr sobre a metralha, é mais bonito que a Vitória de Samotrácia.\$1_{5}$. Nós queremos entoar hinos ao homem que segura o volante, cuja haste ideal atravessa a Terra, lançada também numa corrida sobre o circuito da sua órbita.\$1_{6}$. É preciso que o poeta prodigalize com ardor, fausto e munificiência, para aumentar o entusiástico fervor dos elementos primordiais.\nMARINETTI, F. T. Manifesto futurista. In: TELES, G. M. Vanguardas europeias e Modernismo brasileiro. Petrópolis: Vozes, 1985.\nO documento de Marinetti, de 1909, propõe os referenciais estéticos do Futurismo, que valorizam a",
      subItens: []
    },
    options: ["composição estática.","inovação tecnológica.","suspensão do tempo.","retomada do helenismo.","manutenção das tradições."],
    correctAnswer: 1,
    materia: "Arte – Vanguarda Europeia (Futurismo)",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Ela nasceu lesma, vivia no meio das lesmas, mas não estava satisfeita com sua condição. Não passamos de criaturas desprezadas, queixava-se. Só somos conhecidas por nossa lentidão. O rastro que deixaremos na História será tão desprezível quanto a gosma que marca nossa passagem pelos pavimentos.\nA esta frustração correspondia um sonho: a lesma queria ser como aquele parente distante, o escargot. O simples nome já a deixava fascinada: um termo francês, elegante, sofisticado, um termo que as pessoas pronunciavam com respeito e até com admiração.\nMas, lembravam as outras lesmas, os escargots são comidos, enquanto nós pelo menos temos chance de sobreviver. Este argumento não convencia a insatisfeita lesma, ao contrário: preferiria exatamente terminar sua vida desta maneira, numa mesa de toalha adamascada, entre talheres de prata e cálices de cristal. Assim como o mar é o único túmulo digno de um almirante batavo, respondia, a travessa de porcelana é a única lápide digna dos meus sonhos.\nSCLIAR, M. Sonho de lesma. In: ABREU, C. F. et al. A prosa do mundo. São Paulo: Global, 2009.\nIncorporando o devaneio da personagem, o narrador compõe uma alegoria que representa o anseio de",
      subItens: []
    },
    options: ["rejeitar metas de superação de desafios.","restaurar o estado de felicidade pregressa.","materializar expectativas de natureza utópica.","rivalizar com indivíduos de condição privilegiada.","valorizar as experiências hedonistas do presente."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Gêneros Narrativos (Conto)",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Marcelo Gleiser\nÁrea de atuação: Física e astronomia\nContribuição mais famosa: Seus livros A dança do universo e O fim da Terra e do céu\nNascimento: 19 de março de 1959\nAlma Mater: PUC-Rio, UFRJ e King's College de Londres\nSuper Trunfo Tecmundo\nDisponível em: www.tecmundo.com.br. Acesso em: 10 dez. 2018 (adaptado).\nO texto tem o formato de uma carta de jogo e apresenta dados a respeito de Marcelo Gleiser, premiado pesquisador brasileiro da atualidade. Essa apresentação subverte um gênero textual ao",
      subItens: []
    },
    options: ["vincular áreas distintas do conhecimento.","evidenciar a formação acadêmica do pesquisador.","relacionar o universo lúdico a informações biográficas.","especificar as contribuições mais conhecidas do pesquisador.","destacar o nome do pesquisador e sua imagem no início do texto."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Gêneros Textuais (Carta de Jogo)",
...
createQuestion({
    ...
    options: ["Albedo dos corpos físicos.","Profundidade do lençol freático.","Campo de magnetismo terrestre.","Qualidade dos recursos minerais.","Movimento de translação planetária."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Em sentido geral e fundamental, Direito é a técnica da coexistência humana, isto é, a técnica voltada a tornar possível a coexistência dos homens. Como técnica, o Direito se concretiza em um conjunto de regras (que, nesse caso, são leis ou normas); e tais regras têm por objeto o comportamento intersubjetivo, isto é, o comportamento recíproco dos homens entre si.\nABBAGNANO, N. Dicionário de Filosofia. São Paulo: Martins Fontes, 2007.\nO sentido geral e fundamental do Direito, conforme foi destacado, refere-se à",
      subItens: []
    },
    options: ["aplicação de códigos legais.","regulação do convívio social.","legitimação de decisões políticas.","mediação de conflitos econômicos.","representação da autoridade constituída."],
    correctAnswer: 1,
    materia: "Filosofia – Teoria do Direito",
    conteudo: "Sociologia – Organização Social",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Dificilmente passa-se uma noite sem que algum sitiante tenha seu celeiro ou sua pilha de cereais destruídos pelo fogo. Vários trabalhadores não diretamente envolvidos nos ataques pareciam apoiá-los, como se vê neste depoimento ao The Times: \"deixa queimar, pena que não foi a casa”; “podemos nos aquecer agora”; “nós só queríamos algumas batatas, há um fogo ótimo para cozinhá-las”.\nHOBSBAWM, E.; RUDÉ, G. Capitão Swing. Rio de Janeiro: Francisco Alves, 1982 (adaptado).\nA revolta descrita no texto, ocorrida na Inglaterra no século XIX, foi uma reação ao seguinte processo socioespacial:",
      subItens: []
    },
    options: ["Restrição da propriedade privada.","Expropriação das terras comunais.","Imposição da estatização fundiária.","Redução da produção monocultora.","Proibição das atividades artesanais."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Regiões áridas e semiáridas do mundo (map)\$1_{30}$° N Trópico de Câncer\$1_{0}$° Equador\$1_{30}$° S Trópico de Capricórnio\nSEMIÁRIDA\nÁRIDA (DESERTO)\nSALGADO-LABOURIAL, M. L. História ecológica da Terra. São Paulo: Edgard Blucher, 1994 (adaptado).\nNo Hemisfério Sul, a sequência latitudinal dos desertos representada na imagem sofre uma interrupção no Brasil devido à seguinte razão:",
      subItens: []
    },
    options: ["Existência de superfícies de intensa refletividade.","Preponderância de altas pressões atmosféricas.","Influência de umidade das áreas florestais.","Predomínio de correntes marinhas frias.","Ausência de massas de ar continentais."],
    correctAnswer: 2,
    materia: "Geografia – Climatologia",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "De fato, não é porque o homem pode usar a vontade livre para pecar que se deve supor que Deus a concedeu para isso. Há, portanto, uma razão pela qual Deus deu ao homem esta característica, pois sem ela não poderia viver e agir corretamente. Pode-se compreender, então, que ela foi concedida ao homem para esse fim, considerando-se que se um homem a usa para pecar, recairão sobre ele as punições divinas. Ora, isso seria injusto se a vontade livre tivesse sido dada ao homem não apenas para agir corretamente, mas também para pecar. Na verdade, por que deveria ser punido aquele que usasse sua vontade para o fim para o qual ela lhe foi dada?\nAGOSTINHO. O livre-arbítrio. In: MARCONDES, D. Textos básicos de ética. Rio de Janeiro: Jorge Zahar, 2008.\nNesse texto, o filósofo cristão Agostinho de Hipona sustenta que a punição divina tem como fundamento o(a)",
      subItens: []
    },
    options: ["desvio da postura celibatária.","insuficiência da autonomia moral.","afastamento das ações de desapego.","distanciamento das práticas de sacrifício.","violação dos preceitos do Velho Testamento."],
    correctAnswer: 1,
    materia: "Filosofia – Ética",
    conteudo: "Filosofia – Filosofia Medieval",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A cidade medieval é, antes de mais nada, uma sociedade da abundância, concentrada num pequeno espaço em meio a vastas regiões pouco povoadas. Em seguida, é um lugar de produção e de trocas, onde se articulam o artesanato e o comércio, sustentados por uma economia monetária. É também o centro de um sistema de valores particular, do qual emerge a prática laboriosa e criativa do trabalho, o gosto pelo negócio e pelo dinheiro, a inclinação para o luxo, o senso da beleza. É ainda um sistema de organização de um espaço fechado com muralhas, onde se penetra por portas e se caminha por ruas e praças e que é guarnecido por torres.\nLE GOFF, J.; SCHMITT, J.-C. Dicionário temático do Ocidente Medieval. Bauru: Edusc, 2006.\nNo texto, o espaço descrito se caracteriza pela associação entre a ampliação das atividades urbanas e a",
      subItens: []
    },
    options: ["emancipação do poder hegemônico da realeza.","aceitação das práticas usurárias dos religiosos.","independência da produção alimentar dos campos.","superação do ordenamento corporativo dos ofícios.","permanência dos elementos arquitetônicos de proteção."],
    correctAnswer: 4,
    materia: "História – Idade Média",
    conteudo: "Geografia – Urbanização Histórica",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Exploração e romantização.","Sacralização e profanação.","Preservação e degradação.","Segregação e democratização.","Idealização e mercantilização."],
    correctAnswer: 4,
    materia: "Geografia – Relação Sociedade-Natureza",
    conteudo: "Língua Portuguesa – Análise de Textos",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: "Sociologia – Diversidade Cultural e Religiosa",
    conteudo: "Sociologia – Direitos Humanos",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["valorização do pacto colonial — combate à livre-iniciativa.","defesa dos monopólios régios — apoio à livre concorrência.","formação do sistema metropolitano — crítica à livre navegação.","abandono da acumulação metalista — estímulo ao livre-comércio.","eliminação das tarifas alfandegárias — incentivo ao livre-cambismo."],
    correctAnswer: 1,
    materia: "História – Economia Moderna",
    conteudo: "Filosofia – Liberalismo Econômico",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["centrado na razão humana.","baseado na explicação mitológica.","fundamentado na ordenação imanentista.","focado na legitimação contratualista.","configurado na percepção etnocêntrica."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["Difusão das estéticas antigas.","Exaltação das crendices populares.","Propagação das conclusões científicas.","Reiteração dos discursos hegemônicos.","Contestação dos estereótipos consolidados."],
    correctAnswer: 4,
    materia: "Sociologia – Mídia e Estereótipos",
    conteudo: "Sociologia – Corpo e Sociedade",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Penso que não há um sujeito soberano, fundador, uma forma universal de sujeito que poderíamos encontrar em todos os lugares. Penso, pelo contrário, que o sujeito se constitui através das práticas de sujeição ou, de maneira mais autônoma, através de práticas de liberação, de liberdade, como na Antiguidade - a partir, obviamente, de um certo número de regras, de estilos, que podemos encontrar no meio cultural.\nFOUCAULT, M. Ditos e escritos V: ética, sexualidade, política. Rio de Janeiro: Forense Universitária, 2004.\nO texto aponta que a subjetivação se efetiva numa dimensão",
      subItens: []
    },
    options: ["legal, pautada em preceitos jurídicos.","racional, baseada em pressupostos lógicos.","contingencial, processada em interações sociais.","transcendental, efetivada em princípios religiosos.","essencial, fundamentada em parâmetros substancialistas."],
    correctAnswer: 2,
...
createQuestion({
    ...
    options: ["objetificação do espaço físico.","retomada do modelo criacionista.","recuperação do legado ancestral.","infalibilidade do método científico.","formação da cosmovisão holística."],
    correctAnswer: 0,
    materia: "Filosofia – Filosofia da Ciência",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Essa atmosfera de loucura e irrealidade, criada pela aparente ausência de propósitos, é a verdadeira cortina de ferro que esconde dos olhos do mundo todas as formas de campos de concentração. Vistos de fora, os campos e o que neles acontece só podem ser descritos com imagens extraterrenas, como se a vida fosse neles separada das finalidades deste mundo. Mais que o arame farpado, é a irrealidade dos detentos que ele confina que provoca uma crueldade tão incrível que termina levando à aceitação do extermínio como solução perfeitamente normal.\nARENDT, H. Origens do totalitarismo. São Paulo: Cia. das Letras, 1989 (adaptado).\nA partir da análise da autora, no encontro das temporalidades históricas, evidencia-se uma crítica à naturalização do(a)",
      subItens: []
    },
    options: ["ideário nacional, que legitima as desigualdades sociais.","alienação ideológica, que justifica as ações individuais.","cosmologia religiosa, que sustenta as tradições hierárquicas.","segregação humana, que fundamenta os projetos biopolíticos.","enquadramento cultural, que favorece os comportamentos punitivos."],
    correctAnswer: 3,
    materia: "Filosofia – Teoria Política (Totalitarismo)",
...
createQuestion({
    ...
    conteudo: "Sociologia – Espaço Urbano",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: "Filosofia – Filosofia Moderna (Kant)",
    conteudo: "Língua Portuguesa – Intertextualidade",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A soberania dos cidadãos dotados de plenos direitos era imprescindível para a existência da cidade-estado. Segundo os regimes políticos, a proporção desses cidadãos em relação à população total dos homens livres podia variar muito, sendo bastante pequena nas aristocracias e oligarquias e maior nas democracias.\nCARDOSO, C. F. A cidade-estado clássica. São Paulo: Ática, 1985.\nNas cidades-estado da Antiguidade Clássica, a proporção de cidadãos descrita no texto é explicada pela adoção do seguinte critério para a participação política:",
      subItens: []
    },
    options: ["Controle da terra.","Liberdade de culto.","Igualdade de gênero.","Exclusão dos militares.","Exigência da alfabetização."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A Revolta da Vacina (1904) mostrou claramente o aspecto defensivo, desorganizado, fragmentado da ação popular. Não se negava o Estado, não se reivindicava participação nas decisões políticas; defendiam-se valores e direitos considerados acima da intervenção do Estado.\nCARVALHO, J. M. Os bestializados: o Rio de Janeiro e a República que não foi. São Paulo: Cia. das Letras, 1987 (adaptado).\nA mobilização analisada representou um alerta, na medida em que a ação popular questionava",
      subItens: []
    },
    options: ["a alta de preços.","a política clientelista.","as reformas urbanas.","o arbítrio governamental.","as práticas eleitorais."],
    correctAnswer: 3,
    materia: "História – República Oligárquica",
    conteudo: "História – Movimentos Urbanos",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A partir da segunda metade do século XVIII, o número de escravos recém-chegados cresce no Rio e se estabiliza na Bahia. Nenhum lugar servia tão bem à recepção de escravos quanto o Rio de Janeiro.\nFRANÇA, R. O tamanho real da escravidão. O Globo, 5 abr. 2015 (adaptado).\nNa matéria, o jornalista informa uma mudança na dinâmica do tráfico atlântico que está relacionada à seguinte atividade:",
      subItens: []
    },
    options: ["Coleta de drogas do sertão.","Extração de metais preciosos.","Adoção da pecuária extensiva.","Retirada de madeira do litoral.","Exploração da lavoura de tabaco."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "NUESTRA CULTURA NO CABE EN SUS MUSEOS (image)\n\"Nossa cultura não cabe nos seus museus\".\nTOLENTINO, A. B. Patrimônio cultural e discursos museológicos. Midas, n. 6, 2016.\nProduzida no Chile, no final da década de 1970, a imagem expressa um conflito entre culturas e sua presença em museus decorrente da",
      subItens: []
    },
    options: ["valorização do mercado das obras de arte.","definição dos critérios de criação de acervos.","ampliação da rede de instituições de memória.","burocratização do acesso dos espaços expositivos.","fragmentação dos territórios das comunidades representadas."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A ocasião fez o ladrão: Francis Drake travava sua guerra de pirataria contra a Espanha papista quando roubou as tropas de mulas que levavam o ouro do Peru para o Panamá. Graças à cumplicidade da rainha Elizabeth I, ele reincide e saqueia as costas do Chile e do Peru antes de regressar pelo Oceano Pacífico, e depois pelo Índico. Ora, em Ternate ele oferece sua proteção a um sultão revoltado com os portugueses; assim nasce o primeiro entreposto inglês ultramarino.\nFERRO, M. História das colonizações. Das colonizações às independências. Séculos XIII a XX. São Paulo: Cia. das Letras, 1996.\nA tática adotada pela Inglaterra do século XVI, conforme citada no texto, foi o meio encontrado para",
      subItens: []
    },
    options: ["restabelecer o crescimento da economia mercantil.","conquistar as riquezas dos territórios americanos.","legalizar a ocupação de possessões ibéricas.","ganhar a adesão das potências europeias.","fortalecer as rotas do comércio marítimo."],
    correctAnswer: 1,
    materia: "História – Expansão Marítima",
    conteudo: "História – Período Moderno",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "O bônus demográfico é caracterizado pelo período em que, por causa da redução do número de filhos por mulher, a estrutura populacional fica favorável ao crescimento econômico. Isso acontece porque há proporcionalmente menos crianças na população, e o percentual de idosos ainda não é alto.\nGOIS, A. O Globo, 5 abr. 2015 (adaptado).\nA ação estatal que contribui para o aproveitamento do bônus demográfico é o estímulo à",
      subItens: []
    },
    options: ["atração de imigrantes.","elevação da carga tributária.","qualificação da mão de obra.","admissão de exilados políticos.","concessão de aposentadorias."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A fome não é um problema técnico, pois ela não se deve à falta de alimentos, isso porque a fome convive hoje com as condições materiais para resolvê-la.\nPORTO-GONÇALVES, C. W. Geografia da riqueza, fome e meio ambiente. In: OLIVEIRA, A. U.; MARQUES, M. I. M. (Org.). O campo no século XXI: território de vida, de luta e de construção da justiça social. São Paulo: Casa Amarela; Paz e Terra, 2004 (adaptado).\nO texto demonstra que o problema alimentar apresentado tem uma dimensão política por estar associado ao(à)",
      subItens: []
    },
    options: ["escala de produtividade regional.","padrão de distribuição de renda.","dificuldade de armazenamento de grãos.","crescimento da população mundial.","custo de escoamento dos produtos."],
    correctAnswer: 1,
    materia: "Geografia – Problemas Socioeconômicos",
    conteudo: "Sociologia – Desigualdade Social",
    imageNames: []
  }),