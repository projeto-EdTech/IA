...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Don’t write in English, they said,\nEnglish is not your mother tongue...\n...The language I speak\nBecomes mine, its distortions, its queerness\nAll mine, mine alone, it is half English, half\nIndian, funny perhaps, but it is honest,\nIt is as human as I am human...\n...It voices my joys, my longings my\nHopes...\n(Kamala Das, 1965:10)\n\nGARGESH, R. South Asian Englishes. In: KACHRU, B. B.; KACHRU, Y.; NELSON, C. L.\n(Eds.). The Handbook of World Englishes. Singapore: Blackwell, 2006.\n\nA poetisa Kamala Das, como muitos escritores indianos, escreve suas obras em inglês, apesar de essa não ser sua primeira língua. Nesses versos, ela",
      subItens: []
    },
    options: ["usa a língua inglesa com efeito humorístico.","recorre a vozes de vários escritores ingleses.","adverte sobre o uso distorcido da língua inglesa.","demonstra consciência de sua identidade linguística.","reconhece a incompreensão na sua maneira de falar inglês."],
    correctAnswer: 3,
    materia: "Inglês – Leitura e Interpretação Poética",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["elogiar o trabalho proposto para a educação nessa era tecnológica.","reforçar como a mídia pode contribuir para revolucionar a educação.","chamar a atenção das pessoas influentes para o significado da educação.","destacar que o site tem melhores resultados do que a educação tradicional.","criticar a concepção de educação em que se baseia a organização."],
    correctAnswer: 4,
    materia: "Inglês – Compreensão e Comparação de Textos",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "SEU ORGANISMO JÁ ESTÁ\nACOSTUMADO COM O\nAÇÚCAR E ESTÁ DIFÍCIL\nLARGAR?\n\nO IDEAL É IR SE ACOSTUMANDO\nAOS POUCOS COM CADA VEZ\nMENOS AÇÚCAR.\n\nDisponível em: www.facebook.$\\\\frac{com}{minsaude}$. Acesso em: 14 fev. 2018 (adaptado).\n\nA utilização de determinadas variedades linguísticas em campanhas educativas tem a função de atingir o público-alvo de forma mais direta e eficaz. No caso desse texto, identifica-se essa estratégia pelo(a)",
      subItens: []
    },
    options: ["discurso formal da língua portuguesa.","registro padrão próprio da língua escrita.","seleção lexical restrita à esfera da medicina.","fidelidade ao jargão da linguagem publicitária.","uso de marcas linguísticas típicas da oralidade."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Na sociologia e na literatura, o brasileiro foi por vezes tratado como cordial e hospitaleiro, mas não é isso o que acontece nas redes sociais: a democracia racial apregoada por Gilberto Freyre passa ao largo do que acontece diariamente nas comunidades virtuais do país. Levantamento inédito realizado pelo projeto Comunica que Muda [...] mostra em números a intolerância do internauta tupiniquim. Entre abril e junho, um algoritmo vasculhou plataformas [...] atrás de mensagens e textos sobre temas sensíveis, como racismo, posicionamento político e homofobia. Foram identificadas 393 284 menções, sendo 84% delas com abordagem negativa, de exposição do preconceito e da discriminação.\n\nDisponível em: https://oglobo.globo.com. Acesso em: 6 dez. 2017 (adaptado).\n\nAo abordar a postura do internauta brasileiro mapeada por meio de uma pesquisa em plataformas virtuais, o texto",
      subItens: []
    },
    options: ["minimiza o alcance da comunicação digital.","refuta ideias preconcebidas sobre o brasileiro.","relativiza responsabilidades sobre a noção de respeito.","exemplifica conceitos contidos na literatura e na sociologia.","expõe a ineficácia dos estudos para alterar tal comportamento."],
    correctAnswer: 1,
    materia: "Sociologia – Sociologia da Internet",
...
createQuestion({
    ...
    options: ["incorpora seletivamente o discurso do seu opressor.","submete-se à discriminação como meio de fortalecimento.","engaja-se na denúncia do passado de opressão e injustiças.","sofre uma perda de identidade e de noção de pertencimento.","acredita esporadicamente na utopia de uma sociedade igualitária."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "TEXTO I\n(Imagem de campanha sobre exercícios físicos: “AQUELES QUE PENSAM QUE NÃO TÊM TEMPO PARA FAZER EXERCÍCIO, MAIS CEDO OU MAIS TARDE SERÃO OBRIGADOS A TER TEMPO PARA AS DOENÇAS.”)\n\nDisponível em: http://revistaiiqb.usac.edu.gt. Acesso em: 25 abr. 2018 (adaptado).\n\nTEXTO II\nImaginemos um cidadão, residente na periferia de um grande centro urbano, que diariamente acorda às 5h para trabalhar, enfrenta em média 2 horas de transporte público, em geral lotado, para chegar às 8h ao trabalho. Termina o expediente às 17h e chega em casa às 19h para, aí sim, cuidar dos afazeres domésticos, dos filhos etc. Como dizer a essa pessoa que ela deve praticar exercícios, pois é importante para sua saúde? Como ela irá entender a mensagem da importância do exercício físico? A probabilidade de essa pessoa praticar exercícios regularmente é significativamente menor que a de pessoas da classe mé$\\\\frac{dia}{alta}$ que vivem outra realidade. Nesse caso, a abordagem individual do problema tende a fazer com que a pessoa se sinta impotente em não conseguir praticar exercícios e, consequentemente, culpada pelo fato de ser ou estar sedentária.\n\nFERREIRA, M. S. Aptidão física e saúde na educação física escolar: ampliando o enfoque. RBCE, n. 2, jan. 2001 (adaptado).\n\nO segundo texto, que propõe uma reflexão sobre o primeiro acerca do impacto de mudanças no estilo de vida na saúde, apresenta uma visão",
      subItens: []
    },
    options: ["medicalizada, que relaciona a prática de exercícios físicos por qualquer indivíduo à promoção da saúde.","ampliada, que considera aspectos sociais intervenientes na prática de exercícios no cotidiano.","crítica, que associa a interferência das tarefas da casa ao sedentarismo do indivíduo.","focalizada, que atribui ao indivíduo a responsabilidade pela prevenção de doenças.","geracional, que preconiza a representação do culto à jovialidade."],
    correctAnswer: 1,
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: "Língua Portuguesa – Gêneros Textuais",
    conteudo: "Sociologia – Sociologia da Internet",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Ó Pátria amada,\nIdolatrada,\nSalve! Salve!\nBrasil, de amor eterno seja símbolo\nO lábaro que ostentas estrelado,\nE diga o verde-louro dessa flâmula\n\"Paz no futuro e glória no passado.\"\nMas, se ergues da justiça a clava forte,\nVerás que um filho teu não foge à luta,\nNem teme, quem te adora, a própria morte.\nTerra adorada,\nEntre outras mil,\nÉs tu, Brasil,\nÓ Pátria amada!\nDos filhos deste solo és mãe gentil,\nPátria amada, Brasil!\n\nHino Nacional do Brasil. Letra: Joaquim Osório Duque Estrada. Música: Francisco Manuel da Silva (fragmento).\n\nO uso da norma-padrão na letra do Hino Nacional do Brasil é justificado por tratar-se de um(a)",
      subItens: []
    },
    options: ["reverência de um povo a seu país.","gênero solene de característica protocolar.","canção concebida sem interferência da oralidade.","escrita de uma fase mais antiga da língua portuguesa.","artefato cultural respeitado por todo o povo brasileiro."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Variação Linguística",
    conteudo: "Língua Portuguesa – Gêneros Textuais",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "(Imagem da fachada de um supermercado com os dizeres \"Supermercado\" em diferentes idiomas: inglês, alemão, espanhol, japonês, árabe.)\n\nSILVA, I.; SANTOS, M. E. P.; JUNG, N. M. Domínios de Lingu@gem, n. 4, out.-dez. 2016 (adaptado).\n\nA fotografia exibe a fachada de um supermercado em Foz do Iguaçu, cuja localização transfronteiriça é marcada tanto pelo limite com Argentina e Paraguai quanto pela presença de outros povos. Essa fachada revela o(a)",
      subItens: []
    },
    options: ["apagamento da identidade linguística.","planejamento linguístico no espaço urbano.","presença marcante da tradição oral na cidade.","disputa de comunidades linguísticas diferentes.","poluição visual promovida pelo multilinguismo."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Linguagem e Sociedade",
    conteudo: "Língua Portuguesa – Multilinguismo",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "(Imagem: Quadrinho adaptado de \"Grande Sertão: Veredas\" de João Guimarães Rosa, mostrando uma cena de um bezerro branco, com máscara de cachorro, sendo morto, e diálogos.)\n\nROSA, R. Grande sertão: veredas: adaptação da obra de João Guimarães Rosa. São Paulo: Globo, 2014 (adaptado).\n\nA imagem integra uma adaptação em quadrinhos da obra Grande sertão: veredas, de Guimarães Rosa. Na representação gráfica, a inter-relação de diferentes linguagens caracteriza-se por",
      subItens: []
    },
    options: ["romper com a linearidade das ações da narrativa literária.","ilustrar de modo fidedigno passagens representativas da história.","articular a tensão do romance à desproporcionalidade das formas.","potencializar a dramaticidade do episódio com recursos das artes visuais.","desconstruir a diagramação do texto literário pelo desequilíbrio da composição."],
    correctAnswer: 3,
    materia: "Arte – Linguagem dos Quadrinhos",
    conteudo: "Arte – Adaptação de Obras Literárias",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "(Imagem: Campanha \"SEPARE O LIXO E ACERTE NA LATA\". Representação de uma lata de lixo com divisões para \"ÚMIDO\" (cascas, ossos, restos de comida, pó de café e chá, galhos e podas) e \"SECO\" (latas, papéis, plástico, vidro). Acima, o texto \"PLÁSTICO VELHO PODE VIRAR TECIDO NOVO\" e informações sobre o valor da reciclagem de PET.)\n\nDisponível em: www.separeolixo.gov.br. Acesso em: 4 dez. 2017 (adaptado).\n\nNessa campanha, a principal estratégia para convencer o leitor a fazer a reciclagem do lixo é a utilização da linguagem não verbal como argumento para",
      subItens: []
    },
    options: ["reaproveitamento de material.","facilidade na separação do lixo.","melhoria da condição do catador.","preservação de recursos naturais.","geração de renda para o trabalhador."],
    correctAnswer: 4,
    materia: "Língua Portuguesa – Linguagem Não Verbal",
    conteudo: "Língua Portuguesa – Gêneros Publicitários",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "(Fotografia: LUCAS HALLEL. Disponível em: www.flickr.com. Acesso em: 16 abr. 2018 (adaptado). A imagem mostra artistas do grupo O Teatro Mágico se apresentando em um palco com elementos circenses e musicais.)\n\nO grupo O Teatro Mágico apresenta composições autorais que têm referências estéticas do rock, do pop e da música folclórica brasileira. A originalidade dos seus shows tem relação com a ópera europeia do século XIX a partir da",
      subItens: []
    },
    options: ["disposição cênica dos artistas no espaço teatral.","integração de diversas linguagens artísticas.","sobreposição entre música e texto literário.","manutenção de um diálogo com o público.","adoção de um enredo como fio condutor."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "TEXTO I\n(Imagem: GRIMBERG, N. Estrutura vertical dupla. Disponível em: www.normagrimberg.com.br. Acesso em: 13 dez. 2017. A imagem mostra uma escultura em cerâmica composta por elementos empilhados verticalmente.)\n\nTEXTO II\n(Imagem: Urna cerimonial marajoara. Cerâmica. 1400 a 400 a.C. 81 cm. Museu Nacional do Rio de Janeiro. Disponível em: www.museunacional.ufrj.br. Acesso em: 11 dez. 2017. A imagem mostra uma urna funerária indígena marajoara, com decorações e formas arredondadas.)\n\nAs duas imagens são produções que têm a cerâmica como matéria-prima. A obra Estrutura vertical dupla se distingue da urna funerária marajoara ao",
      subItens: []
    },
    options: ["evidenciar a simetria na disposição das peças.","materializar a técnica sem função utilitária.","abandonar a regularidade na composição.","anular possibilidades de leituras afetivas.","integrar o suporte em sua constituição."],
    correctAnswer: 1,
    materia: "Arte – Escultura",
    conteudo: "Arte – Cultura Material",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "O rio que fazia uma volta atrás de nossa casa era a imagem de um vidro mole que fazia uma volta atrás de casa.\nPassou um homem e disse: Essa volta que o rio faz por trás de sua casa se chama enseada.\nNão era mais a imagem de uma cobra de vidro que fazia uma volta atrás de casa.\nEra uma enseada.\nAcho que o nome empobreceu a imagem.\n\nBARROS, M. O livro das ignoranças. Rio de Janeiro: Best Seller, 2008.\n\nO sujeito poético questiona o uso do vocábulo \"enseada\" porque a",
      subItens: []
    },
    options: ["terminologia mencionada é incorreta.","nomeação minimiza a percepção subjetiva.","palavra é aplicada a outro espaço geográfico.","designação atribuída ao termo é desconhecida.","definição modifica o significado do termo no dicionário."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Literatura Brasileira",
    conteudo: "Língua Portuguesa – Linguagem e Significado",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "REAÇÕES CELÍACAS AO LER\nUM RÓTULO SEM GLÚTEN\n(Imagem com 5 emoticons representando reações ao ler rótulos sem glúten: SORRINDO (\"Não Contém Glúten CURTI!\"), SORRINDO (\"Sem Glúten e com Sabor AMEI!\"), NORMAL (\"Sem Glúten e Barato HAHA!\"), TRISTE (\"Sem Glúten mas pode conter traços TRISTE!\"), RAIVA (\"Rótulo tá todo errado GRR!\").)\n\nDisponível em: www.facebook.$\\\\frac{com}{omeusegredinho}$. Acesso em: 9 dez. 2017 (adaptado).\n\nEssa imagem ilustra a reação dos celíacos (pessoas sensíveis ao glúten) ao ler rótulos de alimentos sem glúten. Essas reações indicam que, em geral, os rótulos desses produtos",
      subItens: []
    },
    options: ["trazem informações explícitas sobre a presença do glúten.","oferecem várias opções de sabor para esses consumidores.","classificam o produto como adequado para o consumidor celíaco.","influenciam o consumo de alimentos especiais para esses consumidores.","variam na forma de apresentação de informações relevantes para esse público."],
    correctAnswer: 4,
    materia: "Língua Portuguesa – Linguagem Não Verbal",
    conteudo: "Língua Portuguesa – Leitura Crítica",
    imageNames: []
...
createQuestion({
    ...
    conteudo: "Língua Portuguesa – Linguagem Persuasiva",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Figura 1\n(Imagem: Fotografia de um ônibus antigo, com a inscrição \"CLEVELAND AVE\" na frente.)\n\nDisponível em: www.thehenryford.org. Acesso em: 3 maio 2018.\n\nFigura 2\n(Imagem: Fotografia em preto e branco de Rosa Parks e Martin Luther King Jr.)\n\nDisponível em: www.abc.net.au. Acesso em: 3 maio 2018.\n\nEsse ônibus relaciona-se ao ato praticado, em 1955, por Rosa Parks, apresentada em fotografia ao lado de Martin Luther King. O veículo alcançou o estatuto de obra museológica por simbolizar o(a)",
      subItens: []
    },
    options: ["impacto do medo da corrida armamentista.","democratização do acesso à escola pública.","preconceito de gênero no transporte coletivo.","deflagração do movimento por igualdade civil.","eclosão da rebeldia no comportamento juvenil."],
    correctAnswer: 3,
    materia: "História – Movimento pelos Direitos Civis",
    conteudo: "Sociologia – Segregação Racial",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["predisposição ao conhecimento.","submissão ao transcendente.","tradição epistemológica.","condição original.","vocação política."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Foi-se o tempo em que era possível mostrar um mundo econômico organizado em camadas bem definidas, onde grandes centros urbanos se ligavam, por si próprios, a economias adjacentes \"lentas”, com o ritmo muito mais rápido do comércio e das finanças de longo alcance. Hoje tudo ocorre como se essas camadas sobrepostas estivessem mescladas e interpermeadas. Interdependências de curto e longo alcance não podem mais ser separadas umas das outras.\n\nBRENNER, N. A globalização como reterritorialização. Cadernos Metrópole, n. 24, jul.-dez. 2010 (adaptado).\n\nA maior complexidade dos espaços urbanos contemporâneos ressaltada no texto explica-se pela",
      subItens: []
    },
    options: ["expansão de áreas metropolitanas.","emancipação de novos municípios.","consolidação de domínios jurídicos.","articulação de redes multiescalares.","redefinição de regiões administrativas."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["utilização do trabalho escravo.","implantação de polos urbanos.","devastação de áreas naturais.","ocupação de terras indígenas.","expropriação de riquezas locais."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Anamorfose é a transformação cartográfica espacial em que a forma dos objetos é distorcida, de forma a realçar o tema. A área das unidades espaciais às quais o tema se refere é alterada de forma proporcional ao respectivo valor.\n\nGASPAR, A. J. Dicionário de ciências cartográficas. Lisboa: Lidel, 2004.\n\nA técnica descrita foi aplicada na seguinte forma de representação do espaço:\n\n(Imagem: Gráficos e mapas anamórficos. A imagem (A) mostra um mapa de contorno de um continente e as imagens (B), (C), (D) e (E) mostram representações espaciais distorcidas de mapas do mundo ou de uma cidade, para destacar um tema específico.)",
      subItens: []
    },
    options: ["(Imagem A, mapa de contorno.)","(Imagem B, gráfico de elevação.)","(Imagem C, mapa-múndi com áreas de países distorcidas para mostrar a população.)","(Imagem D, um mapa de rota.)","(Imagem E, um mapa de rua.)"],
    correctAnswer: 2,
    materia: "Geografia – Cartografia",
    conteudo: "Geografia – Representação Espacial",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["autonomia de atuação das multinacionais.","descentralização da cobrança tributária.","flexibilização das reservas cambiais.","liberdade de remessa de ganhos.","captação de recursos do exterior."],
    correctAnswer: 4,
    materia: "História – História do Brasil República",
    conteudo: "História – Economia Brasileira",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "(Imagem: Gráfico mostrando a trajetória de ciclones tropicais sobre uma superfície com características como cobertura vegetal, barreiras orográficas, pressão atmosférica, refletividade e correntes marinhas.)\n\nDisponível em: http://globalwarmingart.com. Acesso em: 12 jul. 2015 (adaptado).\n\nQual característica do meio físico é condição necessária para a distribuição espacial do fenômeno representado?",
      subItens: []
    },
    options: ["Cobertura vegetal com porte arbóreo.","Barreiras orográficas com altitudes elevadas.","Pressão atmosférica com diferença acentuada.","Superfície continental com refletividade intensa.","Correntes marinhas com direções convergentes."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Precipitações (mm)\n(Gráfico de linha mostrando \"Vazão em áreas urbanizadas\" e \"Vazão em áreas não urbanizadas\" ao longo do tempo (h). A vazão em áreas urbanizadas apresenta picos mais altos e mais rápidos após o início da precipitação.)\n\nDisponível em: www.biologiasur.org. Acesso em: 4 jul. 2015 (adaptado).\n\nA dinâmica hidrológica expressa no gráfico demonstra que o processo de urbanização promove a",
      subItens: []
    },
    options: ["redução do volume dos rios.","expansão do lençol freático.","diminuição do índice de chuvas.","retração do nível dos reservatórios.","ampliação do escoamento superficial."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["construção de vias terrestres.","preservação do meio ambiente.","emprego de armamentos sofisticados.","intimidação contínua da população local.","domínio cognitivo da configuração espacial."],
    correctAnswer: 4,
    materia: "Geografia – Geopolítica",
    conteudo: "Geografia – Estratégias Militares",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "(Imagem: Cartaz de propaganda do Estado Novo com o texto \"Crianças! Aprendendo, no lar e nas escolas, o culto da Pátria, trazeis para a vida prática todas as probabilidades de êxito. Só o amor constrói e, amando o Brasil, forçosamente o conduzireis aos mais altos destinos entre as Nações, realizando os desejos de engrandecimento aninhados em cada coração brasileiro.\".)\n\nDisponível em: http://cpdoc.fgv.br. Acesso em: 6 dez. 2017.\n\nEssa imagem foi impressa em cartilha escolar durante a vigência do Estado Novo com o intuito de",
      subItens: []
    },
    options: ["destacar a sabedoria inata do líder governamental.","atender a necessidade familiar de obediência infantil.","promover o desenvolvimento consistente das atitudes solidárias.","conquistar a aprovação política por meio do apelo carismático.","estimular o interesse acadêmico por meio de exercícios intelectuais."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Os países industriais adotaram uma concepção diferente das relações familiares e do lugar da fecundidade na vida familiar e social. A preocupação de garantir uma transmissão integral das vantagens econômicas e sociais adquiridas tem como resultado uma ação voluntária de limitação do número de nascimentos.\n\nGEORGE, P. Panorama do mundo atual. São Paulo: Difusão Europeia do Livro, 1968 (adaptado).\n\nEm meados do século XX, o fenômeno social descrito contribuiu para o processo europeu de",
      subItens: []
    },
    options: ["estabilização da pirâmide etária.","conclusão da transição demográfica.","contenção da entrada de imigrantes.","elevação do crescimento vegetativo.","formação de espaços superpovoados."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "A quem não basta pouco, nada basta.\n\nEPICURO. Os pensadores. São Paulo: Abril Cultural, 1985.\n\nRemanescente do período helenístico, a máxima apresentada valoriza a seguinte virtude:",
      subItens: []
    },
    options: ["Esperança, tida como confiança no porvir.","Justiça, interpretada como retidão de caráter.","Temperança, marcada pelo domínio da vontade.","Coragem, definida como fortitude na dificuldade.","Prudência, caracterizada pelo correto uso da razão."],
    correctAnswer: 2,
...
createQuestion({
    ...
    options: ["afirmação das origens ancestrais.","fragilização das redes de sociabilidade.","padronização das políticas educacionais.","fragmentação das propriedades agrícolas.","globalização das tecnologias de comunicação."],
    correctAnswer: 1,
    materia: "Sociologia – Pobreza e Exclusão Social",
    conteudo: "Sociologia – Cultura e Sociedade",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["liberação da circulação de pessoas.","preponderância dos limites naturais.","supressão dos obstáculos aduaneiros.","desvalorização da noção de nacionalismo.","seletividade dos mecanismos segregadores."],
    correctAnswer: 4,
    materia: "Geografia – Geopolítica",
    conteudo: "Geografia – Globalização",
    imageNames: []
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Não é verdade que estão ainda cheios de velhice espiritual aqueles que nos dizem: \"Que fazia Deus antes de criar o céu e a terra? Se estava ocioso e nada realizava\", dizem eles, \"por que não ficou sempre assim no decurso dos séculos, abstendo-se, como antes, de toda ação? Se existiu em Deus um novo movimento, uma vontade nova para dar o ser a criaturas que nunca antes criara, como pode haver verdadeira eternidade, se n'Ele aparece uma vontade que antes não existia?\"\n\nAGOSTINHO. Confissões. São Paulo: Abril Cultural, 1984.\n\nA questão da eternidade, tal como abordada pelo autor, é um exemplo da reflexão filosófica sobre a(s)",
      subItens: []
    },
    options: ["essência da ética cristã.","natureza universal da tradição.","certezas inabaláveis da experiência.","abrangência da compreensão humana.","interpretações da realidade circundante."],
    correctAnswer: 3,
    materia: "Filosofia – Filosofia Medieval",
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Rodrigo havia sido indicado pela oposição para fiscal duma das mesas eleitorais. Pôs o revólver na cintura, uma caixa de balas no bolso e encaminhou-se para seu posto. A chamada dos eleitores começou às sete da manhã. Plantados junto da porta, os capangas do Trindade ofereciam cédulas com o nome dos candidatos oficiais a todos os eleitores que entravam. Estes, em sua quase totalidade, tomavam docilmente dos papeluchos e depositavam-nos na urna, depois de assinar a autêntica. Os que se recusavam a isso tinham seus nomes acintosamente anotados.\n\nVERISSIMO, E. O tempo e o vento. São Paulo: Globo, 2003 (adaptado).\n\nErico Verissimo tematiza em obra ficcional o seguinte aspecto característico da vida política durante a Primeira República:",
      subItens: []
    },
    options: ["Identificação forçada de homens analfabetos.","Monitoramento legal dos pleitos legislativos.","Repressão explícita ao exercício de direito.","Propaganda direcionada à população do campo.","Cerceamento policial dos operários sindicalizados."],
    correctAnswer: 2,
    materia: "História – Primeira República",
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Então disse: \"Este é o local onde construirei. Tudo pode chegar aqui pelo Eufrates, o Tigre e uma rede de canais. Só um lugar como este sustentará o exército e a população geral\". Assim ele traçou e destinou as verbas para a sua construção, e deitou o primeiro tijolo com sua própria mão, dizendo: \"Em nome de Deus, e em louvor a Ele. Construí, e que Deus vos abençoe\".\n\nAL-TABARI, M. Uma história dos povos árabes. São Paulo: Cia. das Letras, 1995 (adaptado).\n\nA decisão do califa Al-Mansur (754-775) de construir Bagdá nesse local orientou-se pela",
      subItens: []
    },
    options: ["disponibilidade de rotas e terras férteis como base da dominação política.","proximidade de áreas populosas como afirmação da superioridade bélica.","submissão à hierarquia e à lei islâmica como controle do poder real.","fuga da península arábica como afastamento dos conflitos sucessórios.","ocupação de região fronteiriça como contenção do avanço mongol."],
    correctAnswer: 0,
    materia: "História – Mundo Islâmico",
    conteudo: "Geografia – Urbanização",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "ELLA SERIA ADORAVEL\n...si não fosse doentia\n\n(Imagem: Anúncio publicitário antigo de um produto chamado \"A SAÚDE DA MULHER\". A imagem mostra uma mulher elegante e o texto exalta a saúde perfeita como capaz de dar beleza e encanto, promovendo o produto para regularizar o organismo feminino.)\n\nTônico para a saúde da mulher. Disponível em: www.propagandashistoricas.com.br. Acesso em: 28 nov. 2017.\n\nO anúncio publicitário da década de 1940 reforça os seguintes estereótipos atribuídos historicamente a uma suposta natureza feminina:",
      subItens: []
    },
    options: ["Pudor inato e instinto maternal.","Fragilidade física e necessidade de aceitação.","Isolamento social e procura de autoconhecimento.","Dependência econômica e desejo de ostentação.","Mentalidade fútil e conduta hedonista."],
    correctAnswer: 1,
    materia: "Sociologia – Gênero e Sociedade",
    conteudo: "Sociologia – Mídia e Publicidade",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Participação percentual do extrativismo vegetal e da silvicultura no valor da produção primária florestal – Brasil – 1996-2014\n\n(Gráfico de linhas mostrando a participação percentual do extrativismo vegetal e da silvicultura no valor da produção primária florestal no Brasil de 1996 a 2014. A linha do extrativismo vegetal diminui e a da silvicultura aumenta ao longo do período.)\n\nIBGE. Produção da extração vegetal e da silvicultura. Rio de Janeiro: IBGE, 2014 (adaptado).\n\nConsiderando as diferenças entre extrativismo vegetal e silvicultura, a variação das curvas do gráfico foi influenciada pela tendência de",
      subItens: []
    },
    options: ["conservação do bioma nativo.","estagnação do setor primário.","utilização de madeira de reflorestamento.","redução da produção de móveis.","retração da indústria alimentícia."],
    correctAnswer: 2,
    materia: "Geografia – Setor Primário",
    conteudo: "Geografia – Economia Florestal",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["conclusão operacional obtida por lógica dedutiva.","visão de mundo marcada por preconceitos morais.","hábito social condicionado pela religiosidade popular.","conhecimento empírico apropriado pelo senso comum.","padrão de preservação construído por experimentação dirigida."],
    correctAnswer: 3,
