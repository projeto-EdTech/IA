createQuestion({
    ...
    options: ["Gráfico que mostra aceleração variando linearmente em forma de triângulo.","Gráfico que mostra aceleração constante e positiva.","Gráfico que mostra aceleração constante e igual a zero.","Gráfico que mostra aceleração constante e negativa.","Gráfico que mostra aceleração constante e positiva a partir de um instante t_H."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "Assinale a alternativa correta sobre o Sermão do bom sucesso das armas e o Sermão de Santo Antônio, do padre Antônio Vieira.",
      subItens: []
    },
    options: ["No Sermão do bom sucesso das armas, o orador constrói argumentos para desqualificar o interlocutor e, então, provar seu erro em proteger os holandeses.","No Sermão de Santo Antônio, o orador dirige-se aos peixes, a fim de destacar suas virtudes, inexistentes nos homens.","No Sermão do bom sucesso das armas, o orador simula uma interpelação a Deus para conclamar os maranhenses a lutarem contra os holandeses.","No Sermão de Santo Antônio, o orador, simulando dirigir-se aos peixes, repreende, entre outras coisas, a tendência dos homens a se entredevorarem.","No Sermão do bom sucesso das armas, o orador simula a vitória dos holandeses, a fim de destacar a necessidade de os brasileiros abandonarem seus pecados."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "Observe a tira abaixo.\n[Imagem: Armandinho comic, shows a child asking “VOCÊ SABE / QUEM INVENTOU / O PAPEL / DO BIÓLOGO?” and the biologist answers “É O PAPEL / RECICLADO?” then in the last frame the child says “BIÓLOGO!”. Text below: BECK, A. Armandinho. Zero Hora. 10 ago. 2015.]\nA biologia como ciência começou a ser estruturada no século XIX. Assinale com V (verdadeiro) ou F (falso) as afirmações abaixo, referentes a essa área de conhecimento.\n( ) As células são unidades estruturais básicas que provêm de células preexistentes.\n( ) Os seres vivos são geneticamente relacionados e capazes de evoluir.\n( ) A maioria das reações químicas que mantém os organismos vivos ocorre no ambiente extracelular.\n( ) Conclusões obtidas a partir de um determinado organismo não podem servir de base para investigações em outros seres vivos.\nA sequência correta de preenchimento dos parênteses, de cima para baixo, é",
      subItens: []
    },
    options: ["V – V – F – F.","V – F – V – F.","V – F – F – V.","F – F – V – F.","F – V – V – V."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "Sobre as macromoléculas biológicas presentes em todos os organismos, é correto afirmar que",
      subItens: []
    },
    options: ["os carboidratos são as macromoléculas encontradas em maior quantidade nos tecidos vivos.","os carboidratos podem ter função estrutural como, por exemplo, a quitina presente nos artrópodes.","os monômeros das proteínas são os aminoácidos cujas diversificadas funções incluem o armazenamento de energia.","os ácidos graxos saturados são encontrados somente em animais, pois as plantas não produzem colesterol.","as bases nitrogenadas encontradas no DNA e no RNA são as mesmas."],
    correctAnswer: 1,
    materia: "Biologia – Bioquímica",
    conteudo: "Biologia – Macromoléculas",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "Por questões econômicas, a medalha de ouro não é 100% de ouro desde os jogos de 1912 em Estocolmo, e sua composição varia nas diferentes edições dos jogos olímpicos. Para os jogos olímpicos de 2016, no Rio de Janeiro, a composição das medalhas foi distribuída como apresenta o quadro abaixo.\n[Imagem: Tabela intitulada “Medalha Composição em massa” com as seguintes linhas: “Ouro prata (98,8%) e ouro (1,2%)”, “Prata prata (100%)”, “Bronze cobre (95%) e zinco (5%)”.]\nConsiderando que as três medalhas tenham a mesma massa, assinale a alternativa que apresenta as medalhas em ordem crescente de número de átomos metálicos na sua composição.",
      subItens: []
    },
    options: ["Medalha de bronze < medalha de ouro < medalha de prata.","Medalha de bronze < medalha de prata < medalha de ouro.","Medalha de prata < medalha de ouro < medalha de bronze.","Medalha de prata < medalha de bronze < medalha de ouro.","Medalha de ouro < medalha de prata < medalha de bronze."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "Observe o gráfico e a tabela abaixo, que representam a curva de solubilidade aquosa (em gramas de soluto por 100 g de água) do nitrato de potássio e do nitrato de sódio em função da temperatura.\n[Imagem: Gráfico de Solubilidade vs Temperatura, mostrando duas curvas, A e B. A curva A mostra um aumento mais acentuado da solubilidade com a temperatura do que a curva B. Tabela ao lado com “T (°C)”, “KNO_{3}”, “NaNO_{3}” e valores de solubilidade para 60, 65, 75 °C.]\nAssinale a alternativa que preenche corretamente as lacunas do enunciado abaixo, na ordem em que aparecem.\nA curva A diz respeito ao ........ e a curva B, ao ........ . Considerando duas soluções aquosas saturadas e sem precipitado, uma de KNO_{3} e outra de NaNO_{3}, a 65 °C, o efeito da diminuição da temperatura acarretará a precipitação de ........ .",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "O rompimento de uma barragem da mineradora Samarco, em novembro de 2015, considerado o maior desastre ambiental do Brasil, causou uma enxurrada de lama com rejeitos, na região de Mariana (MG). Considere as afirmações abaixo, sobre as consequências desse desastre.\nI - O impacto ambiental do rompimento, que vazou 35 bilhões de litros de rejeitos de minérios, atingiu a vida aquática, as faixas de matas ciliares, bem como o litoral do Espírito Santo.\nII - A lama contaminada, oriunda da barragem, abalou o abastecimento de água de várias cidades ao longo da bacia do Rio Doce.\nIII- A lama contaminada modificou a composição do solo, ao longo de 650 km do Rio Doce e seus afluentes, tornando-o improdutivo naqueles locais em que houve a deposição dos sedimentos.\nQuais estão corretas?",
      subItens: []
    },
    options: ["Apenas I.","Apenas II.","Apenas III.","Apenas II e III.","I, II e III."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "Na sua narrativa da Guerra do Peloponeso, Tucídides assim relata as práticas funerais atenienses.\n“Desse cortejo participam livremente cidadãos e estrangeiros; e as mulheres da família estão presentes, ao túmulo, fazendo ouvir sua lamentação. Depositam-se, em seguida, os despojos no monumento público, situado na mais bela avenida da cidade, e onde as vítimas de guerra são sempre sepultadas – à exceção dos mortos de Maratona: a estes, considerando-se seu mérito excepcional, concedeu-se sepultura no próprio lugar da batalha. Uma vez que a terra recobre os mortos, um homem escolhido pela pólis, reputado por distinguir-se intelectualmente e gozar de alta estima, pronuncia em sua honra um elogio apropriado; depois disto, todos se retiram. Assim têm lugar esses funerais; e, durante toda a guerra, quando era o caso, aplicava-se o costume”.\nCitado em LORAUX, N. A invenção de Atenas. Rio de Janeiro: Editora 34, 1994. p. 39. Assinale a alternativa correta a respeito da história da antiguidade grega, a partir do texto apresentado.",
      subItens: []
    },
    options: ["Os ritos funerais na Grécia antiga eram cerimônias religiosas, destinadas apenas a conduzir ao paraíso os heróis mortos.","Os metecos, participantes das práticas funerais, formavam parte do demos ateniense e possuíam os mesmos direitos políticos que os cidadãos da pólis.","Todos os soldados atenienses mortos nos confrontos com Esparta, em razão do grande mérito de seus feitos, eram sepultados no próprio lugar da batalha.","A cena descrita, ocorrida na democracia ateniense, indica o valor dado aos cidadãos mais eloquentes da cidade.","A realização de um discurso fúnebre por alguém escolhido na massa de cidadãos de Atenas revela o caráter secundário e improvisado da cerimônia."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "Na última década do século XX, a perda de gelo de uma das maiores geleiras do hemisfério norte foi estimada em 96 km³. Se 1 cm³ de gelo tem massa de 0,92 g, a massa de 96 km³ de gelo, em quilogramas, é",
      subItens: []
    },
    options: ["8,832·10¹².","8,832·10¹³.","8,832·10¹⁴.","8,832·1⁵.","8,832·1⁶."],
    correctAnswer: 1,
