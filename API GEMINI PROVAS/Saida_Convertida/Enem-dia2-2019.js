createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Para realizar o desentupimento de tubulações de esgotos residenciais, é utilizada uma mistura sólida comercial que contém hidróxido de sódio (NaOH) e outra espécie química pulverizada. Quando é adicionada água a essa mistura, ocorre uma reação que libera gás hidrogênio e energia na forma de calor, aumentando a eficiência do processo de desentupimento.\nConsidere que 1 g desse medicamento ocupe um volume de 1 cm³.\nQual é a outra espécie que está presente na composição da mistura sólida comercial para aumentar sua eficiência?\nTabela: Semirreação de redução | E° (V)\$1_{2}$ H₂O + 2 e⁻ → H₂ + 2 OH⁻ | -0,83\nCo(OH)₂ + 2 e⁻ → Co + 2 OH⁻ | -0,73\nCu(OH)₂ + 2 e⁻ → Cu + 2 OH⁻ | -0,22\nPbO + H₂O + 2 e⁻ → Pb + 2 OH⁻ | -0,58\nAl(OH)₄⁻ + 3 e⁻ → Al + 4 OH⁻ | -2,33\nFe(OH)₂ + 2 e⁻ → Fe + 2 OH⁻ | -0,88",
      subItens: []
    },
    options: ["Al","Co","Cu(OH)₂","Fe(OH)₂","Pb"],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "As redes de alta tensão para transmissão de energia elétrica geram campo magnético variável o suficiente para induzir corrente elétrica no arame das cercas. Tanto os animais quanto os funcionários das propriedades rurais ou das concessionárias de energia devem ter muito cuidado ao se aproximarem de uma cerca quando esta estiver próxima a uma rede de alta tensão, pois, ao tocarem no arame da cerca, poderão sofrer choque elétrico.\nPara minimizar este tipo de problema, deve-se:\nA Afastar o aterramento dos arames da cerca.\nB Acrescentar fusível de segurança na cerca.\nC Realizar o aterramento da rede de alta tensão.\nD Instalar fusível de segurança na rede de alta tensão.\nE Utilizar fios encapados com isolante na rede de alta tensão.",
      subItens: []
    },
    options: ["Afastar o aterramento dos arames da cerca.","Acrescentar fusível de segurança na cerca.","Realizar o aterramento da rede de alta tensão.","Instalar fusível de segurança na rede de alta tensão.","Utilizar fios encapados com isolante na rede de alta tensão."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Glicólise é um processo que ocorre nas células, convertendo glicose em piruvato. Durante a prática de exercícios físicos que demandam grande quantidade de esforço, a glicose é completamente oxidada na presença de O₂. Entretanto, em alguns casos, as células musculares podem sofrer um déficit de O₂ e a glicose ser convertida em duas moléculas de ácido lático. As equações termoquímicas para a combustão da glicose e do ácido lático são, respectivamente, mostradas a seguir:\nC₆H₁₂O₆ (s) + 6 O₂ (g) → 6 CO₂ (g) + 6 H₂O (l) ∆H = −2 800 kJ\nCH₃CH(OH)COOH (s) + 3 O₂ (g) → 3 CO₂ (g) + 3 H₂O (l) ∆H = −1 344 kJ\nO processo anaeróbico é menos vantajoso energeticamente porque\nA libera 112 kJ por mol de glicose.\nB libera 467 kJ por mol de glicose.\nC libera 2 688 kJ por mol de glicose.\nD absorve 1 344 kJ por mol de glicose.\nE absorve 2 800 kJ por mol de glicose.",
      subItens: []
    },
    options: ["libera 112 kJ por mol de glicose.","libera 467 kJ por mol de glicose.","libera 2 688 kJ por mol de glicose.","absorve 1 344 kJ por mol de glicose.","absorve 2 800 kJ por mol de glicose."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "No quadro estão apresentadas informações sobre duas estratégias de sobrevivência que podem ser adotadas por algumas espécies de seres vivos.\nTabela: Hábitat | Potencial biótico | Duração da vida | Descendentes | Tamanho populacional\nEstratégia 1: Mais instável e imprevisível | Muito elevado | Curta e com reprodução precoce | Muitos e com tamanho corporal pequeno | Variável\nEstratégia 2: Mais estável e previsível | Baixo | Longa e com reprodução tardia | Poucos e com tamanho corporal maior | Constante\nNa recuperação de uma área desmatada deveriam ser reintroduzidas primeiramente as espécies que adotam qual estratégia?\nA Estratégia 1, pois essas espécies produzem descendentes pequenos, o que diminui a competição com outras espécies.\nB Estratégia 2, pois essas espécies têm uma longa duração da vida, o que favorece a produção de muitos descendentes.\nC Estratégia 1, pois essas espécies apresentam um elevado potencial biótico, o que facilita a rápida recolonização da área desmatada.\nD Estratégia 2, pois essas espécies estão adaptadas a hábitats mais estáveis, o que corresponde ao ambiente de uma área desmatada.\nE Estratégia 2, pois essas espécies apresentam um tamanho populacional constante, o que propicia uma recolonização mais estável da área desmatada.",
      subItens: []
    },
    options: ["Estratégia 1, pois essas espécies produzem descendentes pequenos, o que diminui a competição com outras espécies.","Estratégia 2, pois essas espécies têm uma longa duração da vida, o que favorece a produção de muitos descendentes.","Estratégia 1, pois essas espécies apresentam um elevado potencial biótico, o que facilita a rápida recolonização da área desmatada.","Estratégia 2, pois essas espécies estão adaptadas a hábitats mais estáveis, o que corresponde ao ambiente de uma área desmatada.","Estratégia 2, pois essas espécies apresentam um tamanho populacional constante, o que propicia uma recolonização mais estável da área desmatada."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Os olhos humanos normalmente têm três tipos de cones responsáveis pela percepção das cores: um tipo para tons vermelhos, um para tons azuis e outro para tons verdes. As diversas cores que enxergamos são o resultado da percepção das cores básicas, como indica a figura.\nDiagrama de Cores: Círculo com cores indicadas: Amarelo, Vermelho, Verde, Branco, Ciano, Magenta, Azul.\nA protanopia é um tipo de daltonismo em que há diminuição ou ausência de receptores da cor vermelha. Considere um teste com dois voluntários: uma pessoa com visão normal e outra com caso severo de protanopia. Nesse teste, eles devem escrever a cor dos cartões que lhes são mostrados. São utilizadas as cores indicadas na figura.\nPara qual cartão os dois voluntários identificarão a mesma cor?\nA Vermelho.\nB Magenta.\nC Amarelo.\nD Branco.\nE Azul.",
      subItens: []
    },
    options: ["Vermelho.","Magenta.","Amarelo.","Branco.","Azul."],
    correctAnswer: 4,
    materia: "Biologia – Sentidos",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Um teste de laboratório permite identificar alguns cátions metálicos ao introduzir uma pequena quantidade do material de interesse em uma chama de bico de Bunsen para, em seguida, observar a cor da luz emitida.\nA cor observada é proveniente da emissão de radiação eletromagnética ao ocorrer a\nA mudança da fase sólida para a fase líquida do elemento metálico.\nB combustão dos cátions metálicos provocada pelas moléculas de oxigênio da atmosfera.\nC diminuição da energia cinética dos elétrons em uma mesma órbita na eletrosfera atômica.\nD transição eletrônica de um nível mais externo para outro mais interno na eletrosfera atômica.\nE promoção dos elétrons que se encontram no estado fundamental de energia para níveis mais energéticos.",
      subItens: []
    },
    options: ["mudança da fase sólida para a fase líquida do elemento metálico.","combustão dos cátions metálicos provocada pelas moléculas de oxigênio da atmosfera.","diminuição da energia cinética dos elétrons em uma mesma órbita na eletrosfera atômica.","transição eletrônica de um nível mais externo para outro mais interno na eletrosfera atômica.","promoção dos elétrons que se encontram no estado fundamental de energia para níveis mais energéticos."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Em qualquer obra de construção civil é fundamental a utilização de equipamentos de proteção individual, tal como capacetes. Por exemplo, a queda livre de um tijolo de massa 2,5 kg de uma altura de 5 m, cujo impacto contra um capacete pode durar até 0,5 s, resulta em uma força impulsiva média maior do que o peso do tijolo. Suponha que a aceleração gravitacional seja 10 m s⁻² e que o efeito de resistência do ar seja desprezível.\nA força impulsiva média gerada por esse impacto equivale ao peso de quantos tijolos iguais?\nA 2\nB 5\nC 10\nD 20\nE 50",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Os hidrocarbonetos são moléculas orgânicas com uma série de aplicações industriais. Por exemplo, eles estão presentes em grande quantidade nas diversas frações do petróleo e normalmente são separados por destilação fracionada, com base em suas temperaturas de ebulição. O quadro apresenta as principais frações obtidas na destilação do petróleo em diferentes faixas de temperaturas.\nTabela: Fração | Faixa de temperatura (°C) | Exemplos de produto(s) | Número de átomos de carbono (hidrocarboneto de fórmula geral CnH2n+2)\$1_{1}$ | Até 20 | Gás natural e gás de cozinha (GLP) | C₁ a C₄\$1_{2}$ | 30 a 180 | Gasolina | C₆ a C₁₂\$1_{3}$ | 170 a 290 | Querosene | C₁₁ a C₁₆\$1_{4}$ | 260 a 350 | Óleo diesel | C₁₄ a C₁₈\nSANTA MARIA, L. C. et al. Petróleo: um tema para o ensino de química. Química Nova na Escola, n. 15, maio 2002 (adaptado).\nNa fração 4, a separação dos compostos ocorre em temperaturas mais elevadas porque\nA suas densidades são maiores.\nB o número de ramificações é maior.\nC sua solubilidade no petróleo é maior.\nD as forças intermoleculares são mais intensas.\nE a cadeia carbônica é mais difícil de ser quebrada.",
      subItens: []
    },
    options: ["suas densidades são maiores.","o número de ramificações é maior.","sua solubilidade no petróleo é maior.","as forças intermoleculares são mais intensas.","a cadeia carbônica é mais difícil de ser quebrada."],
    correctAnswer: 3,
    materia: "Química – Funções Orgânicas",
    conteudo: "Química – Propriedades Físicas",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A utilização de corantes na indústria de alimentos é bastante difundida e a escolha por corantes naturais vem sendo mais explorada por diversas razões. A seguir são mostradas três estruturas de corantes naturais.\nEstruturas químicas da Bixina (presente no urucum), Licopeno (presente no tomate) e β-caroteno (presente na cenoura e na laranja).\nA propriedade comum às estruturas que confere cor a esses compostos é a presença de\nA cadeia conjugada.\nB cadeia ramificada.\nC átomos de carbonos terciários.\nD ligações duplas de configuração cis.\nE átomos de carbonos de hibridação sp³.",
      subItens: []
    },
    options: ["cadeia conjugada.","cadeia ramificada.","átomos de carbonos terciários.","ligações duplas de configuração cis.","átomos de carbonos de hibridação sp³."],
    correctAnswer: 0,
    materia: "Química – Química Orgânica",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "O odor que permanece nas mãos após o contato com alho pode ser eliminado pela utilização de um “sabonete de aço inoxidável”, constituído de aço inox (74%), cromo e níquel. A principal vantagem desse “sabonete” é que ele não se desgasta com o uso. Considere que a principal substância responsável pelo odor de alho é a alicina (estrutura I) e que, para que o odor seja eliminado, ela seja transformada na estrutura II.\nEstrutura I: Alicina com enxofre ligado a grupo sulfóxido.\nEstrutura II: Diallyl disulfide (CH₂=CH-CH₂—S—S—CH₂—CH=CH₂).\nNa conversão de I em II, o “sabonete” atuará como um\nA ácido.\nB redutor.\nC eletrólito.\nD tensoativo.\nE catalisador.",
      subItens: []
    },
    options: ["ácido.","redutor.","eletrólito.","tensoativo.","catalisador."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A poluição radioativa compreende mais de 200 nuclídeos, sendo que, do ponto de vista de impacto ambiental, destacam-se o césio-137 e o estrôncio-90. A maior contribuição de radionuclídeos antropogênicos no meio marinho ocorreu durante as décadas de 1950 e 1960, como resultado dos testes nucleares realizados na atmosfera. O estrôncio-90 pode se acumular nos organismos vivos e em cadeias alimentares e, em razão de sua semelhança química, pode participar no equilíbrio com carbonato e substituir o cálcio em diversos processos biológicos.\nFIGUEIRA, R. C. L.; CUNHA, I. I. L. A contaminação dos oceanos por radionuclídeos antropogênicos. Química Nova, n. 21, 1998 (adaptado).\nAo entrar numa cadeia alimentar da qual o homem faz parte, em qual tecido do organismo humano o estrôncio-90 será acumulado predominantemente?\nA Cartilaginoso.\nB Sanguíneo.\nC Muscular.\nD Nervoso.\nE Ósseo.",
      subItens: []
    },
    options: ["Cartilaginoso.","Sanguíneo.","Muscular.","Nervoso.","Ósseo."],
    correctAnswer: 4,
    materia: "Biologia – Ecologia",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Uma das técnicas de reciclagem química do polímero PET [poli(tereftalato de etileno)] gera o tereftalato de metila e o etanodiol, conforme o esquema de reação, e ocorre por meio de uma reação de transesterificação.\nEsquema de reação de transesterificação do PET, mostrando PET + 2n A, resultando em COOCH₃ e n HOCH₂CH₂OH.\nO composto A, representado no esquema de reação, é o\nA metano.\nB metanol.\nC éter metílico.\nD ácido etanoico.\nE anidrido etanoico.",
      subItens: []
    },
    options: ["metano.","metanol.","éter metílico.","ácido etanoico.","anidrido etanoico."],
    correctAnswer: 1,
    materia: "Química – Química Orgânica",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Durante sua evolução, as plantas apresentaram grande diversidade de características, as quais permitiram sua sobrevivência em diferentes ambientes. Na imagem, cinco dessas características estão indicadas por números.\nDiagrama de cladogênese das plantas, mostrando: Alga verde ancestral. 1: Embriões protegidos no gametófito (Hepáticas, Antóceros, Musgos). 2: Tecidos condutores verdadeiros (Licófitas, Pteridófitas). 3: Formação de tubo polínico (Gimnospermas). 4: Polinização pelo vento (Gimnospermas). 5: Produção de frutos (Angiospermas).\nCAMPBELL, N. et al. Biologia. São Paulo: Artmed, 2010 (adaptado).\nA aquisição evolutiva que permitiu a conquista definitiva do ambiente terrestre pelas plantas está indicada pelo número\nA 1.\nB 2.\nC 3.\nD 4.\nE 5.",
      subItens: []
    },
    options: ["1.","2.","3.","4.","5."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Uma casa tem um cabo elétrico mal dimensionado, de resistência igual a 10 Ω, que a conecta à rede elétrica de 120 V. Nessa casa, cinco lâmpadas, de resistência igual a 200 Ω, estão conectadas ao mesmo circuito que uma televisão de resistência igual a 50 Ω, conforme ilustrado no esquema. A televisão funciona apenas com tensão entre 90 V e 130 V.\nDiagrama de circuito elétrico com fonte de 120 V, resistência de 10 Ω, 5 lâmpadas em paralelo de 200 Ω cada e uma televisão de 50 Ω em paralelo.\nO número máximo de lâmpadas que podem ser ligadas sem que a televisão pare de funcionar é:\nA 1.\nB 2.\nC 3.\nD 4.\nE 5.",
      subItens: []
    },
    options: ["1.","2.","3.","4.","5."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Em 1808, Dalton publicou o seu famoso livro intitulado Um novo sistema de filosofia química (do original A New System of Chemical Philosophy), no qual continha os cinco postulados que serviam como alicerce da primeira teoria atômica da matéria fundamentada no método científico. Esses postulados são numerados a seguir:\$1_{1}$. A matéria é constituída de átomos indivisíveis.\$1_{2}$. Todos os átomos de um dado elemento químico são idênticos em massa e em todas as outras propriedades.\$1_{3}$. Diferentes elementos químicos têm diferentes tipos de átomos; em particular, seus átomos têm diferentes massas.\$1_{4}$. Os átomos são indestrutíveis e nas reações químicas mantêm suas identidades.\$1_{5}$. Átomos de elementos combinam com átomos de outros elementos em proporções de números inteiros pequenos para formar compostos.\nApós o modelo de Dalton, outros modelos baseados em outros dados experimentais evidenciaram, entre outras coisas, a natureza elétrica da matéria, a composição e organização do átomo e a quantização da energia no modelo atômico.\nOXTOBY, D. W.; GILLIS, H. P.; BUTLER, L. J. Principles of Modern Chemistry. Boston: Cengage Learning, 2012 (adaptado).\nCom base no modelo atual que descreve o átomo, qual dos postulados de Dalton ainda é considerado correto?\nA 1\nB 2\nC 3\nD 4\nE 5",
      subItens: []
    },
    options: ["1","2","3","4","5"],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Uma empresa presta serviço de abastecimento de água em uma cidade. O valor mensal a pagar por esse serviço é determinado pela aplicação de tarifas, por faixas de consumo de água, sendo obtido pela adição dos valores correspondentes a cada faixa.\n• Faixa 1: para consumo de até 6 m³, valor fixo de R$ 12,00;\n• Faixa 2: para consumo superior a 6 m³ e até 10 m³, tarifa de R$ 3,00 por metro cúbico ao que exceder a 6 m³;\n• Faixa 3: para consumo superior a 10 m³, tarifa de R$ 6,00 por metro cúbico ao que exceder a 10 m³.\nSabe-se que nessa cidade o consumo máximo de água por residência é de 15 m³ por mês.\nO gráfico que melhor descreve o valor P, em real, a ser pago por mês, em função do volume V de água consumido, em metro cúbico, é\nOpções: Cinco gráficos de P(R$) em função de V(m³), com faixas de valores e inclinações diferentes.",
      subItens: []
    },
    options: ["Gráfico com três segmentos: primeiro constante, segundo com inclinação menor, terceiro com inclinação maior.","Gráfico com três segmentos: primeiro constante, segundo com inclinação menor, terceiro com inclinação maior.","Gráfico com três segmentos: primeiro constante, segundo com inclinação menor, terceiro com inclinação maior.","Gráfico com três segmentos: primeiro constante, segundo com inclinação menor, terceiro com inclinação maior.","Gráfico com três segmentos: primeiro constante, segundo com inclinação menor, terceiro com inclinação maior."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A gripe é uma infecção respiratória aguda de curta duração causada pelo vírus influenza. Ao entrar no nosso organismo pelo nariz, esse vírus multiplica-se, disseminando-se para a garganta e demais partes das vias respiratórias, incluindo os pulmões.\nO vírus influenza é uma partícula esférica que tem um diâmetro interno de 0,00011 mm.\nDisponível em: www.gripenet.pt. Acesso em: 2 nov. 2013 (adaptado).\nEm notação científica, o diâmetro interno do vírus influenza, em mm, é\nA 1,1 x 10⁻¹\nB 1,1 x 10⁻²\nC 1,1 x 10⁻³\nD 1,1 x 10⁻⁴\nE 1,1 x 10⁻⁵",
      subItens: []
    },
    options: ["1,1 x 10⁻¹","1,1 x 10⁻²","1,1 x 10⁻³","1,1 x 10⁻⁴","1,1 x 10⁻⁵"],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Um ciclista quer montar um sistema de marchas usando dois discos dentados na parte traseira de sua bicicleta, chamados catracas. A coroa é o disco dentado que é movimentado pelos pedais da bicicleta, sendo que a corrente transmite esse movimento às catracas, que ficam posicionadas na roda traseira da bicicleta. As diferentes marchas ficam definidas pelos diferentes diâmetros das catracas, que são medidos conforme indicação na figura.\nImagem: Diâmetro do disco dentado indicado.\nO ciclista já dispõe de uma catraca com 7 cm de diâmetro e pretende incluir uma segunda catraca, de modo que, à medida em que a corrente passe por ela, a bicicleta avance 50% a mais do que avançaria se a corrente passasse pela primeira catraca, a cada volta completa dos pedais.\nO valor mais próximo da medida do diâmetro da segunda catraca, em centímetro e com uma casa decimal, é\nA 2,3.\nB 3,5.\nC 4,7.\nD 5,3.\nE 10,5.",
      subItens: []
    },
    options: ["2,3.","3,5.","4,7.","5,3.","10,5."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["398,02.","400,00.","401,94.","404,00.","406,02."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Charles Richter e Beno Gutenberg desenvolveram a escala Richter, que mede a magnitude de um terremoto. Essa escala pode variar de 0 a 10, com possibilidades de valores maiores. O quadro mostra a escala de magnitude local (Mₛ) de um terremoto que é utilizada para descrevê-lo.\nTabela: Descrição | Magnitude local (Mₛ) (µm.Hz)\nPequeno | 0 ≤ Mₛ ≤ 3,9\nLigeiro | 4,0 ≤ Mₛ ≤ 4,9\nModerado | 5,0 ≤ Mₛ ≤ 5,9\nGrande | 6,0 ≤ Mₛ ≤ 9,9\nExtremo | Mₛ ≥ 10,0\nPara se calcular a magnitude local, usa-se a fórmula Mₛ = 3,30 + log (A∙f), em que A representa a amplitude máxima da onda registrada por um sismógrafo em micrômetro (µm) e f representa a frequência da onda, em hertz (Hz). Ocorreu um terremoto com amplitude máxima de 2 000 µm e frequência de 0,2 Hz.\nDisponível em: http://cejarj.cecierj.edu.br. Acesso em: 1 fev. 2015 (adaptado).\nUtilize 0,3 como aproximação para log 2.\nDe acordo com os dados fornecidos, o terremoto ocorrido pode ser descrito como\nA Pequeno.\nB Ligeiro.\nC Moderado.\nD Grande.\nE Extremo.",
      subItens: []
    },
    options: ["Pequeno.","Ligeiro.","Moderado.","Grande.","Extremo."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Após o Fórum Nacional Contra a Pirataria (FNCP) incluir a linha de autopeças em campanha veiculada contra a falsificação, as agências fiscalizadoras divulgaram que os cinco principais produtos de autopeças falsificados são: rolamento, pastilha de freio, caixa de direção, catalisador e amortecedor.\nApós uma grande apreensão, as peças falsas foram cadastradas utilizando-se a codificação:\nDisponível em: www.oficinabrasil.com.br. Acesso em: 25 ago. 2014 (adaptado).\$1_{1}$: rolamento, 2: pastilha de freio, 3: caixa de direção, 4: catalisador e 5: amortecedor.\nAo final obteve-se a sequência: 5, 4, 3, 2, 1, 2, 3, 4, 5, 4, 3, 2, 1, 2, 3, 4, 5, 4, 3, 2, 1, 2, 3, 4, que apresenta um padrão de formação que consiste na repetição de um bloco de números. Essa sequência descreve a ordem em que os produtos apreendidos foram cadastrados.\nO 2015º item cadastrado foi um(a)\nA rolamento.\nB catalisador.\nC amortecedor.\nD pastilha de freio.\nE caixa de direção.",
      subItens: []
    },
    options: ["rolamento.","catalisador.","amortecedor.","pastilha de freio.","caixa de direção."],
    correctAnswer: 4,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Durante suas férias, oito amigos, dos quais dois são canhotos, decidem realizar um torneio de vôlei de praia. Eles precisam formar quatro duplas para a realização do torneio. Nenhuma dupla pode ser formada por dois jogadores canhotos.\nDe quantas maneiras diferentes podem ser formadas essas quatro duplas?\nA 69\nB 70\nC 90\nD 104\nE 105",
      subItens: []
    },
    options: ["69","70","90","104","105"],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Em uma fábrica de refrigerantes, é necessário que se faça periodicamente o controle no processo de engarrafamento para evitar que sejam envasadas garrafas fora da especificação do volume escrito no rótulo.\nDiariamente, durante 60 dias, foram anotadas as quantidades de garrafas fora dessas especificações. O resultado está apresentado no quadro.\nTabela: Quantidade de garrafas fora das especificações por dia | Quantidade de dias\$1_{0}$ | 52\$1_{1}$ | 5\$1_{2}$ | 2\$1_{3}$ | 1\nA média diária de garrafas fora das especificações no período considerado é\nA 0,1.\nB 0,2.\nC 1,5.\nD 2,0.\nE 3,0.",
      subItens: []
    },
    options: ["0,1.","0,2.","1,5.","2,0.","3,0."],
    correctAnswer: 2,
    materia: "Matemática – Estatística",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "O Sistema Métrico Decimal é o mais utilizado atualmente para medir comprimentos e distâncias. Em algumas atividades, porém, é possível observar a utilização de diferentes unidades de medida. Um exemplo disso pode ser observado no quadro.\nTabela: Unidade | Equivalência\nPolegada | 2,54 centímetros\nJarda | 3 pés\nJarda | 0,9144 metro\nAssim, um pé, em polegada, equivale a\nA 0,1200.\nB 0,3048.\nC 1,0800.\nD 12,0000.\nE 36,0000.",
      subItens: []
    },
    options: ["0,1200.","0,3048.","1,0800.","12,0000.","36,0000."],
    correctAnswer: 3,
    materia: "Matemática – Grandezas e Medidas",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "O Índice de Desenvolvimento Humano (IDH) é uma medida usada para classificar os países pelo seu grau de desenvolvimento. Para seu cálculo, são levados em consideração a expectativa de vida ao nascer, tempo de escolaridade e renda per capita, entre outros. O menor valor deste índice é zero e o maior é um. Cinco países foram avaliados e obtiveram os seguintes índices de desenvolvimento humano: o primeiro país recebeu um valor X, o segundo √X, o terceiro X², o quarto X³ e o último X⁵. Nenhum desses países zerou ou atingiu o índice máximo.\nQual desses países obteve o maior IDH?\nA O primeiro.\nB O segundo.\nC O terceiro.\nD O quarto.\nE O quinto.",
      subItens: []
    },
    options: ["O primeiro.","O segundo.","O terceiro.","O quarto.","O quinto."],
    correctAnswer: 2,
    materia: "Matemática – Funções",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Um mestre de obras deseja fazer uma laje com espessura de 5 cm utilizando concreto usinado, conforme as dimensões do projeto dadas na figura. O concreto para fazer a laje será fornecido por uma usina que utiliza caminhões com capacidades máximas de 2 m³, 5 m³ e 10 m³ de concreto.\nImagem: Planta baixa de uma laje com várias seções e dimensões indicadas.\nQual a menor quantidade de caminhões, utilizando suas capacidades máximas, que o mestre de obras deverá pedir à usina de concreto para fazer a laje?\nA Dez caminhões com capacidade máxima de 10 m³.\nB Cinco caminhões com capacidade máxima de 10 m³.\nC Um caminhão com capacidade máxima de 5 m³.\nD Dez caminhões com capacidade máxima de 2 m³.\nE Um caminhão com capacidade máxima de 2 m³.",
      subItens: []
    },
    options: ["Dez caminhões com capacidade máxima de 10 m³.","Cinco caminhões com capacidade máxima de 10 m³.","Um caminhão com capacidade máxima de 5 m³.","Dez caminhões com capacidade máxima de 2 m³.","Um caminhão com capacidade máxima de 2 m³."],
    correctAnswer: 2,
    materia: "Matemática – Geometria Espacial",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Uma empresa tem diversos funcionários. Um deles é o gerente, que recebe R$ 1 000,00 por semana. Os outros funcionários são diaristas. Cada um deles trabalha 2 dias por semana, recebendo R$ 80,00 por dia trabalhado.\nChamando de X a quantidade total de funcionários da empresa, a quantia Y, em reais, que esta empresa gasta semanalmente para pagar seus funcionários é expressa por\nA Y = 80X + 920.\nB Y = 80X + 1 000.\nC Y = 80X + 1 080.\nD Y = 160X + 840.\nE Y = 160X + 1 000.",
      subItens: []
    },
    options: ["Y = 80X + 920.","Y = 80X + 1 000.","Y = 80X + 1 080.","Y = 160X + 840.","Y = 160X + 1 000."],
    correctAnswer: 3,
    materia: "Matemática – Funções",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Um grupo de engenheiros está projetando um motor cujo esquema de deslocamento vertical do pistão dentro da câmara de combustão está representado na figura.\nImagens: Câmara de combustão com pistão em h(0)=0 (instante t=0) e h(t) em t≠0.\nA função h(t) = 4 + 4sen(πβt/2) definida para t ≥ 0 descreve como varia a altura h, medida em centímetro, da parte superior do pistão dentro da câmara de combustão, em função do tempo t, medido em segundo. Nas figuras estão indicadas as alturas do pistão em dois instantes distintos.\nO valor do parâmetro β, que é dado por um número inteiro positivo, está relacionado com a velocidade de deslocamento do pistão. Para que o motor tenha uma boa potência, é necessário e suficiente que, em menos de 4 segundos após o início do funcionamento (instante t = 0), a altura da base do pistão alcance por três vezes o valor de 6 cm. Para os cálculos, utilize 3 como aproximação para π.\nO menor valor inteiro a ser atribuído ao parâmetro β, de forma que o motor a ser construído tenha boa potência, é\nA 1.\nB 2.\nC 4.\nD 5.\nE 8.",
      subItens: []
    },
    options: ["1.","2.","4.","5.","8."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Um comerciante, que vende somente pastel, refrigerante em lata e caldo de cana em copos, fez um levantamento das vendas realizadas durante a semana. O resultado desse levantamento está apresentado no gráfico.\nGráfico de radar: Vendas na última semana por dia (Domingo, Segunda, Terça, Quarta, Quinta, Sexta, Sábado) e tipo de produto (Caldo de cana, Refrigerante, Pastel).\nValores para cada dia e produto (aproximados do gráfico):\nDomingo: Caldo=4, Refri=6, Pastel=8\nSegunda: Caldo=0, Refri=2, Pastel=4\nTerça: Caldo=2, Refri=2, Pastel=0\nQuarta: Caldo=2, Refri=0, Pastel=2\nQuinta: Caldo=0, Refri=4, Pastel=2\nSexta: Caldo=2, Refri=4, Pastel=4\nSábado: Caldo=8, Refri=8, Pastel=6\nEle estima que venderá, em cada dia da próxima semana, uma quantidade de refrigerante em lata igual à soma das quantidades de refrigerante em lata e caldo de cana em copos vendidas no respectivo dia da última semana. Quanto aos pastéis, estima vender, a cada dia da próxima semana, uma quantidade igual à quantidade de refrigerante em lata que prevê vender em tal dia. Já para o número de caldo de cana em copos, estima que as vendas diárias serão iguais às da última semana.\nSegundo essas estimativas, a quantidade a mais de pastéis que esse comerciante deve vender na próxima semana é\nA 20.\nB 27.\nC 44.\nD 55.\nE 71.",
      subItens: []
    },
    options: ["20.","27.","44.","55.","71."],
    correctAnswer: 1,
    materia: "Matemática – Análise Gráfica",
    conteudo: "Matemática – Operações Básicas",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Nos seis cômodos de uma casa há sensores de presença posicionados de forma que a luz de cada cômodo acende assim que uma pessoa nele adentra, e apaga assim que a pessoa se retira desse cômodo. Suponha que o acendimento e o desligamento sejam instantâneos.\nO morador dessa casa visitou alguns desses cômodos, ficando exatamente um minuto em cada um deles. O gráfico descreve o consumo acumulado de energia, em watt × minuto, em função do tempo t, em minuto, das lâmpadas de LED dessa casa, enquanto a figura apresenta a planta baixa da casa, na qual os cômodos estão numerados de 1 a 6, com as potências das respectivas lâmpadas indicadas.\nGráfico: Energia (W-min) acumulada em função do Tempo (min).\nPontos: (0;0), (1;20), (2;35), (3;40), (4;55), (5;75), (6;85), (7;105), (8;120).\nPlanta baixa da casa: Cômodos numerados de 1 a 6, com potências das lâmpadas.\$1_{1}$. Entrada (0W)\$1_{2}$. Quarto (13W)\$1_{3}$. Banho (2W)\$1_{4}$. Suíte (15W)\$1_{5}$. Banho (5W)\$1_{6}$. Cozinha (10W)\$1_{7}$. Sala (20W)\nA sequência de deslocamentos pelos cômodos, conforme o consumo de energia apresentado no gráfico, é\nA 1→4→5→4→1→6→1→4\nB 1→2→3→1→4→1→4→4\nC 1→4→5→4→1→6→1→2→3\nD 1→2→3→5→4→1→6→1→4\nE 1→4→2→3→5→1→6→1→4",
      subItens: []
    },
    options: ["1→4→5→4→1→6→1→4","1→2→3→1→4→1→4→4","1→4→5→4→1→6→1→2→3","1→2→3→5→4→1→6→1→4","1→4→2→3→5→1→6→1→4"],
    correctAnswer: 0,
    materia: "Matemática – Análise Gráfica",
