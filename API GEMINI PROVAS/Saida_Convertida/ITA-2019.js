createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Em férias no litoral, um estudante faz para um colega as seguintes observações: I. A luz solar consiste de uma onda eletromagnética transversal, não polarizada e policromática. II. A partir de um certo horário, toda a luz solar que incide sobre o mar sofre reflexão total. III. A brisa marítima é decorrente da diferença entre o calor específico da areia e o da água do mar. A respeito dessas observações, é correto afirmar que",
      subItens: []
    },
    options: ["todas são verdadeiras.","apenas I é falsa.","apenas II é falsa.","apenas III é falsa.","há mais de uma observação falsa."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Considere um corpo celeste esférico e homogêneo de massa M e raio R atravessado de polo a polo por um túnel cilíndrico retilíneo de diâmetro desprezível. Em um desses polos um objeto pontual é solto a partir do repouso no instante t = 0. Sendo G a constante universal de gravitação, esse objeto vai alcançar o outro polo após o intervalo de tempo dado por",
      subItens: []
    },
    options: ["(π / 2) * √(R³/GM)","π * √(R³/GM)","(1 / 2) * √(4R³/3GM)","2 * √(R³/GM)","2 * √(3R³/GM)"],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A imagem de um objeto formada por um espelho côncavo mede metade do tamanho do objeto. Se este é deslocado de uma distância de 15 cm em direção ao espelho, o tamanho da imagem terá o dobro do tamanho do objeto. Estime a distância focal do espelho e assinale a alternativa correspondente.",
      subItens: []
    },
    options: ["40 cm","30 cm","20 cm","10 cm","5,0 cm"],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Uma bateria composta por 50 células voltaicas em série é carregada por uma fonte de corrente contínua ideal de 220 V. Cada célula tem uma força eletromotriz de 2,30 V e resistência interna de 0,100 Ω. Sendo a corrente de carregamento de 6,00 A, indique o valor da resistência extra que deve ser inserida em série com a fonte.",
      subItens: []
    },
    options: ["23,0 Ω","36,6 Ω","12,5 Ω","5,00 Ω","19,2 Ω"],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Uma bola é deixada cair conforme mostra a figura. Inicialmente, ela gira com velocidade angular ω no sentido anti-horário para quem a observa do leste, sendo nula a velocidade do seu centro de massa. Durante a queda, o eixo de rotação da bola permanece sempre paralelo à direção oeste-leste. Considerando o efeito do ar sobre o movimento de queda da bola, são feitas as seguintes afirmações: I. A bola está sujeita apenas a forças verticais e, portanto, cairá verticalmente. II. A bola adquire quantidade de movimento para o norte (N) ou para o oeste (O). III. A bola adquire quantidade de movimento para o leste (L) ou para o sul (S). IV. Quanto maior for a velocidade angular ω da bola, mais ela se afastará do ponto C. Está(ão) correta(s) apenas\n(A imagem mostra uma esfera com um vetor de velocidade angular ω apontando para fora da página (para o leste) e uma rosa dos ventos indicando Norte (N), Sul (S), Leste (L) e Oeste (O).)",
      subItens: []
    },
    options: ["I.","II e IV.","III e IV.","III.","II."],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Em um reservatório são armazenados 1 mol de gás hélio e 1 mol de gás oxigênio em equilíbrio térmico. Por meio de um orifício de dimensões muito menores que o comprimento livre médio das espécies gasosas, inicia-se um vazamento de gás para o exterior. Sobre essa situação são feitas as seguintes afirmações: I. No interior do reservatório, os átomos de hélio têm, em média, energia cinética menor em comparação à das moléculas de oxigênio. II. No interior do reservatório, os átomos de hélio têm, em média, velocidade de translação maior em comparação à das moléculas de oxigênio. III. A porção do gás que vaza e a que permanece no interior do reservatório têm a mesma fração molar de hélio. Assinale a opção correta.",
      subItens: []
    },
    options: ["Apenas a afirmação I é falsa.","Apenas a afirmação II é falsa.","Apenas a afirmação III é falsa.","Há mais de uma afirmação falsa.","Todas as afirmações são verdadeiras."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Na figura mostra-se o valor do potencial elétrico para diferentes pontos P(50 V), Q(60 V), R(130 V) e S(120 V) situados no plano xy. Considere o campo elétrico uniforme nessa região e o comprimento dos segmentos OP, OQ, OR e OS igual a 5,0 m. Pode-se afirmar que a magnitude do campo elétrico é igual a\n(A imagem mostra um plano cartesiano xy com a origem O. Pontos P, Q, R, S estão marcados com seus respectivos potenciais elétricos: P(50 V), Q(60 V), R(130 V), S(120 V). Os segmentos OP, OQ, OR, OS têm todos o mesmo comprimento de 5,0 m.)",
      subItens: []
    },
    options: ["12,0 V/m.","8,0 V/m.","6,0 V/m.","10,0 V/m.","16,0 V/m."],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Seja uma partícula de massa m e carga positiva q, imersa em um campo magnético uniforme B, com velocidade inicial v no instante de tempo t = 0. Sabe-se que θ é o ângulo entre v e B, cujos respectivos módulos são v e B. Pode-se afirmar que a distância mínima percorrida pela partícula até que sua velocidade readquira a mesma direção e sentido iniciais é dada por",
      subItens: []
    },
    options: ["π * mv / qB * cos θ.","2π * mv / qB * cos θ.","2π * mv / qB * sen θ.","π * mv / qB","2π * mv / qB"],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["a comunidade de pichadores não necessariamente demonstra interesse no reconhecimento da pichação como um movimento artístico.","os pichadores assumem uma forma de expressão mais provocadora, ao transgredir até mesmo as regras das instituições culturais.","a pichação é uma forma de expressão marginalizada, assumida por alguns grupos como traço identitário.","os códigos e as mensagens manifestados na pichação costumam ser compreendidos somente pela própria comunidade de pichadores.","a essência da pichação é ser uma forma de expressão utilizada para delimitação de territórios por gangues e grupos rivais."],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Assinale a alternativa cujo trecho sublinhado denota uma condição.",
      subItens: []
    },
    options: ["[...] trazem à tona um questionamento conceitual importante: uma vez considerado arte contemporânea, o movimento perderia sua essência?","[...] ele ganhou em força, criatividade e técnica, sendo reconhecido hoje no Brasil como graffiti artístico.","Muito além da diferenciação conceitual entre as expressões – ainda que elas compartilhem da mesma matéria-prima [...]","Ela é evidenciada pela impossibilidade de inserção em qualquer estatuto pré-estabelecido, pois isso pressuporia a diluição e a perda de sua potência signo-estética.","“Se alguém faz alguma coisa no seu trabalho, isso é positivo, para mim, porque escolheram a minha peça entre as expostas” [...]"],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Assinale a alternativa em que o trecho sublinhado expressa ideia de causa.",
      subItens: []
    },
    options: ["Essa distinção das expressões deu-se em boa parte pela institucionalização do graffiti, com os primeiros resquícios já na década de 1970.","Enquanto o graffiti foi sendo introduzido como uma nova expressão de arte contemporânea, a pichação utilizou o princípio de não autorização para fortalecer sua essência.","A rejeição do público geral reside na falta de compreensão e intelecção das inscrições; apenas os membros da própria comunidade decifram o conteúdo.","Mesmo sem adotar o comportamento esperado, caíram em contradição.","O grafiteiro é visto hoje como artista plástico, possuindo as características de todo e qualquer artista contemporâneo, incluindo a prática e o status."],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "As questões de 17 a 19 referem-se ao texto a seguir:",
      subItens: [{"titulo":"Texto 2","conteudo":"Em frente da minha casa existe um muro enorme, todo branco. No Facebook, uma postagem me chama atenção: é um muro virtual e a brincadeira é pichá-lo com qualquer frase que vier à cabeça. Não quero pichar o mundo virtual, quero um muro de verdade, igual a este de frente para a minha casa. Pelas ruas e avenidas, vou trombando nos muros espalhados pelos quarteirões, repletos de frases tolas, xingamentos e erros de português. Eu bem poderia modificar isso.\nQuestão 17. Por ser uma crônica, o"},{"titulo":"texto 2","conteudo":"apresenta formas coloquiais, que por vezes distanciam o texto da norma padrão da língua portuguesa. Assinale a alternativa em que ocorre desvio da norma culta."}]
    },
    options: ["Fui tentar entender e não me faltaram explicações: é grafite, é tribal, coisas de difícil compreensão.","O pequeno vândalo escondido dentro de mim busca frases na memória e, então, sinto até o cheiro da lama de Woodstock [...]","Depois arriscaria uma frase que criei e gosto [...]","Desde os primórdios dos tempos, usamos a escrita como forma de expressão [...]","Poderia passar o dia todo pichando frases, as linhas vão se acabando e ainda tenho tanto a pichar..."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Assinale a alternativa em que o item sublinhado NÃO é pronome relativo.",
      subItens: []
    },
    options: ["a brincadeira é pichá-lo com qualquer frase que vier à cabeça","ou no papel amassado que embrulha o pão da manhã","são tantas, até temo que me faltem os muros","há um certo prazer na loucura que só um louco conhece","que serve para exemplificar o que sinto neste momento"],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A partir da leitura dos textos 1 e 2, depreende-se que I. os autores reiteram que grafite e pichação não são práticas artísticas bem aceitas por toda a sociedade. II. o",
      subItens: [{"titulo":"texto 1","conteudo":"menciona a ausência de poesia na pichação; o"},{"titulo":"texto 2","conteudo":"explora a possibilidade de essa prática disseminar cultura. III. o"},{"titulo":"texto 1","conteudo":"contrasta grafite e pichação; já o"},{"titulo":"texto 2","conteudo":"expressa motivações subjetivas do autor para pichar. Está/ão correta/s:"}]
    },
    options: ["apenas I e II.","apenas I e III.","apenas II.","apenas II e III.","todas."],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Senhora, de José de Alencar, é uma obra representativa do Romantismo porque apresenta",
      subItens: []
    },
    options: ["um par romântico que, para se casar, enfrenta a rivalidade de suas famílias.","personagens masculinas cuja retidão de caráter é sempre inabalável.","importantes cenários naturais, circunscritos ao ambiente urbano.","o protagonista moldado irreversivelmente pela educação e pelo meio social.","uma protagonista virtuosa e movida sobretudo pelo sentimento amoroso."],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "No Realismo, o adultério subverte o ideal romântico de casamento. Machado de Assis, porém, costuma tratá-lo de modo ambíguo, valendo-se, por exemplo, do ciúme masculino ou da dubiedade feminina. Com isso, em seus romances, a traição nem sempre é comprovada, ou, mesmo que desejada pela mulher, não se consuma. Constatamos tal ambiguidade em Quincas Borba, quando",
      subItens: []
    },
    options: ["Palha se enraivece com os olhares de desejo que os homens dirigem a Sofia nos eventos sociais.","Sofia decide não contar ao marido que Rubião a assediou certa noite, no jardim da casa deles.","Palha, mesmo interessado na riqueza de Rubião, decide confrontá-lo ao perceber o assédio dele a Sofia.","Sofia tenta esconder do marido o interesse que tem por Carlos Maria, que a seduziu em um baile.","Sofia, mesmo interessada em Carlos Maria, faz de tudo para que Maria Benedita se case com ele."],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "São Bernardo, de Graciliano Ramos, é obra representativa da Geração de 30. Em relação ao protagonista, podemos dizer que",
      subItens: []
    },
    options: ["mesmo sendo um proprietário de terras de perfil feudal, não se envolve sexualmente com as serviçais da fazenda.","por ter cometido assassinatos para tornar-se o dono de sua propriedade, é um homem sem nenhum traço de humanidade.","ele próprio reconhece que as muitas agruras pelas quais passou até enriquecer acabaram por lhe dar uma alma agreste.","após se tornar senhor da fazenda, esquece-se do passado e abandona, até mesmo, a sua pobre mãe de criação.","mesmo com a morte trágica de sua esposa, não chega a questionar o sentido dos atos que praticou ao longo da vida."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "As questões de 25 a 29 referem-se ao texto a seguir:\n(Texto sobre obesidade, consumo de alimentos e responsabilidade social)\nQuestão 25. De acordo com o texto, em comparação com 1976, atualmente nós compramos",
      subItens: []
    },
    options: ["50% a mais de leite fresco.","3% a mais de cereais matinais.","39 vezes menos sobremesas lácteas.","uma quantidade três vezes maior de sorvete.","uma quantidade três vezes menor de batatas fritas."],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["atualmente consumimos 2.130 quilocalorias por dia, ao passo que em 1976 o consumo diário era de 2.280 quilocalorias, incluindo doces e álcool.","os dados indicam que, em comparação com 1976, nosso consumo de açúcar de forma indireta sofreu um declínio acentuado.","somente existem dados referentes ao consumo indireto de açúcar incluindo bebidas e produtos de confeitaria até o ano de 1992.","a indústria alimentícia tem recorrido à contratação de cientistas para orientar a população em relação às verdadeiras causas da obesidade.","a discussão desencadeada pela foto de 1976 sinaliza que a estratégia de culpar o obeso por sua própria condição tem se revelado eficaz."],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["o posicionamento dos legisladores em relação à obesidade é embasado em dados das pesquisas mais recentes em neurociências.","apenas menos de 10% dos legisladores não acreditam que a motivação pessoal exerça forte influência no aumento da obesidade.","os legisladores são capazes de apontar todos os mecanismos que são considerados responsáveis pela perda de força de vontade.","o sobrepeso e a obesidade, que atualmente afetam 61% da população inglesa, são atribuídos, pelos legisladores, a fatores como estresse e ansiedade.","as explicações fornecidas pelos legisladores acerca das causas do aumento da obesidade são plausíveis e encontram respaldo em evidências."],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "De acordo com o texto, é correto afirmar que o autor sustenta que",
      subItens: []
    },
    options: ["cada pessoa deve assumir a responsabilidade por seu peso, uma vez que ninguém é obrigado a consumir alimentos prejudiciais à saúde.","as pessoas são preguiçosas e não se preocupam com a saúde, pois sentem que têm direito assegurado a assistência médica gratuita.","nos países ricos há menos pessoas obesas do que em países mais pobres, pois a ciência evidencia que a causa da obesidade reside no baixo poder de compra.","a força de vontade, bem como a responsabilidade pessoal, devem ser exercidas; porém, pelos governantes e legisladores, respectivamente.","o governo deve controlar as fraquezas descobertas nos obesos, da mesma forma que controla problemas como o desemprego."],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Assinale a alternativa que pode substituir 'as' na sentença \"As Jacques Peretti argued in his film The Men Who Made Us Fat, food companies have invested heavily in designing products [...]\" (linhas 19-20) mantendo o mesmo sentido do texto e a correção gramatical.",
      subItens: []
    },
    options: ["In line with what","In contempt of","During the time","Considering that","Despite the fact that"],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "No último quadrinho, o chefe do jornalista",
      subItens: []
    },
    options: ["solicita que ele lhe mostre as imagens da matéria que está escrevendo.","fica entusiasmado porque ele concorda que as imagens são sensacionalistas.","demonstra interesse e pede que ele lhe mostre os dados do teste mencionado.","muda de ideia e demanda que ele exiba as ilustrações dos jornais concorrentes.","rende-se à lógica das redes sociais, após checar a repercussão das fotos publicadas."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "No contexto da tirinha, todas as palavras pertencem à mesma classe gramatical, EXCETO:",
      subItens: []
    },
    options: ["lies","testing","shows","clicks","likes"],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "As questões de 33 a 36 referem-se ao texto a seguir:\n(Texto sobre Inteligência Artificial e regulação)\nQuestão 33. Assinale a alternativa INCORRETA. No texto, o autor afirma que",
      subItens: []
    },
    options: ["os legisladores precisam compreender a inteligência artificial para que possam criar regulamentações que nos mantenham seguros, porém sem refrear a inovação.","embora haja a necessidade de uma agência reguladora, ele preferiria que ela funcionasse como uma parceria público-privada, contando com consultores da indústria tecnológica.","estamos no início de uma nova era, na qual a governança é definida por software, o que leva à necessidade de um novo tipo de agência, que inclua tanto software quanto seres humanos.","as empresas públicas, em especial, são incentivadas a se automonitorar e se autorregular a fim de que seus algoritmos maximizem ora metas financeiras, ora metas sociais.","por ser um investidor em tecnologia, ele não deseja que um Congresso mal informado crie regulamentações que tornem as empresas de tecnologia burocráticas demais."],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "O autor defende uma regulação definida por software, pois I. a considera mais adequada para monitorar indústrias orientadas por software do que regulações impostas por equipes de reguladores humanos. II. algoritmos podem procurar por detalhes e padrões que os seres humanos talvez nunca pudessem descobrir, mas que, não obstante, são indicativos de abusos. III. precisamos de tecnologia que seja capaz de identificar comportamentos como o do Facebook que, ao explorar vieses políticos, difundiu manchetes de partidos conservadores. IV. é importante que algoritmos monitorem o papel dos seres humanos em empresas orientadas por software para evitar que minorias sejam prejudicadas na utilização de serviços. Estão corretas apenas",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A palavra ou expressão sublinhada na primeira coluna pode ser substituída pela palavra ou expressão na segunda coluna em todas as opções, mantendo o mesmo sentido, EXCETO em:",
      subItens: []
    },
    options: ["The watchdog algorithms can be like open-source software [...] → guardian","[...] and analyze for “off the rails” behaviors [...] → illegal","[...] before bad regulations get enacted [...] → are sanctioned","We have a chance right now to tee up AI [...] → organize","To unleash it in a positive direction [...] → restrain"],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Observe o uso da palavra 'so' nas frases abaixo. I. [...] and help guide AI so it benefits society [...] (linha 8) II. Regulators helped make it so difficult to develop [...] (linha 9 e 10) III. So, while we need a Federal Artificial Intelligence Agency, or FAIA [...] (linha 10 e 11) Assinale a alternativa que explica respectivamente, o uso de 'so'.",
      subItens: []
    },
    options: ["Para expressar propósito, como intensificador, para sintetizar ideias anteriores.","Para expressar resultado, para indicar tamanho ou extensão, para substituir uma oração.","Para introduzir uma decisão, como advérbio de modo, com sentido de ‘até o momento’.","Para indicar confirmação, para expressar efeito, como conjunção adversativa.","Para indicar inclusão, como preposição, para indicar a relevância do que será expresso."],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Considere um retângulo ABCD em que o comprimento do lado AB é o dobro do comprimento do lado BC. Sejam M o ponto médio de BC e N o ponto médio de CM. A tangente do ângulo MÂN é igual a",
      subItens: []
    },
    options: ["1/35","2/35","4/35","8/35","16/35"],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Seja p(x) = x³ + ax² + bx um polinômio cujas raízes são não negativas e estão em progressão aritmética. Sabendo que a soma de seus coeficientes é igual a 10, podemos afirmar que a soma das raízes de p(x) é igual a",
      subItens: []
    },
    options: ["9.","8.","3.","9/2","10."],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Seja γ a circunferência de equação x² + y² = 4. Se r e s são duas retas que se interceptam no ponto P = (1, 3) e são tangentes a γ, então o cosseno do ângulo entre r e s é igual a",
      subItens: []
    },
    options: ["1/√7","√7/7","1/√2","√2/2","2√6/5"],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A superfície lateral de um cone circular reto corresponde a um setor circular de 216°, quando planificada. Se a geratriz do cone mede 10 cm, então a medida de sua altura, em cm, é igual a",
      subItens: []
    },
    options: ["5.","6.","7.","8.","9."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Assinale a opção que identifica o lugar geométrico de todos os pares ordenados (a, b) ∈ ℝ² que tornam impossível o sistema linear S: {-x + 5y = 10; (a²/5 + 5b²)x + 10aby = 1",
      subItens: []
    },
    options: ["Uma elipse","Uma reta","Uma parábola","Uma hipérbole","Um único ponto"],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Sabe-se que -2 + 2i é uma das raízes quartas de um número complexo z. Então, no plano de Argand-Gauss, a área do triângulo, cujos vértices são as raízes cúbicas de z, é igual a",
      subItens: []
    },
    options: ["4(√3+1).","6√3.","8(√3-1).","10√3.","12√3."],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Considere as seguintes afirmações a respeito de matrizes A de ordem n × n inversíveis, tais que os seus elementos e os de sua inversa sejam todos números inteiros: I. |det(A)| = 1. II. AT = A⁻¹. III. A + A⁻¹ é uma matriz diagonal. É(são) sempre VERDADEIRA(S)",
      subItens: []
    },
    options: ["apenas I.","apenas III.","apenas I e II.","apenas I e III.","todas."],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Sejam feitas estas afirmações a respeito do ponto de ebulição de substâncias à pressão atmosférica: I. O ponto de ebulição do 2-propanol é maior que o da propanona. II. O ponto de ebulição do cis-but-2-eno é maior que o do trans-but-2-eno. III. O ponto de ebulição do fluorometano é maior que o da metilamina. IV. O ponto de ebulição do 2-metilbutano é maior que o do 2,2-dimetilpropano. Das afirmações acima, está(ão) CORRETA(S)",
      subItens: []
    },
    options: ["apenas I, II e IV.","apenas I e III.","apenas II e IV.","apenas III.","todas."],
    correctAnswer: 0,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Após atravessar um filtro de radiação ultravioleta, o qual não permite passar fótons de comprimento de onda menor que 300 nm, um feixe de luz solar é direcionado para uma amostra de hidrogênio atômico gasoso à baixa pressão, mantido em um recipiente transparente à luz visível e opaco ao infravermelho (com comprimento de onda superior a 663 nm). Após passarem pela amostra, a quantidade de fótons e suas energias são detectadas por sensores posicionados ortogonalmente ao feixe de luz. Assinale a opção que melhor apresenta as energias, em eV, dos fótons que podem ser detectados.",
      subItens: []
    },
    options: ["0,7; 1,9; 3,3; 10,2","0,9; 1,4; 1,9; 3,3","1,0; 1,5; 3,4; 13,6","1,9; 2,6; 2,9; 3,0","2,1; 2,4; 3,4; 3,8"],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Considere uma pequena chapa de aço revestido com zinco (aço galvanizado) mergulhada em uma solução azul de sulfato de cobre nas condições padrão e a 25 °C. Após determinado intervalo de tempo, observa-se que a solução fica verde. Com base nessas observações e desconsiderando a presença de espécies interferentes, é ERRADO afirmar que",
      subItens: []
    },
    options: ["o aço foi corroído.","o íon cobre atuou como agente oxidante preferencialmente ao oxigênio atmosférico.","o zinco foi parcialmente oxidado.","o zinco foi oxidado preferencialmente ao ferro.","a função do zinco no aço galvanizado é oferecer proteção catódica."],
    correctAnswer: 2,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Um dado indicador ácido-base tem constante de dissociação ácida igual a 3,0 x 10⁻⁵. A forma ácida desse indicador tem cor vermelha e sua forma básica tem cor azul. Com base nessas informações, assinale a opção que apresenta o valor aproximado da variação de pH para que ocorra a mudança de cor do indicador de 75% da coloração vermelha para 75% da azul.",
      subItens: []
    },
    options: ["0,33","1,0","1,5","2,0","3,0"],
    correctAnswer: 1,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["Co*, Co*, Co","Co*, Co, Ni","Co*, Ni*, Ni","Ni*, Co*, Co","Ni*, Ni*, Ni"],
    correctAnswer: 4,
    materia: "",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Uma amostra de gás contém 80% de metano, 10% de etano, 5% de propano e 5% de nitrogênio, em volume. Considerando que todos os átomos de carbono na amostra de gás são convertidos em butadieno com 100% de rendimento, assinale a opção que apresenta a massa de butadieno obtido a partir de 100 g do gás.",
      subItens: []
    },
    options: ["50 g","60 g","70 g","80 g","90 g"],
    correctAnswer: 3,
    materia: "",
    conteudo: "",
    imageNames: []
