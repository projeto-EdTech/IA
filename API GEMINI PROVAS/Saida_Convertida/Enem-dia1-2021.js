...
createQuestion({
    ...
    options: ["a ascensão social era improvável.","a mudança de nome era impensável.","a origem do indivíduo era irrelevante.","o trabalho feminino era inimaginável.","o comportamento parental era irresponsável."],
    correctAnswer: 0,
    materia: "Inglês – Leitura e Interpretação de Texto",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "My desire to be well-informed is currently at odds with my desire to remain sane.\nSIPRESS. Disponível em: www.newyorker.com. Acesso em: 12 jun. 2018.\n\nA presença de \"at odds with\" na fala da personagem do cartum revela o(a)",
      subItens: []
    },
    options: ["necessidade de acessar informações confiáveis.","dificuldade de conciliar diferentes anseios.","desejo de dominar novas tecnologias.","desafio de permanecer imparcial.","vontade de ler notícias positivas."],
    correctAnswer: 1,
    materia: "Inglês – Leitura e Interpretação de Texto",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["contrapõe características da escrita e da fala.","ironiza a comunicação fora da norma-padrão.","substitui regionalismos por registros formais.","valoriza o uso de variedades populares.","defende novas regras gramaticais."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["remetem à violência física e simbólica contra os povos escravizados.","valorizam as influências da cultura africana sobre a música nacional.","relativizam o sincretismo constitutivo das práticas religiosas brasileiras.","narram os infortúnios da relação amorosa entre membros de classes sociais diferentes.","problematizam as diferentes visões de mundo na sociedade durante o período colonial."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Intertextualidade",
    conteudo: "Língua Portuguesa – Patrimônio Linguístico e Cultural",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "ESSE PET É DESCARTÁVEL. ESSE NÃO. ABANDONO É CRIME. LEI FEDERAL Nº 9 $\\\\frac{605}{98}$\nDisponível em: www.deskgram.org. Acesso em: 12 dez. 2018 (adaptado).\n\nA associação entre o texto verbal e as imagens da garrafa e do cão configura recurso expressivo que busca",
      subItens: []
    },
    options: ["estimular denúncias de maus-tratos contra animais.","desvincular o conceito de descarte da ideia de negligência.","incentivar campanhas de adoção de animais em situação de rua.","sensibilizar o público em relação ao abandono de animais domésticos.","alertar a população sobre as sanções legais acerca de uma prática criminosa."],
    correctAnswer: 3,
    materia: "Língua Portuguesa – Linguagem Verbal e Não Verbal",
    conteudo: "Língua Portuguesa – Campanhas Educativas",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "RENUNCIAREI À VIDA FOLGAZÃ, RENUNCIAREI À BUSCA DA BELEZA FÍSICA!\nQUANDO NENEM NASCER, RENUNCIAREI AOS PRAZERES MUNDANOS!\nRENUNCIAREI À VIDA SOCIAL! RENUNCIAREI AOS PROJETOS INDIVIDUALISTAS!\nASSIM TERMINA MAIS UM CAPÍTULO NA LUTA DA MULHER POR SUA EMANCIPAÇÃO...\nHENFIL. Disponível em: https://medium.com. Acesso em: 29 out. 2018 (adaptado).\n\nNessa tirinha, produzida na década de 1970, os recursos verbais e não verbais sinalizam a finalidade de",
      subItens: []
    },
    options: ["reforçar a luta por direitos civis.","explicitar a autonomia feminina.","ironizar as condições de igualdade.","estimular a abdicação da vida social.","criticar as obrigações da maternidade."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Gêneros Textuais",
...
createQuestion({
    ...
    options: ["pouca complexidade musical das composições ajustadas ao gosto do grande público.","prevalência de referências musicais africanas no imaginário da população brasileira.","incipiente atribuição de prestígio social a músicas instrumentais feitas para a dança.","tensa relação entre o erudito e o popular na constituição da música brasileira.","importância atribuída à música clássica na sociedade brasileira do século XIX."],
    correctAnswer: 3,
    materia: "Arte – História da Música Brasileira",
    conteudo: "Língua Portuguesa – Literatura Brasileira",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "MEIRELLES, V. Moema. Óleo sobre tela, 129 cm x 190 cm. Masp, São Paulo, 1866.\nDisponível em: www.masp.art.br. Acesso em: 13 ago. 2012 (adaptado).\n\nNessa obra, que retrata uma cena de Caramuru, célebre poema épico brasileiro, a filiação à estética romântica manifesta-se na",
      subItens: []
    },
    options: ["exaltação do retrato fiel da beleza feminina.","tematização da fragilidade humana diante da morte.","ressignificação de obras do cânone literário nacional.","representação dramática e idealizada do corpo da índia.","oposição entre a condição humana e a natureza primitiva."],
    correctAnswer: 3,
    materia: "Arte – História da Arte",
    conteudo: "Arte – Romantismo",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "Que tal transformar a internet em palco para a dança?\nR\nO coreógrafo e bailarino Didier Mulleras se destaca como um dos criadores que descobriram a dança de outro ponto de vista. Mini@tures é uma experiência emblemática entre movimento, computador, internet e vídeo. Com os recursos da computação gráfica, a dança das miniaturas pode caber na palma da mão. Pelo fato de usar a internet como palco, o processo de criação das miniaturas de dança levou em consideração os limites de tempo de download e o tamanho de arquivo, para que um número maior de \"espectadores” pudesse assistir. A graça das miniaturas está justamente na contaminação entre mídias: $\\\\frac{corpo}{dan}$ç$\\\\frac{a}{computa}$ção grá$\\\\frac{fica}{internet}$. De fato, é a rede que faz a maior diferença nesse grupo. Mini@tures explora uma nova dimensão que descobre o espaço-tempo da web e conquista um novo território para a dança contemporânea. A qualquer hora, dança on-line.\nSPANGHERO, M. A dança dos encéfalos acesos.\nSão Paulo: Itaú Cultural, 2003 (adaptado).\n\nConsiderado o primeiro projeto de dança contemporânea concebido para a rede, esse trabalho é apresentado como inovador por",
      subItens: []
    },
    options: ["adotar uma perspectiva conceitual como contraposição à tradição de grandes espetáculos.","criar novas formas de financiamento ao utilizar a internet para divulgação das apresentações.","privilegiar movimentos gerados por computação gráfica, com a substituição do palco pela tela.","produzir uma arte multimodal, com o intuito de ampliar as possibilidades de expressão estética.","redefinir a extensão e o propósito do espetáculo para adaptá-lo ao perfil de diferentes usuários."],
    correctAnswer: 3,
    materia: "Arte – Dança Contemporânea",
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "A PESQUISA FOI O PRIMEIRO PASSO NA PRODUÇÃO DESTE LIVRO\nDEIXA DE DRAMA, A MAIOR PARTE DO MATERIAL ESTÁ ON-LINE\nSEGUIDA DA SELEÇÃO DAS INFORMAÇÕES E DA ELABORAÇÃO DE UM ROTEIRO\nO DESENHO FEITO À TINTA NÃO OLHA AINDA!\nE DEPOIS EDITADO E COLORIZADO DIGITALMENTE.\nDEPOIS DE TODO TRABALHO, ESTE LIVRO SÓ PRECISA DE MAIS UMA COISA: SER LIDO.\nLEMOS, A. Artistas brasileiras. Belo Horizonte: Miguilim, 2018.\n\nO que assegura o reconhecimento desse texto em quadrinhos como prefácio é o(a)",
      subItens: []
    },
    options: ["função de apresentação do livro.","apelo emocional apoiado nas imagens.","descrição do processo criativo da autora.","referência à mescla dos trabalhos manual e digital.","uso de elementos gráficos voltados para o público-alvo."],
    correctAnswer: 0,
    materia: "Arte – Quadrinhos",
    conteudo: "Língua Portuguesa – Gêneros Textuais",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "OS RISCOS PARA CRIANÇAS DO USO DO CELULAR ANTES DE DORMIR\nESTUDO DO KING’S COLLEGE CONCLUIU QUE ESSAS CRIANÇAS E ADOLESCENTES TEM MAIOR RISCO DE OBESIDADE, BAIXO SISTEMA IMUNOLÓGICO, CRESCIMENTO ATROFIADO E DEPRESSÃO.\nFALTA DE SONO NO LONGO PRAZO REDUZ HORMÔNIOS\nMELATONINA QUE PREPARA O CORPO PARA O SONO\nLEPTINA, DA SACIEDADE\nCH. CORTISOL\nDA ESTABILIDADE EMOCIONAL DO CRESCIMENTO E DO CONTROLE DE INFLAMAÇÕES\nNÃO SÓ A LUZ, MAS ESTÍMULOS DEIXAM O CÉREBRO EM ALERTA\nA FORTE LUZ PENETRA NO OLHO E CONFUNDE O RELÓGIO BIOLÓGICO\nA CRIANÇA DEMORA A DORMIR, ACORDA MAIS VEZES E DESCANSA MENOS\nISSO PODE LEVAR A PROBLEMAS DE COMPORTAMENTO E DE ATENÇÃO ÀS AULAS\nPREJUDICA TAMBÉM O PROCESSAMENTO DA MEMÓRIA\nO QUE FAZER?\nFICAR ENTRE 30 MINUTOS E 2 HORAS SEM TELAS ANTES DE IR PARA A CAMA\nREDUZIR A INTENSIDADE DA LUZ EMITIDA\nMANTER O TELEFONE LONGE, PORÉM NO QUARTO, NÃO RESOLVE. A EXPECTATIVA DE RECEBER MENSAGENS É SUFICIENTE PARA ATRAPALHAR O SONO\nDisponível em: https://g_{1}.globo.com. Acesso em: 18 jun. 2019 (adaptado).\n\nNo texto, os recursos verbais e não verbais empregados têm por objetivo",
      subItens: []
    },
    options: ["divulgar informações científicas sobre o uso indiscriminado de aparelhos celulares.","influenciar o leitor a mudar atitudes e hábitos considerados prejudiciais às crianças.","relacionar o uso da tecnologia aos efeitos decorrentes da falta de exercícios físicos.","indicar medidas eficazes para desestimular a utilização de telefones pelo público infantil.","sugerir aos pais e responsáveis a substituição de dispositivos móveis por atividades lúdicas."],
    correctAnswer: 1,
    materia: "Biologia – Saúde Humana",
    conteudo: "Biologia – Impacto da Tecnologia",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["empobrecimento do valor artístico pela combinação de diferentes matérias-primas.","reposicionamento estético de objetos por meio da mudança de função.","convite aos espectadores para interagir e completar obras inacabadas.","militância com temas da ecologia que marcam o continente africano.","realidade precária de suas condições de produção artística."],
    correctAnswer: 1,
    materia: "Arte – Arte Contemporânea",
    conteudo: "Arte – Impacto Social da Arte",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "Se for possível, manda-me dizer:\n— É lua cheia. A casa está vazia —\nManda-me dizer, e o paraíso\nHá de ficar mais perto, e mais recente\nMe há de parecer teu rosto incerto.\nManda-me buscar se tens o dia\nTão longo como a noite. Se é verdade\nQue sem mim só vês monotonia.\nE se te lembras do brilho das marés\nDe alguns peixes rosados\nNumas águas\nE dos meus pés molhados, manda-me dizer:\n— É lua nova —\nE revestida de luz te volto a ver.\nHILST, H. Júbilo, memória, noviciado da paixão. São Paulo: Cia. das Letras, 2018.\n\nFalando ao outro, o eu lírico revela-se vocalizando um desejo que remete ao",
      subItens: []
    },
    options: ["aceticismo quanto à possibilidade do reencontro.","tédio provocado pela distância física do ser amado.","sonho de autorrealização desenhado pela memória.","julgamento implícito das atitudes de quem se afasta.","questionamento sobre o significado do amor ausente."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Gêneros Líricos",
    conteudo: "Língua Portuguesa – Leitura e Interpretação de Texto",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "O pavão vermelho\nOra, a alegria, este pavão vermelho,\nestá morando em meu quintal agora.\nVem pousar como um sol em meu joelho\nquando é estridente em meu quintal a aurora.\nClarim de lacre, este pavão vermelho\nsobrepuja os pavões que estão lá fora.\nÉ uma festa de púrpura. E o assemelho\na uma chama do lábaro da aurora.\nÉ o próprio doge a se mirar no espelho.\nE a cor vermelha chega a ser sonora\nneste pavão pomposo e de chavelho.\nPavões lilases possuí outrora.\nDepois que amei este pavão vermelho,\nos meus outros pavões foram-se embora.\nCOSTA, S. Poesia completa: Sosígenes Costa. Salvador: Conselho Estadual de Cultura, 2001.\n\nNa construção do soneto, as cores representam um recurso poético que configura uma imagem com a qual o eu lírico",
      subItens: []
    },
    options: ["revela a intenção de isolar-se em seu espaço.","simboliza a beleza e o esplendor da natureza.","experimenta a fusão de percepções sensoriais.","metaforiza a conquista de sua plena realização.","expressa uma visão de mundo mística e espiritualizada."],
    correctAnswer: 3,
    materia: "Língua Portuguesa – Gêneros Líricos",
    conteudo: "Língua Portuguesa – Recursos Poéticos",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "O TATA CONTOU SOBRE O CALUNGA, O MAR QUE NÃO ACABA.\nNANA, SE A GENTE BEBER A NSANGA É ENFRENTAR O CALUNGA, PODEMOS FICAR JUNTOS LÁ NA OUTRA TERRA.\nLONGE DAQUI... ....LONGE DISSO TUDO.\nD'SALETE, M. Cumbe. São Paulo: Veneta, 2018, p. 10-11 (adaptado).\n\nA sequência dos quadrinhos conjuga lirismo e violência ao",
      subItens: []
    },
    options: ["sugerir a impossibilidade de manutenção dos afetos.","revelar os corpos marcados pela brutalidade colonial.","representar o abatimento diante da desumanidade vivida.","acentuar a resistência identitária dos povos escravizados.","expor os sujeitos alijados de sua ancestralidade pelo exílio."],
    correctAnswer: 3,
    materia: "Língua Portuguesa – Gêneros Textuais",
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "Quando a taxa de remuneração do capital excede substancialmente a taxa de crescimento da economia, pela lógica, a riqueza herdada aumenta mais rápido do que a renda e a produção. Então, basta aos herdeiros poupar uma parte limitada da renda de seu capital para que ele cresça mais rápido do que a economia como um todo. Sob essas condições, é quase inevitável que a riqueza herdada supere a riqueza constituída durante uma vida de trabalho, e que a concentração do capital atinja níveis muito altos.\nPIKETTY, T. O capital no século XXI. Rio de Janeiro: Intrínseca, 2014 (adaptado).\n\nConsiderando os princípios que legitimam as democracias liberais, a lógica econômica descrita no texto enfraquece o(a)",
      subItens: []
    },
    options: ["ideologia do mérito.","direito de nascimento.","eficácia da legislação.","ganho das financeiras.","eficiência dos mercados."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["ampliação do comércio de imagens sacras.","substituição de materiais de valor artístico.","políticas de conservação de bens culturais.","defesa da privatização de sítios arqueológicos.","medidas de salvaguarda de peças museológicas."],
    correctAnswer: 2,
...
createQuestion({
    ...
    options: ["Exercício pleno da cidadania.","Divisão internacional do trabalho.","Gestão empresarial do toyotismo.","Concepção sustentável da economia.","Protecionismo alfandegário dos Estados."],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: ["Alianças afetivas conectadas ao ritual matrimonial.","Práticas místicas associadas ao patrimônio cultural.","Manifestações teatrais atreladas ao imaginário político.","Narrativas fílmicas relacionadas às intempéries climáticas.","Argumentações literárias interligadas às catástrofes ambientais."],
    correctAnswer: 1,
    materia: "Geografia – Cultura e Tradições",
...
createQuestion({
    ...
    options: ["ascensão social e burocracia estatal.","miscigenação étnica e limites fronteiriços.","desqualificação profissional e ação policial.","instabilidade financeira e crises econômicas.","desenraizamento cultural e insegurança legal."],
    correctAnswer: 4,
    materia: "Sociologia – Migrações",
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "Vocês que fazem parte dessa massa\nQue passa nos projetos do futuro\nÉ duro tanto ter que caminhar\nE dar muito mais do que receber\nÊ, ô, ô, vida de gado\nPovo marcado\nÊ, povo feliz!\nZÉ RAMALHO. A peleja do diabo com o dono do céu.\nRio de Janeiro: Sony, 1979 (fragmento).\n\nQual comportamento coletivo é criticado no trecho da letra da canção lançada em 1979?",
      subItens: []
    },
    options: ["Militância política.","Passividade social.","Altruísmo religioso.","Autocontrole moral.","Inconformismo eleitoral."],
    correctAnswer: 1,
    materia: "Sociologia – Crítica Social",
    conteudo: "Sociologia – Cultura Brasileira",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "Desde 2009, a área portuária carioca vem sofrendo grandes transformações realizadas no escopo da operação urbana consorciada conhecida como Porto Maravilha. Parte importante na tentativa de tornar o Rio de Janeiro um polo de serviços internacional, a \"revitalização” urbana deveria deixar para trás uma paisagem geográfica que ainda recordava a cidade do início do século passado para abrir espaço, em seu lugar, à instalação de modernas torres comerciais, espaços de consumo e lazer inéditos e cerca de cem mil novos moradores, uma nova configuração socioespacial capaz de alçar a área portuária do Rio de Janeiro ao patamar dos waterfronts de Baltimore, Barcelona e Buenos Aires.\nLACERDA, L.; WERNECK, M.; RIBEIRO, B. Cortiços de hoje na cidade do amanhã.\nE-metropolis, n. 30, set. 2017.\n\nAs intervenções urbanas descritas derivam de um processo socioespacial que busca a",
      subItens: []
    },
    options: ["intensificação da participação na competitividade global.","contenção da especulação no mercado imobiliário.","democratização da habitação popular.","valorização das funções tradicionais.","priorização da gestão participativa."],
    correctAnswer: 0,
    materia: "Geografia – Urbanização",
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "Por maioria, nós não entendemos uma quantidade relativa maior, mas a determinação de um estado ou de um padrão em relação ao qual tanto as quantidades maiores quanto as menores serão ditas minoritárias. Maioria supõe um estado de dominação. É nesse sentido que as mulheres, as crianças e também os animais são minoritários.\nDELEUZE, G.; GUATTARI, F. Mil platôs. São Paulo: Editora 34, 2012 (adaptado).\n\nNo texto, a caracterização de uma minoria decorre da existência de",
      subItens: []
    },
    options: ["ameaças de extinção social.","políticas de incentivos estatais.","relações de natureza arbitrária.","valorações de conexões simétricas.","hierarquizações de origem biológica."],
    correctAnswer: 2,
    materia: "Sociologia – Minoria e Maioria",
    conteudo: "Filosofia – Poder e Dominação",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "Ao mesmo tempo, graças às amplas possibilidades que tive de observar a classe média, vossa adversária, rapidamente concluí que vós tendes razão, inteira razão, em não esperar dela qualquer ajuda. Seus interesses são diametralmente opostos aos vossos, mesmo que ela procure incessantemente afirmar o contrário e vos queira persuadir que sente a maior simpatia por vossa sorte. Mas seus atos desmentem suas palavras.\nENGELS, F. A situação da classe trabalhadora na Inglaterra. São Paulo: Boitempo, 2010.\n\nNo texto, o autor apresenta delineamentos éticos que correspondem ao(s)",
      subItens: []
    },
    options: ["conceito de luta de classes.","alicerce da ideia de mais-valia.","fundamentos do método científico.","paradigmas do processo indagativo.","domínios do fetichismo da mercadoria."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "A participação social no planejamento e na gestão urbanos ganhou impulso a partir do Estatuto da Cidade (Lei n. 10.$\\\\frac{257}{2001}$), que estabeleceu condições para elaboração de planos diretores participativos, instrumentos esses indutores da expansão urbana e do ordenamento territorial que, a princípio, devem buscar representar os interesses dos diversos segmentos da sociedade. No entanto, é notório o limite à representação dos interesses das camadas sociais menos favorecidas nesse processo. Este rumo deve ser corrigido e deve-se continuar buscando mecanismos de inclusão dos interesses de toda a sociedade.\nCaderno Objetivos de Desenvolvimento Sustentável ODS n. 11: tornar as cidades e os assentamentos humanos inclusivos, seguros, resilientes e sustentáveis. Brasília: Ipea, 2019.\n\nQual medida promove a participação social descrita no texto?",
      subItens: []
    },
    options: ["Redução dos impostos municipais.","Privatização dos espaços públicos.","Adensamento das áreas de comércio.","Valorização dos condomínios fechados.","Fortalecimento das associações de bairro."],
    correctAnswer: 4,
    materia: "Sociologia – Planejamento Urbano",
    conteudo: "Sociologia – Participação Social",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "Quando Getúlio Vargas se suicidou, em agosto de 1954, o país parecia à beira do caos. Acuado por uma grave crise política, o velho líder preferiu uma bala no peito à humilhação de aceitar uma nova deposição, como a que sofrera em outubro de 1945. Entretanto, ao contrário do que imaginavam os inimigos, ao ruído do estampido não se seguiu o silêncio que cerca a derrota.\nREIS FILHO, D. A. O Estado à sombra de Vargas.\nRevista Nossa História, n. 7, maio 2004.\n\nO evento analisado no texto teve como repercussão imediata na política nacional a",
      subItens: []
    },
    options: ["reação popular.","intervenção militar.","abertura democrática.","campanha anticomunista.","radicalização oposicionista."],
    correctAnswer: 0,
    materia: "História – Era Vargas",
    conteudo: "História – Política Brasileira",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "Eu, Dom João, pela graça de Deus, faço saber a V. Mercê que me aprouve banir para essa cidade vários ciganos homens, mulheres e crianças devido ao seu escandaloso procedimento neste reino. Tiveram ordem de seguir em diversos navios destinados a esse porto, e, tendo eu proibido, por lei recente, o uso da sua língua habitual, ordeno a V. Mercê que cumpra esse lei sob ameaça de penalidades, não permitindo que ensinem dita língua a seus filhos, de maneira que daqui por diante o seu uso desapareça.\nTEIXEIRA, R. C. História dos ciganos no Brasil.\nRecife: Núcleo de Estudos Ciganos, 2008.\n\nA ordem emanada da Coroa portuguesa para sua colônia americana, em 1718, apresentava um tratamento da identidade cultural pautado em",
      subItens: []
    },
    options: ["converter grupos infiéis à religião oficial.","suprimir formas divergentes de interação social.","evitar envolvimento estrangeiro na economia local.","reprimir indivíduos engajados em revoltas nativistas.","controlar manifestações artísticas de comunidades autóctones."],
    correctAnswer: 1,
    materia: "História – Brasil Colonial",
    conteudo: "História – Relações Étnico-Raciais",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["pluralidade das demandas sociais.","homogeneidade das lutas religiosas.","unicidade das abordagens históricas.","superficialidade dos interesses políticos.","superioridade dos aspectos econômicos."],
    correctAnswer: 0,
    materia: "História – Revolução Inglesa",
...
createQuestion({
    ...
    options: ["Criação de vilas operárias.","Promoção de eventos comunitários.","Recuperação de áreas degradadas.","Incorporação de saberes tradicionais.","Importação de mão de obra qualificada."],
    correctAnswer: 4,
    materia: "Sociologia – Empresas e Economia",
    conteudo: "Geografia – Indústria e Territorialização",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "Sócrates: \"Quem não sabe o que uma coisa é, como poderia saber de que tipo de coisa ela é? Ou te parece ser possível alguém que não conhece absolutamente quem é Mênon, esse alguém saber se ele é belo, se é rico e ainda se é nobre? Parece-te ser isso possível? Assim, Mênon, que coisa afirmas ser a virtude?\".\nPLATÃO. Mênon. Rio de Janeiro: PUC-Rio; São Paulo: Loyola, 2001 (adaptado).\n\nA atitude apresentada na interlocução do filósofo com Mênon é um exemplo da utilização do(a)",
      subItens: []
    },
    options: ["escrita epistolar.","método dialético.","linguagem trágica.","explicação fisicalista.","suspensão judicativa."],
    correctAnswer: 1,
    materia: "Filosofia – Filosofia Antiga",
    conteudo: "Filosofia – Método Socrático",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "A filosofia é como uma árvore, cujas raízes são a metafísica; o tronco, a física, e os ramos que saem do tronco são todas as outras ciências, que se reduzem a três principais: a medicina, a mecânica e a moral, entendendo por moral a mais elevada e a mais perfeita porque pressupõe um saber integral das outras ciências, e é o último grau da sabedoria.\nDESCARTES, R. Princípios da filosofia. Lisboa: Edições 70, 1997 (adaptado).\n\nEssa construção alegórica de Descartes, acerca da condição epistemológica da filosofia, tem como objetivo",
      subItens: []
    },
    options: ["sustentar a unidade essencial do conhecimento.","refutar o elemento fundamental das crenças.","impulsionar o pensamento especulativo.","recepcionar o método experimental.","incentivar a suspensão dos juízos."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2021,
    text: {
      principal: "Minha fórmula para o que há de grande no indivíduo é amor fati: nada desejar além daquilo que é, nem diante de si, nem atrás de si, nem nos séculos dos séculos. Não se contentar em suportar o inelutável, e ainda menos dissimulá-lo, mas amá-lo.\nNIETZSCHE apud FERRY, L. Aprender a viver: filosofia para os novos tempos.\nRio de Janeiro: Objetiva, 2010 (adaptado).\n\nEssa fórmula indicada por Nietzsche consiste em uma crítica à tradição cristã que",
      subItens: []
    },
    options: ["combate as práticas sociais de cunho afetivo.","impede o avanço científico no contexto moderno.","associa os cultos pagãos à sacralização da natureza.","condena os modelos filosóficos da Antiguidade Clássica.","consagra a realização humana ao campo transcendental."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["Exaltação do ritualismo litúrgico.","Afirmação do pensamento racional.","Desqualificação da atividade laboral.","Condenação da alimentação impura.","Desvalorização da materialidade corpórea."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["valorização do trabalho braçal.","reiteração das hierarquias sociais.","sacralização das atividades laborais.","superação das exclusões econômicas.","ressignificação das heranças religiosas."],
    correctAnswer: 1,
    materia: "História – Brasil Colonial",
