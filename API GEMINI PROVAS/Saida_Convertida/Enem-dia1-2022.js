...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "A tirinha apresenta quatro quadrinhos. No primeiro quadrinho, um homem com roupa de realeza e coroa, dentro de um castelo, diz a uma mulher: \"NOW THAT YOU ARE MY BRIDE, YOU WILL NEVER LEAVE THIS CASTLE! WOW! YOUR LIBRARY IS AMAZING!\". A mulher, com roupa de noiva, olha surpresa para a parede do castelo, que é uma grande estante de livros. No segundo quadrinho, o homem, do lado de fora do castelo, aponta para uma parede alta sem portão e uma floresta escura, dizendo: \"BEYOND THE CASTLE IS A HIGH WALL WITH NO GATE, AND BEYOND THAT IS A DEEP, DARK FOREST WITH NO PATH. I SUPPOSE IT'S MY LIBRARY TOO, NOW WE'RE MARRIED.\" A mulher, ainda com a roupa de noiva, está sentada no chão, desanimada, e a estante de livros aparece ao fundo. No terceiro quadrinho, o homem, ainda do lado de fora, diz: \"THE FOREST IS CRAWLING WITH RAVENOUS WOLVES, MALIGNANT BIRDS AND THE SPIRITS OF LONG-DEAD TRAVELLERS. SO MANY BOOKS! I CAN'T BELIEVE MY LUCK!\". A mulher está sentada dentro do castelo, no chão, rodeada por uma pilha enorme de livros. No quarto quadrinho, o homem, do lado de fora, continua: \"WHEN THE SUN SETS, I TRANSFORM INTO A WILD BEAST AND SOAR INTO THE NIGHT, SEIZED BY A TERRIBLE BLOODLUST! OK. I'LL STAY HERE AND READ. SEE YOU IN THE MORNING.\" A mulher está tranquilamente sentada entre seus livros dentro do castelo. GAULD, T. Disponível em: www.tomgauld.com. Acesso em: 25 out. 2021.\nNessa tirinha, o comportamento da mulher expressa",
      subItens: []
    },
    options: ["revolta com a falta de sorte.","gosto pela prática da leitura.","receio pelo futuro do casamento.","entusiasmo com os livros de terror.","rejeição ao novo tipo de residência."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "I tend the mobile now\nlike an injured bird\nWe text, text, text\nour significant words.\nI re-read your first,\nyour second, your third,\nLook for your small xx,\nfeeling absurd.\nThe codes we send\narrive with a broken chord.\nI try to picture your hands,\ntheir image is blurred.\nNothing my thumbs press\nwill ever be heard.\nDUFFY, C. Disponível em: www.independent.co.uk. Acesso em: 27 out. 2021.\nNesse poema, o eu lírico evidencia um sentimento de",
      subItens: []
    },
    options: ["contentamento com a interação virtual.","zelo com o envio de mensagens.","preocupação com a composição de textos.","mágoa com o comportamento de alguém.","insatisfação com uma forma de comunicação."],
    correctAnswer: 4,
    materia: "Inglês – Interpretação de texto poético",
    conteudo: "Inglês – Sentimentos",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "A imagem mostra uma peça publicitária com o título \"Arrependimento\" em negrito na parte superior. Abaixo, há uma imagem desfocada de um carro capotado ou acidentado em uma área escura, com pouca iluminação. À direita do título, um texto em destaque diz: \"Causar um acidente é algo que você leva pro resto da vida. Não beba se for dirigir.\" No canto inferior direito, há o logo do \"DETRAN ES\". Disponível em: www.portaldapropaganda.com.br. Acesso em: 29 out. 2013 (adaptado).\nPara convencer o público-alvo sobre a necessidade de um trânsito mais seguro, essa peça publicitária apela para o(a)",
      subItens: []
    },
    options: ["sentimento de culpa provocado no condutor causador de acidentes.","dano psicológico causado nas vítimas da violência nas estradas.","importância do monitoramento do trânsito pelas autoridades competentes.","necessidade de punição a motoristas alcoolizados envolvidos em acidentes.","sofrimento decorrente da perda de entes queridos em acidentes automobilísticos."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["falta de compreensão causada pelo choque entre gerações.","contexto de comunicação em que a conversa se dá.","grau de polidez distinto entre os interlocutores.","diferença de escolaridade entre os falantes.","nível social dos participantes da situação."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "Uma imagem apresenta um cartaz publicitário com o título em destaque \"QUANTO CUSTOU?\". Abaixo, um texto menor informa: \"Proposta obriga órgão público a divulgar gasto com anúncio na própria peça publicitária.\" No canto inferior esquerdo da imagem, há o texto \"Qual sua opinião?\". Disponível em: www.facebook.$\\\\frac{com}{senadofederal}$. Acesso em: 9 dez. 2017.\nConsiderando-se a função social dos posts, essa imagem evidencia a apropriação de outro gênero com o objetivo de",
      subItens: []
    },
    options: ["promover o uso adequado de campanhas publicitárias do governo.","divulgar o projeto sobre transparência da administração pública.","responsabilizar o cidadão pelo controle dos gastos públicos.","delegar a gestão de projetos de lei ao contribuinte.","assegurar a fiscalização dos gastos públicos."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Linguagem publicitária",
    conteudo: "Língua Portuguesa – Função social da linguagem",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["tematiza o fazer poético, como em “Os poetas classificam as palavras pela alma”.","utiliza o recurso expressivo da metáfora, como em “As palavras têm corpo e alma”.","valoriza a gramática da língua, como em “substantivo, adjetivo, verbo, advérbio, conjunção”.","estabelece comparações, como em “As palavras têm corpo e alma, mas são diferentes das pessoas”.","apresenta informações pertinentes acerca do conceito de “palavra”, como em “As gramáticas classificam as palavras”."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "Morte lenta ao luso infame que inventou a calçada portuguesa. Maldito D. Manuel I e sua corja de tenentes Eusébios. Quadrados de pedregulho irregular socados à mão. À mão! É claro que ia soltar, ninguém reparou que ia soltar? Branco, preto, branco, preto, as ondas do mar de Copacabana. De que me servem as ondas do mar de Copacabana? Me deem chão liso, sem protuberâncias calcárias. Mosaico estúpido. Mania de mosaico. Joga concreto em cima e aplaina. Buraco, cratera, pedra solta, bueiro-bomba. Depois dos setenta, a vida se transforma numa interminável corrida de obstáculos. A queda é a maior ameaça para o idoso. “Idoso”, palavra odienta. Pior, só “terceira idade”. A queda separa a velhice da senilidade extrema. O tombo destrói a cadeia que liga a cabeça aos pés. Adeus, corpo. Em casa, vou de corrimão em corrimão, tateio móveis e paredes, e tomo banho sentado. Da poltrona para a janela, da janela para a cama, da cama para a poltrona, da poltrona para a janela. Olha aí, outra vez, a pedrinha traiçoeira atrás de me pegar. Um dia eu caio, hoje não.\nTORRES, F. Fim. São Paulo: Cia. das Letras, 2013.\nO recurso que caracteriza a organização estrutural desse texto é o(a)",
      subItens: []
    },
    options: ["justaposição de sequências verbais e nominais.","mudança de eventos resultante do jogo temporal.","uso de adjetivos qualificativos na descrição do cenário.","encadeamento semântico pelo uso de substantivos sinônimos.","inter-relação entre orações por elementos linguísticos lógicos."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Recursos estilísticos",
...
createQuestion({
    ...
    options: ["revelar a imposição de crenças religiosas a pessoas escravizadas.","apontar a hipocrisia do discurso conservador na defesa da escravidão.","sugerir práticas de violência física e moral em nome do progresso material.","relacionar o declínio da produção agrícola e comercial a questões raciais.","ironizar o comportamento dos proprietários de terra na exploração do trabalho."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Romantismo",
    conteudo: "Língua Portuguesa – Crítica social",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["garantem a igualdade entre as pessoas.","foram criados por uma pesquisadora surda.","tiveram origem em um curso de pós-graduação.","estão circunscritos ao espaço institucional da escola.","têm como objetivo a disseminação do conhecimento."],
    correctAnswer: 4,
    materia: "Sociologia – Tecnologia e inclusão",
    conteudo: "Sociologia – Acessibilidade",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "A imagem exibe duas caixas de texto lado a lado, com a silhueta de pessoas. A caixa da esquerda, sobre uma silhueta feminina com o cabelo preso, diz: \"Mulher ao volante, perigo constante. Mulher tem estrada para andar\". A caixa da direita, sobre uma silhueta masculina de perfil, diz: \"Os homens não choram.\". Disponível em: https://viva-porto.pt. Acesso em: 24 nov. 2021 (adaptado).\nA articulação entre os elementos verbais e os não verbais do texto tem como propósito desencadear a",
      subItens: []
    },
    options: ["identificação de distinções entre mulheres e homens.","revisão de representações estereotipadas de gênero.","adoção de medidas preventivas de combate ao sexismo.","ratificação de comportamentos femininos e masculinos.","retomada de opiniões a respeito da diversidade dos papéis sociais."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Linguagem não verbal",
    conteudo: "Língua Portuguesa – Estereótipos de gênero",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "Uma imagem apresenta um manual de orientação dividido em três seções: \"Até 2 anos\", \"De 2 a 5 anos\" e \"Até 10 anos\", com recomendações para o tempo de exposição de crianças a telas. O título geral é \"MANUAL DE ORIENTAÇÃO\" e o subtítulo \"O primeiro guia prático da Sociedade Brasileira de Pediatria para ajudar pais e pediatras no desafio de educar nativos digitais\".\nNa seção \"Até 2 anos\", o texto diz: \"A criança não deve ser exposta passivamente às telas – TV, tablet, celular etc. —, principalmente durante as refeições e até 2 horas antes de dormir.\"\nNa seção \"De 2 a 5 anos\", o texto diz: \"O tempo de exposição às telas deve ser limitado a 1 hora por dia. Crianças dessa faixa etária devem ser mais protegidas da violência virtual, pois não sabem separar fantasia de realidade.\"\nNa seção \"Até 10 anos\", o texto diz: \"Devem ter acesso controlado a computadores e dispositivos móveis. Crianças de até 10 anos não devem usar TV ou computador no próprio quarto.\"\nDisponível em: https://tab.uol.com.br. Acesso em: 25 ago. 2017 (adaptado).\nO texto sobre os chamados nativos digitais traz informações com a função de",
      subItens: []
    },
    options: ["propor ações específicas para cada etapa da infância.","estabelecer regras que devem ser seguidas à risca.","explicar os efeitos do acesso precoce à internet.","determinar a incorporação de rituais à educação dos filhos.","educar com base em um conjunto de estratégias formativas."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Gêneros textuais",
    conteudo: "Língua Portuguesa – Saúde e tecnologia",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["enumeração de objetos e fatos.","predominância de linguagem objetiva.","ocorrência de período longo no trecho.","combinação de verbos no presente e no pretérito.","presença de léxico do campo semântico de funerais."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Realismo",
    conteudo: "Língua Portuguesa – Recursos estilísticos",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: "Arte – Arte conceitual",
    conteudo: "Arte – Crítica à arte",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "O gráfico apresenta as porcentagens de evapotranspiração, escoamento superficial, infiltração subsuperficial e percolação profunda para três diferentes tipos de cobertura do solo. O primeiro gráfico, \"Cobertura natural do solo\", mostra: evapotranspiração: 40%, escoamento superficial: 10%, infiltração subsuperficial: 25%, percolação profunda: 25%. O segundo gráfico, \"10% - 20% de superfície impermeável\", mostra: evapotranspiração: 38%, escoamento superficial: 20%, infiltração subsuperficial: 21%, percolação profunda: 21%. O terceiro gráfico, \"35% - 50% de superfície impermeável\", mostra: evapotranspiração: 35%, escoamento superficial: 30%, infiltração subsuperficial: 20%, percolação profunda: 15%. O quarto gráfico, \"75% - 100% de superfície impermeável\", mostra: evapotranspiração: 30%, escoamento superficial: 55%, infiltração subsuperficial: 10%, percolação profunda: 5%. PAZ, A. D. Disponível em: www.ct.ufpb.br. Acesso em: 15 out. 2021 (adaptado).\nA intensificação da ocupação urbana demonstrada afeta de forma imediata o(a)",
      subItens: []
    },
    options: ["nível altimétrico.","ciclo hidrológico.","padrão climático.","tectônica de placas.","estrutura das rochas."],
    correctAnswer: 1,
    materia: "Geografia – Urbanização",
    conteudo: "Geografia – Ciclo hidrológico",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "Na construção da ferrovia Madeira-Mamoré, o que dizer dos doentes, eternos moribundos a vagar entre delírios febris, doses de quinino e corredores da morte? O Hospital da Candelária era santuário e túmulo, monumento ao progresso científico e preâmbulo da escuridão. Foi ali, com suas instalações moderníssimas, que médicos e sanitaristas dirigiram seu combate aos males tropicais. As maiores vítimas, contudo, permaneceriam na sombra à margem do palco, cobaias sem consolo, credores sem nome de uma sociedade que não lhes concedera tempo algum para ser decifrada.\nFOOT HARDMAN, F. Trem fantasma: modernidade na selva. São Paulo: Cia. das Letras, 1988 (adaptado).\nNo texto, há uma crítica ao modo de ocupação do espaço amazônico pautada na",
      subItens: []
    },
    options: ["discrepância entre engenharia ambiental e equilíbrio da fauna.","incoerência entre maquinaria estrangeira e controle da floresta.","incompatibilidade entre investimento estatal e proteção aos nativos.","competição entre farmacologia internacional e produtos da fitoterapia.","contradição entre desenvolvimento nacional e respeito aos trabalhadores."],
    correctAnswer: 4,
    materia: "História – Desenvolvimento e impacto social",
    conteudo: "História – Amazônia",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "Os caixeiros do comércio a retalho do Rio de Janeiro estiveram entre as primeiras categorias de trabalhadores a se organizar em associações e a exigir a intervenção dos poderes públicos na mediação de suas lutas por direitos. Na década de 1880, os caixeiros participaram da arena política e ganharam as ruas com vários outros, como os republicanos e os abolicionistas.\nPOPINIGIS, F. “Todas as liberdades são irmãs”: os caixeiros e as lutas dos trabalhadores por direitos entre o Império e a República. Estudos Históricos, n. 59, set.-dez. 2016 (adaptado).\nA atuação dos trabalhadores mencionados no texto representou, na capital do Império, um momento de",
      subItens: []
    },
    options: ["manutenção das regras patronais.","desprendimento das ideias liberais.","fortalecimento dos contratos laborais.","consolidação das estruturas sindicais.","contestação dos princípios monárquicos."],
    correctAnswer: 4,
    materia: "História – Movimentos sociais",
    conteudo: "História – Império",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Delimitação de paisagens urbanas e abandono de componentes espiritualistas.","Demarcação de patrimônios afetivos e apropriação de elementos judaizantes.","Expansão de fronteiras regionais e subjetivação do cristianismo medieval.","Circunscrição de bens simbólicos e admissão de cerimônias ecumênicas.","Criação de lugares místicos e experiências do catolicismo popular."],
    correctAnswer: 4,
    materia: "História – Religião e sociedade",
    conteudo: "História – Catolicismo popular",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "Após sete anos da ocupação de um terreno abandonado em Santo André, no ABC paulista, os condomínios Novo Pinheirinho e Santos Dias foram inaugurados, com a presença de representantes dos governos federal, estadual e municipal. A ocupação começou em 2012 e, desde então, o movimento vinha reivindicando o direito de usufruir do espaço para a construção de casas. A Carta Magna, em seu art. 6°, garante a todos os brasileiros o direito à moradia.\nPUTTI, A. Disponível em: www.cartacapital.com.br. Acesso em: 13 nov. 2021 (adaptado).\nO texto apresenta uma estratégia usada pelo movimento social para",
      subItens: []
    },
    options: ["fragilizar o poder público.","fomentar a economia solidária.","controlar a propriedade estatal.","garantir o preceito constitucional.","incentivar a especulação imobiliária."],
    correctAnswer: 3,
    materia: "Sociologia – Movimentos sociais",
    conteudo: "Sociologia – Direito à moradia",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "Um mapa do Brasil, com destaque para a Amazônia Legal, apresenta isolinhas da radiação solar global horizontal média anual em $\\\\frac{kWh}{m}$². As linhas indicam valores que variam de 3,15 a 6,65 $\\\\frac{kWh}{m}$², com as maiores concentrações de radiação solar ocorrendo na região da Amazônia Legal. No canto inferior direito, há uma escala em quilômetros.\nPEREIRA, E. B. et al. Atlas brasileiro de energia solar. São José dos Campos: Inpe, 2006.\nUma característica regional que justifica o maior potencial anual médio para o aproveitamento da energia solar é a reduzida",
      subItens: []
    },
    options: ["declividade do relevo.","extensão longitudinal.","nebulosidade atmosférica.","irregularidade pluviométrica.","influência da continentalidade."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "Um mapa mostra um possível trajeto do voo MH_{370} da Malaysia Airlines antes da queda, em 2014. O mapa abrange as regiões da Malásia, Indonésia, Madagascar, Austrália e o Oceano Índico. Um ponto no Oceano Índico está identificado como \"Local onde os destroços foram avistados\". A distância entre esse ponto e a cidade de Perth (Austrália) é de 2 cm no mapa, e o texto indica que essa distância real é de 2500 km. Disponível em: http://imguol.com. Acesso em: 30 mar. 2014 (adaptado).\nConsiderando-se que a distância entre o local onde os destroços do avião foram avistados e a cidade de Perth é de 2 cm, a escala aproximada dessa representação cartográfica é:",
      subItens: []
    },
    options: ["1:12 500.","1: 125 000.","1:1 250 000.","1:12 500 000.","1:125 000 000."],
    correctAnswer: 4,
    materia: "Geografia – Cartografia",
    conteudo: "Geografia – Escala",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "Um mapa do Brasil, com destaque para a Amazônia Legal, exibe a distribuição de rochas ígneas na região. A legenda indica que as áreas sombreadas correspondem a \"Rochas ígneas Amazônia Legal\". O mapa também mostra coordenadas geográficas e cidades como Manaus, Belém, Cuiabá e Porto Velho. No canto inferior direito, há uma escala em quilômetros. Geoestatísticas de recursos naturais da Amazônia Legal. Rio de Janeiro: IBGE, 2011 (adaptado).\nO mapa espacializa um recurso natural com alto potencial para ocorrência de:",
      subItens: []
    },
    options: ["Abalos sísmicos periódicos.","Jazidas de minerais metálicos.","Reservas de combustíveis fósseis.","Aquíferos sedimentares profundos.","Estruturas geológicas metamórficas."],
    correctAnswer: 1,
    materia: "Geografia – Geologia",
...
createQuestion({
    ...
    options: ["Admitindo o belo como fenômeno transcendental.","Reafirmando a vivência estética como juízo de gosto.","Considerando o olhar como experiência de conhecimento.","Apontando as formas de expressão como auxiliares da razão.","Estabelecendo a inteligência como implicação das representações."],
    correctAnswer: 2,
    materia: "Filosofia – Estética",
    conteudo: "Filosofia – Percepção",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["abrandar cerimônias de punição.","favorecer anseios de violência.","criticar políticas de disciplina.","produzir padrões de conduta.","ordenar cultos de heresia."],
    correctAnswer: 3,
    materia: "História – Inquisição",
    conteudo: "História – Poder da Igreja",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "Entretanto, nosso amigo Basso tem o ânimo alegre. Isso resulta da filosofia: estar alegre diante da morte, forte e contente qualquer que seja o estado do corpo, sem desfalecer, ainda que desfaleça.\nSÊNECA, L. Cartas morais. Lisboa: Calouste Gulbenkian, 1990.\nO excerto refere-se a uma carta de Sêneca na qual se apresenta como um bem fundamental da filosofia promover a",
      subItens: []
    },
    options: ["valorização de disputas dialógicas.","rejeição das convenções sociais.","inspiração de natureza religiosa.","exaltação do sofrimento.","moderação das paixões."],
    correctAnswer: 4,
    materia: "Filosofia – Filosofia Helenística",
    conteudo: "Filosofia – Estoicismo",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2022,
    text: {
      principal: "Quando os espanhóis chegaram à América, estava em seu apogeu o império teocrático dos Incas, que estendia seu poder sobre o que hoje chamamos Peru, Bolívia e Equador, abarcava parte da Colômbia e do Chile e alcançava até o norte argentino e a selva brasileira; a confederação dos Astecas tinha conquistado um alto nível de eficiência no vale do México, e no Yucatán, na América Central, a esplendida civilização dos Maias persistia nos povos herdeiros, organizados para o trabalho e para a guerra. Os Maias tinham sido grandes astrônomos, mediram o tempo e o espaço com assombrosa precisão, e tinham descoberto o valor do número zero antes de qualquer povo da história. No museu de Lima, podem ser vistos centenas de crânios que receberam placas de ouro e prata por parte dos cirurgiões Incas.\nGALEANO, E. As veias abertas da América Latina. Porto Alegre: L&PM, 2012.\nAs sociedades mencionadas deixaram como legado uma diversidade de",
      subItens: []
    },
    options: ["bens religiosos inspirados na matriz cristã.","materiais bélicos pilhados em batalhas coloniais.","heranças culturais constituídas em saberes próprios.","costumes laborais moldados em estilos estrangeiros.","práticas medicinais alicerçadas no conhecimento científico."],
    correctAnswer: 2,
    materia: "História – Civilizações pré-colombianas",
    conteudo: "História – Herança cultural",
    imageNames: []
  }),
