...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Para defender seu ponto de vista, o autor do",
      subItens: [{"titulo":"Texto 1","conteudo":"usa determinadas estratégias de argumentação e composição textual. Assinale a alternativa que NÃO apresenta estratégias utilizadas."}]
    },
    options: ["Citação e intertextualidade.","Paráfrase e raciocínio de causa/consequência.","Paródia e contra-argumentação.","Contraposição de termos e alusão histórica."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Assinale a alternativa correta a respeito da música \"Trabalivre” (",
      subItens: [{"titulo":"Texto 2","conteudo":")."},{"titulo":"Texto 2","conteudo":"Trabalivre\n(Tribalistas)\nUm dia minha mãe me disse\nVocê já é grande, tem que trabalhar\nNaquele instante aproveitei a chance\nVi que eu era livre para me virar\nFiz minha mala, comprei a passagem\nO tempo passou depressa e eu aqui cheguei\nPassei por tudo que é dificuldade\nMe perdi pela cidade mas já me encontrei\nDomingo boto meu pijama\nDeito lá na cama para não cansar\nSegunda-feira eu já tô de novo\nAtolado de trabalho para entregar\nNa terça não tem brincadeira\nQuarta-feira tem serviço para terminar\nNa quinta já tem hora extra\nE na sexta o expediente termina no bar\nMas tenho o sábado inteiro pra mim mesmo\nFora do emprego\nPra me aprimorar\nSou easy, eu não entro em crise\nTenho tempo livre\nPra me trabalhar\nDisponível em: <https://www.letras.mus.br/tribalistas/trabalivre/>. Acesso em: 10 nov. 2017."}]
    },
    options: ["O eu lírico constrói uma narrativa marcada pela progressão temporal dos dias da semana. Essa narrativa busca enaltecer o trabalho e sua função social, de forma a levar o interlocutor a buscar se aprimorar para tal atividade.","O uso de primeira pessoa do singular demonstra que o eu lírico inclui o interlocutor em sua narrativa, compondo uma voz uníssona que versa sobre a atividade laboral.","A ironia é uma estratégia presente na composição do texto e está marcada no jogo feito entre a sequência narrativa e a ação indicativa no final da canção, em que o eu lírico, mesmo em seu tempo livre, trabalha a si próprio, o que revela que o trabalho é algo inerente a esse indivíduo, tanto externa quanto internamente.","A formalidade presente na linguagem da canção compõe uma relação direta com a atividade laboral, demonstrando que o trabalho exige uma postura séria do indivíduo."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Interpretação de Texto",
    conteudo: "Língua Portuguesa – Figuras de Linguagem (Ironia)",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Assinale a alternativa correta a respeito dos elementos linguísticos da música \"Trabalivre\".",
      subItens: []
    },
    options: ["No excerto “Mas tenho o sábado inteiro pra mim mesmo / Fora do emprego / Pra me aprimorar\", o elemento coesivo de contraposição indica que o sábado representa um dia de descanso, ao contrário dos outros dias da semana. No entanto essa expectativa é quebrada quando se insere uma finalidade alheia ao descanso.","Os verbos conjugados no presente do indicativo demonstram que as ações realizadas pelo eu lírico são pontuais e se dão no presente momentâneo do ato enunciativo.","A colocação dos pronomes pessoais do caso oblíquo presentes no texto obedece à norma culta da língua portuguesa. Tal fato pode ser observado especialmente no verso \"Me perdi pela cidade mas já me encontrei”.","Os advérbios de modo dão o tom narrativo ao texto, utilizados para caracterizar ações durativas como a que se expressa no verso \"O tempo passou depressa e eu aqui cheguei\"."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Coesão e Coerência",
    conteudo: "Língua Portuguesa – Classes de Palavras (Verbos, Advérbios, Pronomes)",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: "Língua Portuguesa – Interpretação de Cartuns/Tirinhas",
    conteudo: "Língua Portuguesa – Sintaxe (Verbos)",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Assinale a alternativa correta a respeito do",
      subItens: [{"titulo":"Texto 3","conteudo":"e de seus elementos linguísticos."},{"titulo":"Texto 3","conteudo":"\"ALIEN INTERVIEW” (Entrevista com um alienígena)\nNo momento em que o ser alienígena tinha sido devolvido à base eu já tinha passado várias horas com ela. Como já referi, o Sr. Cavitt me disse para ficar com a extraterrestre, já que eu era a única pessoa entre nós que poderia compreendê-la e manter comunicação telepaticamente. Eu não pude compreender e entender a minha capacidade de me \"comunicar\" telepaticamente com o ser extraterrestre. Eu nunca antes havia tido experiência com comunicação telepática com alguém. A comunicação não-verbal que eu experimentei era como a compreensão que se tem quando uma criança ou um cão está tentando fazer você entender alguma coisa, mas muito, muito mais direta e poderosa! Mesmo que não houvesse falado \"palavras\", ou comunicação através de sinais, a intenção dos pensamentos eram inconfundíveis para mim. Percebi mais tarde que, apesar de eu receber o pensamento, eu necessariamente não interpretava o seu significado exatamente.\n[...]\nDisponível em: <http://www.bibliotecapleyades.net/vida_alien/alieninterview/alieninterview.htm)>. Acesso em 10 nov. 2017."}]
    },
    options: ["As aspas foram utilizadas ao longo do texto para marcar ironia por parte do autor, tendo em vista que houve um deslocamento semântico no uso das palavras marcadas por esse sinal. Tal efeito de sentido também se dá pelo uso do ponto de exclamação em \"[...] mas muito, muito mais direta e poderosa! [...]”.","Em \"[...] o ser alienígena tinha sido devolvido à base [...]\", a crase é utilizada por haver, antes dela, uma perífrase verbal formada por dois verbos auxiliares mais um verbo no particípio e por haver, depois dela, um substantivo feminino.","Em \"[...] era como a compreensão que se tem quando uma criança ou um cão está tentando fazer você entender alguma coisa [...]\", o \"se” exerce função de índice de indeterminação do sujeito.","Em “Como já referi, o Sr. Cavitt me disse para ficar com a extraterrestre [...]\" e em \"[...] era como a compreensão que se tem [...]\", os termos em destaque estabelecem relações de sentido diferentes."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "As questões de 10 a 12 são referentes à obra A dança dos cabelos, de Carlos Herculano Lopes.\nLeia o seguinte excerto: \"Assentada neste banco onde a empregada me trouxe o jantar e após a sobremesa uma garrafa de café, estou com os olhos no azul da serra e no sol que nele se abriga, nessa estranha hora em que o silêncio é cortado apenas pelo berro de uma rês ou pelo cruzar de uma ave, e em que faço mais um cigarro, sem, no entanto, livrar-me dos latejos que em fincadas sucessivas voltam às minhas pernas e doem como as antigas lembranças de minha infância.\" LOPES, Carlos Herculano. A dança dos cabelos. Rio de Janeiro: Record, 2017. Considerando que o romance apresenta, entre outras, três personagens femininas, sendo estas avó, mãe e filha, todas com o nome de Isaura, assinale a alternativa correta em relação ao trecho apresentado.",
      subItens: []
    },
    options: ["Trata-se de uma carta da avó Isaura ao avô Antônio.","O trecho é referente à carta redigida pela mãe Isaura ao seu marido.","Refere-se a uma reflexão da mãe Isaura.","Refere-se ao sonho da filha Isaura quando retorna à casa na qual cresceu."],
    correctAnswer: 1,
    materia: "Literatura Brasileira – Romance Contemporâneo (Carlos Herculano Lopes)",
    conteudo: "Língua Portuguesa – Interpretação de Texto",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Considerando o título e o enredo da obra, assinale a alternativa correta. (A obra referida é 'A dança dos cabelos' de Carlos Herculano Lopes, como estabelecido no preâmbulo da questão 10).",
      subItens: []
    },
    options: ["O título simboliza a labuta diária das personagens femininas que, em uma tentativa de agradar aos homens, trançam os longos cabelos pretos todos os dias em um ritual semelhante ao de uma dança.","O livro é narrado por três mulheres, simbolizando as três partes de uma trança, e a narrativa ora apresenta o discurso de uma delas, ora de outra e, em um terceiro momento, de outra, criando um movimento também muito parecido com o trançar de cabelos, atividade presente no cotidiano das mulheres da família.","Em um determinado momento da narrativa, Isaura (filha) relata ter ficado escondida, ainda quando criança, com outras mulheres, num quarto pequeno, abafado, úmido e escuro, enquanto a casa era invadida por jagunços. O título da obra simboliza tal momento, pois a forma adotada pelas mulheres para amenizar o horror que estava acontecendo foi dançar até que aquela situação acabasse.","Não há uma relação explícita entre o título e o enredo, pois, ao longo da narrativa, nada é mencionado sobre dança ou cabelos."],
    correctAnswer: 2,
    materia: "Literatura Brasileira – Romance Contemporâneo (Carlos Herculano Lopes)",
    conteudo: "Literatura Brasileira – Análise da Obra",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Filmes de ficção, como Star Wars (Guerra nas Estrelas), mostram voos de espaçonaves e suas manobras direcionais, além de batalhas envolvendo naves e civilizações tecnologicamente avançadas. Em relação a esses filmes, é correto afirmar que eles",
      subItens: []
    },
    options: ["respeitam as leis da Física, especialmente aquelas que envolvem as conservações do momento linear e da energia mecânica.","respeitam as questões relativas à acústica em meio vácuo, assim como a velocidade e a visualização de “pacotes de onda” (\"disparos\" laser) no vazio do espaço.","desrespeitam as noções de gravidade artificial no interior da nave, desconsiderando efeitos de imponderabilidade.","desrespeitam as noções de dinâmicas de voo em superfícies planetárias, adotando designs não aerodinâmicos de naves."],
    correctAnswer: 3,
    materia: "Física – Cinema e Física",
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: "Física – Gravitação Artificial",
    conteudo: "Física – Força Centrífuga",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Assinale a alternativa que apresenta fenômenos que poderiam estar associados às seguintes ilustrações.\n(Image: Two circular diagrams with concentric waves emanating from a central point. The left one shows waves expanding from a red dot, the right one shows waves contracting towards a red dot, or vice versa depending on interpretation of the \"source\"). Both have x and y axes from -10 to 10.",
      subItens: []
    },
    options: ["Ressonância magnética e oscilações forçadas.","Efeito Casimir e Ultrassom.","Efeito Doppler e Desvio para o Vermelho (Big Bang).","Ressonância acústica e interferência destrutiva."],
    correctAnswer: 3,
    materia: "Física – Ondas",
    conteudo: "Física – Fenômenos Ondulatórios (Ressonância, Interferência)",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Considere a figura a seguir em que uma bola de massa m, suspensa na extremidade de um fio, é solta de uma altura h e colide elasticamente, em seu ponto mais baixo, com um bloco de massa 2m em repouso sobre uma superfície sem nenhum atrito. Depois da colisão, a bola subirá até uma altura igual a\n(Image: A pendulum with a mass 'm' at height 'h' above its lowest point. Below the lowest point, on a flat surface, is a block of mass '2m').",
      subItens: []
    },
    options: ["h/7.","h/9.","h/5.","h/3."],
    correctAnswer: 1,
    materia: "Física – Conservação da Energia Mecânica",
    conteudo: "Física – Colisões Elásticas",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: "Física – Termodinâmica (Leis da Termodinâmica)",
    conteudo: "Física – Experimentos Mentais",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Após 21 anos de Ditadura Militar no Brasil, ocorreu a eleição do primeiro presidente civil. Esse período histórico, que se convencionou chamar de “redemocratização”, compreendeu uma série de medidas instauradas progressivamente. Integram esse quadro de medidas:",
      subItens: []
    },
    options: ["o fim do DIP (Departamento de Imprensa e Propaganda); o slogan “Cinquenta Anos em Cinco\"; o retorno ao pluripartidarismo; a revogação do Al-5 de 1968.","a oposição ao comunismo; a Lei de Anistia; a Doutrina de Segurança Nacional; a dissolução do Congresso Nacional.","a revogação do Al-5 de 1968; o retorno do pluripartidarismo; a Lei de Anistia; o fim da censura prévia aos espetáculos e às publicações.","a Doutrina de Segurança Nacional; o fim da censura prévia aos espetáculos e às publicações; a revogação do Al-5 de 1968."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "As estrofes a seguir pertencem à música de Teixeirinha, denominada \"24 de agosto\", produzida em 1962 e presente na 6ª faixa do disco LP \"Saudades de Passo Fundo\". A música homenageia Getúlio Vargas. \"Vinte e quatro de agosto a terra estremeceu Os rádios anunciaram o fato que aconteceu As nuvens cobriram o céu, o povo em geral sofreu O Brasil se vestiu de luto, Getúlio Vargas morreu! Seu nome ficou na história pra nossa recordação Seu sorriso era a vitória da nossa imensa nação Com saúde, ele venceu guerra e revolução Depois foi morrer à bala pela sua própria mão”. (Adapatado) Considerando a letra da música e os conhecimentos históricos sobre o tema, assinale a alternativa INCORRETA.",
      subItens: []
    },
    options: ["O título da música refere-se à data em que Getúlio Vargas cometeu suicídio, em 1954, deixando uma carta-testamento, cuja autenticidade não foi devidamente comprovada, na qual consta a frase \"Saio da vida para entrar na história\".","A \"guerra” à qual a música se refere é a Segunda Guerra Mundial, da qual o Brasil participou, através da Força Expedicionária Brasileira (FEB), lutando ao lado dos aliados em território italiano.","A homenagem de Teixeirinha quer destacar a popularidade de Getúlio Vargas, conhecido por ser o \"Pai dos Pobres\". Esse codinome provavelmente está relacionado, entre outros fatores, ao fato de Getúlio Vargas adotar uma política trabalhista, com a criação da CLT (Consolidação das Leis do Trabalho), sendo responsável pelas concepções da Carteira de Trabalho, da Justiça do Trabalho e do salário mínimo.","A revolução mencionada na música diz respeito à Revolução Constitucionalista de São Paulo, também conhecida como Guerra Paulista, movimento armado que ocorreu no segundo governo de Getúlio Vargas, a favor de suas políticas populistas."],
    correctAnswer: 3,
    materia: "História – Brasil República (Era Vargas)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Com base nos dois depoimentos e na imagem a seguir, considerando o que pode ser relacionado a essas fontes históricas, assinale a alternativa INCORRETA.\n• \"Eu tenho conhecimento de mais acidentes no início do dia do que no final. Eu fui, inclusive, testemunha de um deles. Uma criança estava trabalhando a lã, isto é, preparando a la para a máquina, mas a alça a prendeu, como ela foi pega de surpresa, acabou sendo levada para dentro do mecanismo; e nós encontramos seus membros em um lugar, outro acolá, e ela foi cortada em pedaços; todo o seu corpo foi mandado para dentro e foi totalmente mutilado\". (John Allett começou a trabalhar em uma fábrica de têxteis quando tinha quatorze anos. Allett tinha cinquenta e três anos quando foi entrevistado por Michael Sadler e seu Comitê da Câmara dos Comuns, em 21 de maio de 1832.).\n• \"Os primeiros dias de setembro foram muito quentes. Os jornais noticiavam que homens e cavalos caiam mortos nos campos de produção agrícola. Ainda assim, a temperatura nunca passava de 29°C durante a parte mais quente do dia. Qual era então a situação das pobres crianças que estavam condenadas a trabalhar quatorze horas por dia, em uma temperatura média de 28°C? Pode algum homem, com um coração em seu peito e uma língua em sua boca, não se habilitar a amaldiçoar um sistema que produz tamanha escravidão e crueldade?\" (William Cobbett fez um artigo sobre uma visita a uma fábrica de tecidos que aconteceu em setembro de 1824).\n(Image: \"Fonte: Lewis Hine. Some of the young knitters in London Hosiery Mills. Londres, 1910\" - shows young girls working at knitting machines in a factory.)",
      subItens: []
    },
    options: ["Os trechos e a foto são associados ao trabalho infantil na Revolução Industrial, pois aproximadamente 50% dos trabalhadores eram crianças que trabalhavam entre 12 e 16 horas por dia. Nas fábricas, as condições de trabalho eram precárias, pois não havia janelas e trabalhavam muitos operários, propagando-se as doenças mais facilmente.","Os trechos e a foto reforçam os aspectos negativos da Revolução Industrial, quando uma classe industrial nascente preferia empregar mulheres e crianças, pois estes recebiam metade do salário de um homem adulto, pela mesma carga horária. Contudo os aspectos positivos devem ser também ressaltados, mesmo porque essa situação foi modificada com máquinas adaptadas à altura das crianças, e a escola tornou-se obrigatória para o povo logo após o movimento ludista e o movimento cartista.","Os depoimentos e a foto retratam o fato de que muitas crianças com menos de 8 anos trabalhavam nas fábricas simplesmente para ganhar alojamento e comida, sendo que havia uma alta jornada de trabalho em condições deploráveis. O longo tempo de trabalho gerava cansaço nas crianças, o que acabava diminuindo o ritmo das atividades. Castigos, como socos e outras agressões, eram aplicados para punir a desatenção. As crianças que chegavam atrasadas ou que conversavam durante o trabalho também eram castigadas.","No início da Revolução Industrial, os operários viviam em péssimas condições de vida e trabalho. O ambiente das fábricas era insalubre, assim como os cortiços onde muitos trabalhadores viviam. As jornadas de trabalho chegavam a 80 horas semanais. Para mulheres e crianças, submetidas ao mesmo número de horas e às mesmas condições de trabalho, os salários eram ainda mais baixos."],
    correctAnswer: 0,
    materia: "História – Idade Contemporânea (Revolução Industrial)",
    conteudo: "História – Trabalho Infantil",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Assinale a alternativa INCORRETA sobre o abolicionismo no Brasil.",
      subItens: []
    },
    options: ["Joaquim Nabuco foi uma voz contrária à escravidão, em sua principal obra, O Abolicionismo (1883), considerada a melhor peça escrita contra a escravidão no Brasil, assumiu a defesa da abolição incondicional do cativeiro, e sua argumentação se engendrou na luta política vivenciada entre 1882 e 1883, incentivada por discordâncias internas ao Partido Liberal.","Em 1711, foi publicado o livro Cultura e Opulência do Brasil, de André João Antonil. Essa obra é considerada o maior tratado abolicionista do Brasil.","Maria Firmina dos Reis, maranhense negra e filha ilegítima, enfrentou a barreira dos preconceitos e publicou, em 1859, o romance Úrsula, considerado o primeiro romance abolicionista do Brasil e um dos primeiros escritos produzidos por uma mulher brasileira.","O abolicionista Ignácio Araújo Lima lançou em São Paulo, em 1889, o jornal A Pátria, publicação feita por e para \"homens de cor\"."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Considere a parábola de equação y = ax² + bx + c, com a, b, c reais e a≠0. Sabe-se que essa parábola intersecta o eixo das ordenadas no ponto P(0,5), que o ponto Q(-2, 8) pertence à parábola e que a abscissa do vértice é X= 2. Nessas condições, a ordenada do vértice dessa parábola é dada por",
      subItens: []
    },
    options: ["y = 2,5.","y = 3.","y = 3,5.","y = 4."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["336 cm².","324 cm².","316 cm².","312 cm²."],
    correctAnswer: 0,
    materia: "Matemática – Geometria Espacial (Prismas)",
    conteudo: "Matemática – Área de Superfície",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["4 anos e meio.","5 anos e 8 meses.","5 anos e 10 meses.","Mais de 6 anos."],
    correctAnswer: null,
...
createQuestion({
    ...
    conteudo: "Química – Tabela Periódica (Calcogênios)",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Em um balão volumétrico, foram adicionados 60 mL de uma solução de $HNO_{3}$ de concentração desconhecida e 40 mL de solução de KOH 0,4 mol/L. Sabendo-se que o pH final da mistura é igual a 12, é correto afirmar que a molaridade da solução de ácido nítrico era de",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "As briófitas mais conhecidas são os musgos, que formam extensos tapetes verdes sobre rochas, troncos de árvores e barrancos. Quando habitam rochas, fazem parte de um importante processo ecológico denominado sucessão ecológica. Em relação ao papel das briófitas nesse processo, assinale a alternativa correta.",
      subItens: []
    },
    options: ["Ao habitarem as rochas, as briófitas iniciam o processo de sucessão ecológica secundária, no qual se comportam como espécies-chave no ecossistema.","A comunidade formada pelas briófitas sobre a rocha pode ser considerada uma comunidade clímax, já que a rocha não pode sofrer alterações.","As briófitas são consideradas espécies secundárias por conseguirem viver em mais de um tipo de habitat além das rochas.","O processo de sucessão que ocorre nas rochas nuas é chamado de sucessão primária e as briófitas são as plantas pioneiras nesse habitat."],
    correctAnswer: 3,
    materia: "Biologia – Botânica (Briófitas)",
    conteudo: "Biologia – Ecologia (Sucessão Ecológica)",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Grampiformes e periderme.","Adventícias e lenticelas.","Pneumotóforos e hidatódios.","Estranguladoras e estômatos."],
    correctAnswer: 1,
    materia: "Biologia – Botânica (Morfologia e Fisiologia Vegetal)",
    conteudo: "Biologia – Ecologia (Adaptações)",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Evolutivamente, o aparecimento do sistema circulatório trouxe grande vantagem para os animais, pois favoreceu o transporte de oxigênio e nutrientes para todos os tecidos, permitindo, assim, o aparecimento de animais de porte cada vez maior. Considerando o sistema circulatório nos diversos grupos animais, preencha as lacunas e assinale a alternativa correta. O sistema circulatório aparece pela primeira vez no filo _______, no qual ele é do tipo aberto em _______ e fechado em _______. Posteriormente, no filo _______, no qual ele é _______.",
      subItens: []
    },
    options: ["Nematelminthes / tramatódeos / hirudínea / Mollusca / fechado somente em cefalópodes","Platyhelminthes / turbelários / trematódeos / Annelida / aberto com presença de coração rudimentar","Mollusca / bivalves e gastrópodes / cefalópodes / Echinodermata / substituído pelo sistema ambulacral","Annelida / poliquetos / oligoquetos / Arthropoda / fechado e preenchido com hemolinfa"],
    correctAnswer: 2,
    materia: "Biologia – Zoologia (Sistemas Circulatórios)",
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Na espécie humana, as mutações denominadas cromossômicas, como a aneuploidia, são consequências de não disjunções na meiose e podem originar a",
      subItens: []
    },
    options: ["distrofia muscular de Duchenne.","hemofilia.","síndrome de Down.","adrenoleucodistrofia."],
    correctAnswer: 2,
    materia: "Biologia – Genética (Cromossomopatias, Aneuploidias, Meiose)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Ao se observar a natureza, é possível se deparar com diferentes animais capazes de voar, como diferentes insetos, pássaros e mamíferos. Esses animais possuem asas adaptadas à função de voar que têm origens embrionárias diferentes, sendo assim denominadas órgãos análogos. A adaptação evolutiva a modos de vida semelhantes leva organismos pouco aparentados a desenvolver formas corporais análogas. Esse processo é denominado",
      subItens: []
    },
    options: ["recombinação gênica.","teoria sintética da evolução.","seleção natural.","convergência evolutiva."],
    correctAnswer: 3,
    materia: "Biologia – Evolução (Órgãos Análogos, Convergência Evolutiva)",
    conteudo: "",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Sobre a Estrutura Fundiária Brasileira, assinale a alternativa correta.",
      subItens: []
    },
    options: ["As pequenas propriedades rurais são em maior número e ocupam mais da metade das terras do território brasileiro.","A maior parte dos latifúndios está situada em áreas de expansão das fronteiras agrícolas, pecuárias e de exploração mineral.","A média propriedade rural é numericamente predominante na Região Sul, nomeadamente nos Estados do Paraná e de Santa Catarina.","A Sub-região do Nordeste, o Agreste, é caracterizada pela predominância quantitativa das médias e grandes propriedades rurais."],
    correctAnswer: 1,
    materia: "Geografia – Geografia Agrária (Estrutura Fundiária)",
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: "Geografia – Meio Ambiente (Desastres Ambientais)",
    conteudo: "Geografia – Geografia Econômica (Mineração no Brasil)",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: "Geografia – Geopolítica (Conflitos Separatistas)",
    conteudo: "Geografia – Europa (Espanha)",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: "Geografia – Geografia do Brasil (Regiões Naturais)",
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: "Geografia – Meio Ambiente (Mudanças Climáticas)",
    conteudo: "Geografia – Economia Ambiental (Créditos de Carbono)",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "The text expresses the opinion of a top Brazilian judge about drugs. Mark the correct answer concerning the subject matter discussed throughout the essay.\n(Referencing the provided English text on drug legalization, starting with \"Brazil must legalise drugs - its existing policy just destroys lives\" on page 23).",
      subItens: []
    },
    options: ["The judge believes that the only way to win the war against the drug trafficking is by killing the criminals.","The judge believes that the legalization of drugs can be a way of dealing with the problem of drug trafficking.","The judge believes that the decriminalisation of drugs is not a way of dealing with the drug problem.","The judge believes that fighting drug trafficking with police and weapons is effective."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Taking into account the excerpt: \"Brazil must legalise drugs\", mark the option which best describes the word \"must\" in the aforementioned context.",
      subItens: []
    },
    options: ["\"Must” is a phrasal verb which expresses obligation and order.","\"Must” is a phrasal verb which expresses ability or politeness.","\"Must\" is a modal verb which indicates inevitability or certainty.","\"Must” is a modal verb which indicates conditionality or expectation."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Considering the excerpt \"[...] it has disrupted the daily life of the community [...]\", and the context it was taken from, mark the correct option regarding the pronoun \"it\".",
      subItens: []
    },
    options: ["\"It\" is a subject pronoun and refers back to \"Rocinha\".","\"It\" is a possessive pronoun and refers back to \"Rocinha\".","\"It\" is a personal pronoun and refers back to \"the war\".","\"It\" is an objective pronoun and refers back to \"the war\"."],
    correctAnswer: 2,
    materia: "Inglês – Gramática (Pronouns)",
    conteudo: "Inglês – Cohesion",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Consider the following excerpt: \"Since the 1970s, under the influence and leadership of the US, the world has tackled this problem with the use of police forces, armies, and armaments.\" Mark the option which best describes the use of some words in the excerpt.",
      subItens: []
    },
    options: ["There are 9 nouns, 1 adjective, and 5 articles.","There are 8 nouns and 2 verbs, but no adjectives.","There are 5 articles, 3 adjectives, and 1 verb, but no adverbs.","There are 4 prepositions, 2 conjunctions, and 1 pronoun."],
    correctAnswer: 0,
    materia: "Inglês – Gramática (Word Classes)",
    conteudo: "Inglês – Análise Sintática",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "In the excerpt \"Recently, a stray bullet killed a Spanish tourist\", the expression \"stray bullet\" is",
      subItens: []
    },
    options: ["Formed by nouns and it means \"a decisive shot\".","Formed by an adjective and a noun and it means \"a random shot\".","Formed by an adverb and a noun and it means \"a sharp shot”.","Formed by a verb and a noun and it means \"a lost shot\"."],
    correctAnswer: 1,
