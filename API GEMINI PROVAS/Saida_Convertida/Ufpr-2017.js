...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "Foi realizado um experimento para se medir a taxa de oxigênio dissolvido na água em função da presença de macrófitas\naquáticas e da taxa de insolação. Tanques contendo esses organismos foram mantidos em laboratório com condições\ncontroladas, com temperatura, pressão e pH constantes. Alguns desses organismos foram expostos a condições de\nluminosidade equivalentes às de um inverno em Manaus (AM), enquanto outros foram submetidos a condições de\nluminosidade equivalentes às de um inverno em Buenos Aires (Argentina). Assinale a alternativa em que estão\nmostrados os gráficos com o resultado do experimento:\n\n(Gráficos para Condições de insolação de Manaus e Condições de insolação de Buenos Aires. Eixo Y: O2 dissolvido (mg.L-1). Eixo X: Hora do dia (h).)\n\nAlternativa a: Manaus tem curva de O2 com pico no final do dia, Buenos Aires tem O2 mais constante e alto.\nAlternativa b: Manaus tem curva de O2 com pico ao meio dia, Buenos Aires com O2 mais constante.\nAlternativa c: Manaus tem curva de O2 com pico ao meio dia e queda noturna, Buenos Aires tem O2 com pico ao meio dia e queda noturna mais acentuada.\nAlternativa d: Manaus e Buenos Aires tem curvas de O2 invertidas em relação ao pico.\nAlternativa e: Manaus e Buenos Aires tem curvas de O2 com picos e vales diferentes.",
      subItens: []
    },
