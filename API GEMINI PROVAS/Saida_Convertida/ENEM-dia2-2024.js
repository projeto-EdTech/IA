...
createQuestion({
    ...
    options: ["3 x $1^{19}$","3 x $1^{20}$","3 x $1^{21}$","3 x $1^{20}$ - 1","3 x $1^{20}$ - 3"],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "A prefeitura de uma cidade planeja construir três postos de saúde. Esses postos devem ser construídos em locais equidistantes entre si e de forma que as distâncias desses três postos ao hospital dessa cidade sejam iguais. Foram conseguidos três locais para a construção dos postos de saúde que apresentam as características desejadas, e que distam 10 km entre si, conforme o esquema, no qual o ponto H representa o local onde está construído o hospital; os pontos $1_{1}_{}$, $1_{2}_{}$ e $1_{3}_{}$, os postos de saúde; e esses quatro pontos estão em um mesmo plano.\n[Imagem: Diagrama de três pontos $1_{1}_{}$, $1_{2}_{}$, $1_{3}_{}$ formando um triângulo equilátero, e um ponto H central, com as distâncias entre $1_{1}_{}$, $1_{2}_{}$ e $1_{3}_{}$ sendo 10 km.]\nA distância, em quilômetro, entre o hospital e cada um dos postos de saúde, é um valor entre",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "Em uma região com grande incidência de terremotos, observou-se que dois terremotos ocorridos apresentaram magnitudes $1_{1}_{}$ e $1_{2}_{}$, medidos segundo a escala Richter, e liberaram energias iguais a $1_{1}_{}$ e $1_{2}_{}$, respectivamente. Entre os estudiosos do assunto, é conhecida uma expressão algébrica relacionando esses valores dada por $1_{2}_{}$ - $1_{1}_{}$ = (2/3) log ($1_{2}_{}$/$1_{1}_{}$).\nEstudos mais abrangentes observaram que o primeiro terremoto apresentou a magnitude $1_{1}_{}$ = 6,9 e a energia liberada foi um décimo da observada no segundo terremoto.\nO valor aproximado da magnitude $1_{2}_{}$ do segundo terremoto, expresso com uma casa decimal, é igual a",
      subItens: []
    },
