...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Uma orquestra é formada por instrumentos musicais de várias categorias. Entre os instrumentos de sopro, temos a flauta, que é, essencialmente, um tubo sonoro aberto nas duas extremidades. Uma dessas flautas tem comprimento L = 34 cm. Considere que a velocidade do som no local vale Vsom = 340 $\\\\frac{m}{s}$. Levando em consideração os dados apresentados, assinale a alternativa que apresenta corretamente o valor da menor frequência (chamada de frequência fundamental) que essa flauta pode produzir.",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Um trem se desloca em movimento retilíneo uniforme numa dada seção reta de trilhos. Sabe-se que, nesse movimento, analisado num referencial inercial, a energia cinética do trem vale K = 10 MJ e a quantidade de movimento (ou momento linear) vale (em módulo) p = 1 x 10⁶ kg·$\\\\frac{m}{s}$. Com base nesses dados, assinale a alternativa que apresenta corretamente o valor do deslocamento realizado pelo trem num intervalo de 10 minutos executando esse movimento.",
      subItens: []
    },
