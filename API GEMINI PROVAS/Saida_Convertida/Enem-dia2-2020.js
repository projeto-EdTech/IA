...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Uma população (momento A) sofre isolamento em duas subpopulações (momento B) por um fator de isolamento (I). Passado um tempo, essas subpopulações apresentam características fenotípicas e genotípicas que as distinguem (momento C), representadas na figura pelas tonalidades de cor. O posterior desaparecimento do fator de isolamento I pode levar, no momento D, às situações $1_{1}_{}$ e $1_{2}_{}$.\n\nA figura mostra a evolução de uma população:\nMomento A: Uma única população homogênea.\nMomento B: A população se divide em duas subpopulações por um fator de isolamento (I).\nMomento C: As duas subpopulações se diferenciam geneticamente (indicado por cores diferentes).\nMomento D: O fator de isolamento desaparece. Duas possíveis situações resultantes:\$1_{1}$: As duas subpopulações se misturam novamente, formando uma população com gradientes de características.\$1_{2}$: As duas subpopulações permanecem separadas, agora como espécies distintas, coexistindo no mesmo espaço.\n\nA representação indica que, no momento D, na situação",
      subItens: []
    },
    options: ["$1_{1}_{}$ ocorre um novo fator de isolamento geográfico.","$1_{1}_{}$ existe uma única população distribuída em gradiente.","$1_{1}_{}$ ocorrem duas populações separadas por isolamento reprodutivo.","$1_{2}_{}$ coexistem duas populações com características fenotípicas distintas.","$1_{2}_{}$ foram preservadas as mesmas características fenotípicas da população original A."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Um processo de aeração, que consiste na introdução de ar num líquido, acontece do seguinte modo: uma bomba B retira o líquido de um tanque $1_{1}_{}$ e o faz passar pelo aerador $1_{1}_{}$, que aumenta o volume do líquido em 15%, e em seguida pelo aerador $1_{2}_{}$, ganhando novo aumento de volume de 10%. Ao final, ele fica armazenado num tanque $1_{2}_{}$, de acordo com a figura.\n\nDiagrama do processo de aeração. O líquido de $1_{1}_{}$ passa por $1_{1}_{}$ e $1_{2}_{}$ e é armazenado em $1_{2}_{}$. $1_{1}_{}$ é um prisma reto de base retangular de comprimento c e largura L. $1_{2}_{}$ é um prisma reto de base retangular de comprimento c/2 e largura 2L.\n\nPara finalizar o processo de aeração sem derramamento do líquido em $1_{2}_{}$, o responsável deve saber a relação entre a altura da coluna de líquido que já saiu de $1_{1}_{}$, denotada por x, e a altura da coluna de líquido que chegou a $1_{2}_{}$, denotada por y.\nDisponível em: www.dec.ufcg.edu.br. Acesso em: 21 abr. 2015.\n\nA equação que relaciona as medidas das alturas y e x é dada por",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Um pé de eucalipto em idade adequada para o corte rende, em média, 20 mil folhas de papel $1_{4}_{}$. A densidade superficial do papel $1_{4}_{}$, medida pela razão da massa de uma folha desse papel por sua área, é de 75 gramas por metro quadrado, e a área de uma folha de $1_{4}_{}$ é 0,062 metro quadrado.\nDisponível em: http://revistagalileu.globo.com. Acesso em: 28 fev. 2013 (adaptado).\n\nNessas condições, quantos quilogramas de papel rende, em média, um pé de eucalipto?",
      subItens: []
    },
