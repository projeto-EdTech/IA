...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "09 - Ao criar o termo mediavalesco que finaliza o texto, o autor associa a $\\\\frac{media}{m}$ídia ao termo medievalesco, ou seja, relativo à Idade Média. Sua intenção, com isso, é ressaltar um aspecto dos meios de comunicação que poderia ser resumido pelo termo:",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "26 - Segundo o Departamento de Direitos Humanos e Cidadania do governo estadual paranaense, \"ser cidadão é ter direito à vida, à liberdade, à propriedade, à igualdade perante a lei: ter direitos civis. É também participar no destino da sociedade, votar, ser votado, ter direitos políticos. Os direitos civis e políticos não asseguram a democracia sem os direitos sociais, aqueles que garantem a participação do indivíduo na riqueza coletiva: o direito à educação, ao trabalho justo, à saúde, a uma velhice tranquila\". (disponível em: <http://www.dedihc.pr.gov.$\\\\frac{br}{modules}$/$\\\\frac{conteudo}{conteudo}$.\nphp?conteudo=8>)\n\nSobre movimentos de conquista de cidadania na história contemporânea, considere as seguintes afirmativas:\n\n1. O movimento sufragista lutou pelo direito das mulheres de votarem e serem votadas em países como o Brasil e os Estados Unidos entre o final do século XIX e a primeira metade do século XX.\n2. O movimento de luta por direitos civis pelos negros norte-americanos nos anos 1960, liderado por Rosa Parks e Martin Luther King Jr., seguiu os princípios da não violência e da desobediência civil.\n3. O movimento pelo Apartheid na África do Sul inaugurou a luta por cidadania em seu sentido moderno, após a Declaração Universal dos Direitos Humanos em 1948.\n4. O movimento de luta por direitos dos LGBTT (lésbicas, gays, bissexuais, travestis e transexuais) tem obtido conquistas, como a oficialização dos casamentos e a adoção de crianças.\n\nAssinale a alternativa correta.",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "35 - Sabe-se que o objeto fotografado por uma câmera fotográfica digital tem 20 vezes o tamanho da imagem nítida formada no sensor dessa câmera. A distância focal da câmera é de 30 mm. Para a resolução desse problema, considere as seguintes equações: A = - $\\\\frac{1}{p}$ = $\\\\frac{1}{o}$ + $\\\\frac{1}{f}$ = $\\\\frac{1}{p}$'.\n\nAssinale a alternativa que apresenta a distância do objeto até a câmera.",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "36 - Foram geradas duas ondas sonoras em um determinado ambiente, com frequências f_{1} e f_{2}. Sabe-se que a frequência f_{2} era de 88 Hz. Percebeu-se que essas duas ondas estavam interferindo entre si, provocando o fenômeno acústico denominado \"batimento\", cuja frequência era de 4 Hz. Com o uso de instrumentos adequados, verificou-se que o comprimento de onda para a frequência f_{2} era maior que o comprimento de onda para a frequência f_{1}. Com base nessas informações, assinale a alternativa que apresenta a frequência f_{1}.",
      subItens: []
    },
...
createQuestion({
    ...
    options: ["dióxido de enxofre (SO2).","metano (CH4).","monóxido de carbono (CO).","nitrito (NO2).","ozônio (O3)."],
    correctAnswer: 3,
    materia: "Biologia – Ecologia",
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "74 - Leggi attentamente queste frasi:\n\n1. Un supermercato con degli sconti funzionerà all'Expo.\n2. L'Expo Milano 2015 avrà la durata di sei mesi.\n3. Nell'evento si discuteranno maniere per assicurare il cibo alle future generazioni.\n\nIn base al volantino, sono corrette:",
      subItens: []
    },
