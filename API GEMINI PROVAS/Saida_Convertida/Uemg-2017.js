...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "Uma mistura formada por água, CCl4 e sal de cozinha (NaCl) passou por dois processos físicos com o objetivo de separar todos os seus componentes.\nConsidere o fluxograma e as afirmações sobre as características dos referidos processos:\n\n[Diagrama de um fluxograma de separação de misturas: \"Mistura original\" -> \"Processo de separação I\" que resulta em \"Substância pura I\" e \"Mistura restante\"; \"Mistura restante\" -> \"Processo de separação II\" que resulta em \"Substância pura II\" e \"Substância pura III\".]\nI- O processo de separação II é uma filtração.\nII- A mistura restante é uma solução homogênea.\nIII- O processo de separação I corresponde a uma decantação.\nIV- As substâncias puras II e III correspondem a dois líquidos à temperatura ambiente.\nSão corretas apenas as afirmativas\na) I e II.\nb) I e IV.\nc) II e III.\nd) III e IV.",
      subItens: []
    },
