...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Sejam x, y ∈ (0, π/2), tais que cos(x) = 3/5 e $\\sin$(y) = 5/13. Podemos concluir que tg(x + y) é igual a:",
      subItens: []
    },
