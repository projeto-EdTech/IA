...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A seleção de futebol da França, campeã da Copa de 2018, possui mais da metade dos seus jogadores de origem africana $\\\\frac{e}{ou}$ árabe. Desde 1998, a seleção francesa é conhecida em seu país como equipe \"black-blanc-beur\" (negra, branca e árabe). Uma razão histórica do aumento da diversidade étnica, racial e religiosa na Europa, presente nos dias atuais é:",
      subItens: []
    },
...
createQuestion({
    ...
    options: ["LiF – MgO – BeF.","LiF – Mg2O – BeF.","LiF – MgO – BeF2.","Li2F – MgO – BeF2.","Li2F – Mg2O – BeF2."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "A usina de energia de Hellisheidi, na Islândia, vem testando um novo método para combater o aquecimento global: transformar o gás carbônico (CO_{2}) em pedra. O processo ocorre em duas etapas: primeiro o CO_{2} é dissolvido em água em altas pressões (25 bar) e depois injetado no solo numa temperatura de 230 °C. A mineralização do gás carbônico ocorre de maneira rápida, devido à reatividade e composição do solo da região, rica em ferro, cálcio e magnésio. As duas etapas da remoção de CO_{2} estão esquematizadas de maneira simplificada ao lado.\nEsquema de reações:\nCO_{2} (g) + H_{2}O (l) (25 bar) → CO_{3}(aq) + 2 H+ (aq)\nCO_{3}(aq) + Ca_{2}+ (aq) (230 °C) → CaCO_{3} (s)\nFonte: 1. <https://www.bbc.$\\\\frac{com}{portuguese}$>. Acessado em 23 de maio 2018. Adaptado. 2. Mater, J. M. et alii, Rapid carbon mineralization for permanent disposal of anthropogenic carbon dioxide emissions. Science, Vol. 352, Issue 6291, pp. 1312-1314.\nA remoção desse gás da atmosfera ocorre por:",
      subItens: []
    },
    options: ["formação de composto iônico.","reação de oxidorredução.","ligação covalente com a rocha.","alteração do estado de agregação.","adsorção de CO2 numa matriz porosa."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Giovana deseja fazer um painel usando folhas de papel de tamanhos carta e A_{4}. O painel será composto por duas faixas, cada uma contendo apenas folhas inteiras de um tipo dispostas lado a lado (sem sobreposição e sem espaço entre elas), formando uma figura retangular, sem sobras e sem cortes de papel. As folhas do tipo carta (1) serão dispostas na posição vertical, e as folhas do tipo A_{4} (2) serão dispostas na posição horizontal, conforme ilustra a figura abaixo:\nDiagrama: Duas faixas. Faixa superior mostra folhas \"Carta\" (1) na vertical, em sequência. Faixa inferior mostra folhas \"A_{4}\" (2) na horizontal, em sequência. Ambos os tipos de folhas se repetem indefinidamente.\nSabendo que as folhas A_{4} têm tamanho 210 mm por 297 mm e que as folhas carta têm tamanho 216 mm por 279 mm, a menor quantidade total de folhas de papel (incluindo A_{4} e carta) que Giovanna precisa usar para conseguir atender às exigências do enunciado é:",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Um tanque contém uma solução de água e sal cuja concentração está diminuindo devido à adição de mais água. Suponha que a concentração Q(t) de sal no tanque, em gramas por litro ($\\\\frac{g}{l}$), decorridas t horas após o início da diluição, seja dada por\nQ(t) = 100 × 5⁻⁰,³ᵗ\nAssinale a alternativa que mais se aproxima do tempo necessário para que a concentração de sal diminua para 50 $\\\\frac{g}{l}$.\n(Use log 5 = 0,7)",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Sejam x, y ∈ (0, π/2), tais que cos(x) = $\\\\frac{3}{5}$ e sen(y) = $\\\\frac{5}{13}$. Podemos concluir que tg(x + y) é igual a:",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Leia o excerto abaixo:\nAs bombas que os aliados lançaram sobre a Alemanha durante a Segunda Guerra Mundial conseguiram atingir a borda inferior do espaço: a ionosfera se enfraqueceu sob a influência da onda expansiva de tantos explosivos. _______ o efeito tenha sido temporário, chegou a ser sentido nos céus da Inglaterra. _______ os bombardeios alemães, primeiro os da Luftwaffe (a aviação nazista) e, depois, com os foguetes V_{1} e V_{2}, mal deixaram vestígios na atmosfera.\nAssinale a alternativa que preenche corretamente as lacunas acima, na ordem em que aparecem no texto.",
      subItens: []
    },
...
createQuestion({
    ...
    options: ["v2 = 4v1.","v2 = 2v1.","v2 = v1.","v2 = v1/2.","v2 = v1/4."],
    correctAnswer: 3,
