...
createQuestion({
    ...
    year: 2015,
    text: {
      principal: "10 - Um veículo está se movendo ao longo de uma estrada plana e retilínea. Sua velocidade em função do tempo, para um trecho do percurso, foi registrada e está mostrada no gráfico ao lado. Considerando que em t = 0 a posição do veículo s é igual a zero, assinale a alternativa correta para a sua posição ao final dos 45 s.\n\n[IMAGEM: Gráfico de velocidade (V, em $\\\\frac{m}{s}$) em função do tempo (t, em s). A velocidade começa em 0, sobe para 36 $\\\\frac{m}{s}$ em t=5s, mantém 36 $\\\\frac{m}{s}$ até t=10s, desce para -10 $\\\\frac{m}{s}$ em t=15s, mantém -10 $\\\\frac{m}{s}$ até t=20s, sobe para 8 $\\\\frac{m}{s}$ em t=25s, mantém 8 $\\\\frac{m}{s}$ até t=30s, desce para 0 $\\\\frac{m}{s}$ em t=35s, mantém 0 $\\\\frac{m}{s}$ até t=40s, e sobe para 36 $\\\\frac{m}{s}$ em t=45s.]",
      subItens: []
    },
...
createQuestion({
    ...
    year: 2015,
    text: {
      principal: "61- Num laboratório, sensores são colocados no topo de dois pistões para analisar o desempenho de um motor. A profundidade do primeiro pistão no bloco do motor pode ser descrita, de maneira aproximada, pela expressão H₁ = 12 cos(2π$\\\\frac{t}{60}$), e a profundidade do segundo, pela expressão H₂ = 12 sen(2π$\\\\frac{t}{60}$), sendo t o tempo medido em milissegundos a partir do acionamento do motor. Quanto tempo levará para que os pistões estejam na mesma profundidade, pela primeira vez, após o acionamento do motor?",
      subItens: []
    },
