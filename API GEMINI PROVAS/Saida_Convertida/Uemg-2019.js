...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Em relação à composição estrutural $\\\\frac{e}{ou}$ aos elementos linguísticos do",
      subItens: [{"titulo":"Texto 1","conteudo":", assinale a alternativa CORRETA:"}]
    },
    options: [" a expressão destacada pertence à classe dos advérbios e serve para sinalizar a relação semântica de oposição existente entre as ideias contidas nos enunciados que une.","Em \"Um alento e tanto se você pensar que essa estrutura costuma ser menor entre os sujeitos deprimidos\", a expressão em destaque é usada como um termo substituto que retoma a referência feita pelo nome \"cérebro\" empregado no período anterior.","No texto, as falas de autoridades no assunto tratado, o papel da atividade física na prevenção e no controle da depressão, são apresentadas por meio do discurso direto, marcado pelo uso de aspas e de verbos de elocução.","Uma característica do estilo predominantemente informal no texto é o uso de frases nominais, de períodos interrompidos e de expressões coloquiais, como “montão de gente\", \"um alento e tanto\" ou \"anda pra baixo\", por exemplo."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Elementos Linguísticos",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Leia o cartum a seguir:\n\nVIOLÊNCIA CRESCE NO INTERIOR DO PAÍS\nVAI PASSANDO\nA CARTEIRA,\nCAIPIRA!\nNUM FALEI\nPROCÊ QUE UM\nDIA O PROGRESSO\nCHEGAVA AQUI,\nMUIE?\nSANDRO\nDisponível em: https://www.google.com.$\\\\frac{br}{search}$?q=cartum&.\nAcesso: 11 dez. 2018.\n\nSobre o cartum, assinale a alternativa CORRETA.",
      subItens: []
    },
    options: ["A construção perifrástica “Vai passando\" é formada pelo verbo auxiliar \"ir\" seguido do verbo principal “passar” no gerúndio, e o valor veiculado por ela é de possibilidade ou probabilidade.","A fala do assaltado contribui para a sua identificação como habitante do interior do país, por apresentar formas de expressão usuais em regiões menos urbanizadas.","A fala do assaltante se distancia da fala do assaltado pelo fato de trazer formas de expressão reservadas a ocasiões determinadas, em que os falantes incluem pessoas de outras comunidades linguísticas para sua comunicação.","As diferenças linguísticas exemplificadas no cartum tanto ocorrem em função da idade dos personagens quanto acontecem devido à influência do grupo social a que pertencem."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Variação Linguística",
    conteudo: "Língua Portuguesa – Interpretação de Cartum",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Em relação ao emprego dos sinais de pontuação na construção do",
      subItens: [{"titulo":"Texto 2","conteudo":", assinale a alternativa CORRETA:"}]
    },
    options: ["Em [...] “no Pinterest (rede social de compartilhamento de fotos)”, o uso dos parênteses se deve à necessidade do texto de separar o trecho que indica uma interrupção do pensamento da autora da pesquisa realizada.","Em \"Artigo publicado no periódico inglês Future Science AO examina se as postagens em uma mídia social são modismo ou se há evidência científica quando o assunto é o câncer associado a alimentos funcionais\", não há vírgulas separando orações porque o período é composto por coordenação.","Em \"Claudia informa que existem cerca de 50 bilhões de pins sobre comida no Pinterest, e que o objetivo principal era investigar a relação entre postagens sobre comida e câncer no Pinterest e as evidências científicas\", o uso da vírgula é facultativo já que as orações subordinadas coordenadas entre si se ligam pela conjunção \"e\".","Em “Os Pins são ideias que as pessoas encontram e salvam de toda a Web', esclarece a pesquisadora\", o uso da vírgula é obrigatório, uma vez que ela precede uma oração apositiva."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "LITERATURA BRASILEIRA\nINSTRUÇÃO: As questões 7 e 8 referem-se à obra “A barca dos amantes\" de Antônio Barreto.\n\nO livro de Antônio Barreto, “A barca dos amantes\", compreende quatro partes: 1) O homem que trazia o mar, 2) Livro das figurações, 3) Os deuses disfarçados e 4) Mar de mármore, nas quais",
      subItens: []
    },
    options: ["É narrada a história de amor, que culmina em um final feliz, entre o poeta Tomás Antônio Gonzaga e, sua eterna musa, Maria Dorotéia Joaquina de Seixas.","Há citações de trechos de poesia árcade de incógnita autoria, ao longo de uma recriação ficcional que remonta o ciclo do Ouro no final do século XVIII.","É construída uma \"colcha de retalhos romanceada\", envolvendo personagens literárias e históricas que viveram o período da insurreição mineira.","Há remissão a fatos da história colonial barroca em um romance sobre a vida na capital do Império em que nobres desejavam ter experiências marítimas."],
    correctAnswer: 2,
    materia: "Literatura Brasileira – Obras Literárias",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "NÃO há na composição da obra “A barca dos amantes\":",
      subItens: []
    },
    options: ["Referência a uma lenda nórdica, ingrediente mítico que evidencia o caráter intertextual literário do romance.","Notas e bibliografia consultadas que remetem a fontes de pesquisa e de confirmação de informações presentes na narrativa.","Bases históricas sobre a Inconfidência e sobre Tomás Antônio Gonzaga que favorecem a verossimilhança do enredo.","Registro do lamento de pessoas que perderam entes queridos em naufrágios, denominadas pelo autor de \"órfãos do mar\"."],
    correctAnswer: 3,
    materia: "Literatura Brasileira – Obras Literárias",
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Leia este poema.\n\nDIALÉTICA\nÉ claro que a vida é boa\nE a alegria, a única indizível emoção\nÉ claro que te acho linda\nEm ti bendigo o amor das coisas simples\nÉ claro que te amo\nE tenho tudo para ser feliz\nMas acontece que eu sou triste...\nMORAES, Vinícius. Disponível em:\nhttp://www.viniciusdemoraes.com.$\\\\frac{br}{pt}$-$\\\\frac{br}{poesia}$/poesias-$\\\\frac{avulsas}{dialetica}$. Acesso: 11 dez. 2018.\n\nEm relação a esse texto, escrito pelo poeta e compositor Vinícius de Moraes, é CORRETO afirmar que:",
      subItens: []
    },
    options: ["O eu-lírico emprega, no primeiro verso, a palavra \"claro” que, nesse contexto, expressa a ideia de incerteza.","O elemento linguístico que confirma que a vida é realmente boa está presente no terceiro verso do poema.","A repetição em três versos, na sequência da estrutura do poema, reforça a ideia apresentada no sexto verso.","As expectativas são confirmadas, no último verso, pois o eu-lírico revela uma tristeza que ele consegue superar."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "O enredo do romance “Triste fim de Policarpo Quaresma\" gira em torno do personagem-título, funcionário público que:",
      subItens: []
    },
    options: ["É avesso à xenofobia e vive em um mundo bem ajustado com a realidade que o circunda.","Dedica amor intenso ao Brasil, sendo ridicularizado por seu idealismo e ufanismo exacerbado.","Não se identifica com as causas indígenas, desprezando as raízes históricas nacionais.","Visita a ilha das cobras para redigir um protesto em defesa de soldados presos injustamente."],
    correctAnswer: 1,
    materia: "Literatura Brasileira – Pré-Modernismo",
    conteudo: "Literatura Brasileira – Personagens Literários",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Gênero literário é a categoria à qual pertence uma obra com base em suas características predominantes que possibilitam o agrupamento por semelhanças.\n\nConsiderando a classificação dos gêneros literários, assinale V para as afirmativas verdadeiras e F para as falsas.\n\n() Gênero lírico caracteriza-se pela manifestação do eu-interior do poeta e pela exposição de sua subjetividade de sentimentos e emoções vivenciados em seu mundo íntimo.\n\n() Gênero dramático caracteriza-se pela narração (em versos) de grandes feitos históricos em textos em que a presença de um herói representa a força do coletivo.\n\n() Gênero épico caracteriza-se por textos escritos para serem encenados em que o autor utiliza o discurso direto e dá voz a seus personagens sem a intermediação de um narrador.\n\nAssinale a alternativa que apresenta a sequência CORRETA:",
      subItens: []
    },
    options: ["VVV.","VFF.","FVV.","FFF."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "FÍSICA\nQUESTÃO 13\nApós estudar física exaustivamente para as provas de vestibular, Lívia sentiu-se mal e precisou receber a visita de um médico.\n\nEU VEJO\nMOVIMENTOS\nCIRCULARES.\nCOM QUE\nFREQUÊNCIA?\nω/2π\nHTTP://WWW.EFEITOJOULE.COM/\nDisponível: https://www.efeitojoule.$\\\\frac{com}{2011}$/$\\\\frac{04}{vestibulario}$-tirinhas-do-vestibular-de.html\nAcesso: 11 dez. 2018.\n\nCom base nas informações do diálogo apresentado e considerando uma roda que gire em torno do seu próprio eixo com velocidade angular (w) constante, o período de rotação dessa roda é dado por:",
      subItens: []
    },
    options: ["2. (ω.π)-1","2.π.ω-1.","ω.2.π","ω.(2.π)-1"],
    correctAnswer: 1,
    materia: "Física – Movimento Circular Uniforme",
    conteudo: "Física – Período e Frequência",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["R$ 0,47.","R$ 0,75.","R$ 0,88.","R$ 1,25."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "QUESTÃO 21\nObserve a imagem a seguir:\n\nHere's the roomy G-E Refrigerator my family won't outgrow\nDisponível em:\nhttps://www.flickr.$\\\\frac{com}{photos}$/25152449@$\\\\frac{N_{06}}{3007836828}$.\nAcesso: 11 dez. 2018.\n\nA imagem faz parte de um anúncio publicitário de refrigerador, publicado na revista feminina estadunidense McCall's no ano de 1952, que buscava evidenciar que, EXCETO:",
      subItens: []
    },
    options: ["A economia dos Estados Unidos sinalizava um pequeno crescimento durante a Segunda Guerra Mundial e, de forma não tão arrojada, continuaria a crescer nas décadas seguintes.","A fartura de alimentos, a geladeira cheia de produtos e a atmosfera de alegria denotavam a satisfação causada pela compra do refrigerador, padrão novo que podia ser desfrutado pelos trabalhadores daquele país à época.","Os bens, que antes eram restritos a uma pequena parcela da população estadunidense, passaram a ser acessíveis à maioria das pessoas daquele país.","A representação sugeria um ideal de felicidade baseado no consumismo e na posse de bens como prova de sucesso social e econômico, que foi disseminado na sociedade do Estados Unidos e de seus parceiros econômicos, incluindo o Brasil."],
    correctAnswer: 0,
    materia: "História – Pós-Segunda Guerra Mundial",
    conteudo: "História – Sociedade de Consumo",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Os anos da Guerra Fria, sucessores aos da criação da ONU, por dividirem o mundo em dois polos de influência distintos, limitaram o papel da organização no campo de segurança internacional.","A ação da ONU, devido à influência da Guerra Fria, se restringiu a intervenções de paz apenas quando estas não colidiam com os interesses das grandes potências que a manipulavam, assistindo passivamente, devido aos vetos do Conselho de Segurança, a conflitos que resultaram em milhares de mortos.","A primeira e maior missão de observação da ONU, que pedia um cessar-fogo em 1948, ocorreu na região da Coreia do Sul e da Coreia do Norte.","O Conselho de Segurança da ONU é atualmente composto por cinco membros permanentes e dez membros eleitos de dois em dois anos. Os membros permanentes são: Estados Unidos, Rússia, Inglaterra, França e China."],
    correctAnswer: 2,
...
createQuestion({
    ...
    options: ["53412.","3 2 1 4 5.","4 15 2 3.","2 4 3 5 1."],
    correctAnswer: 0,
    materia: "História – República Oligárquica",
    conteudo: "História – Presidentes do Brasil",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Sebastião José de Carvalho e Melo, vulgo Marquês de Pombal, pertencente à pequena nobreza portuguesa, homem que mudou o destino de Portugal e que foi preso conforme disposto no fragmento.","Maria Francisca Isabel Josefa Antónia Gertrudes Rita Joana, vulgo D. Maria I a louca, primeira mulher a assumir o trono Português.","D. José I, rei de Portugal, que teve um reinado glorioso, graças aos esforços, à iniciativa enérgica e à notável persistência de Sebastião José de Carvalho na administração de que se encarregara.","Marquês de Pombal que muito conseguiu com sua administração enérgica, a despeito dos inimigos, da nobreza e da poderosa Companhia de Jesus que, por meio de muitas intrigas, tentavam acabar com seu prestígio junto ao rei."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "QUESTÃO 27\nEm um novo projeto de iniciação científica, o estudante de designer João está fabricando uma peça para exposição, na qual ele utiliza uma placa quadrada de um metal cuja densidade é de $\\\\frac{9000Kg}{m}$³, com 5000mm de lado. Sabe-se que essa chapa tem a espessura de 2,5cm e que inicialmente o profissional recorta um círculo de diâmetro máximo. Em seguida, ele recorta desse círculo um quadrado de dimensão máxima.\n\nA massa em toneladas desse quadrado recortado é de aproximadamente:",
      subItens: []
    },
    options: ["2,66ton.","2,71ton.","2,76ton.","2,81ton."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "QUESTÃO 28\nO preço do litro de determinado produto de limpeza é igual a R$ 0,32. Se um reservatório industrial tem a forma de um paralelepipedo retângulo reto, medindo internamente 1,2dam × 125cm × 0,08hm, então o preço que se pagará para encher esse reservatório com o referido produto de limpeza será igual a:",
      subItens: []
    },
    options: ["R$32.450,00.","R$35.400,00.","R$38.400,00.","R$40.450,00."],
    correctAnswer: 2,
...
createQuestion({
    ...
    conteudo: "Matemática – Aumentos e Descontos",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "QUÍMICA\nQUESTÃO 31\nObserve o aparelho esquematizado a seguir:\n\nGerador\nLâmpada\n\nAssinale a alternativa que indica CORRETAMENTE a substância que, quando adicionada em quantidade adequada à água, poderia provocar um brilho muito intenso na lâmpada.",
      subItens: []
    },
    options: ["AgCl.","CaSO4","NaNO3","FeS."],
    correctAnswer: 2,
    materia: "Química – Eletroquímica",
    conteudo: "Química – Eletrólitos",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "QUESTÃO 32\nVinagre é uma mistura homogênea cujo principal constituinte é o ácido acético. Um estudante de química analisou uma amostra de uma garrafa de 500mL de vinagre de maçã, em que, no rótulo, há a informação de que o teor do ácido acético presente na solução é de 4,2% $\\\\frac{m}{v}$.\n\nConsiderando que o ácido acético é o único composto de caráter ácido do vinagre, analise as proposições sugeridas pelo estudante após as análises.\n\nI- A molaridade do ácido acético na amostra analisada é 0,$\\\\frac{7mol}{L}$.\nII- Ao titular 20mL desse vinagre com hidróxido de sódio $\\\\frac{1mol}{L}$, foram gastos 50mL da base.\nIII- Uma cozinheira que utiliza 6,3g de vinagre por dia, durante 30 dias, irá utilizar 9 garrafas.\n\nEstá(ão) CORRETA(S) a(s) afirmativa(s):",
      subItens: []
    },
    options: ["I apenas.","I e II apenas.","II e III apenas.","I e III apenas."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["A reação de oxidação da hidroxila do linalol com KMnO4 em meio ácido produzirá cetona.","Um teste apropriado para diferenciar o citronelal e o anetol é o reagente de Tollens.","Um teste apropriado para diferenciar o eugenol e o anetol é o teste da solução de bromo (Br2/CH4).","A reação de oxidação da hidroxila do eugenol com KMnO4 em meio ácido produzirá cetona."],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: ["O suco de limão com manjericão é 2 vezes mais ácido que o suco de tomate.","A concentração de OH - nos dois sucos é igual a zero.","No suco de tomate a [H+]/[ OH-] = 1.","A concentração de H⁺ no suco de limão com manjericão é igual a 5 X 10-3 mol/L."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["C5H7N","C3H3N","C10H14N2","C6H8N"],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["A fluoxetina não possui atividade óptica.","As funções orgânicas presentes no sildenafil são amina, amida, éter e tiol.","A fórmula molecular da fluoxetina é C17H18F3NO.","A fórmula molecular do sildenafil é C22H28N6O4S."],
    correctAnswer: 2,
    materia: "Química – Química Orgânica",
    conteudo: "Química – Funções Orgânicas",
    imageNames: []
...
createQuestion({
    ...
    options: ["1/32.","9/32.","9/16.","1/16."],
    correctAnswer: 1,
    materia: "Biologia – Genética",
    conteudo: "Biologia – Leis de Mendel",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "QUESTÃO 38\nO sistema urinário humano ou aparelho urinário é encarregado pela preservação da homeostasia corpórea. Esse controle se dá através da identificação da condição do organismo: se, por exemplo, há uma queda ou um aumento da pressão sanguínea, o Sistema Nervoso Central (SNC) ativa mecanismos renais que trabalharão com a finalidade de normalizá-la. Os órgãos que compõem o sistema urinário são os rins e as vias urinárias. As vias urinárias compreendem a uretra, a bexiga e o ureter.\n\nSobre o sistema urinário humano, é INCORRETO afirmar que:",
      subItens: []
    },
    options: ["Os ureteres são dois tubos de aproximadamente 20cm de comprimento cada, que conduzem a urina dos rins para a bexiga.","A uretra é o canal que conduz a urina do interior da bexiga para fora do corpo. Ela termina no pênis ou na vulva.","A bexiga urinária recebe e armazena temporariamente a urina com uma quantidade que pode variar de 400ml até 500ml.","Os rins funcionam como um filtro que retém as impurezas do sangue venoso e o deixa em condições de circular pelo organismo."],
    correctAnswer: 3,
    materia: "Biologia – Anatomia Humana",
    conteudo: "Biologia – Sistema Urinário",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Xilema.","Floema.","Colênquima.","Meristema."],
    correctAnswer: 0,
    materia: "Biologia – Botânica",
    conteudo: "Biologia – Tecidos Vegetais",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["I, II, III e IV.","I e II apenas.","I, II e III apenas.","I, II e IV apenas."],
    correctAnswer: 2,
...
createQuestion({
    ...
    options: ["Planície Abissal.","Fossa Oceânica.","Talude Continental.","Plataforma Continental."],
    correctAnswer: 3,
    materia: "Geografia – Geomorfologia",
    conteudo: "Geografia – Relevo Submarino",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["FVFV.","VFVF.","VVFV.","VFFF."],
    correctAnswer: 1,
    materia: "Geografia – Geologia",
    conteudo: "Geografia – Eras Geológicas",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "QUESTÃO 45\nSão acontecimentos do período entre guerras e oriundos da Segunda Guerra Mundial, EXCETO:\n\nA) No período entre guerras ocorreu, na Itália, a ascensão do fascismo que foi marcado por um nacionalismo exacerbado, uma política de controle sindical e uma perseguição à imprensa.\n\nB) No decorrer da Segunda Guerra Mundial, o Japão, que tinha a intenção de ampliar seu poder na Ásia, formou um bloco com França e Inglaterra, denominado bloco dos Aliados.\n\nC) Durante a década de 1920, a Alemanha teve uma crise econômica de grandes proporções, que resultou na diminuição da arrecadação do Estado e no aumento do desemprego.\n\nD) Os alemães invadiram o território francês em 1940, forçando os franceses a assinarem um armistício que foi extremamente desastroso para a França.",
      subItens: []
    },
    options: ["No período entre guerras ocorreu, na Itália, a ascensão do fascismo que foi marcado por um nacionalismo exacerbado, uma política de controle sindical e uma perseguição à imprensa.","No decorrer da Segunda Guerra Mundial, o Japão, que tinha a intenção de ampliar seu poder na Ásia, formou um bloco com França e Inglaterra, denominado bloco dos Aliados.","Durante a década de 1920, a Alemanha teve uma crise econômica de grandes proporções, que resultou na diminuição da arrecadação do Estado e no aumento do desemprego.","Os alemães invadiram o território francês em 1940, forçando os franceses a assinarem um armistício que foi extremamente desastroso para a França."],
    correctAnswer: 1,
    materia: "História – Período Entre Guerras",
...
createQuestion({
    ...
    options: ["Biogás.","Eólica.","Solar.","Nuclear."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["Chibata.","Armada.","Cabanagem.","Vacina."],
    correctAnswer: 1,
    materia: "História – Primeira República",
    conteudo: "História – Revolta da Armada",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "QUESTION 53\nThe correct reported speech form for the sentence \"Most of the laboratories there were lost, too, and the research of several professors. I'm not sure you can say the impact of what was lost”, said by Dimila Mothé, is:\nA) Dimila Mothé said that most of the laboratories there were lost, too, and the research of several professors and she is not sure one can say the impact of what was lost.\nB) Dimila Mothé said that most of the laboratories there had been lost, too, and the research of several professors and she was not sure one could say the impact of what had been lost.\nC) Dimila Mothé said that most of the laboratories there were lost, too, and the research of several professors and she was not sure one could say the impact of what was lost.\nD) Dimila Mothé said that most of the laboratories there are lost, too, and the research of several professors and she was not sure one can say the impact of what was lost.",
      subItens: []
    },
    options: ["Dimila Mothé said that most of the laboratories there were lost, too, and the research of several professors and she is not sure one can say the impact of what was lost.","Dimila Mothé said that most of the laboratories there had been lost, too, and the research of several professors and she was not sure one could say the impact of what had been lost.","Dimila Mothé said that most of the laboratories there were lost, too, and the research of several professors and she was not sure one could say the impact of what was lost.","Dimila Mothé said that most of the laboratories there are lost, too, and the research of several professors and she was not sure one can say the impact of what was lost."],
    correctAnswer: 1,
    materia: "Inglês – Gramática",
