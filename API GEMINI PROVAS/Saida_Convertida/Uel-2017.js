...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "Com a finalidade de se calcular a quantidade de pessoas presentes em manifestações sociais em determinado trecho urbano, são utilizadas diferentes metodologias, sendo que uma delas consiste em quatro etapas:\$1_{1}$. estabelece-se a área A (em m²) da região delimitada pelo trecho da manifestação;\$1_{2}$. posicionam-se alguns fiscais que ficam responsáveis, cada um, por uma sub-região fixa e exclusiva do trecho urbano, a fim de coletar, de maneira simultânea e periódica, quantas pessoas se encontram em sua sub-região no momento de cada medição;\$1_{3}$. calcula-se a média M de todas as medições realizadas por todos os fiscais;\$1_{4}$. ao final, declara-se que há A ⋅ M pessoas presentes na manifestação.\nSuponha que uma manifestação ocorreu na região hachurada dada pelo setor de uma coroa circular de centro O (conforme figura) e que foi observada por 3 medições com 2 fiscais cada, cujas tabelas dos dados coletados encontram-se a seguir.\n[Figura de um setor de coroa circular]\nMedição 1 | Medição 2 | Medição 3\nFiscal 1  | 3         | 4\nFiscal 2  | 3         | 5\nConsiderando essa metodologia e a aproximação π ≈ 22/7, assinale a alternativa que apresenta, corretamente, a quantidade de pessoas que estiveram presentes na manifestação, naquele trecho.",
      subItens: []
    },
