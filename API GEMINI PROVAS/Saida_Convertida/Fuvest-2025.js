createQuestion({
    ...
    text: {
      principal: "",
      subItens: [{"titulo":"Texto 1","conteudo":"\"Afinal, depois de ver todas as coisas daquele museu, acabei me perguntando se os brancos já não teriam começado a adquirir também tantas de nossas coisas só porque nós, Yanomami, já estamos começando também a desaparecer. Por que ficam nos pedindo nossos cestos, nossos arcos e nossos adornos de penas, enquanto garimpeiros e fazendeiros invadem nossa terra?\"\nKOPENAWA, Davi; ALBERT, Bruce. Queda do céu: palavras de um xamã yanomami. São Paulo: Companhia das Letras, 2015. p.429."},{"titulo":"Texto 2","conteudo":"\"Em seu trabalho, Glicéria debruça-se sobre a artesania do manto tupinambá, símbolo das tradições ancestrais de seu povo. A artista chama de cosmo-técnica a feitura do manto, e hoje busca compreender qual era sua função cultural e social em sua comunidade. Recentemente, a artista esteve na Europa e encontrou mantos datados do século XVII, que foram levados do Brasil ao longo da colonização, na Dinamarca. Segundo Glicéria, 'hoje, as pessoas entendem o manto como arte, arte contemporânea, mas eu vejo muito além. É um ancestral nosso'.\"\nInstituto Pipa. Ocupação dos artistas premiados do Pipa 2023: Glicéria Tupinambá. Disponível em: https://www.premiopipa.com/2023/10/ (Adaptado).\nA reflexão de Davi Kopenawa sobre a apropriação de objetos indígenas por museus e a pesquisa de Glicéria Tupinambá sobre o manto tupinambá em contextos europeus permitem explorar diversas dimensões da arte indígena.\nCom base nos textos e na imagem, assinale a alternativa que relaciona corretamente as reflexões apresentadas à importância da arte e dos artefatos culturais na discussão sobre questões indígenas no Brasil."}]
    },
    options: ["A arte indígena, ao ser exposta em museus europeus, perde seu significado original e se transforma apenas em objeto de decoração, desvinculando-se completamente de suas raízes culturais e simbólicas, de acordo com David Kopenawa.","Glicéria Tupinambá, ao retomar elementos tradicionais em suas obras, busca uma representação autêntica que resiste à domesticação cultural imposta pelos colonizadores, valorizando o aspecto utilitário desses objetos.","O trabalho de Glicéria Tupinambá, ao redescobrir os mantos tupinambá na Europa, revela como a arte indígena pode servir como uma ponte para o entendimento e a valorização das culturas indígenas por sociedades que historicamente as marginalizaram.","Para David Kopenawa, a guarda de artefatos indígenas em museus da Europa é uma forma eficaz de preservação e valorização da cultura indígena, pois demonstra reconhecimento da sua importância e esforço, por parte da sociedade, para proteger os direitos territoriais desses povos.","A arte, como mostrado por Glicéria Tupinambá, atua como um meio de resistência cultural, em que elementos tradicionais são recontextualizados para contestar narrativas coloniais e reafirmar identidades indígenas em face de processos de desapropriação e desaparecimento."],
    correctAnswer: 4,
    materia: "Arte – Arte Indígena",
...
createQuestion({
    ...
    options: ["Os territórios indígenas encontram-se nas áreas mais desmatadas da Amazônia; como o garimpo ilegal produz forte impacto ambiental pelo intenso uso da água em seus processos, tal atividade colabora com a desertificação do bioma.","O garimpo ilegal representa alto risco a populações humanas e animais em geral, pela contaminação das águas e dos alimentos por substâncias usadas na garimpagem e porque tal atividade ocorre em áreas ainda muito preservadas, aumentando o impacto ambiental.","O garimpo ilegal na Amazônia não produz tanto impacto para os corpos d'água, uma vez que as atividades encontram-se distantes do rio Amazonas e de seus afluentes, os maiores rios da região; seu maior impacto ocorre devido ao desmatamento de extensas áreas de floresta nativa.","A proximidade dos corpos d'água deve-se a questões estratégicas, e não ao garimpo ilegal propriamente, pois este é de baixo impacto; porém traz conflitos territoriais com as comunidades indígenas, e os rios constituem rotas de fuga rápidas e eficientes para os garimpeiros.","A relação entre garimpos e corpos d'água ocorre de forma indireta, pois o garimpo amazônico não depende da água em seus processos; os garimpeiros buscam esses territórios porque as populações indígenas sabem onde existe ouro e se desenvolvem próximas a rios e lagos."],
    correctAnswer: 1,
    materia: "Geografia – Impactos Socioambientais",
    conteudo: "Geografia – Questões Indígenas no Brasil",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Há uma incoerência entre a imagem do segundo quadro e o enunciado verbal do primeiro quadro, uma vez que a posposição do adjunto adverbial \"na água\" anula qualquer ambiguidade.","Ao antecipar o objeto direto “o mercúrio\" para o começo da oração, o chargista chama a atenção para esse elemento, estimulando o leitor a buscá-lo visualmente no segundo quadro.","Por meio da escolha do verbo \"descartar\", mostra-se, de forma crítica, a necessidade da criação de um local correto para o depósito dos rejeitos provenientes do garimpo ilegal.","O uso da forma pronominal informal \"a gente\", em detrimento do pronome \"nós\", empregado em situações mais formais e sérias, atenua o teor crítico, o que colabora para gerar efeito humorístico.","O significado negativo do prefixo que aparece na palavra \"ilegal\" reforça a precariedade do atendimento à saúde nas comunidades indígenas."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Análise de Charge",
...
createQuestion({
    ...
    options: ["pela construção de caminhos que os afastassem dos cursos dos rios.","pela desconsideração das rotas de deslocamento abertas pelos animais.","pela utilização de picadas abertas pelas comunidades indígenas.","pelo emprego de tropas de muares, responsáveis por abrir trilhas nas matas.","pela exploração do transporte fluvial e marítimo por meio de pirogas."],
    correctAnswer: 2,
    materia: "História – Brasil Colonial",
    conteudo: "História – Ocupação Territorial",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["O uso dos contrastes claro x escuro na novela gráfica confere ênfase visual ao conflito entre diferentes formas de privilégio e marginalização presentes no romance de Hatoum, explicitadas pelo ponto de vista do narrador.","Ao trabalhar com os contrastes claro x escuro em suas imagens, a novela gráfica enfatiza a diferença étnica e social que fundamenta a rivalidade fraterna entre Yaqub e Omar, um dos eixos estruturais do romance.","Ao utilizar procedimentos como a aproximação (zoom-in) e a fragmentação das imagens, a novela gráfica recria o fluxo de consciência e a atmosfera onírica da narrativa de Hatoum.","A novela gráfica demonstra, por meio de imagens, que o romance Dois irmãos reinventa a tradição da literatura regionalista do Brasil, retratando a opulência da cidade de Manaus ao longo do século XX.","Por meio de recursos estéticos como a fragmentação das imagens, a novela gráfica recupera o ponto de vista fraturado do romance de Hatoum, composto por vários narradores ao longo da história."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Adaptação Literária",
    conteudo: "Arte – Quadrinhos e Graphic Novels",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Torcedores de diversos times de futebol se reúnem desanimados para assistir a um jogo da seleção.","Religiosos conservadores sugerem banir livros eróticos doados por desconhecidos para a sua comunidade.","Com medo da violência, um homem passa a andar armado na rua e assusta os transeuntes.","Um homem acusa uma mulher de racismo e algumas testemunhas confirmam a versão dele para a polícia.","Um trabalhador denuncia ao chefe um colega por assédio moral, mas esse último não é punido."],
    correctAnswer: 2,
    materia: "Filosofia – Fenomenologia",
...
createQuestion({
    ...
    options: ["Ataque à pessoa.","Apelo à piedade.","Apelo à força.","Ambiguidade.","Apelo à ignorância."],
    correctAnswer: 2,
    materia: "Filosofia – Lógica",
    conteudo: "Filosofia – Falácias",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["reforçar a separação entre consumidor e produtor, resultante da ampliação da comunicação unilateral na internet.","apostar na passividade do público, que precisa de um mediador para poder comunicar informações ativamente.","gerar excesso de informação, que consolida estrutura capaz de condenar todos os consumidores à passividade.","provocar presentificação, decorrente da dissolução dos intermediários e da combinação dos papéis de consumidor e produtor.","dissolver a distinção entre produtor e consumidor, causadora de congestionamento de tempo e de informação."],
    correctAnswer: 3,
    materia: "Sociologia – Mídia e Comunicação",
    conteudo: "Sociologia – Cultura Digital",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: "Sociologia – Cultura do Cancelamento",
...
createQuestion({
    ...
    options: ["seja...seja evidencia a dúvida das autoras quanto aos campos afetados pelo cancelamento.","que é utilizado para intensificar o valor dos movimentos sociais na luta pela diversidade.","sendo assim indica adesão autoral diante das formas de sanção aplicadas pelos agentes do cancelamento.","mas sim ressalta a diferença entre como se pune na cultura do cancelamento e no direito penal.","como introduz uma comparação entre distintas ações passíveis de gerar cancelamento."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["partida dos colonizadores da metrópole, da qual saíram por fatores religiosos, e a adoção do trabalho livre como base da produção.","dominação e a exploração dos povos originários e o emprego sistemático do trabalho forçado dessas populações.","introdução de colonos sem interesse na ocupação demográfica e o objetivo exclusivo da extração de riquezas minerais.","produção local organizada em pequenas propriedades e a utilização primordial da força de trabalho familiar.","falta de interesse metropolitano pela exploração comercial e a inexistência de benefícios financeiros para a metrópole."],
    correctAnswer: 1,
    materia: "História – Colonização da América",
    conteudo: "História – Trabalho Forçado na Colônia",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["à dissolução da Assembleia Constituinte e à outorga de uma constituição elaborada pelo Conselho de Estado.","ao distanciamento do governo brasileiro em relação à Coroa Portuguesa e à política europeia do período.","ao caráter descentralizador do regime monárquico e ao aumento da autonomia das províncias.","ao poder exercido pelos produtores nordestinos de algodão e pelos cafeicultores paulistas.","à adoção de regime republicano pela Constituição e ao fechamento do parlamento nacional."],
    correctAnswer: 0,
    materia: "História – Brasil Império",
    conteudo: "História – Confederação do Equador",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["aplicação imparcial e consistente de princípios éticos e morais.","promoção de punições rigorosas para qualquer tipo de crime.","distribuição de recursos econômicos de maneira equitativa, com ênfase no coletivo.","garantia de que todos recebam o que lhes é devido, contemplando direitos individuais.","proteção exclusiva dos direitos das minorias, aumentando sua visibilidade social."],
    correctAnswer: 3,
    materia: "Filosofia – Teoria da Justiça",
...
createQuestion({
    ...
    options: ["d < 2","2 ≤ d ≤ 5","5 ≤ d ≤ 8","8 < d ≤ 11","11 < d"],
    correctAnswer: 2,
...
createQuestion({
    ...
    conteudo: "Física – Efeito Compton",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Todos os modelos previram a presença de cargas positivas no núcleo atômico.","O modelo proposto por Thomson, por prever a existência de nêutrons, não poderia explicar a radiação alfa (a).","Diferentemente do modelo de Dalton, o modelo de Rutherford não explica a estrutura de cátions e ânions.","Apenas o modelo de Bohr, com o advento de balanças de precisão, considerou a diferença de massa entre os elementos.","Elementos radioativos não poderiam ser explicados pelo modelo proposto por Dalton."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["praticamente não está presente no oceano, apesar de este ser salgado.","é insolúvel na água do oceano por apresentar ligação iônica.","utilizado no Brasil é quase todo proveniente do oceano.","obtido do oceano apresenta ligação covalente, enquanto o extraído do salgema, ligação iônica.","retirado do oceano, tem átomos de cloro ligados ao sódio do que o oriundo de outras fontes."],
    correctAnswer: 2,
    materia: "Geografia – Geografia Urbana",
    conteudo: "Geografia – Nomenclatura Urbana",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["1:2.000.","1:200.000.","1:2.000.000.","1:2.200.000.","1:20.000.000."],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: ["A rota que liga os portos de Murmansk a Churchill é vantajosa em razão da facilidade de acesso e de não interferir na Zona Econômica Exclusiva, evitando conflitos territoriais.","Os percursos advindos das rotas Noroeste e Nordeste possibilitam maior estratégia geopolítica dos países pertencentes à região, que utilizam, para isso, todas as zonas turísticas como sítios para bases militares.","A rota Nordeste, que liga Roterdã a Shangai, aumenta a distância percorrida pelas frotas marítimas e ainda pode ser ameaçada pela ampliação da cobertura de gelo no futuro.","A rota Noroeste, que liga Ásia a América, é percurso já consagrado pelo tráfego marítimo intenso, por sua menor distância e por percorrer muitos portos comerciais e bases militares.","O fluxo comercial possibilitado pelas rotas Noroeste e Nordeste tende a se concentrar no Estreito de Bering, reduzindo a distância a ser percorrida em relação aos trajetos via Canais do Panamá e de Suez."],
    correctAnswer: 4,
    materia: "Geografia – Geopolítica",
    conteudo: "Geografia – Comércio Marítimo",
    imageNames: []
  }),
...
createQuestion({
    ...
    conteudo: "Física – Rotação da Terra",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["terremotos.","vulcões.","avalanches.","marés dos oceanos.","ciclones."],
    correctAnswer: 3,
    materia: "Inglês – Interpretação de Texto",
...
createQuestion({
    ...
    options: ["as espécies necessariamente se adaptarão às novas mudanças do planeta.","somente espécies de dias longos, ou seja, aquelas que precisam de mais horas de luz, sobreviverão às mudanças previstas.","é difícil prever como se dará a evolução das espécies, porque esse é um processo mediado pelo acaso.","nenhuma espécie sobreviverá às mudanças na Terra e novas espécies surgirão em seu lugar.","espécies aquáticas terão vantagem adaptativa sobre espécies terrestres, uma vez que todos os continentes submergirão com o derretimento das geleiras."],
    correctAnswer: 2,
    materia: "Inglês – Interpretação de Texto",
    conteudo: "Biologia – Teoria da Evolução",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["dilatação e reflexão.","interferência e dilatação.","dissipação e difração.","convecção e dispersão.","reflexão e interferência."],
    correctAnswer: 4,
    materia: "Física – Óptica",
...
createQuestion({
    ...
    options: ["Ele vê o gesto do advogado Dr. Otávio Conti, no café, metendo a mão no bolso, tirando uma cédula de cem mil-réis e entregando-a ao Duque.","Ele não sabe explicar... Há nisso um certo tom de versatilidade... de facilidade... de um tal ou qual afrouxamento do caráter...","Ele vê o Andrade tirando, com o gesto do Dr. Otávio Conti, a \"mesma\" cédula do bolso e entregando-lha...","Uma pequena aragem que sopra levemente nesta parte alta da rua passa-lhe pelas mãos e esfria-as.","Ao mesmo tempo o coração, que batia lá no fundo do peito, veio palpitar bem à superfície, quase à flor da pele, meio engasgando-o."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["O conto apresenta, de modo documental e objetivo, a condição econômico-social de uma família, mediante a enumeração de objetos que conotam a vida difícil dos moçambicanos em busca de um lugar na hierarquia preestabelecida pelo colonizador europeu.","O conto demonstra como Luís Bernardo Honwana recria consistentemente a estrutura do português do colonizador a partir das línguas originárias de Moçambique, fazendo da linguagem um instrumento de luta anticolonial.","O conto retrata as primeiras reações dos trabalhadores do campo, como Madala e Djimbo, que se levantam em armas contra os aparelhos repressivos do Estado português e a violência nas relações de trabalho, representados no texto pelo capataz.","No conto, a sociedade moçambicana vai sendo apresentada sob o ponto de vista do colonizador, de modo a comprovar o ideal civilizatório da colonização portuguesa na África e a convivência equilibrada entre colonizadores e colonizados.","No conto, embora perceba ter ultrapassado um limite moral ao descobrir o parentesco entre Maria e Madala, o capataz personifica a imposição da violência e do patriarcalismo metropolitanos aos homens e mulheres de Moçambique."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["ao aprisionamento da mulher que não consegue se libertar do poderio masculino.","à guerra interior e à falta de forças da mulher oprimida, que aceita sua condição.","ao renascimento da mulher que alcança, após a opressão, coragem para encontrar-se a si mesma.","ao rebaixamento da mulher que se cala e se desculpa, perdendo aos poucos sua autoestima.","à força da mulher que, mesmo hostilizada, tem poder para fazer entrar em sua casa quem a encurralava."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Análise Textual",
    conteudo: "Língua Portuguesa – Gênero Textual (Poema)",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["\"Eram faíscas suas palavras que me queimavam em/ doses homeopáticas/ durante todas as noites...\" — conotação: o predicativo \"faíscas\" e a forma verbal \"queimavam\" estão sendo usados em sentido figurado, enfatizando seu sofrimento.","\"Até que um dia, me empurrou, me acuou/como se eu pudesse caber em qualquer fresta, /encurralada\" — antítese: OS elementos \"empurrou\", \"acuou\" e \"encurralada\" potencializam de forma contraditória seu sofrimento.","\"acreditando que o amor era isso, esse abismo, onde só/ um fala e o outro, fica omisso\" - metonímia: o uso do aposto \"esse abismo\", referindo-se a \"amor\", expressa literalmente seu sofrimento.","\"Precisei tirar forças de lugares sagrados/ pra me afastar e reagir, recolher meus pedaços\" pleonasmo: 0 complemento “meus pedaços\" reforça o significado do verbo \"recolher\", acentuando seu sofrimento.","\"Meus olhos encheram de mar, eu desaguei, /decidi não mais me calar, denunciei!” paronímia: os verbos \"encher\" e \"desaguar” são elementos de significação próxima que dão ênfase a seu sofrimento."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["atribuem valor idêntico à presença de homens e de mulheres nas esferas pública e privada.","revelam a neutralidade do material no que diz respeito às posições políticas e às relações entre gêneros.","ressaltam a importância da formação intelectual das mulheres oriundas dos setores populares.","fazem propaganda do regime político e demarcam as funções da mulher como mãe e esposa.","desenvolvem crítica político-partidária à estrutura patriarcal e à política popular."],
    correctAnswer: 3,
    materia: "História – História da América Latina",
    conteudo: "História – Peronismo",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["As práticas esportivas devem ser consideradas como práticas sociais, pois claramente refletem em sua realidade as potencialidades e os retrocessos da sociedade. Sendo assim, as mulheres já atingiram o mesmo nível de destaque que os homens na sociedade contemporânea, haja vista a ascensão e visibilidade feminina no cenário esportivo.","Os grandes eventos esportivos conferem às mulheres uma visibilidade muitas vezes camuflada na sociedade. A visibilidade gerada para as atletas em cenário esportivo, a partir dos grandes eventos, demonstra o quanto elas já atingiram em totalidade seu status social e caminham no sentido de alcançar a agenda dos ODS.","As mulheres atletas têm, vagarosamente, alcançado mais possibilidades de inclusão e participação junto ao mundo esportivo, porém a igualdade de gênero ainda se mostra uma meta distante de ser alcançada quando se observa a baixa proporção de mulheres ocupando cargos de gestão e liderança no cenário esportivo.","O mundo esportivo não tem implicação direta junto ao alcance das metas dos ODS, uma vez que possui organização e regramento específicos, além de uma constituição social própria. Dessa maneira, a instituição esportiva não deve ser padrão de referência para revelar avanços ou retrocessos da sociedade como um todo.","O esporte tem sido importante fenômeno de promoção das mulheres, mas sua influência é limitada à prática profissional de modalidades esportivas mais populares, sem potencial de contribuir para a igualdade de oportunidades para as mulheres em todos os níveis de tomada de decisão na vida política, econômica e pública."],
    correctAnswer: 2,
    materia: "Sociologia – Gênero e Esporte",
    conteudo: "Sociologia – Objetivos de Desenvolvimento Sustentável (ODS)",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["enaltece a romantização e idealização de épocas passadas.","destaca o papel de contextos externos no manejo de frustrações.","expressa o sentimento de insatisfação ou inadequação em relação às expectativas sociais.","critica a revelação de segredos e o rompimento de fronteiras pessoais.","enfatiza a importância da sorte e de elementos culturais como mitos e rituais."],
    correctAnswer: 2,
    materia: "Inglês – Interpretação de Texto",
    conteudo: "Inglês – Análise de Letra de Música",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["refúgio mental para apaziguar as pressões e o descontentamento da vida.","concepção ligada às experiências infantis em mecanismos de enfrentamento.","conceito pressuposto, dependente da realidade concreta das pessoas.","dificuldade de ter autoafirmação, por conta de questões internas pendentes.","algo criado pela sociedade, produzindo falsa sensação de segurança."],
    correctAnswer: 4,
    materia: "Inglês – Interpretação de Texto",
...
createQuestion({
    ...
    options: ["os aspectos prosaicos da linguagem modernista ganham expressão lírica a partir de um sujeito poético que repropõe, em versos livres, a nostalgia romântica da infância idealizada.","o sujeito poético incorpora, sob a perspectiva de uma lírica de raiz subjetiva, vários procedimentos estilísticos das vanguardas modernistas, em especial a escrita automática e o surrealismo.","a tópica literária do desconcerto do mundo ganha uma reconfiguração moderna, a partir de um sujeito poético que, mais do que revelar um mundo às avessas, focaliza o seu desajuste frente à realidade.","o nacionalismo literário, tão típico da revisão empreendida pela primeira geração modernista sobre a realidade brasileira, apresenta-se como eixo temático de cunho ufanista.","a paisagem mineira, no espaço literário, é configurada pelo sujeito poético como ambiente bucólico e refúgio privilegiado para os seus desajustes frente ao \"vasto mundo\"."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Literatura Brasileira",
...
createQuestion({
    ...
    options: ["A passagem do tempo é ilusória.","O tempo desfaz a mudança.","Há um paradoxo na compreensão do tempo.","Os momentos do tempo identificam-se entre si.","Há ruptura completa entre o tempo presente e o futuro."],
    correctAnswer: 2,
    materia: "Filosofia – Filosofia do Tempo",
...
createQuestion({
    ...
    options: ["constituem o único órgão de reserva de amido das plantas, substância altamente energética para os seres vivos em geral.","armazenam todas as vitaminas e nutrientes necessários para a planta e, portanto, também ao ser humano.","possuem DNA da planta-mãe e do embrião, que constituem nutrientes sem os quais a espécie humana não sobrevive.","contêm substâncias de reserva provedoras de energia para o desenvolvimento do embrião vegetal, que também servem de fonte energética aos seres humanos.","possuem enzimas digestivas de amido e de proteínas, que disponibilizam energia ao embrião vegetal e também são usadas para promover a digestão em seres humanos."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["Cerrado, agropecuária e processos erosivos.","Cerrado, silvicultura e contaminação do solo.","Amazônia, mineração e poluição das águas.","Caatinga, pastagem e impermeabilização da superfície.","Caatinga, extrativismo e perda de biodiversidade."],
    correctAnswer: 0,
    materia: "Geografia – Biomas Brasileiros",
    conteudo: "Geografia – Desmatamento",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["Caatinga.","Cerrado.","Mata Atlântica.","Pampas.","Pantanal."],
    correctAnswer: 3,
    materia: "Geografia – Biomas Brasileiros",
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: "Geografia – Climatologia Urbana",
    conteudo: "Geografia – Ilhas de Calor",
    imageNames: []
  }),
...
createQuestion({
    ...
    conteudo: "Matemática – Transformações de Gráficos",
    imageNames: []
  }),
...
createQuestion({
    ...
    conteudo: "Geografia – Análise de Gráficos Meteorológicos",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["A elevação da temperatura e o aumento da pluviosidade, somados ao desmatamento, à urbanização e à circulação de pessoas em várias áreas, potencializam a expansão da dengue.","A dengue é um problema nacional e está relacionada ao fato de o Brasil ser um país tropical com áreas de florestas, aspectos que, combinados à dispersão da população, contribuem para minimizar a epidemia.","A proliferação do mosquito Aedes aegypti ocorre em áreas pouco povoadas nos centros urbanos, associada às baixas temperaturas que intensificam a transmissão da doença.","No território brasileiro, as áreas com baixas temperaturas reduzem o tempo necessário para eclosão dos ovos, aumentando a proliferação do mosquito Aedes aegypti e a frequência de picadas.","A dengue é um problema de saúde pública em escala mundial e sua disseminação está associada à diminuição de temperatura, aumento da velocidade do vento e redução da precipitação."],
    correctAnswer: 0,
    materia: "Biologia – Ecologia",
...
createQuestion({
    ...
    options: ["fechado apresenta uma menor pressão do sangue / hemolinfa em relação ao sistema circulatório aberto.","aberto apresenta o coração dividido em quatro cavidades: dois átrios e dois ventrículos.","fechado permite maior eficiência no transporte de oxigênio em relação ao sistema circulatório aberto.","aberto facilita a distribuição dos nutrientes aos tecidos em relação ao sistema circulatório fechado.","fechado mistura mais facilmente os gases respiratórios: oxigênio e dióxido de carbono."],
    correctAnswer: 2,
...
createQuestion({
    ...
    options: ["Os sais de sódio mencionados, por serem hidrofílicos, repelem a água.","Propanona e hexano são exemplos de álcoois e aldeídos antimicrobianos.","Assim como o betume e óleo de cedro, qualquer outro composto orgânico serviria como impermeabilizante.","Todo sal iônico poderia ser utilizado em substituição aos sais de sódio mencionados.","A impermeabilidade conferida pelas resinas se deve às suas características apolares ou muito pouco polares."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["A precipitação do acetato de sódio é exotérmica e sua solubilização é endotérmica.","A diminuição da temperatura aumenta a solubilidade do acetato de sódio.","A solubilização do acetato de sódio para a regeneração do aquecedor libera energia, aquecendo o banho de água.","Quando o aquecedor é regenerado, a solução interna passa de supersaturada para uma solução diluída.","A concentração de acetato de sódio na solução dentro do reservatório não muda durante a regeneração do aquecedor."],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: ["À queda de uma maçã, que teria inspirado Newton à descoberta da gravitação universal.","À observação de um pássaro em voo, que teria levado Einstein a formular a teoria da relatividade.","Aos experimentos com objetos de massas diferentes, que teriam indicado a Galileu os princípios da queda livre.","Ao transbordamento da água em uma banheira, que teria sugerido a Arquimedes o conceito de empuxo.","À queda de um bloco de ferro ligado a uma hélice, que teria levado Joule à equivalência entre calor e energia."],
    correctAnswer: 2,
...
createQuestion({
    ...
    options: ["indetermina o sujeito, tentando mostrar que desconhece a real autoria do experimento.","valoriza o objeto \"caldo de cana\", enfatizando a importância desse produto para o experimento.","chama a atenção para o verbo transitivo \"utilizar\", valorizando a importância de se experimentar diretamente o caldo de cana.","faz uso da voz passiva, construção em que \"caldo de cana\" atua como sujeito, deixando de haver menção a quem realizou o experimento.","escolhe uma construção reflexiva em que \"caldo de cana\" é, ao mesmo tempo, o agente e o objeto do experimento realizado."],
    correctAnswer: 3,
...
createQuestion({
    ...
    conteudo: "Sociologia – Desenvolvimento Socioeconômico",
    imageNames: []
  }),
...
createQuestion({
    ...
    conteudo: "Matemática – Funções Modulares",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["12 m/s².","120 m/s².","1200 m/s².","12000 m/s².","120000 m/s²."],
    correctAnswer: 3,
    materia: "Física – Dinâmica",
...
createQuestion({
    ...
    options: ["1400π","2100π","2400π","2600π","2800π"],
    correctAnswer: 0,
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: "Língua Portuguesa – Análise de Cartum",
...
createQuestion({
    ...
    options: ["pela concentração de rotas migratórias em território bizantino.","pela inexistência de invasões direcionadas para o norte da África.","pela inexpressiva diversidade de povos das correntes migratórias.","pela proeminência de migrações na porção ocidental do Império Romano.","pelo predomínio de invasões por rotas marítimas em detrimento das rotas terrestres."],
    correctAnswer: 3,
    materia: "História – Roma Antiga",
    conteudo: "História – Migrações Bárbaras",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["as ideias calvinistas impulsionaram o capitalismo e levaram os comerciantes germânicos a buscar a acumulação irrestrita de capitais.","o crescimento acelerado dos mercados consumidores facilitou, no século XVI, a aceitação das ideias calvinistas pelos banqueiros e negociantes europeus.","as condições materiais, sociais e políticas da Europa Central contribuíram, no século XVI, para a expansão do capitalismo e para a repressão do calvinismo.","a união entre os comerciantes contra o Sacro Império Romano Germânico e contra o Papado determinou a adoção de práticas capitalistas e calvinistas na Europa medieval.","a defesa calvinista do trabalho árduo e o estímulo ao comportamento austero do crente tiveram impactos positivos na formação de condutas adequadas ao desenvolvimento do capitalismo."],
    correctAnswer: 4,
...
createQuestion({
    ...
    options: ["Tal como São Paulo, a Zona Franca de Manaus teve a expansão de suas indústrias dada pelo potencial do mercado consumidor local dos produtos resultantes da industrialização.","O Nordeste teve sua expansão industrial durante o Estado Novo, em razão da alta concentração de capitais dos estados da região, permitindo conexões dos seus polos industriais já consolidados.","O boom industrial que aconteceu na região Sul, a partir da década de 1980, foi similar ao desenvolvimento ocorrido no Sudeste, onde a mão de obra especializada aumentou a produção.","A concentração industrial no Sudeste ocorreu devido à existência de mercado consumidor, de capitais, de mão de obra disponível e de maior capacidade dos meios de transporte.","A região Centro-Oeste contou com a facilidade de obtenção de energia, por meio de hidrelétricas e termoelétricas, além da densa malha viária para o seu desenvolvimento industrial."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["representam, respectivamente, a ascensão política da burguesia brasileira durante a segunda metade do século XIX e a decadência da aristocracia portuguesa no mesmo período.","têm suas aspirações de grandeza e reconhecimento social frustradas diretamente pelo envolvimento de ambos com as políticas partidárias nacionais, introduzindo reformas substanciais que alteram a situação periférica de cada país.","buscam reconhecimento social, continuamente frustrados nesse propósito por se inserirem em meios sociais que privilegiam a grandeza moral e as virtudes humanas.","comprometem-se com a superação dos atrasos civilizacionais de seus países. Apesar de terem destinos diferentes, confrontam-se com o descompromisso de suas respectivas sociedades quanto às transformações sociais e econômicas.","são vítimas de suas ideias ambiciosas de modernização nacional, seja por Rubião promover ideias políticas \"modernas\", seja por Gonçalo insistir na restauração da grandeza de sua família. Ao final, atingem seus objetivos."],
    correctAnswer: 4,
    materia: "Língua Portuguesa – Literatura Brasileira",
...
createQuestion({
    ...
    options: ["O emprego de recursos pictóricos que realçam os efeitos de luz e sombra na cena retratada.","A representação de aspectos da cultura brasileira, valorizando uma paisagem local.","A simplificação de formas geométricas abstratas.","A inspiração na arte africana e na produção simbólica de povos originários.","A incorporação da colagem e de técnicas mistas como procedimentos artísticos centrais."],
    correctAnswer: 1,
    materia: "Arte – Modernismo Brasileiro",
    conteudo: "Arte – Tarsila do Amaral",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["à existência de um comércio de produtos manufaturados entre a África e a América.","à prerrogativa masculina na produção de tecidos naquela região da África.","à baixa qualidade das manufaturas africanas em comparação com as da Europa.","à impossibilidade de acesso, por africanos e afrodescendentes, a produtos vindos da África.","ao comércio de africanos escravizados para o trabalho nas plantações de algodão."],
    correctAnswer: 0,
    materia: "História – História da África",
    conteudo: "História – Comércio Transatlântico",
    imageNames: []
  }),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: "Geografia – Regiões da África",
...
createQuestion({
    ...
    options: ["uma construção histórica proporcionada pela ação humanitária dos colonizadores europeus.","um resultado natural da luta dos povos do continente contra a dominação estrangeira.","uma região historicamente afetada por graves problemas demográficos e sanitários.","um continente definido a partir de critérios políticos e geográficos deterministas.","um mosaico composto por relações econômicas, políticas e culturais instáveis."],
    correctAnswer: 4,
    materia: "Língua Portuguesa – Literatura Africana",
...
createQuestion({
    ...
    options: ["discriminação em relação a afrodescendentes.","exaltação das virtudes naturais e nacionais.","concepção civilizatória assentada na religião católica.","valorização da cultura cabocla e do regionalismo.","escolha do malandro como símbolo nacional."],
    correctAnswer: 1,
