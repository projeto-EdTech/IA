createQuestion({
    id: 1,
    university: "1º DIA CADERNO 1 AZUL",
    year: 2020,
    text: {
      principal: "women shouldn't |\nwomen shouldn't have rights\nwomen shouldn't vote\nwomen shouldn't work\nwomen shouldn't box\nwomen shouldn't suffer from discrimination anymore\nDisponível em: https://sites.psu.edu. Acesso em: 12 jun. 2018.\nOs recursos usados nesse pôster de divulgação de uma campanha levam o leitor a refletir sobre a necessidade de",
      subItens: []
    },
    options: ["criticar o tipo de tratamento dado à mulher.","rever o desempenho da mulher no trabalho.","questionar a sobrecarga de atribuições da mulher.","analisar as pesquisas acerca dos direitos da mulher.","censurar a mulher pelo uso de determinadas palavras."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "WE’RE A CULTURE,\nNOT A COSTUME\nThis is\nNOT Who We Are,\nand this is NOT OK\nOffice of\nCSU Diversity\nCHICO & Inclusion\nDisponível em: www.csuchico.edu. Acesso em: 11 dez. 2017.\nNesse pôster de divulgação de uma campanha que aborda a diversidade e a inclusão, a interação dos elementos verbais e não verbais faz referência ao ato de",
      subItens: []
    },
    options: ["estereotipar povos de certas culturas.","discriminar hábitos de grupos minoritários.","banir imigrantes de determinadas origens.","julgar padrões de beleza de diversas etnias.","desvalorizar costumes de algumas sociedades."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "A Minor Bird\nI have wished a bird would fly away,\nAnd not sing by my house all day;\nHave clapped my hands at him from the door\nWhen it seemed as if I could bear no more.\nThe fault must partly have been in me.\nThe bird was not to blame for his key.\nAnd of course there must be something wrong\nIn wanting to silence any song.\nFROST, R. West-running Brook. New York: Henry Holt and Company, 1928.\nNo poema de Robert Frost, as palavras “fault” e “blame” revelam por parte do eu lírico uma",
      subItens: []
    },
    options: ["culpa por não poder cuidar do pássaro.","atitude errada por querer matar o pássaro.","necessidade de entender o silêncio do pássaro.","sensibilização com relação à natureza do pássaro.","irritação quanto à persistência do canto do pássaro."],
    correctAnswer: 3,
    materia: "Inglês – Interpretação de Texto Literário",
    conteudo: "",
    imageNames: []
...
createQuestion({
    ...
    options: ["diálogo que a letra da canção estabelece com diferentes tradições da cultura nacional.","singularidade com que o compositor converte referências eruditas em populares.","caráter inovador com que o compositor concebe o processo de criação artística.","relativização que a letra da canção promove na concepção tradicional de originalidade.","resgate que a letra da canção promove de obras pouco conhecidas pelo público no país."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Senhor Juiz\nO instrumento do \"crime\" que se arrola\nNesse processo de contravenção\nNão é faca, revólver ou pistola,\nSimplesmente, doutor, é um violão.\nSerá crime, afinal, será pecado,\nSerá delito de tão vis horrores,\nPerambular na rua um desgraçado\nDerramando nas praças suas dores?\nMande, pois, libertá-lo da agonia\n(a consciência assim nos insinua)\nNão sufoque o cantar que vem da rua,\nQue vem da noite para saudar o dia.\nÉ o apelo que aqui lhe dirigimos,\nNa certeza do seu acolhimento\nJuntada desta aos autos nós pedimos\nE pedimos, enfim, deferimento.\nDisponível em: www.migalhas.com.br. Acesso em: 23 set. 2020 (adaptado).\nEssa petição de habeas corpus, ao transgredir o rigor da linguagem jurídica,",
      subItens: []
    },
    options: ["permite que a narrativa seja objetiva e repleta de sentidos denotativos.","mostra que o cordel explora termos próprios da esfera do direito.","demonstra que o jogo de linguagem proposto atenua a gravidade do delito.","exemplifica como o texto em forma de cordel compromete a solicitação pretendida.","esclarece que os termos “crime” e “processo de contravenção” são sinônimos."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Respeita as torcedoras!\nConversar?\nTorcer juntos?\nTocar sem permissão?\nEmpurrar?\nSe sentiu desrespeitada?\nDenuncie: disque 180\n#respeitaasminas\n#geralnapaz\nDisponível em: www.facebook.$\\\\frac{com}{ministeriodoesporte}$. Acesso em: 7 dez. 2017.\nEsse anúncio publicitário propõe soluções para um problema social recorrente, ao",
      subItens: []
    },
    options: ["promover ações de conscientização para reduzir a violência de gênero em eventos esportivos.","estimular o compartilhamento de políticas públicas sobre a igualdade de gênero no esporte.","divulgar para a população as novas regras complementares para as torcidas de futebol.","informar ao público masculino as consequências de condutas ofensivas.","regulamentar normas de boa convivência nos estádios."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Publicidade",
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Cadeiras.f. 1 assento com encosto e pernas, ger. para uma pessoa 2 fig. lugar de honra ocupado por político, cientista, literato etc. 3 fig. disciplina; cátedra\nKOSUTH, J. One and Three Chairs. Museu Reina Sofia, Espanha, 1965.\nDisponível em: www.museoreinasofia.es. Acesso em: 4 jun. 2018 (adaptado).\nA obra de Joseph Kosuth data de 1965 e se constitui por uma fotografia de cadeira, uma cadeira exposta e um quadro com o verbete “Cadeira\". Trata-se de um exemplo de arte conceitual que revela o paradoxo entre verdade e imitação, já que a arte",
      subItens: []
    },
    options: ["não é a realidade, mas uma representação dela.","fundamenta-se na repetição, construindo variações.","não se define, pois depende da interpretação do fruidor.","resiste ao tempo, beneficiada por múltiplas formas de registro.","redesenha a verdade, aproximando-se das definições lexicais."],
    correctAnswer: 0,
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Leandro Aparecido Ferreira, o MC Fioti, compôs em 2017 a música Bum bum tam tam, que gerou, em nove meses, 480 milhões de visualizações no YouTube. É o funk brasileiro mais ouvido na história do site.\nA partir de uma gravação da flauta que achou na internet, MC Fioti fez tudo sozinho: compôs, cantou e produziu em uma noite só. \"Comecei a pesquisar alguns tipos de flauta, coisas antigas. E nisso eu achei a 'flautinha do Sebastian Bach\", conta. A descoberta foi por acaso: Fioti não sabia quem era o músico alemão e não sabe tocar o instrumento.\nA \"flauta envolvente\" da música é um trecho da Partita em Lá menor, escrita pelo alemão Johann Sebastian Bach por volta de 1723.\nDisponível em: https://g_{1}.globo.com. Acesso em: 6 jun. 2018 (adaptado).\nA incorporação de um trecho da obra para flauta solo de Johann Sebastian Bach na música de MC Fioti demonstra a",
      subItens: []
    },
    options: ["influência permanente da cultura eurocêntrica nas produções musicais brasileiras.","homenagem aos referenciais estéticos que deram origem às produções da música popular.","necessidade de divulgar a música de concerto nos meios populares nas periferias das grandes cidades.","utilização desintencional de uma música excessivamente distante da realidade cultural dos jovens brasileiros.","inter-relação de elementos culturais vindos de realidades distintas na construção de uma nova proposta musical."],
    correctAnswer: 4,
    materia: "Arte – Música",
    conteudo: "Arte – Cultura e Tecnologia",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "para nós, a rua é\nUM CAMPO DE BATALHA\nCHEGA DE\n(fiufiu!\nDisponível em: www.bhaz.com.br. Acesso em: 14 jun. 2018.\nEssa campanha de conscientização sobre o assédio sofrido pelas mulheres nas ruas constrói-se pela combinação da linguagem verbal e não verbal. A imagem da mulher com o nariz e a boca cobertos por um lenço é a representação não verbal do(a)",
      subItens: []
    },
    options: ["silêncio imposto às mulheres, que não podem denunciar o assédio sofrido.","metáfora de que as mulheres precisam defender-se do assédio masculino.","constrangimento pelo qual passam as mulheres e sua tentativa de esconderem-se.","necessidade que as mulheres têm de passarem despercebidas para evitar o assédio.","incapacidade de as mulheres protegerem-se da agressão verbal dos assediadores."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Publicidade",
...
createQuestion({
    ...
    options: ["disseminação da arte poética em um veículo não convencional.","manutenção da expectativa das pessoas ao andarem pelas ruas.","necessidade de exposição de poemas pequenos em diferentes suportes.","característica corriqueira do suporte lambe-lambe, muito comum nas ruas.","exposição da beleza escondida das esquinas da cidade de Belo Horizonte."],
    correctAnswer: 0,
    materia: "Língua Portuguesa – Gêneros Textuais",
    conteudo: "Arte – Arte Urbana",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "O conceito de saúde formulado na histórica VIII Conferência Nacional de Saúde, no ano de 1986, ficou conhecido como um “conceito ampliado\" de saúde, conforme ilustrado na figura. Esse conceito foi fruto de intensa mobilização em diversos países da América Latina nas décadas de 1970 e 1980, como resposta à crise dos sistemas públicos de saúde.\nCondições Socioeconômicas, Culturais e Ambientais Gerais\nCondições de vida e de trabalho\nAmbiente de trabalho\nEducação\nProdução agrícola e de alimentos\nREDES SOCIAIS E COMUNITARIAS\nESTILO DE VIDA DOS INDIVIDUOS\nIdade, sexo e fatores hereditários\nDesemprego\nÁgua e esgoto\nServiços sociais de saúde\nHabitação\nBATISTELLA, C. Abordagens contemporâneas do conceito de saúde. Disponível em: www.dihs.ensp.fiocruz.br. Acesso em: 23 set. 2020.\nCom base no conceito apresentado no texto, a saúde é consequência direta do(a)",
      subItens: []
    },
    options: ["adoção de um estilo de vida ativo por parte dos indivíduos.","disponibilidade de emprego no mercado de trabalho.","condição habitacional presente nas cidades.","acesso ao sistema educacional.","forma de organização social."],
    correctAnswer: 4,
    materia: "Biologia – Saúde Pública",
    conteudo: "Sociologia – Determinantes Sociais da Saúde",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Hino à Bandeira\nEm teu seio formoso retratas\nEste céu de puríssimo azul,\nA verdura sem par destas matas,\nE o esplendor do Cruzeiro do Sul.\nContemplando o teu vulto sagrado,\nCompreendemos o nosso dever,\nE o Brasil por seus filhos amado,\nPoderoso e feliz há de ser!\nSobre a imensa Nação Brasileira,\nNos momentos de festa ou de dor,\nPaira sempre sagrada bandeira\nPavilhão da justiça e do amor!\nBILAC, O.; BRAGA, F. Disponível em: www_{2}.planalto.gov.br. Acesso em: 10 dez. 2017 (fragmento).\nNo Hino à Bandeira, a descrição é um recurso utilizado para exaltar o símbolo nacional na medida em que",
      subItens: []
    },
    options: ["remete a um momento futuro.","promove a união dos cidadãos.","valoriza os seus elementos.","emprega termos religiosos.","recorre à sua história."],
    correctAnswer: 2,
    materia: "Língua Portuguesa – Interpretação de Texto",
    conteudo: "Arte – Hino Nacional",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Rodrigo\nAdotado aos 13 anos\nAndre\nAdotado aos 15 anos\nSinomar Bruno\nAdotou aos\n29 anos\nPra encontrar a sua verdadeira\nfamilia, não existe idade\nGanhou novos irmãos ADOÇÃO\nDébora\nLIÇÃO DE AMOR\nAdotou aos 27 anos\nFrancisco\nAdotado aos\n8 anos\nDisponível em: www.acontecendoaqui.com.br. Acesso em: 15 jun. 2018.\nNessa campanha publicitária, a imagem da família e o texto verbal unem-se para reforçar a ideia de que",
      subItens: []
    },
    options: ["a família que adota é mais feliz.","a adoção tardia é muito positiva.","as famílias preferem adotar bebês.","a adoção de adolescentes é mais simples.","os filhos adotivos são companheiros dos pais."],
    correctAnswer: 1,
    materia: "Língua Portuguesa – Publicidade",
    conteudo: "Sociologia – Família e Sociedade",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Embora inegáveis os benefícios que ambas as economias têm auferido do intercâmbio comercial, o Brasil tem reiterado seu objetivo de desenvolver com a China uma relação comercial menos assimétrica. Os números revelam com clareza a assimetria. As exportações brasileiras de produtos básicos, especialmente soja, minério de ferro e petróleo, compõem, dependendo do ano, algo entre 75% e 80% da pauta, ao passo que as importações brasileiras consistem, aproximadamente, em 95% de produtos industrializados chineses, que vão desde os mais variados bens de consumo até máquinas e equipamentos de alto valor.\nLEÃO, V. C. Prefácio. In: CINTRA, M. A. M.; SILVA FILHO, E. B.; PINTO, E. C. (Org.). China em transformação: dimensões econômicas e geopolíticas do desenvolvimento. Rio de Janeiro: Ipea, 2015.\nUma ação estatal de longo prazo capaz de reduzir a assimetria na balança comercial brasileira, conforme exposto no texto, é o(a)",
      subItens: []
    },
    options: ["expansão do setor extrativista.","incremento da atividade agrícola.","diversificação da matriz energética.","fortalecimento da pesquisa científica.","monitoramento do fluxo alfandegário."],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: ["estagnação de direitos adquiridos e do anacronismo da legislação vigente.","manutenção do status quo gerencial e dos padrões de socialização familiar.","desestruturação da herança patriarcal e das mudanças do perfil ocupacional.","disputas na composição sindical e da presença na esfera político-partidária.","exigências de aperfeiçoamento profissional e de habilidades na competência diretiva."],
    correctAnswer: 1,
    materia: "Sociologia – Relações de Gênero",
    conteudo: "Sociologia – Mercado de Trabalho",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Zona de pastoreio e cultura do algodão e cereais do agreste (1963)\n[Imagem de um calendário circular com meses e atividades agrícolas]\nCONVENÇÕES\nPASTOREIO —\nPLANTIO E LIMPA —\nCRESCIMENTO —\nCOLHEITA DE FEIJÃO —\nCOLHEITA DE MILHO VERDE —\nCOLHEITA DE MILHO SECO —\nCOLHEITA DE ALGODÃO —\nANDRADE, M. C. A terra e o homem no Nordeste. São Paulo: Brasiliense, 1963.\nA dinâmica produtiva apresentada na imagem tem como estratégia central a",
      subItens: []
    },
    options: ["separação pelo tipo de solo.","exportação da colheita sazonal.","priorização da tecnologia moderna.","adequação pelo tempo da natureza.","intensificação da atividade pecuária."],
    correctAnswer: 3,
    materia: "Geografia – Agricultura",
    conteudo: "Geografia – Clima",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "A demanda mundial para a produção de alimentos aumenta progressivamente a taxas muito altas. Atualmente, na maioria dos países, continentes e regiões, a água consumida na agricultura é de cerca de 70% da disponibilidade total.\nTUNDISI, J. G. Recursos hídricos no futuro: problemas e soluções. Estudos Avançados, n. 63, 2008 (adaptado).\nPara que haja a redução da pressão sobre o recurso natural mencionado, a expansão da agricultura demanda melhorias no(a)",
      subItens: []
    },
    options: ["fertilização química do solo.","escoamento hídrico do terreno.","manutenção de poços artesianos.","eficiência das técnicas de irrigação.","velocidade das máquinas colheitadeiras."],
    correctAnswer: 3,
    materia: "Geografia – Recursos Hídricos",
    conteudo: "Geografia – Agricultura e Meio Ambiente",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "O planejamento deixou de controlar o crescimento urbano e passou a encorajá-lo por todos os meios possíveis e imagináveis. Cidades, a nova mensagem soou em alto e bom som, eram máquinas de produzir riquezas; o primeiro e principal objetivo do planejamento devia ser o de azeitar a máquina.\nHALL, P. Cidades do amanhã: uma história intelectual do planejamento e do projeto urbanos no século XX. São Paulo: Perspectiva, 2016 (adaptado).\nO modelo de planejamento urbano problematizado no texto é marcado pelo(a)",
      subItens: []
    },
    options: ["primazia da gestão popular.","uso de práticas sustentáveis.","construção do bem-estar social.","soberania do poder governamental.","ampliação da participação empresarial."],
    correctAnswer: 4,
    materia: "Geografia – Urbanização",
    conteudo: "Sociologia – Relações de Poder",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["fontes de águas termais.","afloramentos de sal-gema.","jazidas de minerais metálicos.","depósitos de calcário agrícola.","reservas de combustível fóssil."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "A Divisão Internacional do Trabalho significa que alguns países se especializam em ganhar e outros, em perder. Nossa comarca no mundo, que hoje chamamos América Latina, foi precoce: especializou-se em perder desde os remotos tempos em que os europeus do Renascimento se aventuraram pelos mares e lhe cravaram os dentes na garganta. Passaram-se os séculos e a América Latina aprimorou suas funções.\nGALEANO, E. As veias abertas da América Latina. São Paulo: Paz e Terra, 1978.\nEscrito na década de 1970, o texto considera a participação da América Latina na Divisão Internacional do Trabalho marcada pela",
      subItens: []
    },
    options: ["produção inovadora de padrões de tecnologia.","superação paulatina do caráter agroexportador.","apropriação imperialista dos recursos territoriais.","valorização econômica dos saberes tradicionais.","dependência externa do suprimento de alimentos."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Sexto rei sumério (governante entre os séculos XVIII e XVII a.C.) e nascido em Babel, “Khammu-rabi\" (pronúncia em babilonio) foi fundador do I Império Babilônico (correspondente ao atual Iraque), unificando amplamente o mundo mesopotâmico, unindo os semitas e os sumérios e levando a Babilônia ao máximo esplendor. O nome de Hamurabi permanece indissociavelmente ligado ao código jurídico tido como o mais remoto já descoberto: o Código de Hamurabi. O legislador babilônico consolidou a tradição jurídica, harmonizou os costumes e estendeu o direito e a lei a todos os súditos.\nDisponível em: www.direitoshumanos.usp.br. Acesso em: 12 fev. 2013 (adaptado).\nNesse contexto de organização da vida social, as leis contidas no Código citado tinham o sentido de",
      subItens: []
    },
    options: ["assegurar garantias individuais aos cidadãos livres.","tipificar regras referentes aos atos dignos de punição.","conceder benefícios de indulto aos prisioneiros de guerra.","promover distribuição de terras aos desempregados urbanos.","conferir prerrogativas políticas aos descendentes de estrangeiros."],
    correctAnswer: 1,
    materia: "História – Antiguidade Oriental",
    conteudo: "História – Direito",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["alteração da matriz econômica.","substituição do modal hidroviário.","retração do contingente demográfico.","projeção do escoamento produtivo.","estagnação de lavouras policultoras."],
    correctAnswer: 3,
    materia: "Geografia – Transportes",
    conteudo: "Geografia – Agronegócio",
    imageNames: []
  }),
...
createQuestion({
    ...
    options: ["colisão de placas tectônicas.","rifteamento da crosta terrestre.","subducção da plataforma oceânica.","formação de cadeias montanhosas.","metamorfismo de bordas continentais."],
    correctAnswer: 1,
    materia: "Geografia – Geologia",
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "A reabilitação da biografia histórica integrou as aquisições da história social e cultural, oferecendo aos diferentes atores históricos uma importância diferenciada, distinta, individual. Mas não se tratava mais de fazer, simplesmente, a história dos grandes nomes, em formato hagiográfico – quase uma vida de santo –, sem problemas, nem máculas. Mas de examinar os atores (ou o ator) célebres ou não, como testemunhas, como reflexos, como reveladores de uma época.\nDEL PRIORE, M. Biografia: quando o indivíduo encontra a história. Topoi, n. 19, jul.-dez. 2009.\nDe acordo com o texto, novos estudos têm valorizado a história do indivíduo por se constituir como possibilidade de",
      subItens: []
    },
    options: ["adesão ao método positivista.","expressão do papel das elites.","resgate das narrativas heroicas.","acesso ao cotidiano das comunidades.","interpretação das manifestações do divino."],
    correctAnswer: 3,
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Montaigne deu o nome para um novo gênero literário; foi dos primeiros a instituir na literatura moderna um espaço privado, o espaço do \"eu\", do texto íntimo. Ele cria um novo processo de escrita filosófica, no qual hesitações, autocríticas, correções entram no próprio texto.\nCOELHO, M. Montaigne. São Paulo: Publifolha, 2001 (adaptado).\nO novo gênero de escrita aludido no texto é o(a)",
      subItens: []
    },
    options: ["confissão, que relata experiências de transformação.","ensaio, que expõe concepções subjetivas de um tema.","carta, que comunica informações para um conhecido.","meditação, que propõe preparações para o conhecimento.","diálogo, que discute assuntos com diferentes interlocutores."],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: ["anterioridade da razão no domínio cognitivo.","confirmação da existência de saberes inatos.","valorização do corpo na apreensão da realidade.","verificabilidade de proposições no campo da lógica.","possibilidade de contemplação de verdades atemporais."],
    correctAnswer: 2,
    materia: "Filosofia – Teoria do Conhecimento",
    conteudo: "Filosofia – Fenomenologia",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "A principal característica da situação social do anglo-americanos é seu caráter eminentemente democrático. Afirma anteriormente que reinava uma igualdade muito grande entre os emigrantes que foram se estabelecer na Nova Inglaterra. Para isso contribuiu a influência das leis de sucessão. Estabelecidas de uma maneira, as leis de sucessão reúnem, concentram e agrupam em um só a propriedade e o poder. Estabelecidas por outros princípios, produzem e opõem, dividem, partilham e disseminam os bens e o poder.\nTOCQUEVILLE, A. A democracia na América. Belo Horizonte: Itatiaia; São Paulo: EDUSP, 1977 (adaptado).\nO texto tematiza o papel desempenhado por uma norma na criação de um ambiente propício ao(à)",
      subItens: []
    },
    options: ["emprego do trabalho escravo.","consolidação dos poderes burgueses.","incremento das dissidências religiosas.","contenção da identificação nacionalista.","hierarquização dos agentes econômicos."],
    correctAnswer: 1,
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "O toyotismo, a partir dos anos 1970, teve grande impacto no mundo ocidental, quando se mostrou para os países avançados como uma opção possível para a superação de uma crise de acumulação.\nANTUNES, R. Os sentidos do trabalho: ensaio sobre a afirmação e a negação do trabalho. São Paulo: Boitempo, 2009 (adaptado).\nA característica organizacional do modelo em questão, requerida no contexto de crise, foi o(a)",
      subItens: []
    },
    options: ["expansão dos grandes estoques.","incremento da fabricação em massa.","adequação da produção à demanda.","aumento da mecanização do trabalho.","centralização das etapas de planejamento."],
    correctAnswer: 2,
    materia: "Geografia – Geografia Industrial",
    conteudo: "Sociologia – Organização do Trabalho",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "O fenômeno histórico conhecido como \"tráfico de coolies\" esteve associado diretamente ao período que vai do final da década de 1840 até o ano de 1874, quando milhares de chineses foram encaminhados principalmente para Cuba e Peru e muitos abusos no recrutamento de mão de obra foram identificados. O tráfico de coolies ou, em outros termos, o transporte por meios coativos de mão de obra de um lugar para outro, foi comparado ao tráfico africano de escravos por muitos historiadores e analistas do século XIX.\nSANTOS, M. A migração e o trabalho sob contrato no século XIX. História, n. 12, 2017.\nA comparação mencionada no texto foi possível em razão da seguinte característica:",
      subItens: []
    },
    options: ["oferta de contrato formal.","origem étnica dos grupos de trabalhadores.","restrição da cidadania por parentesco.","conhecimento das tarefas desenvolvidas.","investimento requerido dos empregadores."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "A divisão interna dos grupos sociais nas comunidades indígenas e suas representações de poder varia muito, mas algumas regularidades podem ser notadas. Um traço cultural que acompanha as práticas políticas de muitas sociedades nativas é a ênfase na dimensão do grupo em detrimento do individual. Nas discussões e decisões, os chefes costumam apresentar a política como um consenso que a todos abarca. Por exemplo, \"falar pelos outros\" é o que habitualmente faz o chefe, porque uma decisão que satisfaça a todos não pode, aos olhos do grupo, ser apresentada como particular.\nCLASTRES, P. A sociedade contra o Estado. São Paulo: Cosac Naify, 2012 (adaptado).\nDe acordo com o autor, qual é a origem do conhecimento humano?",
      subItens: []
    },
    options: ["A potência inata da mente.","A revelação da inspiração divina.","O estudo das tradições filosóficas.","A vivência dos fenômenos do mundo.","O desenvolvimento do raciocínio abstrato."],
    correctAnswer: 3,
    materia: "Filosofia – Teoria do Conhecimento",
    conteudo: "Sociologia – Antropologia",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Os seringueiros amazônicos eram invisíveis no cenário nacional nos anos 1970. Começaram a se articular como um movimento agrário no início dos anos 1980, e na década seguinte conseguiram reconhecimento nacional, obtendo a implantação das primeiras reservas extrativas após o assassinato de Chico Mendes. Assim, em vinte anos, os camponeses da floresta passaram da invisibilidade à posição de paradigma de desenvolvimento sustentável com participação popular.\nALMEIDA, M. W. B. Direitos à floresta e ambientalismo: seringueiros e suas lutas. Revista Brasileira de Ciências Sociais, n. 55, 2004.\nDe acordo com o texto, a visibilidade dos seringueiros amazônicos foi estabelecida pela relação entre",
      subItens: []
    },
    options: ["crescimento econômico e migração de trabalhadores.","produção de borracha e escassez de recursos naturais.","reivindicação de terra e preservação de mata nativa.","incentivo governamental e conservação de territórios.","modernização de plantio e comércio de látex."],
    correctAnswer: 2,
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "As cidades de Puebla, no México, e Legazpi, nas Filipinas, não têm quase nada em comum. Estão muito longe uma da outra e são habitadas por povos muito diferentes. O que as une é um trágico detalhe de sua geografia. Elas foram erguidas na vizinhança de alguns dos vulcões mais perigosos do mundo: o mexicano Popocatepetl e o filipino Mayon. Seus habitantes precisam estar prontos para correr a qualquer hora. Eles fazem parte dos 550 milhões de indivíduos que moram em zonas de risco vulcânico no mundo. Ao contrário do que seria sensato, continuam ali, indiferentes ao perigo que os espreita.\nANGELO, C. Disponível em: http://super.abril.com.br. Acesso em: 24 out. 2015 (adaptado).\nA característica física que justifica a fixação do homem nos locais apresentados no texto é a ocorrência de",
      subItens: []
    },
    options: ["solo fértil.","encosta íngreme.","vegetação diversificada.","drenagem eficiente.","clima ameno."],
    correctAnswer: 0,
    materia: "Geografia – Vulcanismo",
    conteudo: "Geografia – Riscos Naturais",
    imageNames: []
  }),
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "Ao abrigo do teto, sua jornada de fé começava na sala de jantar. Na pequena célula cristã, dividia-se a refeição e durante elas os crentes conversavam, rezavam e liam cartas de correligionários residentes em locais diferentes do Império Romano (século II da Era Cristã). Esse ambiente garantia peculiar apoio emocional às experiências intensamente individuais que abrigava.\nSENNET, R. Carne e pedra. Rio de Janeiro: Record, 2008.\nUm motivo que explica a ambientação da prática descrita no texto encontra-se no(a)",
      subItens: []
    },
    options: ["regra judaica, que pregava a superioridade espiritual dos cultos das sinagogas.","moralismo da legislação, que dificultava as reuniões abertas da juventude livre.","adesão do patriciado, que subvertia o conceito original dos valores estrangeiros.","decisão política, que censurava as manifestações públicas da doutrina dissidente.","violência senhorial, que impunha a desestruturação forçada das famílias escravas."],
    correctAnswer: 3,
    materia: "História – Roma Antiga",
...
createQuestion({
    ...
    year: 2020,
    text: {
      principal: "A colisão entre uma placa continental e uma oceânica provocará a subducção desta última sob a placa continental, que, a exemplo dos arcos e ilhas, produzirá um arco magmático na borda do continente, composto por rochas vulcânicas acompanhado de deformações e metamorfismo tanto de rochas preexistentes como de parte das rochas formadas no processo.\nTEIXEIRA, W. et al. (Org.). Decifrando a Terra. São Paulo: Oficina de Textos, 2000.\nQual feição fisiográfica é gerada pelo processo tectônico apresentado?",
      subItens: []
    },
    options: ["Planícies abissais.","Planaltos cristalinos.","Depressões absolutas.","Bacias sedimentares.","Dobramentos modernos."],
    correctAnswer: 4,
    materia: "Geografia – Geologia",
    conteudo: "Geografia – Tectonismo",
    imageNames: []
