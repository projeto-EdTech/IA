...
createQuestion({
    ...
    options: [
      "O mar, que só preza a pedra, que faz de coral suas árvores, luta por curar os ossos da doença de possuir carne,",
      "Sobre o lado ímpar da memória o anjo da guarda esqueceu perguntas que não se respondem.",
      "Com peixes e cavalos sonâmbulos pintas a obscura metafísica do limbo.",
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Portuguesa"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Referência Pronominal"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "de cidadãos para o exercício de funções administrativas por um curto período de tempo.",
      "de indivíduos da população da cidade para participarem da assembleia dos cidadãos na ágora.",
      "de habitantes mais hábeis militarmente e mais cultos para comporem o conselho político da polis.",
      "de homens e mulheres descendentes de gregos para governarem a cidade nos tempos de paz.",
      "de estrangeiros aliados da cidade para auxiliarem os cidadãos nas decisões concernentes às relações entre as polis."
    ],
    correctAnswer: 0,
    materia: ["História"],
...
createQuestion({
    ...
    options: [
      ...
      "do utilitarismo, que defendeu a produção especializada de objetos de consumo.",
      "do corporativismo, que propôs a organização da sociedade em grupos econômicos.",
      "do socialismo, que expôs a contradição entre produção e apropriação de riqueza.",
      "do mercantilismo, que elaborou princípios de protecionismo econômico."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Iluminismo e Economia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "tendência do governo imperial de evitar os relacionamentos da sociedade brasileira com as novidades europeias.",
      "incompatibilidade das tecnologias importadas com uma sociedade sustentada pelo trabalho escravo.",
      "questão das mudanças de costumes sociais provocadas por processos de modernização histórica.",
      "consciência do atraso histórico do Império no quadro das repúblicas democráticas da América.",
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Socialismo e Revolução Russa"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "expunha a facilidade de manipulação de analfabetos pela classe política dominante.",
      "denunciava o controle político dos votantes favorecido pelo voto a descoberto.",
      "condenava as eleições regulares de representantes políticos na Primeira República.",
      "criticava o domínio do poder federal por políticos de São Paulo e de Minas Gerais.",
      "reivindicava a liberdade de imprensa como condição necessária à democracia."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Primeira República"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "estratégico para a autonomia do Brasil, pois países capitalistas projetam incorporar o último espaço demograficamente vazio do planeta.",
      "específico de países como o Brasil, considerando a preservação histórica do equilíbrio ecológico nos países industrializados.",
      "desprovido de significado econômico, uma vez que a defesa da ecologia impede o desenvolvimento de países como o Brasil.",
      "agravado recentemente no Brasil, devido à sincronia entre a crise político-econômica e o avanço de processos ilegais de extração de riquezas naturais.",
      "irrelevante para o Brasil, tendo em vista a eficácia das decisões estatais preservacionistas em curso."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "perdeu seu conteúdo de renovação dos costumes nos países ricos da Europa.",
      "expressou a visão de mundo dos políticos norte-americanos conservadores.",
      "ganhou uma dimensão internacional graças à presença hegemônica dos Estados Unidos no mundo.",
      "produziu letras, ritmos invariáveis em nações e países diversos.",
      "foi aceito pelos movimentos culturais nacionalistas dos países latino-americanos."
    ],
    correctAnswer: 2,
    materia: ["Arte"],
...
createQuestion({
    ...
    options: [
      "de embargo econômico, que promovem a transferência de moedas para paraísos fiscais.",
      "neoliberais, que levam ao enfraquecimento dos mecanismos de controle estatal da economia.",
      "de reestruturação econômica, que promovem mudanças no âmbito da produção e da propriedade.",
      "keynesianas, que promovem o controle do Estado sobre os setores relacionados à infraestrutura.",
      "de planificação da economia, que levam à coexistência entre as propriedades estatais e as privadas."
    ],
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Globalização e Movimentos Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "do Primeiro Mundo, onde a revolução técnico-científica proporcionou a absorção da mão de obra urbana no processo de terceirização.",
      "de industrialização precoce, onde a revolução técnica ocorreu pela existência de matérias-primas próximas aos locais de produção.",
      "do Terceiro Mundo, onde as desigualdades socioespaciais promoveram o incremento do setor terciário ligado à produção agrícola.",
      "de industrialização recente, onde houve uma rápida modernização do setor secundário, com a ampliação do papel do Estado na indústria de base.",
      "de industrialização tardia, onde houve a modernização das atividades agrícolas, que expulsaram trabalhadores rurais para as cidades."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Urbanização", "Economia Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "empresas de tecnologia militar.",
      "indústrias de monitoramento por radar.",
      "agências de pesquisas espaciais."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Indústria e Tecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "importação de alta tecnologia da União Europeia.",
      "exportação de produtos manufaturados para o Mercosul.",
      "exportação de commodities para a China.",
      "importação de produtos semimanufaturados dos Estados Unidos.",
      "exportação de produtos terciários para a Índia."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Economia Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "à direção do movimento das placas litosféricas.",
      "ao deslocamento das correntes marítimas.",
      "à direção do assoalho oceânico em profundidade.",
      "à direção das correntes de ressurgência.",
      "ao deslocamento do manto terrestre fluido."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geologia"],
...
createQuestion({
    ...
    options: [
      "planície litorânea, uma forma do relevo desgastada pelo tempo.",
      "escudo cristalino, uma forma do relevo que sofreu subsidência.",
      "ravina, uma forma do relevo erodida pelo escoamento superficial.",
      "aluvião, uma forma do relevo que apresenta solos porosos.",
      "depressão absoluta, uma forma do relevo abaixo do nível do mar."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "massa polar do pacífico.",
      "frente fria atlântica.",
...
createQuestion({
    ...
    options: [
      "redução do albedo em superfície.",
      "redução do número de organismos vivos.",
      "redução da intensidade da erosão eólica.",
      "elevação da produtividade agrícola monocultora.",
      "elevação do processo de humificação do solo."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "a escassez hídrica, que é menor onde a oferta de água é realizada por rios intermitentes.",
      "a segurança hídrica, que é maior nas bacias onde a perenidade dos rios é constante.",
      "o potencial hídrico, que é maior na área meridional sob influência da evapotranspiração.",
      "o estresse hídrico, que é maior nas regiões onde a densidade demográfica é alta.",
      "a crise hídrica, que é menor na parcela oriental, onde a oferta de água é abundante."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Recursos Hídricos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "no complexo golgiense e no retículo endoplasmático.",
      "no peroxissomo e no ribossomo.",
      "no citoesqueleto e na mitocondria.",
      "nos centríolos e no lisossomo.",
      "no envoltório nuclear e no cromossomo."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Citologia"],
...
createQuestion({
    ...
    options: [
      "quando os parasitas estão ausentes, as espécies X e Y não competem entre si.",
      "quando os parasitas estão ausentes, a espécie X é melhor competidora do que a espécie Y.",
      "quando os parasitas estão presentes, a espécie X é melhor competidora do que a espécie Y.",
      "os parasitas não influenciam a competição entre as duas espécies de roedores.",
      "quando os parasitas estão presentes, a espécie Y é melhor competidora do que a espécie X."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Ecologia"],
...
createQuestion({
    ...
    options: [
      "normas de reação, que apareceram por mutações induzidas.",
      "características adaptativas, que foram selecionadas pelo ambiente.",
      "órgãos homólogos, que surgiram para adaptá-los ao ambiente.",
      "órgãos vestigiais, que ficaram cada vez mais complexos com o tempo.",
      "órgãos análogos, que surgiram pela necessidade de sobrevivência."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Evolução"],
...
createQuestion({
    ...
    options: [
      "armazena os espermatozoides produzidos pelos testículos.",
      "secreta substâncias que alcalinizam o pH do fluido vaginal.",
      "secreta o volume total do sêmen, que nutre os gametas.",
      "produz o hormônio testosterona, que estimula a ereção peniana.",
      "contém um conjunto de nervos que desencadeia a ereção peniana."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "serão originadas quatro células-filhas geneticamente idênticas.",
      "cada célula-filha terá quatro cromossomos diferentes.",
      "cada célula-filha terá dois cromossomos diferentes.",
      "serão originadas duas células-filhas geneticamente idênticas.",
      "a divisão ocorreu em uma célula somática, originando duas células-filhas idênticas."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Genética"],
...
createQuestion({
    ...
    options: [
      "membrana plasmática e organelas membranosas.",
      "inclusões citoplasmáticas e envoltório nuclear.",
      "moléculas de DNA lineares e plasmídeos.",
      "material genético disperso e ribossomos.",
      "citoesqueleto e parede com peptidoglicano."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "de massa e de elétrons.",
      "atômico e de elétrons.",
      "de massa e de nêutrons.",
      "atômico e de massa.",
      "atômico e de nêutrons."
    ],
    correctAnswer: 0,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "iônicos – óxidos - fertilizantes.",
      "iônicos - sais - fertilizantes.",
      "iônicos – sais – xampus.",
      "moleculares – óxidos – fertilizantes.",
      "moleculares – sais - xampus."
    ],
    correctAnswer: 1,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "conduzem igualmente corrente elétrica.",
      "apresentam pH < 7 a 25 °С.",
      "reagem com ácidos gerando sais e água.",
      "são neutralizadas com água de cal.",
      "têm a mesma concentração de íons OH-."
    ],
    correctAnswer: 2,
    materia: ["Química"],
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Progressões", "Polinômios"],
    imageNames: []
}),
