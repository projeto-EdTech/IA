...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Trigonometria", "Geometria Plana", "Resolução de Problemas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Sequências Numéricas", "Progressões Aritméticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Funções Logarítmicas", "Análise de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Matrizes", "Álgebra Linear", "Porcentagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Análise Combinatória", "Permutação e Combinação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Eutrofização", "Impactos Ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Genética", "Cariótipo", "Anomalias Cromossômicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "os espinhos são anexos epidérmicos e os acúleos são folhas ou ramos modificados e ambos atuam na proteção.",
      "os espinhos e os acúleos são ramos modificados e atuam na secreção de substâncias.",
      "os espinhos e os acúleos são anexos epidérmicos e atuam na captação de luz.",
      "os espinhos e os acúleos são folhas modificadas e atuam na proteção.",
      "os espinhos são folhas ou ramos modificados e os acúleos são anexos epidérmicos e ambos atuam na proteção."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "A fermentação ocorre na ausência de gás oxigênio e a respiração celular ocorre somente na presença desse gás. As duas reações geram energia, armazenada na forma de ATP.",
      "A fermentação ocorre na presença de gás carbônico e a respiração celular ocorre na ausência desse gás. As duas reações geram ATP, um tipo de energia.",
      "A fermentação ocorre na ausência de gás oxigênio e a respiração celular ocorre somente na presença desse gás. As duas reações absorvem energia da molécula de ATP.",
      "A fermentação ocorre na presença de ácido lático e a respiração celular ocorre na ausência desse ácido. As duas reações liberam a mesma quantidade de energia na forma de ATP.",
      "A fermentação ocorre na presença de gás oxigênio e a respiração celular ocorre na ausência desse gás. As duas reações geram energia, armazenada na forma de ATP."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Bioquímica", "Metabolismo Energético", "Respiração Celular", "Fermentação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Genética", "Hereditariedade Ligada ao Sexo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Genética Molecular", "Estrutura do DNA"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "por sua política de importação de alimentos cultivados junto ao Mar Mediterrâneo.",
      "por seu objetivo imperialista de conquistar a hegemonia política na porção oriental do globo.",
      "por seus acordos de cooperação técnico-científica na área do meio ambiente.",
      "por sua dependência energética das importações de petróleo dos Estados do Golfo.",
      "por sua vocação humanitária ao difundir práticas que ajudaram a melhorar os indicadores sociais chineses."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geopolítica", "Relações Internacionais", "Oriente Médio"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ao liberalismo e ao neoliberalismo.",
      "ao keynesianismo e ao mercantilismo.",
      "ao liberalismo e ao mercantilismo.",
      "ao mercantilismo e ao keynesianismo.",
      "ao keynesianismo e ao neoliberalismo."
    ],
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["Economia", "Liberalismo", "Neoliberalismo", "Teorias Econômicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "de melhorias em regiões pré-definidas, por meio de parcerias entre o poder público e a iniciativa privada.",
      "de prioridades de mobilidade urbana para garantir a sustentabilidade, a eficiência e os menores custos nos deslocamentos.",
      "de diferenças entre a regularização fundiária de interesse social e a de interesse específico para agilizar a legitimação de posse da terra.",
      "de princípios, diretrizes e normas para que o processo de desenvolvimento se realize entre os diferentes agentes do espaço urbano.",
      "de regras de parcelamento, uso e ocupação do solo para definir as atividades que podem ser instaladas nos diferentes lugares da cidade."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      ...
      "a redução da produtividade em alguns setores da economia.",
      "a diminuição dos postos de trabalho ofertados.",
      "a estabilidade no sistema público de seguridade social.",
      "o incremento da população economicamente ativa."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Demografia", "Estrutura Populacional", "Consequências Sociais e Econômicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "natural e antrópico.",
      "geológico e climático.",
      "geológico e social.",
      "social e econômico."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Cartografia", "Desastres Naturais", "Riscos Geológicos", "Riscos Climáticos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "superficial ocorrerá primeiro no solo argiloso.",
      "subsuperficial sofrerá saturação por último no solo arenoso.",
      "superficial ocorrerá primeiro no solo siltoso.",
      "subsuperficial sofrerá saturação por último no solo argiloso.",
      "superficial ocorrerá primeiro no solo arenoso."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Pedologia", "Hidrografia", "Solos e Drenagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "pelo processo de terraceamento, que altera o fluxo superficial das águas que chegam à represa.",
      "pela degradação do solo, que promove a laterização decorrente da impermeabilização da área.",
      "pela ocorrência da inversão térmica, que aumenta a temperatura local com a instalação de equipamentos urbanos.",
      "pelo comprometimento da área de nascentes, que diminui os espaços permeáveis de recarga da represa.",
      "pela chegada de espécies invasoras, que prejudica o equilíbrio do ecossistema com a implantação de novos usos."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Meio Ambiente", "Urbanização e Recursos Hídricos", "Impactos Ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ser amplamente encontrado no bioma da caatinga.",
      "substituir matas sem função econômica pelo seu cultivo.",
      "ajudar na redução do déficit habitacional.",
      "configurar um recurso renovável e biodegradável.",
      "suprir a demanda industrial por aço."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Meio Ambiente", "Recursos Naturais e Sustentabilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a tentativa de produzir alternativas ao uso de herbicidas na produção agrícola.",
      "a baixa exigência de equipamentos de proteção individual para manipular a produção agrícola.",
      "o manejo retrógrado estipulado pelos órgãos de controle do setor agrícola.",
      "o uso exacerbado de defensivos agrícolas no modelo de agricultura contemporâneo.",
      "o comprometimento da produção agrícola pela resistência ao uso de insumos agrícolas."
    ],
    correctAnswer: 3,
    materia: ["Sociologia", "Geografia"],
    conteudo: ["Indústria Cultural e Consumo", "Agricultura e Meio Ambiente", "Saúde Pública"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Cartografia", "Geodésia", "Astronomia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Estática", "Torque e Equilíbrio"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Leis de Kepler", "Gravitação", "Movimento Orbital"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Ondas", "Ondas Eletromagnéticas", "Ondas Estacionárias"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica", "Resistência Elétrica", "Leis de Kirchhoff"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "no sentido anti-horário entre t₀ e t₁ e entre t₁ e t₂.",
      "no sentido horário entre t₀ e t₁ e entre t₁ e t₂.",
      "no sentido horário entre t₀ e t₁ e no anti-horário entre t₁ e t₂.",
      "no sentido anti-horário entre t₀ e t₁ e no horário entre t₁ e t₂.",
      "no sentido anti-horário entre t₀ e t₁ e não haverá corrente induzida entre t₁ e t₂."
    ],
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Indução Eletromagnética", "Lei de Lenz"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Antiguidade Clássica", "Grécia Antiga", "Democracia Ateniense"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Idade Média", "Cidade Medieval", "Cristianismo na Idade Média"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Brasil Colônia", "Expansão Marítima", "Documentos Históricos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "procurava enviar para a América o excesso de população dos continentes europeu e africano.",
      "inaugurava a base de uma democracia social, política e econômica nas terras coloniais da América portuguesa.",
      "estava baseado na produção em grande escala de produtos tropicais para exportação.",
      "tinha por finalidade defender o território da ocupação de países europeus inimigos de Portugal.",
      "buscava, por meio da exploração da mão de obra escrava africana, expandir as fronteiras do cristianismo."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Brasil Colônia", "Economia Colonial", "Sociedade Colonial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Idade Moderna", "Revolução Inglesa", "Absolutismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Idade Contemporânea", "Iluminismo", "Independência das Américas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "pretendeu abolir as bases econômicas do governo republicano, extinguindo a propriedade rural monocultora.",
      "mobilizou os oficiais militares contrários ao regime republicano e à extensão do direito de voto à população brasileira.",
      "foi uma manifestação dos antigos grupos dominantes afastados do poder devido à proclamação da República.",
      "ficou restrito ao estado de São Paulo, fato que o isolou do restante do país e facilitou a sua derrota.",
      "procurou reformar os procedimentos políticos republicanos, sustentados por fraudes eleitorais, assim como pelo voto a descoberto."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Brasil República", "Tenentismo", "República Oligárquica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "a tentativa de superação de crises econômicas agudizadas por meio do aumento excepcional na produção de armamentos.",
      "o caráter negativo da guerra de destruição sobre o conjunto das nações industrializadas."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Idade Contemporânea", "Primeira Guerra Mundial", "Economia Mundial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Brasil República", "Governo Juscelino Kubitschek", "Industrialização no Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a ajuda chinesa aos países pobres visa à expansão do socialismo.",
      "o desnível social e econômico das nações diminuiu sensivelmente.",
      "as potências globais começaram a estimular o desenvolvimento de fontes de energia menos agressivas ao meio ambiente.",
      "a ordem mundial contemporânea passa por mudanças significativas.",
      "as eventuais crises econômicas ficarão restritas a certas regiões do globo."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geopolítica", "Economia Global", "Relações China-América Latina"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "imantação, seguida de decantação.",
      "imantação, seguida de levigação.",
      "imantação, seguida de filtração.",
      "combustão, seguida de levigação.",
      "combustão, seguida de decantação."
    ],
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Separação de Misturas", "Propriedades Físicas da Matéria"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Gases", "Estequiometria", "Gases Ideais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Estequiometria", "Massas Molares"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a ureia apresenta apenas ligações iônicas e o sulfato de amônio, ligações covalentes e iônicas.",
      "o sulfato de amônio apresenta apenas ligações iônicas e a ureia, ligações covalentes e iônicas.",
      "ambas possuem apenas ligações covalentes.",
      "ambas possuem apenas ligações iônicas.",
      "a ureia apresenta apenas ligações covalentes e o sulfato de amônio, ligações covalentes e iônicas."
    ],
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Ligações Químicas", "Química Orgânica", "Química Inorgânica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Isomeria Óptica", "Nomenclatura Orgânica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Estequiometria", "Mol e Massa Molar"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Reações Químicas", "Oxirredução", "Pilhas e Eletrólise"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "temperatura – pressão – CO₂ (g).",
      "pressão - temperatura – catalisador.",
      "pressão – temperatura – CO₂ (g).",
      "pressão - temperatura – C (s)."
    ],
    correctAnswer: 0,
    materia: ["Química"],
...
createQuestion({
    ...
    conteudo: ["Interpretação de Texto", "Movimentos Literários"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática", "Tempos Verbais", "Semântica Verbal"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Filosofia", "História", "Língua Portuguesa"],
    conteudo: ["Filosofia Política", "Relações Igreja-Estado", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática", "Conectivos", "Semântica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Figuras de Linguagem", "Análise Literária"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática", "Preposição", "Semântica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Movimentos Literários", "Romantismo", "Poesia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Análise Literária", "Poesia Romântica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto", "Leitura e Interpretação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Gramática", "Referência Pronominal"],
    imageNames: []
}),
