createQuestion({
    ...
    options: [
      "Um dos objetivos do texto é informar o leitor sobre o fato de que ele mesmo é um youtuber e, a partir disso, é possível inferir também certa divulgação do seu próprio trabalho nesse espaço.",
      "O texto tem como intenção principal expor objetivamente características dos youtubers, fato que se comprova por meio dos dados numéricos citados.",
...
createQuestion({
    ...
    options: [
      "O sentido da palavra como é diferente em cada um dos trechos.",
      "No trecho \"c\" a palavra introduz a ideia de causa.",
...
createQuestion({
    ...
    options: [
      "No trecho \"a\", trata-se de um pronome reflexivo.",
      "No trecho \"b\", trata-se de um pronome demonstra-tivo.",
...
createQuestion({
    ...
    options: [
      "Este soneto pertence à obra cultista de Gregório de Matos, onde denotamos a fortuna lúdica desde a exploração da antítese \"parte & todo\".",
      "O poema tem como tema o achado de um braço de menino Jesus, parte estilhaçada de uma imagem venerada na Sé da Bahia e que fora assolada por infiéis.",
...
createQuestion({
    ...
    options: [
      "Um exemplo clássico da arquitetura bizantina é a Hagia Sofia (A Igreja da Sabedoria Sagrada), atu-almente um museu, que foi construída em 532-37 em Constantinopla.",
      "O mosaico bizantino Justiniano e seu Séquito data-do de 547 d.C., localizado na Igreja de San Vitale, em Ravena, na Itália, apresenta um ideal de beleza humana com figuras altas e esguias, pés minúscu-los, rostos pequenos em forma de amêndoa, olhos grandes, e corpos exibindo trajes finos.",
...
createQuestion({
    ...
    options: [
      "A percepção da forma, da profundidade e do claro-escuro está estreitamente ligada à percepção da cor.",
      "A luz branca não tem uma cor específica, mas con-tém todas as cores.",
...
createQuestion({
    ...
    options: [
      "No período medieval, empregaram-se sistemas es-peciais de escalas denominados modos.",
      "Uma das principais expressões da música religiosa medieval denominava-se cantochão, e era cantada em uníssono.",
...
createQuestion({
    ...
    options: [
      "O Barroco é o período da história da música que vai do aparecimento da ópera e do oratório até a morte de Johann Sebastian Bach, ou seja, de cerca de 1600 até aproximadamente 1750.",
      "No Barroco, os compositores demostravam um grande virtuosismo técnico, principalmente na exe-cução de peças com temáticas nacionalistas execu-tadas, preferencialmente, ao piano.",
...
createQuestion({
    ...
    options: [
      "No período Neolítico, as técnicas de pintura rupes-tre eram rudimentares com o predomínio da con-fecção de esculturas feitas com ossos de animais.",
      "A arte rupestre possuía a função estética de relatar fatos do cotidiano do homem pré-histórico. Nela, encontram-se as primeiras expressões de perspec-tiva linear, complexidade cromática e profundidade de campo.",
...
createQuestion({
    ...
    options: [
      "Em A, está representada uma célula vegetal colo-cada em solução hipotônica, a qual absorve água por osmose, tornando-se túrgida. Ao contrário da célula animal, a célula vegetal não corre risco de estourar, por causa da parede celular.",
      "Em B, a célula está em solução idêntica à do con-teúdo celular (ou seja, isotônica). Nesse caso, as pressões de entrada e de saída de água por osmo-se são equivalentes.",
...
createQuestion({
    ...
    options: [
      "O ciclo das pentoses ocorre nas membranas dos ti-lacoides e é composto de reações que incluem a absorção de luz, fixação do carbono e liberação de ATP e CO2.",
      "Os glicídios produzidos na fase clara da fotossínte-se são utilizados durante a reprodução da planta, fase da vida na qual a demanda de energia é maior.",
...
createQuestion({
    ...
    options: [
      "O tecido conjuntivo cartilaginoso possui como célu-las principais os osteócitos, formados a partir de osteoblastos. Tem função de sustentação e tam-bém permitem a flexibilidade dos membros, visto que possuem sais de cálcio e fibras em sua consti-tuição.",
      "O tecido conjuntivo adiposo é rico em células que acumulam gordura, os adipócitos, os quais funcio-nam como reserva de energia e proteção contra o frio. Este tecido pode ser encontrado ainda envol-vendo alguns órgãos, protegendo-os contra trau-mas durante os movimentos do corpo.",
...
createQuestion({
    ...
    options: [
      "Em A, tem-se os ovos isolécitos (ou oligolécitos), os quais apresentam pouco vitelo distribuído de forma mais ou menos homogênea no citoplasma. Está presente em moluscos e anelídeos, por exem-plo.",
      "Os ovos telolécitos C apresentam grande quanti-dade de vitelo, o qual ocupa quase totalmente a célula. Pode-se encontrar este tipo de ovo em aves, peixes e répteis, por exemplo.",
...
createQuestion({
    ...
    options: [
      "Em uma circunferência, a medida de um ângulo central, em radianos, é definida pela razão entre o comprimento do arco correspondente a esse ângulo e a medida do raio da circunferência.",
      "A aceleração centrípeta, bem como a velocidade vetorial, são constantes em módulo, contudo vari-áveis em direção.",
...
createQuestion({
    ...
    options: [
      "Toda força perpendicular ao deslocamento realiza trabalho.",
      "O trabalho realizado por uma força constante, apli-cada a um corpo, é uma grandeza escalar.",
...
createQuestion({
    ...
    options: [
      "Este elemento químico é um metal alcalino.",
      "Este elemento se encontra no quarto período da tabela periódica.",
...
createQuestion({
    ...
    options: [
      "Átomos de C possuem 6 elétrons em sua eletrosfe-ra, distribuídos em dois níveis energéticos.",
      "Os átomos N, C e B são isótopos entre si.",
...
createQuestion({
    ...
    options: [
      "A ligação existente entre os átomos de carbono e oxigênio na molécula do dióxido de carbono é a li-gação covalente.",
      "A molécula de dióxido de carbono é polar.",
...
createQuestion({
    ...
    options: [
      "São reações em que uma substância composta é desdobrada em duas ou mais substâncias simples ou compostas.",
      "Na reação 2HgO → 2Hg + O2, o óxido de mercúrio III se decompõe em mercúrio e gás oxigênio.",
...
createQuestion({
    ...
    options: [
      "Ao aquecer HF, podemos romper as ligações de hi-drogênio, enquanto que ao aquecer HCl, HBr e HI podemos romper as interações do tipo dipolo-dipolo.",
      "As moléculas de bromo, Br2, estão unidas no esta-do líquido por interações do tipo dipolo induzido-dipolo induzido.",
...
createQuestion({
    ...
    options: [
      "a + b + c - d é um número quadrado perfeito.",
      "(b-a)/(d-c) é um número primo.",
...
createQuestion({
    ...
    options: [
      "Para que a indústria tenha o maior lucro possível, deve produzir 35 peças por dia.",
      "Se a indústria produzir 60 peças num único dia, te-rá prejuízo.",
...
createQuestion({
    ...
    options: [
      "A soma do primeiro termo da progressão aritmética com o da progressão geométrica é 32.",
      "A soma dos três primeiros termos da progressão aritmética é 240.",
...
createQuestion({
    ...
    options: [
      "O vértice da parábola que representa a função g(x) tem coordenadas (2,9).",
      "A função f(x) + n(x) tem sinal positivo para x ≥ 1.",
...
createQuestion({
    ...
    options: [
      "Tribuno da Plebe foi um cargo que existia na estru-tura administrativa da Grécia e representava a conquista dos plebeus enquanto classe menos fa-vorecida.",
      "Esparta e Atenas foram as cidades-Estado que mais se destacaram por sua capacidade de lideran-ça.",
...
createQuestion({
    ...
    options: [
      "A estrutura da sociedade foi fortemente estratifica-da, isto é, estava dividida em grupos sociais forte-mente separados entre si.",
      "A crença na imortalidade fez com que os egípcios encarassem a morte como um grande aconteci-mento.",
...
createQuestion({
    ...
    options: [
      "Atualmente, pode-se conhecer sobre os povos pré-colombianos por meio das descobertas arqueológi-cas como o Coliseu, cujas ruínas podem ser visita-das.",
      "Os arqueólogos registraram, entre os povos cha-mados pré-colombianos, um tipo de escrita que fi-cou conhecida como cuneiforme.",
...
createQuestion({
    ...
    options: [
      "Em uma das fases da história, os povos africanos se unificaram e formaram o chamado Reino de Is-rael.",
      "O Reino de Gana ficou conhecido em razão de sua produção de ouro. Segundo registros, a extração do minério foi tão grande que Gana se tornou o principal fornecedor do metal ao mundo mediterrâ-neo.",
...
createQuestion({
    ...
    options: [
      "Historiografia é o registro da História enquanto ciência que estuda, analisa e registra os fatos his-tóricos.",
      "Tradicionalmente, o estudo da História é dividido em Idades: Antiga, Média, Moderna e Contemporâ-nea.",
...
createQuestion({
    ...
    options: [
      "Território é um conceito de espaço relacionado a poder e leis.",
      "O conceito de lugar está impregnado de relações de convivência e afetivas entre as pessoas.",
...
createQuestion({
    ...
    options: [
      "Na continentalidade, a amplitude térmica é mínima se comparada à oceanidade. Isso explica porque o Hemisfério Sul é mais frio que o Hemisfério Norte da Terra.",
      "O Polo Sul é mais frio que o Polo Norte, em média. Isso decorre do fato que o Polo Sul possui massa continental (Antártida) com altitudes de mais de 2000 mil metros, enquanto o ponto mais ao norte do Polo Norte possui oceano congelado.",
...
createQuestion({
    ...
    options: [
      "É um efeito natural da Terra onde gases como va-por de água e gás carbônico ajudam a impedir a saída da radiação proveniente do Sol absorvida pe-la superfície terrestre.",
      "Um dos gases mais importantes no efeito estufa é o metano, que pode ser gerado a partir de decom-posição de material orgânico.",
...
createQuestion({
    ...
    options: [
      "Thomas Malthus afirmava, no século XVIII, que o crescimento elevado da população não se ajustava à capacidade limitada dos recursos naturais exis-tentes no planeta, sobretudo alimentos.",
      "A pirâmide etária de países subdesenvolvidos tem a base mais larga e o topo estreito.",
...
createQuestion({
    ...
    options: [
      "A filosofia desse período é conhecida também como Patrística, com a introdução de ideias desconheci-das para os filósofos Greco-romanos.",
      "Caracteriza-se pelo desenvolvimento do saber racional em contraste com o conhecimento mitoló-gico.",
...
createQuestion({
    ...
    options: [
      "Tem caráter \"purificador\" pelo fato de levar seus discípulos a confessarem suas próprias contradi-ções e ignorâncias, partindo então para o caminho da reconstrução das ideias.",
      "Consiste em dois momentos básicos: ironia e mai-êutica.",
...
createQuestion({
    ...
    options: [
      "Fundamenta-se na multiplicidade das várias formas de saber, que constituem um grande conjunto de concepções aceitas como verdadeiras, transfor-mando-se em frases populares, como: \"Querer é poder.\"",
      "Caracteriza-se pela problematização das coisas e pela busca da explicação e da verdade, repugnando a opinião.",
...
createQuestion({
    ...
    options: [
      "A lógica é um instrumento para as ciências, portan-to não é teorética e tem como objeto, a proposi-ção, que é constituída por categorias.",
      "O conjunto das obras lógicas aristotélicas recebeu o nome de Órganon.",
...
createQuestion({
    ...
    options: [
      "Para os filósofos modernos (a partir do século XVII), a questão do conhecimento foi considerada precedente à ontologia e pré-requisito para a filo-sofia e as ciências.",
      "O filósofo Francis Bacon, em sua obra Novum organum, destaca quatro gêneros de ídolos que embaraçam a mente humana: ídolos da tribo, ído-los da caverna, ídolos do foro e ídolos do teatro.",
...
createQuestion({
    ...
    options: [
      "Para Marx a inserção numa classe social se dá pela forma de entender e compreender a mesma.",
      "Weber e Durkheim compartilham a ideia de que o fato e a ação social são complementares entre si.",
...
createQuestion({
    ...
    options: [
      "Faz parte das estruturas das sociedades as se-guintes instituições: família, estado, igreja e esco-la.",
      "Os grupos sociais assemelham-se às instituições sociais ao criarem suas próprias normas e assim fi-carem isentos de cumprir as normas institucionais.",
...
createQuestion({
    ...
    options: [
      "Cada um de nós entende a cultura de outros po-vos, a partir da cultura que nos é transmitida na sociedade que fazemos parte.",
      "A cultura é resultado de parte do processo da evo-lução humana.",
...
createQuestion({
    ...
    options: [
      "O número de aves é um indicador da saúde de um ecossistema.",
      "Mudanças de temperatura podem reduzir muito os habitats de aves que representam dez estados dos EUA.",
...
createQuestion({
    ...
    options: [
      "Eles estão no presente contínuo, presente simples e passado simples, respectivamente.",
      "São, pela ordem, um verbo regular, um verbo irre-gular e um verbo regular.",
...
createQuestion({
    ...
    options: [
      "Ambos são adjetivos compostos.",
      "São um substantivo composto e um adjetivo com-posto, respectivamente.",
...
createQuestion({
    ...
    options: [
      "Observadores de pássaros reportam até oito mi-lhões de avistamentos por mês ao eBird.",
      "Observadores de pássaros já ajudaram a salvar da extinção 250 milhões de aves.",
...
createQuestion({
    ...
    options: [
      "Esse programa abrange toda a parte central dos EUA.",
      "Sai mais barato criar esses habitats temporários do que estabelecer e manter reservas permanentes.",
