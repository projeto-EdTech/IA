createQuestion({
    ...
    options: [
      "A palavra \"perdendo\", empregada na frase, é uma forma nominal do verbo chamada de gerúndio, que expressa uma ação em andamento.",
      "A forma verbal \"perdendo\", utilizada no período, está conjugada na terceira pessoa do plural do futuro do modo subjuntivo.",
...
createQuestion({
    ...
    options: [
      "O elemento \"ultra\", presente no termo \"ultraprocessados\", tem como função acrescentar à palavra o significado de \"extremamente\" ou \"excessivamente\".",
      "O constituinte \"ultra\", que integra a palavra \"ultraprocessados\", é um exemplo de prefixo de origem latina.",
...
createQuestion({
    ...
    options: [
      "Apesar de o feijão ser rico em vitaminas, proteínas e minerais, inclusive ferro, além de fibras solúveis e insolúveis, que ajudam no funcionamento da digestão, pesquisas recentes apontaram que somente outros vegetais oferecem a vitamina B12.",
      "A entrada de transnacionais do setor de alimentos e a maior participação das mulheres no mercado de trabalho, na década de 1980, mudaram o perfil de consumo da população, que passou a enxergar nos ultraprocessados uma alternativa mais prática para o cotidiano.",
...
createQuestion({
    ...
    options: [
      "De janeiro de 2012 a janeiro de 2023, o feijão carioca subiu de preço 33% mais do que a inflação acumulada no período.",
      "De janeiro de 2012 a janeiro de 2023, o feijão preto teve uma alta de preço 97% maior do que a inflação acumulada no período.",
...
createQuestion({
    ...
    options: [
      "O trecho sublinhado é constituído por uma perífrase.",
      "Os termos sublinhados constituem uma elipse que evita a repetição da palavra \"feijão\".",
...
createQuestion({
    ...
    options: [
      "Na videodança, o movimento e a coreografia são idealizados para a tela, integrando dança e audiovisual.",
      "Máquinas, luzes, estruturas de cenografia, projeção de imagens e uso de softwares são recursos tecnológicos utilizados em produções artísticas visuais, musicais e cênicas.",
...
createQuestion({
    ...
    options: [
      "No Teatro Fórum, as encenações são interrompidas no auge do conflito e os \"espect-atores\" são conduzidos pelo \"curinga\" a intervir na ação teatral e a propor os desfechos para as peças.",
      "No Teatro do Oprimido, os jogos e exercícios teatrais exploram possibilidades criativas de representar, de modo que os sujeitos possam se autoconhecer, dialogar, intervir e transformar as cenas.",
...
createQuestion({
    ...
    options: [
      "0 choro é uma prática musical conjunta, essencialmente brasileira, que se desenvolveu a partir da segunda metade do século XX, cujas composições apresentam versos cantados sobre temas românticos.",
      "Cavaquinho, bandolim, violão 7 cordas, flauta, clarinete e pandeiro são instrumentos musicais utilizados para se executar o choro.",
...
createQuestion({
    ...
    options: [
      "A cultura Hip-Hop se expressa por meio dos elementos artísticos: musicais (graffiti), corporais (rap) e visuais (breaking).",
      "As manifestações do movimento Hip-Hop surgiram e começaram a ganhar força no Brasil por volta do ano de 1980, em especial na cidade de São Paulo.",
...
createQuestion({
    ...
    options: [
      "Na pintura expressionista O Grito, Edvard Munch demonstra maior preocupação com a intensidade da emoção a ser transmitida do que com o equilíbrio formal da obra.",
      "Os artistas impressionistas Claude Monet e Pierre August Renoir se empenharam em explorar as superfícies que refletiam a luz e criaram pinturas sem contornos nítidos e com cores puras aplicadas na tela com pequenas pinceladas.",
...
createQuestion({
    ...
    options: [
      "Surgimento de aparelhos modernos.",
      "Influência da filosofia grega nas práticas das atividades físicas.",
...
createQuestion({
    ...
    options: [
      ...
      "São exclusivamente praticadas em ambientes fechados.",
...
createQuestion({
    ...
    options: [
      "Os jogos populares são praticados de acordo com o estilo de vida de uma determinada cultura.",
      "Os jogos eletrônicos não trazem benefícios físicos ao seu praticante.",
...
createQuestion({
    ...
    options: [
      "As células procarióticas são ditas não compartimentalizadas. Nelas, a membrana plasmática estabelece os limites da célula, organizando uma barreira seletiva do meio circundante.",
      "Procariotos mantêm uma ampla comunicação intracelular mediada por vesículas secretórias que surgem no retículo endoplasmático rugoso, de onde são endereçadas a outras organelas.",
...
createQuestion({
    ...
    options: [
      "Os lisossomos atuam na digestão intracelular, são delimitados por membrana lipoproteica e apresentam conteúdo ácido. Neles, estão contidas uma série de enzimas: as hidrolases ácidas.",
      "As principais hidrolases ácidas presentes nos lisossomos são as proteases, as lipases, as carboidrases e as nucleases.",
...
createQuestion({
    ...
    options: [
      "Os processos de transcrição e de tradução ocorrem no núcleo celular de uma célula eucariótica, local onde estão presentes os genes, os ribossomos e as enzimas necessárias para os eventos de síntese.",
      "No processo conhecido como transcrição, uma das fitas do DNA (gene) é utilizada como molde para a síntese de uma fita complementar de RNA.",
...
createQuestion({
    ...
    options: [
      "Em I, está representada a difusão simples. Nela, algumas moléculas pequenas e apolares podem se mover passivamente através da bicamada lipídica a favor do seu gradiente de concentração.",
      "Em II e III, estão representadas as vias em que os solutos necessitam da assistência de um canal ou transportador para atravessar a membrana plasmática. Essas vias de transporte passivo permitem que as moléculas se movam a favor dos seus gradientes de concentração.",
...
createQuestion({
    ...
    options: [
      "Sociedades são relações interespecíficas formadas por organismos dependentes organizados cooperativamente.",
      "No mutualismo, indivíduos de espécies diferentes associados se beneficiam e a associação é fundamental à sobrevivência de ambos.",
...
createQuestion({
    ...
    options: [
      "A célula A corresponde ao espermatócito primário (espermatócito I).",
      "O processo representado pela letra Z na imagem corresponde à espermiogênese.",
...
createQuestion({
    ...
    options: [
      ...
      "Para aquecer 0,5 L de água de 20 °C até 60 °C, são necessárias 2 x 10⁴ cal.",
...
createQuestion({
    ...
    options: [
      "O óxido de alumínio e o gás carbônico são compostos covalentes ou moleculares e são classificados como óxidos anfóteros.",
      "Fe₂O₃ é a fórmula do óxido de ferro III, composto iônico em que o ferro tem nox igual a +3.",
...
createQuestion({
    ...
    options: [
      "Em um grupo, o raio atômico aumenta com o aumento do número atômico.",
      "Em um período, os elementos apresentam propriedades químicas semelhantes.",
...
createQuestion({
    ...
    options: [
      "Há uma mistura heterogênea constituída por duas substâncias.",
      "Há duas substâncias equilibradas em três fases.",
...
createQuestion({
    ...
    options: [
      "Elétrons dos metais presentes nos fogos de artifício sofrem excitação eletrônica e, posteriormente, liberação de energia sob a forma de luz, cuja cor é característica de cada metal.",
      "O fenômeno de emissão de luz colorida pelos fogos de artifício está em concordância com a transição eletrônica, conforme o modelo atômico de Bohr.",
...
createQuestion({
    ...
    options: [
      "Se um capital de R$ 1000,00 é aplicado durante 4 meses, à taxa de juros de 10% ao mês, então a diferença entre os valores do montante a juros compostos e do montante a juros simples é de R$ 64,10.",
      "Se a população de uma cidade de cerca de 50000 habitantes cresce anualmente 2,5%, então, ao fim de 2 anos, ela terá 52500 habitantes.",
...
createQuestion({
    ...
    options: [
      "A Escola A apresenta o menor desvio médio entre as notas médias de todas as escolas nos três últimos anos.",
      "Se for levada em conta a maior média das notas médias de cada escola nos últimos três anos, a vencedora será a Escola D.",
...
createQuestion({
    ...
    options: [
      "O governo do estado deve contratar um total de 55 técnicos especialistas para auxiliar no combate à doença.",
      "Se a região Norte registrasse mais 40 casos além dos já registrados, o governo do estado deveria contratar um total de 45 técnicos especialistas para auxiliar no combate à doença.",
...
createQuestion({
    ...
    options: [
      "Estrangeiros, prisioneiros de guerra e mulheres figuram entre os grupos que foram escravizados na Grécia antiga.",
      "É possível falar na existência de um tráfico humano nas regiões com as quais os gregos mantinham contatos comerciais e políticos, o que consequentemente levou à escravização de pessoas.",
...
createQuestion({
    ...
    options: [
      "O Renascimento ocorreu no contexto em que as cidades comerciais voltaram a se fortalecer e a nascente burguesia se projetou como classe social no continente europeu.",
      "Cientistas que se destacaram no Renascimento, Galileu Galilei e Nicolau Copérnico desenvolveram teorias afirmando que a Terra ocupava lugar central no Sistema Solar.",
...
createQuestion({
    ...
    options: [
      "O pacto colonial foi um mecanismo adotado para obrigar as colônias a venderem seus produtos exclusivamente para suas metrópoles.",
      "A Revolução de Avis possibilitou que a Inglaterra investisse no conhecimento náutico e expandisse suas rotas marítimas, especialmente pelo Oceano Atlântico.",
...
createQuestion({
    ...
    options: [
      "A ocupação efetiva da região Sul da colônia contou com a presença de grandes levas de imigrantes, notadamente italianos, poloneses e alemães, que chegaram a partir do século XVI.",
      "A ocupação da região das minas, no século XVIII, se configurou como um dos mais intensos processos de movimentação e concentração demográfica em uma região do interior da colônia.",
...
createQuestion({
    ...
    options: [
      "A reação espanhola aos movimentos rebeldes nas colônias se deu por meio do chamado Movimento Comunero, uma ação coordenada entre as forças militares espanholas e os grupos contrários à emancipação que viviam nos territórios coloniais.",
      "Descendentes de espanhóis, os criollos formavam a elite política e social colonial e promoveram rebeliões coloniais. No entanto, não apoiavam a ideia de grandes transformações sociais como as pretendidas por mestiços e indígenas.",
...
createQuestion({
    ...
    options: [
      "São conjuntos fixos e estáticos de estrelas, sem movimento.",
      "Podem reunir bilhões de estrelas, que variam em tamanho e temperatura.",
...
createQuestion({
    ...
    options: [
      "O bioma amazônico ocupa a maior parte do território do Norte do país e está associado a altos índices de chuvas.",
      "As araucárias são espécies adaptadas às regiões subtropicais do Brasil.",
...
createQuestion({
    ...
    options: [
      "Os ventos podem carregar os agentes poluidores que formam a chuva ácida e essa precipitação pode ocorrer em áreas distantes da área que originou a poluição.",
      "Os agentes químicos que formam a chuva ácida podem corroer áreas de florestas.",
...
createQuestion({
    ...
    options: [
      "A água doce superficial presente em lagos e rios representa uma parcela muito pequena do total de água doce do planeta.",
      "A bacia hidrográfica do Paraná não é exclusiva do estado do Paraná, mas é a principal deste estado.",
...
createQuestion({
    ...
    options: [
      "Atualmente, o mundo passa por uma estabilização da população mundial, que leva à diminuição do impacto do consumo de matérias-primas e alimentos no espaço geográfico.",
      "Todo espaço físico natural sem transformação humana é chamado de espaço geográfico.",
...
createQuestion({
    ...
    options: [
      "A pólis tem seu surgimento vinculado à necessidade da busca por resoluções de cunho racional para os problemas da vida social.",
      "Em Atenas, não existiam meios legais para a prática da discussão política em praças públicas, por isso essa prática não ocorria na pólis.",
...
createQuestion({
    ...
    options: [
      "O diálogo crítico socrático visa à promoção do autoconhecimento.",
      "Na dialética socrática, não há abertura para a refutação de ideias.",
...
createQuestion({
    ...
    options: [
      "Tudo é água, e por isso a água é o elemento principiador de todos os seres.",
      "Tales de Mileto estabeleceu a arché como sendo o ápeiron.",
...
createQuestion({
    ...
    options: [
      "O conceito de poder está intimamente ligado ao conceito de força.",
      "O conceito de poder é investigado na filosofia política a fim de problematizar o poder social.",
...
createQuestion({
    ...
    options: [
      "A filosofia moral estuda os diferentes sistemas morais presentes nas organizações das diversas sociedades.",
      "As normas morais também variam conforme o local, e são seguidas a partir da convicção e dos valores de cada sociedade.",
...
createQuestion({
    ...
    options: [
      "Na opinião da autora do texto, Tatyana Woodall, os leitores podem se surpreender ao descobrir como seus dados de localização são rastreados.",
      "Segundo a autora, no espaço digital, a privacidade assemelha-se mais a um privilégio do que a um direito.",
...
createQuestion({
    ...
    options: [
      "É predominantemente expositivo, pois apresenta ao leitor informações sobre características relativas ao processo de rastreamento de dados de localização.",
      "Sua autora busca transmitir clareza ao introduzir o texto apresentando a temática e, depois, traz informações que dialogam com a ideia do subtítulo.",
...
createQuestion({
    ...
    options: [
      "Quase todos os \"minúsculos computadores\" que carregamos coletam e compartilham muitas informações pessoais nossas com empresas.",
      "A expressão up for grabs sugere que os dados relativos à nossa localização estão facilmente disponíveis para serem acessados.",
...
createQuestion({
    ...
    options: [
      "É diretora do Programa Tecnologia para a Liberdade, da União Americana pelas Liberdades Civis.",
      "Kade parece não ser totalmente favorável ao modo como os dispositivos de rastreamento funcionam.",
...
createQuestion({
    ...
    options: [
      "A autora defende os benefícios das tecnologias de rastreamento sem mencionar suas desvantagens.",
      "A pergunta retórica feita pela autora em why it's hard to say no to location tracking tech serve para introduzir algumas vantagens dessas tecnologias.",
