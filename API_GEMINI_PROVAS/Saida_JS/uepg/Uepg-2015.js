createQuestion({
    ...
    options: [
      "Michele Micheletti realizou estudos a partir dos quais a Suécia apresentou envolvimento de 50% dos cidadãos com algum tipo de \"consumo politizado\", nos doze meses anteriores à pesquisa, enquanto, no Brasil, o número não chegou a 7%.",
      "O texto parte da origem da palavra boicote para então apresentar a relação entre os termos do inglês \"boycotts\" e \"buycotts\", sendo que o primeiro é o mais recente e pode ser traduzido como \"compra orientada de produtos\".",
...
createQuestion({
    ...
    options: [
      "\"A partir disso...\", no início do terceiro parágrafo, retoma informações dos parágrafos anteriores.",
      "\"...pois...\" no trecho: \"...defende que o ato de consumo pode se transformar em ativismo político, pois, segundo ela, a falta de uma regulamentação global transferiu para os consumidores parte da responsabilidade sobre o mercado.\" introduz uma explicação.",
...
createQuestion({
    ...
    options: [
      "É possível perceber que o autor desconhece o que, de fato, é um antônimo, uma vez que os termos guardam semelhanças entre si que são apresenta-das e explicadas nos parágrafos seguintes.",
      "Essa informação destoa das demais presentes no texto, desenvolvidas no parágrafo anterior e nos seguintes, pois os termos \"boycott\" e \"buycott\" se relacionam de modo que \"buycott\" é um tipo de \"boycott\" mais específico. Portanto, não são antô-nimos entre si.",
...
createQuestion({
    ...
    options: [
      "Caso a crase fosse retirada no trecho 2, o sentido ficaria comprometido, pois seria possível compre-ender que a pesquisa ainda estava incompleta, ou seja, na metade.",
      "No trecho 1 ocorre um erro devido à regência, pois o sinal indicativo da crase deveria estar presente: \"...recusando-se à baixar...\".",
...
createQuestion({
    ...
    options: [
      "Boicote — empréstimo: palavra estrangeira aportuguesada.",
      "Mão de obra — composição por justaposição.",
...
createQuestion({
    ...
    options: [
      "Saavedra está a afirmar que Quintana produz uma poesia fascinante como um jogo transformador do mundo, ao dizer que o poeta cria um \"caleidoscópio\" (um aparelho com vidro multicolorido, usado por séculos como brinquedo ótico).",
      "Dentre as questões essenciais do livro O Aprendiz de Feiticeiro, consta justamente o inexplicável de um mundo em transformação, o enigma da própria poesia como magia, como feitiço, como caleidoscópio.",
...
createQuestion({
    ...
    options: [
      "Em 1908, prestes à publicação de Recordações do Escrivão Isaías Caminha, a obra foi divulgada pela \"Revista do Brasil\", de Monteiro Lobato. Ocasião em que Lima Barreto adentra à Academia Brasileira de Letras, sucedendo João do Rio e derrotando Humberto de Campos.",
      "Após ser colocada à venda, no Rio de Janeiro, a obra Recordações do Escrivão Isaías Caminha, Lima Barreto participa do Júri da \"Primavera de Sangue\" (em 1910), que condena um tenente pela repressão a estudantes no Largo de São Francisco.",
...
createQuestion({
    ...
    options: [
      "O tempo t de aplicação é superior a 6 meses.",
      "O montante produzido por C2 é R$ 1.980,00.",
...
createQuestion({
    ...
    options: [
      "Sua largura é inferior a 30 metros.",
      "Seu perímetro é maior que 120 metros.",
...
createQuestion({
    ...
    options: [
      "O ângulo no primeiro relógio é menor que 120°.",
      "O ângulo no segundo relógio é maior que 140°.",
...
createQuestion({
    ...
    options: [
      "O volume do paralelepipedo é 475 cm³.",
      "A área total de cada cubo é 150 cm².",
...
createQuestion({
    ...
    options: [
      "A carga elétrica é uma propriedade de natureza eletromagnética de certas partículas elementares.",
      "Um corpo só poderá tornar-se eletrizado negativamente se for um condutor.",
...
createQuestion({
    ...
    options: [
      "À pressão de 76 cmHg, um iceberg flutuará com aproximadamente 90% de seu volume imerso.",
      "O iceberg flutua, pois a água em estado sólido apresenta menor densidade em relação ao seu estado líquido.",
...
createQuestion({
    ...
    options: [
      "Para expressar a que distância J1407b encontra-se de nossa galáxia, os astrônomos podem utilizar o ano-luz como unidade de comprimento. Um ano-luz corresponde à distância percorrida pela luz em um ano, e vale aproximadamente 9,5x1012 km.",
      "A Lei da Gravitação Universal exclui exoplanetas.",
...
createQuestion({
    ...
    options: [
      "No ponto mais alto da trajetória circular do trecho de um trilho que apresenta um looping, as forças que atuam nos carrinhos, na ausência de ventos, são a força peso e a reação normal do apoio, ambas verticais e orientadas para baixo.",
      "Durante a descida dos carrinhos, na ausência de forças dissipativas, a energia cinética e a velocidade aumentam.",
...
createQuestion({
    ...
    options: [
      "O planeta Terra apresenta campo magnético natural. Sob a influência do campo magnético terrestre, é possível utilizar uma bússola como referência de orientação.",
      "Em um imã, chama-se de polo norte magnético a extremidade que se orienta para o Polo Norte geográfico terrestre. A outra extremidade que se orienta para o Polo Sul geográfico terrestre, chama-se de polo sul magnético.",
...
createQuestion({
    ...
    options: [
      "Em 1, é apontado o estroma. Este corresponde à região do cloroplasto entre o envelope e os tilacoides. No estroma há ribossomos, DNA, RNA relacionados com a síntese de algumas proteínas dos cloroplastos.",
      "O grano ou granum é representado em 3. Esta estrutura é organizada por tilacoides empilhados e é onde ocorre toda a fase escura da fotossíntese.",
...
createQuestion({
    ...
    options: [
      "Em II, III e IV, encontram-se tecidos condutores de seiva e são consideradas plantas vasculares.",
      "Apenas em IV, o estudante foi capaz de observar frutos.",
...
createQuestion({
    ...
    options: [
      "Uma imunoglobulina adulta é repleta de moléculas de hemoglobinas e responsável pelo transporte de O2.",
      "As albuminas são responsáveis pelo transporte de ácidos graxos livres, pela viscosidade do sangue e por seu potencial osmótico.",
...
createQuestion({
    ...
    options: [
      "A adaptação evolutiva pode levar organismos pouco aparentados a desenvolver estruturas e formas corporais semelhantes, o que é denominado convergência evolutiva.",
...
createQuestion({
    ...
    options: [
      "O carvão mineral, o gás natural e o petróleo são exemplos de combustíveis fósseis.",
      "A utilização de combustíveis fósseis pela espécie humana tem restituído à atmosfera, na forma de CO2, átomos de carbono que ficaram fora de circulação durante milhões de anos.",
...
createQuestion({
    ...
    options: [
      "Em 1, é apontado o osso esterno. A este osso achatado no meio do peito unem-se, por meio de cartilagens, os sete pares superiores de costelas.",
      "Em 2, são apontadas duas costelas. As costelas ajudam a compor a caixa torácica, a qual tem função de proteção do coração, dos pulmões e dos principais vasos sanguíneos.",
...
createQuestion({
    ...
    options: [
      "A mistura de sal de cozinha com areia é uma mistura heterogênea.",
      "A primeira etapa para separar a mistura de sal de cozinha com areia é a adição de água à mistura para a dissolução do sal de cozinha.",
...
createQuestion({
    ...
    options: [
      "A decomposição da amônia é uma transformação física em que os gases N2 e H2 são formados por ebulição.",
      "A interação intermolecular que mantém as moléculas de amônia unidas é chamada de forças de dispersão de London.",
...
createQuestion({
    ...
    options: [
      "A água é uma substância composta e se decompõe em outras duas substâncias simples.",
      "As moléculas de hidrogênio e de oxigênio formadas, compõem uma mistura de substâncias simples.",
...
createQuestion({
    ...
    options: [
      "O átomo de número atômico 15, ao perder 3 elétrons, adquire a configuração de gás nobre.",
      "Os halogênios, como o flúor e o cloro, atingem o octeto quando recebem elétrons na camada de valência.",
...
createQuestion({
    ...
    options: [
      "A ebulição da água contendo NaCl, em temperatura acima de 100°C ao nível do mar.",
      "A produção de lingotes de alumínio a partir de alumínio fundido.",
...
createQuestion({
    ...
    options: [
      "Neste modelo econômico, o estado possui pouca participação, com insignificantes taxas de impostos e de juros, características dos países com IDH muito alto na atualidade.",
      "Tem como um de seus teóricos pioneiros o alemão Eduard Bernstein, que bebeu nas fontes do marxismo, mas era contra revoluções. Era revisionista, ou seja, acreditava que o capitalismo poderia ser reformado para um sistema mais equânime.",
...
createQuestion({
    ...
    options: [
      "O Xintoísmo, religião nacional do Japão, é baseado no animismo e possui como figura central na representação de descendência de deidade terrena, o imperador japonês.",
      "O Confucionismo, que possui origens na China, tem como sacerdotes os próprios funcionários do estado e seu atual chefe espiritual é o próprio imperador chinês.",
...
createQuestion({
    ...
    options: [
      "Quando o clima começa com a primeira letra maiúscula C, segundo Köppen, significa que ele é mesotérmico e temperado. Climas com essa denominação são encontrados na região Sul do Brasil.",
      "No interior do nordeste brasileiro, encontra-se o clima Bsh, que é semiárido e quente. Porém, o litoral dessa região (Zona da Mata) apresenta também o clima Am, com curta estação seca, similar ao clima de boa parte da zona oriental amazônica.",
...
createQuestion({
    ...
    options: [
      "A região dos Campos Gerais foi colonizada com auxílio da rota dos tropeiros. Por esta região passavam os muares criados em Viamão (RS) que seriam vendidos em Sorocaba (SP). Criação de gado vacum e garimpo de ouro não possuiam importância para a economia da região no que tange à criação ou povoamento de centros urbanos.",
      "Apesar do ideário de que o norte paranaense não era colonizado até metade do século XX, esta região já possuía caboclos, safristas e posseiros. Porém, é a partir de 1930 que nessa região se dá a incorporação a uma economia capitalista em expansão no Brasil, com o desflorestamento de grandes áreas por pequenos agricultores que ali estavam instalados. Espécies como peroba, cedro, pinho, figueira e angico foram consideravelmente exploradas neste período.",
...
createQuestion({
    ...
    options: [
      "O produto interno bruto (PIB) do setor agropecuário do município de Ponta Grossa é bastante inferior ao produto interno bruto do setor industrial da cidade. Isso ocorre, dentre outros fatores, devido ao fato de que o setor de transformação agrega muito valor aos produtos primários, inclusive aqueles produzidos pela agropecuária.",
      "Ponta Grossa, uma das mais altas arrecadações de ICMS do Paraná também está entre as 5 cidades do estado com o mais alto IDHM (Índice de Desenvolvimento Humano Municipal), segundo o censo do IBGE de 2010.",
...
createQuestion({
    ...
    options: [
      "As tensões sociais e políticas, provocadas pelas reformas de base propostas pelo presidente João Goulart (1961-1964), serviram de justificativa para que os militares brasileiros promovessem um golpe que os manteve no poder por mais de duas décadas.",
      "O A.I. nº 5, publicado em 1968, é identificado como o mais severo dos Atos Institucionais editados durante a ditadura. Entre outras coisas, o Ato estabeleceu eleições indiretas para a presidência da República e governos dos estados, criou o bipartidarismo e decidiu pela elaboração de uma nova Constituição.",
...
createQuestion({
    ...
    options: [
      "Diferente do que ocorreria na II Guerra Mundial (1939-1945), na I Guerra Mundial não houve registro da utilização de gases tóxicos.",
      "A região dos Bálcas, onde tradicionalmente as questões de fundo nacionalista se expressaram de forma intensa, foi o lugar onde o conflito teve início.",
...
createQuestion({
    ...
    options: [
      "Apesar de não conseguirem seu objetivo inicial, as Cruzadas produziram transformações importantes no mundo medieval ocidental, como o enfraquecimento da aristocracia rural, o fortalecimento do poder real e a expansão mercantil europeia.",
      "A \"Cruzada dos Mendigos\" reuniu milhares de pobres, camponeses desvalidos e pessoas que viviam à margem da sociedade feudal, os quais foram massacrados pelos exércitos turcos.",
...
createQuestion({
    ...
    options: [
      "Questões raciais e culturais influenciaram diretamente a formação da classe operária brasileira na virada do século XIX para o século XX. Nesse sentido, os negros recém-saídos da escravidão foram automaticamente incorporados ao mercado de trabalho assalariado.",
      "A industrialização e o beneficiamento de produtos agrícolas como o café, o algodão e o cacau, ocorridos ainda no século XIX, foram decisivos para o aparecimento dos primeiros núcleos operários brasileiros.",
...
createQuestion({
    ...
    options: [
      "A reabertura da embaixada norte-americana em Havana foi uma das primeiras ações efetivas após a retomada das relações entre os países.",
      "Os grupos anticastristas radicados em Miami manifestaram-se contrários à reaproximação política por compreender que isso contribui para a manutenção do atual regime político cubano.",
...
createQuestion({
    ...
    options: [
      "Alberto Youssef, doleiro que já havia sido processado por lavagem de dinheiro no processo de privatização do Banestado, é considerado um dos principais operadores do esquema de corrupção na Petrobras.",
      "Até agora, a Polícia Federal já prendeu executivos de diversas empreiteiras acusadas de participação no esquema de corrupção. Entre eles estão diretores de duas das maiores empreiteiras do país: Andrade Gutierrez e Odebrecht.",
...
createQuestion({
    ...
    options: [
      "Apesar da presidente Dilma Rousseff pedir oficialmente para que os dois brasileiros, condenados à morte por tráfico de drogas na Indonésia, não fossem executados, a pena foi cumprida.",
      "Alexis Tsipras renunciou ao cargo de primeiro-ministro da Grécia. A política de austeridade econômica adotada por ele não foi aceita pelos membros do seu partido e pela sociedade grega.",
...
createQuestion({
    ...
    options: [
      "concordaram em estender a trégua até o dia de Ano Novo.",
      "ajudaram uns aos outros a cavar as sepulturas.",
...
createQuestion({
    ...
    options: [
      "O segmento é composto apenas por adjetivos e conjunções.",
      "A fala contém um verbo, um substantivo, um adjetivo e três advérbios.",
...
createQuestion({
    ...
    options: [
      "A trégua teve início com uma atitude dos alemães, que colocaram árvores iluminadas nas bordas das trincheiras.",
      "Um capelão realizou uma recitação bilíngue de um salmo durante os sepultamentos.",
...
createQuestion({
    ...
    options: [
      "If you don't shoot, we won't shoot.",
...
createQuestion({
    ...
    options: [
      "trocaram apertos de mão e fumaram juntos.",
      "jogaram futebol e trocaram botões de fardas entre si.",
...
createQuestion({
    ...
    options: [
      "São uma conjunção, um verbo, um substantivo, um adjetivo e um advérbio.",
      "Poderiam ser traduzidos por mas, negligenciando, dever, ambos e carinhosamente.",
...
createQuestion({
    ...
    options: [
      "Ele se refere apenas aos alemães.",
      "Ele se refere tanto aos alemães quanto aos aliados.",
