...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Ciclo Celular", "Mitose", "DNA"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a notocorda é uma estrutura que surgiu há cerca de 542 milhões de anos.",
      "a respiração pulmonar nos vertebrados surgiu há mais de 400 milhões de anos.",
      "a homeotermia é uma novidade evolutiva surgida no Cenozoico.",
      "a coluna vertebral é uma estrutura surgida há cerca de 300 milhões de anos."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Evolução", "Filogenia", "Cordados"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o vírus da gripe é inoculado no anexo 3, que permite o desenvolvimento embrionário em ambiente terrestre e serve como depósito de excretas produzidas pelo embrião.",
      "o anexo 6, onde se inocula o vírus da caxumba, é encontrado em todos os grupos de vertebrados e protege o embrião contra choques mecânicos.",
      "o anexo 2, que armazena substâncias nutritivas para o embrião, passa a produzir anticorpos contra o vírus da herpes, os quais serão purificados e utilizados nas vacinas.",
      "o anexo 1, que permite trocas gasosas entre o embrião e o meio externo, contém elementos do cório e do âmnio, e é onde há multiplicação de antígenos dos poxvírus inoculados."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Embriologia", "Virologia", "Imunologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Uma planta de sol é a melhor escolha para abastecer o sistema, pois seu ponto de compensação fótico é inferior ao de uma planta de sombra.",
      "O armazenamento de energia na bateria que mantém a luz acesa será inversamente proporcional à captação líquida diária de CO₂, seja a planta de sol ou de sombra.",
      "Uma planta de sombra associada ao sistema começa a gerar produtos da fotossíntese que serão utilizados pelas geobactérias em intensidades luminosas menores que uma planta de sol.",
      "A quantidade de produtos derivados da fotossíntese fornecidos às geobactérias será o mesmo, seja a planta de sol ou de sombra, pois ambas atingem um ponto de saturação luminosa."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Vegetal", "Fotossíntese", "Ecologia Microbiana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Genética", "Heredogramas", "Doenças Genéticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Microbiologia", "Reinos dos Seres Vivos", "Fungos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica", "Resistores", "Circuitos Elétricos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Astronomia", "Fases da Lua", "Fenômenos Celestes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Mecânica", "Forças", "Atrito"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Gases Perfeitos", "Escalas Termométricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletricidade", "Potência Elétrica", "Termologia", "Calor Latente"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletricidade", "Energia Elétrica", "Calorimetria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Fluidos", "Hidrodinâmica", "Equação da Continuidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Mecânica", "Energia Mecânica", "Lançamento de Projéteis"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Átomos que pertencem à família dos metais alcalinos formam cátions monovalentes.",
      "Átomos que pertencem ao grupo 17 formam ânions monovalentes.",
      "A ligação iônica ocorre entre cátions e ânions e é caracterizada pela existência de forças de atração eletrostática entre eles.",
      "Na ligação iônica, apenas átomos que perdem e ganham a mesma quantidade de elétrons podem se combinar."
    ],
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Ligações Químicas", "Tabela Periódica", "Íons"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "orto-para-dirigente.",
      "meta-dirigente.",
      "orto-meta-para-dirigente."
    ],
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Reações de Substituição Aromática"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Termoquímica", "Energia de Ligação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Radioatividade", "Decaimento Nuclear"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "I – CO₂ – linear – polar.",
      "II – H₂O – angular – apolar.",
      "III – NH₃ – trigonal plana – apolar.",
      "IV – CH₄ – tetraédrica – apolar."
    ],
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Ligações Químicas", "Geometria Molecular", "Polaridade das Moléculas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Ácidos e Bases", "Funções Inorgânicas", "Força de Ácidos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Isomeria", "Funções Orgânicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Soluções", "Solubilidade", "Fatores que Afetam a Solubilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Reações Químicas", "Estequiometria", "Reações de Dupla Troca", "Reações de Simples Troca"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Sequências Numéricas", "Álgebra"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Funções", "Equação da Reta", "Equação da Circunferência"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Funções", "Logaritmos", "Funções Exponenciais", "Composição de Funções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Análise Combinatória", "Permutação", "Arranjo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial", "Cilindros", "Cones"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Teoria dos Números", "Propriedades Aritméticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geografia Agrária", "Regionalização do Espaço Brasileiro", "Biomas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geopolítica", "Blocos Econômicos", "União Europeia", "Brexit"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Uma afirmação feita pelos pesquisadores é que o impacto das ações humanas sobre o planeta será visível em sedimentos e rochas daqui a milhões de anos.",
      "Uma variedade de processos antropogênicos, como agricultura, urbanização e aquecimento global foram levados em consideração para se pensar em uma nova época geológica.",
      "A partir da primeira Revolução Industrial, o crescimento da população passa a se tornar um novo agente transformador do planeta que atuará junto com os demais agentes ambientais.",
      "A expansão da agricultura e a domesticação dos animais têm um impacto reduzido nas transformações do planeta. Dos processos considerados, aponta-se que a urbanização e a industrialização são os únicos responsáveis pelas mudanças."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Impactos Ambientais", "Geologia", "Antropoceno"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Área marcada pela seca, pela fome e por conflitos que remontam séculos. Possui os IDHs mais baixos do planeta. Atualmente vive sérios problemas com grupos terroristas como Boko Haran.",
      "Área de solos férteis com vegetação dependente da ocorrência de chuvas, essa região é ocupada por diversas populações nômades que tiram dela seu sustento.",
      "Área de solos pobres com vegetação savânica e que tem se mostrado produtiva e capaz de fixar os grupos humanos à terra. Sua população tem aumentado gradativamente.",
      "Área de clima desértico e solos inférteis, possui baixos índices demográficos. As populações que ali vivem são nômades e sobrevivem graças à extração da goma acácia."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geografia Regional (África)", "Problemas Socioambientais", "Conflitos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O evento apontado na nota do observatório faz referência a um acontecimento isolado. Como o Brasil está localizado no centro e não nas bordas da Placa Sul-americana a possibilidade da ocorrência de terremotos no país é muito pequena.",
      "A nota aponta a frequência com que estes eventos ocorrem. Especialistas que acompanham esses fenômenos afirmam que as várias falhas geológicas que a Placa Sul-americana possui podem ser uma das explicações para ocorrência de terremotos em determinadas áreas do país.",
      "É preciso verificar os epicentros das ocorrências desses fenômenos antes de afirmarmos que ocorrem em território brasileiro. A Placa Sul-americana, onde está o Brasil, recebe muitas ondas sísmicas secundárias provenientes de abalos que se deram em outros países.",
      "A Placa Sul-americana faz limite com a Placa de Nazca. Essa área de encontro entre as duas placas é a área de ocorrência de terremotos na América do Sul. Países como o Brasil, que estão no centro de uma placa, pouco ou quase nada sofrem quando estas se deslocam."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geofísica", "Tectonismo", "Placas Tectônicas", "Sismologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Impactos Ambientais", "Hidrografia", "Geografia Regional (Ásia Central)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A Troposfera é a camada onde ocorrem os fenômenos climáticos (formação de nuvens, precipitações de neve ou granizo, relâmpagos). É também nesta camada que os aviões circulam e ocorre a poluição do ar.",
      "A Exosfera é a camada que antecede o espaço sideral. É composta basicamente por nitrogênio e hidrogênio na proporção de 50% cada. Nesta parte da atmosfera, a temperatura pode oscilar até -100° C e sua espessura chega a 500Km.",
      "A Termosfera é a camada mais extensa da atmosfera. Ela possui oxigênio atômico em sua composição, que tem a capacidade de absorver a energia solar em grande quantidade; por isso, ela pode atingir até 1000° C",
      "Na Mesosfera, a temperatura varia entre –10°C até –100°C. Ela é extremamente fria, pois não há gases ou nuvens capazes de absorver a energia solar. Aqui ocorre o fenômeno da aeroluminiscência."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Climatologia", "Atmosfera", "Camadas da Atmosfera"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História do Brasil", "Migrações no Brasil", "Economia Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a projeção de Mercator é do tipo conforme.Ela conserva o formato dos continentes, mas altera a dimensão de suas áreas.",
      "a projeção de Mercator não apresenta distorções.Ela é classificada como projeção tipo conforme. Nesse caso, não há distorções das áreas representadas.",
      "esta projeção constituiu um avanço para a cartografia náutica.Ela conseguiu solucionar a impossibilidade de determinar a longitude no mar.",
      "com a projeção de Mercator, foi possível usar menos as direções magnéticas indicadas pela bússola e mais as direções geográficas."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Roma Antiga", "Fundação de Roma", "Império Romano"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "negava qualquer tipo de autoridade religiosa, pois afirmava a supremacia absoluta do indivíduo e da sua capacidade de, ao ler a Bíblia, atingir a graça do conhecimento como caminho para a salvação.",
      "criticava as igrejas nacionais e as lideranças dos reis nos cultos, entendendo que os fiéis atingiriam a salvação por meio de boas obras como a conversão dos pecadores pela pregação da palavra de Deus.",
      "afirmava a predestinação absoluta dos eleitos de Deus, reconhecíveis por sinais tais como uma vida simples e austera, a frequência ao culto, o trabalho árduo e honesto, e o cuidado com a família.",
      "indicava que a salvação pela fé poderia ser conseguida também com o uso da razão, e que os fiéis que viveram uma vida santa e celibatária eram modelos a serem discutidos e ensinados nos seminários."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Idade Moderna", "Reforma Protestante", "Calvinismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História do Brasil", "Independência do Brasil", "Independência da América Latina", "Revolução Haitiana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História do Brasil", "Período Regencial", "Guarda Nacional"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Os países vencedores tiveram menos perdas humanas.",
      "O número de mortes civis foi maior entre os perdedores do que entre os vencedores.",
      "Em todos os países, houve perdas militares maiores do que entre os civis.",
      "Em vários países, as perdas humanas foram apenas civis."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Segunda Guerra Mundial", "Conflitos Mundiais", "Demografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o fato de serem decretadas por presidentes eleitos para estabelecer regimes autoritários capazes de manter a paz política e social e a segurança em momentos de polarização política.",
      "ambas ampliaram o Poder Executivo em detrimento do Legislativo e do Judiciário, enfraqueceram a autonomia dos Estados e criaram mecanismos para controlar os meios de comunicação.",
      "ambas criaram dispositivos legais para o funcionamento do pluripartidarismo e para a participação equilibrada dos poderes republicanos.",
      "a incorporação de Atos Institucionais autoritários que reforçavam o poder Legislativo para garantir a paz interna e a independência do país através de ampla atividade legislativa."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História do Brasil", "Era Vargas", "Ditadura Militar", "Constituições Brasileiras"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "liberalizou o regime, negociando com os grupos de esquerda, e principalmente com os tupamaros, para restabelecer a democracia a partir de 1973.",
      "ampliou os poderes do Parlamento para buscar controlar as atividades dos tupamaros e outros grupos considerados terroristas.",
      "deu sequência e aprofundou a postura autoritária anterior, participando do “golpe em câmera lenta”, o qual estabeleceu a ditadura que durou entre 1973 e 1985.",
      "convocou os militares para garantir a segurança das atividades parlamentares que eram impedidas pelos grupos terroristas."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História da América Latina", "Ditaduras Militares na América Latina", "Uruguai"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Ampliação do quórum para aprovação de emendas constitucionais, eleição direta para senadores biônicos, criação do Estado do Tocantins, suspensão da Lei Falcão e liberação da propaganda eleitoral, diminuição do mandato presidencial.",
      "Eleições indiretas para governador e para um senador por Estado, ampliação do mandato do presidente da república e das bancadas do Norte e Nordeste na Câmara dos Deputados, restrição da propaganda eleitoral com a Lei Falcão.",
      "Aprovação da Lei da Anistia, reforma partidária e fim do bipartidarismo, nomeação dos prefeitos dos municípios das capitais pelos governadores estaduais, ampliação do mandato do presidente da república e dos senadores.",
      "Restrição do quórum para aprovação de emendas constitucionais, eleições diretas para governadores, senadores e deputados, e indicação, pelos governadores, de prefeitos e vereadores, restrição da propaganda eleitoral com a Lei Falcão."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História do Brasil", "Ditadura Militar", "Governo Geisel"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "arregimentar as massas trabalhadoras para a derrubada da república liberal instalada em fevereiro de 1917.",
      "manter os trabalhadores mobilizados para a guerra civil em curso, na defesa da revolução bolchevique contra seus inimigos, internos e externos.",
      "defender o governo provisório, liderado por Alexander Kerensky, com apoio dos socialistas moderados.",
      "incentivar a os trabalhadores a integrar o Exército Branco, que reunia contrarrevolucionários russos e potencias estrangeiras."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História Contemporânea", "Revolução Russa", "Guerra Civil Russa", "Propaganda"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O plano piloto prevê que usuários do metrô evitem transportar mochilas, malas, carrinhos e outros itens que ocupem espaço de passageiros.",
      "Os trens das linhas E e L do metrô estão participando dessa parte inicial do plano piloto.",
      "Os trens redecorados em azul-marinho e modificados com redução de assentos mostraram-se espaçosos e atraentes.",
      "Os usuários do metrô acham que mais espaço é fundamental para os horários de pico."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "sólido apoio da população à iniciativa da companhia do metrô de Nova Iorque, que prevê possibilidade de mais usuários com mais conforto.",
      "descontentamento de usuários do metrô pela redução de assentos.",
      "oposição do próprio autor com relação ao plano piloto de remoção dos assentos.",
      "comentários favoráveis e desfavoráveis à retirada de assentos proposta pela companhia do metrô."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto", "Opinião do Autor"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "parentes preocupados têm procurado manter as crianças a uma distância rastreável por GPS.",
      "a tecnologia é o mais novo aliado dos pais na busca por crianças desaparecidas.",
      "o verão de 2017 trouxe uma busca desenfreada por um dispositivo que acaba com a preocupação dos pais quanto à localização dos seus filhos.",
      "o dispositivo mais procurado no verão de 2017 é o que permite que pais localizem seus filhos por meio de smartphones."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto", "Tecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "os hackers têm regularmente invadido as urnas eletrônicas usadas nas eleições americanas.",
      "o governo americano costuma desfazer-se das urnas eletrônicas após cada eleição.",
      ...
      "a Def Con adquiriu 30 urnas eletrônicas para verificar qual hacker conseguiria invadir o sistema em menos de 90 minutos."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto", "Vocabulário"],
...
createQuestion({
    ...
    options: [
      "possibilita interferência nos resultados.",
      "impede o controle de votantes.",
      "resulta do trabalho de hackers.",
      "desestimula seu uso em eleições futuras."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "Horgan and Trudeau se encontraram para discutir a expansão do oleoduto.",
      "O premier e o primeiro ministro notam que surpreendentemente estão vestidos de forma parecida.",
      "Cinco itens são mencionados para ilustrar a semelhança na escolha do guarda-roupa dos dois políticos.",
      "Horgan e Trudeau combinaram usar itens do vestuário parecidos para mostrar afinidade política."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto", "Vocabulário", "Coerência Textual"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto", "Detalhes do Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "o mundo começa com nossa própria mudança.",
      "fazer o bem ao próximo nos muda para melhor."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Letras de Música", "Tema Central"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Figuras de Linguagem", "Leitura e Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "enquadra-se também no modelo da narrartiva mítica por seu caráter primordial, revelado em techos como: Além, muito além daquela serra, que ainda azula no horizonte, nasceu Iracema... e, Tudo passa sobre a terra.",
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Romantismo", "José de Alencar", "Iracema"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Modernismo (2ª Geração)", "Carlos Drummond de Andrade", "Análise Poética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Realismo", "Machado de Assis", "Memórias Póstumas de Brás Cubas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "em ambos, predomina a função conativa da linguagem, já que o narrador atua sobre as personagens, tornando-as suas interlocutoras.",
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Modernismo (3ª Geração)", "Guimarães Rosa", "Sagarana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Modernismo (2ª Geração)", "Carlos Drummond de Andrade", "Claro Enigma"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ao feitio impositivo do fundamentalismo bíblico.",
      "à constituição da ideia de que a Terra é plana.",
      "à padronização de uma forma radical de pensar.",
      "ao modo como as pessoas passaram a se relacionar nas redes digitais."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Título e Tema"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "“... tribos exóticas que passaram a existir ou ganharam visibilidade...\"",
      "“... movimentos terraplanistas modernos existem pelo menos desde os anos 50...\"",
      "“... ninguém mais está condenado à solidão. ”",
      "tais comunidades se tornem cada vez mais radicais e descoladas da realidade.\""
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Opinião do Autor"],
...
createQuestion({
    ...
    options: [
      "componentes das tribos exóticas.",
      "cientistas e às agências governamentais.",
      "militantes de teses gravitacionistas.",
      "indivíduos que contestam “fake news” terraplanistas."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática", "Pronomes", "Referência Textual"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "do autor do texto \"Formato global\".",
      "dos terraplanistas.",
      "das agências governamentais.",
      "da coletividade virtual."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "apesar de não estar condenado à solidão, não tem com quem interagir.",
      "por estar conectado às redes, não encontra quem com ele defenda suas ideias.",
      "mesmo contrariando padrões de aceitabilidade, tem adeptos na internet.",
      "ainda que não se depare com alguém com suas ideias, presume ter seguidores nas redes."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Vocabulário"],
...
createQuestion({
    ...
    options: [
      "oposição e inclusão.",
      "explicação e contradição.",
      "concessão e soma.",
      "ressalva e contraste."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Coesão e Coerência Textual", "Conectivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "aos aspectos benignos da terraplanagem; aos indivíduos que defendem a antivacinação ou fazem parte do terrorismo.",
      "aos adeptos da teoria de que a Terra é plana; às pessoas contrárias à vacinação ou adeptas ao terrorismo.",
      "aos partidários que enfrentam a viralização de ideias; aos sujeitos que se valem da rede mundial de computadores para difundir ideias terroristas.",
      "aos terraplanistas; aos militantes da vacinação ou adeptos de segmentos terroristas como os do Estado Islâmico."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática", "Pronomes", "Referência Textual"],
...
createQuestion({
    ...
    options: [
      "introduzir o significado de caldo de cultura.",
      "apresentar onde surgem as “fake news”.",
      "contrapor os significados das “fake news” com os das notícias falsas.",
      "isolar o emprego da expressão estrangeira do que ela significa."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática", "Pontuação (Vírgula)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Aqui: argumentos que conquistam adeptos para defender a sociedade; agora: os tempos de antes e depois da internet.",
      "Aqui: teses que podem causar danos a toda a sociedade; agora: o momento após o advento da internet.",
      "Aqui: riscos que as notícias falsas causam quando sustentadas pela má-fé; agora: os tempos anteriores à balbúrdia informativa.",
      "Aqui: proposições que geram conflito entre os usuários da internet; agora: o momento circunscrito ao advento da internet."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática", "Advérbios", "Interpretação de Texto"],
    imageNames: []
})