...
createQuestion({
    ...
    conteudo: ["Eletrodinâmica", "Análise de gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física", "Matemática"],
    conteudo: ["Dinâmica", "Análise de gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Espectro eletromagnético", "Termologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física", "Matemática"],
    conteudo: ["Ondulatória", "Análise de gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Fontes de energia", "Fontes de energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Óptica", "Fisiologia humana"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Gráfico de energia cinética (E) versus altura (h) com uma parábola para baixo, atingindo E=0 em hmin e hmáx, e pico máximo em h=0.",
      "Gráfico de energia cinética (E) versus altura (h) com uma parábola para cima, atingindo E=0 em hmin, crescendo para h=0, e depois caindo para E=0 em hmáx.",
      "Gráfico de energia cinética (E) versus altura (h) com uma parábola para baixo, atingindo E=0 em hmin e hmáx, e pico máximo em h=0.",
      "Gráfico de energia cinética (E) versus altura (h) com uma linha reta horizontal em E=0 de hmin a hmáx.",
      "Gráfico de energia cinética (E) versus altura (h) com uma curva constante positiva de hmin a hmáx."
    ],
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Energia", "Cinemática"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química orgânica", "Separação de misturas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física", "Química"],
    conteudo: ["Hidrostática", "Soluções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Termologia", "Eletrodinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Separação de misturas", "Ligações intermoleculares"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Funções trigonométricas", "Porcentagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Razões e proporções", "Porcentagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria espacial", "Razões e proporções"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Gráfico de h versus V mostrando uma linha reta crescente.",
      "Gráfico de h versus V mostrando uma curva côncava crescente.",
      "Gráfico de h versus V mostrando uma linha reta crescente até certo V, depois um plateau, e depois uma linha reta crescente com menor inclinação.",
      "Gráfico de h versus V mostrando uma linha reta crescente até certo V, e depois uma linha reta crescente com menor inclinação sem plateau.",
      "Gráfico de h versus V mostrando uma curva convexa crescente."
    ],
    correctAnswer: 3,
    materia: ["Matemática", "Física"],
    conteudo: ["Análise de gráficos", "Hidrodinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Otimização", "Geometria plana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria espacial", "Otimização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Leitura e interpretação de instrumentos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática", "Física"],
    conteudo: ["Geometria plana", "Cinemática"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Funções lineares", "Razões e proporções"],
    imageNames: []
})