createQuestion({
    ...
    conteudo: ["Compreensão de texto", "Questão ambiental"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Inglês", "Geografia"],
    conteudo: ["Interpretação de texto", "Migração"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Análise de poema", "Bilinguismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de imagem", "Ambiente de trabalho"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de texto", "Gênero e identidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "à existência de uma língua ideal que alguns falantes lusófonos creem ser a falada em Portugal.",
    ...
    conteudo: ["Variação linguística", "Preconceito linguístico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de texto", "Gêneros literários"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Patrimônio cultural", "Questões indígenas", "Diversidade linguística"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação linguística", "Libras"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Variação linguística", "Linguagem e poder"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "resgatar a importância da poesia para denunciar a morte de negros, que cresce a cada dia.",
      "destacar o crescimento exponencial da temática do preconceito na produção literária no Brasil.",
      "demonstrar o momento no quantitativo de expressões artísticas na discussão de problemas sociais.",
    ...
    conteudo: ["Literatura", "Manifestações culturais", "Racismo e violência"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Interpretação de texto", "Gênero e sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa", "História", "Arte"],
    conteudo: ["Literatura", "Cultura africana no Brasil", "Música"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Violência de gênero", "Análise de gênero textual"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Literatura", "Escravidão no Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Teatro", "Ditadura Militar no Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Interpretação de texto", "Ditadura e sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "provocar o interlocutor para uma tomada de posição.",
...
createQuestion({
    ...
    options: [
      ...
      "perspectiva de estímulo à vocação turística da cidade.",
...
createQuestion({
    ...
    options: [
      "manifestar um estética tida como inconveniente para o ideal político vigente.",
      "representar um posicionamento político-cultural concebido por grupos de oposição.",
    ...
    correctAnswer: 0,
    materia: ["Arte", "História"],
    conteudo: ["História da arte", "Nazismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "contraposição entre o resgate de tradições e a efemeridade da vida humana."
    ],
    correctAnswer: 2,
    materia: ["Arte", "Sociologia"],
    conteudo: ["Dança", "Religião e cultura"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "visualizar a passagem de atos fúnebres nas produções coletivas com espírito festivo."
    ],
    correctAnswer: 0,
    materia: ["Arte", "História"],
    conteudo: ["Manifestações culturais", "Cultura afro-brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Arte", "Sociologia"],
    conteudo: ["Música", "Questões indígenas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Lexicografia", "Instituição familiar"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "desprezo ao assalariado, afetando o engajamento dos sindicatos para o trabalho.",
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Agronegócio", "Impactos socioambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geopolítica", "População"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "o processo de expansão marítima.",
      "a eclosão do renascimento cultural.",
      "a concretização da centralização política.",
      "o manutenção do sistema feudal."
    ],
    correctAnswer: 0,
    materia: ["História", "Geografia"],
    conteudo: ["Idade Média", "Impactos ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Preconceito", "Escravidão"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia", "História"],
    conteudo: ["Preconceito racial", "Cultura afro-brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Escravidão no Brasil", "Memória e identidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "derramamento de lava vulcânica.",
      "encontro de placas tectônicas.",
      "ação do intemperismo químico.",
      "sedimentação de geleiras eólicas.",
      "ruptura a evolução biológica."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geologia", "Relevo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "demonstrar uma premissa idealista.",
      "sustentar um argumento mentalista.",
      "defender uma posição intencionalista."
    ],
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["Filosofia da mente", "Descartes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História", "Sociologia"],
    conteudo: ["Ditadura Militar no Brasil", "Estado e sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["Cultura popular", "Religião e sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["Brasil Colonial", "Cultura e consumo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Violência de gênero", "Direitos humanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "domínio cultural-identitário de atores sociais.",
      "disputas étnico-raciais de povos tradicionais.",
      "divergências político-ideológicas de agentes estatais.",
      "imposição econômico-financeira de empresas privadas.",
      "projetos ecológico-sustentáveis de entidades ambientais."
    ],
    correctAnswer: 2,
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Arte", "História"],
    conteudo: ["Barroco Mineiro", "Brasil Colônia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Meio ambiente", "Povos indígenas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Patrimônio cultural", "Arquitetura"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Desigualdade social", "Problemas urbanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Meio ambiente", "Agroecologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "conservação do meio rural.",
      "crescimento da vegetação ciliar.",
      "interferência do espaço geográfico.",
      "equilíbrio do ambiente das cidades.",
      "controle da proliferação dos animais."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Urbanização", "Meio ambiente urbano"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "afronta às estruturas sociais.",
      "desprezo aos valores religiosos.",
      "transgressão às normas morais.",
      "desrespeito à dignidade humana.",
      "oposição aos princípios hierárquicos."
    ],
    correctAnswer: 3,
    materia: ["História", "Sociologia"],
    conteudo: ["Conflitos contemporâneos", "Direitos humanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Religião e sociedade", "Laicidade do Estado"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Cidadania", "Movimentos sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "proliferação de doenças hídricas."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Impactos socioambientais", "Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia", "História"],
    conteudo: ["Migração", "Movimentos migratórios"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "flexibilização legal da prática de aborto.",
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia", "Geografia"],
    conteudo: ["Desigualdade social", "Acesso a serviços"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "redistribuição dos fluxos migratórios e a maior atuação de sindicatos.",
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Agricultura", "Comércio internacional"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "preceitos ideológicos religiosos.",
      "aspectos socioeconômicos e ideológicos.",
      "regulamentações territoriais e alfandegárias.",
      "orientações constitucionais e estatutárias.",
      "decretos legislativos e internacionais."
    ],
    correctAnswer: 1,
    materia: ["História", "Sociologia"],
    conteudo: ["Antissemitismo", "Preconceito"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["Ditadura Militar no Brasil", "Movimentos sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Ética e justiça", "Crime e sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "controle doutrinário nas narrativas do cotidiano de origem e de destino.",
...
createQuestion({
    ...
    options: [
      "elevação da biomassa.",
      "redução da salinização.",
      "diminuição da fertilidade.",
      "ampliação da microrregiões.",
      "decomposição do substrato."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Meio ambiente", "Uso do solo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "ampliação dos momentos de socialização.",
      "afastamento das atividades especializadas."
    ],
    correctAnswer: 3,
    materia: ["Sociologia", "História"],
    conteudo: ["Trabalho e gênero", "Urbanização no Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "aceitação da hierarquia de gênero.",
      "consolidação de estratificação social.",
      "ruptura de valores institucionalizados."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Literatura", "Gênero e sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Incentivar os fluxos migratórios.",
      "Monitorar as atividades vulcânicas.",
      "Controlar as emissões de carbono.",
      "Priorizar a utilização de termoelétricas."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Climatologia", "Meio ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Literatura", "Filosofia antiga"],
    imageNames: []
})