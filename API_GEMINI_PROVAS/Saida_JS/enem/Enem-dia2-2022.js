createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Reações de Oxirredução", "Química Ambiental"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Fontes de Energia", "Potência"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Reações Químicas", "Toxicologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[Image showing compass configuration A]",
      "[Image showing compass configuration B]",
      "[Image showing compass configuration C]",
      "[Image showing compass configuration D]",
      "[Image showing compass configuration E]"
    ],
    correctAnswer: 3,
    materia: ["Física"],
...
createQuestion({
    ...
    options: [
      "[Image showing battery association A]",
      "[Image showing battery association B]",
      "[Image showing battery association C]",
      "[Image showing battery association D]",
      "[Image showing battery association E]"
    ],
    correctAnswer: 0,
    materia: ["Física"],
...
createQuestion({
    ...
    conteudo: ["Soluções", "Estequiometria", "Bioquímica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[Image showing force diagram A]",
      "[Image showing force diagram B]",
      "[Image showing force diagram C]",
      "[Image showing force diagram D]",
      "[Image showing force diagram E]"
    ],
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Mecânica", "Leis de Newton", "Atrito"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana", "Doping"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Impulso e Quantidade de Movimento", "Energia Mecânica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[Image showing chemical structure A]",
      "[Image showing chemical structure B]",
      "[Image showing chemical structure C]",
      "[Image showing chemical structure D]",
      "[Image showing chemical structure E]"
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Equilíbrio Ácido-Base"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Comportamento Animal"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Mecânica", "Dinâmica do Movimento Circular"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Eletroquímica", "Materiais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica", "Calorimetria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Animal", "Endocrinologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Microrganismos", "Farmacologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Biotecnologia", "Fisiologia Humana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Gravitação", "Astronomia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Ambiental", "Métodos de Separação de Misturas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Eletrodinâmica", "Proporcionalidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Ecologia", "Química Ambiental"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Imunologia", "Biotecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Estatística", "Análise de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Escalas", "Geometria Plana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Aritmética", "Problemas de Lógica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[Image showing cube net A]",
      "[Image showing cube net B]",
      "[Image showing cube net C]",
      "[Image showing cube net D]",
      "[Image showing cube net E]"
    ],
    correctAnswer: 3,
    materia: ["Matemática"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física", "Matemática"],
    conteudo: ["Termodinâmica", "Razão e Proporção"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Interpretação de Gráficos e Tabelas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[Image showing unfolded paper shape A]",
      "[Image showing unfolded paper shape B]",
      "[Image showing unfolded paper shape C]",
      "[Image showing unfolded paper shape D]",
      "[Image showing unfolded paper shape E]"
    ],
    correctAnswer: 2,
    materia: ["Matemática"],
...
createQuestion({
    ...
    options: [
      "[Image showing 2D projection A]",
      "[Image showing 2D projection B]",
      "[Image showing 2D projection C]",
      "[Image showing 2D projection D]",
      "[Image showing 2D projection E]"
    ],
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Razão e Proporção", "Conversão de Unidades"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Porcentagem", "Cálculos Financeiros"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Raciocínio Lógico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Análise de Gráficos", "Razão e Proporção"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Aritmética", "Razão e Proporção"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Otimização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial", "Volume de Sólidos", "Razão e Proporção"],
    imageNames: []
}),
