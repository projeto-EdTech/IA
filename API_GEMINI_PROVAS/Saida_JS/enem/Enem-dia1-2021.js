...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação Linguística", "Gêneros Literários"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação Linguística", "Literatura Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Textuais", "Tipos de Discurso"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Intertextualidade", "Patrimônio Linguístico e Cultural"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Linguagem Verbal e Não Verbal", "Campanhas Educativas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Gêneros Textuais", "Movimentos Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Arte Contemporânea", "Questões Humanitárias"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["História da Música Brasileira", "Literatura Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["História do Brasil", "Racismo e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Arte"],
    conteudo: ["História da Arte", "Romantismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Infância e Sociedade", "Impacto da Tecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Arte"],
    conteudo: ["Dança Contemporânea", "Arte e Tecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Arte"],
    conteudo: ["Dança", "Hibridismo Cultural"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Narrativos", "Recursos Literários"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Recursos Linguísticos", "Gêneros Narrativos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Arte"],
    conteudo: ["Design Brasileiro", "Arquitetura e Urbanismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Tecnologia e Sociedade", "Redes Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Textuais", "Mídia e Informação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Cultura e Esporte", "Transformações Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Funções da Linguagem", "Gêneros Textuais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Arte", "Língua Portuguesa"],
    conteudo: ["Quadrinhos", "Gêneros Textuais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Saúde Humana", "Impacto da Tecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Gênero e Sociedade", "Brasil Império"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Arte"],
    conteudo: ["Arte Contemporânea", "Impacto Social da Arte"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Gêneros Musicais", "Crítica Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "aceticismo quanto à possibilidade do reencontro.",
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Líricos", "Leitura e Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Variação Linguística", "Gêneros Musicais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Narrativos", "Leitura e Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Líricos", "Recursos Poéticos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Arte"],
    conteudo: ["Arte Moderna", "Corpo na Arte"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Gêneros Textuais", "Escravidão"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Narrativos", "Meios de Comunicação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Arte", "Língua Portuguesa"],
    conteudo: ["Música Brasileira", "Gêneros Textuais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Mundo do Trabalho", "Tecnologia e Relações Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Desigualdade Social", "Teoria Política"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Biotecnologia", "Cadeias Produtivas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História", "Sociologia"],
    conteudo: ["Patrimônio Cultural", "Urbanização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Globalização", "Meio Ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Brasil Império", "Relações Internacionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Alianças afetivas conectadas ao ritual matrimonial.",
      "Práticas místicas associadas ao patrimônio cultural.",
      "Manifestações teatrais atreladas ao imaginário político.",
      "Narrativas fílmicas relacionadas às intempéries climáticas.",
      "Argumentações literárias interligadas às catástrofes ambientais."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Cultura e Tradições", "Região Nordeste"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Mundo do Trabalho", "Tecnologia e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Migrações", "Direitos Humanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História", "Sociologia"],
    conteudo: ["Século XIX", "Relações de Gênero"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Capitalismo e Consumo", "Indivíduo e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Urbanização", "Paisagem Geográfica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Conhecimento Geográfico", "Climatologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Crítica Social", "Cultura Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Urbanização", "Planejamento Urbano"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Economia e Sociedade", "Globalização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia", "Geografia"],
    conteudo: ["Conflitos Socioambientais", "Questões Agrárias e Urbanas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia", "Filosofia"],
    conteudo: ["Minoria e Maioria", "Poder e Dominação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Karl Marx", "Luta de Classes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Sistema Prisional", "Políticas Públicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História", "Sociologia"],
    conteudo: ["Idade Média", "Impactos Sociais de Catástrofes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Movimentos Sociais", "Povos Indígenas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Era Vargas", "Conhecimento Geográfico"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Ecologia", "Conhecimento Tradicional"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Planejamento Urbano", "Participação Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Era Vargas", "Política Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Brasil Colonial", "Relações Étnico-Raciais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Brasil Colonial", "Cultura e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Idade Média", "Pensamento Cristão"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Formação do Brasil", "América Colonial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Filosofia"],
    conteudo: ["Revolução Inglesa", "Iluminismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia", "Geografia"],
    conteudo: ["Empresas e Economia", "Indústria e Territorialização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Desenvolvimento Social", "Estrutura Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia", "História"],
    conteudo: ["Educação", "Brasil República"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Antiga", "Método Socrático"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Arte", "Sociologia"],
    conteudo: ["Arte Africana", "Cultura e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Cultura Indígena", "Manifestações Culturais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Moderna", "Epistemologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Contemporânea", "Ética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Medieval", "Ética"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Movimentos Celestes", "Movimentos da Terra"],
    imageNames: []
}),
