...
createQuestion({
    ...
    options: [
      "Afastar o aterramento dos arames da cerca.",
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Imunologia", "Parasitologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Termoquímica", "Metabolismo Energético"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Estratégia 2, pois essas espécies estão adaptadas a hábitats mais estáveis, o que corresponde ao ambiente de uma área desmatada.",
...
createQuestion({
    ...
    options: [
      ...
      "eleva o pH do solo em função da degradação dos componentes do resíduo.",
      "apresenta efeitos inibidores de crescimento para a maioria das espécies vegetais pela cafeína."
    ],
    correctAnswer: 0,
    materia: ["Química", "Biologia"],
    conteudo: ["Química Orgânica", "Ecologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "emprego da compostagem.",
      "controle da irrigação do solo.",
      "utilização de predadores naturais.",
      "uso de sementes inoculadas com Rhizobium."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Biotecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química", "Biologia"],
    conteudo: ["Química Ambiental", "Saneamento Básico"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Modelos Atômicos", "Óptica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Funções Orgânicas", "Propriedades Físicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Virologia", "Biotecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Fluidos", "Termodinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Cinética Química", "Química Orgânica"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Ecologia", "Radioatividade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "inibição da glicólise, resultando em maior absorção celular da glicose sanguínea.",
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Membrana Plasmática", "Fisiologia Vegetal"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Fluidos", "Propriedades Físicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A imagem mostra a sombra das letras PINE com espaçamento constante, com o P sendo um retângulo e I, N, E como retângulos verticais.",
      "A imagem mostra a sombra das letras PINE com espaçamento constante, com o P sendo um retângulo e I, N, E como retângulos verticais.",
      "A imagem mostra a sombra das letras PINE com espaçamento constante, com o P sendo um retângulo e I, N, E como retângulos verticais.",
      "A imagem mostra a sombra das letras PINE com espaçamento constante, com o P sendo um retângulo e I, N, E como retângulos verticais.",
      "A imagem mostra a sombra das letras PINE com espaçamento constante, com o P sendo um retângulo e I, N, E como retângulos verticais."
...
createQuestion({
    ...
    options: [
      ...
      "qualquer valor positivo inferior a 10⁻⁷.",
      "valores maiores que 7 e menores que 8.",
      "valores maiores que 70 e menores que 80.",
      "valores maiores que 10⁻⁸ e menores que 10⁻⁷."
    ],
    correctAnswer: 4,
    materia: ["Matemática", "Química"],
    conteudo: ["Funções Exponenciais e Logarítmicas", "pH e pOH"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Gráfico com três segmentos: primeiro constante, segundo com inclinação menor, terceiro com inclinação maior.",
      "Gráfico com três segmentos: primeiro constante, segundo com inclinação menor, terceiro com inclinação maior.",
      "Gráfico com três segmentos: primeiro constante, segundo com inclinação menor, terceiro com inclinação maior.",
      "Gráfico com três segmentos: primeiro constante, segundo com inclinação menor, terceiro com inclinação maior.",
      "Gráfico com três segmentos: primeiro constante, segundo com inclinação menor, terceiro com inclinação maior."
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Escalas", "Grandezas e Medidas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Funções", "Indicadores Socioeconômicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Razão e Proporção", "Expressões Algébricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Análise Gráfica", "Progressão Aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática", "Geografia"],
    conteudo: ["Razão e Proporção", "População e Urbanização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Análise Gráfica", "Operações Básicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Análise Gráfica", "Eletricidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática", "Geografia"],
    conteudo: ["Matemática Financeira", "Globalização e Blocos Econômicos"],
    imageNames: []
})