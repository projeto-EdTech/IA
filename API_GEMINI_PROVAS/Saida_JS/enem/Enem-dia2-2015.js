...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Compreensão e interpretação de texto", "Ambiguidade e polissemia"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de texto", "Manifestações artísticas e culturais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "transita entre o humor e o ironia para celebrar o caos da vida cotidiana.",
      "satiriza a matemática e a medicina para desmistificar o saber científico."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa", "Filosofia", "História"],
    conteudo: ["Interpretação de texto", "Concepções de mundo", "História da humanidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Funções da linguagem", "Gêneros textuais (propaganda)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Funções da linguagem", "Gêneros textuais (informativo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Linguagem publicitária", "Recursos verbais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de texto", "Cultura romana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais (memórias)", "Recursos narrativos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais (divulgação científica)", "Propósito comunicativo"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de texto", "Tecnologia e sociedade", "Relações de trabalho"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de texto", "Cultura indígena", "Cultura e conhecimento"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação linguística (regional)", "Leitura e interpretação de letra de música"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Linguagem publicitária", "Recursos verbais e não verbais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros literários (poesia)", "Contexto histórico-literário (Barroco e Arcadismo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais (biografia)", "Literatura de cordel"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros literários (poesia)", "Contexto histórico-literário (Primeira República)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Arte"],
    conteudo: ["Surrealismo", "Análise de obra de arte"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa", "História"],
    conteudo: ["Leitura e interpretação de letra de música", "Cultura afro-brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Arte"],
    conteudo: ["Arte africana", "Vanguardas europeias"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Arte e cultura", "Colonização do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Arte"],
    conteudo: ["Arte contemporânea", "Performance"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Formação de palavras", "Neologismos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Poesia Concreta", "Recursos poéticos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Sociedade da informação", "Tecnologia e sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação linguística", "Linguagem digital"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros literários (poesia)", "Metalinguagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação linguística (regional)", "Preconceito linguístico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais (projeto cultural)", "Acesso à cultura"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Ao acervo linguístico indígena fosse conhecido e valorizado.",
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Ocupação do território brasileiro", "Cultura indígena"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Saúde Humana", "Doenças (Obesidade)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Gêneros literários (poesia)", "Existencialismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação linguística (coloquial)", "Leitura e interpretação de letra de música"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa", "História"],
    conteudo: ["Gêneros literários (poesia)", "Ditadura Militar no Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Gêneros literários (prosa)", "Modelos sociais", "Interpretação de texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Arte"],
    conteudo: ["Arte contemporânea", "Análise de obra de arte"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Funções (Função quadrática)", "Otimização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Volume de sólidos de revolução)", "Álgebra (Expressões algébricas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Funções (Funções definidas por partes)", "Interpretação de gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Funções (Interpretação de gráficos)", "Resolução de problemas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Áreas de figuras planas)", "Geometria Espacial (Prismas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Funções (Análise de gráficos)", "Inequações"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Volume)", "Relações métricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Proporcionalidade", "Escala"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Área)", "Porcentagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Máximo Divisor Comum (MDC)", "Problemas de otimização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Proporcionalidade", "Aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Figuras planas)", "Transformações geométricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Círculo)", "Área"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Matemática financeira (Juros)", "Progressão Aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Notação científica", "Unidades de medida (conversão)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Proporcionalidade", "Resolução de problemas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Estatística (Média)", "Porcentagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Probabilidade", "Porcentagem", "Saúde (Doenças sexualmente transmissíveis)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Funções (Função exponencial)", "Progressão Geométrica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Mínimo Múltiplo Comum (MMC)", "Divisibilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Volume de cilindro)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Área de polígonos)", "Proporcionalidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Estatística (Média)", "Classificação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Aritmética (Números decimais)", "Comparação de valores"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Área de setor circular)", "Inequações"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Aritmética", "Unidades de medida (Volume)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Proporcionalidade", "Leitura de tabelas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Volume", "Unidades de medida (Capacidade)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Funções trigonométricas", "Otimização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Aritmética", "Raciocínio lógico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Interpretação de gráficos", "Porcentagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Volume)", "Porcentagem"],
    imageNames: []
}),
