...
createQuestion({
    ...
    options: [
      "\"Deve ter recorrido. Ainda o vi várias vezes contando aos colegas o andamento do processo, meses depois.” (15º parágrafo)",
      "\"- Vou aos jornais - disse-me o crédulo. – Eles têm de receber o requerimento, como manda a lei.\" (6º parágrafo)",
      "\"Estava montado o angu. O rapaz foi até o chefe, que se negou a receber o requerimento.\" (5º parágrafo)",
      "\"Prepara o requerimento, junta uma cópia da certidão de nascimento da criança e dá entrada no processo.” (1º parágrafo)",
      "\"- Não podemos receber o requerimento sem o atestado do médico que assistiu a parturiente.\" (2º parágrafo)"
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação linguística", "Interpretação de texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Discurso direto e indireto", "Concordância verbal", "Verbos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Escolas literárias", "Romantismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Conectivos", "Interpretação de texto", "Semântica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Silepse", "Sintaxe (Concordância)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "the dirt and dust deriving from the overcrowded streets in the country's capital.",
      "air pollution, and the health risks brought about by fine-dust particulates.",
      "a variety of factors impacting on the South Koreans' quality of life in the present days.",
      "the great number of camera-equipped drones flying all around Seoul's skies.",
      "the many types of pollutants produced by the country's industries and residents."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "map the dirty and dust-affected streets in Seoul.",
      "predict critical points of pollution in Seoul's metropolitan area.",
      "create technological solutions to solve Seoul's dust dilemma.",
      "identify alternatives to some of the most distressing factors affecting South Koreans.",
      "monitor industrial plant emissions in the city and its surroundings."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "it has recently reached levels far beyond those the WHO admits as safe for humans to live with.",
      "its particles have just been discovered to be even tinier than the average PM10 particles.",
      "it has, in the latest years, surpassed PM10 in numbers and as the origin of incurable diseases.",
      "it is composed of black carbon, nitrates and ammonia, a combination inevitably resulting in deadly side-effects.",
      "it has been announced by the WHO as the main cause for respiratory diseases and cancer in the country."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Reading comprehension"],
...
createQuestion({
    ...
    options: [
      "stopping fishing illegally.",
      "deciding to only consume fish obtained through responsible fishing practices.",
      "protecting the environment by stopping eating fish.",
      "assisting WWF financially in their campaign against destructive fishing methods.",
      "joining www.fishforward.eu to help save the seas and their ecosystem."
    ],
    correctAnswer: 1,
    materia: ["Inglês", "Geografia", "Biologia"],
    conteudo: ["Reading comprehension", "Meio ambiente", "Ecologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Povos indígenas do Brasil", "Período pré-colonial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Crise do Sistema Colonial", "Iluminismo e liberalismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a partilha do continente africano ocorreu no início do século XIX, assegurando o equilíbrio entre as áreas territoriais controladas pelas potências europeias.",
      "o processo de libertação da África do domínio colonial europeu desenvolveu-se no decorrer do século XIX, a partir de acordos diplomáticos com as potências europeias.",
      "a ocupação do centro africano ocorreu no decorrer do século XIX e reafirmou a hegemonia das mesmas potências europeias que já colonizavam o litoral do continente.",
      "a ocupação principal da África ocorreu no decorrer do século XIX, culminando com a partilha do continente pelas potências europeias.",
      "o avanço da ocupação europeia para o centro do continente africano foi pacífico e de natureza semelhante à dominação do litoral no princípio do século XIX."
    ],
    correctAnswer: 3,
    materia: ["História", "Geografia"],
    conteudo: ["Neocolonialismo", "Partilha da África", "Cartografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "da política de Boa Vizinhança, que intensificou a circulação de mercadorias e produtos culturais nas Américas, reforçando a liderança estratégica norte-americana no continente.",
      "do imperialismo norte-americano, que impôs seu controle ideológico e econômico sobre a América Latina, freando o avanço da influência socialista soviética e cubana no continente.",
      "das disputas entre Estados Unidos e Japão no Pacífico, que provocaram o esforço norte-americano de assegurar a neutralidade política e diplomática dos países latino-americanos no conflito mundial.",
      "da política do Big Stick, que permitiu aos Estados Unidos consolidar sua hegemonia mercantil no Atlântico Sul, impedindo que os países da América Latina mantivessem relações comerciais com a Europa.",
      "do New Deal, programa de recuperação financeira que os Estados Unidos impuseram aos países da América Latina, reduzindo os efeitos negativos do conflito mundial na economia do continente."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Segunda Guerra Mundial", "Relações Brasil-EUA"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "contrapõe a conquista da Copa do Mundo pelo Brasil à crise econômica e à carestia por que o país passava.",
      "associa a conquista da Copa do Mundo pelo Brasil à repressão política durante a ditadura cívico-militar.",
      "ironiza a paixão dos brasileiros pelo futebol, o que os impedia de notar a crise econômica que o país atravessava.",
      "satiriza o uso político do futebol, incapaz de evitar o acirramento da luta popular contra a ditadura cívico-militar.",
      "alude à conquista da Copa do Mundo, o que provocou forte aumento na autoestima dos brasileiros."
    ],
    correctAnswer: 0,
    materia: ["História", "Arte"],
    conteudo: ["Ditadura Militar (Brasil)", "Crise econômica no Brasil (anos 70)", "Análise de charge"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geopolítica", "Recursos naturais (petróleo)", "Oriente Médio"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "da compreensão de uma lógica socioeconômica externa que requalifica a periferia.",
      "das disparidades observadas na metrópole que segregam diferentes classes sociais.",
      "da desconstrução das representações sobre a periferia e seus moradores.",
      "das estratégias de publicidade que alimentam a especulação imobiliária.",
      "de um novo sistema de produção equânime entre patrões e empregados."
    ],
    correctAnswer: 2,
    materia: ["Sociologia", "Geografia"],
    conteudo: ["Cultura e Mídia", "Espaço urbano", "Movimentos sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "baixo - impermeabilizou – assoreamento.",
      "baixo impermeabilizou - diastrofismo.",
      "alto - encharcou - terraceamento.",
      "alto - saturou – soerguimento.",
      "alto - saturou - deslizamento."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Geomorfologia", "Desastres naturais", "Hidrografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Meio ambiente (Mata Atlântica)", "Uso e cobertura da terra", "Cartografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o aperfeiçoamento do transporte de cabotagem e da segurança nacional.",
      "o investimento em energia primária e na importação de biomassa.",
      "a privatização das ferrovias e dos terminais multimodais.",
      "a diversificação da matriz energética e do sistema de transporte.",
      "a implementação de fontes de energia secundária e de novas rodovias."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Energia", "Transportes", "Economia Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "foi beneficiado no ecossistema com lesmas e prejudicado no ecossistema com minhocas.",
      "foi beneficiado pelos animais nos dois ecossistemas.",
      "foi prejudicado pelos animais nos dois ecossistemas.",
      "foi beneficiado no ecossistema com minhocas e prejudicado no ecossistema com lesmas.",
      "não foi impactado pela presença dos animais em nenhum dos ecossistemas."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Relações ecológicas", "Cadeias alimentares"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "maior - ribossomo - 123.",
      "menor nucléolo - 369.",
      "o mesmo - ribossomo - 123.",
      "o mesmo nucléolo - 124."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Genética molecular", "Síntese proteica", "DNA e RNA"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Evolução", "Especiação", "Genética"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Genética", "Heredograma", "Probabilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "carbonato de sódio e carbonato de bário.",
      "carbonato de sódio e sulfato de bário.",
      "sulfato de sódio e carbonato de sódio.",
      "sulfato de sódio e sulfato de bário.",
      "sulfato de sódio e carbonato de bário."
    ],
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Solubilidade", "Reações Químicas (ácido-base, efervescência)", "Classificação de compostos (carbonatos, sulfatos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Soluções e concentração", "Proporcionalidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "aumenta – absorve – endotérmico.",
      "aumenta – absorve – exotérmico.",
      "diminui - libera - exotérmico.",
      "aumenta - libera - endotérmico.",
      "diminui - absorve - endotérmico."
    ],
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Equilíbrio químico", "pH e pOH", "Termoquímica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Química orgânica", "Isomeria (Quiralidade)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Cinemática", "Dinâmica (Força de atrito, Força centrípeta)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Trabalho em gases"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Óptica geométrica", "Lentes esféricas", "Espelhos planos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Ondas estacionárias", "Cordas vibrantes", "Leis de Newton (forças)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Eletricidade (Resistividade, Resistência)", "Biofísica"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Porcentagem", "Proporcionalidade", "Economia global"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Análise combinatória", "Lógica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Sistemas lineares", "Álgebra", "Porcentagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia", "Matemática"],
    conteudo: ["Genética de populações", "Lei de Hardy-Weinberg", "Funções (interpretação de gráficos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Funções (função quadrática)", "Álgebra", "Genética de populações"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "40000 km² e 50000 km².",
      "140000 km² e 150000 km².",
      "230000 km² e 240000 km².",
      "310000 km² e 320000 km².",
      "420000 km² e 430000 km²."
    ],
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria plana (Área de setor circular)", "Trigonometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Geometria espacial (Volume de esfera)", "Razão e proporção", "Astronomia (Sistema Solar)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "4200 dólares e 75 litros.",
      "4200 dólares e 37,5 litros.",
      "3600 dólares e 75 litros.",
      "2100 dólares e 75 litros.",
      "2100 dólares e 37,5 litros."
    ],
    correctAnswer: 0,
    materia: ["Matemática", "Física"],
    conteudo: ["Interpretação de gráficos", "Razão e proporção", "Eletricidade (energia)"],
    imageNames: []
})