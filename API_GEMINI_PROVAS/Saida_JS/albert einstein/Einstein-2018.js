...
createQuestion({
    ...
    options: [
      "Mytilus californianus é uma espécie que se prolifera rapidamente na ausência de estrelas-do-mar, a ponto de ocupar amplamente o substrato e não deixar outras espécies se fixarem.",
      "a espécie Pisaster ochraceus exerce pouca influência na determinação da composição de espécies nos costões das áreas estudadas.",
      "a Área 1, conforme mostra o gráfico, é mais representativa de uma situação ideal de equilíbrio ecológico em um ecossistema que a Área 2.",
      "a Área 2, conforme mostra o gráfico, tem sua diversidade de espécies definida pelo crescimento explosivo do molusco bivalve."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Ecologia"],
...
createQuestion({
    ...
    options: [
      "apenas vírus mistos, contendo proteína da linhagem A e RNA da linhagem B.",
...
createQuestion({
    ...
    options: [
      "O cartograma refere-se à divisão regional formulada por Milton Santos e Maria Laura Silveira em 1999. Considerou-se para essa proposta: a quantidade de recursos tecnológicos avançados, o volume de atividades econômicas modernas em áreas financeiras e o papel da agropecuária em relação à mecanização e à integração com a indústria.",
      "A Região Concentrada diz respeito a uma área no território brasileiro onde, apesar da alta taxa de urbanização e concentração de serviços, não congrega o centro de decisões econômico-financeiras do país. Esse papel não está centralizado em um único ponto, está disperso pelas mais importantes capitais brasileiras.",
      "A Região Centro-Oeste caracteriza-se pela intensa produção agropecuária pouco integrada à economia globalizada. O uso de tecnologia nessa região limita-se às atividades comerciais em centros urbanos. Trata-se de um dos pontos de grande geração de empregos e absorção de uma mão-de-obra jovem.",
      "A Região Amazônica é marcada pela baixa densidade demográfica, ao mesmo tempo que utiliza recursos tecnológicos de ponta. O potencial de exploração dessa região está na agricultura comercial e na pecuária de corte. Tais atividades são favorecidas pelo relevo plano e abundância de áreas disponíveis."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "Os 195 países que assinaram o acordo se comprometeram a reduzir a emissão de gases de efeito estufa (GEE) no contexto do desenvolvimento sustentável.",
      "O compromisso firmado entre os países signatários é de manter o aumento da temperatura média global em bem menos de 2ºC acima dos níveis pré-industriais.",
      "O acordo prevê o aumento da capacidade de adaptação dos países aos impactos das alterações climáticas de forma que não ameacem a produção de alimentos.",
      "Devem atingir um pico global das emissões de gases de efeito estufa o mais lentamente possível, de forma a realizar reduções rápidas na segunda metade deste século."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "estratégias do governo americano para salvar bancos que estavam enfrentando sérios problemas de ordem financeira.",
      "depauperação das finanças públicas do país em função de investimentos feitos nos setores sociais.",
      "efetiva expansão dos financiamentos a juros baixos feitos para aquisição de bens imobiliários, que se mantinham desde 2000.",
      "cobrança de elevados impostos sobre vários setores importantes da economia norte-americana."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "Um problema para o Brasil ainda são os serviços de saneamento para as populações rural e urbana. Mas é a população rural que mais sofre com a carência de oferta de água tratada, coleta de lixo e tratamento de esgoto.",
      "O abastecimento de água por rede geral chega à maioria da população rural, porém o acesso ao esgotamento por rede coletora ou pluvial ainda é muito ruim e a coleta de lixo precisa ser ampliada.",
      "O acesso ao abastecimento de água por rede geral, a coleta direta ou indireta de lixo e esgotamento por rede coletora ou pluvial ainda são deficientes no país como um todo.",
      "A população urbana ainda precisa de muito mais investimento em relação à coleta de lixo e esgotamento por rede coletora ou pluvial. Com relação ao acesso a água tratada podemos afirmar que não se trata mais de um problema."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "A peste bubônica, que se alastrou entre os combatentes da 1a Guerra mundial, atingiu os grupos de brasileiros ligados ao exército e à política na capital do país, o que implicou o isolamento de partes da cidade para impedir a disseminação.",
      ...
      "A gripe espanhola, doença que assolou os países europeus durante a 1a Guerra, atingiu também a população brasileira, levando o governo da capital a contratar um grupo de higienistas para combater a disseminação da doença."
    ],
    correctAnswer: 3,
    materia: ["História"],
...
createQuestion({
    ...
    options: [
      "dar exemplos de tipos de \"bullying\" eletrônico para que os pais possam se precaver.",
      "mostrar ao adolescente assediado que ele não está só.",
      "chamar a atenção da população para o fato de que o \"bullying” é uma realidade perigosa.",
      "mostrar à população que o combate ao “bullying\" depende da ação adequada de cada pessoa individualmente."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "a menor porcentagem mencionada é a do grupo de vítimas que não contam sobre o \"bullying” eletrônico aos pais.",
      "cerca de 50% dos adolescentes são sistematicamente assediados eletronicamente.",
      "a maior parte dos pais não chega a saber que seus filhos sofrem \"bullying\" eletrônico.",
      "a quantidade de adolescentes que sofrem “bullying\" eletrônico ocasional chega a quase 100%."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Dados"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "pretende unir, por via terrestre, os diversos cinturões de produção de seda da China de forma a fazê-la chegar mais rapidamente ao consumidor.",
      "restringe-se ao território Chinês no que diz respeito à criação de infraestrutura terrestre para transporte de bens desde sua produção até o consumo.",
      "envolve tanto o transporte terrestre de seda, ligando a China à Europa, quanto o transporte marítimo de outros bens, ligando a costa sul da China ao leste da África.",
      "é um ambicioso projeto de criação de ampla infraestrutura, desenvolvido pelo governo Chinês, que pretende impulsionar a dinâmica econômica entre a China e diversas regiões do globo."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto"],
...
createQuestion({
    ...
    options: [
      ...
      "Eulália, também chamada de Nhá-loló, que nutriu grande amor por Brás Cubas, mas morreu aos dezenove anos e mereceu um epitáfio por parte do autor.",
