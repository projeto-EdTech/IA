createQuestion({
    ...
    conteudo: ["Interpretação de texto", "Literatura Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de tirinhas", "Figuras de linguagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "uma palavra resultante da atribuição do sentido conotativo de um verbo qualquer ao substantivo \"coisa\".",
      "uma palavra resultante do processo de sufixação que transforma o substantivo \"coisa\" no verbo \"coisar\".",
      "uma palavra que, graças a seu sentido universal, pode ser usada em substituição a todo e qualquer verbo não lembrado.",
      "uma palavra que resulta da transformação do substantivo \"coisa\" em verbo \"coisar\", reiterando um esquecimento."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Morfologia", "Norma Culta"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A pergunta lançada no último quadrinho (\"Você sabe quem inventou o avião?\") remete-nos a Santos Dummont, portanto confirma o que se diz no primeiro e segundo quadrinhos.",
      "A pergunta lançada no último quadrinho (\"Você sabe quem inventou o avião?\") retifica a afirmação do primeiro quadrinho (“Não há lei que o brasileiro não burle.",
      "A afirmação do segundo quadrinho (“Há a lei da Gravidade.\") refere-se a uma lei da física que nenhum brasileiro é capaz de burlar, como se admite no primeiro quadrinho.",
      "A pergunta lançada no último quadrinho (\"Você sabe quem inventou o avião?\") é retórica, já que não há uma resposta para ela nem no primeiro nem no segundo quadrinhos."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de tirinhas", "Ironia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de texto", "Elementos da comunicação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Elementos da Narrativa"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Análise Literária"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Portuguesa", "Análise Literária"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Equações Exponenciais", "Funções Compostas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[Gráfico representando uma curva de função]",
      "[Gráfico representando uma curva de função]",
      "[Gráfico representando uma curva de função]",
      "[Gráfico representando uma curva de função]"
    ],
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Funções", "Geometria Plana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Progressões Aritméticas", "Trigonometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Vocabulário", "Ordem Alfabética"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "a constante da primeira equação multiplicada por In 2, o que está de acordo com um somatório."
    ],
    correctAnswer: 1,
    materia: ["Química"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História do Brasil", "República Velha"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Geologia", "Paleontologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História", "Física"],
    conteudo: ["Segunda Guerra Mundial", "Física Nuclear"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Inglês"],
    conteudo: ["Imperialismo", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de Texto", "Geopolítica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A densidade de massa de um corpo humano é aproximadamente igual à da água, e retirar o braço para fora da água reduziria a força de empuxo, contrária ao peso do corpo, contribuindo para seu afundamento.",
      "O corpo humano está submetido a uma aceleração gravitacional aproximadamente igual à que atua na porção de água de mesma massa que o corpo, e retirar o braço para fora da água reduziria a força de empuxo, contrária ao peso do corpo, contribuindo para seu afundamento.",
      "A densidade de massa de um corpo humano é aproximadamente igual à da água, e retirar o braço para fora da água aumentaria a força de empuxo, contrária ao peso do corpo, contribuindo para seu afundamento.",
      "O corpo humano está submetido a uma aceleração gravitacional aproximadamente igual à que atua na porção de água de mesma massa que o corpo, e retirar o braço para fora da água aumentaria a força de empuxo, contrária ao peso do corpo, contribuindo para seu afundamento."
    ],
    correctAnswer: 0,
    materia: ["Física"],
...
createQuestion({
    ...
    conteudo: ["Química Ambiental", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "serras e cristas do complexo Gnáissico-Magmático e a lama contém majoritariamente areia e óxidos metálicos.",
      "planícies quaternárias com a presença de falésias vivas e a lama contém majoritariamente argila e óxidos metálicos.",
      "serras e cristas do complexo Gnáissico-Magmático e a lama contém majoritariamente argila e óxidos metálicos.",
      "planícies quaternárias com a presença de falésias vivas e a lama contém majoritariamente areia e óxidos metálicos."
    ],
    correctAnswer: 2,
    materia: ["Química", "Geografia"],
    conteudo: ["Geoquímica", "Geomorfologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Região Sul; 3.900 MWh.",
      "Região Nordeste; 1.950 MWh.",
      "Região Nordeste; 3.900 MWh.",
      "Região Sul; 1.950 MWh."
    ],
    correctAnswer: 1,
    materia: ["Física", "Geografia"],
    conteudo: ["Energia", "Fontes de Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A presença de insetos nas lavouras pode ser uma das causas da queda de produtividade e biodiversidade.",
      "Práticas agrícolas convencionais, com uso de pesticidas, favorecem os polinizadores e aumentam a produtividade.",
      ...
      "A biodiversidade observada na África, Ásia e América do Sul demanda uso intenso de defensivos agrícolas."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Agronegócio"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A, B, De F são diploides.",
      "B, C, De E são formados na telófase I.",
      "A, B, De G são células idênticas quanto ao seu material genético.",
      "B, C, De I são haploides."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Divisão Celular", "Meiose"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O alimento B não afeta a concentração de glicose na circulação sanguínea.",
      "O alimento A não possui carboidratos em sua composição.",
      "O alimento B ajuda a emagrecer, pois estimula a liberação de adrenalina.",
      "O alimento A estimula a liberação de insulina na circulação sanguínea."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "A principal forma de se adquirir o HPV é através da ingestão de alimentos contaminados.",
      "O câncer de colo de útero não pode ser causado pelo vírus HPV.",
      "Ο vírus HPV pode permanecer latente por vários anos.",
      "Não há tratamento nem vacina para o HPV."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Virologia", "Doenças Sexualmente Transmissíveis"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "À semelhança dos mamíferos placentários, a fêmea do ornitorinco alimenta os filhotes com seu leite, mas coloca ovos.",
      "Diferentemente dos mamíferos placentários, os ornitorrincos não produzem leite para a alimentação dos filhotes.",
      "À semelhança dos mamíferos placentários, os embriões dos ornitorrincos alimentam-se exclusivamente de vitelo acumulado no ovo.",
      "Diferentemente dos mamíferos placentários, os ornitorrincos apresentam autofecundação e produzem ovos."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "As espécies 1 e 4 são mais próximas entre si do que as espécies 1 e 3.",
      "As espécies 2 e 3 são mais próximas entre si do que as espécies 1 e 3.",
      "As espécies 1 e 3 são mais próximas entre si do que as espécies 3 e 4.",
      "As espécies 2 e 4 são mais próximas entre si do que as espécies 1 e 2."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "O tecido adiposo branco produz mais energia que o tecido adiposo marrom.",
      "O tecido adiposo marrom não produz ATP, mas produz calor.",
      "O tecido adiposo branco não produz ATP, mas produz calor.",
      "O tecido adiposo branco produz ATP e calor."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana", "Histologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História do Brasil", "Período Colonial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História Social", "Século XIX"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["História do Brasil", "Iconografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Tropicalismo", "Ditadura Militar (Brasil)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o processo de globalização provocou a destruição da cultura dos povos não ocidentais e, por isso, aumentou práticas como o terrorismo a partir de 2001.",
      "a ideia de civilização, como imaginada no século XIX, produziu a emancipação das Américas e o fim da disputa colonial no mundo.",
      "o conceito de civilização foi estabelecido na Grécia Antiga e aperfeiçoado pelas práticas integradoras do imperialismo do século XIX ocorridas na África.",
      "a lógica de integração de culturas é negada por grupos radicais e pelos defensores do princípio de que vivemos em um choque de civilizações."
    ],
    correctAnswer: 3,
    materia: ["Sociologia", "Filosofia"],
    conteudo: ["Globalização", "Cultura"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["O que é Filosofia", "Filosofia Política"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Estática", "Leis de Newton"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Astrofísica", "Energia e Potência"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Biologia Celular", "Óptica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Myanmar, Síria, Somália.",
      "Afeganistão, Síria, Somália.",
      "Afeganistão, Grécia, Macedônia.",
      "Grécia, Macedônia, Myanmar."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["População", "Conflitos Geopolíticos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Economia Brasileira", "Recursos Naturais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "áreas de extensões aquáticas dispostas em paralelo ao litoral e isoladas por cordões litorâneos; mantêm comunicação por canais com as águas fluviais e marinhas, possibilitando a deposição e circulação de sedimentos originados dos dois ambientes e dos ventos.",
      "unidades geomorfológicas arenosas formadas pela ação permanente dos ventos, apresentando pouca ou nenhuma cobertura vegetal e variação de acúmulo de sedimentos; podem contribuir para a recarga dos lençóis freáticos.",
      "áreas de planície arenosa de origem marinha de grande fragilidade ambiental; apresentam variação de cobertura vegetal em diferentes estágios sucessionais e variação de topografia do terreno; contêm zonas inundáveis e não inundáveis.",
      "ambientes de transição, ecótonos, entre áreas marinhas e terrestres, ricos em sedimentos constituídos de matéria orgânica e nutrientes; predomina vegetação arbustiva, que sobrevive em ambientes de permanente inundação."
    ],
    correctAnswer: 3,
    materia: ["Geografia", "Biologia"],
    conteudo: ["Geografia Física", "Ecologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "das dinâmicas das massas de ar formadas nas áreas oceânicas, sempre no verão; são causadas por diferença de pressão atmosférica de áreas de baixa pressão nos oceanos para áreas de alta pressão nos continentes.",
      "do contato de massas de ar com características termodinâmicas semelhantes, formando sistemas de circulação frontais; quanto menor a umidade do sistema, maior é a instabilidade atmosférica.",
      "da ação dos sistemas de ciclones extratropicais, especialmente no inverno; o deslocamento de grandes volumes de água decorre da diferença de pressão atmosférica, que produz ventos intensos.",
      "da ação de ciclones tropicais formados no Atlântico Sul, sempre nos meses de inverno; nesta estação do ano são menores as diferenças de temperatura entre o polo sul e o equador."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Climatologia", "Oceanografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geografia Urbana", "População"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Demografia", "Geografia do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia", "Filosofia"],
    conteudo: ["Sociologia da Violência", "Filosofia Política"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "1 Sudeste; 2 Centro-Oeste; 3 Sul; 4 Norte; 5 Nordeste.",
      "1 Nordeste; 2 Sul; 3 Centro-Oeste; 4 Sudeste; 5 Norte.",
      "1 Centro-Oeste; 2 Sudeste; 3 Norte; 4 Nordeste; 5 Sul."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geografia Agrária", "Cartografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "leite, sendo que a figura da esquerda diz respeito ao acerto da acidez, e a da direita diz respeito à eliminação de microrganismos.",
      "leite, sendo que a figura da esquerda diz respeito à eliminação de microrganismos, e a da direita diz respeito ao acerto da acidez.",
      "dois produtos, por leite, sendo que a figura da esquerda diz respeito à contaminação de hidróxido de sódio, e a da direita diz respeito à contaminação de peróxido de hidrogênio.",
      "hidróxido de sódio, por leite, na figura da esquerda, e a figura da direita não diz respeito à contaminação de nenhum produto."
    ],
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química de Alimentos", "Saúde"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Reações Químicas", "Propriedades dos Materiais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Termodinâmica", "Soluções"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "os revestimentos representados em 1 e 2 apresentam a mesma eficiência em devolver a urina, porque ambos apresentam o mesmo número de átomos na cadeia carbônica hidrofóbica.",
      "o revestimento representado em 1 é mais eficiente para devolver a urina, porque a cadeia carbônica é hidrofóbica e repele a urina.",
      "o revestimento representado em 2 é mais eficiente para devolver a urina, porque a cadeia carbônica apresenta um grupo de mesma polaridade que a água, e, assim, é hidrofóbica e repele a urina.",
      "o revestimento representado em 2 é mais eficiente para devolver a urina, porque a cadeia carbônica apresenta um grupo de mesma polaridade que a água, e, assim, é hidrofílica e repele a urina."
    ],
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Interações Intermoleculares", "Polaridade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "diminuída, enquanto a evaporação do suor no corpo humano evita que sua temperatura aumente.",
      "aumentada, enquanto a evaporação do suor no corpo humano evita que sua temperatura diminua.",
      "diminuída, enquanto a evaporação do suor no corpo humano evita que sua temperatura diminua.",
      "aumentada, enquanto a evaporação do suor no corpo humano evita que sua temperatura aumente."
    ],
    correctAnswer: 3,
    materia: ["Física"],
...
createQuestion({
    ...
    options: [
      "Qualquer que seja a resposta do consumidor, até o travamento automático ou passando do automático, a saúde do frentista será prejudicada, pois sempre haverá eliminação de vapores durante o abastecimento.",
      "A resposta mais adequada do consumidor seria \"sim”, porque a quantidade de vapores eliminados no abastecimento é a mesma, e o prejuízo à saúde do frentista é o mesmo, independentemente do volume de combustível adicionado ao tanque.",
      "A resposta mais adequada do consumidor seria \"não”, pois somente a partir do travamento automático é que há eliminação de vapores durante o abastecimento e só depois disso há prejuízo para a saúde do frentista.",
      "A resposta mais adequada do consumidor seria \"sim”, porque não haverá eliminação de vapores durante o abastecimento e assim nunca haverá prejuízo para a saúde do frentista."
    ],
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Ambiental", "Saúde"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o apreço pela história das invasões bárbaras.",
      "a admiração pela família real.",
      "o valor que atribuem aos seus jardins.",
      "o cuidado com a preservação de seus edifícios históricos."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa", "História"],
    conteudo: ["Interpretação de Tirinhas", "Cultura Britânica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "conversas casuais ou amenas, para estabelecer contato ou quebrar o gelo.",
      "conversas entre cientistas sobre mudanças climáticas.",
      "conversas entre meteorologistas sobre o tempo.",
      "conversas entre pessoas que não conseguem chegar a um consenso."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "38% das jovens engravidam antes dos 18 anos.",
      "38% das jovens concluem o ensino médio aos 22 anos.",
      "a gravidez na adolescência interfere na vida escolar das jovens.",
      "a gravidez após os 18 anos interfere na vida escolar das jovens."
    ],
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Demografia", "Juventude"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de Texto", "Roma Antiga"],
    imageNames: []
})