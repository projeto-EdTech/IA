...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Acentuação", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de Texto", "Semântica", "Brasil República"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Racismo", "Desigualdades Sociais", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Textuais (Verbete)", "Semântica (Ressignificação)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Gêneros Digitais (Memes)", "Intertextualidade", "Teoria Política (Desobediência Civil)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Ditadura Militar no Brasil", "Literatura Brasileira (MPB)", "Interpretação de Canção"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Literatura Brasileira (Literatura Social)", "Cidadania e Participação Política"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira (Poesia Contemporânea)", "Análise Poética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Literatura Brasileira (Teatro Moderno)", "Política e Corrupção"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Filosofia", "Língua Portuguesa"],
    conteudo: ["História das Mentalidades", "Filosofia da Religião", "Literatura Portuguesa (Barroco)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Portuguesa (Realismo)", "Análise Literária (Narrativa)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia", "Língua Portuguesa"],
    conteudo: ["Genética (Projeto Genoma Humano)", "Figuras de Linguagem (Metáfora)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física", "Língua Portuguesa"],
    conteudo: ["Movimento Harmônico Simples (Pêndulo)", "Literatura (Interdisciplinaridade)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa", "Química", "Sociologia"],
    conteudo: ["Literatura Portuguesa (Poesia)", "Composição Química", "Racismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "menor que 4; no exemplo dado eles ocorreram com maior frequência durante o dia.",
      "maior que 4; no exemplo dado eles ocorreram com maior frequência à noite.",
      "menor que 4; no exemplo eles não ocorreram nem durante o dia nem à noite.",
      "maior que 4; no exemplo eles ocorreram durante o período do exame."
    ],
    correctAnswer: 0,
    materia: ["Biologia", "Química", "Física"],
    conteudo: ["Fisiologia Humana (Sistema Digestório)", "pH e Acidez", "Leitura de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Toxicologia", "Proporcionalidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "\"A porcentagem em massa de sódio no realçador (glutamato) é de 13,6%.\"; \"Por outro lado, o realçador só conta com cerca de um terço do nutriente que é encontrado no sal de cozinha.\".",
      "\"A porcentagem em massa de sódio no realçador (glutamato) é de 39,3%.\"; \"Além disso, o realçador contém cerca de três vezes mais nutriente do que o encontrado no sal de cozinha.\".",
      "\"A porcentagem em massa de sódio no realçador (glutamato) é de 11,2%.\"; \"Por outro lado, o realçador conta com cerca de um terço do nutriente que é encontrado no sal de cozinha.\".",
      "\"A porcentagem em massa de sódio no realçador (glutamato) é de 21,0%.”; “Além disso, o realçador contém cerca de três vezes mais nutriente do que o encontrado no sal de cozinha.\"."
    ],
    correctAnswer: 0,
    materia: ["Química", "Biologia"],
    conteudo: ["Estequiometria (Cálculo de Porcentagem)", "Nutrição"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Cinética Química (Meia-vida)", "pH e Acidez"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "3,5 milhões de toneladas de diesel.",
      "11 milhões de toneladas de diesel.",
      "22 milhões de toneladas de diesel.",
      "35 milhões de toneladas de diesel."
    ],
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Ambiental (Biocombustíveis)", "Estequiometria (Cálculo de Massa)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "menor, e a curva A diz respeito aos 30 minutos de exposição prévia.",
      "menor, e a curva A diz respeito aos 10 minutos de exposição prévia.",
      "menor, e a curva B diz respeito aos 10 minutos de exposição prévia.",
      "maior, e a curva B diz respeito aos 30 minutos de exposição prévia."
    ],
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Óptica (Radiação UV)", "Leitura de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "nos três vulcões e, neles, HF e HCl são aproximadamente iguais.",
      "em apenas dois vulcões e, neles, HF e HCl são aproximadamente iguais.",
      "nos três vulcões, mas em apenas dois deles HF e HCl são aproximadamente iguais.",
      "em apenas dois vulcões, mas nos três vulcões HF e HCl são aproximadamente iguais."
    ],
    correctAnswer: 2,
    materia: ["Geografia", "Química", "Física"],
    conteudo: ["Vulcanismo", "Gases", "Leitura de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "tirosina e a curva 1 pode ser correlacionada a um indivíduo que apresenta a fenilcetonúria.",
      "fenilalanina e a curva 1 pode ser correlacionada a um indivíduo que apresenta a fenilcetonúria.",
      "tirosina e a curva 2 pode ser correlacionada a um indivíduo que apresenta a fenilcetonúria.",
      "fenilalanina e a curva 2 pode ser correlacionada a um indivíduo que apresenta a fenilcetonúria."
    ],
    correctAnswer: 2,
    materia: ["Biologia", "Química", "Física"],
    conteudo: ["Genética (Doenças Metabólicas)", "Bioquímica", "Leitura de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia", "Física", "Química"],
    conteudo: ["Biotecnologia (Terapia Fotodinâmica)", "Óptica (Absorção e Emissão de Luz)", "Compostos Orgânicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Angra dos Reis: soja in natura, destinada primordialmente ao mercado do leste europeu.",
      "Vitória: automóveis, destinados primordialmente ao mercado do Oriente Médio.",
      "Itaqui: minério de ferro, destinado primordialmente ao mercado asiático.",
      "Vila do Conde: motocicletas, destinadas primordialmente ao mercado africano."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Comércio Exterior do Brasil", "Produção Agrícola e Mineral do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A expulsão de agricultores familiares pelo avanço das culturas da cana-de-açúcar e do algodão tem gerado conflitos entre pequenos e grandes proprietários de terra; região Centro-Oeste.",
      "A fragmentação da propriedade em áreas de colonização dirigida e a disputa pela posse da terra entre herdeiros vêm produzindo violência agrária; região Norte.",
      "A rivalidade entre trabalhadores rurais e criadores extensivos de gado bovino no Pantanal e nas chapadas mato-grossenses tem resultado em violência agrária; região Centro-Oeste.",
      "A disputa pela terra envolvendo grileiros contra posseiros em áreas de expansão de monocultivos e de projetos de exploração mineral e madeireira tem gerado violência; região Norte."
    ],
    correctAnswer: 3,
    materia: ["Geografia", "Sociologia"],
    conteudo: ["Questão Agrária no Brasil", "Conflitos Sociais no Campo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As florestas têm um aumento na diversidade de suas espécies à medida que a precipitação aumenta e as temperaturas apresentam declínio.",
      "Os desertos e as savanas ocorrem em todos os continentes, em áreas com temperaturas elevadas e baixo volume de precipitação.",
      "A taiga apresenta espécies arbóreas de maior porte em razão da umidade proveniente das baixas pressões de médias latitudes do Hemisfério Norte.",
      "As savanas e as florestas de monções dependem da sazonalidade climática: invernos frios e chuvosos, verões quentes e secos."
    ],
    correctAnswer: 2,
    materia: ["Geografia", "Biologia"],
    conteudo: ["Biomas e Ecossistemas", "Ecologia (Biomas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O volume correspondente à vazão dos dois rios é similar, e o volume de chuvas responsáveis pela recarga desses cursos d'água é o mesmo.",
      "Os dois rios possibilitam, durante todo o ano, o abastecimento humano, a geração de energia, a navegação e a pesca.",
      "A captação de água nos rios A e B pode ocorrer durante todo o ano, pois em ambos há excesso de água no verão e deficit no inverno.",
      "Os rios apresentam regimes fluviais diferentes: o rio A corresponde ao Regime Pluvial Tropical e o rio B representa o Regime Pluvial Semiárido."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Hidrografia Brasileira", "Climatologia (Regimes de Chuva)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O deficit habitacional no Brasil vem sendo enfrentado com a construção de novos domicílios, o que tem resolvido satisfatoriamente a questão da moradia.",
      "Os dados do gráfico confirmam que, em qualquer área do território brasileiro, há mais domicílios vagos em condições de serem ocupados que deficit habitacional.",
      "É muito provável que todas as classes sociais moradoras nas cidades no Brasil sejam igualmente atingidas pelo fenômeno urbano de deficit habitacional.",
      "A correlação entre domicílios vagos e deficit habitacional explica-se, em grande medida, pela especulação imobiliária, que mantém imóveis fechados."
    ],
    correctAnswer: 3,
    materia: ["Geografia", "Sociologia"],
    conteudo: ["Geografia Urbana (Déficit Habitacional)", "Questão da Moradia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Bangladesh; mulçumana e budista.",
      "Índia; católica e hindu.",
      "Tailândia; católica e mulçumana.",
      "China; hindu e budista."
    ],
    correctAnswer: 0,
    materia: ["Geografia", "História"],
    conteudo: ["Geopolítica (Conflitos Étnicos e Migratórios)", "História Contemporânea (Ásia)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Fusos Horários", "Resolução de Problemas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As pastagens e as estepes foram os domínios mais devastados pela implantação da agricultura, em função da fertilidade do seu solo em épocas de degelo, o que favoreceu a produtividade de grande escala.",
      "Não é possível identificar grandes transformações nas condições naturais dos domínios de vegetação europeus em função do processo de sedentarização das sociedades humanas.",
      "O desenvolvimento de lavouras na Europa durante o Neolítico foi base para a transformação de domínios vegetais naturais, o que significa que o desmatamento é uma prática milenar.",
      "As áreas que hoje correspondem aos países da Península Ibérica, ao Reino Unido e à Irlanda foram as pioneiras no desenvolvimento de práticas agrícolas sedentarizadas."
    ],
    correctAnswer: 2,
    materia: ["História", "Geografia"],
    conteudo: ["Pré-História (Neolítico)", "Biogeografia", "Impactos Ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Teoria Política (Fascismo Social)", "Filosofia Política"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia", "Sociologia"],
    conteudo: ["Populações e Migrações", "Questões Indígenas", "Geografia Urbana"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "na Califórnia (EUA), e as ondas longitudinais são aquelas em que a oscilação se dá na direção de propagação.",
      "nos Andes (Chile), e as ondas transversais são aquelas em que a oscilação se dá perpendicularmente à direção de propagação.",
      "na Califórnia (EUA), e as ondas longitudinais são aquelas em que a oscilação se dá perpendicularmente à direção de propagação.",
      "nos Andes (Chile), e as ondas transversais são aquelas em que a oscilação se dá na direção de propagação."
    ],
    correctAnswer: 0,
    materia: ["Geografia", "Física"],
    conteudo: ["Geologia (Tectônica de Placas)", "Ondas Sísmicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "smog fotoquímico, que ocorre em presença de luz, é comum nos dias mais quentes e secos, e tem sua origem nos gases liberados pelos automóveis, cuja composição contém dióxido de enxofre e material particulado.",
    ...
    conteudo: ["Química Ambiental (Poluição do Ar)", "Climatologia (Inversão Térmica)", "Leitura de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Cinemática (Velocidade Média)", "Unidades de Medida (Ano-luz)", "Proporcionalidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O peso da boia.",
      "O dobro do peso da boia.",
      "O peso do peixe menos o peso da boia.",
      "O peso do peixe menos o dobro do peso da boia."
    ],
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Hidrostática (Empuxo)", "Leis de Newton (Tensão)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física", "Matemática"],
    conteudo: ["Eletricidade (Corrente Elétrica)", "Conversão de Unidades"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Hidrostática (Pressão Hidrostática)", "Leitura de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Termodinâmica (Transferência de Calor por Condução)", "Leitura de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Óptica (Laser)", "Energia e Potência"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Termodinâmica (Calor Específico)", "Óptica (Laser)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física", "Matemática"],
    conteudo: ["Ondas (Ondas Eletromagnéticas)", "Notação Científica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Na miopia, a imagem do ponto remoto se forma antes da retina e a cirurgia visa a aumentar a distância focal da lente efetiva do olho.",
      "Na miopia, a imagem do ponto remoto se forma depois da retina e a cirurgia visa a aumentar a distância focal da lente efetiva do olho.",
      "Na miopia, a imagem do ponto remoto se forma depois da retina e a cirurgia visa a diminuir a distância focal da lente efetiva do olho.",
      "Na miopia, a imagem do ponto remoto se forma antes da retina e a cirurgia visa a diminuir a distância focal da lente efetiva do olho."
    ],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: [
      "As minhocas são invertebrados do filo dos anelídeos, possuem corpo celomado e segmentado, convertem detritos ingeridos em matéria orgânica e melhoram o arejamento do solo.",
      "As cobras-cegas são vertebrados do filo dos anelídeos, possuem corpo pseudocelomado e reprodução sexuada, são predadoras de pragas agrícolas e melhoram o arejamento do solo.",
      "As cobras-cegas são invertebrados do filo dos cordados, possuem corpo celomado e não segmentado e são capazes de controlar ervas daninhas, pois consomem suas raízes.",
      "As minhocas são invertebrados do filo dos anelídeos, possuem pseudoceloma e reprodução assexuada, são predadoras de pragas agrícolas e melhoram o arejamento do solo."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Biotecnologia (Terapia Gênica)", "Genética Humana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Genética (Herança Citoplasmática)", "Botânica (Cloroplastos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "não pode pertencer à linhagem evolutiva das serpentes, pois a perda dos membros anteriores e posteriores levaria a um prejuízo à vida do animal, e a evolução resulta apenas em melhoria dos organismos.",
      "não pode pertencer à linhagem evolutiva das serpentes, pois a evolução é gradual e incapaz de gerar mudanças drásticas na morfologia de um ser vivo, como a perda de membros anteriores e posteriores.",
      "pode pertencer à linhagem evolutiva das serpentes, sendo que seu ancestral comum com os lagartos possuía membros, depois perdidos por processos evolutivos, originando as serpentes ápodas atuais.",
      "pode ser um fóssil de transição, pois os ancestrais das serpentes que não utilizavam seus membros com tanta frequência sofreram atrofia desses membros, deixando de transferir tal característica para seus descendentes."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "A radiação diminui a taxa fotossintética de plantas, porém a ação de descontaminação do ambiente pelo homem permite o retorno de populações de plantas e, portanto, dos organismos que delas se alimentam.",
      "A radiação aumenta a taxa de mutação e acelera o metabolismo de plantas, favorecendo sua taxa reprodutiva, o que leva a aumento de suas populações e, consequentemente, das populações de herbívoros.",
      "A radiação reduz os tumores de animais e plantas, aumentando a taxa de sobrevivência desses seres vivos e, consequentemente, o tamanho de suas populações e das de seus consumidores.",
      "A radiação tem impactos negativos sobre animais e plantas, porém a ausência de atividade humana no ambiente contaminado por radiação favorece o crescimento das populações desses organismos."
    ],
    correctAnswer: 3,
    materia: ["Biologia", "Química", "Geografia"],
    conteudo: ["Ecologia (Impactos Ambientais)", "Radioatividade", "Meio Ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "diminui a produção de urina, impedindo que medicamentos proibidos sejam eliminados nas amostras a serem analisadas nos testes antidoping.",
      "diminui a produção de amônia, mas aumenta a eliminação de medicamentos pelo rim, resultando em diluição das amostras analisadas nos testes antidoping.",
      "aumenta a produção de urina, resultando na diminuição da concentração de medicamentos nas amostras, o que dificulta sua detecção nos testes antidoping.",
      "aumenta a produção de ureia, o que resulta na diluição das amostras a serem analisadas nos testes antidoping e na diminuição da concentração dos medicamentos."
    ],
    correctAnswer: 2,
    materia: ["Biologia", "Química"],
    conteudo: ["Fisiologia Humana (Sistema Urinário)", "Bioquímica (Furosemida)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química", "Biologia", "Matemática"],
    conteudo: ["Química Ambiental", "Botânica (Tecidos Vegetais)", "Leitura de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Parasitologia (Malária)", "Ciclo de Vida de Parasitas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "(i) tirosina; (ii) a síntese de proteínas; (iii) nucleotídeo dAMP; (iv) pelo ribossomo como possível precursor na transcrição.",
      "(i) vidarabina; (ii) a replicação do DNA; (iii) nucleotídeo dAMP; (iv) pela polimerase como possível precursor na síntese do DNA.",
      "(i) vidarabina; (ii) a síntese de proteínas; (iii) ácido úrico; (iv) pelo ribossomo como possível precursor na tradução.",
      "(i) tirosina; (ii) a replicação do DNA; (iii) nucleotídeo dAMP; (iv) pela transcritase como possível precursor do DNA."
    ],
    correctAnswer: 1,
    materia: ["Química", "Biologia"],
    conteudo: ["Química Orgânica", "Bioquímica (Replicação de DNA)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Química Ambiental (Gases do Efeito Estufa)", "Revolução Industrial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Filosofia", "Sociologia", "Matemática"],
    conteudo: ["Relação Filosofia e Ciência", "Sociologia da Educação", "História da Matemática"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Genética de Populações", "Probabilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Porcentagem", "Aritmética Comercial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Média Aritmética", "Desigualdades"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Aritmética", "Equações Algébricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Funções Quadráticas", "Gráficos de Funções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Equações de Segundo Grau (Relações de Girard)", "Trigonometria (Identidades Fundamentais)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Triângulos)", "Ângulos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Área de Triângulos)", "Semelhança de Triângulos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Pentágonos)", "Progressão Geométrica", "Trigonometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Paralelepípedo)", "Teorema de Pitágoras"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Os conhecimentos sobre os fenômenos naturais construídos pelos mesopotâmicos, egípcios, macedônicos, babilônicos, persas, entre outros povos, foram ignorados pelo Isla Medieval, marcado pelo fundamentalismo religioso.",
    ...
    conteudo: ["Idade Média (Civilização Islâmica)", "História da Filosofia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Figura emblemática do Renascimento, Leonardo da Vinci destaca-se pela sua obra pictórica e por seu desenho do Homem Vitruviano. Para ele, arte e ciência se baseavam nas relações análogas entre homem e natureza preconizadas pela alquimia.",
      "O Homem Vitruviano de Leonardo da Vinci condensa uma série de estudos do artista, e mesmo a leitura de uma cópia manuscrita da obra de Vitrúvio. O desenho sintetiza uma relação harmônica entre homem e mundo pautada pela analogia geométrica.",
      "Na linhagem dos artistas-arquitetos-engenheiros renascentistas, Leonardo da Vinci dedicou-se ao estudo da perspectiva e especialmente da aritmética, buscando harmonizar as relações entre o homem e Deus no Homem Vitruviano.",
      "Leitor assíduo da física newtoniana, Leonardo da Vinci reconhecia que tanto a aritmética quanto a geometria poderiam ser usadas na arte, arquitetura e engenharia. Na elaboração do desenho do Homem Vitruviano, ele comprovou esta hipótese."
    ],
    correctAnswer: 1,
    materia: ["Arte", "História", "Matemática"],
    conteudo: ["Renascimento (Leonardo da Vinci)", "História da Ciência", "Geometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A presença de negros nos processos de conquista e colonização das Américas limitou-se à atuação como mão de obra escravizada em plantações, em serviços domésticos ou como trabalhadores sem especialização em núcleos urbanos.",
      "A presença de afrodescendentes na América espanhola pode ser distribuída nas categorias: escravos, fugitivos ou forros, em meio rural e urbano, auxiliares nos processos de conquista e ainda como conquistadores, proprietários e vecinos.",
      "A presença de negros nos exércitos de Cortez é um exemplo da ausência de critérios discriminatórios de limpeza de sangue no processo de conquista da América espanhola, diferentemente do que ocorria nas Américas portuguesa e inglesa.",
      "A presença de afrodescendentes no mundo espanhol foi tardia e concentrou-se no espaço caribenho, onde atuaram como parte da mão de obra escravizada, mas também atuaram como conquistadores e vecinos cidadãos."
    ],
    correctAnswer: 1,
    materia: ["História", "Sociologia"],
    conteudo: ["Colonização da América (América Espanhola)", "Populações Afro-Americanas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "O texto permite compreender a necessidade de o colonizador português conhecer e dominar a língua para poder disciplinar os índios em toda a Amazônia durante o período pombalino e no século XIX.",
      ...
      "A experiência do nheengatu desapareceu no processo de exploração da mão de obra indígena na Amazônia e em função da interferência da Coroa, que defendia o uso da língua portuguesa."
    ],
    correctAnswer: 2,
    materia: ["História", "Língua Portuguesa", "Sociologia"],
    conteudo: ["Brasil Colônia (Língua Geral)", "Linguística (História da Língua)", "Colonialismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A demanda do mercado consumidor criado na zona mineradora permitiu a conexão entre diferentes partes da Colônia que até então eram pouco integradas.",
      "A partir da criação de rotas de comércio entre os campos do sul da Colônia e a região mineradora, Sorocaba e suas feiras perderam a relevância econômica adquirida no século XVII.",
      ...
      "Como o solo da região mineradora era infértil, durante todo o século XVIII sua população importava os produtos alimentares de Portugal ou de outras capitanias."
    ],
    correctAnswer: 0,
    materia: ["História", "Geografia"],
    conteudo: ["Brasil Colônia (Ciclo do Ouro)", "Formação do Território Brasileiro"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["Colonialismo na África", "Etnocentrismo", "Identidade Cultural"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Através de vários mecanismos de propaganda ideológica e coerção física, os italianos foram forçados a entoar a música Bella Ciao, a fim de demonstrar publicamente sua adesão ao fascismo. Este caráter umbilical da relação da massa com o líder aparece retratado na fotografia.",
      "Por se tratar de um produto da indústria cultural com forte apelo comercial, compreende-se a circulação e o consumo desta música em plano global e em várias mídias (shows musicais, novelas e séries). Neste sentido, a imagem é um cartaz caracterizado pela neutralidade política.",
      "Trata-se de uma música de alcance internacional entoada em várias partes do mundo, em diferentes contextos de resistência política contra o fascismo, regime caracterizado pela adesão da massa em relação ao seu líder, como explicita a fotografia.",
      "O gesto que recupera em 2018 esta canção sugere uma semelhança entre o tempo de antes (do fascismo) e o de hoje, aproximando Silvio Berlusconi de Mussolini, dirigente retratado na fotografia. Antes, como agora, Bella Ciao exalta a resistência, identificando-se como uma canção nacionalista."
    ],
    correctAnswer: 2,
    materia: ["História", "Arte", "Sociologia"],
    conteudo: ["Fascismo e Totalitarismo", "Música (Canção de Protesto)", "Ideologia e Propaganda"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Influenciado pela política de Estado da União Soviética, as manifestações de 1968 foram desencadeadas pelos operários franceses, que exigiam melhores condições de trabalho, por meio das pichações em muros espalhados pela cidade.",
      "Influenciado pelo contexto cultural da Guerra Fria, as manifestações de 1968 tinham como palavras de ordem a liberdade de expressão política e sexual, como se via nas inscrições nos muros de Paris.",
      ...
      "Influenciado por ideias esquerdistas, comunistas e anarquistas, as manifestações de 1968 ficaram restritas às camadas populares francesas, sendo que as inscrições nos muros das cidades indicavam o grupo social responsável."
    ],
    correctAnswer: 1,
    materia: ["História", "Sociologia", "Arte"],
    conteudo: ["História Contemporânea (Maio de 1968)", "Movimentos Sociais", "Arte Urbana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física", "História", "Filosofia"],
    conteudo: ["Leis de Kepler", "Revolução Científica", "Cosmologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "determinar como o manuseio de papel térmico pode contaminar uma pessoa com bisfenol A, considerando que a concentração foi monitorada utilizando-se um BPA em que átomos de ²H foram substituídos por ¹H.",
      "analisar de que forma o uso de luvas nitrílicas lavadas com sabão e contendo BPA deuterado pode contaminar receitas impressas em papel térmico que contém um disruptor endócrino.",
      "monitorar, durante uma semana ou mais, a cinética de eliminação de um disruptor endócrino, bisfenol A (BPA), do corpo humano que foi contaminado pelo uso de luvas nitrílicas.",
      "verificar como um papel térmico deteriorado por átomos de ²H poderia contaminar as mãos de uma pessoa, mesmo que ela estivesse usando luvas nitrílicas durante duas horas e depois as removesse."
    ],
    correctAnswer: 0,
    materia: ["Química", "Biologia", "Física"],
    conteudo: ["Química Analítica (BPA)", "Saúde Humana (Contaminação)", "Isótopos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Teoria dos Números (Números Primos)", "Critérios de Divisibilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "as vantagens da globalização para o consumidor e os problemas causados pela imigração.",
      "o impacto negativo dos processos migratórios no modo como as culturas vêm sendo globalizadas.",
      "os efeitos da globalização no nosso cotidiano e o preconceito contra imigrantes.",
      "o consumo excessivo de produtos estrangeiros no mundo capitalista contemporâneo."
    ],
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Globalização", "Migrações", "Preconceito"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "justificar a meritocracia como princípio de reconhecimento de igualdade de oportunidades.",
      "identificar a garantia do salário mínimo como condição suficiente para a proteção da classe trabalhadora.",
      "abordar os efeitos da precarização do trabalho nas sociedades contemporâneas.",
      "propor que a empregabilidade leva à recuperação da economia e à justiça social."
    ],
    correctAnswer: 2,
    materia: ["Sociologia", "Língua Portuguesa"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia", "Língua Portuguesa"],
    conteudo: ["Gênero e Feminismo", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Inglês", "Língua Portuguesa"],
    conteudo: ["Vocabulário", "Humor", "Gêneros Textuais (Frase de Efeito)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Inglês", "Sociologia", "Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Identidade Cultural", "Intertextualidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de Poesia", "Existencialismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "algumas mulheres descuidarem da prevenção de problemas de saúde para os quais pareciam não estar predispostas.",
      "governos usarem as informações genéticas para negar a certos cidadãos o acesso a serviços de saúde pública.",
      "pais e educadores passarem a desconsiderar dados sobre o coeficiente de inteligência de seus filhos ou alunos."
    ],
    correctAnswer: 1,
    materia: ["Biologia", "Sociologia", "Filosofia"],
    conteudo: ["Genética (Testes Genéticos)", "Ética e Tecnologia", "Bioética"],
    imageNames: []
})