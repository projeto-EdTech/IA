createQuestion({
    ...
    options: [
      "A teve um crescimento maior do que C.",
      "C teve um crescimento maior do que B.",
      "B teve um crescimento igual a A.",
      "C teve um crescimento menor do que B."
    ],
    correctAnswer: 1,
    materia: ["Matemática"],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Idade Média", "Cristianismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Idade Média", "Trabalho e Escravidão"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Brasil Colônia", "Pacto Colonial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["América Latina", "Independência"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Brasil República", "Belle Époque"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Guerra Fria", "Nova Ordem Mundial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Arte"],
    conteudo: ["Arte Brasileira", "Leitura de imagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Regional", "África Contemporânea"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Urbanização", "Metropolização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia", "História"],
    conteudo: ["Transportes", "Formação Territorial Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["População Brasileira", "Demografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Estado e Governo", "Constituição Federal"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "É uma prática conservacionista, em que há a incorporação dos restos vegetais de uma cultura no próximo plantio, procurando melhorar as características químicas e físicas do solo.",
      "É uma prática conservacionista, em que há a incorporação dos restos vegetais de uma cultura no próximo plantio, procurando melhorar unicamente as características químicas do solo.",
      "É uma prática conservacionista, em que há a incorporação dos restos vegetais de uma cultura no próximo plantio, procurando melhorar unicamente as características físicas do solo.",
      "Apesar de diminuir os processos erosivos provocados pelo escoamento superficial da água, a prática não evita o uso de queimadas esporádicas e não aumenta a fertilidade química do solo."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Agricultura", "Meio Ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ocorreu no Hemisfério Sul e corresponde a uma área de alta pressão atmosférica.",
      "pode ocorrer em qualquer hemisfério, independentemente da pressão atmosférica.",
      "ocorreu no Hemisfério Norte, em zonas tropicais e de baixa pressão atmosférica.",
      "ocorreu no Hemisfério Sul e corresponde a uma área de baixa pressão atmosférica."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "Trata-se de uma manifestação eruptiva do Mesozoico, associada com o riftiamento que formou o Oceano Atlântico, sendo uma das maiores manifestações vulcânicas da história geológica da Terra. As alterações dessas rochas formam solos muito férteis, chamados de Nitossolos.",
      "Trata-se de uma manifestação eruptiva do Quaternário, relacionada a uma série de hotspots associados à bacia do Paraná. As alterações dessas rochas formam solos muito ácidos, que acabam por dificultar as atividades agrícolas.",
      "Corresponde a um evento vulcânico que foi ativo durante milhões de anos, associado à deriva continental da América do Sul, em direção leste. As alterações dessas rochas formam solos extremamente férteis, classificados atualmente como \"Terras Roxas\".",
      "Foi uma atividade vulcânica entre as maiores da história da Terra, que ocorreu durante o Paleógeno (antigo Terciário Inferior), quando se iniciou a separação América do Sul-África. Os solos desenvolvidos sobre essas rochas são extremamente férteis."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geomorfologia", "Geologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O rio corre em direção sudeste, sendo sua margem esquerda a de maior declividade. Apresenta um comprimento total de 17.500 metros.",
      "O rio corre em direção sudoeste, sendo a margem direita a de maior declividade. Apresenta um comprimento total de 1.750 quilômetros.",
      "O rio corre em direção sudeste, sendo sua margem esquerda a de maior declividade. Apresenta um comprimento total de 1.750 metros.",
      "O rio corre em direção sudoeste, sendo sua margem esquerda a de maior declividade. Apresenta um comprimento total de 175 metros."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "Trata-se da ascensão de um moderno mundo urbano, onde coexistiam harmonicamente diferentes temporalidades, funções urbanas, sistemas técnicos e formas de trabalho, viabilizando-se, desse modo, a coesão entre o espaço da cidade e o tecido social.",
      "Trata-se de um espaço agrário e acomodado, num período em que a urbanização não tinha se estabelecido, mas que abrigava em seu interstício alguns vetores da modernização industrial.",
      "Trata-se de um espaço onde coexistiam distintas temporalidades: uma atrelada ao ritmo lento de um passado agrário e, outra, atrelada ao ritmo acelerado que caracteriza a modernidade urbana.",
      "Trata-se de uma paisagem urbana e uma divisão do trabalho típicas do período colonial, pois a metropolização é um processo desencadeado a partir da segunda metade do século XX."
    ],
    correctAnswer: 2,
    materia: ["Geografia", "História", "Língua Portuguesa"],
    conteudo: ["Urbanização", "Brasil República", "Leitura de imagem e texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Coesão e Coerência", "Análise textual"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Análise textual", "Gêneros textuais", "Figuras de linguagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais (Publicidade)", "Leitura de imagem e texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Análise textual", "Vocabulário"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Análise textual", "Sintaxe"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Figuras de linguagem", "Interpretação poética", "Modernismo Português"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação poética", "Ironia", "Brasil República"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Modernismo Brasileiro", "Clarice Lispector"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros literários (Comédia)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Romantismo", "Almeida Garrett"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Pré-modernismo", "Monteiro Lobato"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Modernismo Brasileiro", "Carlos Drummond de Andrade", "Figuras de linguagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Africana", "Mia Couto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Quantidade de Movimento", "Colisões"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[Diagrama de circuito elétrico A]",
      "[Diagrama de circuito elétrico B]",
      "[Diagrama de circuito elétrico C]",
      "[Diagrama de circuito elétrico D]"
    ],
    correctAnswer: 0,
    materia: ["Física"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica", "Corrente Alternada"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "antenas à esquerda das pernas.",
      "pedipalpos à direita do abdome.",
      "abdome à esquerda das pernas.",
      "abdome à direita dos pedipalpos."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Citologia", "Microscopia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A é Briófita, B é Pteridófita e C é Espermatófita.",
      "C é Espermatófita, D é traqueófita e E é Angiosperma.",
      "C possui sementes, D é Espermatófita e E é Angiosperma.",
      "B é Briófita, D é traqueófita e E possui sementes."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Evolução", "Botânica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a energia é conservada entre os níveis tróficos.",
      "a respiração dos autótrofos é uma fonte de energia para os heterótrofos.",
      "a produtividade primária líquida é representada na base da pirâmide.",
      "a excreção é uma fonte de energia para os níveis tróficos superiores."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "Na presença de genes apenas nas regiões A e C, a flor produzirá pólen.",
      "Na presença de genes apenas nas regiões A e B, a flor dará origem a um fruto.",
      "Na ausência de genes na região B, a autofecundação na flor é possível.",
      "Na ausência de genes na região A, a flor será menos visitada por polinizadores."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Botânica", "Genética do Desenvolvimento"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "peixes são animais amoniotélicos, aves e répteis são ureotélicos e mamíferos são uricotélicos.",
      "a ureia é altamente tóxica e insolúvel em água, sendo a principal excreta das aves.",
      "peixes, exceto os condrictes, são amoniotélicos e aves e répteis adultos são ureotélicos.",
      "a amônia é altamente tóxica e necessita de um grande volume de água para ser eliminada."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "dentes de superfície plana revelam uma dieta herbívora composta predominantemente de gramíneas e são típicos de onívoros, cujos crânios são representados nas imagens A e B acima.",
      "os incisivos, caninos e molares estreitos têm formas diversas, que podem cortar ou destacar alimentos. O crânio representado na figura A acima sugere que se trata de um carnívoro.",
      "os incisivos, caninos e molares estreitos têm formas diversas, que podem cortar ou destacar alimentos. Os caninos para perfurar ou rasgar, como os representados na imagem B acima, são típicos de carnívoros.",
      "dentes de superfície plana revelam uma dieta herbívora composta predominantemente de gramíneas e são típicos de onívoros como os felinos, representados na imagem A acima."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Evolução", "Anatomia Comparada"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Genética", "Saúde Humana"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a fotossíntese das plantas é maior no início e no final do período diurno.",
      "as plantas respiram mais na estação chuvosa.",
      "na estação seca, há um pico de respiração às 12 horas.",
      "as plantas fazem mais fotossíntese e respiram menos na estação chuvosa."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Fisiologia Vegetal"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a composição química da atmosfera influenciou o surgimento da vida.",
      "os coacervados deram origem às moléculas orgânicas.",
      "a teoria da abiogênese foi provada pelos experimentos de Pasteur.",
      "o vitalismo é uma das bases da biogênese."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "O fato de ser transmitida por um vírus para o qual não existe vacina.",
      "O fato de ser frequentemente transmitida por secreções das vias respiratórias, como gotículas eliminadas pelo espirro ou pela tosse.",
      "O fato de ser transmitida apenas por meio de insetos vetores.",
      "O fato de ser extremamente contagiosa apenas em crianças desnutridas, recém-nascidos e crianças portadoras de imunodeficiências."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Saúde", "Doenças Virais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "I não atrai os insetos e tem caráter básico.",
      "II atrai os insetos e tem caráter ácido.",
      "II não atrai os insetos e tem caráter básico.",
      "I não atrai os insetos e tem caráter ácido e básico."
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Funções Orgânicas", "Acidez e Basicidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "1 e 7, porque o aroma da carne se deve, principalmente, aos hidrocarbonetos aromáticos.",
      "3 e 5, porque a infusão facilita a extração de componentes importantes do chá.",
      "4 e 6, porque os carboidratos são constituintes importantes do óleo comestível.",
      "2 e 8, porque a proteína é um tipo especial de açúcar."
    ],
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química dos Alimentos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "concordar parcialmente com a sugestão, pois há argumentos que justificam a polaridade, mas não há argumentos que justifiquem a volatilidade.",
      "concordar totalmente com a sugestão, pois os argumentos referentes à polaridade e à volatilidade apresentados no trecho justificam ambas.",
      "concordar parcialmente, pois não há argumentos que justifiquem a polaridade, mas há argumentos que justificam a volatilidade.",
      "discordar totalmente, pois não há argumentos que justifiquem a polaridade nem a volatilidade."
    ],
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Propriedades Físicas dos Materiais", "Forças Intermoleculares"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "da emissão das espécies NOx, e não contribui para a poluição atmosférica.",
      "completa do NO e apenas da metade do NO2 emitido, mas contribui para a poluição atmosférica.",
      "completa do NO, mas somente reduz a emissão de NO2 depois que acabar o NO, e não contribui para a poluição atmosférica.",
      "da emissão das espécies NOx, mas contribui para a poluição atmosférica."
    ],
    correctAnswer: 3,
    materia: ["Química"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Bioquímica", "Estequiometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "aumenta com o derretimento das geleiras e diminui com o congelamento da água do mar.",
      "diminui com o congelamento e com a evaporação da água do mar.",
      "aumenta com a evaporação e o congelamento da água do mar e diminui com a chuva ou neve.",
      "diminui com a evaporação da água do mar e aumenta com o derretimento das geleiras."
    ],
    correctAnswer: 2,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "é proveniente dos cometas e a água da Terra e a do cometa têm propriedades físicas muito parecidas.",
      "não é proveniente dos cometas, apesar de a água da Terra e a do cometa terem propriedades físicas muito parecidas.",
      "não é proveniente dos cometas, porque a água da Terra e a do cometa apresentam propriedades físicas muito diferentes.",
      "é proveniente dos cometas e a água da Terra e a do cometa têm as mesmas propriedades físicas."
    ],
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Radioatividade", "Isótopos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Soluções", "Processos Físico-Químicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "do aumento do pH dos mares e acabam de constatar o abaixamento do nível dos mares.",
      "da diminuição do pH dos mares e acabam de constatar o aumento do nível dos mares.",
      "do aumento do nível dos mares e acabam de constatar o abaixamento do pH dos mares.",
      "da diminuição do nível dos mares e acabam de constatar o aumento do pH dos mares."
    ],
    correctAnswer: 2,
    materia: ["Geografia", "Língua Portuguesa"],
    conteudo: ["Impactos Ambientais", "Leitura de imagem e texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "despreza os que restringem a liberdade de expressão.",
      "critica os excessos da liberdade de expressão.",
      "critica a falta de liberdade de expressão.",
      "defende a liberdade de expressão sem restrições."
    ],
    correctAnswer: 3,
    materia: ["Filosofia", "Sociologia"],
    conteudo: ["Filosofia Política", "Direitos Humanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "derrotar o adversário em um jogo de futebol.",
      "vencer o interlocutor em uma discussão.",
      "derrotar o adversário na olimpíada de inglês.",
...
createQuestion({
    ...
    options: [
      "curso on-line e presencial que oferece uma metodologia para ajudar a definir quais alimentos deverão ser consumidos no futuro.",
      "curso on-line que oferece uma metodologia para minimizar riscos no consumo de alimentos no futuro.",
      "curso on-line e presencial que oferece uma metodologia para construção de cenários futuros sobre consumo de alimentos.",
      "curso presencial que oferece uma metodologia para ajudar as pessoas a comerem melhor no futuro."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Interpretação de texto"],
...
createQuestion({
    ...
    options: [
      "fazer coisas que nunca fez antes.",
      "fazer novos amigos.",
      "fazer um curso de dança como ouvinte.",
      "abandonar o curso."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
...
createQuestion({
    ...
    conteudo: ["Interpretação de texto", "Ecologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "caminham longas distâncias e usam o celular para registrar essas distâncias.",
      "escrevem ou leem mensagens, ou veem vídeos no celular enquanto caminham.",
      "testam o celular como dispositivo para caminhadas longas.",
      "tropeçam e caem quando usam o celular enquanto caminham."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Interpretação de texto"],
