...
createQuestion({
    ...
    conteudo: ["Literatura Portuguesa", "Interpretação de Texto", "Questões da Identidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Análise Poética", "Vocabulário e Semântica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Portuguesa", "Intertextualidade", "Provérbios"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Literatura Brasileira", "Interpretação de Texto", "Figuras de Linguagem (Metáfora)", "Brasil Império"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Análise de Obra"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa", "Arte", "Sociologia", "História"],
    conteudo: ["Interpretação de Texto", "Arte Indígena Contemporânea", "Cultura Indígena", "Memória e Tradição"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Figuras de Linguagem (Metáfora)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Formação de Palavras (Neologismo)", "Semântica", "Relação Campo-Cidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "O texto Il alude ao texto I para reforçar a equivalência entre as condições de ficar “off-line” e ser \"marginal\" em cada contexto.",
    ...
    conteudo: ["Arte Contemporânea", "Intertextualidade", "Comportamento Social e Redes Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "da produção e circulação de bens culturais por grupos sociais.",
      "da atenção dada aos valores individuais e aos direitos autorais.",
      "da consideração de experiências e valores de outras culturas.",
      "do compartilhamento de bens culturais via tecnologia digital."
    ],
    correctAnswer: 2,
    materia: ["Filosofia", "Sociologia", "Língua Portuguesa"],
    conteudo: ["Cultura e Sociedade", "Produção Cultural", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "contextualizam os usos dos dois termos pela agência.",
      "enfatizam a sinonímia dos termos no uso pela agência.",
      "evidenciam uma antonímia dos significados dos termos.",
      "informam as acepções figuradas de cada um dos termos."
    ],
    correctAnswer: 0,
    materia: ["Geografia", "Sociologia", "Língua Portuguesa"],
    conteudo: ["Migrações", "Questões Sociais", "Vocabulário e Semântica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Sistemas de Equações", "Problemas de Primeiro Grau"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Análise de Gráficos e Tabelas", "Proporcionalidade", "Aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Funções (Interpretação de Gráficos)", "Composição de Funções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Progressões Geométricas", "Média Geométrica", "Potenciação"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "para uma vacina, quanto maior R₀, menor a porcentagem mínima da população que deve ser vacinada para controlar a epidemia.",
      "para uma vacina, quanto maior R₀, maior a porcentagem mínima da população que deve ser vacinada para controlar a epidemia.",
      "para um dado R₀, quanto maior a efetividade da vacina, maior a porcentagem mínima da população que deve ser vacinada para controlar a epidemia."
    ],
    correctAnswer: 2,
    materia: ["Matemática", "Biologia"],
    conteudo: ["Modelagem Matemática", "Epidemiologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Círculo e Quadrilátero)", "Progressão Aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Funções Quadráticas (Parábola)", "Equações de Retas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Polinômios", "Divisão de Polinômios"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "400√2−√2 − 60√2+√2 ≈ 195,3",
      "200√2−√2 − 15√2+√2 ≈ 125,4",
      "200√2−√2 + 15√2+√2 ≈ 180,8",
      "200√3−√3 − 15√3+√3 ≈ 192,6"
    ],
    correctAnswer: 2,
    materia: ["Matemática", "Física"],
    conteudo: ["Trigonometria", "Geometria Plana", "Cinemática (contexto)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Neologismo", "Semântica", "Vocabulário", "Gramática"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "critica a baixa representatividade da amostra, e apresenta uma série de recomendações que podem valorizar a profissão de artistas.",
      "questiona a ausência de muitos pontos que poderiam ter sido discutidos na pesquisa, e sugere várias medidas para aumentar o debate em torno da arte.",
      "levanta uma série de dúvidas quanto à validade da pesquisa, e indica medidas que podem contribuir para uma depreciação da arte.",
      "problematiza os dados revelados pela pesquisa, e recomenda algumas ações cujos resultados ratificam a relevância da profissão de artistas."
    ],
    correctAnswer: 3,
    materia: ["Inglês", "Sociologia"],
    conteudo: ["Interpretação de Texto", "Profissões e Valor Social", "Arte e Cultura"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Inglês", "Filosofia", "Sociologia", "Biologia"],
    conteudo: ["Interpretação de Texto", "Ética", "Direitos Humanos", "Direitos Animais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Movimentos Sociais (LGBTQIA+)", "Direitos Civis", "História Contemporânea"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Inglês", "Biologia", "Sociologia"],
    conteudo: ["Interpretação de Texto", "Saúde Pública", "Política e Ciência"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Inglês", "Filosofia", "Arte"],
    conteudo: ["Interpretação de Texto", "Existencialismo", "Tomada de Decisão", "Interpretação de Imagens"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Inglês", "Sociologia", "Filosofia"],
    conteudo: ["Compreensão de Texto", "Relações Interpessoais", "Ética"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de Texto", "Conflitos Geopolíticos (Conflito Israel-Palestina)", "Direitos Humanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "antimicrobiano, oxidante, floculante e adsorvente.",
      "microbiano, oxidante, floculante e adsorvente.",
      "antimicrobiano, redutor, coagulante, floculante.",
      "microbiano, redutor, coagulante, floculante."
    ],
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Tratamento de Água", "Funções Inorgânicas", "Propriedades de Compostos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "processos, substratos, termoquímicos, biológicos, inorgânicos e orgânicos.",
      "substratos, processos, biológicos, termoquímicos, orgânicos e inorgânicos.",
      "processos, substratos, termoquímicos, biológicos, orgânicos e inorgânicos.",
      "substratos, processos, biológicos, termoquímicos, inorgânicos e orgânicos."
    ],
    correctAnswer: 1,
    materia: ["Química", "Biologia"],
    conteudo: ["Cadeias de Carbono", "Química Ambiental", "Ciclos Biogeoquímicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "inverno e verão, e que a dessorção dos gases que ocorre nos MPs e a sublimação dos MPs são processos endotérmicos.",
      "inverno e verão, e que a dessorção dos gases que ocorre nos MPs e a sublimação dos MPs são processos exotérmicos.",
      "verão e inverno, e que a dessorção dos gases que ocorre nos MPs é um processo exotérmico, ao passo que a sublimação dos MPs é endotérmica.",
      "verão e inverno, e que a dessorção dos gases que ocorre nos MPs é um processo endotérmico, ao passo que a sublimação dos MPs é exotérmica."
    ],
    correctAnswer: 0,
    materia: ["Física", "Química"],
    conteudo: ["Termodinâmica", "Adsorção"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "abaixamento do pH, e a maioria das moléculas do indicador que estava no cartucho mudou da forma B para a forma A.",
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Funções Orgânicas", "Equilíbrio Químico (pH)", "Ácidos e Bases"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "1,5 kg de CO₂, que é uma massa maior do que a massa de gasolina que foi queimada.",
      "50 kg de CO₂, que é uma massa menor do que a massa de gasolina que foi queimada.",
      "1,5 kg de CO₂, que é uma massa menor do que a massa de gasolina que foi queimada.",
      "50 kg de CO₂, que é uma massa maior do que a massa de gasolina que foi queimada."
    ],
    correctAnswer: 3,
    materia: ["Química", "Física"],
    conteudo: ["Estequiometria", "Química Ambiental", "Conceitos Energéticos (contexto)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Biocombustíveis", "Química Orgânica", "Agronegócio"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "mas o percentual de plásticos que vai para os aterros sanitários vem diminuindo assim como os percentuais da reciclagem e da queima.",
      "assim como o percentual de plásticos que vai para os aterros sanitários, pois há um aumento menor dos percentuais de reciclagem e de queima.",
      "mas a quantidade de plásticos que vai para os aterros sanitários vem diminuindo devido ao aumento maior dos percentuais de reciclagem e de queima.",
      "assim como a quantidade de plásticos que vai para os aterros sanitários, mesmo com o aumento dos percentuais de reciclagem e de queima."
    ],
    correctAnswer: 3,
    materia: ["Geografia", "Sociologia", "Matemática"],
    conteudo: ["Meio Ambiente", "Consumo e Descarte", "Análise de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química", "Física"],
    conteudo: ["Adsorção", "Propriedades dos Gases", "Separação de Misturas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "um navio que parte do Japão em direção à costa oeste dos Estados Unidos, ao cruzar a linha internacional de datas, terá que notificar em seus registros que pulou um dia no calendário civil oficial.",
      "cruzeiros turísticos podem antecipar a comemoração do Réveillon, ao cruzarem a linha internacional de datas na noite do dia 30 de dezembro, desde que este deslocamento se dê no sentido oeste.",
      "um navio que parte da costa oeste dos Estados Unidos em direção ao Japão, ao cruzar a linha internacional de datas, terá que notificar em seus registros que atrasou um dia no calendário civil oficial.",
      "cruzeiros turísticos podem antecipar a comemoração do Réveillon, ao cruzarem a linha internacional de datas na noite do dia 30 de dezembro, desde que esse deslocamento se dê no sentido leste."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Fusos Horários", "Cartografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O Bioma 1 corresponde às formações florestais que se situam nas áreas de baixa latitude. Apresentam baixa diversidade vegetal, com predomínio de coníferas. Ocorrem em áreas com excesso de chuvas, elevadas temperaturas e solos profundos de boa drenagem.",
      "O Bioma 2 abarca as formações mediterrâneas desenvolvidas em solos férteis, em climas com verão úmido e inverno seco. Sua fitofisionomia é formada por arbustos baixos, intercalados por gramíneas. As espécies são caducifólias por conta do período seco.",
      "O Bioma 3 representa as áreas de desertos, que apresentam espécies xerófilas, associados a dois fatores: a corrente marítima fria que dificulta a evaporação da água do mar, e a zona de alta pressão nas médias latitudes, formada por anticiclones.",
      "O Bioma 4 engloba as formações savânicas localizadas entre as florestas e os desertos. Ocorre em solos hidromórficos desenvolvidos em climas tropicais de sazonalidade bem marcada pela pluviosidade, resultando na formação de fitofisionomias abertas."
    ],
    correctAnswer: 0,
    materia: ["Geografia", "Biologia", "ANULADA: Erro de plotagem no mapa referente ao bioma 3, que é semidesértico e não desértico."],
    conteudo: ["Biomas Africanos", "Ecossistemas", "Clima"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "pratica a vitivinicultura na Patagônia, extrai bauxita no Atacama, conta com uma economia bastante centrada no Estado e as privatizações foram generalizadas.",
      "extrai cobre da Patagônia, pratica a salmonicultura no Atacama, conta com uma economia bastante centrada no mercado e as privatizações só atingiram o setor do petróleo.",
      "pratica a carcinicultura na Patagônia, extrai ouro do Atacama, conta com uma economia centrada nas empresas estatais e as privatizações foram inexistentes.",
    ...
    conteudo: ["Economia do Chile", "Geografia Humana", "América Latina Contemporânea", "Desigualdade Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "do declínio da produção e exportação de commodities agrícolas em virtude do avanço da quarta revolução industrial.",
      "do crescimento do mercado interno para produtos industrializados de maior valor agregado, em detrimento das exportações.",
      "da maior participação de commodities na pauta exportadora paralelamente ao declínio da exportação de produtos industrializados.",
      "da estagnação da pauta exportadora de produtos semimanufaturados em virtude do crescimento das commodities minerais."
    ],
    correctAnswer: 2,
    materia: ["Geografia", "Sociologia", "Matemática"],
    conteudo: ["Economia Brasileira", "Globalização", "Análise de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Em grande parte dos países da África Subsaariana, mais de 60% da população urbana vive em favelas ou habitações precárias, um problema social decorrente, entre outros fatores, da inserção do continente na divisão internacional do trabalho.",
      "Na América Latina, entre 5% e 20% da população urbana vive hoje em favelas ou habitações precárias, o que deixou de ser um problema social por conta da industrialização da região no século XX e da disseminação de políticas públicas.",
      "A forte desaceleração da urbanização na China e na Índia nesta década, associada a políticas públicas, tem levado à diminuição das habitações precárias nesses países, ainda que os números absolutos de moradores em condições precárias continuem elevados.",
      "A habitação precária não se coloca como uma questão social importante nos países do Oriente Médio, uma vez que há volumosos investimentos em políticas públicas para o setor da habitação, financiados com recursos obtidos da exploração do petróleo."
    ],
    correctAnswer: 0,
    materia: ["Geografia", "Sociologia"],
    conteudo: ["Urbanização", "Questões Urbanas", "Desigualdade Espacial", "Divisão Internacional do Trabalho"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["História do Brasil (Escravidão e Pós-Abolição)", "Movimentos Sociais", "Questões Fundiárias", "Direitos Humanos no Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A Serra do Mar é formada predominantemente por áreas falhadas compostas por rochas basálticas. A origem dessas rochas está relacionada à ruptura das placas tectônicas, o que resultou na abertura do Oceano Atlântico.",
      "A Serra do Mar é formada por rochas sedimentares que apresentam, em sua estrutura, falhas e fraturas. No período chuvoso, a infiltração aumenta o peso do material, desencadeando processos gravitacionais denominados movimentos de massa.",
      "A Serra do Mar originou-se com a ruptura das placas tectônicas sul-americana e africana, que ocasionou um conjunto de blocos falhados (soerguidos e rebaixados), formando ilhas, pois os grabens foram recobertos pela água do mar.",
      "A Serra do Mar tem sua gênese associada a processos similares à origem da Cordilheira dos Andes, que, com a convergência das placas sul-americana e africana, ocasionou a formação de dobramentos e falhamentos hoje estabilizados."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geomorfologia", "Geologia", "Tectônica de Placas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Filosofia Política", "Globalização", "Estado e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História", "Arte", "Filosofia"],
    conteudo: ["Idade Média (Peste Negra)", "História da Arte", "Morte e Existência"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O mito da terra plana, disseminado em finais do século XIX, foi usado para interpretar os Descobrimentos portugueses, e até hoje cativa um público. Ainda assim, desde a Antiguidade, já se sabia que a Terra é redonda.",
      "Os Descobrimentos portugueses subordinam-se à noção de Revolução Científica do século XVII, resultando em uma inovação tecnológica associada a uma mentalidade racionalista singular.",
      "O texto propõe compreender os Descobrimentos portugueses como impulsionados por uma nova mentalidade empírica com implicações tecnológicas, o que reafirma a noção da Terra plana.",
      "No domínio da modernidade científica, OS Descobrimentos portugueses vão além do mito de Colombo e da Terra plana. Seus conhecimentos, porém, desembocaram em resultados de pouco significado histórico."
    ],
    correctAnswer: 0,
    materia: ["História", "Filosofia"],
    conteudo: ["Grandes Navegações", "História da Ciência", "Epistemologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História da África", "Colonialismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Filosofia", "História", "Sociologia"],
    conteudo: ["Filosofia Política", "Revolução Americana", "Teoria do Estado"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["História do Brasil (Independência)", "Formação Territorial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História", "Sociologia"],
    conteudo: ["História do Brasil (República Velha)", "Memória e Identidade Nacional"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História", "Filosofia"],
    conteudo: ["Historiografia", "Teoria da História", "Filosofia da História"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História", "Sociologia"],
    conteudo: ["Movimentos Sociais (LGBTQIA+)", "Direitos Humanos", "Cidadania"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Cinemática Circular", "Geometria (Circunferência)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Gravitação Universal", "Leis de Newton"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Movimento Circular Uniforme", "Gravitação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Energia Potencial Gravitacional", "Trabalho e Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Calor e Temperatura", "Potência Elétrica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "θ pode ter qualquer valor maior que 100 °C e menor que 133 °C.",
      "θ pode ter qualquer valor menor que 100 °C ou maior que 133 °C.",
      "θ pode ter qualquer valor maior que 133 °C."
    ],
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Mudanças de Estado", "Pressão e Temperatura"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Eletrostática", "Campo Elétrico", "Diferença de Potencial"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o índice de refração da água para as diferentes cores da luz branca é menor do que o do ar; assim, no interior das gotículas, os raios de luz das diferentes cores se aproximam mais da reta normal à interface entre os meios de refração, quanto maior for o índice de refração corresponde àquela cor, na água.",
      "o índice de refração da água para as diferentes cores da luz branca é menor do que o do ar; assim, os raios de luz das diferentes cores, no interior das gotículas, se afastam mais da reta normal à interface entre os meios de refração, quanto maior for o índice de refração corresponde àquela cor, na água.",
      "o índice de refração da água para as diferentes cores da luz branca é maior do que o do ar; assim, os raios de luz das diferentes cores, no interior das gotículas, se aproximam mais da reta normal à interface entre os meios de refração, quanto maior for o índice de refração corresponde àquela cor, na água.",
      "o índice de refração da água para as diferentes cores da luz branca é maior do que o do ar; assim, os raios de luz das diferentes cores, no interior das gotículas, se afastam mais da reta normal à interface entre os meios de refração, quanto maior for o índice de refração corresponde àquela cor, na água."
    ],
    correctAnswer: 2,
    materia: ["Física"],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Botânica", "Genética (desenvolvimento)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "São moluscos bivalves – considerados predadores ativos das cadeias tróficas –, capazes de metabolizar e excretar elevadas taxas de arsênico e chumbo.",
      "São moluscos bivalves – considerados bentônicos filtradores – tolerantes à poluição e capazes de bioacumular elevadas taxas de arsênico e chumbo.",
      "São crustáceos – considerados predadores ativos das cadeias tróficas, capazes de metabolizar e excretar elevadas taxas de arsênico e chumbo.",
      "São crustáceos – considerados bentônicos filtradores – tolerantes à poluição e capazes de bioacumular elevadas taxas de arsênico e chumbo."
    ],
    correctAnswer: 1,
    materia: ["Biologia", "Química"],
    conteudo: ["Zoologia (Moluscos)", "Ecologia (Bioacumulação)", "Química Ambiental"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a pluviosidade sobre os rios da bacia do rio Paraguai é determinante para as inundações do Pantanal, um bioma com misto de vegetações de floresta, cerrado e campo. A produtividade primária do bioma, devido à conversão de luz solar em energia e biomassa, dá suporte para os demais níveis tróficos.",
      "a pluviosidade sobre os rios da bacia do rio Cuiabá é determinante para as inundações do Pantanal, um bioma com misto de vegetações de floresta, cerrado e caatinga. A produtividade primária do bioma, devido à conversão de luz solar em energia e matéria orgânica, dá suporte aos animais endêmicos.",
      "as chuvas sobre os rios da bacia do rio Paraguai são importantes para o ciclo de alagamento do Pantanal, um bioma com misto de vegetações de floresta, cerrado e caatinga. A produtividade secundária do bioma, com a conversão de luz solar em energia e biomassa, dá suporte para os demais níveis tróficos.",
      "as chuvas sobre os rios da bacia do rio Cuiabá são importantes para o ciclo de alagamento do Pantanal, um bioma com misto de vegetações de floresta, cerrado e campo. A produtividade secundária do bioma, com a conversão de luz solar em energia e matéria orgânica, dá suporte aos animais endêmicos."
    ],
    correctAnswer: 0,
    materia: ["Geografia", "Biologia"],
    conteudo: ["Biomas Brasileiros (Pantanal)", "Ecologia (Cadeias Tróficas)", "Hidrografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "artiodáctilos são os grupos irmãos dos HCoV-4408 e SARS-CoV-2 de humanos, por meio de hospedeiros intermediários.",
      "morcegos são os grupos irmãos dos SARS-CoV-2 e HCOV-OC43 de humanos, por meio de hospedeiros intermediários.",
      "artiodáctilos são os grupos irmãos dos SARS-CoV, SARS-CoV-2 e MERS-CoV de humanos.",
      "morcegos são os grupos irmãos dos SARS-CoV, SARS-CoV-2 e MERS-CoV de humanos."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Virologia", "Evolução", "Saúde Pública"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Corpos de frutificação são estruturas de fixação do fungo ao substrato; a emissão de luz nessas estruturas depende da presença de oxigênio.",
      "Micélios são as estruturas reprodutivas dos fungos; a emissão de luz nessas estruturas dá-se no momento em que a luciferina é reduzida.",
      "Hifas são filamentos ricos em quitina que permitem aos fungos obterem nutrientes; a emissão de luz nessas estruturas depende da presença de luciferina reduzida.",
      "Esporos diploides são produzidos pelos gametângios; a emissão de luz nessas estruturas dá-se com a oxidação da oxiluciferina."
    ],
    correctAnswer: 2,
    materia: ["Biologia", "Química"],
    conteudo: ["Biologia Celular (Fungos)", "Reações Químicas", "Fisiologia Vegetal (Metabolismo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Imunologia", "Biotecnologia", "Saúde Pública"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "(i) endócrino; (ii) melatonina; (iii) do ciclo circadiano; (iv) da reprodução.",
      "(i) nervoso; (ii) melatonina; (iii) de secreção da tireoide; (iv) da homeostase hídrica.",
      "(i) endócrino; (ii) ocitocina; (iii) de secreção da tireoide; (iv) da homeostase hídrica.",
      "(i) nervoso; (ii) ocitocina; (iii) do ciclo circadiano; (iv) da reprodução."
    ],
    correctAnswer: 0,
    materia: ["Biologia", "Física"],
    conteudo: ["Fisiologia Humana (Sistema Endócrino)", "Radiação Eletromagnética", "Neurofisiologia"],
    imageNames: []
})