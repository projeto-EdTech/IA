createQuestion({
    ...
    options: [
      "considera tão difícil o processo de criação da fórmula E=mc² quanto calcular o imposto de renda.",
      "compara o processo de criação da fórmula E=mc² e o cálculo do imposto de renda.",
      "prefere realizar tarefas que lhe cabem como cidadão às atividades que realiza como físico.",
      "qualifica como mais fácil calcular o imposto de renda do que o processo de criação da fórmula E=mc²."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "já possuam contas nas redes virtuais de relacionamento.",
      "tenham se conhecido nas redes virtuais de relacionamento.",
      "ainda não consigam gerenciar suas relações sociais nas redes virtuais de relacionamento.",
      "tenham conseguido se conhecer fora das redes virtuais de relacionamento."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      ...
      "o gasto de dinheiro público para financiar projetos que poluem o meio ambiente.",
...
createQuestion({
    ...
    options: [
      "maremotos ocorrem quando a energia acumulada entre placas tectônicas é liberada de modo abrupto, vindo, então, rapidamente à superfície.",
      "terremotos podem ser imperceptíveis na superfície, ainda que tenha havido, de fato, colisão ou deslizamento de placas tectônicas.",
      "maremotos, também denominados ondas sísmicas, ocorrem quando placas tectônicas colidem ou deslizam.",
      "terremotos são mais frequentes na zona costeira do Oceano Pacífico devido à baixa incidência de atividades vulcânicas na região."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "A redução na ingestão de água aumenta a pressão osmótica do sangue. O ADH atua nos rins, aumentando a reabsorção de água e diminuindo a pressão osmótica do sangue.",
      "O aumento na ingestão de água aumenta a pressão osmótica do sangue. O ADH atua nos rins, aumentando a reabsorção de água e diminuindo a pressão osmótica do sangue.",
      "A redução na ingestão de água diminui a pressão osmótica do sangue. O ADH atua nos rins, aumentando a reabsorção de água e aumentando a pressão osmótica do sangue.",
      "O aumento na ingestão de água diminui a pressão osmótica do sangue. O ADH atua nos rins, diminuindo a reabsorção de água e aumentando a pressão osmótica do sangue."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "O vetor do vírus da dengue é o Aedes aegypti. Suas fases imaturas desenvolvem-se no solo e há diminuição na sua reprodução em temperaturas abaixo de 17° C.",
      "O vetor do vírus da dengue é o Culex quiquefasciatus. Suas fases imaturas desenvolvem-se na água suja e há aumento na sua reprodução em temperaturas abaixo de 17° C.",
      "O vetor do vírus da dengue é o Aedes aegypti. Suas fases imaturas desenvolvem-se na água limpa e há diminuição na sua reprodução em temperaturas abaixo de 17° C.",
      "O vetor do vírus da dengue é o Culex quiquefasciatus. Sua reprodução se dá no solo e sofre aumento em temperaturas abaixo de 17° С."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "parede celular, grana, arquêntero, mitocondria, DNA.",
      "mitocondria, vacúolo, tilacoide, vasos, cromossomo.",
      "mitocondria, carioteca, axônio, núcleo, estroma.",
      "dendrito, cloroplasto, DNA, endométrio, estômato."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "A espécie Y não apresenta ganho líquido de carbono a 15°C.",
...
createQuestion({
    ...
    options: [
      ...
      "possuem conchas, mas não rádula.",
      "são exclusivamente terrestres.",
      "possuem pé desenvolvido e rádula."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Zoologia"],
...
createQuestion({
    ...
    options: [
      "Vírus, peste bubônica.",
      "Bactéria, peste bubônica.",
      "Vírus, leptospirose.",
...
createQuestion({
    ...
    options: [
      "A crítica à institucionalização da Igreja, com a consolidação da hierarquia em torno do papa e dos bispos, teve sua principal manifestação na manutenção de práticas pagās.",
      "As práticas pagas eram costumes de origem popular respeitados pelas ordens religiosas, como os beneditinos, mas criticados pelos bispos e pelo clero tradicional.",
      "A diversidade de práticas religiosas era frequente na Alta Idade Média, apesar dos esforços institucionais do alto clero católico em combater as crenças populares e defender a unidade religiosa na Europa.",
      "A presença do cristianismo não significou o desaparecimento de todas as práticas religiosas consideradas pagas, pois algumas delas foram toleradas pela Igreja, como o sabá e as festas populares."
    ],
    correctAnswer: 2,
    materia: ["História"],
...
createQuestion({
    ...
    options: [
      "o mecenato e a aplicação de leis idênticas para holandeses e luso-brasileiros eram uma continuidade do modelo renascentista, representando um período de modernização da região.",
      "houve dinamização da economia açucareira na região, com a reativação de engenhos e perdão de dívidas dos antigos proprietários, impulsionando a remodelação da cidade de Recife.",
      "houve a aplicação de princípios mercantilistas para a obtenção de lucros e a perseguição, por parte dos holandeses calvinistas, a judeus, cristãos-novos e católicos.",
      "as expedições dos artistas e cientistas tinham o propósito de retratar a paisagem e identificar potencialidades econômicas da região, pois o açúcar estava em declínio no comércio internacional."
    ],
    correctAnswer: 3,
    materia: ["História"],
...
createQuestion({
    ...
    options: [
      "A prática jurídica da igualdade foi expressa na Declaração de Independência dos EUA e assegurada nos países independentes do continente americano após 1776.",
      "A lei inglesa, ao referir-se aos antigos direitos, preservava a hierarquia, os privilégios exclusivos da nobreza sobre a propriedade e os castigos corporais como procedimento jurídico.",
      "No contexto da Revolução Francesa, a Declaração dos Direitos do Homem e do Cidadão significou o fim do Antigo Regime, ainda que tenham sido mantidos os direitos tradicionais da nobreza.",
      "Os direitos do homem, por serem direitos dos humanos em relação uns aos outros, significam que não pode haver privilégios, nem direitos divinos, mas devem prevalecer os princípios da igualdade e universalidade dos direitos entre os humanos."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Iluminismo e Revoluções Liberais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o nacionalismo foi impulsionado na literatura com a vinda da família real, em 1808, quando houve a introdução da imprensa no Rio de Janeiro e os primeiros livros circularam no país.",
      "o indianismo ocupou um lugar de destaque na afirmação das identidades locais, expressando um viés decadentista e cético quanto à civilização nos trópicos.",
      "os autores românticos foram importantes no período por produzirem uma literatura que expressava aspectos da natureza, da história e das sociedades locais.",
      "a população nativa foi considerada a mais original dentro do Romantismo e, graças à atuação dos literatos, os indígenas passaram a ter direitos políticos que eram vetados aos negros."
    ],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: [
      "dedicação à pesca artesanal, agricultura de pousio, espaços destinados a usos comuns e cultivo de gêneros alimentícios voltado para a subsistência e o mercado local.",
      "dedicação à pesca predatória, agricultura de pousio, espaços destinados ao arrendamento e cultivo de cana-de-açúcar voltado para a produção de biocombustível.",
      "dedicação à pesca artesanal, agricultura científica de precisão, espaços destinados a usos privados e cultivo de gêneros alimentícios voltado para o mercado local.",
      "dedicação à pesca predatória, agricultura equiparável ao agronegócio, espaços destinados a usos comuns e cultivo de plantas voltado para a indústria química."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Populações Tradicionais Brasileiras"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "A expansão dos canaviais e o aumento da produção de álcool e de açúcar permitem que os trabalhadores permaneçam empregados durante todo o ano, reduzindo o trabalho sazonal.",
      ...
      "Os trabalhadores são migrantes sazonais que se deslocam para o trabalho manual nos canaviais e retornam para suas antigas regiões após a colheita, dedicando-se a atividades de subsistência."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "A, cônica; B, azimutal; C, cilíndrica.",
      "A, cilíndrica; B, cônica; C, azimutal.",
      "A, azimutal; B, cilíndrica; C, cônica.",
      "A, cilíndrica; B, azimutal; C, cônica."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      ...
      "Altitudes acima de 1.000 metros; latitude entre 23° N e 66° N.",
      "Altitudes abaixo de 1.000 metros; latitude entre 66° N e 90° N."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "ao fenômeno do “El Niño”, que produz mais evaporação da água de rios, mares e canais, afetando também as regiões temperadas e polares.",
      "a uma anomalia das condições atmosféricas locais, resultante da influência dos ventos quentes vindos do sul da Rússia.",
      "ao período de verão, estação em que ocorre mais frequentemente o aumento da temperatura média e maior evaporação da água.",
      "ao deslocamento de nuvens da Europa mediterrânea, de clima quente e úmido, produzindo chuvas torrenciais nas regiões polares."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Climatologia"],
...
createQuestion({
    ...
    options: [
      "pouco sobrecarregadas dos ecossistemas costeiros, devido ao modo como ocorreu a ocupação humana, com o processo de urbanização.",
      "onde a cobertura vegetal ocorre em mosaicos, encontrando-se em praias, cordões arenosos, dunas, depressões, serras e planaltos, sem apresentar diferenças fisionômicas importantes.",
      "suscetíveis à erosão costeira causada, entre outros fatores, por amplas zonas de transporte de sedimentos, elevação do nível relativo do mar e urbanização acelerada.",
      "onde o solo arenoso não apresenta dificuldade para a retenção de água e o acesso a nutrientes necessários ao desenvolvimento da cobertura vegetal herbácea em praias e dunas."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "médio alto São Francisco, a salinidade da água em Cabrobó será maior do que a próxima ao Rio Apodi e a salinização do solo se deverá à evaporação da água.",
      "médio alto São Francisco, a salinidade da água próxima ao Rio Apodi será maior do que em Cabrobó e a salinização do solo se deverá à condensação da água.",
      "médio baixo São Francisco, a salinidade da água em Cabrobó será maior do que a próxima ao Rio Apodi e a salinização do solo se deverá à condensação da água.",
      "médio baixo São Francisco, a salinidade da água próxima ao Rio Apodi será maior do que em Cabrobó e a salinização do solo se deverá à evaporação da água."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "124 milhões de litros de refrigerante.",
      "2,60 bilhões de litros de refrigerante.",
      "1.365 milhões de litros de refrigerante.",
      "273 milhões de litros de refrigerante."
    ],
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Regra de Três"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Propriedades Físicas da Matéria"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "como higienizador bucal, elevando o pH da saliva: 2 NaHCO₃ → Na₂CO₃ + H₂O + CO₂.",
      "em extintores de incêndio, funcionando como propelente: NaHCO₃ + OH⁻ → Na⁺ + CO₃²⁻ + H₂O.",
      "como fermento em massas alimentícias, promovendo a expansão da massa: NaHCO₃ → HCO₃⁻ + Na⁺.",
...
createQuestion({
    ...
    options: [
      "O uso encadeado de \"Boas coisas\" e \"As melhores coisas\" possibilita a valorização do primeiro enunciado e a desvalorização do segundo.",
      "A repetição do termo “coisas\" garante que \"boas coisas\" e \"as melhores coisas\" remetem ao mesmo referente.",
      "Entre as expressões \"para quem espera\" e \"para quem se levanta e faz\" estabelece-se uma relação de temporalidade.",
      "A sequenciação desse texto ocorre por meio da recorrência de expressões e de estruturas sintáticas."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "delimita a amostra de lares em que a mulher precisa articular tarefas profissionais e domésticas.",
      "restringe o universo das mulheres mencionadas no trecho ao das que se dedicam à vida doméstica.",
      "informa o local social em que circulavam as mulheres referidas no trecho.",
      "destaca o fato de que a maioria das mulheres vive com companheiros."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "O robô está presente tanto no lago congelado no ártico como na gruta nos trópicos.",
      "O jovem engenheiro do JLP e a geomicrobióloga carregam respiradores para ajudá-los a respirar.",
      "O jovem engenheiro do JLP e a geomicrobióloga estão executando suas pesquisas sozinhos.",
      "O holofote do robô é ligado a partir de um sinal emitido pelo laboratório JPL."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto"],
