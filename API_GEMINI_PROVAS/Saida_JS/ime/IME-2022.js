createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Sistemas Lineares", "Equações Polinomiais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Progressão Geométrica", "Funções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Cálculo Diferencial", "Funções Logarítmicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Teoria dos Números", "Equações Diofantinas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Números Complexos", "Logaritmos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Equações Polinomiais", "Números Primos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Probabilidade", "Geometria Plana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Progressões", "Geometria Plana"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "(100 choose 0)² + (100 choose 1)² + ... + (100 choose 100)² = (200 choose 100)",
      "(100 choose 39) + (100 choose 40) = (101 choose 40)",
      "2×1×(100 choose 2) + 3×2×(100 choose 3) + 4×3×(100 choose 4) + ... + 100×99×(100 choose 100) = 9900 × 2⁹⁸",
      "(100 choose 1) + 2×(100 choose 2) + 3×(100 choose 3) + ... + 100×(100 choose 100) = 100 × 2⁹⁹",
      "1 - (100 choose 1) + (100 choose 2) - (100 choose 3) + ... + (100 choose 100) = 0"
    ],
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Combinatória", "Coeficientes Binomiais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Álgebra Linear", "Determinantes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Funções Trigonométricas", "Identidades Trigonométricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Lugar Geométrico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial", "Projeções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Eletrostática", "Dinâmica Circular"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Ondulatória", "Óptica Física"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Óptica Geométrica", "Dispersão da Luz"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Ondulatória", "Ondas em Tubos Sonoros"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Relatividade Especial", "Dilatação do Tempo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Eletrostática", "Estática"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Eletricidade", "Energia e Potência"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o período de sua órbita O₃ é igual ao da órbita O₂ de P₂.",
      "o período de sua órbita O₃ é maior que o da órbita O₂ de P₂.",
      "o período de sua órbita O₃ é menor que o da órbita O₂ de P₂.",
      "não haverá órbita O₃, pois o planeta P₃ irá de encontro à estrela S₂.",
      "não haverá órbita O₃, pois o planeta P₃ escapará de sua órbita em torno de S₂."
    ],
    correctAnswer: 0,
    materia: ["Física"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Termoquímica", "Equilíbrio Químico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Termodinâmica Química", "Espontaneidade de Reações"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Reações de Desidratação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Termodinâmica Química", "Diagramas de Fase"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o DNA é constituído por diferentes combinações dos aminoácidos citosina, guanina, adenina e timina, enquanto o RNA é constituído pelos aminoácidos citosina, guanina, adenina e uracila.",
      "as proteínas são componentes importantes na dieta de praticamente todos os animais, uma vez que constituem a principal reserva de energia para os organismos.",
      "a glicose e a frutose são exemplos de monossacarídeos, enquanto o amido e a celulose são exemplos de polissacarídeos.",
      "as vitaminas são proteínas essenciais ao correto funcionamento do organismo dos seres humanos, geralmente atuando como coenzimas em reações bioquímicas.",
      "os lipídios são compostos de origem biológica que se dissolvem em solventes polares."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Estequiometria", "Gases"],
    imageNames: []
}),
