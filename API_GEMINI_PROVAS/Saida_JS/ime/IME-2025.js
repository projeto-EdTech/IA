createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Sistemas de Numeração", "Sequências Numéricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Funções Inversas", "Séries Geométricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Equações Polinomiais", "Relações de Girard"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "possui solução entre 0 e 2025² / 6",
      "possui solução entre 2025² / 3 e 2025² / 2"
    ],
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Expressões Algébricas", "Inequações"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Retas e Triângulos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Teoremas Geométricos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Polígonos Regulares", "Círculos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Mecânica", "Cinemática Rotacional", "Dinâmica da Rotação", "Conservação de Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Eletrostática", "Lei de Coulomb", "Forças"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Gases Ideais", "Hidrostática"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Força Magnética", "Movimento de Cargas em Campos Magnéticos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Mecânica", "Leis de Newton", "Forças em Rampas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Ondulatória", "Óptica Ondulatória", "Interferência"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Relatividade", "Transformações de Lorentz"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Gravitação", "Energia Potencial Gravitacional", "Órbitas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Óptica Geométrica", "Lentes", "Cálculo Diferencial Aplicado"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Termologia", "Condução de Calor", "Calor Latente"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Campo Elétrico", "Lei de Gauss"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Eletroquímica", "Pilhas Galvânicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Reações Orgânicas", "Estereificação"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "375",
      "500",
      "Não é gerado gás algum e a solução apenas aquece pela passagem da corrente elétrica."
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Eletroquímica", "Eletrólise", "Titulação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Termoquímica", "Cinética Química", "Equilíbrio Químico", "pH"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Termoquímica", "Energia Livre de Gibbs", "Espontaneidade de Reações"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Reações Orgânicas", "Estereoquímica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Na emissão de uma partícula α, o ⁹²U²³⁸ decai para um elemento ⁹⁰X²³⁴.",
      "Por não ser físsil, o ⁹²U²³⁸ não é empregado isoladamente para a geração de energia em reatores nucleares.",
      "Uma partícula α é emitida espontaneamente por certos núcleos de elementos radioativos, com número atômico maior que 82, como urânio, tório, polônio e rádio.",
      "Na emissão de uma partícula α e de duas partículas β, o ⁹²U²³⁸ decai para o seu isótopo ⁹²U²³⁴.",
      "A distribuição eletrônica do ⁸²Pb²⁰⁶ (1s² 2s² 2p⁶ 3s² 3p⁶ 4s² 3d¹⁰ 4p⁶ 5s² 4d¹⁰ 5p⁶ 6s² 4f¹⁴ 5d¹⁰ 6p²) garante sua estabilidade nuclear."
    ],
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Radioatividade", "Decaimento Nuclear"],
    imageNames: []
})