createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Binômio de Newton", "Polinômios"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Álgebra", "Expressões Algébricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Polinômios", "Relações de Girard", "Funções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Matrizes", "Números Complexos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Cálculo de Áreas", "Funções Logarítmicas", "Integral Definida"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "pode-se construir um triângulo isósceles.",
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Equações Exponenciais", "Polinômios", "Geometria Plana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Sistemas de Equações", "Funções Logarítmicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Equações Trigonométricas", "Funções Logarítmicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Áreas", "Semelhança de Triângulos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial", "Volume de Pirâmides", "Semelhança de Sólidos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Óptica Ondulatória", "Interferência e Difração", "Análise Dimensional"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Cinemática Vetorial", "Movimento Relativo", "Geometria Analítica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica", "Circuitos Elétricos", "Resistência Elétrica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Máquinas Térmicas", "Ciclo de Carnot"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Termologia", "Calorimetria", "Equilíbrio Estático", "Potência Elétrica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Mecânica", "Colisões", "Conservação do Momento Linear", "Atrito", "Dinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Campo Magnético", "Lançamento Oblíquo", "Movimento de Cargas em Campo Magnético"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Eletrostática", "Capacitores", "Óptica Ondulatória", "Difração"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Ondas", "Balística", "Cinemática"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "6 µg, Ponto de Aplicação B, Sentido →",
      "3 µg, Ponto de Aplicação B, Sentido ←",
      "3 µg, Ponto de Aplicação B, Sentido →",
      "3 µg, Ponto de Aplicação C, Sentido →",
      "6 µg, Ponto de Aplicação C, Sentido ←"
    ],
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Estática", "Equilíbrio de Corpos Rígidos", "Torque"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Termologia", "Calorimetria", "Mudanças de Fase"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Hidrostática", "Densidade", "Princípio de Arquimedes", "Forças Inerciais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Gravitação", "Velocidade de Escape", "Densidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "X-0.1F-1H-Y, Z-2Ω-W (Diagrama de circuito mostrando um capacitor de 0.1 F em série com um indutor de 1 H, e um resistor de 2 Ω em paralelo com essa combinação.)",
      "X-0.1F-2Ω-Y, Z-1H-W (Diagrama de circuito mostrando um capacitor de 0.1 F em série com um resistor de 2 Ω, e um indutor de 1 H em paralelo com essa combinação.)",
      "X-2.4H-4Ω-Y, Z-0.05F-W (Diagrama de circuito mostrando um indutor de 2.4 H em série com um resistor de 4 Ω, e um capacitor de 0.05 F em paralelo com essa combinação.)",
      "X-2Ω-1H-Y, Z-0.1F-W (Diagrama de circuito mostrando um resistor de 2 Ω em série com um indutor de 1 H, e um capacitor de 0.1 F em paralelo com essa combinação.)",
      "X-1H-2Ω-Y, Z-0.1F-W (Diagrama de circuito mostrando um indutor de 1 H em série com um resistor de 2 Ω, e um capacitor de 0.1 F em paralelo com essa combinação.)"
    ],
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Circuitos RLC", "Energia em Circuitos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Termodinâmica Química", "Equilíbrio Químico", "Energia Livre de Gibbs"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Equilíbrio Químico", "Princípio de Le Chatelier", "Termodinâmica Química"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Estequiometria", "Reações de Neutralização", "Soluções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Estrutura Atômica", "Isótopos, Isótonos e Isóbaros"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Mecanismos de Reação", "Reações de Esterificação", "Nucleofilicidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "{ v = 0,002 (1 −X), 0 ≤ X ≤ 0,95; e v = 0,004 (1 −X)², 0,95 ≤ X ≤ 1.",
      "{ v = 0,0002 (1 −X), 0 ≤ X ≤ 0,05; e v = 0,002 (1 −X)², 0,05 ≤ X ≤ 1.",
      "v = 0,004 (1 – X)² durante todo o processo, pois a reação se dá em solução.",
      "{ v = 0,0004 (1 −X)², 0 ≤ X ≤ 0,05; e v = 0,004 (1 −X)², 0,05 ≤ X ≤ 1.",
      "{ v = 0,0002 (1 −X), 0 ≤ X ≤ 0,95; e v = 0,004 (1 −X)², 0,95 ≤ X ≤ 1."
    ],
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Cinética Química", "Ordem de Reação", "Solubilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O ácido carbônico é um oxiácido moderado.",
      "A adição do bicarbonato não altera o equilíbrio de ionização do ácido carbônico.",
      "A adição do bicarbonato aumenta o grau de ionização do ácido carbônico.",
      "A adição do bicarbonato não altera o valor da constante de equilíbrio.",
      "A adição de ácido clorídrico, em pequenas quantidades, contribuirá para a diminuição do pH da solução."
    ],
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Equilíbrio Iônico", "Ácidos e Bases", "pH"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A adição de brometo de hidrogênio ao propeno, em presença de peróxidos, gera o 2- bromopropano.",
      "O ciclopropano é um composto pouco reativo em virtude da estabilidade proporcionada por sua estrutura triangular.",
      "Como possui três duplas ligações, o benzeno é altamente suscetível a adições eletrofílicas aromáticas.",
      "A adição de cloro em excesso ao metano gera exclusivamente o clorometano.",
      "Tanto o cis-3-octeno quanto o trans-3-octeno, ao serem oxidados com permanganato de potássio em meio básico e posteriormente acidificados, geram os ácidos propanoico e pentanoico."
    ],
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Reações Orgânicas", "Aromaticidade", "Reações de Oxidação"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Um elétron livre absorve energia quando é incorporado ao íon H⁺ em n = 2.",
      "O comprimento de onda da luz emitida é maior quando um elétron retorna do estado n = 3 para n = 1, do que do estado n = 3 para n = 2.",
      "Quando um elétron se desloca do estado n = 3 para n = 2, a energia absorvida é equivalente a um quantum de energia.",
      "Quando o elétron se desloca do estado n = 2 para n = 1, o átomo emite energia radiante, sob forma de um fóton.",
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Tabela Periódica", "Propriedades Periódicas", "Energia de Ionização", "Raio Atômico"],
    imageNames: []
})