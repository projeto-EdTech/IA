...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Inequações Polinomiais", "Álgebra"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Números Complexos", "Matrizes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Funções", "Limites", "Continuidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Matrizes", "Progressões Aritméticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Inequações Exponenciais", "Logaritmos", "Polinômios"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Números Complexos", "Séries", "Logaritmos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial", "Planos e Retas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Energia Cinética", "Calorimetria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Óptica Ondulatória", "Interferência", "Refração"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Lei de Faraday", "Lei de Ohm"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Estática", "Equilíbrio de Corpos Rígidos", "Força Elétrica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Gravitação", "Velocidade de Escape", "Órbitas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Óptica Geométrica", "Lentes", "Espelhos Planos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Cinemática", "Lançamento Vertical", "Movimento Horizontal", "Hidrostática", "Empuxo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Cinemática", "Movimento Relativo", "Óptica Geométrica", "Espelhos Planos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Eletrostática", "Campo Elétrico", "Potencial Elétrico", "Conservação de Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Reações Orgânicas", "Nomenclatura de Compostos Orgânicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Tabela Periódica", "Distribuição Eletrônica", "Íons"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Química Inorgânica", "Estrutura de Compostos", "Minerais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A uma pressão de 10 atm, o catodo passou a agir como anodo e o anodo como catodo.",
      "A estrutura interna do drone sofreu avarias, porque o H₂SO₄ decomposto no anodo gerou vapores corrosivos.",
      "O volume de H₂O consumido foi de 1,5 L.",
      "A massa de H₂SO₄ restante foi de 49 g.",
      "O volume da solução aquosa de H₂SO₄ reduziu para 75% do seu valor inicial."
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Eletroquímica", "Eletrólise", "Estequiometria", "Soluções"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Os aminoácidos são anfóteros, podendo doar ou receber prótons (H+) de acordo com o conceito ácido base de Brönsted-Lowry.",
      "O RNA tem em sua estrutura diferentes combinações dos nucleotídeos formados pelas bases nitrogenadas purínicas adenina e guanina e pelas bases nitrogenadas pirimidínicas uracila e citosina.",
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Bioquímica", "Aminoácidos", "Proteínas", "Ácidos Nucleicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "16 g de metano nas CNTP.",
      "8 g de oxigênio e 14,48 g de ar atmosférico a 0 °C.",
      "7 g de dióxido de carbono e 7 g de nitrogênio a 20 °C.",
      "8 g de oxigênio e 14 g de nitrogênio a 20 °C.",
      "13,6 g de amônia a 72 °C."
    ],
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Gases", "Leis dos Gases Ideais", "Estequiometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Reações Redox", "Titulação", "Estequiometria", "Soluções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Termodinâmica", "Entalpia", "Equilíbrio Químico", "Leis dos Gases Ideais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Diagrama com sólido e menos bolhas de CO2 na situação i, e mais bolhas na situação ii.",
      "Diagrama com sólido e mesma quantidade de bolhas de CO2 na situação i, e mais bolhas na situação ii.",
      "Diagrama com mais sólido e menos bolhas de CO2 na situação i, e menos sólido e mais bolhas na situação ii.",
      "Diagrama com menos sólido e mais bolhas de CO2 na situação i, e mais sólido e mais bolhas na situação ii.",
      "Diagrama com mais sólido e menos bolhas de CO2 na situação i, e menos sólido e mais bolhas na situação ii."
    ],
    correctAnswer: 4,
    materia: ["Química"],
