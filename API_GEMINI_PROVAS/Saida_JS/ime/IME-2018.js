...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Progressão Aritmética", "Trigonometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Determinantes", "Logaritmos", "Matrizes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Inequações Polinomiais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Funções", "Divisibilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Probabilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Equações Trigonométricas", "Análise de Funções"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "2sen(Â + Ĉ) = sen(A) + sen(Ĉ)",
      "2cos(Â + Ĉ) = cos(A) + cos(Ĉ)",
      "2sen(Â – Ĉ) = sen(A) – sen(Ĉ)",
      "2cos(Â – Ĉ) = cos(A) – cos(Ĉ)",
      "2cos(Â + Ĉ) = sen(A) + sen(C)"
    ],
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Trigonometria", "Progressão Aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Ondas Sonoras", "Tubos Sonoros"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Óptica Geométrica", "Lentes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Estática", "Hidrostática", "Eletrostática", "Lei de Hooke"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Cinemática Angular", "Aceleração Centrípeta e Tangencial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Colisões", "Conservação do Momento Linear"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica", "Circuitos Elétricos", "Energia Elétrica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Conservação de Energia", "Lançamento de Projéteis", "Mola"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Dinâmica Rotacional", "Conservação de Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Astronomia", "Movimento Circular"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Estática", "Eletrostática", "Lei de Coulomb"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Ondas Sonoras", "Acústica", "Ressonância"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Propriedades Coligativas", "Equilíbrio Iônico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Reatividade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O decréscimo de entropia é menor na reação (I) do que na reação (II).",
      "O acréscimo de entropia na reação (I) é maior do que na reação (II).",
      "O decréscimo de entropia na reação (II) do que na reação (I).",
      "O acréscimo de entropia na reação (II) é maior do que na reação (I).",
      "A variação de entropia é igual em ambas as reações."
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Termodinâmica", "Entropia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Estequiometria", "Cinética Química", "Titulação"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Bromo < dissulfeto de carbono < butanol < etanol < brometo de potássio.",
      "Metano < neopentano < dietilcetona < t-butanol < n-butanol.",
      "Hidróxido de alumínio < carbonato de cálcio < carbonato de magnésio < nitrato de prata < sulfato de bário.",
      "Isobutano < p-diclorobenzeno < o-diclorobenzeno < o-nitrofenol < p-nitrofenol.",
      "Cromato de chumbo (II) < Cromato de bário < carbonato de sódio < carbonato de magnésio < clorato de magnésio."
    ],
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Solubilidade", "Forças Intermoleculares"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A estrutura primária de uma proteína é definida pela ordem em que os aminoácidos adenina, timina, citosina e guanina se ligam entre si.",
      "A estrutura secundária de uma proteína é definida por conformações locais de sua cadeia principal que assumem padrões específicos, tais como hélices α e folhas β.",
      "A estrutura terciária de uma proteína é definida pelo modo conforme duas ou mais cadeias polipeptídicas se agregam entre si.",
      "As enzimas são proteínas que atuam como catalisadores biológicos e que se caracterizam pela sua capacidade de reagir, simultaneamente, com milhares de substratos de grande diversidade estrutural.",
      "A glicose, a ribose e a frutose são enzimas que devem ser obrigatoriamente ingeridas na dieta dos seres humanos, uma vez que nossos organismos não conseguem sintetizá-las."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Bioquímica", "Estrutura de Proteínas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Polímeros", "Isomeria"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A energia de ligação na molécula de NO é maior que no íon NO⁺.",
      "A energia de ligação na molécula de CO é maior que no íon CO⁺.",
      "A molécula de O₂ tem maior energia de ligação que os íons O₂⁺ e O₂⁻.",
      "A ligação dupla C=C tem o dobro da energia da ligação simples C-C.",
      "O íon NO⁻ é mais estável que o íon NO⁺."
    ],
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Geral", "Ligações Químicas", "Teoria de Orbitais Moleculares"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "independe do pH.",
      "ocorre somente na faixa de pH alcalino.",
      "ocorre somente na faixa de pH ácido.",
      "não ocorre para pH < 3",
      "ocorre somente para pH ≥ 12."
    ],
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Solubilidade", "Equilíbrio Iônico"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Amina, ácido carboxílico, álcool, aldeído.",
      "Álcool, cetona, éster, éter.",
      "Amida, aldeído, cetona.",
      "Éter, amida, ácido carboxílico."
    ],
    correctAnswer: 0,
    materia: ["Química"],
