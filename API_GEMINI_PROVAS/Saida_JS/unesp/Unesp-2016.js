...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Direitos do Consumidor"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Portuguesa (Simbolismo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Sintaxe (Termos Acessórios da Oração)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Colonização da África"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Geopolítica (Oriente Médio)", "Religião"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Climatologia", "Termodinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Neurociência", "Comportamento Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de Texto", "Estética"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "diminuirá o número de casos de dengue, mas poderá contribuir para o aumento do número de pessoas com febre chikungunya.",
      "fará diminuir o tamanho das populações de Aedes aegypti, diminuindo o número de casos de dengue e o número de casos de febre chikungunya.",
      "tornará as pessoas imunes a ambas as doenças, mas a presença de mosquitos Aedes aegypti no ambiente continuará alta.",
      "tornará as pessoas imunes ao mosquito Aedes aegypti, mas não imunes aos agentes etiológicos da dengue e da febre chikungunya.",
      "protegerá contra a febre chikungunya apenas nos casos em que o Aedes aegypti for portador de ambos os agentes etiológicos."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "seiva elaborada, sendo que a evapotranspiração na parte aérea da planta criou uma pressão hidrostática positiva no interior do floema, forçando a elevação da coluna de água com corante até as pétalas das flores.",
      "seiva bruta, sendo que, por transporte ativo, as células da extremidade inferior do xilema absorveram pigmentos do corante, o que aumentou a pressão osmótica nas células dessa região, forçando a passagem de água com corante pelo xilema até as células das pétalas das flores.",
      "seiva elaborada, sendo que, por transporte ativo, as células adjacentes ao floema absorveram a sacarose produzida nas pétalas da flor, o que aumentou a pressão osmótica nessas células, permitindo que, por osmose, absorvessem água com corante do floema.",
      "seiva bruta, sendo que a evapotranspiração na parte aérea da planta criou uma pressão hidrostática negativa no interior do xilema, forçando a elevação da coluna de água com corante até as pétalas das flores.",
      "seiva elaborada, sendo que a solução colorida era hipotônica em relação à osmolaridade da seiva elaborada e, por osmose, a água passou da solução para o interior do floema, forçando a elevação da coluna de água com corante até as pétalas das flores."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Botânica"],
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Reinos dos Seres Vivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o movimento da mão esticando a borracha corresponde ao relaxamento do diafragma, em resposta a estímulos de quimiorreceptores localizados no bulbo, que detectam a baixa concentração de O₂ no sangue e promovem a inspiração.",
      "o movimento da mão esticando a borracha corresponde à contração do diafragma, por ação do bulbo quando o pH do sangue circulante diminui em razão da formação de ácido carbônico no plasma.",
      "a garrafa pet corresponde à pleura, membrana dupla que envolve os pulmões e que apresenta quimiorreceptores sensíveis à variação de O₂ e CO₂ nos capilares alveolares, desencadeando os movimentos de inspiração e expiração.",
      "a garrafa pet corresponde à parede da caixa torácica que, ao manter o volume torácico constante, permite que os pulmões, representados pelos balões, se inflem na inspiração e se esvaziem na expiração, expulsando o ar rico em CO2.",
      "os tubos que penetram na garrafa correspondem à traqueia e aos brônquios que, embora não apresentem movimentos de contração e relaxamento, favorecendo a movimentação do ar nas vias respiratórias, possuem válvulas que impedem a mistura do ar rico em O₂ com o ar rico em CO2."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "Paulo e Mário são irmãos por parte de pai e por parte de mãe, e Lucas é filho de Sílvio e não de Fátima.",
      "Lucas e Mário são meios-irmãos, mas não se pode afirmar qual deles é fruto do primeiro casamento.",
      "Paulo e Lucas são meios-irmãos, mas não se pode afirmar qual deles é fruto do primeiro casamento.",
      "Paulo e Mário são meios-irmãos, mas não se pode afirmar qual deles é fruto do primeiro casamento.",
      "Lucas e Mário são irmãos por parte de pai e por parte de mãe, e Paulo é filho de Sílvio e não de Fátima."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Genética"],
...
createQuestion({
    ...
    conteudo: ["Propriedades Periódicas", "Termologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química", "Física"],
    conteudo: ["Química Orgânica", "Ondas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Energia", "Quantidade de Movimento"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Termodinâmica", "Climatologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "uma possível unidade de medida de energia elétrica é o kVA (quilovolt - ampère), que pode, portanto, ser convertida para a unidade correspondente do Sistema Internacional, o joule.",
