...
createQuestion({
    ...
    conteudo: ["Brasil Colônia e Império", "Literatura Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geografia Humana e Economia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Gramática e Vocabulário"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria e Trigonometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "quebra de moléculas de celulose",
      "neutralização da acidez do suco gástrico",
      "aumento da produção de glóbulos vermelhos",
      "controle das bactérias patogênicas intestinais"
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "[Diagrama de cromossomos: um com 'a', outro com 'b']",
      "[Diagrama de cromossomos: um com 'aa' (duas cromátides) e outro com 'bb' (duas cromátides)]",
      "[Diagrama de cromossomo: um com 'a']",
      "[Diagrama de cromossomos: um com 'a', outro com 'b', diferente da representação em A e B]"
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      ...
      "apenas b está presente",
      "nenhuma está presente"
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Botânica e Ecologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "250 adeninas, 650 guaninas, 250 timinas, 650 citosinas",
      "300 adeninas, 600 guaninas, 300 timinas, 600 citosinas",
      "350 adeninas, 550, guaninas, 350 timinas, 550 citosinas",
      "400 adeninas, 500 guaninas, 400 timinas, 500 citosinas"
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "[Gráfico U(V) x i(A) com uma reta decrescente que intercepta o eixo U em um valor positivo e o eixo i em um valor positivo]",
      "[Gráfico U(V) x i(A) com uma reta crescente que intercepta o eixo U em um valor positivo e o eixo i em um valor negativo]",
      "[Gráfico U(V) x i(A) com uma reta crescente que intercepta o eixo U no zero]",
      "[Gráfico U(V) x i(A) com uma reta decrescente que intercepta o eixo U no zero]"
    ],
    correctAnswer: 0,
    materia: ["Física"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Ácidos e Bases"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Sul e Oeste da Europa",
      "Sudeste e Leste da Ásia",
      "Centro e Norte da América",
      "Nordeste e Noroeste da África"
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      ...
      "atividade empresarial do governo",
      "dimensão clientelista do caudilhismo"
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "elevação da taxa de escoamento superficial",
      "diminuição do volume de sedimentação aluvial",
      "ampliação da bacia de drenagem da metrópole",
      "redução do índice de impermeabilização do solo"
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "retrocesso do pluralismo social, gerando o aumento da intolerância",
      "esvaziamento do poder presidencial, causando a descentralização da gestão",
      "desvalorização da identidade nacional, produzindo a negação do patriotismo",
      "limitação da propriedade privada, provocando o fortalecimento do sindicalismo"
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geografia Política"],
...
createQuestion({
    ...
    options: [
      "relativização de liberdades democráticas",
      "separação de categorias profissionais",
      "espacialização das hierarquias sociais",
      "ascensão de classes populares"
    ],
    correctAnswer: 2,
    materia: ["História", "Sociologia"],
    conteudo: ["História Contemporânea", "Desigualdade Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "regularização da liberdade de associação e anistia das lideranças locais",
      "interrupção de setor produtivo estratégico e respaldo da sociedade civil",
      "garantia da estabilidade de emprego e flexibilização do corporativismo profissional",
      "fortalecimento do equilíbrio econômico nacional e modernização das relações capitalistas"
    ],
    correctAnswer: 1,
    materia: ["História", "Sociologia"],
...
createQuestion({
    ...
    options: [
      "rigidez do planejamento urbano",
      "modernização do transporte público",
      "aprimoramento do manejo ambiental",
      "permanência da segregação espacial"
    ],
    correctAnswer: 3,
    materia: ["História", "Geografia"],
    conteudo: ["História Contemporânea", "Geografia Urbana"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "hierarquização das heranças de matriz étnica",
      "descrição das práticas de orientação eugênica",
      "redefinição das dinâmicas de mobilidade geográfica",
      "caracterização das relações de ancestralidade biológica"
    ],
    correctAnswer: 3,
    materia: ["História"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História", "Sociologia"],
    conteudo: ["Teoria da História", "Nacionalismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "disparidade de renda familiar",
      "estagnação de oferta laboral",
      "interrupção de reformas urbanas",
      "analfabetismo de populações rurais"
    ],
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Desigualdade Social", "Direitos Humanos"],
    imageNames: []
})