...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Vozes Verbais", "Gramática"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Orações Subordinadas Adverbiais", "Sintaxe"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Equação da Reta", "Distância entre Pontos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Funções Exponenciais", "Funções Lineares", "Funções Quadráticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Alemanha Ocidental e Alemanha Oriental, com a instituição do Muro de Berlim.",
      "Rússia e China, com a instituição do protecionismo econômico.",
      "Estados Unidos e União Soviética, com a chamada Guerra Fria.",
      "Coreia do Norte e Coreia do Sul, com a deflagração da Guerra da Coreia.",
      "Estados Unidos e Reino Unido, com a proclamada Guerra ao Terror."
    ],
    correctAnswer: 2,
    materia: ["História"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["População", "Urbanização", "Êxodo Rural"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "à Floresta Amazônica, à desertificação e aos fragmentos de floresta natural.",
      "ao Pantanal, à recuperação de solos e ao relevo de serras e morros.",
      "ao Pantanal, à desertificação e aos tabuleiros costeiros.",
      "à Floresta Amazônica, à recuperação de solos e ao clima subtropical.",
      "aos Campos, à erosão de solos e ao relevo de serras e morros."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Biomas Brasileiros", "Meio Ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "baixa demanda por energia elétrica nas regiões que contemplam a parcela meridional do país.",
      "menor segurança energética nas áreas em que se concentra a produção industrial brasileira.",
      "maior facilidade de conexão com a rede de transmissão de energia nas regiões recomendadas.",
      "grande oferta de energia não renovável na região Nordeste, o que elimina a concorrência de outras fontes.",
      "elevada nebulosidade sobre a região Nordeste capaz de provocar instabilidades na transmissão de energia."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Fontes de Energia", "Geografia Econômica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Coordenadas Geográficas", "Orientação no Espaço"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Idade Média", "Peste Negra", "Contribuições Islâmicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Imperialismo", "Revolução Industrial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Primeira Guerra Mundial", "Período Entreguerras", "Nazismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Brasil República", "Ditadura Militar no Brasil", "Guerra Fria"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a cafeína possui um efeito maior sobre a longevidade do que os compostos antioxidantes do café.",
      "o consumo de café pode reduzir o risco de doenças hepáticas.",
      "o café descafeinado não faz mal para quem não pode ingerir cafeína.",
      "o risco de morte diminui cerca de 18% entre as pessoas que bebem de uma a duas xícaras de café por dia, dependendo da etnia.",
      "um estudo realizado anteriormente mostrou que o café é inadequado para consumo humano."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Conjunctions", "Textual Cohesion"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o alto consumo de café entre os europeus aumentou o risco de morte nesse grupo.",
      "a pesquisa do Dr. Marc Gunter mostrou que o café pode reduzir o risco de câncer.",
      "o café pode tanto prolongar o tempo de vida das pessoas quanto fazer bem à saúde.",
      "o consumo indiscriminado de café pode aumentar o risco de doenças dos sistemas circulatório e digestório.",
      "os hábitos e costumes relacionados ao consumo de café eram semelhantes nos dez países europeus envolvidos no estudo."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Reading Comprehension"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Mecânica", "Gravitação", "Movimento Circular Uniforme"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Ondas", "Ondas Estacionárias", "Instrumentos Musicais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Eletricidade", "Campo Elétrico", "Energia Potencial Elétrica"],
    imageNames: []
}),
