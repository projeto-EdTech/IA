createQuestion({
    ...
    options: [
      "está ausente nos bebês qualquer processo cognitivo que os faça compreender o mundo ao seu redor, uma vez que eles ainda estão distantes da linguagem e da compreensão das ações dos adultos.",
      "os bebês realizam ações que organizam sua entrada no mundo da linguagem e os colocam em contato com os adultos, como o ato de murmurar e mesmo o reconhecimento da voz dos pais.",
      "as frases ditas pelos adultos para os bebês são incompreensíveis para estes porque eles ainda não conseguem processar nenhum tipo de informação que venha do mundo externo ou do contato com seus pais.",
      "o aprendizado dos bebês se inicia no momento exato em que eles viram a cabeça para o lado e reconhecem os seus pais, a partir daí eles já estão prontos para utilizar as primeiras palavras.",
      "o aprendizado da língua pelos bebês é algo que depende exclusivamente do ambiente externo e do contato com os pais, pois é improvável que haja habilidades inatas que contribuam para o desenvolvimento da linguagem."
    ],
    correctAnswer: 1,
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática", "Morfossintaxe"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "expor um conjunto de informações, tendo como objetivo central apresentar ao leitor uma série de conhecimentos a respeito do tema principal.",
      "relatar fatos e experiências vividos pelo seu autor, daí o tom predominantemente autobiográfico naquilo que é explanado.",
      "construir um enredo narrativo que é conduzido até seu clímax final.",
      "instruir o leitor, uma vez que é construído essencialmente como uma espécie de guia de conduta para os pais, orientando comportamentos.",
      "argumentar, já que há a elaboração de posicionamentos críticos, expostos contraditoriamente, com a função essencial de persuadir o leitor."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Tipologia Textual", "Gêneros Textuais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Ao murmurar e balbuciar, os bebês instintivamente tem como objetivo afinar suas cordas vocais para que os barulhos que fazem, ao virarem a cabeça, fiquem semelhantes com as vozes do pai e da mãe.",
      "A mãe e o pai extasiados com os barulhos que os bebês fazem instintivamente, ao afinarem suas cordas vocais, viram a cabeça quando eles murmuram e balbuciam.",
      "Virar a cabeça, ao ouvir um barulho, e se alegrar com o som das vozes dos pais são ações comuns aos bebês, que também murmuram e balbuciam, o que acaba por tornar suas cordas vocais afinadas.",
      "Virar a cabeça é um movimento do instinto dos bebês que murmuram e balbuciam quando ouvem as vozes do pai ou da mãe, fazendo, assim, com que suas cordas vocais também se afinem.",
      "Ao ouvirem um barulho, os bebês murmuram e balbuciam, assim como viram a cabeça com o som das vozes dos pais, que instintivamente afinam, extasiados, as cordas vocais dos bebês."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Reescrita de Frases", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Jacob é a representação de uma personagem que ultrapassa todas as barreiras para merecer a pessoa amada.",
      "do ponto de vista estrutural, o soneto alicerça-se em uma construção linear não isenta de tensão dramática.",
      "o discurso narrativo do eu-lírico é interrompido no segundo terceto para inserir a voz de uma personagem.",
      "o caráter narrativo da história de Jacob, baseada no texto bíblico, compromete a originalidade da composição poética.",
      "nos quartetos, encontra-se a exposição do caso narrado e, no segundo terceto, o remate da história."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura", "Classicismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "destaca-se o predomínio da razão sobre o sentimento nas composições artísticas.",
      "há a libertação dos dogmas da Igreja, mas sem o desaparecimento, por completo, da religiosidade.",
      "destaca-se a presença da mitologia greco-latina nas composições artísticas.",
      "há a preocupação e valorização da perfeição formal nas composições literárias.",
      "destaca-se o relato realista, por vezes com enfoque determinista, sobre os eventos narrados nas composições artísticas."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura", "Classicismo"],
...
createQuestion({
    ...
    options: [
      "um narrador-observador que participa da cena apenas para produzir um efeito de comicidade, como em A cena se estava tornando patética (linha 13).",
      "o uso da primeira pessoa na voz narrativa, caracterizando um personagem com dupla função: narrador-personagem.",
      "um narrador-protagonista que conhece e participa de toda a história, impondo juízo de valores, como em E o infeliz amante arrancou debaixo da camisa um breve (linha 06).",
      "o recurso do flashback, iniciado com - Espere, tornou D. Carolina (linha 23), para elucidar uma ação ocorrida no passado com consequências no presente.",
      "um narrador que, em perspectiva futurista, exalta a vida moderna, a velocidade e a sociedade urbana."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Elementos da Narrativa", "Narrador"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Grammar", "Passive Voice"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Reading Comprehension", "Interpretação de Tirinhas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Área de Polígonos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Números Complexos", "Matrizes", "Determinantes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Combinatória"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Funções", "Funções Exponenciais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Meio Ambiente", "Urbanização", "Problemas Socioambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "se apenas a afirmativa II está correta.",
      "se apenas a afirmativa III está correta."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Economia", "Recursos Naturais", "Petróleo e Gás"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "A contínua elevação da expectativa de vida fez aumentar a proporção de idosos no continente europeu, ao mesmo tempo em que a reduzida taxa de natalidade fez com que a proporção da população economicamente ativa não acompanhasse esse crescimento. Esses dois fenômenos, combinados, provocam o déficit previdenciário, agravado pela crise econômica.",
      "A população europeia é chamada de \"madura\" ou \"envelhecida\", pois a proporção média de idosos (pessoas acima de 60 anos) nos países do continente ultrapassa os 60% da população total. Nesse contexto, os gastos com aposentadorias e pensões tornam-se muito superiores ao volume das contribuições previdenciárias.",
      "A grande participação de imigrantes ilegais é a principal causa do déficit previdenciário nos países europeus, sobretudo na sua porção ocidental. Países como França e Alemanha apresentam grandes percentuais de estrangeiros irregulares, notadamente argelinos e turcos. Esses imigrantes, por serem ilegais, não trabalham, mas consomem os recursos previdenciários sob a forma de aposentadorias e pensões."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["População", "Demografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "1- Cotton Belt (algodão), 2- Corn Belt (milho), 3- Wheat Belt (trigo).",
      "1- Wheat Belt (trigo), 2- Cotton Belt (algodão), 3- Sun Belt (frutas).",
      "1- Corn Belt (milho), 2- Dairy Belt (sorgo), 3- Wheat Belt (trigo).",
      "1- Dairy Belt (sorgo), 2- Corn Belt (milho), 3- Cotton Belt (algodão).",
      "1- Rice Belt (arroz), 2- Dairy Belt (sorgo), 3- Corn Belt (milho)."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Economia", "Agricultura", "Geografia dos EUA"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O número 1 no mapa corresponde ao deserto do Saara. Tem sua origem nas massas de ar muito secas da região do Sahel e também por ser entrecortado pela linha do Equador.",
      "O número 2 no mapa corresponde ao deserto do Kalahari. Tem sua origem devido à influência direta da Corrente Marítima do Atlântico Sul.Sendo fria, provoca precipitações sobre o mar e, assim, as massas de ar chegam secas ao continente.",
      "O número 3 no mapa corresponde ao deserto do Atacama. Tem sua origem devido à influência direta da Corrente Marítima de Humboldt. Sendo fria, provoca resfriamento na atmosfera junto ao oceano e precipitações sobre o mar, fazendo com que as massas de ar cheguem mais secas ao continente.",
      "O número 1 no mapa corresponde ao deserto do Saara. Tem sua origem devido à influência direta da Corrente Marítima de Benguela. Sendo quente e úmida, ao adentrar no continente condensa e precipita completamente ao cruzar o compartimento geológico dos Montes Atlas.",
      "O número 2 no mapa corresponde ao deserto da Namíbia. Tem sua origem devido à influência direta da Corrente Marítima de Falklands. Sendo quente e úmida, ao penetrar no continente perde sua umidade ao ultrapassar as cadeias montanhosas de Drakensberg, onde torna-se seca, permanecendo muito quente."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Climatologia", "Biogeografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Geopolítica", "Reino Unido"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "se apenas a assertiva I está correta.",
      "se apenas as assertivas I e II estão corretas.",
      "se apenas as assertivas II e III estão corretas.",
      "se apenas as assertivas II e IV estão corretas.",
      "se apenas as assertivas I, III e IV estão corretas."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Equilíbrio Químico", "pH e pOH"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "que possui 2 átomos de carbono híbridos sp².",
...
createQuestion({
    ...
    options: [
      "o cloreto formado é insolúvel em meio aquoso.",
      "o cloreto de sódio será totalmente consumido.",
      "haverá excesso de 0,03 mol de nitrato de prata.",
      "ocorrerá a precipitação de 0,01 mol de cloreto de prata.",
      "a concentração do nitrato de prata na solução final é de 0,03 mol.L⁻¹."
    ],
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Estequiometria", "Soluções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Propriedades Coligativas", "Soluções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Termoquímica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Funções Orgânicas", "Geometria Molecular"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Evolução", "Classificação dos Seres Vivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "grão-de-pólen e óvulo.",
      "célula do tubo polínico e endosperma.",
      "tubo polínico e saco embrionário.",
      "microsporócito e megasporócito.",
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Saúde Humana", "Doenças Virais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "alantoide, cório, saco vitelínico e âmnio.",
      "alantoide, âmnio, saco vitelínico e cório.",
      "cório, alantoide, âmnio e saco vitelínico.",
      "saco vitelínico, alantoide, cório e âmnio.",
      "âmnio, alantoide, cório e saco vitelínico."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "aumento do metabolismo basal; adrenalina; adenoipófise; glucagon.",
      "diminuição da glicemia sanguínea; noradrenalina; hipotálamo; insulina.",
      "aumento da produção de calor; cortisol; neuroipófise; glucagon.",
      "controle do metabolismo de cálcio; aldosterona; adenoipófise; insulina.",
      "diminuição da atividade metabólica; adrenalina; hipotálamo; glucagon."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana", "Tecido Sanguíneo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["História Moderna", "Iluminismo", "Portugal e Colônias"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História Contemporânea", "Portugal", "Revolução dos Cravos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "à importância do indígena brasileiro na composição étnica e cultural do povo brasileiro.",
      "às dimensões continentais adquiridas pela nação brasileira e sua semelhança com um instrumento musical.",
      "ao processo histórico de penetração e ocupação do território nacional e a delimitação das nossas fronteiras.",
      "à conquista do território nacional, realizada pelos nossos indígenas, graças à navegação dos nossos rios.",
      "à enorme diversidade de ecossistemas e paisagens naturais presentes no nosso vasto território."
    ],
    correctAnswer: 2,
    materia: ["História"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História do Brasil", "Segundo Reinado", "Guerra do Paraguai"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["História Moderna", "Expansão Marítima Europeia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História Contemporânea", "Revoluções Liberais", "França (século XIX)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletricidade", "Eletrostática"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Mecânica", "Cinemática", "Queda Livre"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Mecânica", "Conservação de Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Mecânica", "Leis de Newton", "Atrito", "Gráficos no Movimento"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Mecânica", "Estática", "Torque e Equilíbrio"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Eletricidade", "Circuitos Elétricos", "Ponte de Wheatstone"],
    imageNames: []
})