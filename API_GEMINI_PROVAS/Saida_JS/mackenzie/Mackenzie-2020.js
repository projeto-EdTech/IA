...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Análise Semântica e Sintática"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Crônica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Literários (Crônica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira (Modernismo, Clarice Lispector)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira (Simbolismo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Flavour doesn't change a lot from the original, made of meat, and the plant-based food.",
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Frases"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Imagens e Cartuns"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Ângulos e Retas Paralelas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Volume de Cilindro e Esfera)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Inequações Exponenciais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Climatologia (Massas de Ar)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Demografia (Pirâmides Etárias e Transição Demográfica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["População (Teorias Demográficas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "França, Espanha e Canadá são exemplos de países que integram a OTAN, constituída em 1949, no contexto histórico da Guerra Fria, com o objetivo de estabelecer um pacto militar entre os países membros, contra o avanço da influência socialista.",
      "O Brasil é o primeiro país na América Latina, e o quarto, no mundo, a receber o status especial de aliado extra-OTAN.",
      "Os recentes conflitos do governo brasileiro com o governo norte-americano, em decorrência das queimadas na Amazônia, fizeram com que o congresso dos EUA cancelasse o status especial concedido ao Brasil por Trump.",
      "De acordo com o secretário geral da Organização do Tratado do Atlântico Norte (OTAN), a condição de aliado especial ou prioritário é o primeiro passo para que o Brasil passe a se tornar membro oficial da organização, o que deve ocorrer ainda em 2019.",
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Geomorfologia (Tipos de Rochas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geopolítica (América do Sul, Conflitos Políticos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Química Orgânica (Funções Orgânicas, Isomeria Óptica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Química Inorgânica (Minerais, Dureza da Água)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Química Orgânica (Reações Orgânicas, Ozonólise, Oxidação)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Estequiometria (Cálculos de Dose)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Equilíbrio Químico (Constante de Acidez Ka)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Reações Químicas (Balanceamento Redox)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Bioquímica (Proteínas, Enzimas, Síntese Proteica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O percentual de oxiemoglobina é maior em capilares alveolares, quando o pH se aproxima de 7,6 em função da hematose.",
      "A hematose é um fenômeno responsável pela queda do pH sanguíneo.",
      "O aumento da taxa de CO2 no sangue aumenta o pH sanguíneo próximo dos alvéolos.",
      "Nos capilares teciduais, a diminuição da taxa de CO2 diminui o pH sanguíneo, diminuindo a taxa de oxiemoglobina sanguínea.",
      "A hiperventilação involuntária é desencadeada quando o pH sanguíneo chega em 7,6 em função da queda das taxas de O₂ no sangue."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana (Sistema Respiratório, Transporte de Gases)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Genética (Heredograma, Heranças Ligadas ao Sexo, Linkage, Crossing-over)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Origem da Vida (Hipótese Heterotrófica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Ecologia (Biomas, Impactos Ambientais, Sucessão Ecológica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a liberação do carbono estocado na massa vegetal e na diminuição da taxa de fotossíntese, processo biológico que fixa o carbono atmosférico.",
      "a diminuição da decomposição biológica, impedida pela morte dos microrganismos do solo.",
      "a intensificação do efeito estufa e, consequente, aumento na inversão térmica durante os períodos de estiagem na floresta.",
      "o processo de diminuição na camada de ozônio, reduzindo o bloqueio da radiação ultravioleta do sol e, consequente, intensificação do aquecimento global.",
      "o aumento do efeito estufa, processo natural relacionado exclusivamente à concentração de CO2 na atmosfera."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Ecologia (Ciclos Biogeoquímicos, Efeito Estufa, Impactos Ambientais)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "as pteridófitas conquistaram a independência da água para fecundação devido ao desenvolvimento de um sistema vascular eficiente.",
      "as angiospermas são o único grupo vegetal com total independência da água para fecundação, graças à polinização promovida por animais.",
      "as pteridófitas são o primeiro grupo a conquistar definitivamente o ambiente terrestre, pois possuem a fase esporofítica predominante, e o gametófito obtém a água para fecundação a partir do esporófito.",
      "as gimnospermas são as primeiras plantas sifonógamas, ou seja, possuem grãos de pólen que formam o tubo polínico, que dispensa a necessidade de água para o encontro dos gametas.",
      "as angiospermas conquistaram a independência da água para fecundação graças ao desenvolvimento da dupla fecundação e do fruto."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Botânica (Reprodução das Plantas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História Antiga (Roma Antiga, Crise da República)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "transmitiu a ideia de ser uma “pessoa do povo\" que iniciando sua carreira como vereador em Alagoas, pode pelo esforço próprio alcançar o mais alto cargo político no país o de presidente da República.",
      "a campanha do candidato baseava-se na luta contra a corrupção e apoio aos \"descamisados\", grupo do qual fez parte no começo de sua carreira, no interior carente do estado de Alagoas.",
      "construiu junto ao povo brasileiro a imagem de \"caçador de marajás\", defensor do fim de regalias e contra a corrupção; pois, jovem, foi eleito por meio do voto popular, ao cargo de prefeito de Maceió.",
      "conseguiu transmitir aos eleitores a imagem de um candidato jovem, “moderno” e “moralizador” que se opunha aos representantes políticos corruptos e conservadores.",
      "deu, efetivamente, início a um programa de atendimento às camadas mais pobres da população, ao se colocar ao lado dos “pés-descalços”, como protetor contra os “velhos políticos\"."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História do Brasil (Nova República, Eleições de 1989)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "à ação intervencionista do Estado no campo social e econômico nessa época, majoritariamente a favor das classes populares. Tal ação garantiu-lhe o apelido de \"Pai dos Pobres\".",
      "às diversas conquistas feitas, pelo trabalhador urbano no período, quando foi estabelecido o salário mínimo e a possibilidade de criação de sindicatos autônomos e representativos para as diversas categorias de trabalho.",
      "à reunião de diversas leis trabalhistas, em 1943, na Consolidação das Leis do Trabalho (CLT), que foram extintas durante o regime militar, no governo do presidente Geisel.",
      "à concessão lenta e gradual de leis trabalhistas, pelas quais o Estado intervém profundamente na questão trabalhista; porém, por outro lado garantiu, entre outros, a jornada de trabalho de oito horas.",
      "à garantia de direitos para todos os trabalhadores brasileiros, tanto o rural, quanto o urbano, direitos esses, jamais concedidos antes na História do país à classe trabalhadora."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História do Brasil (Era Vargas, Estado Novo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História Geral (Segunda Guerra Mundial, Batalha de Stalingrado)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a Homestead Act de 1862 dificultava o acesso à terra, pois estipulava valores muito altos para a compra de territórios a oeste do rio Mississipi, resultando na baixa ocupação europeia e na prevalência de povos indígenas. Tal qual os EUA, a Lei de Terras de 1850 impede que setores populares tenham acesso à terra no Brasil, pelo seu alto custo.",
      "a Lei de Terras de 1850 proibia a aquisição de terras públicas por qualquer outro meio que não fosse a compra, finalizando as formas tradicionais de aquisição de terras mediante doações do governo. De maneira diferente, o Homestead Act de 1862 doava terras exclusivamente à população indígena e africana interessada na ocupação do oeste.",
      "a política rural, tanto no Brasil como nos Estados Unidos, estava ligada a uma certa concepção de trabalho não escravo. Mas, enquanto a Lei de Terras de 1850 dificultava a obtenção de terra pelo trabalhador livre, o Homestead Act de 1862 doava terras aqueles que desejassem nela se instalar.",
      "Brasil e EUA desenvolvem suas políticas de terras dentro de um contexto de crise do sistema escravocrata e necessidade crescente da mão de obra do trabalhador livre europeu. Assim, tanto a Lei de Terras de 1850 quanto a Homestead Act de 1862 democratizam o acesso à terra em seus respectivos países.",
      "as leis agrárias brasileira e norte americana, completamente diferentes, estão vinculadas a necessidades de substituição gradual da mão de obra escrava. A Lei de Terras de 1850 democratiza a terra na medida, em que possibilita a posse a quem ocupá-la por mais de 5 anos, enquanto o Homestead Act de 1862 estabelece a posse pela compra."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História do Brasil (Segundo Reinado, Lei de Terras)", "História Geral (Homestead Act)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História Geral (Idade Moderna, Renascimento e Humanismo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História Geral (Século XIX, Revoluções de 1848, Marxismo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Semelhança de Modelos e Escalas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Estática (Equilíbrio de Corpos Rígidos, Momento de Força)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Termodinâmica (Máquinas Térmicas, Rendimento)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Eletricidade (Potência e Energia Elétrica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Eletricidade (Consumo de Energia Elétrica)"],
    imageNames: []
})