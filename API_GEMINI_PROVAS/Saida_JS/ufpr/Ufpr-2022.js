...
createQuestion({
    ...
    options: [
      "is made of silk.",
      "preserves traditional spinning techniques.",
      "is not sewed.",
...
createQuestion({
    ...
    options: [
      "severe measures against specific fuel fires and a knife attack at a temple in London.",
      "the lack of coal supplies for the coming winter and the persecution of a Londoner in a church.",
      "the shortage of coal for heating ovens and the attack in a fair in London.",
      "some restrictions imposed on coal to heat both houses and Muslim temples in London.",
      "a huge explosion and the destruction of a church in London."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Manchete"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Uma população biológica é constituída por espécimes da mesma espécie que vivem em uma mesma área geográfica.",
      "Populações biológicas são grupos de espécies semelhantes, formadas por diferentes espécimes da mesma área geográfica.",
      "Uma população biológica é formada por diferentes espécies que habitam áreas geográficas semelhantes.",
      "Um espécime é um tipo de espécie que se distribui em diferentes populações biológicas ao longo de áreas geográficas distintas.",
      "Espécimes são grupos de espécies semelhantes constituídas por populações biológicas da mesma área geográfica."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Ecologia"],
...
createQuestion({
    ...
    options: [
      "No epitélio intestinal dos animais, as especializações da membrana chamadas de microvilosidades reduzem a área de absorção, evitando o transporte por endocitose.",
      "Na difusão simples, a passagem de substâncias através da membrana ocorre a favor do gradiente de concentração, com gasto de ATP.",
      "Nos neurônios, o potencial de repouso da membrana é mantido pela difusão facilitada chamada de bomba sódio-potássio.",
      "A região dos pelos radiculares das plantas tem maior concentração de solutos que a água do solo, de modo que a água entra no interior das raízes por osmose.",
      "O transporte ativo é caracterizado pela passagem de substâncias a favor do gradiente de concentração, com o auxílio de proteínas carreadoras chamadas de permeases."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Celular"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "somente gimnospermas e angiospermas são capazes de realizar fotossíntese, pois são plantas vasculares e com sementes.",
      "as briófitas possuem estruturas clorofiladas, mas são incapazes de realizar fotossíntese por não possuírem vasos condutores.",
      "as pteridófitas possuem folhas com células ricas em cloroplastos, relacionadas com a realização da fotossíntese.",
      "desde que interrompam o processo de respiração celular, plantas avasculares podem fazer fotossíntese.",
      "nas plantas vasculares, a fotossíntese é interrompida durante a respiração celular devido ao ponto de compensação fótica."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Botânica"],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Aritmética e Teoria dos Números"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a crise do sistema mercantilista e as revoltas burguesas.",
      "a querela das investiduras e as controvérsias iconoclastas.",
      "a chamada caça às bruxas e as expedições cruzadas.",
      "a guerra das Duas Rosas e as invasões dos hunos.",
      "a epidemia de peste bubônica e as ondas de fome."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Europa Medieval"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "exaltação da simonia, que almejava trazer os cristãos afastados para o cotidiano da igreja.",
      "ênfase na justificação pela fé, que visava eliminar intermediários humanos na relação com a divindade.",
      "importância do celibato, que intentava preservar o clero regular da corrupção de bens religiosos.",
      "renovação das obras de caridade, que pretendia reforçar o engajamento dos cristãos na vida social.",
      "adoção da peregrinação, que procurava aproximar os fiéis de diferentes partes da Europa."
    ],
    correctAnswer: 1,
    materia: ["História"],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["África Pré-Colonial e Colonialismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O governo do presidente Fernando Henrique Cardoso, entre 1995 e 1999, foi implantado devido à vitória do parlamentarismo no plebiscito sobre regimes de governo em 1993.",
      "O governo do presidente Washington Luís, entre 1926 e 1930, foi implantado devido ao desgaste da política do café-com-leite e à ascensão do movimento da Aliança Liberal.",
      "O governo do presidente Eurico Gaspar Dutra, entre 1950 e 1951, foi implantado devido aos planos de instauração de uma ditadura militar com auxílio da Arena (Aliança Renovadora Nacional).",
      "O governo do presidente João Goulart, entre 1961 e 1963, foi implantado devido à articulação de setores militares e conservadores para limitar os poderes presidenciais.",
      "O governo do presidente Café Filho, entre 1954 e 1955, foi implantado devido à crise política decorrente do suicídio de Getúlio Vargas e da mobilização do Partido Comunista para tomar o poder."
    ],
    correctAnswer: 3,
    materia: ["História"],
...
createQuestion({
    ...
    options: [
      "...atinou com desaviso a inquietante... (linha 1) / Estima-se que as ações do Facebook... (linha 3)",
      "...que consomem a atenção das pessoas... (linha 2) / ...ao efetuarem pagamentos... (linha 6)",
      "...em questão de horas forneceu um interessante... (linha 4) / ... solucionarem a questão... (linha 6)",
      "...o fenômeno abre espaço para observar as conexões entre a valorização do capital... (linha 9)",
...
createQuestion({
    ...
    options: [
      "A estimativa da queda das ações do Facebook em torno de 5% levou os técnicos da empresa a tentarem corrigir essa falha.",
      "O distanciamento das redes sociais caiu num limbo provocado pelo retorno a eras mais remotas.",
      "Sem saber o que fazer com o tempo livre, as pessoas ficaram desorientadas e arrancaram os cabelos pela \"queda do zap\".",
      "As pessoas se deram conta da existência do real a partir da interrupção do mascaramento da vida nas redes sociais.",
      "Segundo Eduardo Mariutti, UNICAMP, o mundo virtual não se opõe ao mundo real, mas o contradiz, fragmentando-o."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Compreensão de Texto"],
...
createQuestion({
    ...
    options: [
      "inviável, ligeireza, alçada.",
      "obrigatório, rapidez, foro.",
      "opcional, importância, campo.",
      "imperioso, notoriedade, localidade.",
      "transitório, morosidade, domínio."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Semântica"],
...
createQuestion({
    ...
    options: [
      "Os travessões da linha 6 destacam o aposto de 'a arte da guerra'.",
      "O emprego de itálico em 'background' (linha 1) equivale, como recurso, às aspas duplas em \"apocalíptico\" (linha 7).",
      "Todas as ocorrências de aspas duplas são empregadas para destacar a ironia.",
      "As aspas duplas em \"apocalíptico\" (linha 7) e \"racional\" (linha 9) foram empregadas para marcar incerteza.",
      "O emprego de itálico em 'background' (linha 1) não é correto, pois o termo deveria vir entre aspas."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Pontuação"],
...
createQuestion({
    ...
    options: [
      "um recanto arruinado do Rio de Janeiro, cuja pobreza perturba os planos amorosos de Cassi e Clara.",
      "um espaço público na capital do país, em que uma mulher embriagada acusa Cassi de tê-la desonrado.",
      "um arruamento irreconhecível para o protagonista, devido ao brilho e realce das hospedarias coloniais.",
      "uma vizinhança arruinada e miscigenada onde morava Marramaque, com quem Cassi tinha uma dívida.",
      "um subúrbio formado por favelas, que eram habitadas por trabalhadores pobres e mulheres degradadas."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira"],
...
createQuestion({
    ...
    options: [
      "O fragmento transcrito é parte da narração do antropólogo Buell Quain, cujo suicídio, ocorrido em 1939, é o fato que motiva a investigação do narrador principal e que conduz toda a narrativa.",
      "O fragmento destoa da visão positiva sobre os resultados dos encontros entre diferentes culturas que predomina em Nove noites, pois traz o depoimento de alguém para quem o convívio entre índios e brancos tende sempre à desarmonia.",
      "O fragmento é parte de uma das cartas do engenheiro Manoel Perna e reforça suas advertências para que o narrador principal tome muito cuidado ao buscar a verdade sobre a morte de Buell Quain.",
      "O fragmento exemplifica a obsessão do narrador por buscar a verdade sobre a morte de Buell Quain, característica que desloca Nove noites, que se parece com obras ficcionais, para os campos da reportagem e da não ficção.",
      "O fragmento é parte da narração do jornalista e narrador principal que, adulto, volta a passar por situações de medo e terror, algo que já havia sentido quando, ainda criança, visitara o Xingu na companhia de seu pai."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "estrutura polimérica ligada covalentemente.",
      "flúor e tungstênio formando ligação metálica.",
      "fluoreto e tungstênio formando ligação iônica.",
      "tungstênio metálico dopado com átomos de flúor.",
      "molécula discreta formada por ligações covalentes."
    ],
    correctAnswer: 4,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "permitir a reciclagem ou o reuso do resíduo.",
      "permitir acesso ao resíduo pelos decompositores.",
      "promover condições para a incineração do resíduo.",
      "impedir o vazamento do chorume e a contaminação de lençóis freáticos.",
      "drenar o gás metano e o gás carbônico produzidos na decomposição do resíduo."
    ],
    correctAnswer: 3,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "ser bastante solúvel e possuir um valor de entalpia de dissolução negativa.",
      "ser cristalino e induzir a cristalização do gelo na sua superfície.",
      "ser reativo e atuar como catalisador do processo de precipitação.",
      "ser formado por íons e promover descargas elétricas nas nuvens.",
      "ser sensível à radiação solar e provocar a fotólise da água."
    ],
    correctAnswer: 1,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "América do Norte e Europa são os principais destinos de imigrantes porque as instituições governamentais laicas dos países dessas regiões atraem pessoas que sofrem perseguições religiosas em seus países de origem.",
      "A Guerra dos Trinta Anos e outros conflitos religiosos foram a causa do grande fluxo migratório de europeus em direção às Américas no período que vai do início do século XVI até meados do século XVIII.",
      "O tráfico de escravos da África para o Oriente Médio e para as Américas não é classificado como fluxo migratório porque se tratava de transferências forçadas de pessoas de um continente para outros.",
      "As pessoas que migram para trabalhar são rejeitadas porque enviam dinheiro para os parentes que ficaram em seus países de origem, ocasionando perdas econômicas para o país que as recebe.",
      "No espaço urbano, a alta densidade demográfica facilita o acesso da população aos serviços públicos de educação e saúde, sendo esse um fator de atração de migrantes provenientes do campo."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Demografia"],
...
createQuestion({
    ...
    options: [
      "Foi durante a Rio-92 que os representantes dos países amazônicos assinaram os tratados que estabeleceram a gestão internacional compartilhada dos recursos florestais da região para preservar a biodiversidade.",
      "As pressões nacionais e internacionais para preservar a Amazônia se intensificaram a partir de meados dos anos 1980 devido à divulgação das imagens de queimadas na região e do assassinato do líder seringueiro Chico Mendes.",
      "A justificativa para a internacionalização da floresta amazônica é o seu papel na absorção de carbono em escala global, característica que a tornou conhecida nos meios científicos como o \"pulmão do mundo\".",
      "O enfrentamento das mudanças climáticas requer uma estratégia geopolítica para estabelecer a soberania global sobre o bioma amazônico.",
      "O setor financeiro é resistente ao esforço internacional de preservação da Amazônia, visto que o Banco Mundial concede financiamento a projetos de infraestrutura na região considerando a lucratividade."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Questões Ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Povo é um agrupamento de pessoas que se organizam sob a forma de Estado para defender um território e seus recursos.",
      "Nação é um grupo de pessoas que apresenta homogeneidade de características físicas e que partilha de uma história comum.",
      "País é o espaço econômico organizado por um governo ou por uma associação de governos, como ocorre no exemplo da União Europeia.",
      "Sociedade é um agrupamento de indivíduos que vivem juntos num certo espaço e que se relacionam de acordo com determinadas regras, como se vê na sociedade das formigas, das abelhas e na sociedade humana.",
      "Países com unidade territorial e organização econômica estável são aqueles que representam um único povo, na medida em que a homogeneidade cultural evita pressões separatistas e conflitos internos."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia Política"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A diminuição do percentual de pobres se acelera após 1949 devido à instituição da Lei do Filho Único na China, tendo em vista a grande participação desse país no total da população pobre do mundo até aquele ano.",
      "A redução da proporção de pobres não fez a pobreza extrema diminuir em termos absolutos porque a população mundial passou de 1 para 7,8 bilhões entre 1800 e 2017, o que fez o número de pobres crescer.",
      "A elevação da renda per capita em um país não melhora as condições de saúde, educação e de saneamento básico se não houver diminuição da concentração de renda.",
      "A queda do percentual de pessoas extremamente pobres se acelera no período marcado pela intensificação dos processos de industrialização, modernização da agricultura e urbanização.",
      "A pobreza extrema diminui a partir de 1800 porque esse período histórico se caracteriza pelo processo de descolonização, o qual permitiu a generalização da democracia e do modelo de Estado do Bem-Estar."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["População e Pobreza"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O sunismo é a vertente fundamentalista do islamismo, e os xiitas correspondem a cerca de metade da população do Oriente Médio, situação que gera conflitos religiosos em diversos países da região.",
      "A soberania sobre Jerusalém é um dos pivôs dos conflitos no Oriente Médio devido à posição estratégica dessa cidade para o controle das áreas de extração de petróleo que ficam entre o rio Jordão e o mar Mediterrâneo.",
      "A intensidade dos conflitos entre árabes e judeus foi reduzida após a assinatura do Tratado de Oslo, no qual os palestinos reconheceram a soberania de Israel sobre os territórios de Gaza e da Cisjordânia.",
      "A separação entre Estado e religião é uma característica da cultura ocidental que não pode ser reproduzida no Oriente Médio devido às tradições culturais da região e aos preceitos do judaísmo e do islamismo.",
      "Em 1947, a ONU estabeleceu a divisão da Palestina em um Estado Árabe e um Estado Israelense, sendo que os palestinos declararam guerra aos israelenses por não concordarem com essa forma de partilha."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "As metrópoles classificadas como cidades globais são aquelas que apresentam grande relevância como centros financeiros, de serviços modernos e como sedes de empresas multinacionais.",
      "As metrópoles de países subdesenvolvidos tornam-se cidades globais quando suas populações superam 10 milhões de habitantes, pois assim os mercados dessas metrópoles alcançam relevância no comércio mundial.",
      "A globalização da economia tornou os territórios nacionais interdependentes e pacificou as relações entre países, de modo que as capitais nacionais perderam proeminência para os grandes centros econômicos.",
      "As cidades globais formam uma rede que concentra a maior parte da produção industrial do mundo, o que lhes confere proeminência no comércio internacional de produtos.",
      "O processo de urbanização completou-se na Europa antes do que nos demais continentes, razão pela qual as metrópoles europeias não atingem o mínimo de 10 milhões de habitantes necessários para serem classificadas como cidades globais."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "as noções de preconceito, discriminação e segregação são inseparáveis.",
      "o conhecimento religioso foi superado pelo conhecimento produzido pela ciência.",
      "o Estado brasileiro mantém a laicidade como princípio legal desde a primeira Constituição.",
      "a religião se resume ao sobrenatural ou ao incompreensível, e a ciência é a principal forma democrática de prática cidadã.",
      "a religião não pode ser identificada apenas com o monoteísmo e que, no Brasil, há historicamente uma diversificação das práticas religiosas."
    ],
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Religião e Sociedade"],
    imageNames: []
}),
