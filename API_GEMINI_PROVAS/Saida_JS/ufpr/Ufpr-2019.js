createQuestion({
    ...
    options: [
      "Guerra Civil Russa e construção da Cortina de Ferro na Europa.",
      "Primeira Guerra Mundial e limpeza étnica na Iugoslávia.",
      "Guerra Civil Espanhola e ataques terroristas da Al-Qaeda nos Estados Unidos.",
      "Guerra Russo-Japonesa e genocídio dos tutsis em Ruanda.",
      "Segunda Guerra Mundial e Holocausto."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["História Geral", "Século XX"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História do Brasil", "Direitos Políticos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História Geral", "Movimentos Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["História Antiga", "Império Romano"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História Medieval", "Feudalismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História Geral", "Primeira Guerra Mundial", "Sociedade e Gênero"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a crescente imigração de pessoas oriundas de países em conflito étnico na África, de ex-colônias europeias na África e na Ásia e de nações desenvolvidas na Oceania e nas Américas a partir dos anos 1940.",
      "a crescente imigração de pessoas oriundas de países em guerra no Oriente Médio, de países em descolonização na África e na Ásia e de nações pobres na África, Ásia e Américas a partir dos anos 1970.",
      "a crescente imigração de pessoas oriundas de países em crise econômica na América do Norte, de países em guerra civil na América do Sul e de nações subdesenvolvidas na África a partir dos anos 1990.",
      "a crescente imigração de pessoas oriundas de países em crise humanitária no Oriente Médio, de países em conflito civil pertencentes à antiga União Soviética e de nações do Primeiro Mundo durante a crise financeira de 2008.",
      "a crescente imigração de pessoas oriundas de países asiáticos em decorrência da Revolução Cultural Chinesa, de países subdesenvolvidos pós-coloniais da África e de nações latino-americanas em crise a partir dos anos 1930."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geografia Humana", "Migrações"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Iluminismo europeu e foi publicada no contexto do absolutismo inglês, em que o clero católico possuía privilégios, terras e metais preciosos, ao contrário da maioria da população.",
      "Renascimento europeu e foi publicada no contexto do republicanismo inglês, em que os parlamentares possuíam terras, títulos de nobreza e isenção de impostos, ao contrário da maioria da população.",
      "Arcadismo europeu e foi publicada no contexto do protecionismo inglês, em que o clero protestante possuía terras, privilégios e perdão de dívidas, ao contrário da maioria da população.",
      "Humanismo europeu e foi publicada no contexto do absolutismo inglês, em que a aristocracia possuía privilégios, terras e rendas, ao contrário da maioria da população.",
      "Romantismo europeu e foi publicada no contexto de expansionismo inglês, em que a monarquia possuía manufaturas, terras e ouro, ao contrário da maioria da população."
    ],
    correctAnswer: 3,
    materia: ["Filosofia", "História"],
    conteudo: ["Filosofia Moderna", "Teoria Política", "Idade Moderna"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["História do Brasil", "Nova República", "Cidadania"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Química Inorgânica", "Ligações Químicas", "Tabela Periódica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "formação de composto iônico.",
      "reação de oxidorredução.",
      "ligação covalente com a rocha.",
      "alteração do estado de agregação.",
      "adsorção de CO2 numa matriz porosa."
    ],
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Ambiental", "Reações Químicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a temperatura local é maior.",
      "outra via de reação é favorecida.",
      "a concentração dos reagentes é maior.",
      "a área superficial do catalisador é maior.",
      "a pressão parcial das espécies gasosas é maior."
    ],
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Cinética Química"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "geram gases irritantes.",
      "formam líquidos imiscíveis.",
      "produzem compostos voláteis.",
      "formam precipitados suspensos na atmosfera.",
      "sintetizam compostos que absorvem a radiação eletromagnética no espectro visível."
    ],
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Química Geral", "Reações Químicas", "Meio Ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "3,4,4,5-tetrametilcicloexanona.",
      "3,4,4,5-metilcicloexanodienona.",
      "3,4,4,5-tetrametilcicloexano-2,5-dienona."
    ],
    correctAnswer: 4,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "Estrutura química de um polímero de repetição que inclui unidades de isocianato e poliol.",
      "Estrutura química de um polímero de repetição diferente.",
      "Estrutura química de um polímero de repetição diferente.",
      "Estrutura química de um polímero de repetição diferente.",
      "Estrutura química de um polímero de repetição diferente."
    ],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Equilíbrio Ácido-Base", "Chuva Ácida"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O tecido muscular estriado esquelético é formado por células fusiformes e é responsável pelo peristaltismo.",
      "Actina e miosina são células do tecido muscular fundamentais para o processo de contração muscular.",
      "Macrófagos são células típicas do tecido conjuntivo, sendo responsáveis pela formação de células sanguíneas vermelhas.",
      "Colágeno é o tipo de célula característica do tecido cartilaginoso, que tem função de sustentação.",
      "Células nervosas possuem um corpo celular de onde partem dois tipos de prolongamentos e permitem ao organismo responder a estímulos do meio."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Histologia Animal", "Fisiologia Humana"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "1 = árvore – 2 = pulgão – 3 = joaninha – 4 = pássaro.",
      "1 = capim – 2 = pulgão – 3 = joaninha – 4 = pássaro.",
      "1 = árvore – 2 = pássaro – 3 = joaninha – 4 = pulgão.",
      "1 = bezerro – 2 = capim – 3 = homem – 4 = parasita intestinal do homem.",
      "1 = capim – 2 = bezerro – 3 = homem – 4 = parasita intestinal do homem."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "A febre amarela é uma doença bacteriana e sua transmissão ocorre pela picada de mosquito do gênero Aedes.",
      "Sarampo e tuberculose são doenças provocadas por vírus e transmitidas por gotículas eliminadas por tosse e espirro.",
      "Febre amarela e sarampo são doenças causadas por vírus, e para ambas a prevenção pode ser realizada por meio de vacinação.",
      "A tuberculose é causada pelo vírus de Koch, e a prevenção pode ser feita por meio da vacina tríplice viral.",
      "Tuberculose e sarampo são doenças bacterianas, e para ambas a prevenção pode ser realizada por meio de vacinação."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Saúde Pública", "Doenças Transmissíveis"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Ao final da mitose ocorre redução da ploidia da célula por meio da separação das cromátides-irmãs.",
      "Os gametas haploides são originados por meio da separação dos cromossomos homólogos que ocorre na meiose I.",
      "A segregação dos cromossomos homólogos ocorre durante a mitose I, originando gametas haploides.",
      "A meiose origina gametas haploides por meio da separação das cromátides-irmãs.",
      "O crossing over ocorre durante a mitose, podendo produzir gametas recombinantes."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Biologia Celular", "Meiose", "Genética"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Gimnospermas e angiospermas apresentam embriões unicelulares que se desenvolvem dentro de sementes envolvidas por frutos.",
      "Nas angiospermas, a geração esporofítica (2n) é dominante, enquanto nas gimnospermas a geração gametofítica (n) é dominante.",
      "Nas espermatófitas, a semente é bitegumentar e envolvida por fruto.",
      "As espermatófitas apresentam grão de pólen haploide que corresponde ao gametófito masculino.",
      "Briófitas, pteridófitas, gimnospermas e angiospermas possuem embrião multicelular bem como sementes, motivo pelo qual são denominadas espermatófitas."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana", "Enzimologia", "Metabolismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As mutações genéticas ocorrem com o objetivo de promover adaptação dos organismos ao ambiente.",
      "Alterações na sequência de aminoácidos do DNA dos organismos podem ser vantajosas, neutras ou desvantajosas para seus portadores.",
      "Em uma população, uma característica vantajosa tende a aumentar de frequência na geração seguinte pela ação da seleção natural.",
      "Os organismos de uma população biológica são idênticos entre si, potencializando a ação da seleção natural.",
      "Os organismos atuais estão se modificando geneticamente para se adaptar às mudanças climáticas, como o aquecimento global."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Animal", "Trocas Gasosas"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Giovana deseja fazer um painel usando folhas de papel de tamanhos carta e A4. O painel será composto por duas faixas, cada uma contendo apenas folhas inteiras de um tipo dispostas lado a lado (sem sobreposição e sem espaço entre elas), formando uma figura retangular, sem sobras e sem cortes de papel. As folhas do tipo carta (1) serão dispostas na posição vertical, e as folhas do tipo A4 (2) serão dispostas na posição horizontal, conforme ilustra a figura abaixo:\nDiagrama: Duas faixas. Faixa superior mostra folhas \"Carta\" (1) na vertical, em sequência. Faixa inferior mostra folhas \"A4\" (2) na horizontal, em sequência. Ambos os tipos de folhas se repetem indefinidamente.\nSabendo que as folhas A4 têm tamanho 210 mm por 297 mm e que as folhas carta têm tamanho 216 mm por 279 mm, a menor quantidade total de folhas de papel (incluindo A4 e carta) que Giovanna precisa usar para conseguir atender às exigências do enunciado é:",
      subItens: []
    },
    options: [
      "12.",
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Razão e Proporção", "Regra de Três"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Funções Polinomiais", "Sequências e Séries"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Circunferência", "Parábola"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Ecologia", "Meio Ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Coesão e Coerência", "Relações Semânticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Leia o excerto abaixo:\nAs bombas que os aliados lançaram sobre a Alemanha durante a Segunda Guerra Mundial conseguiram atingir a borda inferior do espaço: a ionosfera se enfraqueceu sob a influência da onda expansiva de tantos explosivos. _______ o efeito tenha sido temporário, chegou a ser sentido nos céus da Inglaterra. _______ os bombardeios alemães, primeiro os da Luftwaffe (a aviação nazista) e, depois, com os foguetes V1 e V2, mal deixaram vestígios na atmosfera.\nAssinale a alternativa que preenche corretamente as lacunas acima, na ordem em que aparecem no texto.",
      subItens: []
    },
    options: [
      "Embora – No entanto.",
      "Ainda que – Por isso.",
      "Consoante – Não obstante.",
      "Posto que – Logo.",
      "Porquanto – Contudo."
    ],
    correctAnswer: 0,
...
createQuestion({
    ...
    options: [
      "com que – que – sob aquilo.",
      "onde – quanto ao que – sob o que.",
      "em que – que – sobre que.",
      "com o qual – com o qual – sobre o que.",
      "que – onde – sobre o qual."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática", "Pronomes Relativos", "Preposições"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática", "Referência Textual"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "defende a ideia de que eles precisam ser reelaborados, para se adequarem aos valores de cada época.",
      "concorda que deve ser proibido assustar as crianças por meio dos contos, para que isso não as afaste da leitura.",
      "vê com bons olhos as versões dos irmãos Grimm, que abrandaram o enredo e passaram a apresentar finais felizes.",
      "considera a infinita repetição como um aspecto negativo dos contos, mas que é compensado pela infinita variedade.",
      "é favorável a que tenham finais tristes e abordem situações de desigualdade, crueldade e infortúnios."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "A técnica de Mourou e Strickland criada em 1985, e conhecida como: amplificação de pulso com varredura em frequência – CPA, por sua sigla em inglês, tornou-se muito rapidamente a ferramenta-padrão para obter lasers de alta intensidade, utilizados, desde então, em milhões de cirurgias do olho.",
      "A técnica de Mourou e Strickland, criada em 1985, e conhecida como amplificação de pulso com varredura em frequência (CPA, por sua sigla em inglês); tornou-se muito rapidamente, a ferramenta-padrão para obter lasers de alta intensidade utilizados desde então em milhões de cirurgias do olho.",
      "A técnica de Mourou e Strickland criada em 1985 e conhecida como amplificação de pulso com varredura em frequência, (CPA, por sua sigla em inglês), tornou-se muito rapidamente a ferramenta-padrão, para obter lasers de alta intensidade utilizados desde então, em milhões de cirurgias do olho.",
      "A técnica de Mourou e Strickland, criada em 1985 e conhecida como amplificação de pulso com varredura em frequência – CPA, por sua sigla em inglês – tornou-se muito rapidamente, a ferramenta-padrão para: obter lasers de alta intensidade utilizados desde então em milhões de cirurgias do olho.",
      "A técnica de Mourou e Strickland, criada em 1985 e conhecida como amplificação de pulso com varredura em frequência (CPA, por sua sigla em inglês), tornou-se muito rapidamente a ferramenta-padrão para obter lasers de alta intensidade, utilizados desde então em milhões de cirurgias do olho."
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Cinema"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "objeto que regula emoções – exílio.",
      "capacidade de sentir emoções – exclusão.",
      "experiência – falta de exposição.",
      "maturidade – isolamento.",
      "malícia – incapacidade de se expressar."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "A representação dos povos indígenas descreve as tradições coletivas dessas comunidades, mas pode, por vezes, apresentar os sentimentos individuais e particulares de alguns de seus membros.",
      "Gonçalves Dias demonstra em sua poesia americana o interesse de se distanciar da tradição indianista, apresentando temas universais, nos quais o gosto pelo exótico e pela tematização do nacional não deveria predominar.",
      "A tematização da miscigenação entre índios e brancos é considerada prejudicial, uma vez que apagaria os traços próprios da cultura indígena que deveriam ser preservados.",
      "O emprego exclusivo de poemas narrativos longos demonstra que o livro pretende ser uma epopeia que cultua os valores heroicos e descarta a expressão lírica amorosa.",
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Literatura Contemporânea"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O narrador é imparcial ao descrever os cenários do subúrbio e de outros pontos da cidade, demonstrando neutralidade na constatação das diferenças entre as regiões.",
      "O subúrbio é descrito ora de modo realista, ora de modo idealizado, contribuindo para a construção de uma visão, por vezes, romantizada da pobreza.",
      "O narrador disseca com rigor quase sociológico os problemas políticos da época, citando fatos e personagens históricos reais que se misturam à narrativa.",
      "O romance apresenta o ambiente do subúrbio aliando a descrição pormenorizada do espaço físico à caracterização dos personagens que o habitam.",
      "Os vários bairros e personagens que estão nos arredores da linha férrea do trem urbano são descritos como um conjunto indiferenciado, como se cada bairro não tivesse sua característica própria."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "O auto de João Cabral de Melo Neto utiliza o verso e recursos da tradição oral popular do Nordeste para reforçar o caráter religioso da peça, excluindo indícios de crítica social aos problemas regionais.",
      "O conflito entre pai e filho em Eles não usam Black-tie transpõe para o ambiente cotidiano de uma família os conflitos e impasses da classe operária diante dos desmandos dos patrões.",
      "A peça de Guarnieri faz referências à cultura e ao ambiente da favela, incluindo até letras de sambas antigos, o que reforça a imagem idealizada do morro e da figura do malandro.",
      "Morte e vida Severina utiliza versos de metrificação idêntica em todo o texto, o que prejudica o ritmo musical e melódico, ao contrário do que se observa na peça de Guarnieri.",
      "Os personagens da peça de Guarnieri são considerados alegóricos, porque não apresentam conflitos psicológicos, enquanto os de João Cabral são personagens individualizados e diversos entre si."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Unidades de Medida", "Dinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Fluidos", "Termodinâmica", "Unidades de Medida"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Dinâmica", "Movimento Circular"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Meio Ambiente", "Geografia Física", "Unidades de Conservação"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As indicações de norte \"para cima\" e sul \"para baixo” são convenções e podem ser alteradas.",
      "O planeta Terra obedece a um referencial específico magnético, motivo pelo qual o norte da rosa dos ventos deve sempre apontar para a linha do Equador.",
      "O mapa pode ser mantido do modo como está apresentado, porém, onde consta região Sul, deve ser alterado para região Norte, e sucessivamente para as demais, obedecendo à orientação.",
      "Se representado desse modo, Trópico de Capricórnio deve ser substituído por Trópico de Câncer.",
      "A rosa dos ventos não pode ser alterada, mesmo que o mapa esteja invertido."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia Humana", "Geopolítica", "Economia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Devido ao fato de o ciclo hidrológico ser um processo natural, a influência do homem, por meio da retirada da vegetação, não é suficiente para alterar sua dinâmica.",
      "A retenção de água na encosta se manterá em equilíbrio, pois os itens 4 e 10 deixarão de retirá-la para a atmosfera e anularão o efeito dos demais processos.",
      "O rio a jusante sofrerá interferência, pois, nos momentos de chuva, sua vazão se elevará, devido ao aumento no item 7, e quando em estiagem sofrerá diminuição, pois não será alimentado pelos itens 6 e 9.",
      "Ocorrerá alteração significativa da dinâmica da água na encosta com o aumento dos itens 6, 8 e 9 e a consequente redução do item 7.",
      "Os recursos hídricos serão potencializados por meio dos itens 1, 2 e 3."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geografia Física", "Hidrografia", "Meio Ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O número de estrangeiros, no Brasil, é proporcionalmente maior que na Argentina e no Paraguai, haja vista que esses países possuem menor população.",
      "No Brasil, em razão do tamanho da sua população e da quantidade de estrangeiros, pode-se dizer há um equilíbrio entre ambos, se comparado aos EUA e à Alemanha, por exemplo.",
      "As informações do texto e os dados da tabela evidenciam que o Brasil é pouco atrativo para estrangeiros, se comparado aos outros países.",
      "O Brasil, por ser conhecido por ter boas políticas de Estado em relação à migração, tem apresentado historicamente um crescente interesse por parte dos estrangeiros migrantes.",
      "A política de incentivo à migração, integrando-os à economia, faz com que os EUA se tornem o país mais visado para estrangeiros."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geografia Humana", "População", "Migrações"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Geografia Humana", "Espaço Urbano e Rural", "Urbanização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia", "Sociologia"],
    conteudo: ["Globalização", "Economia Global", "Desigualdade Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Climatologia", "Conhecimento Geográfico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Moderna", "Filosofia Contemporânea"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Antiga", "Pensamento Grego"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Moderna", "Racionalismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["Estética", "Conhecimento"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Gênero", "Movimentos Sociais", "Direitos Humanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Sociologia Clássica", "Karl Marx", "História Contemporânea"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Filosofia Política", "Teoria Política", "Poder"],
    imageNames: []
}),
