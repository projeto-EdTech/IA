...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Taxonomia e Sistemática"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "constrição, diminuição, aumento",
      "dilatação, aumento, aumento",
      "dilatação, diminuição, aumento",
      "dilatação, aumento, diminuição",
      "constrição, aumento, diminuição"
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Expressões Algébricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Índia, Egito e África do Sul permaneceram neutros durante a Guerra Fria, não se alinhando ao sistema bipolar.",
      "Acordos econômicos eram efetivados entre o Japão e a China, que se mantiveram neutros em relação aos conflitos do Ocidente.",
      "Nos anos cinquenta do século XX, os Estados Unidos e a União Soviética assinaram um pacto para evitar a proliferação de armas nucleares.",
      "O macarthismo, movimento político desenvolvido nos Estados Unidos durante a década de 1950, manifestou-se pelo fim das hostilidades entre soviéticos e estadunidenses.",
      "Com a morte do líder soviético Stálin, ocorrida no ano de 1953, o sistema mundial de dominação bipolar foi dissolvido, sendo criada no ano seguinte a Liga das Nações."
    ],
    correctAnswer: 0,
    materia: ["História"],
...
createQuestion({
    ...
    conteudo: ["Idade Média", "Arte Medieval"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Foi decisivo nas conquistas territoriais durante o período republicano, perdendo seu prestígio durante o período imperial.",
      "Permaneceu distante das atividades de manutenção das fronteiras dos territórios.",
      "Deixou de exercer sua influência no governo após as reformas de Augusto.",
      "Desempenhou diferentes papéis administrativos e econômicos na manutenção do poder imperial.",
      "Era limitado em tamanho, o que refletiu num papel político secundário."
    ],
    correctAnswer: 3,
    materia: ["História"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Ditadura Militar no Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Independência da América Latina"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O novo industrialismo substituiu as técnicas tradicionais de trabalho e os modos de vida dos camponeses, evidenciando o progresso das técnicas da manufatura fabril.",
      "Os trabalhadores ingleses já estavam agrupados em partidos políticos antes mesmo do surgimento da industrialização, demonstrando uma organização que seguia cada ofício de trabalho, como o alfaiate, o artesão e o tecelão.",
      "Os trabalhadores que viveram antes da era da industrialização tiveram sua memória utilizada como símbolo de resistência dos movimentos operários posteriores.",
      "A história que a classe operária inglesa contou sobre a industrialização não leva em consideração o crescimento econômico do período, nem o papel de liderança assumido pelos empresários industriais.",
      "As hostilidades dos trabalhadores ingleses às novas técnicas industriais informam o modo como os indivíduos foram afetados pelo surgimento da industrialização."
    ],
    correctAnswer: 4,
    materia: ["História"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Abolição da Escravatura"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Filosofia Moderna", "Revolução Científica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Grandezas Físicas e Unidades de Medida"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Instituições Políticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ele tenha se divertido com os comentários a respeito da presença dos imbecis na web.",
      "na web, as opiniões atingem audiências altíssimas por expressarem ideias absurdas.",
      "a opinião de um ganhador do prêmio Nobel e a de um imbecil têm o mesmo peso na web.",
      "as notícias sofrem distorções durante o processo de circulação entre as diferentes mídias.",
      "os navegadores da web não conferiram a informação sobre ele ter recebido ou não um prêmio Nobel."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "A oração \"foi publicado em alguns jornais\" (1ª linha) trata-se de uma oração sem sujeito.",
      "A expressão \"lectio magistralis\" (2ª linha) está destacada em itálico em virtude de seu emprego conotativo.",
      "A expressão \"no curso de\" (2ª linha) pode ser substituída pela preposição \"durante\", mantendo paralelismo semântico.",
      "O advérbio \"viralmente” (penúltima linha) é uma figura de linguagem empregada para estabelecer um paradoxo.",
      "A oração \"É falso” (2ª linha) deveria apresentar concordância nominal de gênero com o termo antecedente \"história dos imbecis\"."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Semântica", "Estilística"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "mas - Mas - porém.",
      "por isso – Então – porém.",
      "mas - Já – então.",
      "portanto - Mas – portanto.",
      "por isso – Já – então."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "tanto o Santo Graal quanto a vacina são buscados com afinco.",
      "a descoberta da vacina e do Santo Graal cabe a pessoas com aptidões especiais.",
      "o Santo Graal e a vacina têm o sangue como elemento em comum.",
      "tanto o Santo Graal como a imunização pelas vacinas são lendas.",
      "tanto a vacina quanto o Santo Graal apresentam-se em mais de uma forma."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      ...
      "\"A casa da família do famoso violeiro não ficava nas ruas fronteiras à gare da Central; mas, numa transversal, cuidada, limpa e calçada a paralelepipedos. Nos subúrbios, há disso: ao lado de uma rua, quase oculta em seu cerrado matagal, topa-se uma catita, de ar urbano inteiramente. Indaga-se por que tal via pública mereceu tantos cuidados da edilidade, e os historiógrafos locais explicam: é porque nela, há anos, morou o deputado tal ou o ministro sicrano ou o intendente fulano\".",
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Funções Inorgânicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Física Moderna", "Funções Exponenciais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "alto valor de densidade.",
      "baixo valor de energia de ionização.",
      "baixo valor de volume atômico.",
      "alto valor de eletronegatividade.",
      "alto valor de afinidade eletrônica."
    ],
    correctAnswer: 1,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "é um questionamento sobre o fundamento das coisas.",
      "enuncia a verdade sobre a origem das coisas.",
      "é uma proposição que se pode comprovar.",
...
createQuestion({
    ...
    options: [
      "Dado seu uso recente no Brasil, não há registro de acidentes com substâncias radiativas no país, seja no âmbito da produção de energia, seja no uso em equipamentos radiológicos.",
      "O domínio tecnológico para a geração de energia nuclear pode possibilitar a produção de armas nucleares, razão pela qual os Estados Unidos exercem uma forte pressão sobre o projeto nuclear do Irã.",
      "A construção de novas usinas nucleares no Brasil encontra-se restrita, dada sua dependência tecnológica em relação ao enriquecimento do urânio.",
      "A reduzida participação da energia nuclear na matriz energética japonesa é decorrente da preocupação quanto à capacidade de as usinas suportarem atividades sísmicas no país.",
      "O acidente de Tchernóbil influenciou a opinião pública acerca da aceitação da energia nuclear, repercutindo na queda de sua produção nos países industrializados."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Fontes de Energia", "Geopolítica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A degradação ambiental passou a se constituir como um problema para a humanidade a partir do lançamento das bombas atômicas de Hiroshima e Nagasaki, em agosto de 1945.",
      "A Terra reclama uma estratégia ambiental que atribua responsabilidades individuais, para cada nação, no sentido de desenvolver pesquisas e estudos acerca das implicações das atividades humanas sobre o sistema natural e vice-versa.",
      "As questões ambientais se circunscrevem aos países de alto grau de desenvolvimento econômico e elevado consumo, em que os problemas são mais graves e complexos.",
      "A resistência à manutenção do maior número de espécies para assegurar o futuro do ser humano se dá pelo fato de ela se constituir em proposição que contraria o desenvolvimento econômico.",
      "A problemática ambiental não se limita ao mundo físico, integrando, em escalas diversas, as questões socioespaciais."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "As adaptações e transformações do espaço geográfico são dependentes do planejamento urbano e regional e resultam numa organização espacial menos injusta, menos desigual, menos assimétrica.",
      "O processo de organização espacial resultou em dois brasis: um novo e moderno, constituído por Sul e Sudeste, e outro velho e arcaico, representado pelo Norte, Nordeste e Centro Oeste.",
      "A rede urbana da Amazônia obedece a uma orientação dada pela rede hidrográfica da região.",
      "A formação territorial brasileira obedeceu à sucessão de ciclos econômicos, iniciando pela exploração do pau-brasil e culminando na atividade industrial, promotora de desenvolvimento e equanimidade regionais.",
      "A divisão territorial do trabalho vigente no Brasil apresenta um centro dinâmico e industrializado – eixo Rio-São Paulo – e várias periferias especializadas no fornecimento de matérias-primas e mão de obra barata."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Geografia Urbana", "Geografia Econômica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Regiões de grande concentração populacional na Ásia, como o Sudeste asiático, apresentam maior estresse hídrico do que as áreas do continente de baixa densidade populacional.",
      "O Brasil possui, segundo a Agência Nacional de Águas, aproximadamente 12% da disponibilidade de água doce do planeta e, à exceção do semiárido nordestino, as demais áreas do país apresentam baixo risco de estresse hídrico.",
      "O estresse hídrico no continente africano é uma decorrência do excessivo uso de suas águas subterrâneas.",
      "No sul da Europa, onde predominam verões quentes e secos, o turismo representa uma pressão adicional sobre os sistemas de águas.",
      "Nos países andinos, a atividade industrial é responsável pela maior parte do consumo hídrico, superando o consumo agrícola e o residencial."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia Ambiental"],
...
createQuestion({
    ...
    conteudo: ["Teoria do Poder", "Teoria Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["História da Sociologia"],
    imageNames: []
}),
