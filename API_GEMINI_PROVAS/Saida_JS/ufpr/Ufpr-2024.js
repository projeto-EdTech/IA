...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Funções Quadráticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial", "Progressão Geométrica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Eletricidade", "Capacitores"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Grandezas Físicas", "Unidades de Medida"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Dinâmica", "Força Centrípeta"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Ondulatória", "Ondas Sonoras"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "A molécula possui carbonos com hibridização sp³, sp² e sp.",
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Estrutura e Ligação", "pH"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Ca₅(PO₄)₃OH(s) + PO₃F²⁻(aq) → Ca₅(PO₄)₃F(s) + HPO₄²⁻(aq)",
      "Ca₅(PO₄)₃⁺(aq) + 5 PO₃F²⁻(aq) → 5 Ca(PO₃F)(s) + 3 PO₄³⁻(aq)",
      "Ca₅(PO₄)₃⁺(aq) + PO₃F²⁻(aq) + H₂O(l) → Ca₅(PO₄)₃OH(s) + HPO₃F⁻(aq)",
      "Ca₅(PO₄)₃⁺(aq) + PO₃F²⁻(aq) + H₂O(l) → Ca₅(PO₄)₃(HPO₃F)(s) + OH⁻(aq)",
      "Ca₅(PO₄)₃OH(s) + PO₃F²⁻(aq) + H₂O(l) → Ca₅(PO₄)₃(HPO₃F)(s) + 2 OH⁻(aq)"
    ],
    correctAnswer: 0,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "Oᴬ e Oᴮ, com carga -1 cada.",
      "Oᴬ e Oᶜ, com carga -1 cada.",
      "Oᴬ e F, com carga -1 cada.",
      "Oᴮ e F, com carga -1 cada.",
      "Oᴮ e P, com carga -1 cada."
    ],
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Ligações Químicas", "Cargas Formais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Estequiometria", "Reações Químicas", "Metalurgia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "os elementos representativos não metálicos presentes resultam em acúmulo de material biodegradável.",
      "os metais nobres entre os metais de transição presentes possuem alto valor agregado.",
      "os elementos lantanídeos presentes representam dependência externa para produção.",
      "os elementos representativos presentes produzem óxidos alcalinos corrosivos.",
      "os semimetais presentes produzem compostos livres de toxicidade."
    ],
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Tabela Periódica", "Elementos Químicos", "Reciclagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Comparando um ecossistema marinho composto majoritariamente por algas com um ecossistema composto por uma floresta tropical, este último apresentará relativamente maior produtividade devido à maior biomassa presente nesse ecossistema.",
      "A energia disponível para os consumidores primários pode ser medida pela produtividade primária bruta (PPB) dos produtores, que se refere à taxa de absorção da energia luminosa captada pelos seres autotróficos em um certo tempo.",
      "Aumentar o consumo direto de vegetais irá reduzir a perda energética que ocorre na passagem para os níveis tróficos seguintes, otimizando os recursos investidos na produção vegetal, que é mais barata que a produção animal.",
      "Uma das formas pelas quais o aumento no consumo de produtos de origem vegetal poderia impactar positivamente o meio ambiente é diminuir o chamado sequestro de carbono, processo que consiste na liberação de carbono para a atmosfera.",
      "A pecuária, apesar de contribuir para a emissão de gases que causam o efeito estufa, possui alta produtividade, já que um herbívoro consegue aproveitar quase toda a energia contida nos vegetais, aumentando a quantidade de energia para o nível trófico seguinte."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "Absorção de CO₂ do ambiente → Liberação de O₂ → Síntese de glicose → Fixação do carbono.",
      "Absorção de O₂ → Liberação de CO₂ no ambiente → Fixação do carbono → Síntese de glicose.",
      "Absorção de CO₂ do ambiente → Fixação do carbono → Síntese de glicose → Liberação de O₂.",
      "Liberação de O₂ → Absorção de CO₂ do ambiente → Fixação do carbono → Síntese de glicose.",
      "Fixação do carbono → Absorção de CO₂ do ambiente → Síntese de glicose → Liberação de O₂."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Genética", "Hereditariedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "1) cloroplastos; 2) mitocôndrias; 3) hipótese endossimbiótica; 4) clorofila; 5) fotossíntese; 6) coenzima A; 7) ciclo de Krebs.",
      "1) cloroplastos; 2) mitocôndrias; 3) hipótese endossimbiótica; 4) coenzima A; 5) fotossíntese; 6) clorofila; 7) ciclo de Krebs.",
      "1) cloroplastos; 2) mitocôndrias; 3) hipótese endossimbiótica; 4) clorofila; 5) ciclo de Krebs; 6) coenzima A; 7) fotossíntese.",
      "1) hipótese endossimbiótica; 2) mitocôndrias; 3) cloroplastos; 4) coenzima A; 5) Ciclo de krebs; 6) clorofila; 7) fotossíntese.",
      "1) hipótese endossimbiótica; 2) mitocôndrias; 3) ciclo de Krebs; 4) fotossíntese; 5) clorofila; 6) coenzima A; 7) cloroplastos."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Biologia Celular", "Organelas", "Teoria Endossimbiótica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Em animais que possuem o sistema digestório com duas aberturas (boca e ânus), o processo de digestão é intracelular.",
      "Animais que ingerem grandes quantidades de material vegetal possuem o intestino subdividido em câmaras onde ocorre a fermentação do alimento.",
      "Grande parte da digestão das proteínas acontece na boca, enquanto os carboidratos são digeridos no estômago, onde também os lipídeos são totalmente digeridos.",
      "As aves desenvolveram um sistema digestório adaptado para alimentos não mastigados, como a presença de proventrículo e moela.",
      "Platelmintos parasitas, como as tênias, possuem sistema digestivo com boca e ânus e se alimentam das substâncias presentes no estômago do hospedeiro."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Animal", "Sistema Digestório"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Saúde", "Doenças Transmissíveis"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Introduzir mais espécies exóticas para aumentar a diversidade e competição no ecossistema é uma forma de erradicar espécies invasoras.",
      "Uma espécie nativa é aquela que se originou em um determinado ecossistema e coevoluiu com outras espécies presentes nesse ambiente ao longo do tempo.",
      "As espécies invasoras têm predadores naturais mais eficazes e geralmente são maiores e mais agressivas do que as espécies nativas.",
      "Espécies invasoras não competem por recursos com espécies nativas, pois estão adaptadas a diferentes habitats e condições climáticas.",
      "A introdução de espécies invasoras leva ao aumento da frequência das espécies nativas, devido ao aumento da biodiversidade dos ecossistemas."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Espécies Nativas e Invasoras"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Na difusão simples, ocorre o movimento de moléculas diretamente através da membrana, seguindo seus gradientes de concentração, sem o auxílio de proteínas transportadoras.",
      "A endocitose é um exemplo de transporte passivo no qual moléculas são internalizadas pela célula através de proteínas transportadoras.",
      "A osmose é uma forma de transporte ativo no qual a água se move de áreas de alta concentração de solutos para áreas de baixa concentração de solutos.",
      "A bomba de sódio-potássio é um exemplo de transporte passivo secundário no qual o sódio é transportado para dentro da célula e o potássio, para fora.",
      "A difusão facilitada é um tipo de transporte ativo que requer energia (ATP) para permitir que moléculas hidrofóbicas atravessem a membrana plasmática."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Biologia Celular", "Membrana Plasmática", "Transporte de Substâncias"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A economia contemporânea se baseia no setor de serviços financeiros, e as atividades predominantes em regiões subdesenvolvidas como o Nordeste são as agropecuárias.",
      "As políticas de desenvolvimento do Nordeste tiveram pouco efeito porque a Sudene não atacou o problema das secas, causa histórica do atraso relativo dessa região.",
      "As políticas de desenvolvimento da Sudene não reverteram o fluxo migratório de nordestinos para o Sudeste e o Sul, que continuou intenso nas décadas consideradas.",
      "O subdesenvolvimento da região Nordeste se deve à fragilidade do mercado regional, já que a economia se assenta nas exportações de açúcar e de algodão.",
      "O Nordeste apresenta o terceiro maior PIB regional do Brasil devido ao tamanho de sua população; em termos per capita, a renda dos nordestinos continua sendo a menor do país."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Geografia Regional", "Economia Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "No Norte, a maioria da população é parda, o que reflete o intenso processo de miscigenação com a população indígena original.",
      "No Sul, os pretos participam com cerca de um quinto da população total, enquanto a participação dos pardos é de aproximadamente dois quintos.",
      "O critério de autoclassificação foi adotado pelo IBGE a partir do Censo Demográfico de 1991, o que reflete a redemocratização ocorrida após o fim do regime de 1964.",
      "A população branca tornou-se predominante no Centro-Oeste devido ao avanço da fronteira agrícola, que atraiu produtores rurais gaúchos para aquela região.",
      "A população preta é predominante nas regiões rurais, motivo pelo qual cerca de metade da população nordestina é classificada como preta."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geografia da População", "Diversidade Étnico-Racial"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A expansão das monoculturas de soja, milho e trigo na Grande Região Centro-Oeste vem substituindo o bioma do Cerrado por um bioma antrópico.",
      "As regiões desérticas do planeta não constituem biomas devido à vegetação escassa e à baixa diversidade de vida animal ali encontrada.",
      "Florestas são formações vegetais em que predominam árvores; um exemplo de bioma florestal é a Floresta Pluvial Tropical, encontrada na Amazônia.",
      "No bioma Floresta Equatorial, o dossel de folhas das árvores bloqueia a luz solar, o que reduz a biodiversidade vegetal.",
      "Devido à umidade dos climas equatorial e tropical, os biomas do Centro-Oeste do Brasil são formados por florestas de árvores com folhagem perene."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Biogeografia", "Biomas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Nos países mais desenvolvidos, a agricultura moderna responde pela maior parte do consumo de água em virtude do uso intensivo da irrigação.",
      "Uma dificuldade para o enfrentamento do problema de escassez hídrica é o alto custo de extração de água dos aquíferos confinados.",
      "A elevação do consumo doméstico de água responde pelos problemas de estresse hídrico em países desenvolvidos e com boa disponibilidade natural desse recurso.",
      "Em regiões com disponibilidade natural de água, mas com estrutura de captação, tratamento e distribuição insuficientes, a escassez hídrica é um problema de ordem econômica.",
      "O Código Florestal restringe a ocupação humana nos topos de morro para evitar a extração de água nas áreas baixas, onde a água se acumula."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia Econômica", "Recursos Hídricos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A autonomia estadual é maior nos EUA do que no Brasil, como exemplifica o fato de haver leis estaduais diferentes para temas como aborto e pena de morte nos EUA.",
      "A instituição precoce do sistema federalista no Brasil evitou a eclosão de conflitos separatistas, tal como foi a Guerra de Secessão, nos EUA, apaziguada quando os estados norte-americanos ganharam autonomia.",
      "O federalismo é adequado para descentralizar o poder em países presidencialistas como o Brasil, pois o parlamentarismo já apresenta menor concentração de poder no Executivo.",
      "No Brasil e nos EUA, o Distrito Federal apresenta um status diferenciado por sediar a capital nacional, razão pela qual os governadores distritais são eleitos indiretamente.",
      "A Constituição de 1988 instituiu um nível hierárquico intermediário entre a União e os estados dentro do sistema federativo brasileiro, que é o das Grandes Regiões."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geografia Política", "Federalismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A predominância das atividades agroindustriais na economia do interior do Paraná levou a uma estrutura urbana concentrada, de modo que ainda não se formaram regiões metropolitanas fora do entorno da capital paranaense.",
      "Conurbação é a integração física de manchas urbanas, de modo que estradas ligando núcleos urbanos separados podem se converter em avenidas de uma mancha urbana que abrange os territórios de vários municípios.",
      "A Constituição de 1988 estabelece que a condição para instituir uma região metropolitana é a conurbação dos municípios que compõem uma aglomeração urbana.",
      "A urbanização se dá pela ocupação dos espaços rurais no entorno dos municípios, então as regiões metropolitanas são espaços onde se organizam atividades industriais e de serviços.",
      "Em países periféricos, a hierarquia urbana se organiza pela distribuição das atividades de serviços, de modo que o setor quaternário brasileiro se concentra nas metrópoles de São Paulo e Rio, e o terciário se concentra nas demais metrópoles."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "Com a globalização, as migrações com motivação econômica foram reduzidas, enquanto os conflitos étnicos ganharam predominância como causa.",
      "Os EUA deixaram de ser o país que mais recebe imigrantes no mundo durante o governo Donald Trump, quando foi construído o muro na fronteira mexicana.",
      "A presença dos imigrantes latinos se reflete na cultura dos EUA, manifesta na influência da língua espanhola e da culinária mexicana.",
      "A formação da União Europeia exigiu a instituição de uma política migratória comum para os países do bloco, que se abriram para as imigrações.",
      "O grau de diferenciação entre civilizações define os padrões migratórios, como se vê pela pouca participação de asiáticos na população estrangeira residente nos EUA."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geografia da População", "Migrações Internacionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A construção de grandes eixos rodoviários foi vital para racionalizar a ocupação da fronteira econômica, que até então se expandia pela ação de madeireiras ilegais.",
      "A industrialização foi impulsionada pela instalação de distritos industriais em Manaus e Belém com vistas a atender aos mercados urbanos da região.",
      "Os objetivos geopolíticos eram combater a biopirataria e proteger a biodiversidade amazônica para possibilitar o desenvolvimento da indústria nacional de fármacos.",
      "A ocupação da Amazônia era prioridade porque os acordos internacionais sobre mudanças climáticas geraram pressões pela internacionalização da região.",
      "A construção da rodovia Transamazônica e a implantação de \"agrovilas\" visavam atrair imigrantes da zona rural do Nordeste para aliviar as tensões sociais no campo."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["História do Brasil", "Período Militar", "Ocupação da Amazônia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "O fim do comunismo substituiu o mundo bipolar do pós-guerra pela hegemonia dos EUA, o que vem provocando conflitos geopolíticos que são resolvidos por intervenções militares norte-americanas, caso do Afeganistão."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História Contemporânea", "Conflitos Regionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "caracterizada pela popularização e uso corrente da língua grega em diversas partes da Ásia e da África.",
      "definida pela adoção da democracia ateniense por Alexandre, o Grande, após suas vitórias na África e na Ásia.",
      "baseada na conquista da Macedônia pelo Egito e o consequente espalhamento da cultura alexandrina.",
      "marcada pelos contatos entre Oriente e Ocidente a partir da expansão romana no norte da África e na Ásia.",
      "conhecida também como Idade das Trevas por conta da escassez de textos escritos no Ocidente."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História Antiga", "Período Helenístico"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O fortalecimento do feudalismo entre as cidades italianas a partir do século XIII acarretou o aumento populacional e facilitou o surgimento de guildas comerciais.",
      "A inquisição católica e o movimento de caça às bruxas no norte da Europa ocasionaram uma grande imigração de mercadores e artistas para cidades como Gênova e Veneza.",
      "Após o fim da Grande Peste, a reorganização europeia sob o Império Carolíngio permitiu a maior integração das cidades italianas, que passaram a suprir o crescente mercado mediterrânico.",
      "O crescimento urbano e a abertura de novas rotas de viagem, no contexto do chamado Renascimento Comercial, garantiram o poder financeiro de cidades como Gênova e Veneza.",
      "O movimento conhecido como Iluminismo, que surgiu entre mercadores, artistas e pensadores, gerou a pujança econômica das cidades italianas, marcando assim o fim da Idade Média."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História Medieval", "Renascimento Comercial e Urbano"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "leis de discriminação racial e colonialismo na Ásia e África.",
      "Guerra de Secessão e Guerra contra a independência da Argélia.",
      "Macarthismo e ditadura de extrema-direita.",
      "Emenda Platt e República de Vichy.",
      "Grande Depressão e Comuna de Paris."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História Contemporânea", "Direitos Humanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a pacífica rendição dos astecas e a superioridade tecnológica dos espanhóis.",
      "a disseminação de doenças pelos espanhóis e a rivalidade entre astecas e outras sociedades nativas.",
      "a tolerância religiosa dos espanhóis e o auxílio econômico português.",
      "a queda populacional por conta de sacrifícios astecas e a catequização pelos frades beneditinos.",
      "a divinização dos espanhóis pelos astecas e o auxílio militar dos incas."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História da América", "Conquista da América"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Essas iniciativas decorreram do despotismo oriental, que aumentou o poder da Companhia de Jesus e construiu grandes edificações coloniais.",
      "Essas iniciativas decorreram do absolutismo da União Ibérica, que incentivou a ocupação espanhola e o governo dos chapetones.",
      "Essas iniciativas decorreram do despotismo esclarecido, que reforçou a centralização política da metrópole e a exploração colonial.",
      "Essas iniciativas decorreram do salazarismo, que fortaleceu os capitães donatários e liberou a criação de manufaturas coloniais.",
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História do Brasil Colonial", "Iluminismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As reminiscências culturais africanas podem ser vistas em festas e religiões no Brasil, mas não influenciaram outros hábitos da sociedade colonial, como idioma ou culinária.",
      "No período colonial, as irmandades religiosas leigas surgiram com o intuito de barrar a realização de festividades, especialmente aquelas que demonstrassem traços africanos.",
      "Festas brasileiras populares, como a Congada, revelam a capacidade de resistência e adaptação das tradições africanas vindas com o tráfico forçado.",
      "A classe senhorial, aliada com a Igreja Católica, buscou o apagamento integral de culturas africanas em um processo conhecido como sincretismo.",
      "A proibição de festas de origem bantu na Bahia acarretou a eclosão de revoltas de pessoas escravizadas, das quais se destaca a Revolta dos Malês."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História do Brasil Colonial", "Cultura Africana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["História do Brasil Imperial", "Crise da Monarquia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ampliou a política de assimilação dos indígenas à sociedade brasileira.",
      "reconheceu a diversidade de organização social e cultural e os direitos sobre as terras ocupadas.",
      "manteve a noção de relativa incapacidade dos indígenas contida no Estatuto dos Índios de 1973.",
      "instituiu a política integracionista reivindicada pelos povos indígenas desde 1934.",
      "estabeleceu a prática de aldeamento dos indígenas e de tutela por organismos religiosos."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História do Brasil", "Era Vargas", "Políticas Indigenistas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A brutalidade do golpe militar no Chile criou aguerridos movimentos de resistência que reverberaram por toda a América Latina, inspirando a ditadura brasileira a decretar o Ato Institucional n.º 5.",
      "O golpe militar contra Salvador Allende foi motivado tanto pelo anticomunismo vigente no período quanto pelas intenções do líder chileno de instaurar uma economia neoliberal.",
      "O autoritarismo nacionalista da ditadura chilena colocou o país em conflito direto com o Reino Unido, tendo como consequência a Guerra das Malvinas.",
      "Os altos níveis de perseguição e violência da ditadura de Augusto Pinochet causaram o distanciamento de outros governos autoritários da região.",
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["História Contemporânea", "Ditaduras Militares na América Latina", "Operação Condor"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As expressões de cada par em \"que ou quem\" e \"nada ou a ninguém\" referem-se, respectivamente, a coisas e a pessoas.",
      "As expressões \"o pelé do basquete\" e \"a pelé do tênis\" reportam à atuação de Pelé em outros esportes além do futebol.",
      "Na exemplificação apresentada no verbete, a expressão \"assim como Pelé\" estabelece relação de gradação.",
      "Os adjetivos \"excepcional, incomparável e único\" qualificam o nome Pelé sob a forma de metáfora.",
      "A palavra pelé, na acepção formulada pelo dicionário, distingue nomeação de caracterização."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Semântica", "Polissemia", "Intertextualidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Um retrato de Jesus Cristo foi arrematado na quarta-feira (15), em Nova York (...) não se pode confirmar que é realmente um Da Vinci, apesar de um grupo de especialistas ter cravado que é.",
      "Ayrton Senna não era uma pessoa comum. Na verdade, ele era um homem muito maior fora do que dentro do carro.",
      "O apelido que marcou Diego Maradona foi o de \"Dios\" (Deus). Isso não significa que ele fosse visto como uma figura perfeita, pelo contrário.",
      "Rita Lee sempre foi uma Ovelha Negra na indústria da música brasileira.",
      "Comprei prá minha mulher um freezer. (...). Ela falou: (..) não é assim nenhuma Brastemp, mas você também não é assim nenhum Alain Delon!"
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Semântica", "Significado de Palavras"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Na expressão \"negros africanos\" temos um caso de tautologia.",
      "O vocábulo \"coisa\", no segmento \"uma coisa inteiramente nova\", tem a ver com a natureza incorpórea da língua.",
      "A figura do caldeirão justifica-se, no texto, pela capacidade de transformação da língua.",
      "No segmento \"à medida que os ciclos econômicos se sucediam\", o vocábulo \"sucediam\" pode ser substituído, sem prejuízo do sentido básico do texto, por \"obtinham sucesso\".",
      "No segmento \"as línguas gerais ocupavam um espaço definitivo e se difundiam\", o vocábulo \"difundiam\" pode ser substituído, sem prejuízo do sentido básico do texto, por \"misturavam\"."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Recursos Expressivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Hipótese, suposição, comparação.",
      "Condição, inferência, suposição.",
      "Causa, consequência, conclusão.",
      "Causa, oposição, analogia.",
      "Hipótese, consequência, conformidade."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Sintaxe", "Relações Lógico-Sintáticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Tese Central"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Posicionamento do Autor"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variedade Linguística", "Expressões Idiomáticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura", "Romantismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura", "Literatura Contemporânea"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura", "Poesia Contemporânea"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura", "Romance Contemporâneo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Teoria Sociológica", "Max Weber", "Metodologia Científica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Sociologia da Mulher", "Gênero e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Racismo", "Cultura e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Racismo", "Democracia Racial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Moderna", "Karl Marx", "Friedrich Engels", "Ludwig Feuerbach"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Moderna", "René Descartes", "Racionalismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Política", "Justiça Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Moderna", "Voltaire", "Tolerância"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "expõe como arte fotos que não são arte, já que desumanas, sendo a arte um patrimônio da humanidade.",
      "convida o espectador a fazer um julgamento estético, levando-o a contemplar as fotos tendo a arte como referência.",
      "faz justiça ao desejo do fotógrafo em ser reconhecido como artista, a despeito das condições em que exerceu sua arte.",
      "justifica atos imorais em nome da arte.",
      "revela que a decisão acerca do status de arte da fotografia compete exclusivamente aos curadores das exposições fotográficas."
    ],
    correctAnswer: 4,
    materia: ["Filosofia"],
    conteudo: ["Estética", "Arte e Ética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Sociologia da Ciência", "Ceticismo", "Negacionismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "recording Teixeira's video material.",
      "searching for online news on Teixeira.",
      "helping the FBI agents.",
      "hiding inside a helicopter.",
      "running to the back porch of Teixeira's house."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "took issue with a group called Thug Shaker Central.",
      "was part of a spy operation.",
      "was an unauthorized member in the Massachusetts Air National Guard.",
      "reported illegal activities within the government to someone in authority.",
      "put in danger some government papers."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "to be found – have never been identified – are.",
      "are found – will never be identified – might be.",
      "to find – will be identified – are.",
      "found – have never been identified – may be.",
      "find – have been identified – might be."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Gramática", "Vocabulário", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "was found after a long-year search.",
      "is waiting for her mother to pick her up at school.",
      "is a missing American Black girl.",
...
createQuestion({
    ...
    options: [
      "has been refurbished 25 years ago by Frank Gehry.",
      "is a place visitors are interested in exploring both its inside and outside.",
      "is a building that has a structure made almost entirely of cross-laminated timber.",
      "has an architecture similar to the Royal Palace in Madrid.",
      "has straight lines in its building."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "Only affirmative 3 is correct.",
      "Only affirmatives 1 and 2 are correct.",
      "Only affirmatives 3 and 4 are correct.",
      "Only affirmatives 1, 2 and 4 are correct.",
