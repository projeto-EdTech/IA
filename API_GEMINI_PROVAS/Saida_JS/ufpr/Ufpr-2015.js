createQuestion({
    ...
    options: [
      "425m e a escala utilizada é de 1:1000.",
      "705m e a escala utilizada é de 1:5000.",
      "810m e a escala utilizada é de 1:2500.",
      "810m e a escala utilizada é de 1:5000.",
      "1410m e a escala utilizada é de 1:10000."
    ],
    correctAnswer: 1,
    materia: ["Geografia", "Matemática"],
    conteudo: ["Cartografia", "Proporcionalidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A disponibilidade espacial dos recursos hídricos pode variar em função da sazonalidade, haja vista a diferença da precipitação, segundo os meses do ano e as regiões brasileiras.",
      "A região hidrográfica do rio São Francisco tem como característica os menores índices de precipitação do Brasil, enquanto na região hidrográfica da Amazônia são observados os maiores índices de precipitação.",
      "Uma das características do sistema de abastecimento de água para consumo humano no Brasil é a preponderância do uso dos mananciais superficiais.",
      "Há uma forte relação entre cobertura vegetal e água, pois o desmatamento pode provocar aumento do escoamento superficial e redução da infiltração, o que pode alterar o ciclo hidrológico.",
      "Os problemas de abastecimento de água observados no Brasil são consequências de alterações da sazonalidade das chuvas causadas pelas mudanças climáticas globais, e do aumento da demanda."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Coordenadas Geográficas", "Cartografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O aumento populacional brasileiro é decorrente, sobretudo, do crescimento vegetativo da população, que incorpora os conceitos de natalidade e mortalidade.",
      "O crescimento populacional evidenciado indica uma tendência de aumento nas taxas de natalidade e fecundidade e uma diminuição da taxa de mortalidade, associada ao envelhecimento da população.",
      "Esse acréscimo populacional tem como consequência a diminuição da renda per capita e o comprometimento dos recursos naturais, como evidenciado por Malthus, pois há um crescimento geométrico da população e aritmético dos alimentos.",
      "O aumento da população é impulsionado pelo crescimento das periferias das grandes cidades, decorrente dos processos migratórios, que fazem com que diminua o número de habitantes em cidades pequenas.",
      "O fator que explica o aumento populacional é a imigração, pois o Brasil tem recebido grande contingente populacional de outros países."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Demografia"],
...
createQuestion({
    ...
    conteudo: ["Geografia Agrária", "Relações de Trabalho"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Na década de 70, a política de substituição de importações de petróleo levou à modernização tecnológica do setor petrolífero e ao consequente salto de produtividade expresso nos dados da tabela.",
      "Na década de 80, o retrocesso da indústria foi resultado da opção do governo de privilegiar as exportações de produtos agrícolas com o fim de obter divisas para o pagamento da dívida externa.",
      "Na década de 90, a produtividade cresceu mais rapidamente em função dos estímulos criados pelo controle da inflação, pela abertura da economia e também pela atração de investimento direto estrangeiro.",
      "A desconcentração espacial da indústria tem como contrapartida a redução do ritmo de inovação tecnológica, razão pela qual a produtividade só cresceu com força nas décadas de 70 e 90, quando aumentou o nível de concentração industrial em São Paulo.",
      "Na primeira década do séc. XXI, o fraco crescimento da produtividade resultou da privatização de empresas do setor produtivo estatal, medida que implicou a desativação dos centros de pesquisa científica dessas empresas."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geografia Industrial", "Economia Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Durante o século XX, o Estado nacional foi responsável por grandes projetos para ampliação das fronteiras internas de ocupação, como é o caso da marcha para o oeste.",
      ...
      "Processos de ocupação do território, a exemplo do avanço da soja no centro-oeste brasileiro e de atividades agropecuárias na Amazônia demonstram um avanço contínuo sobre os espaços naturais.",
      "Do ponto de vista econômico há um desequilíbrio na produção de bens e serviços entre as regiões brasileiras, fato que tem levado à criação de políticas de desenvolvimento regional, como foi o caso da zona franca de Manaus.",
      "Considerando a extensão e a direção da ocupação do território brasileiro – do litoral rumo ao interior – há uma vasta porção por ser apropriada pelo Estado Nacional: a Amazônia."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Formação Territorial do Brasil", "Amazônia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "evaporar, menor, temperatura, adiabática, perde.",
      "condensar, menor, volume, adiabática, ganha.",
      "evaporar, maior, temperatura, isotérmica, ganha.",
      "condensar, maior, volume, isobárica, perde.",
      "sublimar, menor, temperatura, isotérmica, ganha."
    ],
    correctAnswer: 0,
    materia: ["Física"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Ondas", "Acústica", "Efeito Doppler"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Lei de Faraday", "Lei de Lenz"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica", "Geradores Elétricos", "Potência Elétrica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Óptica", "Reflexão e Refração"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação Textual", "Argumentação"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Ah, bons tempos em que o colégio eleitoral era minimalista: tinha um só eleitor.",
      "O Tiririca, não sei, mas o Romário não deu um bom deputado?",
      "É a democracia em ação, com seus grotescos e tudo. Saboreie, saboreie.",
      "A única alternativa para a velhice é a morte. Já as alternativas para a democracia são várias, uma pior do que a outra.",
      "Diante disso, em vez de \"que chateação\", pense \"que maravilha!\"."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "O processo, incrivelmente, se autodepura, sobrevive aos seus absurdos e dá certo. (se purifica)",
      "Era um processo rápido e ascético que não sujava as ruas. (certeiro)",
      "Mesmo o que impacienta é aproveitável... (irrita)",
      "A escolha do poder nas monarquias absolutas também é simples e sumária. (rápida)",
      "a atividade política termine parecendo apenas uma pantomima. (um logro)"
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Textuais", "Ironia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação Textual", "Gêneros Textuais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Ela arranjou um namorado gato.",
      "Tenho um colega mala.",
      "Ela sempre tem uma palavra amiga.",
      "Precisa ser muito homem para comprar essa briga.",
      "Ele tem um ar paternal."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "\"Priorizar\" e \"disponibilizar\" são formas antigas, do tempo de Camões.",
      "As formas analíticas são mais interessantes.",
      "\"Priorizar\" é uma forma sintética que veio substituir a forma analítica \"dar prioridade\".",
      "Palavras com mais de 20 anos já são consideradas arcaicas.",
      "O desaparecimento de \"priorizar\" e \"disponibilizar\" é iminente."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Morfossintaxe", "Linguística"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação Textual", "Linguística"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Carlos Drummond de Andrade", "Poesia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O emprego da língua portuguesa em seu padrão culto nas falas dos operários atende a uma exigência própria da literatura e do teatro produzidos em meados do século XX.",
      "Prevalece na peça uma visão conciliatória já que, influenciados por Tião, no terceiro ato os moradores do morro abandonam suas principais reivindicações.",
      "O conflito que está no centro da ação dramática é motivado pelas diferentes opções que as personagens assumem perante uma greve.",
      "As personagens femininas não participam das decisões familiares nem têm opinião política, comportamento típico do patriarcalismo vigente naquele período histórico.",
      "O sucesso do samba “Nós não usa black-tie\" resultou em uma surpreendente ascensão socioeconômica para seu compositor, Juvêncio."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Literatura Brasileira", "Luta de Classes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Raduan Nassar"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Química Ambiental", "Equilíbrio Químico", "Ácidos e Bases"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Cinética Química", "Eletroquímica"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Bioquímica", "Enzimologia", "Bioquímica"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Bioquímica", "Química Orgânica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Termodinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Escravidão", "Roma Antiga", "Brasil Colonial"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "No período moderno, o protecionismo era parte integrante do renascimento comercial, caracterizado por intervencionismo estatal, balança comercial favorável e imperialismo; no período atual, o protecionismo é alvo de contestações em nome da liberdade de mercado, num contexto de capitalismo financeiro neoliberal.",
      "No período moderno, o protecionismo era parte integrante do iluminismo, caracterizado por políticas fisiocráticas, subsídios estatais à agricultura e à manufatura, pacto colonial e metalismo; no período atual, o protecionismo é alvo de ações antidumping por parte de países em desenvolvimento, num contexto de capitalismo financeiro globalizado.",
      "No período moderno, o protecionismo era parte integrante do mercantilismo, caracterizado por intervencionismo estatal, metalismo, balança comercial favorável e colonialismo; no período atual, o protecionismo é alvo de contestações em nome da liberdade de mercado, num contexto de capitalismo financeiro globalizado.",
      "No período moderno, o protecionismo era parte integrante do mercantilismo, caracterizado por imperialismo, padrão-ouro e intervencionismo estatal; no período atual, o protecionismo é alvo de contestações de países desenvolvidos em nome da liberdade de mercado, num contexto de capitalismo financeiro monopolista.",
      "No período moderno, o protecionismo era parte integrante do liberalismo, caracterizado por fisiocracia, metalismo, incentivo à maquinofatura e pacto colonial; no período atual, o protecionismo é alvo de ações antitruste em nome da liberdade de mercado, num contexto de capitalismo financeiro globalizado."
    ],
    correctAnswer: 2,
    materia: ["História", "Geografia"],
    conteudo: ["Idade Moderna", "História Contemporânea", "Economia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Brasil Colonial", "Missões Jesuíticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["História do Brasil", "Cultura e Política"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História", "Sociologia"],
    conteudo: ["História Contemporânea", "Estado e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["Ditadura Militar no Brasil", "Guerra Fria", "Movimentos Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A palavra é \"Paz”, pois reivindicava que a Rússia conduzisse o Tratado de Versalhes, e retirasse vantagens dos países perdedores.",
      "A palavra é \"Terra”, pois reivindicava que a Rússia fizesse reforma agrária nas terras conquistadas durante o conflito.",
      "A palavra é \"Terra”, pois reivindicava que a Rússia anexasse territórios para a constituição da União das Repúblicas Socialistas Soviéticas.",
      "A palavra é \"Paz”, pois reivindicava que a Rússia se retirasse imediatamente da guerra, para livrar sua população do sofrimento e iniciar uma nova ordem socialista.",
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Revolução Russa", "Primeira Guerra Mundial"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A pólis desenvolveu-se como uma cidade fortificada, caracterizando a ocupação da Magna Grécia por Esparta. A expansão grega ocorre devido à insuficiência de escravos nas cidades-Estado. Nas guerras realizadas no Mediterrâneo, milhares de prisioneiros foram feitos escravos e vendidos nas colônias gregas, o que intensificou a circulação de moedas.",
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Grécia Antiga", "Economia Antiga"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Mínimo Múltiplo Comum", "Raciocínio Lógico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Funções do 1º Grau", "Álgebra"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial", "Área de Superfícies"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Trigonometria", "Funções Trigonométricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Funções", "Geometria Analítica", "Otimização"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "pO₂ Veia pulmonar < pO₂ Ventrículo direito.",
      "pO₂ Átrio esquerdo > pO₂ Veia cava.",
      "pO₂ Átrio esquerdo < pO₂ Ventrículo direito.",
      "pO₂ Artéria pulmonar > pO₂ Veia pulmonar.",
      "pO₂ Artéria pulmonar > pO₂ Veia cava."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Bioquímica", "Enzimologia", "Fisiologia Animal"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Biologia Celular", "Biologia Molecular"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "na dispersão das sementes e na polinização.",
      "na dispersão das sementes e no controle de pragas.",
      "na polinização e na dispersão das sementes.",
      "no controle de pragas e na dispersão das sementes.",
      "no controle de pragas e na polinização."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Botânica", "Interações Ecológicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Parasitologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "to complain about the result of a test.",
      "to complain about writing a text on teaching.",
      "to question why someone has to learn how to write.",
      "to question how someone can be creative and meet the requirements of a writing task.",
      "to question why someone has to be standing at the back of another person, by his or her neck."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Interpretação Textual"],
...
createQuestion({
    ...
    options: [
      "Because Calvin is doing his final exams.",
      "Because Calvin cannot be creative while writing.",
      "Because Calvin feels he will fail his writing course.",
      "Because Hobbes does not know how much effort the process of writing requires.",
      "Because Calvin was sent to the psychologist at school every time he had fun with writing."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Interpretação Textual"],
...
createQuestion({
    ...
    options: [
      "the question presented in the title.",
      "the string of blood type diet books.",
      "the blood-type-tailored diet proposed by D'Adamo.",
      "the question whether blood type diets actually work.",
      "the experiment which was run to answer the diet question."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Interpretação Textual"],
...
createQuestion({
    ...
    options: [
      "There are many books published about the blood type diet.",
      "D'Adamo's claims about following a blood type diet are based on his personal experience with it.",
      "A Belgium study made use of 1,000 volunteers to check on the blood type diet",
      "According to D'Adamo, the blood type diets are being used on women with cancer.",
      "The book Eat Right 4 Your Type written about the blood type diet sold millions of copies worldwide."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Interpretação Textual"],
...
createQuestion({
    ...
    options: [
      "The different blood types are the result of the migration movements human beings performed.",
      "The author of Eat Right 4 Your Type has a website where he publishes the results of his researches.",
      "The antigens present in our blood type account for the disease we may develop if we do not eat fresh food.",
      "Researchers from Belgium recommend the blood type diet as a way to reduce infections and slow the ageing process.",
      "Based on the origin of different blood types, Peter D'Adamo claims we should eat accordingly or else become ill."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Interpretação Textual"],
...
createQuestion({
    ...
    options: [
      "claiming that what he does is science.",
      "admitting that his experiment was based on the Theory of Relativity.",
      "rebuting the criticism towards his website.",
      "presenting an example which confirms his researches.",
      "stating that his study is based on mathematical calculations."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Interpretação Textual"],
...
createQuestion({
    ...
    options: [
      "He is a Belgium scientist specialized in the area of nutrition.",
      "He receives the support of other doctors to carry out his researches.",
      "He claims that Albert Einstein also followed the blood type diet to stay healthy.",
      "He wrote a book, has a website and sells diet supplements based on his blood type diet.",
