...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira (Aluísio Azevedo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História do Brasil (Plano Collor)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "micênicos tivessem poder político e ameaçassem a aristocracia.",
      "estrangeiros mobilizassem poder político e ameaçassem a oligarquia.",
      "cidadãos concentrassem poder político e ameaçassem a democracia.",
      "espartanos arregimentassem o poder político e ameaçassem a república.",
      "cretenses conseguissem poder político e ameaçassem a tirania."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Grécia Antiga (Ostracismo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Ambos os movimentos defendiam a abolição da escravidão, mas na Inconfidência Mineira houve proposta de indenização aos proprietários de escravizados e na Conjuração Baiana houve proposta de indenização aos escravizados.",
      "Ambos os movimentos desejavam a mudança do sistema político no Brasil, mas na Inconfidência Mineira houve a defesa de um regime democrático e na Conjuração Baiana houve a defesa de monarquia constitucional.",
      "Ambos os movimentos desejavam implantar a industrialização no Brasil, mas na Inconfidência Mineira houve apoio de empresários ingleses e na Conjuração Baiana houve apoio do Marquês de Pombal.",
      "Ambos os movimentos pretendiam unir-se a outras rebeliões nas colônias ibéricas na América, mas na Inconfidência Mineira houve apoio de Simón Bolívar e na Conjuração Baiana houve apoio dos haitianos.",
      "Ambos os movimentos pregavam a independência regional em relação a Portugal, mas na Inconfidência Mineira houve maior participação da elite e na Conjuração Baiana houve maior participação popular."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Brasil Colônia (Inconfidência Mineira e Conjuração Baiana)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Historiografia e Memória"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História dos Estados Unidos (Guerra Civil Americana)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "declínio do Estado de Bem-Estar Social após a Segunda Guerra Mundial e de ascensão de políticas neoliberais que diminuíram investimentos em educação, saúde e seguridade social.",
      "crise econômica causada pela saída da Inglaterra do tratado de Maastricht e de aumento de impostos para as populações mais pobres penalizadas pelo desemprego.",
      "endurecimento do imperialismo inglês sobre suas colônias asiáticas e africanas e de aumento da violência urbana, com atentados terroristas praticados por imigrantes desses territórios dominados.",
      "fracasso das políticas monetaristas implantadas após a Primeira Guerra Mundial e de adoção de reformas protecionistas malsucedidas que penalizaram os pequenos negócios ingleses.",
      "enfraquecimento do Estado de Lei e Ordem e de rejeição de iniciativas de globalização econômica, que causaram a emigração de jovens pobres ingleses em busca de oportunidades de trabalho."
    ],
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["História Contemporânea (Cultura e Sociedade no Pós-Guerra)", "Sociedade e Cultura"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "as espécies continuem vivendo nos seus ecossistemas e permaneçam como estoque genético potencial.",
      "as áreas de reflorestamento com espécies nativas sejam ampliadas e ecologicamente manejadas.",
      "ocorra um aperfeiçoamento contínuo da legislação ambiental, adaptando-a à realidade presente.",
      "proposições mais avançadas de educação ambiental sejam estendidas para as comunidades tradicionais.",
      "novas soluções tecnológicas sejam aplicadas nas áreas de preservação ambiental, para mitigar a dependência de processos ecológicos."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Meio Ambiente (Biodiversidade e Conservação)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O futebol é uma inovação peculiar que desfruta de igual grau de prestígio nos países que o recepcionaram, além de ocupar a posição de esporte mais disseminado e praticado no mundo, desde a sua difusão pelos ingleses há mais de 130 anos.",
      "A expansão e a consolidação de doenças como a dengue não são impedidas pelas condições climáticas (combinação da altitude com temperaturas baixas), mas sim pela baixa densidade demográfica e falta de integração rodoviária da região.",
      "Ao se mudarem para o meio urbano, os migrantes de áreas rurais levam consigo seu modo de vida e seus costumes culturais, que são difundidos e compartilhados por um número crescente de pessoas no local de destino, assegurando a reprodução de culturas tradicionais.",
      "A propagação do islamismo é um exemplo de caso influenciado pela hierarquia dos lugares, isto é, espalhou-se primeiro para as grandes cidades, depois para locais de tamanho intermediário e finalmente para as pequenas cidades e áreas rurais.",
      "A disseminação de novas maneiras de vestir e de novos modismos musicais guarda uma relação com o modo como as pessoas se comportam com relação à localização relativa do lugar que habitam."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Geografia Humana (Difusão Espacial)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a compactação causada pelo pisoteio do gado bovino.",
      "o emprego de fertilizantes à base de nitrogênio.",
      "a irrigação das lavouras em áreas semiáridas.",
      "o desmatamento das matas ciliares.",
      "as queimadas para a renovação das pastagens."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Solos (Salinização)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "uniformemente espaçadas representam inclinações comparativamente estáveis ou constantes.",
      "estreitamente espaçadas representam encostas suavemente inclinadas.",
      "amplamente espaçadas representam encostas íngremes.",
      "somente formam círculos abertos quando representam formas de relevo plano.",
      "comumente se dividem, se cruzam ou se interceptam."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Cartografia (Isolinhas e Curvas de Nível)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia Econômica (Relações Internacionais, Agronegócio Brasil-China)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Climatologia (Ilhas de Calor Urbanas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Genética (Herança Mendeliana e Biologia Molecular)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Os cactos possuem epiderme fina e flexível para reduzir a perda de água e folhas grandes e largas que podem absorver muita água.",
      "Os anfíbios apresentam adaptações para a vida em terra, como a respiração traqueal nos adultos e os ovos com anexos embrionários.",
      "As principais adaptações das plantas nativas do cerrado são raízes respiratórias, também conhecidas como pneumatóforos, para absorção e fixação de oxigênio.",
      "Os mamíferos voadores são animais homeotermos e possuem sacos aéreos para facilitar o voo.",
      "Nos répteis, o ovo com casca e anexos embrionários permite o desenvolvimento em terra e diminui a mortalidade dos embriões."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Ecologia (Adaptações dos Seres Vivos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As formigas são predadoras das abelhas sem ferrão, das moscas-brancas e das folhas de mandioca.",
      "Abelhas sem ferrão têm relação de comensalismo com as moscas-brancas e de competição com as formigas.",
      "Abelhas sem ferrão e formigas têm relação de competição entre si e de mutualismo com as moscas-brancas.",
      "Abelhas sem ferrão e formigas são predadores das moscas-brancas e das folhas de mandioca.",
      "Formigas têm relação de comensalismo com as moscas-brancas e de predação com as abelhas sem ferrão."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "Raízes de leguminosas como feijão, soja e ervilha possuem a capacidade de associação com bactérias fixadoras de nitrogênio.",
      "O aquecimento global é decorrente da redução da taxa de oxigênio da atmosfera e do aumento das emanações de dióxido de enxofre.",
      "As cianobactérias são capazes de degradar matéria inorgânica e disponibilizar o fósforo para outros seres vivos.",
      "A principal forma de incorporar nitrogênio atmosférico (N2) em moléculas orgânicas é por meio da absorção foliar durante a fotossíntese.",
      "A preservação de florestas contribui para a diminuição do efeito estufa, pois garante a captura de CO2 atmosférico por meio da respiração das plantas."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      ...
      "Quando aplicado no corpo de um indivíduo, o vírus inativado é capaz de se replicar, porém de maneira lenta, sem causar maiores danos ao organismo.",
      "Na vacina, o vírus atenuado é um anticorpo que não causa doença, mas provoca uma resposta imunológica que pode bloquear ou matar o vírus se uma pessoa for infectada.",
      "Na vacina, o vírus inativado é um anticorpo que provoca uma resposta imunológica que pode matar o vírus se uma pessoa for infectada.",
      "O vírus atenuado presente na vacina não é capaz de se replicar, sendo constituído apenas pela informação genética que codifica proteínas que representam antígenos relevantes para a proteção do organismo."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "irradiação adaptativa, pois as 15 espécies atuais foram criadas por mutações que surgiram para garantir sua sobrevivência em diferentes ambientes.",
      "convergência evolutiva, pois as 15 espécies diferentes vivem em ambientes semelhantes e desenvolveram as mesmas adaptações como resultado da seleção natural.",
      "irradiação adaptativa, pois um grande aumento da taxa de mutações na espécie ancestral originou as 15 espécies atuais.",
      "convergência evolutiva, pois as 15 espécies atuais são descendentes de um ancestral comum e ocupam diferentes ambientes ou nichos.",
      "irradiação adaptativa, pois as novas espécies, que ocupam diferentes ambientes ou nichos, foram originadas a partir de um ancestral comum."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Evolução (Irradiação Adaptativa)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Unidades de Medida (Sistema Internacional)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Estática e Fluidos (Pressão)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Cinemática e Conservação de Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Ondas (Período, Velocidade, Comprimento de Onda)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Antiga (Platão e a Arte)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Pré-Socrática (Heráclito)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Política (Hannah Arendt)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Área de Setor e Triângulo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Distância)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Nomenclatura (Compostos Inorgânicos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Estequiometria (Relações Gasosas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Orgânica (Polímeros, Biomoléculas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Química Orgânica (Propriedades de Compostos Orgânicos, Hibridação)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Química Orgânica (Nomenclatura IUPAC)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Orgânica (Estereoquímica, Isomeria Óptica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Cultura e Sociedade (Roque de Barros Laraia)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "um comportamento cortês e civilizado.",
      "um símbolo da cultura brasileira que deveria ser valorizado.",
      "o enaltecimento do caráter igualitário e impessoal das leis.",
      "o personalismo e a aversão ao formalismo da burocracia.",
      "um dos efeitos da urbanização e da industrialização do Brasil."
    ],
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Sociologia Brasileira (Sérgio Buarque de Holanda)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A sociologia emprega o termo \"raça” no estudo do racismo para designar o modo como variações físicas entre os membros de uma comunidade são socialmente percebidas.",
      "O conceito de \"etnicidade\" designa um conjunto de atributos físicos e biológicos de grupos minoritários da população, contribuindo para a compreensão das formas de discriminação.",
      "O racismo se refere a um conjunto de convicções de alguns indivíduos em razão de traços psicológicos singulares atribuídos a outros indivíduos, desvinculando-se da estrutura da sociedade.",
      "As desigualdades de riqueza e poder são a origem dos conflitos raciais dos negros contra os brancos e, uma vez superadas essas desigualdades, os antagonismos entre grupos raciais distintos acabariam.",
      "O processo de \"racialização\" atribuído a uma população deriva do reconhecimento de que as diferenças entre os grupos têm origem em sua língua, história e hábitos culturais."
    ],
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Relações Étnico-Raciais (Racismo e Racialização)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Trabalho e Gênero (Divisão Sexual do Trabalho)"],
    imageNames: []
})