...
createQuestion({
    ...
    options: [
      "tangenciais, pois, apesar de tratarem do processo de produção e do consumo do açúcar, ignoram a desigualdade existente entre o consumidor final e o comerciante do produto.",
      "semelhantes, pois o primeiro induz à reflexão sobre as desigualdades existentes no ciclo de produção e de consumo, e o segundo representa o impacto ambiental gerado pelo consumo excessivo.",
      "conflitantes, pois o primeiro representa a alienação dos poetas de todo o processo de produção dos alimentos, enquanto o segundo, a mão de obra empregada nos centros urbanos.",
      "similares, pois o primeiro ressalta as desigualdades existentes entre o trabalhador rural e o consumidor, o eu lírico; e o segundo evidencia a exploração da mão de obra.",
      "complementares, pois o primeiro aborda as desigualdades sociais descrevendo os ciclos econômicos desenvolvidos em períodos diferentes; enquanto o segundo retrata a mão de obra utilizada nesses períodos."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Textos e Intertextualidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Brasil Colonial: Escravidão e Economia Açucareira"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "endonucleases de restrição, centrifugação",
      "DNA polimerase, eletroforese",
      "transcriptase reversa, centrifugação",
      "endonucleases de restrição, eletroforese",
      "DNA polimerase, centrifugação"
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Biotecnologia e Engenharia Genética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Termoquímica: Entalpia de Reação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Porcentagem e Análise de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Média Aritmética e Análise de Dados"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana e Raciocínio Espacial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Crise do Século XIV e Peste Negra"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Brasil Colonial: Capitanias Hereditárias"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Conferência de Verdun, cujo tratado final dividiu a Europa ocidental entre os herdeiros de Carlos Magno, no início do século X.",
      "Conferência de Tordesilhas, cujo tratado final dividiu os territórios da América entre Portugal e Espanha no final do século XV.",
      "Conferência de Madri, que tinha por objetivo rever as determinações de Tordesilhas, cujo tratado vinha sendo desrespeitado desde meados do século XVI.",
      "Conferência de Berlim, que dividiu o território do continente africano entre as principais potências mundiais do final do século XIX.",
      "Conferência de Versalhes, que separou a Alemanha e sua capital, Berlim, nas partes Oriental e Ocidental em meados do século XX."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Imperialismo e Partilha da África (Conferência de Berlim)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "as inúmeras manifestações operárias em todo o mundo conquistaram o controle disciplinar sobre os trabalhadores, bem como o direito à jornada de 10 a 14 horas diárias.",
      "nas primeiras décadas do século XX, as operárias estavam protegidas por legislação que limitava a jornada de trabalho e garantia condições adequadas de higiene.",
      "o trabalho feminino foi regulamentado entre as décadas de 1930 e 1950 pelo presidente Getúlio Vargas, que também fixou a jornada de trabalho em 8 horas diárias.",
      "as mulheres que constituíram a mão de obra empregada na indústria de fiação e tecelagem estavam protegidas por mecanismos que inibiam o assédio sexual.",
      "quase 68% da população brasileira era formada pelas mulheres operárias imigrantes, principalmente as espanholas, italianas, portuguesas e húngaras."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Brasil República: Direitos Trabalhistas e Era Vargas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Guerra da Coreia, Guerra do Vietnã e independências de países africanos.",
      "Revolução Francesa, independência do Haiti e Guerra da Crimeia.",
      "Guerra da Síria, Guerra do Golfo e Guerra Irã-Iraque.",
      "Revolução Mexicana, independência de Cuba e Guerra do Paraguai.",
      "Guerra dos Cem Anos, Guerra de Secessão e independência da Venezuela."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Guerra Fria e Conflitos Regionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Estequiometria e Constante de Avogadro"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Reações Químicas e Balanceamento de Equações"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Interações Intermoleculares"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Química Orgânica: Reações e Funções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Ligações Químicas e Polímeros"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Resolução de Problemas: Funções e Finanças"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana: Área de Paralelogramos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "um balão com gás hélio solto das mãos de uma criança em pé no chão.",
      "um foguete, alçando voo a partir de um lançamento no solo.",
      "uma fruta, caindo de uma árvore direto ao solo.",
      "um paraquedista, saindo de uma aeronave, a qual está com velocidade vertical nula, até chegar ao solo.",
      "uma águia de bico amarelo em seu sobrevoo, atacando uma presa posicionada próxima à superfície do oceano."
    ],
    correctAnswer: 3,
    materia: ["Física"],
...
createQuestion({
    ...
    options: [
      "as regiões de eclipse solar total comprovam a Terra ser plana e as de eclipse solar parcial a Lua ser esférica.",
      "as regiões de eclipse solar total equivalem às penumbras e as de eclipse solar parcial, às sombras.",
      "a Terra se coloca entre o Sol e a Lua, projetando, assim, a sombra da Terra na Lua.",
      "o Sol se coloca entre a Terra e a Lua, projetando, assim, a sombra do Sol na Terra.",
      "a Lua se coloca entre o Sol e a Terra, projetando, assim, a sombra da Lua na Terra."
    ],
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Astronomia: Eclipses"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Relatividade: Dilatação do Tempo e Contração do Comprimento"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Termodinâmica: Taxa de Variação de Temperatura"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a erradicação de doenças infectocontagiosas em função da ausência de seus transmissores, pois a não imunização faz os agentes patogênicos morrerem, já que o indivíduo imunizado foi inoculado com grandes quantidades de vírus.",
      "a elevação do índice de mortalidade do grupo de pessoas que se vacinam, pois a vacina provoca uma resposta imunológica, fazendo com que o organismo pare de produzir anticorpos.",
      "a diminuição de pessoas imunizadas e a consequente eliminação dos vírus transmissores de doenças infectocontagiosas, levando ao desaparecimento das patologias.",
      "um aumento no gasto com saúde pública, pois as pessoas tendem a ficar doentes caso não sejam imunizadas, uma vez que a transmissão dos vírus tende a aumentar.",
      "um surto mundial de doenças como a poliomielite, a asma e o sarampo, uma vez que as vacinas têm um antígeno fortalecido, levando milhões de pessoas à morte."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia da Saúde e Políticas Públicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "da formação de uma única massa continental, a Pangeia, na era Pré-Cambriana.",
      "do soerguimento da Cordilheira dos Andes, no período Terciário da era Cenozoica.",
      "do processo de desertificação das áreas equatoriais, no período Jurássico da era Mesozoica.",
      "do início da abertura do Oceano Atlântico e de retração do Oceano Pacífico, na era Proterozoica.",
      "do surgimento do istmo que liga a América do Norte à América do Sul, no período Carbonífero da era Paleozoica."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geomorfologia e Tectônica de Placas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Guerra Irã-Iraque, na qual o presidente do Irã, Saddam Hussein, ataca o Iraque com a intenção de expandir o islamismo xiita e se apropriar dos campos de petróleo na bacia dos rios Tigre e Eufrates.",
      "Revolução Socialista, que ocorreu no Irã e que levou o Partido Comunista desse país ao poder, suprimiu a propriedade privada e nacionalizou as companhias de petróleo estrangeiras, incluindo as estadunidenses.",
      "Guerra do Golfo, na qual o exército iraniano invadiu o Kuwait, bombardeou os poços de petróleo desse país e rumou em direção à Arábia Saudita, quando foi surpreendido pelas forças de coalizão lideradas pelos Estados Unidos.",
      "derrubada das torres gêmeas do Word Trade Center de Nova Iorque, ação comandada pelo iraniano Osama bin Laden, que tinha a intenção de destruir os centros de comando das Sete Irmãs do Petróleo instaladas naquele complexo de edifícios.",
      "Revolução Islâmica ocorrida no Irã, em que grupos que eram a favor da nacionalização do petróleo, organizações islâmicas e movimentos estudantis apoiaram a rebelião que derrubou a monarquia pró-Estados Unidos e proclamou a República Islâmica do Irã."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Geopolítica do Oriente Médio: Revolução Iraniana"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "anarquista, em que as relações de poder existentes permitem que o mercado se autorregule.",
      "feudal, em que as relações entre senhores feudais e os servos ocorrem na base da livre negociação.",
      "socialista, em que o poder concentrado no parlamento viabiliza as práticas autorregulatórias do mercado.",
      "monarquista, em que a ausência de poder central oportuniza relações comerciais livres, sem a regulamentação estatal.",
      "capitalista, em que as relações econômicas e o mercado se autorregulam de acordo com a demanda dos consumidores."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Sistemas Econômicos: Capitalismo e Livre Mercado"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "pela atividade do câmbio, que produz o xilema estival e o xilema primaveril em resposta às alterações climáticas das estações do ano.",
      "pela atividade do câmbio, que produz, principalmente no inverno, o xilema estival com vasos de grande calibre e paredes finas.",
      "pela atividade do câmbio, que independente dos fatores ambientais, produz o floema primaveril que conduz seiva bruta ou mineral.",
      "pelos vasos lenhosos, que se desenvolvem mais no inverno do que no verão e conduzem seiva elaborada ou orgânica.",
      "pelos feixes liberolenhosos, que se desenvolvem apenas no verão e só conduzem seiva elaborada ou orgânica."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Botânica: Crescimento Secundário e Anéis de Crescimento"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "atuam como decompositores e estabelecem com as plantas relações de parasitismo na troca de nutrientes.",
      "realizam fotossíntese e liberam, para o meio ambiente, a matéria orgânica presente em suas hifas clorofiladas.",
      "estabelecem um tipo específico de associação ecológica, o comensalismo, em que ambos os organismos se prejudicam com a interação.",
      "liberam antibióticos, substâncias que matam as bactérias do solo e que impedem a absorção dos sais minerais pelas raízes das plantas.",
      "aumentam a capacidade de as raízes absorverem os minerais do solo e se beneficiam pela obtenção de substâncias produzidas pelos vegetais."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Ecologia: Relações Ecológicas (Micorrizas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Filariose, Ascaridíase",
      "Ancilostomose, Filariose",
      "Ascaridíase, Ancilostomose",
      "Ancilostomose, Ascaridíase",
      "Ascaridíase, Filariose"
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Parasitologia: Verminoses"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a meiose ocorre no gametófito, no processo de formação dos gametas.",
      "a meiose ocorre no esporófito, no processo de formação dos esporos.",
      "o gametófito se origina a partir da união do anterozoide com a oosfera.",
      "o gametófito é diploide e corresponde à geração predominante.",
      "o esporófito é haploide e corresponde à geração predominante."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Botânica: Ciclos Reprodutivos (Pteridófitas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "mulher IBi, marido IBi",
      "mulher IBIB, marido IAi",
      "mulher IBi, marido IAi",
      "mulher IAIB, marido IBIB",
      "mulher IBi, marido IAIA"
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Genética: Grupos Sanguíneos (Sistema ABO)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Charges e Contexto Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As mudanças ocorridas no mercado de trabalho, nas últimas décadas, caracterizam-se por um processo contínuo de reformulação geradora de lucros ao trabalhador.",
      "As novas formas de relações laborais acabam por gerar oportunidades no mercado de trabalho e garantir o acesso do trabalhador aos direitos assegurados pela carteira assinada.",
      "Como resultado do processo de desumanização das relações trabalhistas, a vida é dissipada pelo consumo ou pelo desgaste devido à busca constante por aperfeiçoamento profissional.",
      "A sociedade atual mantém questionamentos e desafios herdados de períodos históricos diferentes, sem, contudo, despertar o interesse mais profundo de pesquisadores e cientistas.",
      "A partir da Revolução Industrial, repetidos processos geradores de garantias trabalhistas ocorreram, visando à humanização das relações entre empregador e empregado."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "\"É por isso que estamos presenciando uma desconstrução do trabalho sem precedentes...\" É por isso que uma desconstrução inédita do trabalho está sendo presenciada por nós...",
      "\"A vida se consolida, cada vez mais, como sendo desprovida de sentido no trabalho...\" Consolidam a vida, ininterruptamente, tirando do trabalho o sentido...",
      "\"...o capitalismo aprofundou ainda mais as penalizações que está impondo ao universo laborativo...\" As penalizações impostas ao universo laborativo aprofundaram ainda mais o capitalismo...",
      "\"...as últimas décadas do século passado e os inícios do atual vêm presenciando a generalização de 'outras formas e modalidades de precarização' ...\" entre meados do século XIX e início do século XXI, a difusão de \"outras formas e modalidades de precarização” foi presenciada...",
      "\"Este número especial da Revista Katálysis... é uma contribuição efetiva para a linhagem crítica, atualizada e original, tanto pelos temas selecionados, quanto pela qualidade e competência dos colaboradores presentes...\" Uma contribuição efetiva pela linguagem crítica moderna e clássica foi feita pelo número especial da Revista Katálysis, devido aos temas abordados e à qualidade dos colaboradores..."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Reescrita de Frases e Adequação Gramatical"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Febre, hemoptise, dispneia e suores noturnos. A vida inteira que podia ter sido e que não foi. Tosse, tosse, tosse (Manuel Bandeira)",
      "No azul do céu de metileno A lua irônica Diurética É uma gravura de sala de jantar. (Carlos Drummond de Andrade)",
      "Não amei bastante meu semelhante, Não catei o verme nem curei a sarna. Só proferi algumas palavras, Melodiosas, tarde, ao voltar da festa. (Carlos Drummond de Andrade)",
      "Antes de tudo, a música preza Portanto, o ímpar. Só cabe usar O que é mais vago e solúvel no ar Sem nada em si que pousa ou pesa. (Paul Verlaine)",
      "E o amor sempre nessa toada: Briga perdoa perdoa briga. Não se deve xingar a vida, A gente vive, depois esquece. Só o amor volta para brigar, Para perdoar, Amor cachorro bandido trem. (Carlos Drummond de Andrade)"
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Figuras de Linguagem (Paronomásia)"],
    imageNames: []
})