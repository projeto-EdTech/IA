createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Colonização do Brasil", "Escravidão"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "durante o século XIX, o capitalismo industrial garantia todos os direitos aos trabalhadores.",
      "durante o século XIX, ocorreu uma crise produtiva devido à profunda intervenção do Estado.",
      "durante o século XX, o modelo de organização do trabalho manteve-se como era no XIX.",
      "a partir da década de 1970, são retomados os direitos trabalhistas vigentes no século XIX.",
      "a partir do século XX, os modelos de gestão do trabalho estão ligados aos avanços tecnológicos."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Capitalismo Industrial", "Organização do Trabalho"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o término do sistema de plantation.",
      "a formação das corporações de ofício.",
      "a construção de núcleos urbanos feudais.",
      "o início das grandes organizações sindicais.",
      "o surgimento da agricultura de subsistência."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Pré-História", "Modos de Produção"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "evidenciou as relações estreitas do governo Vargas com o comunismo soviético.",
      "contribuiu para a divulgação de uma imagem de \"pai dos pobres\" para Getúlio Vargas.",
      "ampliou a participação da classe operária em movimentos grevistas e comunistas.",
      "proporcionou uma rebelião nas Forças Armadas, dando início às ditaduras militares.",
      "prejudicou as atividades produtivas do setor cafeeiro, que se encontrava no auge."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Era Vargas", "Legislação Trabalhista"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Elementos Químicos", "Tabela Periódica", "Massa Atômica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Ligações Químicas", "Nomenclatura de Compostos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Concentração de Soluções", "Estequiometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Interações Intermoleculares", "Solubilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Não é considerada um \"acompanhador\" de atividades.",
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Massa", "Conversão de Unidades", "Razão e Proporção"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o crescimento dos deslocamentos será linear, enquanto que o crescimento populacional será exponencial.",
      "o crescimento dos deslocamentos será logarítmico, enquanto que o crescimento populacional será linear.",
      "o crescimento dos deslocamentos será exponencial, enquanto que o crescimento populacional será linear.",
      "tanto o crescimento dos deslocamentos quanto o crescimento populacional serão exponenciais.",
      "tanto o crescimento dos deslocamentos quanto o crescimento populacional serão lineares."
    ],
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Funções Exponenciais", "Crescimento Populacional"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o candidato C conquistou a eleição no 1º turno, pois teve 52% dos votos válidos.",
      "o candidato C conquistou a eleição no 1º turno, pois teve 70% dos votos válidos.",
      "o candidato C disputará o 2º turno e teve 46% dos votos válidos.",
      "o candidato A disputará o 2º turno e teve 32% dos votos válidos.",
      "o candidato A disputará o 2º turno e teve 25% dos votos válidos."
    ],
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Porcentagem", "Estatística", "Regra de Três"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "três moedas de R$ 0,50 e uma moeda de R$ 0,25.",
      "uma moeda de R$ 1,00 e três moedas de R$ 0,25.",
      "uma moeda de R$ 0,50 e três moedas de R$ 0,25.",
      "duas moedas de R$ 0,50 e duas moedas de R$ 0,25.",
      "duas moedas de R$ 1,00 e duas moedas de R$ 0,50."
    ],
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Resolução de Problemas", "Aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Energia Cinética", "Energia Potencial Gravitacional", "Conservação de Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Fontes de Energia", "Exploração Espacial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Óptica", "Formação de Imagens"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a maior parte da PEA encontra-se no setor primário, evidenciando o caráter agroexportador da economia brasileira.",
      "a PEA alocada no setor secundário ultrapassa os 50% do seu total, indicando que o Brasil é, efetivamente, um país industrializado.",
      "o setor terciário, por concentrar atividades extrativistas e de mineração, vem se destacando como principal setor empregador do Brasil.",
      "o setor terciário é onde se encontra a maior parte da PEA, revelando a crescente importância desse setor na economia brasileira.",
      "o rápido processo de urbanização ocorrido a partir da segunda metade do século XX tornou o setor secundário o maior empregador brasileiro."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["População", "Economia", "Setores da Economia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "da madeira amazônica reflorestada, largamente utilizada pelos mercados moveleiro e da construção civil dos Estados Unidos.",
      "da borracha, cujo consumo nas indústrias dos Estados Unidos e da Europa crescia graças ao descobrimento da técnica de vulcanização.",
      "do gado de corte, amplamente criado nas franjas da floresta amazônica e consumido principalmente por países do continente americano.",
      "da soja, que a partir do início do século XX começa a ganhar espaço de plantio no sudoeste amazônico para abastecer o mercado japonês.",
      "do minério de ferro, abundantemente encontrado na região fronteiriça entre os dois países e de grande importância para o setor siderúrgico francês e inglês."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geopolítica", "História do Brasil (Região Norte)", "Ciclos Econômicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Tecnologia", "Geopolítica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Industrialização", "Japão", "Economia Global"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Evolução", "Convergência Adaptativa"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Vegetal", "Transporte de Seiva"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Evolução", "Seleção Natural", "Adaptações"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "50°C e pH ácido, sendo que a enzima age especificamente sobre proteínas.",
      "50°C e pH ácido, sendo que a enzima age especificamente sobre polissacarídeos.",
      "50°C e pH básico, sendo que a enzima age especificamente sobre polissacarídeos.",
      "70 °C e pH ácido, sendo que a enzima age especificamente sobre polissacarídeos.",
      "70 °C e pH básico, sendo que a enzima age especificamente sobre proteínas."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Enzimologia", "Fatores que Afetam a Atividade Enzimática"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Genética", "Heredogramas", "Padrões de Herança"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de Texto", "Compreensão de Leitura"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Ariano Suassuna"],
    imageNames: []
})