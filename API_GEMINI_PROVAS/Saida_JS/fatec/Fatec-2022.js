createQuestion({
    ...
    options: [
      "coagulação desinfecção filtração",
      "filtração coagulação decantação",
      "floculação decantação filtração",
      "decantação filtração floculação",
      "floculação decantação desinfecção"
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Saneamento Básico", "Tratamento de Água"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "eram cópias de projetos de engenharia desenvolvidos pelos povos nômades da pré-história.",
      "foram construídas para possibilitar a travessia de animais de carga, que levavam armamento pesado.",
      "transportavam água do Mar do Norte para as províncias dos territórios da Gália Romana, da Grécia continental e do norte da África.",
      "utilizavam a força da gravidade, por meio de canais de pedra ou tijolo ligeiramente inclinados, para levar água para cidades e vilas do Império Romano.",
      "eram barreiras militares instaladas em pontos estratégicos para proteção dos rios de fronteira do Império Romano, diante das ameaças de invasão germânica."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Roma Antiga", "Engenharia Romana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Volume", "Conversão de Unidades", "Grandezas e Medidas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a contaminação ocorre por contato direto com a saliva ou o muco de uma pessoa infectada, por meio de gotículas respiratórias produzidas ao tossir ou espirrar.",
      "os agentes causadores são microscópios e dotados de núcleo organizado capaz de orientar a produção de proteínas prejudiciais ao organismo humano.",
      "a transmissão poderia ser evitada com a eliminação de reservatórios de água parada onde se reproduzem os insetos vetores.",
      "o tratamento é feito por meio de antibióticos, que inibem a proliferação celular dos agentes causadores da doença.",
      "a melhor maneira de prevenção é uma vacina específica produzida a partir de bactérias atenuadas ou mortas."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Doenças", "Saúde Pública"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "inorgânico, formado por 3 elementos químicos.",
      "inorgânico, formado por 4 elementos químicos.",
      "inorgânico, formado por 5 elementos químicos.",
      "orgânico, formado por 4 elementos químicos.",
      "orgânico, formado por 5 elementos químicos."
    ],
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Classificação de Compostos Orgânicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "apenas cientistas políticos poderão controlar uma grande massa ignorante.",
      "a democracia atualmente pressupõe a ignorância celebrada pela sociedade.",
      "há a disseminação de uma doença social causada por vícios como o álcool.",
      "pessoas ignorantes e tolas estão assumindo postos de destaque.",
      "Darwin, cuja teoria criacionista foi banida, está se revirando no caixão."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "apesar de todo o empenho científico para o desenvolvimento da internet, a rede permite opiniões que contradizem a ciência.",
      "apesar de serem pessoas diferentes, a cientista e Billy compartilham das mesmas opiniões acerca da ciência.",
      "apesar dos esforços dos cientistas, os satélites lançados ainda não conseguiram entrar em órbita.",
      "apesar dos avanços tecnológicos, os cientistas ainda não conseguiram calcular o diâmetro da Terra.",
      "apesar de ter tantos computadores sofisticados, a cientista somente consegue fazer cálculos no papel."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Imagens e Texto", "Humor"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "No período colonial, o nióbio era o minério mais procurado no mercado internacional, movimentado pela nascente indústria têxtil; atualmente, o principal minério extraído na região das Minas Gerais é o ouro.",
      "No período colonial, a mineração era orientada pela busca de ouro e diamantes e realizada principalmente por mão de obra escravizada; atualmente, o minério de ferro é o principal minério de exportação de Minas Gerais.",
      "No século XV, a região de Minas Gerais respondia por cerca de 80% do volume de bauxita exportado pelo Brasil; atualmente, os minérios brasileiros enfrentam boicotes internacionais devido aos rompimentos de barragem no estado.",
      "No século XVIII, a região de Minas Gerais era a segunda maior produtora de ouro da colônia, atrás de Goiás; atualmente, no estado de Minas Gerais, a mineração é a terceira maior atividade econômica, atrás do artesanato e do turismo.",
      "No século XIV, a descoberta de jazidas de metais preciosos provocou a colonização da região de Minas Gerais; atualmente, verifica-se a diminuição do número de escravizados nas regiões mineradoras, expulsos pelos sucessivos rompimentos de barragens."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Brasil Colônia", "Economia Colonial (Mineração)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "escassez da mão de obra na Rússia, haja vista que, nos dias de hoje, a população de imigrantes supera a de pessoas nascidas no país.",
      "urgência em diminuir a densidade demográfica do país, a qual está entre as maiores da Terra e contribui para a escassez de recursos naturais.",
      "necessidade de aumentar a população nativa, pois se a taxa de fecundidade continuar em 1,48 filho por mulher, a população absoluta nativa da Rússia tenderá a diminuir.",
      "exigência do Fundo das Nações Unidas para a Infância (UNICEF) de duplicar a população da Eurásia no prazo de 50 anos para suprir os vazios demográficos desse continente.",
      "assimetria na distribuição da população sobre o território russo, uma vez que a maior parte da população se concentra no leste e no norte do país, deixando o oeste e o sul praticamente desabitados."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Cálculo de Área", "Grandezas e Medidas", "Razão e Proporção"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "entre a população de 18 a 24 anos, pois o mercado de trabalho está com baixa atividade econômica e essa faixa etária é composta majoritariamente por pessoas que possuem qualificação profissional.",
      "entre os homens, pois historicamente as pessoas que compõem esse gênero não aceitam serem chefiados por mulheres, uma vez que elas ocupam a maioria dos cargos de chefia nas empresas brasileiras.",
      "entre as mulheres, pois historicamente as pessoas que compõem esse gênero recebem salários maiores do que os dos homens, além de se enquadrarem em jornadas com menos horas de trabalho.",
      "entre os que se declaram pretos, pois, por serem mais escolarizados que os brancos, possuem estabilidade no emprego e maior rede de proteção no sistema de seguridade social.",
      "entre a população de 14 a 17 anos, pois um dos fatores é a exigência do mercado de trabalho por experiências e qualificações na área em que se está procurando emprego."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["População", "Mercado de Trabalho", "Desemprego"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Porcentagem", "Variação Percentual"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História Contemporânea", "Segregação Racial"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "viabilizou a concretização da reforma agrária no país, concedendo microcréditos às famílias que retornaram ao campo.",
      "possibilitou ao Estado ser agente fundamental de redistribuição de renda e estimular o desenvolvimento econômico.",
      "facilitou a criação de novos bancos, em virtude da expansão das agências bancárias autorizadas a pagar o benefício.",
      "motivou a demissão de milhões de trabalhadores urbanos celetistas que preferiam sair de seus empregos para se tornarem beneficiários do programa.",
      "determinou que Organizações Não Governamentais (ONGs) fossem contratadas pelo governo para cadastrar, escolher e remunerar as famílias beneficiadas."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geografia Social", "Políticas Públicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "“silêncio nas horas” e “cheia de culpa\" (2.º parágrafo)",
      "\"sonho de comida\" e \"flores cultivadas\" (3.º parágrafo)",
      "\"assentava em seu trono” e “cheia de fome\" (3.º parágrafo)",
      "\"cheiro algum” e “mãe era a Senhora, a Rainha\" (3.º parágrafo)",
      "\"flores cultivadas” (3.º parágrafo) e \"rios caudalosos\" (6.º parágrafo)"
    ],
    correctAnswer: 3,
...
createQuestion({
    ...
    options: [
      "Eu me lembrava de algumas histórias da infância de minha mãe.",
      "As labaredas [...] pareciam debochar do vazio de nosso estômago.",
      "...a brincadeira preferida era aquela em que a mãe era a Senhora, a Rainha.",
      "Felizes, colhíamos flores cultivadas...",
      "...pude contemplar extasiada os olhos de minha mãe."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "Apresenta vegetação constituída predominantemente por gramíneas e fauna de vertebrados formada principalmente por roedores, como hamsters e marmotas, além de carnívoros, como coiotes e alces.",
      "Apesar de estarem em solo encharcado, as plantas desse bioma não absorvem água com eficiência devido às constantes temperaturas do solo abaixo de 5 °C e sofrem com a desidratação, processo chamado de seca fisiológica.",
      "Ocupa cerca de 10% do território brasileiro, estendendo-se principalmente pelos estados de Sergipe, Alagoas, Bahia e pelo norte de Minas Gerais. Entre as espécies vegetais, apresenta o pau-brasil, orquídeas e samambaias. A fauna se destaca pela presença do mico-leão-dourado, onças, guepardos e raposas.",
      "Localiza-se na faixa equatorial do planeta, com fauna rica e abundante. A vegetação apresenta árvores de grande porte, cujas copas mais altas formam um \"teto” de vegetação, sob o qual existe um patamar interno, formado pelas copas de árvores mais baixas.",
      "Apresenta elevada biodiversidade, em que a fauna de vertebrados abunda, no meio aquático, em peixes, e no meio terrestre, em aves, capivaras, antas, onças, jacarés e serpentes. A flora é principalmente constituída por ervas, arbustos e árvores diversas, como palmeiras, ipês e aroeiras."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "o fim dos impactos ambientais ocorrerá no momento em que o percurso dos produtos a partir de sua produção for monitorado pela sociedade.",
      "o rumo a ser seguido para atingirmos a sustentabilidade passa pela utilização dos combustíveis fósseis e sem a utilização de energia nuclear.",
      "o ciclo da vida dos produtos é a redução do uso de materiais tóxicos e a eliminação, pela queima, de todos os resíduos gerados pelos sistemas produtivos.",
      "a diretriz escolhida na busca pela sustentabilidade passa obrigatoriamente pela desassociação entre produção mais limpa e consumo mais limpo, pois são ações divergentes.",
      "a redução dos impactos ambientais implica buscar a diminuição e mesmo a eliminação de processos nocivos ao meio ambiente, da extração da matéria-prima ao uso e ao descarte final de objetos."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Sustentabilidade", "Impactos Ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "zero absoluto.",
      "20 K acima do zero absoluto.",
      "20 K abaixo do zero absoluto.",
      "526 K acima do zero absoluto.",
      "526 K abaixo do zero absoluto."
    ],
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Temperatura"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "as altas temperaturas verificadas tanto na Amazônia quanto na Austrália foram as causas dos incêndios em ambas as matas.",
      "tanto a floresta amazônica quanto as florestas australianas são acostumadas com o fogo e, portanto, poderão se regenerar rapidamente.",
      "as mudanças climáticas contribuíram para a propagação dos incêndios em áreas florestais da Amazônia e da Austrália, apesar de as causas das queimadas não serem semelhantes.",
      "a queimada na Amazônia ocorreu pelo aumento do processo de desertificação a que essa área está exposta, diferentemente da Austrália, país de clima frio, onde não existem desertos.",
      "as florestas australianas, por serem úmidas, não pegam fogo de maneira espontânea, diferentemente da floresta amazônica que, em função do tempo seco, fica exposta a queimadas naturais."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Meio Ambiente", "Biomas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As \"grandes ilhas de lixo\" constituem-se como a forma adequada para a coleta, reciclagem e tratamento do lixo plástico dos oceanos.",
      "A poluição causada pelo lançamento de resíduos plásticos nos oceanos pode causar o fenômeno conhecido como maré vermelha, devido ao aumento dos decompositores nas teias alimentares.",
      "As áreas oceânicas conhecidas como \"ilhas de lixo” são regiões de intensa degradação dos resíduos plásticos, devido à grande quantidade de bactérias decompositoras anaeróbicas e à falta do gás oxigênio.",
      "As pesquisas demonstram que os resíduos plásticos lançados aos oceanos, ao sofrerem a ação das correntes marinhas, das variações de salinidade, de pressão, de temperatura e de atrito, em um intervalo de tempo médio, não prejudicam mais os ecossistemas.",
      "Em meio marinho, os plásticos apresentam inúmeras ameaças ecológicas, como a inibição da capacidade reprodutiva dos animais, o bloqueio do trato digestório daqueles que ingerem esses plásticos e a transferência de poluentes para a cadeia alimentar."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Impactos Ambientais", "Poluição Marinha"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ela independe de fatores ambientais, tais como: umidade, temperatura, disponibilidade de oxigênio e luminosidade.",
      "ela ocorre intensamente nas \"grandes ilhas de lixo\" encontradas nos oceanos, devido à falta de matéria orgânica desses locais.",
      "as bactérias e os fungos decompositores possuem enzimas específicas para transformar rapidamente a matéria mineral em orgânica.",
      "os materiais resistentes à biodegradação, quando descartados incorretamente, representam um grande desafio da gestão ambiental contemporânea.",
      "os resíduos de plásticos após se fragmentarem nos oceanos são benéficos nos processos respiratórios e reprodutivos de muitos animais marinhos, pois são facilmente digeridos."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Degradação de Materiais", "Gestão Ambiental"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletricidade", "Grandezas Físicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "MO + energia → CH4 + H2 + H2S + CO2 + NH3 + N2 + H2O",
      "MO + O2 + energia → CH4 + H2 + H2S + CO2 + NH3 + N2 + H2O",
      "MO → CH4 + H2 + H2S + CO2 + NH3 + N2 + H2O + energia",
      "MO + O2 → CH4 + H2 + H2S + CO2 + NH3 + N2 + H2O + energia",
      "MO + energia CH4 + H2 + H2S + CO2 + NH3 + N2 + H2O + O2"
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Reações Químicas", "Biogás", "Fermentação"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "temperatura.",
      "forma do recipiente.",
      "área da superfície do gerador."
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Cinética Química", "Fatores que Afetam a Velocidade das Reações"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "do satélite e da bússola.",
      "do gramofone e da luneta.",
      "do rádio e do sistema GPS.",
      "do automóvel e do telefone.",
      "do tear manual e da imprensa."
    ],
    correctAnswer: 3,
    materia: ["História"],
...
createQuestion({
    ...
    options: [
      "124 000 australianos se tornaram milionários no período pré-pandemia.",
      "a Suíça foi o único país que apresentou queda nos preços das residências.",
      "Suécia e Estados Unidos da América são os países com melhores rendimentos per capita.",
      "nos dois países da Oceania mencionados no gráfico, os cidadãos perderam renda.",
      "Japão e Países Baixos apresentam dados de ganhos semelhantes."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto e Gráfico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Progressão Geométrica", "Sequências Numéricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "núcleos instáveis os quais emitem partículas e radiação eletromagnética.",
      "prótons instáveis os quais emitem subpartículas e radiação eletromagnética.",
      "elétrons instáveis os quais emitem subpartículas e radiação eletromagnética.",
      "pósitrons instáveis os quais emitem partículas e não radiação eletromagnética.",
      "nêutrons instáveis os quais emitem subpartículas e não radiação eletromagnética."
    ],
    correctAnswer: 0,
    materia: ["Física"],
...
createQuestion({
    ...
    options: [
      "sua diretora comete erros científicos e força uma temática feminista.",
      "apresenta uma produção enfadonha, apesar do tema fascinante.",
      "sua diretora apela para um drama moralista e ultrapassado.",
      "valoriza a participação das mulheres nas ciências.",
      "incentiva a paridade de gêneros nos laboratórios."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "filmes que são patrocinados por corporações comerciais.",
      "mulheres na direção de filmes na indústria cinematográfica.",
      "produções sobre mulheres que se destacam nas áreas científicas.",
      "erros nas representações de conceitos científicos.",
      "filmes com teor moralista e patronal."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "pela equiparação aos escravizados das colônias francesas, que fez com que esses dois grupos passassem a ter mais direitos que os demais.",
      "pela promulgação da Declaração dos Direitos da Mulher, que assegurou a superioridade feminina em relação aos homens.",
      "pela institucionalização do dia 8 de março e, ao mesmo tempo, pela equiparação salarial em relação aos homens.",
      "pela participação das meninas na vida pública e pela abolição do trabalho doméstico para as mulheres.",
      "pela conquista de direitos como o divórcio e, ao mesmo tempo, pela proibição da participação política."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Revolução Francesa", "Direitos da Mulher"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Gênero Discursivo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "respeito, pois o contexto formal de comunicação impõe o uso do tratamento coloquial utilizado.",
      "afetividade, uma vez que qualquer contexto comunicativo impõe o uso formal de pronomes de tratamento.",
      "ironia da enunciadora, que, mesmo diante da formalidade do contexto, opta pelo tratamento informal e cômico.",
      "proximidade, pois, embora o contexto seja formal, ela utiliza um tratamento afetivo para sugerir familiaridade.",
      "desenvoltura da enunciadora, que, mesmo reconhecendo a formalidade do discurso, opta por se distanciar do público alvo."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Elementos da Comunicação", "Linguagem Formal e Informal"],
    imageNames: []
})