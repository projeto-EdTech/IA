createQuestion({
    ...
    options: [
      ...
      "a grande participação das mulheres na indústria da construção civil, causando grande concorrência entre elas e reduzindo o salário das trabalhadoras.",
      "o papel dos sindicatos, que colocam a luta das mulheres trabalhadoras em segundo plano, seguindo o que está escrito na Consolidação das Leis do Trabalho (CLT).",
      "o entendimento, por parte de alguns gestores empresariais, de que as mulheres se ausentam mais do trabalho, pois o cuidado com a família ainda é visto como função feminina.",
      "a cultura matriarcal, que valoriza mais o trabalho da mulher, e a questão reprodutiva, em que empregadores obtêm ganhos produtivos quando as funcionárias saem de licença."
    ],
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Relações de Gênero e Trabalho"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Estatística e Média Aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Razões e Proporções", "Leitura de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Movimentos Sociais e Direitos das Mulheres"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "garante que as fêmeas engravidem novamente sem que ocorra ovulação.",
      "garante que o filhote possa chegar à fase adulta sem doenças autoimunes.",
      "fornece as organelas citoplasmáticas, que formarão a bainha de mielina do filhote.",
      "fornece antígenos maternos, que permitem a digestão enzimática dos cátions Ca²⁺.",
      "fornece ao filhote anticorpos maternos, que fortalecem o sistema imune dele."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["História da Física", "Radioatividade", "Raios Cósmicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Transformações Geométricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Todo não nefelibata é pragmático.",
      "Algum nefelibata é pragmático.",
      "Algum não nefelibata é pragmático.",
      "Algum não nefelibata é não pragmático."
    ],
    correctAnswer: 2,
    materia: ["Matemática"],
...
createQuestion({
    ...
    year: 2017,
    text: {
      principal: "No século VIII, tropas $\\mu$çulmanas, lideradas pelo general Tarik, saíram do Norte da África, atravessaram o mar Mediterrâneo pelo Estreito de Gibraltar e conquistaram quase toda a península Ibérica.\nSobre o período de domínio $\\mu$çulmano na península Ibérica, é correto afirmar que",
      subItens: []
    },
    options: [
      ...
      "sua duração foi maior em Portugal do que na Espanha, reino do qual os $\\mu$çulmanos foram expulsos pelos cruzados, cerca de trinta anos após a ocupação da península Ibérica.",
      ...
      "consolidou o sistema escravocrata medieval, fechou universidades, desestimulou o desenvolvimento científico e proibiu manifestações literárias e musicais pagās."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Idade Média", "Expansão $\\mu$çulmana"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o desenvolvimento de teorias raciais de superioridade do homem negro e a criação da Unidade Africana, que reuniu as principais lideranças rebeldes do continente e declarou guerra aos Estados Unidos.",
      "o apoio da União Soviética que, no contexto da polarização política pós-Segunda Guerra Mundial, incentivou a industrialização e a rápida arrancada de desenvolvimento verificadas nas ex-colônias europeias na África.",
      "a atuação de missionários cristãos e agentes da Organização das Nações Unidas que, aliados a agências internacionais de notícias, promoveram campanhas de conscientização da opinião pública internacional pelo fim do colonialismo.",
      "a crise econômica decorrente do aumento abrupto do valor dos escravos no mercado internacional, associada à queda do preço do barril de petróleo, principal commodity da pauta de exportações africanas, o que levou os europeus a abandonar as colônias.",
      "o enfraquecimento econômico e político dos países europeus no pós-Segunda Guerra Mundial e o surgimento de movimentos de libertação em diferentes partes do continente africano, levando à gradativa perda do controle europeu sobre as colônias na África."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Descolonização da África", "Pós-Segunda Guerra Mundial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Período Regencial (Brasil)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a ascensão de regimes nazifascistas, com forte apelo nacionalista, na Itália e na Alemanha, e a aceleração do crescimento econômico do chamado BRICS (Brasil, Rússia, Índia, China e África do Sul).",
      "o descompasso entre a produção e o consumo no mercado dos EUA, e a diminuição das exportações desse país para a Europa, o que gerou aumento dos estoques de produtos agrícolas e industrializados e a queda brusca do valor das ações das empresas no mercado financeiro.",
      "o endividamento dos Estados Unidos, em consequência da devastação que o país sofreu na Primeira Guerra Mundial, e a falência da França e da Inglaterra, que deixaram de cumprir seus compromissos financeiros com a comunidade internacional.",
      "a brusca desvalorização do dólar no mercado internacional, provocada pelo aumento do preço das commodities agrícolas dos países em desenvolvimento, e a política de substituição de importações, adotada pelas economias asiáticas.",
      "as medidas protecionistas adotadas pela União Soviética, favorecendo as indústrias dos países do Leste europeu, e as barreiras alfandegárias impostas aos produtos estadunidenses por parte dos integrantes da Zona do Euro."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Crise de 1929", "Economia Global"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "iônica, e a fórmula do composto formado é CaCl.",
      "iônica, e a fórmula do composto formado é CaCl₂.",
      "covalente, e a fórmula do composto formado é ClCa.",
      "covalente, e a fórmula do composto formado é Ca₂Cl.",
      "covalente, e a fórmula do composto formado é CaCl₂."
    ],
    correctAnswer: 1,
    materia: ["Química"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Funções Orgânicas Oxigenadas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Mínimo Múltiplo Comum (MMC)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Grandezas e Medidas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Análise Dimensional", "Potência"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Energia", "Eficiência Energética"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Cubatão, localizado no estado de São Paulo, entre a capital e o porto de Santos, maior porto brasileiro na ocasião.",
      "Carajás, no interior do estado do Pará, para aproveitar a maior reserva mundial de minério de ferro, situada naquela localidade.",
      "Volta Redonda, situado entre São Paulo e Rio de Janeiro, as duas maiores cidades brasileiras na época, e próximo ao Quadrilátero Ferrífero.",
      "São Paulo, capital do estado mais rico da federação naquele período e maior consumidor de produtos siderúrgicos e metalúrgicos da América Latina.",
      "Salvador, capital do país naquele momento, grande centro financeiro e industrial, cortado pelas linhas da Rede Ferroviária Federal, que abasteciam os fornos da companhia."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geografia Industrial do Brasil", "Era Vargas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "agrícola, pois nesse mapa está indicada a profundidade do solo, fator determinante para a definição de áreas prioritárias para conservação ambiental.",
      "agrícola, pois nesse mapa estão indicadas as áreas mais férteis para o desenvolvimento de determinadas culturas.",
      "agrícola, pois nesse mapa estão definidos os tamanhos dos lotes e o índice pluviométrico da área cartografada.",
      "urbano, pois nesse mapa estão presentes informações que podem ser utilizadas no direcionamento da expansão das cidades.",
      "urbano, pois nesse mapa estão localizadas e detalhadas as informações sobre os equipamentos urbanos existentes no subsolo de uma determinada área."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Cartografia", "Planejamento Urbano"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Blocos Econômicos", "União Europeia", "Geopolítica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "cidades isoladas, em sua maioria no vale do rio Eufrates, não configurando, portanto, um país.",
      "vastas áreas ao sul do Sahel, na África Subsaariana, favorecidas pelo apoio dos Estados Unidos.",
      "quase metade do território da Líbia e possui o reconhecimento formal da maioria dos países do mundo.",
      "todo o Oriente Médio e, com o apoio da Organização das Nações Unidas (ONU), vem reconstruindo o seu califado.",
      "importantes áreas no Irã e na China, explorando imensas jazidas de petróleo, comercializado no mercado paralelo."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Climatologia", "Domínios Morfoclimáticos do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ácido abcísico e aumento da transpiração.",
      "auxina e diminuição da fotossíntese.",
      "citocinina e aumento da transpiração.",
      "etileno e diminuição da transpiração.",
      "giberelina e aumento da fotossíntese."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Vegetal", "Adaptações Vegetais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Biologia Molecular", "Expressão Gênica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "mais aparentadas às algas pardas e vermelhas do que às plantas terrestres.",
      "mais aparentadas às plantas terrestres e algas vermelhas do que às algas pardas.",
      "intermediárias evolutivas entre as algas vermelhas e as plantas terrestres.",
      "originárias do grupo das plantas terrestres.",
      "mais evoluídas que as algas pardas."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Semântica", "Conotação e Denotação"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Elipse, pois o autor omite todos os pronomes pessoais a fim de criar musicalidade.",
      "Bucolismo, pois o amor faz grande reverência à natureza ao evocar a sua sonoridade.",
      "Aliteração, pois o autor explora a repetição harmônica e ritmada de sons consonantais.",
      "Determinismo, pois o meio em que vive a pessoa amada determina o ritmo de sua vida.",
      "Ornamentação exagerada, pois há vocabulário ritmado com exclusividade de rimas ricas."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura", "Figuras de Linguagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Poema"],
    imageNames: []
})