createQuestion({
    ...
    options: [
      "Gráfico que mostra aceleração variando linearmente em forma de triângulo.",
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Cinemática", "Movimento Vertical"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Literatura Brasileira", "Barroco", "Padre Antônio Vieira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Naturalismo", "O Cortiço (Aluísio Azevedo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Conceitos Fundamentais da Biologia", "Citologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "os carboidratos são as macromoléculas encontradas em maior quantidade nos tecidos vivos.",
      "os carboidratos podem ter função estrutural como, por exemplo, a quitina presente nos artrópodes.",
      "os monômeros das proteínas são os aminoácidos cujas diversificadas funções incluem o armazenamento de energia.",
      "os ácidos graxos saturados são encontrados somente em animais, pois as plantas não produzem colesterol.",
      "as bases nitrogenadas encontradas no DNA e no RNA são as mesmas."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Bioquímica", "Macromoléculas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Atomística", "Estequiometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Geografia Física", "Meio Ambiente", "Impactos Ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Geomorfologia", "Tectônica de Placas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Idade Média", "Alta Idade Média", "Feudalismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Conjuntos Numéricos", "Desigualdades"],
    imageNames: []
})