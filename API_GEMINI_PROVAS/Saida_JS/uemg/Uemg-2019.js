...
createQuestion({
    ...
    options: [
      " a expressão destacada pertence à classe dos advérbios e serve para sinalizar a relação semântica de oposição existente entre as ideias contidas nos enunciados que une.",
      "Em \"Um alento e tanto se você pensar que essa estrutura costuma ser menor entre os sujeitos deprimidos\", a expressão em destaque é usada como um termo substituto que retoma a referência feita pelo nome \"cérebro\" empregado no período anterior.",
      "No texto, as falas de autoridades no assunto tratado, o papel da atividade física na prevenção e no controle da depressão, são apresentadas por meio do discurso direto, marcado pelo uso de aspas e de verbos de elocução.",
      "Uma característica do estilo predominantemente informal no texto é o uso de frases nominais, de períodos interrompidos e de expressões coloquiais, como “montão de gente\", \"um alento e tanto\" ou \"anda pra baixo\", por exemplo."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Elementos Linguísticos", "Estrutura Textual"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A construção perifrástica “Vai passando\" é formada pelo verbo auxiliar \"ir\" seguido do verbo principal “passar” no gerúndio, e o valor veiculado por ela é de possibilidade ou probabilidade.",
      "A fala do assaltado contribui para a sua identificação como habitante do interior do país, por apresentar formas de expressão usuais em regiões menos urbanizadas.",
      "A fala do assaltante se distancia da fala do assaltado pelo fato de trazer formas de expressão reservadas a ocasiões determinadas, em que os falantes incluem pessoas de outras comunidades linguísticas para sua comunicação.",
      "As diferenças linguísticas exemplificadas no cartum tanto ocorrem em função da idade dos personagens quanto acontecem devido à influência do grupo social a que pertencem."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação Linguística", "Interpretação de Cartum"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2019,
    text: {
      principal: "Em relação ao emprego dos sinais de pontuação na construção do Texto 2, assinale a alternativa CORRETA:",
      subItens: []
    },
    options: [
...
createQuestion({
    ...
    options: [
      "A crença em boatos parte da confiança naquilo que é veiculado pelos meios de comunicação e acessado pelos usuários.",
      "A ignição do rumor é a conclusão precipitada, o veneno sem origem, a possibilidade que ganhou popularidade.",
      "Os boatos não informam, ao contrário, são essenciais para o aprendizado daquelas pessoas que desejam ser mais sábias.",
      "Os rumores, que geram boatos, têm origem na má-fé, no mal-entendido ou em quaisquer trapalhadas."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Textos Variados", "Gêneros Textuais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "É narrada a história de amor, que culmina em um final feliz, entre o poeta Tomás Antônio Gonzaga e, sua eterna musa, Maria Dorotéia Joaquina de Seixas.",
      "Há citações de trechos de poesia árcade de incógnita autoria, ao longo de uma recriação ficcional que remonta o ciclo do Ouro no final do século XVIII.",
      "É construída uma \"colcha de retalhos romanceada\", envolvendo personagens literárias e históricas que viveram o período da insurreição mineira.",
      "Há remissão a fatos da história colonial barroca em um romance sobre a vida na capital do Império em que nobres desejavam ter experiências marítimas."
    ],
    correctAnswer: 2,
    materia: ["Literatura Brasileira"],
    conteudo: ["Obras Literárias", "Contexto Histórico"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Referência a uma lenda nórdica, ingrediente mítico que evidencia o caráter intertextual literário do romance.",
      "Notas e bibliografia consultadas que remetem a fontes de pesquisa e de confirmação de informações presentes na narrativa.",
      "Bases históricas sobre a Inconfidência e sobre Tomás Antônio Gonzaga que favorecem a verossimilhança do enredo.",
      "Registro do lamento de pessoas que perderam entes queridos em naufrágios, denominadas pelo autor de \"órfãos do mar\"."
    ],
    correctAnswer: 3,
    materia: ["Literatura Brasileira"],
    conteudo: ["Obras Literárias", "Características da Obra"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O eu-lírico emprega, no primeiro verso, a palavra \"claro” que, nesse contexto, expressa a ideia de incerteza.",
      "O elemento linguístico que confirma que a vida é realmente boa está presente no terceiro verso do poema.",
      "A repetição em três versos, na sequência da estrutura do poema, reforça a ideia apresentada no sexto verso.",
      "As expectativas são confirmadas, no último verso, pois o eu-lírico revela uma tristeza que ele consegue superar."
    ],
    correctAnswer: 2,
    materia: ["Literatura Brasileira"],
    conteudo: ["Poesia Moderna", "Análise Poética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Literatura Brasileira"],
    conteudo: ["Pré-Modernismo", "Obras Literárias"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "É avesso à xenofobia e vive em um mundo bem ajustado com a realidade que o circunda.",
      "Dedica amor intenso ao Brasil, sendo ridicularizado por seu idealismo e ufanismo exacerbado.",
      "Não se identifica com as causas indígenas, desprezando as raízes históricas nacionais.",
      "Visita a ilha das cobras para redigir um protesto em defesa de soldados presos injustamente."
    ],
    correctAnswer: 1,
    materia: ["Literatura Brasileira"],
    conteudo: ["Pré-Modernismo", "Personagens Literários"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Gêneros Literários", "Tipologia Textual"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Movimento Circular Uniforme", "Período e Frequência"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Ditadura Militar", "História do Brasil Contemporâneo"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Brasil Contemporâneo", "Geografia Econômica", "Questões Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A economia dos Estados Unidos sinalizava um pequeno crescimento durante a Segunda Guerra Mundial e, de forma não tão arrojada, continuaria a crescer nas décadas seguintes.",
      "A fartura de alimentos, a geladeira cheia de produtos e a atmosfera de alegria denotavam a satisfação causada pela compra do refrigerador, padrão novo que podia ser desfrutado pelos trabalhadores daquele país à época.",
      "Os bens, que antes eram restritos a uma pequena parcela da população estadunidense, passaram a ser acessíveis à maioria das pessoas daquele país.",
      "A representação sugeria um ideal de felicidade baseado no consumismo e na posse de bens como prova de sucesso social e econômico, que foi disseminado na sociedade do Estados Unidos e de seus parceiros econômicos, incluindo o Brasil."
    ],
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["Pós-Segunda Guerra Mundial", "Sociedade de Consumo", "Cultura de Massa"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Os anos da Guerra Fria, sucessores aos da criação da ONU, por dividirem o mundo em dois polos de influência distintos, limitaram o papel da organização no campo de segurança internacional.",
      "A ação da ONU, devido à influência da Guerra Fria, se restringiu a intervenções de paz apenas quando estas não colidiam com os interesses das grandes potências que a manipulavam, assistindo passivamente, devido aos vetos do Conselho de Segurança, a conflitos que resultaram em milhares de mortos.",
      "A primeira e maior missão de observação da ONU, que pedia um cessar-fogo em 1948, ocorreu na região da Coreia do Sul e da Coreia do Norte.",
      "O Conselho de Segurança da ONU é atualmente composto por cinco membros permanentes e dez membros eleitos de dois em dois anos. Os membros permanentes são: Estados Unidos, Rússia, Inglaterra, França e China."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Relações Internacionais", "Pós-Segunda Guerra Mundial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["República Oligárquica", "Presidentes do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Sebastião José de Carvalho e Melo, vulgo Marquês de Pombal, pertencente à pequena nobreza portuguesa, homem que mudou o destino de Portugal e que foi preso conforme disposto no fragmento.",
      "Maria Francisca Isabel Josefa Antónia Gertrudes Rita Joana, vulgo D. Maria I a louca, primeira mulher a assumir o trono Português.",
      "D. José I, rei de Portugal, que teve um reinado glorioso, graças aos esforços, à iniciativa enérgica e à notável persistência de Sebastião José de Carvalho na administração de que se encarregara.",
      "Marquês de Pombal que muito conseguiu com sua administração enérgica, a despeito dos inimigos, da nobreza e da poderosa Companhia de Jesus que, por meio de muitas intrigas, tentavam acabar com seu prestígio junto ao rei."
    ],
    correctAnswer: 2,
    materia: ["História", "Literatura Brasileira"],
    conteudo: ["Período Colonial", "Obras Literárias"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Frações", "Resolução de Problemas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Análise Combinatória", "Permutações"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Conversão de Unidades", "Densidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial", "Volume", "Conversão de Unidades"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Porcentagem", "Aumentos e Descontos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Eletroquímica", "Eletrólitos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Soluções", "Estequiometria", "Titulação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Físico-Química", "pH e pOH"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A fluoxetina não possui atividade óptica.",
      "As funções orgânicas presentes no sildenafil são amina, amida, éter e tiol.",
      "A fórmula molecular da fluoxetina é C17H18F3NO.",
      "A fórmula molecular do sildenafil é C22H28N6O4S."
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Funções Orgânicas", "Nomenclatura e Isomeria"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Os ureteres são dois tubos de aproximadamente 20cm de comprimento cada, que conduzem a urina dos rins para a bexiga.",
      "A uretra é o canal que conduz a urina do interior da bexiga para fora do corpo. Ela termina no pênis ou na vulva.",
      "A bexiga urinária recebe e armazena temporariamente a urina com uma quantidade que pode variar de 400ml até 500ml.",
      "Os rins funcionam como um filtro que retém as impurezas do sangue venoso e o deixa em condições de circular pelo organismo."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Anatomia Humana", "Sistema Urinário"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Imunologia", "Doenças Infecciosas", "Microbiologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Zoologia", "Fisiologia Animal", "Invertebrados", "Vertebrados"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geomorfologia", "Relevo Submarino"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geologia", "Eras Geológicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "No período entre guerras ocorreu, na Itália, a ascensão do fascismo que foi marcado por um nacionalismo exacerbado, uma política de controle sindical e uma perseguição à imprensa.",
      "No decorrer da Segunda Guerra Mundial, o Japão, que tinha a intenção de ampliar seu poder na Ásia, formou um bloco com França e Inglaterra, denominado bloco dos Aliados.",
      "Durante a década de 1920, a Alemanha teve uma crise econômica de grandes proporções, que resultou na diminuição da arrecadação do Estado e no aumento do desemprego.",
      "Os alemães invadiram o território francês em 1940, forçando os franceses a assinarem um armistício que foi extremamente desastroso para a França."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Período Entre Guerras", "Segunda Guerra Mundial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Fontes de Energia", "Meio Ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geopolítica", "Blocos Econômicos", "Organizações Internacionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História", "Geografia"],
    conteudo: ["Primeira República", "Revolta da Armada", "Geografia Humana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Gramática", "Superlativo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Leitura e Interpretação", "Pronomes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Inglês", "Literatura Brasileira"],
    conteudo: ["Vocabulário", "Obras Literárias"],
    imageNames: []
})