...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Semântica", "Neologismos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "\"Em nove dias, o texto foi lido por mais de 5 milhões de pessoas e compartilhado 270 mil vezes no Facebook (inclusive por Mark Zucker-berg)\".",
      ...
      "No início de 2015, um questionário com 36 perguntas e quatro minu-tos ininterruptos de contato visual ficou conhecido por causa de um artigo da escritora Mandy Len Catron”."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação Textual", "Recursos Expressivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Análise de Dados", "Demografia", "Desigualdades Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Elementos da Narrativa", "Estilo Literário"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto Literário", "Personagens"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto Literário", "Temática Literária"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto Literário", "Gêneros Textuais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Textuais", "Crônica", "Teoria da Literatura"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Trabalho e Energia", "Força"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletricidade", "Fontes de Energia", "Indução Eletromagnética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Óptica Geométrica", "Espelhos", "Lentes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica", "Potência Elétrica", "Circuitos Elétricos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História do Brasil", "Era Vargas", "República Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "conservar ideias autoritárias sobre a participação popular na vida política.",
      "inaugurar novos direitos sociais com a vitória da campanha pelas Diretas Já.",
      "incorporar justas punições aos torturadores abrangidos pela Lei de Anistia.",
      "estimular práticas cidadãs em decisões relativas aos investimentos públicos."
    ],
    correctAnswer: 0,
    materia: ["História"],
...
createQuestion({
    ...
    options: [
      "o fim da censura à imprensa e a anistia de todos os presos políticos.",
      "o impedimento do queremismo e a realização de eleições presidenciais.",
      "o combate nacional às ideias autoritárias e a organização mundial de partidos.",
      "o apoio externo às forças democráticas e a manutenção interna de uma ditadura."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História do Brasil", "Estado Novo", "Segunda Guerra Mundial"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "adesão dos proprietários rurais à plena concretização dos direitos humanos.",
      "elaboração da Constituição por pessoas comprometidas com a justiça social.",
      "criação de leis emancipacionistas para a manutenção da Guerra do Paraguai.",
      "mobilização de diferentes grupos sociais em torno da campanha abolicionista."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História do Brasil", "Escravidão no Brasil", "Abolicionismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "partidos operários de composição camponesa e de multidões em paralisação.",
      "manifestações fabris de exigência de salário e de impedimento de grevistas.",
      "associações políticas de discussões sindicais e de simpatia pelos cercamentos.",
      "movimentos sociais de destruição de máquinas e de reivindicações por escrito."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História Geral", "Revolução Industrial", "Movimentos Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Razão e Proporção", "Porcentagem", "Unidades de Medida"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Polinômios", "Funções do 2º Grau"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Retas", "Cálculo de Área"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial", "Sólidos Geométricos", "Volume e Área"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Sistemas de Equações", "Exponenciais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Bioquímica", "Biomoléculas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Separação de Misturas", "Classificação de Misturas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Estequiometria", "Reações Químicas", "Poluição Ambiental"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana", "Sistema Reprodutor Feminino", "Hormônios"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Bioquímica", "Metabolismo Energético", "Respiração Celular"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Biotecnologia", "Engenharia Genética", "Reprodução Humana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Adaptação", "Evolução"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Recursos Hídricos", "Geografia Econômica", "Uso da Água"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Cartografia", "Regionalização", "Demografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Biomas Brasileiros", "Clima", "Vegetação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geopolítica", "Conflitos Internacionais", "Globalização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Demografia", "Transição Demográfica", "Bônus Demográfico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Indústria", "Geografia Econômica", "Regionalização Industrial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Interpretação Textual", "Pronomes e Referentes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Gramática", "Verbos Modais", "Interpretação Textual"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Interpretação Textual", "Propósito do Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Interpretação Textual", "Compreensão de Detalhes"],
    imageNames: []
})