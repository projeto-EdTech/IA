...
createQuestion({
    ...
    options: [
      "sofreu mutações em células somáticas pela ação do Vibranium na época em que o meteorito atingiu Wakanda.",
      "promoveu mutações no RNA das células do Pantera Negra.",
      "provocou mutações dominantes relacionadas aos super-poderes nas células germinativas do Pantera Negra.",
      "é uma planta característica de ambientes de tundra.",
      "estava em estação de floração quando o meteorito caiu, causando mutações em suas células germinativas."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "I - Aumento da exportação de produtos agropecuários. II - Criação em larga escala de represas de pequeno porte.",
      "I - Aumento progressivo da produtividade dos cultivos já existentes. II - Programa amplo de preservação de matas ciliares.",
      "I - Diminuição do comércio interno de produtos agrícolas. II - Aumento da utilização dos aquíferos para abastecimento dos cultivos.",
      "I - Aumento da exportação de produtos agropecuários. II - Programa amplo de preservação de matas ciliares.",
      "I - Diminuição do comércio interno de produtos agrícolas. II - Criação em larga escala de represas de pequeno porte."
    ],
    correctAnswer: 1,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "de água salobra e seu equilíbrio osmótico ocorre por difusão passiva em ambientes hiposmóticos.",
      "de água doce e possui mecanismos de controle osmótico em ambientes hiperosmóticos.",
      "marinho e possui mecanismos de controle osmótico em ambientes hiperosmóticos.",
      "de água doce e não possui mecanismos de controle osmótico em ambientes hiposmóticos.",
      "marinho e não possui mecanismos de controle osmótico em ambientes hiposmóticos."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "muscular, tumoral e quimioterapia.",
      "ósseo, ovariano e fertilização in vitro.",
      "nervoso, tumoral e transplante.",
      "epitelial, ósseo e transfusão sanguínea.",
      "tumoral, nervoso e radioterapia."
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "A maçã mais pesada possui tanta energia cinética quanto a maçã mais leve.",
      "A maçã mais pesada possui o dobro da energia cinética da maçã mais leve.",
      "A maçã mais pesada possui a metade da energia cinética da maçã mais leve.",
      "A maçã mais pesada possui o quádruplo da energia cinética da maçã mais leve.",
      "A maçã mais pesada possui um quarto da energia cinética da maçã mais leve."
    ],
    correctAnswer: 1,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "0",
      "Qµ₀I/πR e aponta na direção -y",
      "Qµ₀I/πR e aponta na direção y",
      "Qµ₀I/πR e aponta na direção -x",
      "Qµ₀I/πR e aponta na direção x"
    ],
    correctAnswer: 1,
    materia: [],
...
createQuestion({
    ...
    options: [
      "As reentrâncias e os recortes do litoral brasileiro, com sua geomorfologia costeira, foram responsáveis pelo impacto ambiental causado pelo derramamento de petróleo.",
      "A presença de correntes marítimas frias em superfície, características dessa região, com elevado potencial de transporte de sedimentos, acentuou a dispersão do petróleo.",
      "A corrente marítima das Falkland (Malvinas), que margeia a costa brasileira até o litoral da região nordeste, com águas frias em superfície, potencializou a dispersão do petróleo.",
      "A reduzida profundidade média do litoral brasileiro favoreceu a dispersão do petróleo ao longo da costa de norte a sul, resultando em impactos negativos, em especial para a fauna marinha.",
      "A corrente marítima do Brasil, que é caracterizada pelo movimento de águas superficiais quentes ao longo da linha de costa e provenientes do Atlântico Equatorial, espalhou o petróleo."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "O fato de o rio meandrante desviar da área urbana instalada nas suas margens, pois o vale estreito é periodicamente inundado, em especial nos eventos climáticos extremos, que submergem os morros na cidade.",
      "A extensão do assentamento urbano que não respeitou os limites do canal fluvial, acabando por aterrá-lo, o que levou à inundação diante de um evento climático extremo, já que os rios não podem ser encobertos.",
      "A área urbana, que se encontra em um fundo de vale plano onde há a presença de um canal de rio meandrante, o qual pode ter suas águas periodicamente extravasadas para a planície de inundação.",
      "O insucesso da prevenção da inundação por meio da retificação do rio, pois se esperava que, mesmo com volumes excessivos de chuvas, as águas do canal fluvial não poderiam ser extravasadas para as margens.",
      "Como a área urbana se encontra em um fundo de vale rugoso, existe maior facilidade para o assentamento, porém com o risco de o rio entrelaçado desviar seu curso único, causando inundações laterais."
    ],
    correctAnswer: 2,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "Formação de um gradiente de pressão entre Ásia e África, com ventos de Sudoeste e rebaixamento do nível da água do mar pela maré de quadratura.",
      "Formação de um gradiente de pressão entre Europa e África, com ventos de Noroeste e elevação do nível da água do mar pela maré de sizígia.",
      "Formação de um gradiente de pressão entre Europa e África, com ventos de Sudeste e elevação do nível da água do mar pela maré de quadratura.",
      "Formação de um gradiente de pressão entre África e Europa, com ventos de Nordeste e rebaixamento do nível da água do mar pela maré de sizígia.",
      "Formação de um gradiente de pressão entre Ásia e Europa, com predomínio de calmarias e vazante do nível da água do mar pela maré neutra."
    ],
    correctAnswer: 1,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "contribui para a manutenção da biodiversidade local.",
      "constitui uma técnica de ponta para o plantio agrícola.",
      "é uma técnica tradicional denominada agricultura itinerante.",
      "tem como objetivo permitir a pecuária extensiva.",
      "apresenta desvantagem em termos de ganho para a flora."
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "A produção de semicondutores está concentrada no sudeste asiático, nos países da 1ª e 2ª geração dos Tigres Asiáticos, tais como Taiwan, Coreia do Sul, Cingapura e Indonésia.",
      "Nos últimos 20 anos, EUA e Europa vêm perdendo destaque na produção de semicondutores em decorrência da queda acentuada de investimentos em pesquisa e inovação.",
      "A crise da falta de semicondutores revela um dos efeitos negativos da globalização: a independência da cadeia produtiva em escala mundial, pouco suscetível a desequilíbrios de oferta e demanda.",
      "A Nova Divisão Internacional do Trabalho indica o predomínio geoeconômico dos países do sudeste asiático, principais produtores de semicondutores, que têm ampliado, através da China, sua participação nesse setor desde sua democratização.",
      "A escassez de semicondutores é resultado de uma interrupção momentânea da produção, em especial no sudeste asiático, devido à falta de matéria-prima, que é o início da cadeia produtiva."
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "Frasco 1: BaSO4, Frasco 2: BaCO3, Frasco 3: Ba(NO3)2",
      "Frasco 1: BaCO3, Frasco 2: BaSO4, Frasco 3: Ba(NO3)2",
      "Frasco 1: Ba(NO3)2, Frasco 2: BaCO3, Frasco 3: BaSO4",
      "Frasco 1: BaSO4, Frasco 2: Ba(NO3)2, Frasco 3: BaCO3",
      "Frasco 1: BaCO3, Frasco 2: Ba(NO3)2, Frasco 3: BaSO4"
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
