createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Interações Intermoleculares", "Solubilidade", "Mudanças de Estado"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Tabela Periódica", "Ligações Químicas", "Propriedades Periódicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Polaridade", "Solubilidade", "Compostos Orgânicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "limoneno (catalisador) p-cimeno → α-terpineno",
      "limoneno + p-cimeno → α-terpineno",
      "limoneno (catalisador) α-terpineno → p-cimeno",
      "limoneno → α-terpineno → p-cimeno"
    ],
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Cinética Química", "Reações Orgânicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Estequiometria", "Concentração das Soluções", "Número de Avogadro"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Radioatividade", "Reações Nucleares"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O diagrama (A) mostra um átomo de Flúor (F) e uma molécula de Clorometano (CH₃Cl) ambos neutros e parados antes da colisão. Após a colisão, mostra uma molécula de Fluormetano (CH₃F) neutra e um íon Cl- (carga negativa) ambos parados.",
      "O diagrama (B) mostra um átomo de Flúor (F) e uma molécula de Clorometano (CH₃Cl) ambos neutros e parados antes da colisão. Após a colisão, mostra uma molécula de Fluormetano (CH₃F) neutra com movimento e um íon Cl- (carga negativa) com movimento no sentido oposto.",
      "O diagrama (C) mostra um átomo de Flúor (F) e uma molécula de Clorometano (CH₃Cl) ambos neutros e parados antes da colisão. Após a colisão, mostra uma molécula de Fluormetano (CH₃F) com carga positiva e movimento e um íon Cl- (carga negativa) com movimento no sentido oposto.",
      "O diagrama (D) mostra um átomo de Flúor (F) e uma molécula de Clorometano (CH₃Cl) ambos neutros e parados antes da colisão. Após a colisão, mostra uma molécula de Fluormetano (CH₃F) com carga negativa e movimento e um íon Cl+ (carga positiva) com movimento no sentido oposto.",
      "O diagrama (E) mostra um átomo de Flúor (F) com movimento e uma molécula de Clorometano (CH₃Cl) com movimento antes da colisão. Após a colisão, mostra uma molécula de Fluormetano (CH₃F) com movimento e um íon Cl- (carga negativa) com movimento no sentido oposto."
    ],
    correctAnswer: 2,
    materia: ["Física", "Química"],
    conteudo: ["Conservação do Momento Linear", "Reações Químicas", "Estrutura Atômica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "A biliverdina, assim como a hemoglobina, é capaz de transportar O₂ para as células do corpo, pois há oxigênio ligado na molécula.",
    ...
    conteudo: ["Bioquímica", "Funções Orgânicas", "Fisiologia Humana"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A estrutura mostra um anel benzeno com dois grupos NO₂ nas posições 2 e 4, ligado a um grupo =N-NH- ligado a um carbono com um grupo metil e um grupo fenil.",
      "A estrutura mostra um anel benzeno com dois grupos NO₂ nas posições 2 e 4, ligado a um grupo =N-N-H- ligado a um carbono com um grupo metil e um grupo fenil. (Note: O H está no N)",
      "A estrutura mostra um anel benzeno com dois grupos NO₂ nas posições 2 e 4, ligado a um grupo =N-N-H ligado a um carbono com um grupo metil e um grupo fenil. (Note: O H está no N ligado ao C)",
      "A estrutura mostra um anel benzeno com dois grupos NO₂ nas posições 2 e 4, ligado a um grupo =N-NH₂.",
      "A estrutura mostra um anel benzeno com dois grupos NO₂ nas posições 2 e 4, ligado a um grupo O=N-N-NH₂."
    ],
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Reações Orgânicas", "Aldeídos e Cetonas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Estados da Matéria", "Diagramas de Fase", "Termodinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Probabilidade", "pH e Soluções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Perímetro e Área"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Teoria dos Números", "Função Totiente de Euler"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Polinômios", "Produtos Notáveis"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Equações", "Problemas de Primeiro Grau"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Cônicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Razão e Proporção", "Climatologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Compreensão de Texto", "Gênero e Tecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de Texto", "Ambiguidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto", "Ideias Principais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Literatura Brasileira", "Modernismo", "Existencialismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Teoria da Literatura", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Poesia", "Figuras de Linguagem", "Semântica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Morfologia", "Semântica", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Pontuação", "Coesão Textual"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Movimentos Sociais", "Gênero e Raça"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Gêneros Textuais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Barroco", "Modernismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Globalização", "Saúde Pública", "Geopolítica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Botânica", "Reprodução de Fungos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Gráfico (A) mostra um crescimento linear gradual até atingir o tamanho adulto.",
      "Gráfico (B) mostra um crescimento linear gradual com uma leve desaceleração no final até atingir o tamanho adulto.",
      "Gráfico (C) mostra um crescimento em forma de 'S', lento no início, rápido no meio e estabilizando no final até atingir o tamanho adulto.",
      "Gráfico (D) mostra um crescimento constante com aumentos abruptos periódicos (degraus) até atingir o tamanho adulto.",
      "Gráfico (E) mostra um crescimento em degraus mais acentuados, com longos períodos de platô e aumentos rápidos, atingindo o tamanho adulto."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Zoologia", "Desenvolvimento dos Insetos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "glicídeo, proteína, ácido nucleico e água."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Citologia", "Bioquímica Celular"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Biologia Molecular", "DNA"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia", "Geografia"],
    conteudo: ["Ecologia", "Meio Ambiente", "Poluição da Água"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Genética", "Imunologia", "Biotecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Pré-História do Brasil", "Arqueologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Provocou gravíssima queda demográfica, que afetou grande parte da produção econômica europeia.",
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Idade Média", "Peste Negra"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["História da África", "Geografia Econômica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Era Vargas", "Direitos Trabalhistas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Brasil Colonial", "Invasões Holandesas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Brasil Contemporâneo", "Ditadura Militar no Brasil", "Movimentos Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História Contemporânea", "Ditaduras na América Latina"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História Moderna", "Revolução Inglesa", "Parlamentarismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Tecnologia e Sociedade", "Comunicação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Gravitação", "Movimento Circular"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Unidades de Medida", "Quantidade de Movimento Angular"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Cinemática", "Sistema Nervoso"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física", "Química"],
    conteudo: ["Gravitação", "Termodinâmica", "Cinética dos Gases"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Energia", "Trabalho e Energia", "Lei de Hooke"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica", "Leis de Ohm"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Oscilações", "Pêndulo Simples", "Dilatação Térmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Cartografia", "Climatologia", "Movimentos da Terra"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia", "Geografia"],
    conteudo: ["Epidemiologia", "Geografia da Saúde"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a construção de rodovias que permitam às populações mais diretamente atingidas pela seca se deslocarem diariamente para áreas mais úmidas.",
      "o uso das áreas de meia encosta como alternativa para expansão das áreas de produção de culturas temporárias e lavouras permanentes.",
      "o plantio de espécies exóticas que apresentam crescimento rápido e podem reduzir os efeitos da desertificação e da seca, como o eucalipto, por exemplo.",
      "a prevenção, recuperação e reabilitação de terras parcial ou totalmente degradadas com a recomposição de espécies nativas.",
      "os programas de incentivo para a instalação de fossas sépticas que dispensam a implantação de um sistema hídrico de saneamento básico."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Meio Ambiente", "Degradação Ambiental"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geografia Agrária", "População e Economia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "essa é a razão do grande déficit econômico dos Estados Unidos atualmente, uma vez que a maior parte dos negócios e transações é feita pela internet.",
      "essa situação explica o fato de que os Estados Unidos tenham, atualmente, a maior dívida pública do planeta, já que os custos com o tratamento de dados são muito altos.",
      "em um mundo cada vez mais dependente dos fluxos imateriais de informação, a presença de objetos técnicos fixos torna-se irrelevante para a posição geopolítica dos Estados Unidos.",
      "o mapa representa, por meio do \"trânsito de internet\" e do fluxo de \"ligações telefônicas\", uma globalização que integrou completamente tanto os norte-americanos quanto as populações da África.",
      "a presença de fixos, como algumas instalações de armazenagem e conexão, influencia a orientação de fluxos e dá aos EUA uma posição de destaque no contexto geopolítico."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Globalização", "Geopolítica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Desastres Naturais", "Vulnerabilidade Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Geografia"],
    conteudo: ["Relações Internacionais", "Geopolítica", "Oriente Médio"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "as características topográficas, geológicas e geomorfológicas de uma área de risco estão naturalmente ligadas aos escorregamentos, sendo que estradas de terra minimizam a ocorrência de deslizamentos.",
      "a ocorrência de escorregamentos é causada pela ação humana, cuja ocupação de encostas provoca o empobrecimento de solo, que acaba sendo mobilizado pela diminuição de fertilidade.",
      "o problema da ocupação de encostas e risco de escorregamentos inclui o contato entre a rocha e o solo, cuja facilidade de deslizamento é aumentada em função da inclinação do terreno e da maior ocorrência de chuvas.",
      "os deslizamentos de terra fazem parte de um conjunto de fenômenos naturais pontuais e incomuns na superfície da crosta terrestre e, portanto, não participam da escultura do relevo continental e do modelado.",
      "os escorregamentos são causados em especial pelo fato de o solo tornar-se mais leve que a rocha subjacente durante as chuvas prolongadas de verão, facilitando seu deslizamento ao longo das encostas pouco ou nada inclinadas."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geomorfologia", "Meio Ambiente", "Riscos Ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Floresta Temperada, Floresta de Coníferas, Floresta Tropical, Exposição de Rocha, Tundra, Neve e Gelo.",
      "Floresta Temperada, Floresta Tropical, Floresta de Coníferas, Exposição de Rocha, Tundra, Neve e Gelo.",
      "Floresta Tropical, Floresta de Coníferas, Floresta Temperada, Tundra, Exposição de Rocha, Neve e Gelo.",
      "Floresta Tropical, Floresta Temperada, Floresta de Coníferas, Tundra, Exposição de Rocha, Neve e Gelo.",
      "Floresta Tropical, Floresta de Coníferas, Tundra, Floresta Temperada, Exposição de Rocha, Neve e Gelo."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Biogeografia", "Climatologia"],
    imageNames: []
})