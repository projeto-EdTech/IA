...
createQuestion({
    ...
    options: [
      "decantação; H₃CCl.",
      "destilação fracionada; CCl₄.",
      "cristalização; HCCl₃.",
      "destilação fracionada; H₂CCl₂.",
      "decantação; CCl₄ ."
    ],
    correctAnswer: 3,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "Etapa 2: HCN é insolúvel em água, formando um precipitado. Etapa 3: HCN é volatilizado durante a torração, sendo liberado no ar.",
      "Etapa 2: HCN é insolúvel em água, formando uma única fase na manipueira. Etapa 3: HCN permanece na massa torrada, não sendo afetado pela temperatura.",
      "Etapa 2: HCN é solúvel em água, sendo levado na manipueira. Etapa 3: HCN permanece na massa torrada, não sendo afetado pela temperatura.",
      "Etapa 2: HCN é solúvel em água, sendo levado na manipueira. Etapa 3: HCN é volatilizado durante a torração, sendo liberado no ar.",
      "Etapa 2: HCN é insolúvel em água, formando um precipitado. Etapa 3: A 160 °C, a ligação C≡N é quebrada, degradando as moléculas de HCN."
    ],
    correctAnswer: 3,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "a veia cava superior transporta sangue pobre em oxigênio, coletado da cabeça, dos braços e da parte superior do tronco, e chega ao átrio esquerdo do coração.",
      "a veia cava inferior transporta sangue pobre em oxigênio, coletado da parte inferior do tronco e dos membros inferiores, e chega ao átrio direito do coração.",
      "a artéria pulmonar transporta sangue rico em oxigênio, do coração até os pulmões.",
      "as veias pulmonares transportam sangue rico em oxigênio, dos pulmões até o átrio direito do coração.",
      "a artéria aorta transporta sangue rico em oxigênio para o corpo, por meio da circulação sistêmica, e sai do ventrículo direito do coração."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana"],
...
createQuestion({
    ...
    options: [
      "pequenas com estômatos concentrados na parte inferior, muitos tricomas claros, cutícula impermeável e parênquima aquífero.",
      "grandes com estômatos concentrados na parte inferior, poucos tricomas claros, cutícula impermeável e parênquima aerífero.",
      "pequenas com estômatos concentrados na parte superior, ausência de tricomas, cera sobre a epiderme foliar e parênquima aquífero.",
      "grandes com estômatos igualmente distribuídos em ambas as partes, ausência de tricomas, ausência de cera sobre a epiderme foliar e parênquima aerífero.",
      "pequenas com estômatos concentrados na parte superior, muitos tricomas claros, cera sobre a epiderme foliar e parênquima aerífero."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Botânica"],
...
createQuestion({
    ...
    options: [
      "I: redução; autotrófico. II: redução; autotrófico. III: oxidação; heterotrófico e autotrófico.",
      "I: oxidação; autotrófico. II: oxidação; heterotrófico. III: oxidação; autotrófico.",
      "I: redução; autotrófico. II: oxidação; autotrófico. III: oxidação; heterotrófico e autotrófico.",
...
createQuestion({
    ...
    options: [
      "com padrões concentrados na parte interna dos giros oceânicos do Pacífico norte e sul, locais de menor atividade das grandes correntes marinhas.",
      "com maior acumulação no litoral de ambos os hemisférios, devido à atuação de importantes correntes marinhas nessas áreas.",
      "mais volumosos no hemisfério norte, em função das menores temperaturas de suas águas, o que faz aumentar a velocidade de correntes, como a do Peru e a do Japão.",
      "com concentrações idênticas em ambos os hemisférios, devido à forte atuação de importantes correntes marinhas que transitam do hemisfério norte ao sul.",
      "mais concentrados e abundantes no hemisfério norte, devido à grande mobilidade de importantes correntes marinhas, como a de Humboldt e a de Madagascar."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "Houve uma forte redução do preço do barril, no início da década de 1970, por conta dos resultados das pesquisas envolvendo novos procedimentos de extração e refino.",
      "A estatização, no Brasil, do transporte e do refino de petróleo iniciou-se no final dos anos 1930 sob o governo de Juscelino Kubitschek.",
      "O início de seu uso como fonte de energia se deu em 1920, na Inglaterra, com a descoberta de reservas pouco profundas.",
      "No final dos anos 1920, sete empresas petrolíferas mundiais constituíram um cartel controlador da extração, transporte, refino e distribuição do petróleo.",
      "Os Estados Unidos possuem reservas ilimitadas de petróleo, o que ocasiona independência em relação aos países participantes da OPEP."
    ],
    correctAnswer: 3,
    materia: ["História"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Tecnologia e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "despreço por esculturas de corpo inteiro.",
