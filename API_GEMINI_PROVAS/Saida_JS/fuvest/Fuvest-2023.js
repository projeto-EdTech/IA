createQuestion({
    ...
    options: [
      "o impacto causado pela atividade de pesca alterou a produtividade primária do local, o que resultou em uma população de peixes menores ao longo do tempo.",
      "a população não conseguiu recuperar sua abundância de indivíduos após a atividade de pesca, o que a levará ao colapso a médio e longo prazos.",
      "os indivíduos maiores não conseguem se reproduzir depois da pesca devido ao estresse fisiológico causado por essa atividade.",
      "essa atividade de pesca é sustentável a longo prazo e não causa impacto à população de peixes daquele local.",
      "a pesca priorizou os peixes maiores, causando uma seleção artificial que resultou em uma população de peixes menores ao longo do tempo."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "I: tropical, II: temperaturas mínimas altas e muita chuva nos meses mais frios",
      "I: temperado, II: temperaturas mínimas baixas e pouca chuva nos meses mais quentes",
      "I: tropical, II: temperaturas mínimas altas e pouca chuva nos meses mais quentes",
      "I: temperado, II: temperaturas mínimas baixas e pouca chuva nos meses mais frios",
      "I: equatorial, II: temperaturas mínimas baixas e muita chuva nos meses mais quentes"
    ],
    correctAnswer: 3,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "diminuição da perda de água devido às folhas modificadas em espinhos.",
      "menor taxa de fotossíntese, por apresentarem menor área de superfície foliar.",
      "presença de células especializadas no parênquima aquífero do caule da planta.",
      "raiz avantajada que capta melhor a água disponível na superfície do solo.",
      "adaptação das folhas que podem acumular água em seu interior."
    ],
    correctAnswer: 2,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "mais alta nas regiões onde predominam florestas e mais baixa nas regiões onde predomina vegetação mais aberta.",
      "igualmente alta nas regiões tropicais e mais baixa nas regiões subtropicais.",
      "igualmente baixa nas regiões mais orientais e mais alta nas regiões ocidentais.",
      "mais alta nas regiões mais quentes e mais baixa nas regiões mais frias.",
      "mais alta nas regiões que se situam mais próximas ao mar e mais baixa nas regiões mais interiores."
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "às maiores altitudes da Serra da Mantiqueira, que contribuem para reduzir a temperatura do ar.",
      "às baixas altitudes do Vale do rio Ribeira de Iguape, que contribuem para a entrada de ar frio.",
      "ao efeito da maritimidade, que injeta ar frio para o continente, diminuindo a temperatura do ar.",
      "às grandes extensões do Planalto Ocidental Paulista, que favorecem o acúmulo de ar frio.",
      "à ausência de cobertura vegetal em grande parte do território paulista, que potencializa o resfriamento noturno."
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "Ação eólica, erupções vulcânicas e soerguimento de cadeias montanhosas.",
      "Depósitos minerais, abalos sísmicos e erupções vulcânicas.",
      "Formação de cavernas, ação eólica e soerguimento de cadeias montanhosas.",
      "Erupções vulcânicas, abalos sísmicos e depósitos minerais.",
      "Ação eólica, formação de cavernas e soerguimento de cadeias montanhosas."
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "Os topos mais aplainados dos morros ou a área de terraços fluviais, partes mais planas do relevo; no entanto, variações nas cheias dos rios podem atingir as áreas de terraços, e a ocupação dos topos pode comprometer as áreas de nascentes.",
      "Entre os morros e a planície, áreas de maior declividade sujeitas a desabamentos; também deve evitar os terraços fluviais por possuírem sedimentos consolidados, propensos à erosão.",
      "O sopé das encostas dos morros ou a área da planície fluvial, partes planas do relevo sem risco de deslizamentos de terra; além disso, a captação das águas para abastecimento público pode ser aproveitada pela proximidade do canal fluvial.",
      "As áreas de planície com sedimentos inconsolidados resultantes das rochas cristalinas friáveis; além disso, o desmatamento e acúmulo de lixo nas inundações podem soterrar o curso fluvial retilíneo.",
      "Os morros com encostas mais inclinadas, suscetíveis a deslizamentos e assoreamentos; estes acabam por prejudicar a conservação das áreas de nascentes que estão a jusante dos setores mais elevados."
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "tanto a bacia do rio Tocantins quanto a do São Francisco são ameaçadas por contaminação de agrotóxicos nas áreas do Chapadão, cujos divisores topográficos não impedem os fluxos subterrâneos das substâncias utilizadas nas monoculturas.",
      "a maior parte das áreas cultivadas localiza-se no estado do Tocantins, sendo erodidas pelos rios sem conexão com o topo do Chapadão Ocidental Baiano, o que dificulta a dispersão dos agrotóxicos.",
      "a bacia do rio São Francisco é ameaçada pelos agrotóxicos, pois os divisores de águas nas áreas do Chapadão tendem a fluir as substâncias nas drenagens somente para o estado da Bahia.",
      "tanto a bacia do rio Tocantins quanto do rio São Francisco se encontram distantes das áreas de topo do Chapadão Ocidental Baiano onde estão as monoculturas, dificultando a efluência dos agrotóxicos em ambos.",
      "a bacia do rio Tocantins é mais ameaçada do que a do São Francisco pela contaminação originada do uso de agrotóxicos, pois os divisores de águas convergem para o estado do Tocantins."
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      ...
      "os resíduos agrícolas têm pouca contribuição no total emitido à atmosfera na forma de cloretos e sulfetos originados de seu intemperismo, com baixos teores de carbono.",
      "os processos industriais contribuem com emissões significativas de GEE na forma de gás metano, resultante da atividade microbiana sobre os compostos nitrogenados.",
      "as mudanças no uso da terra, em que há a substituição de florestas por áreas cultivadas, respondem por cerca de metade da emissão de GEE a partir de bactérias e fungos.",
      "o setor de energia é um grande emissor de GEE na forma de óxido nítrico, metano e dióxido de carbono, resultantes de todos os processos de geração de energia."
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      ...
      "3,2%",
      "7,4%",
      "O conteúdo de água não afeta o transporte."
    ],
    correctAnswer: 2,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      ...
      "Total de população urbana.",
      "Produção de petróleo.",
      "Refugiados conforme o país de origem."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "à nação na Itália recém-unificada.",
      "à divisão da Itália por Vittorio Emanuele II.",
      "aos ideais republicanos que deram origem ao país.",
      "aos antigos reinos e ao domínio estrangeiro.",
      "à reconstrução do antigo Império romano."
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "a interação mais forte ocorre entre SO3 е MeCN.",
...
createQuestion({
    ...
    options: [
      "Nos pulmões, onde a concentração de oxigênio é mais elevada, a forma de hemoglobina favorecida é a protonada.",
      "Nos tecidos humanos, onde é consumido O2 pelo metabolismo, a forma de hemoglobina favorecida é a HbO2.",
      "Quando uma pessoa expira mais depressa que o normal, a concentração de dióxido de carbono no seu sangue diminui e, nessas situações, a forma de hemoglobina favorecida é a forma protonada.",
      "Nos tecidos humanos, onde é liberado dióxido de carbono produzido pelo metabolismo, a forma de hemoglobina favorecida é a forma protonada.",
      "Nos tecidos humanos, onde é liberado dióxido de carbono produzido pelo metabolismo, a forma de hemoglobina favorecida é a HbO2."
    ],
    correctAnswer: 3,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "Por possuírem Kow muito baixo, os POPs não se solubilizam nem na água nem no octanol.",
      "O Kow não pode ser determinado para os POPs, pois octanol e água são completamente miscíveis.",
      "Uma vez que os POPs se magnificam ao longo da teia trófica, sua concentração é maior em produtores primários.",
      "Os compostos clorados são pouco solúveis em água, de forma que o NaCl pode ser considerado um POP.",
      "POPs possuem Kow elevado, solubilizando-se mais facilmente na fase orgânica por serem substâncias lipossolúveis."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "em lavouras intensivas, em pequenas propriedades, com baixa produtividade e pouco emprego de tecnologia, direcionadas ao mercado internacional de commodities, principalmente no Centro-Sul do país.",
      "em lavouras extensivas, com elevado emprego de mão de obra, altíssima mecanização, com predomínio de adoção de práticas conservacionistas e baixo impacto ambiental, principalmente na região Norte do país.",
      "em lavouras destinadas ao abastecimento do mercado interno, intensamente mecanizadas, com predomínio de grandes propriedades e com baixo impacto ambiental, principalmente na região Nordeste do país.",
      "em lavouras mecanizadas, destinadas ao mercado internacional, com predomínio do emprego de mão de obra especializada, principalmente no Centro-Sul do país.",
      "em lavouras extensivas, destinadas ao mercado externo, com alta mecanização e emprego de mão de obra especializada, principalmente nas regiões Norte e Nordeste do país."
    ],
    correctAnswer: 3,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "criará uma nova espécie de planta resistente a herbicidas.",
      "será realizada nos plastos ou mitocôndrias das plantas.",
      "permitirá que bactérias fixadoras de nitrogênio se tornem mais eficientes.",
      "fará com que as células bacterianas sejam incorporadas nos tecidos das plantas.",
      "gerará riscos para o consumo humano pela possibilidade de ingestão de genes de bactérias."
    ],
    correctAnswer: 1,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "Há menor herbivoria sobre essa população em áreas urbanas.",
      "Há uma abundância maior de insetos herbívoros em áreas urbanas.",
      "Essa espécie de erva daninha não consegue sobreviver em áreas de florestas.",
      "Há competição interespecífica entre os indivíduos que produzem ou não o composto.",
      "A produção ou não do composto corresponde a duas espécies diferentes."
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "um competidor e um herbívoro.",
      "um parasita e um comensal.",
      "um competidor e um parasita.",
      "um mutualista e um herbívoro.",
      "um comensal e um mutualista."
    ],
    correctAnswer: 3,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "I: mitocôndria e II: morando em zonas urbanas.",
      "I: mitocôndria e II: ingerindo antibióticos.",
      "I: núcleo e II: eutanasiando cães infectados.",
      "I: lisossomo e II: tratando esgotos.",
      "I: lisossomo e II: utilizando repelente."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      ...
      "Um conjunto de indivíduos de nacionalidade estrangeira cujos hábitos e costumes contrastam com os da população local.",
...
createQuestion({
    ...
    options: [
      "O período do governo de João Goulart foi marcado pela apatia da sociedade civil.",
      "A presença ostensiva das Forças Armadas impediu a realização do Comício.",
      "O cartaz assinado por metalúrgicos defendia a família, a religião e a propriedade.",
      "Os manifestantes expressaram apoio aos avanços nas Reformas de Base anunciados no Comício.",
      "Os manifestantes reclamavam a intervenção militar para conter políticas do governo João Goulart."
    ],
    correctAnswer: 3,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "O poder central sofreria uma redução de sua autoridade, levando ao declínio da União Soviética.",
      "O poder central seria mantido, apesar das proclamações de soberania das repúblicas.",
      "As forças centrífugas seriam contidas, e a União Soviética se fortaleceria.",
      "A primazia das leis nacionais resultaria em maior autonomia, mas sem a desintegração da União Soviética.",
      "O poder central seria reforçado para conter os movimentos separatistas."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "o filho leva o pai a uma reflexão inócua a respeito do patrimônio público.",
      "o patrimônio público é restrito a equipamentos dispostos nas vias de uma cidade.",
      "as lixeiras e as placas de trânsito não fazem parte do patrimônio público.",
      "a destruição de hospitais, universidades, florestas e estatais é também crime de dano ao patrimônio público.",
      "o pai e o filho discordam quanto aos efeitos da depreciação do patrimônio público."
    ],
    correctAnswer: 3,
    materia: [],
    conteudo: [],
