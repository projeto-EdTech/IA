createQuestion({
    ...
    options: [
      "O copo funciona como uma lente divergente, sendo que os raios refletidos do ovo passam de um meio menos refringente (água) para um meio mais refringente (ar).",
      "O copo funciona como uma lente convergente, sendo que os raios refletidos do ovo passam de um meio mais refringente (água) para um meio menos refringente (ar).",
      "O copo funciona como uma lente divergente e, neste caso, para o ovo (objeto real), a lente proporciona ao observador a formação de uma imagem real, invertida e ampliada.",
      "O copo funciona como uma lente convergente e, neste caso, para o ovo (objeto real), a lente proporciona ao observador a formação de uma imagem real, direita e ampliada.",
      "O copo funciona como uma lente convergente e, neste caso, para o ovo (objeto real), a lente proporciona ao observador a formação de uma imagem virtual, invertida e ampliada."
    ],
    correctAnswer: 1,
    materia: ["Física"],
...
createQuestion({
    ...
    options: [
      "Constitui um circuito a partir do qual é possível conferir no cotidiano as relações que até então eram invisíveis.",
      "Requer que a percepção seja ativada por um movimento, e isso resulta em olhar para o mundo de modo acelerado.",
      "Demonstra a alteração do campo perceptual de modo que o ponto de vista cotidiano apreenda os grandes eventos.",
      "Repercute os sentidos da vida cotidiana ligados à alimentação e, por essa razão, nos apresenta elementos advindos dela.",
      "Sugere que os objetos presentes no cotidiano, como texto, copo, água e ovo, são obras de arte."
    ],
    correctAnswer: 0,
    materia: ["Arte"],
...
createQuestion({
    ...
    options: [
      "CaCO3 com CH3COOH, formando acetato de cálcio e ácido carbônico; osmose; a densidade da água salgada é maior do que a da água pura; osmose; vaporização; flutuar porque sua densidade é menor que a da água.",
      "CaCO3 com lipídeos, formando ácido graxo e ácido carbônico; osmose reversa; a densidade da água salgada é menor que a da água pura; osmose; osmose; afundar porque sua densidade é maior que a da água.",
      "CaCO3 com proteína, formando aminoácido e ácido carbônico; osmose; a densidade da água salgada é menor que a da água pura; osmose; vaporização; afundar porque sua densidade é menor que a da água.",
      "CaCO3 com CH3COOH, formando ácido graxo e ácido carbônico; osmose; a densidade da água salgada é maior que a da água pura; osmose; osmose; flutuar, pois sua densidade é menor que a da água.",
      "CaCO3 com CH3COOH, formando acetato de cálcio e água; osmose reversa; a densidade da água salgada é maior que a da água pura; osmose reversa; vaporização; flutuar, pois sua densidade é menor que a da água."
    ],
    correctAnswer: 0,
    materia: ["Química", "Biologia", "Física"],
    conteudo: ["Reações Químicas", "Osmose", "Densidade e Flutuação"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Geometria Espacial", "Equações", "Hidrostática"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A teoria da geração espontânea, ou biogênese, por considerar a multiplicidade de formas de vida existente, defende a concepção atualmente aceita, segundo a qual seres vivos podem surgir por mecanismos que não sejam através da reprodução.",
      "Para a Panspermia, a vida na Terra é resultado de processos químicos em que compostos orgânicos se combinaram formando moléculas inorgânicas complexas, as quais deram origem aos seres vivos com capacidade de reprodução.",
      "Segundo a hipótese autotrófica, os primeiros seres vivos, por serem muito simples, não teriam mecanismos celulares desenvolvidos para capacitá-los a produzir substâncias alimentares, obrigando-os a utilizar as substâncias disponíveis no meio.",
      "É preconizado pela hipótese heterotrófica que a partir da energia consumida por reações químicas entre componentes orgânicos da crosta terrestre, os primeiros seres vivos produziam suas próprias substâncias alimentares.",
      "Para a hipótese autotrófica, com a formação da camada de ozônio na estratosfera, por consequência da presença do gás oxigênio na atmosfera terrestre, os seres vivos, antes restritos aos ambientes aquáticos, passaram a colonizar ambientes de terra firme."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "Em uma sociedade dividida em ordens, a Dança Macabra foi interpretada como uma crítica social que nivelava os estamentos em face do fenômeno da morte.",
      "Na gravura, dois personagens são conduzidos por figuras macabras, revelando que, devido às péssimas condições de vida, os camponeses eram os que mais temiam a morte.",
      "Na maioria dos países, a epidemia de Peste Negra assolou burgos e castelos, mas preservou os camponeses do contágio, por estarem eles isolados no campo.",
      "Por viverem nos mosteiros, os membros da Igreja foram poupados da Peste Negra, reforçando a imagem do clero como estamento de origem divina.",
      "Devido ao grande número de vítimas da Peste Negra, a sociedade na Baixa Idade Média se tornou indiferente à morte, entendendo-a apenas como uma passagem à vida eterna."
    ],
    correctAnswer: 0,
    materia: ["História"],
...
createQuestion({
    ...
    options: [
      "Um protozoário, adquirido pelo contato com as fezes da pulga que defeca ao picar.",
      "Uma bactéria, transmitida através da picada da pulga contaminada.",
      "Um protozoário, transmitido pela saliva da pulga contaminada.",
      "Uma bactéria, adquirida pelo contato com as fezes da pulga através do ferimento da picada.",
      "Um vírus, transmitido pela picada da pulga contaminada."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "O surto de febre amarela no ano de 2017 atingiu as duas metrópoles nacionais da região sul do país.",
      "Os fatores climáticos como temperatura, umidade e duração da estação chuvosa têm implicações na disseminação da febre amarela no interior do país.",
      "A febre amarela está restrita aos municípios localizados nos domínios morfoclimáticos Amazônico e de Cerrado.",
      "A expansão do vírus em direção ao interior chegou ao oeste paulista devido à presença de condomínios próximos a reservas florestais.",
      "A recomendação temporária para a vacinação é para os três estados mais populosos do país: Espírito Santo, Bahia e Rio Grande do Sul."
    ],
    correctAnswer: 1,
    materia: ["Geografia", "Biologia"],
    conteudo: ["Climatologia", "Saúde Pública", "Virologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Arte"],
    conteudo: ["História do Teatro", "Arte Contemporânea"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Leis de Newton", "Força de Atrito"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Para teóricos do \"fim da linha\" ou do \"fim da história\", a pós-modernidade está marcada pela ausência de perspectivas para superar a cristalização de valores, práticas e projetos sociais defendidos na época da modernidade.",
      "O \"fim da linha\" é o reconhecimento de que os valores criados pela modernidade foram cumpridos, restando às novas gerações, garanti-los sem alterações significativas."
    ],
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Modernidade e Pós-Modernidade", "Movimentos Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "o volume de lama deslocado (Vi) é igual ao volume total do aparelho de TV (Vt).",
      "o módulo do seu peso (P) é igual ao módulo do empuxo (E) exercido pela lama.",
      "a densidade do aparelho de TV é maior que a densidade da lama.",
      "o módulo do empuxo (E) exercido pela lama é maior que o módulo do seu peso (P)."
    ],
    correctAnswer: 2,
    materia: ["Física"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Impactos Ambientais", "Geografia Econômica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "O darwinismo social é a base da concepção materialista da história na medida em que esta teoria demonstra cientificamente que somente os mais aptos podem sobreviver e dominar, sendo os capitalistas um exemplo.",
    ...
    conteudo: ["Marxismo", "Teorias Sociológicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Classes Sociais", "Teorias Sociológicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O preceito metodológico do \"trato direto das coisas” supõe que cada um já possui em si as condições para realizar a investigação da natureza.",
      "A investigação da natureza consiste em aplicar um conjunto de pressupostos metafísicos, cuja função é orientar a investigação.",
      "As \"séries e ordens\" referentes aos fatos particulares resultam da aplicação dos pressupostos do método de investigação.",
      "A renúncia às noções que cada um possui é o princípio do método de investigação, que levará a ida aos fatos particulares.",
      "O método de interpretação da natureza propõe uma nova atitude com relação às coisas e uma nova compreensão dos poderes do intelecto."
    ],
    correctAnswer: 4,
    materia: ["Filosofia"],
...
createQuestion({
    ...
    options: [
      "a intensificação do nacionalismo e a defesa de políticas protecionistas animadas pela crise mundial dos empregos, disputados em maior intensidade no contexto dos deslocamentos de grandes contingentes populacionais.",
      "a defesa intransigente do Estado laico, capaz de concretizar os valores da ciência e da razão, em detrimento da vinculação aos ideais fornecidos pelos diversos matizes de religião existentes no mundo moderno.",
      "a recusa aos princípios da meritocracia, uma vez que esta atende a algumas centenas de privilegiados contemplados com as políticas compensatórias conduzidas pelos governos nacionais das mais variadas tendências.",
      "o tratamento das questões sociais via valorização da perspectiva dialógica, eliminando, assim, o uso de medidas coercitivas nos espaços público e privado.",
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Tendências Contemporâneas", "Nacionalismo", "Globalização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Juventude", "Desigualdade Social", "Violência"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Demografia", "Indicadores Socioeconômicos", "Qualidade de Vida"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Antiga", "Ética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Funções", "Análise de Sentenças Lógicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O êxodo rural causado pelos ataques dos povos germânicos resultou num crescimento desordenado das cidades, criando instabilidade e desordem política nos centros urbanos e forçando a abdicação do último imperador romano.",
      "O paganismo introduzido no Império Romano pelas tribos germânicas enfraqueceu o cristianismo e causou a divisão entre cristãos católicos e ortodoxos, encerrando o apoio da Igreja ao imperador e consequentemente fazendo ruir o império.",
      "A língua oficial do Império Romano, o latim, ao se fundir com os idiomas falados pelos invasores, deu origem às línguas germânicas, dificultando a administração dos territórios que se tornaram cada vez mais autônomos até se separarem de Roma.",
      "A disputa entre os patrícios romanos e a plebe pelas terras férteis facilitou a invasão do império pelos \"povos bárbaros\", pois o exército romano foi obrigado a deixar as fronteiras desguarnecidas para defender os proprietários das terras das constantes rebeliões.",
      "Com o fim das conquistas territoriais, o escravismo e a produção entraram em declínio, somado às \"invasões bárbaras\" e à ascensão do cristianismo, que aceleraram a fragmentação e queda de Roma."
    ],
    correctAnswer: 4,
    materia: ["História"],
...
createQuestion({
    ...
    options: [
      "estruturada fundamentalmente na base econômica da sociedade, que subordina as esferas política, jurídica e ideológica de modo a perpetuar a exploração da classe dominante sobre a dominada.",
      "formada pelas dimensões econômica, política e ideológica, as quais estabelecem entre si relações necessárias que devem ser desvendadas com a descoberta de suas leis gerais invariáveis.",
      "constituída em três dimensões, a econômica, a política e a social, sendo que suas possíveis afinidades eletivas devem ser analisadas à luz de cada especificidade histórica em questão.",
      "composta por múltiplas dimensões, sendo a cultura a determinante para a compreensão totalizante dos processos históricos de desenvolvimento econômico no Ocidente.",
      "estabelecida pela moral social, a qual situa o posicionamento dos indivíduos de acordo com os papéis sociais por eles cumpridos, tendo em vista o melhor desempenho das funções necessárias à sociedade."
    ],
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Estratificação Social", "Max Weber"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Hidrografia Brasileira", "Questões Ambientais Urbanas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "No decorrer do segundo Reinado, a Lei de Terras, promulgada em 1850, possibilitou o livre acesso das terras devolutas aos primeiros imigrantes europeus, garantindo-lhes a sobrevivência.",
      "Na Colônia, as terras doadas como sesmarias garantiam privilégios aos senhores de engenho, mas restringiam a prática de certas atividades econômicas.",
      "No Império, formaram-se os primeiros quilombos cuja propriedade dessas terras foi reconhecida legalmente durante a primeira República.",
      "Em 1964, João Goulart realizou desapropriações das pequenas propriedades no entorno das metrópoles para o cultivo de sobrevivência por parte dos trabalhadores.",
      "No governo de Fernando Henrique Cardoso (1995-2002), retomou-se a política econômica de estatização das propriedades agrícolas resultando em elevadas taxas de crescimento econômico."
    ],
    correctAnswer: 1,
    materia: ["História", "Geografia"],
    conteudo: ["Brasil Colonial", "Questão Agrária"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Nas angiospermas, a semente é um óvulo imaturo envolvido por cinco camadas de tecidos parenquimáticos que formam os estróbilos masculino e feminino.",
      "A dependência de água para a fecundação nas gimnospermas possibilita a dispersão de suas sementes nas mais diferentes regiões do planeta.",
      "À semente das angiospermas é atribuído um valor significativo de sobrevivência porque ela confere nutrição ao embrião até que ocorra a germinação.",
      "As sementes das gimnospermas são protegidas por um carpelo queratinizado, o que dificulta a sua ingestão e dispersão pelos animais frugívoros.",
      "A germinação das sementes de gimnospermas ocorre na forma hipógea, ou seja, os cotilédones são trazidos para fora do solo, o que lhes confere uma vantagem evolutiva."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Botânica"],
...
createQuestion({
    ...
    conteudo: ["Termodinâmica", "Funções Exponenciais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "O íon Fe2+ é um ácido de Arrhenius e a molécula de orto-fenantrolina é um ácido de Arrhenius.",
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Cinética Química", "Reações de Combustão"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Revoluções Industriais", "Recursos Naturais", "Tecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A engrenagem C gira a 800 rpm e sentido antihorário.",
      "A engrenagem B gira a 40 rpm e sentido horário.",
      "A engrenagem B gira a 800 rpm e sentido antihorário.",
      "A engrenagem C gira a 80 rpm e sentido antihorário.",
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Álgebra", "Razão e Proporção"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Mundo do Trabalho", "Globalização"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As universidades na Europa Ocidental do século XII conquistaram o direito de autonomia perante os poderes eclesiásticos, comunais e monárquicos para o livre exercício de suas funções de pesquisa e formação profissional.",
      "Os chamados Tigres Asiáticos. Hong Kong, Taiwan, Coreia do Sul e Cingapura tiveram um excepcional crescimento econômico e científico na década de 1970 devido ao elevado investimento privado na educação.",
      "O período Macartista nos EUA propiciou ao campo da ciência e tecnologia uma liberdade plena para as atividades dos educadores e cientistas independentemente de suas ideologias.",
      "A ideologia da globalização neoliberal, por valorizar os empreendimentos privados, dispensa a realização de pesquisas com fomento público no Brasil, sobretudo por ser o agronegócio a vocação natural do país.",
      "Os fundamentos da ciência econômica do inglês David Ricardo foram importados pelo Cardeal Richelieu, que os aplicou na França, levando-a à bancarrota, o que propiciou o Terror."
    ],
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["História das Universidades", "História da Ciência", "Educação"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A pintura feita com guache é uma característica desse período, que consiste na mistura de alguns tipos de terra; tais pinturas serviam para catalogar o que haviam caçado, garantindo a diversidade de espécies nas caças seguintes.",
      "As pinturas e os desenhos foram feitos com pigmentos minerais e vegetais, fixados com gordura animal; tais produções são relacionadas a aspectos mágicos, presentes no cotidiano das organizações pré-históricas.",
      "As pinturas funcionavam como oferenda aos deuses e, pelas dimensões, é possível perceber o nível de reverência; os artistas desse período empenhavam-se na produção de uma arte religiosa com fins decorativos.",
      "As pinturas e os desenhos encontrados nas grutas eram feitos como afrescos e representam figuras híbridas, metade humana e metade animal; os mitos gregos têm suas origens nessas imagens da pré-história.",
      "Nos registros encontrados nas cavernas, as figuras de destaque remetem à flora; para os povos paleolíticos esses desenhos caracterizaram o momento em que deixaram de ser nômades e, para a história, foi o início das catalogações de todas as espécies."
    ],
    correctAnswer: 1,
    materia: ["Arte", "História"],
    conteudo: ["História da Arte", "Pré-História"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Física Nuclear", "Radioatividade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Europa - Nordeste da Ásia – América do Norte – Indonésia - Austrália.",
      "Sudeste da Ásia – Europa – Nordeste da Ásia – América do Norte - América do Sul.",
      "Sudeste da Ásia – Europa – América do Norte – América do Sul - Austrália.",
      "Europa América do Norte - América do Sul - Austrália - Sudeste da Ásia.",
      "Europa - Nordeste da Ásia – América do Norte – América do Sul - Oceania."
    ],
    correctAnswer: 1,
    materia: ["História", "Geografia"],
    conteudo: ["Pré-História", "Biogeografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A área do Contestado encontra-se na depressão periférica da Bacia do Paraná, segundo a classificação de unidades de relevo do Brasil de Jurandir Ross.",
      "A área contestada em sua totalidade localiza-se onde atualmente está situado o município de Curitiba.",
      "A extensão da estrada de ferro que atravessava de norte a sul a área da Guerra do Contestado possui mais de 200 quilômetros em linha reta.",
      "A bacia hidrográfica na área contestada tem como divisor de águas a Serra da Fartura, localizada na porção nordeste da área em litígio.",
      "O desfecho da guerra garantiu ao Paraná os limites contestados ao sul do rio Iguaçu, definindo a fronteira entre os estados envolvidos."
    ],
    correctAnswer: 4,
    materia: ["História", "Geografia"],
    conteudo: ["História do Brasil", "Geografia do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "O sublime não está contido em nenhuma coisa da natureza, e sim em nosso anímo, quando nos tornamos conscientes de nossa superioridade à natureza.",
...
createQuestion({
    ...
    conteudo: ["História do Brasil", "Êxodo Rural", "Urbanização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Arte"],
    conteudo: ["Arte Contemporânea", "História da Arte"],
    imageNames: []
})