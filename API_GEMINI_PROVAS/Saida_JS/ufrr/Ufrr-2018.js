...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Grandezas Proporcionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Progressão Geométrica", "Geometria Plana"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Se Im(f) = B então f(x) é sobrejetora.",
      "Uma função é par se f(x) = f(-x) para todo x ∈ D(f).",
      "Uma função é injetora se para cada elemento de D(f), temos dois elementos da Im(f) associado a ele.",
      "Uma função é ímpar se f(x) = −f(-x) para todo x ∈ D(f).",
      "Se f(x) é injetora e sobrejetora, então é f(x) bijetora."
    ],
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Funções"],
...
createQuestion({
    ...
    options: [
      "apenas I é fonte de variabilidade genética.",
      "apenas II é fonte de variabilidade genética.",
      "apenas I e II são fontes de variabilidade genética.",
      "apenas I e III são fontes de variabilidade genética.",
      "I, II e III são fontes de variabilidade genética."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Genética", "Divisão Celular"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "possuem superfícies irregulares e os mais longos processos de formação geológica da região.",
      "caracterizam-se por terem uma superfície inclinada com altitude de 500 metros a 800 metros.",
      "dominam completamente a região devido à presença de fortes abalos sísmicos no interior da Amazônia brasileira.",
      "abrangem uma estreita faixa de terras planas que acompanham, principalmente, o rio Amazonas, com altitude inferior a 100 metros.",
      "têm um reduzido potencial hídrico em razão dos processos tectônicos existentes na bacia amazônica."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geomorfologia", "Geografia do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A recente queda de empregos e de faturamento no Polo Industrial de Manaus foi capaz de impulsionar a economia regional.",
      "A instalação de empresas nacionais e fábricas multinacionais desencadearam também a imigração de profissionais, além da migração de trabalhadores de outras partes do Brasil.",
      "Os incentivos fiscais da Zona Franca foram um dos principais motivos de atração para centenas de fábricas.",
      "A recessão econômica do país dos últimos anos provocou um processo de desaceleração da produção industrial em Manaus.",
      "Mesmo com a desaceleração, o Polo Industrial de Manaus é uma referência importante na fabricação de celulares, tablets, televisores e motocicletas no país."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geografia Econômica", "Geografia Regional do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Temperaturas amenas e chuvas bem distribuídas durante todo o ano (i); temperaturas elevadas e muita umidade (ii).",
      "Temperaturas elevadas com chuvas escassas e irregulares ao longo do ano (i); temperaturas elevadas e muita umidade (ii).",
      "Temperaturas elevadas com chuvas escassas e irregulares ao longo do ano (i); temperaturas baixas com escassez de chuva no outono e no inverno (ii).",
      "Temperaturas amenas e chuvas bem distribuídas durante todo o ano (i); temperaturas amenas com pouca chuva no outono e no inverno (ii).",
      "Temperaturas elevadas com umidade durante todo o ano vinda do oceano (i); temperaturas amenas, fortes chuvas no verão e aridez no inverno (ii)."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Climatologia", "Geografia do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História Antiga", "Civilização Egípcia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História Moderna", "Renascimento"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "praticava a agricultura e o comércio nos pequenos núcleos urbanos.",
      "desenvolvia grandes sistemas de irrigação e drenagens, com complexas construções em formas de pirâmides.",
      "trabalhava na metalúrgica, em especial, na fabricação de armas de guerra e instrumentos agrícolas.",
      "vivia de atividades como a caça e coleta de frutos silvestres, habitando em regiões de savanas e utilizando acampamentos provisórios.",
      "abandonou a caça e a coleta, tornando-se sedentário no desenvolvimento de práticas agrícolas e do pastoreio."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Pré-História", "Paleolítico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Ligações Químicas", "Química Ambiental"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "aos quarenta e oito estados contiguos dos Estados Unidos da América.",
