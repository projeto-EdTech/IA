...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Figuras de Linguagem", "Aliteração"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Mínimo Múltiplo Comum (MMC)", "Aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 13,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Círculos", "Teorema de Pitágoras"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As mitocôndrias de animais com reprodução sexuada originam-se igualmente a partir daquelas que existem no gameta feminino e no gameta masculino;",
      "As mitocôndrias de animais com reprodução sexuada originam-se a partir daquelas que existem no gameta masculino, pois as presentes no gameta feminino degeneram após sua fecundação;",
      "As mitocôndrias de animais com reprodução sexuada originam-se por geração espontânea no momento da fase embrionária do indivíduo;",
      "As mitocôndrias de animais com reprodução sexuada originam-se apenas a partir daquelas presentes em bactérias do trato digestivo de sua mãe;",
      "As mitocondrias de animais com reprodução sexuada originam-se a partir daquelas que existem no gameta feminino, pois as presentes no gameta masculino degeneram após a fecundação."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Citologia", "Mitocôndrias", "Genética"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Musculatura esquelética e ossos;",
      "Bexiga urinária e fígado;",
      "Pâncreas e encefálo;",
      "Nervos e sistema respiratório;",
      "Bexiga urinária e ossos."
    ],
    correctAnswer: 13,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Cinemática Vetorial", "Velocidade Média", "Velocidade Escalar Média"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Dinâmica", "Atrito", "Trabalho e Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Pedologia", "Solos", "Intemperismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "I – Núcleo Térmico, II – Núcleo adjacente, III – Manto aquecido, IV – Manto esfriado e V – Crosta;",
      "I – Núcleo, II – Núcleo posterior, III – Manto aquecido, IV - Manto esfriado e V - Estratosfera;",
      "I – Núcleo, II – Esferóide, III – Manto inferior, IV – Manto externo e V – Crosta;",
      "I - Crosta elipsoidal, II – Núcleo posterior, III – Manto inferior, IV – Manto externo e V – Crosta continental;",
      "I – Núcleo interno, II – Núcleo externo, III – Manto Inferior, IV - Manto Superior e V – Crosta."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Estrutura da Terra", "Geologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Por volta de 6.000 a.C. a 5000 a.C., quando o Homo Sapiens desenvolveu o processo de domesticação das plantas na América;",
      "Na Pré-História, por volta de 6,5 milhões de anos, quando os primeiros hominídeos americanos desenvolveram a domesticação das plantas;",
      "Por volta de 5,5 milhões de anos, na Pré-História, o Homo Habilis desenvolveu a domesticação das plantas na América;",
      "Na Pré-História, o Australopiteco Boisei foi o primeiro grupo de hominídeos a desenvolver a domesticação das plantas na América;",
      "O Homo Erectus, embora não vivesse em casas, aprendeu a domesticar plantas na América no período da Pré-História."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Pré-História", "Povos Indígenas", "Agricultura Antiga"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Grécia Antiga", "Jogos Olímpicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As escolas e universidades no período medieval na Europa Ocidental ofereciam oportunidades de estudar para todos, contudo, estavam voltadas inicialmente para o mundo rural;",
      "As escolas eram frequentadas principalmente pelos filhos de servos, enquanto estes desenvolviam as atividades nos campos;",
      "Os servos participavam das escolas como possibilidade de aprender e desenvolver novas tecnologias na época;",
      "As escolas e universidades no período medieval eram fortemente influenciadas pela tradição cristã, e o acesso era restrito a determinados grupos sociais;",
      "A educação medieval na Europa Ocidental ocupou o lugar dos mosteiros no processo de ensino, rompendo totalmente com o ensino religioso cristão e possibilitando o acesso de todos."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Idade Média", "Educação Medieval"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O ácido sulfúrico se ioniza produzindo os íons H⁺ e SO₄²⁻;",
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Eletroquímica", "Soluções Iônicas", "Ácidos e Sais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de Texto", "Descobrimento do Brasil"],
    imageNames: []
}),
