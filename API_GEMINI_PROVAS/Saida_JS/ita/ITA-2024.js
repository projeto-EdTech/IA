createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Cinemática", "Energia Cinética", "Análise de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Óptica Geométrica", "Cinemática (Queda Livre)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Conservação de Energia", "Colisões", "Centro de Massa"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Impulso e Quantidade de Movimento", "Movimento Circular", "Gravitação (Velocidade de Escape)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Gravitação (Leis de Kepler)", "Óptica (Tamanho Aparente)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Oscilações (Pêndulo Simples)", "Termodinâmica (Dilatação Térmica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Óptica (Instrumentos Ópticos, Microscópio)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Óptica (Interferência de Ondas, Experimento de Young)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Eletrostática (Cargas Induzidas, Gaiola de Faraday, Potencial Elétrico, Campo Elétrico)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo (Força Magnética em Cargas em Movimento, Trajetória em Campo Magnético)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo (Indução Eletromagnética, Lei de Faraday-Lenz, Campo Magnético em Solenoide)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Relatividade (Dilatação do Tempo, Contração do Comprimento)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A perspectiva infantil, como no conto que dá título ao livro, acaba por destacar as contradições e tensões sociais produzidas pelo colonialismo.",
      "Em todos os contos do livro, a violência do racismo, seja qual for a sua natureza, é denunciada.",
      "O silenciamento, como em “A velhota”, pode ser interpretado como uma estratégia de sobrevivência, preservação da humanidade e cuidado com os outros.",
      "O uso de termos do idioma ronga é uma das características linguísticas do livro.",
      "No livro, não há questionamentos quanto às estruturas sociais do poder colonizador, apenas quanto aos aspectos culturais do colonialismo."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (Nós Matamos o Cão Tinhoso, Luís Bernardo Honwana)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A crítica ao colonialismo é circunscrita às mulheres, como em “Dina”.",
      "O vocabulário com termos do idioma ronga é uma forma de inscrever, na própria linguagem, o sucesso humanitário do colonialismo português.",
      "O uso de termos do idioma ronga é uma forma de inscrever, na própria linguagem, o desprezo para com a cultura local por parte do escritor.",
      "Marcas de oralidade e vocabulário, a despeito da ocupação portuguesa, sugerem uma identidade cultural autônoma e forte.",
      "Uma das características que as personagens apresentam é o elitismo introjetado pelos povos colonizados, como em “Nhinguitimo”."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (Nós Matamos o Cão Tinhoso, Luís Bernardo Honwana)"],
...
createQuestion({
    ...
    options: [
      "O narrador revela a sua certeza em relação ao futuro de seus irmãos e deixa transparecer a sua impotência para evitar isso.",
      "A recusa do narrador em relatar o que lhe acontecera é uma maneira de poupar a sua família de maiores preocupações.",
      "A violenta dominação portuguesa é representada por aqueles que agrediram o narrador.",
      "A raiva a que se refere o narrador aparece, o tempo todo, em suas relações familiares, tanto com seus irmãos, quanto com sua mãe.",
      "Assim como Madala, o narrador do conto não tem o que fazer, além de suportar as violências às quais é submetido, inclusive para proteger sua família."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (Nós Matamos o Cão Tinhoso, Luís Bernardo Honwana"],
...
createQuestion({
    ...
    options: [
      "o capataz se arrependeu de ter violentado Maria, pois nutria por Madala grande estima e consideração.",
      "apesar de todas as violências cometidas pelo capataz contra os negros, estuprar uma mulher na presença do pai dela extrapola toda e qualquer ética possível entre homens.",
      "Madala recebia do capataz um tratamento privilegiado, principalmente em relação ao tempo de descanso, e, por isso, era menosprezado por seus iguais.",
      "o capataz teve receio de alguma tentativa de retaliação por parte de Madala e seus companheiros, o que o fez reavaliar as suas atitudes violentas.",
      "por ter se apaixonado pela moça, o capataz quis agradar ao seu velho pai, por quem nutria grande afeto, respeito e consideração."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (Nós Matamos o Cão Tinhoso, Luís Bernardo Honwana"],
...
createQuestion({
    ...
    options: [
      "Trata-se de um narrador em terceira pessoa, onisciente, que apresenta seus julgamentos a respeito das ações das personagens.",
      "Trata-se de um narrador onisciente, que reproduz, inclusive, pensamentos e memórias das personagens.",
      "Trata-se de um narrador em primeira pessoa, que reproduz as suas próprias memórias e as de seus pais.",
      "Trata-se de um narrador em primeira pessoa, que reproduz apenas as suas próprias memórias e sentimentos.",
      "Trata-se de um narrador em segunda pessoa, onisciente, que reproduz apenas as memórias do seu pai."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (O Avesso da Pele, Jeferson Tenório"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "“para ela [Martha], o racismo se fortalecia justamente quando começávamos a falar sobre ele, que isso era uma coisa que já deveria ter sido superada. E falar sobre a cor da pele só fortalecia o preconceito.”",
      "\"quando pela primeira vez você ouviu a palavra ‘negritude', seu entendimento sobre a vida tomou outra dimensão, e você se deu conta de que ser negro era mais grave do que imaginava.”",
      "“Você tinha dezenove anos, mas ainda não sabia muita coisa sobre autoestima, nem sobre se valorizar e essas coisas necessárias para manter a sanidade, por isso você não conseguia olhar por muito tempo nos olhos dele.”",
      "“no dia em que você me perguntou que cor eu tinha e foi a primeira vez que eu olhei para os meus braços e vi que tínhamos quase a mesma cor, eu era pequeno, mas eu disse que não sabia que cor era aquela.\""
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (O Avesso da Pele, Jeferson Tenório"],
...
createQuestion({
    ...
    options: [
      "Apenas I e IIII são verdadeiras.",
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (Nós Matamos o Cão Tinhoso, O Avesso da Pele"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "são as referências ao mundo da alta cultura, como as óperas e os concertos sinfônicos frequentados pelas personagens da peça.",
      "é a incorporação da linguagem bíblica nos diálogos, a fim de reforçar o moralismo e a necessidade de defender os bons costumes populares.",
      "é a ambientação na Zona Sul carioca, região mais rica do Brasil naquela época.",
      "são a linguagem coloquial, com muitas gírias, e os elementos do cotidiano, como o futebol e o jogo do bicho.",
      "é o experimentalismo estético que leva a peça ao limite do vanguardismo e da dissolução dos gêneros."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (A Falecida, Nelson Rodrigues"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o privilégio absoluto da palavra, com diálogos versificados e formas fixas, característica maior do texto dramatúrgico.",
      "a recusa a tratar da vida frenética dos centros urbanos, característica do parnasianismo programático do autor.",
      "a unidade de objetividade, realidade e verossimilhança, segundo as regras da mimese clássica, fixadas na Poética, de Aristóteles.",
      "a incorporação de elementos do cinema e da crônica jornalística, como o diálogo espontâneo do cotidiano, cortes de cena, elipses e flashback.",
      "o artificialismo burguês do melodrama romântico, atualizado pelo dramaturgo para a comédia de costumes do século XX."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (A Falecida, Nelson Rodrigues"],
...
createQuestion({
    ...
    options: [
      "ele recusa a chantagem de Pimentel e distribui aos pobres o dinheiro que ganhou honestamente, trabalhando como pipoqueiro no estádio do Maracanã.",
      "ele exige de Pimentel que honre seu compromisso e pague a conta da festa de debutante de Glorinha.",
      "mostra-se tão derrotado quanto Zulmira, sua esposa, a quem nega o último desejo.",
      "ele não é hipócrita e, após a morte de Zulmira, sua esposa, esforça-se para honrar a sua memória, como prometeu a ela.",
      "ele não se deixa abater pelo desemprego e pela falta de perspectivas, lutando bravamente para mudar de vida como jogador profissional de sinuca."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (A Falecida, Nelson Rodrigues"],
...
createQuestion({
    ...
    options: [
      "recommend the best books about Salvador to scholars who wish to study African heritage in Brazil.",
      "present Salvador, Bahia as well as part of the backwoods through literature to a foreign reader.",
      "recount the story of the author's journey as a novelist himself.",
      "instigate foreigners to travel to Salvador to appreciate Afro-Brazilian cuisine.",
      "highlight inequalities and violence that underlie Brazilian society."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto", "Propósito do Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "establish a connection of the book with Salvador, which epitomizes the Black diaspora.",
      "understand how Rufino's Nigerian roots led him to fight for freedom in Salvador.",
      "learn about Muslim leaders and their influence on cultures such as the present \"quilombolas”.",
      "find out how the city of Salvador presents a unique mix of African and European cultures.",
      "agree that freedom of religion and belief is the most precious human right worth fighting for."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto", "Comparação de Obras"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Vocabulário", "Sinônimos e Expressões"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "both books concentrate on the lawless character of the “sertanejo”.",
      "one of the books blames the “sertanejo” for the war of Canudos and the other compares the character to the American cowboy.",
      "both books present the landscape of the “sertão” as an idyllic genesis of the world.",
      "one of the books is more creative while the other is a more fact-based journalistic account.",
      "both books consider Antonio Conselheiro as a spiritual leader, a prophet and even a saint."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto", "Comparação de Obras"],
...
createQuestion({
    ...
    options: [
      "militantes feministas realizam palestras.",
      "mulheres vão para ser admiradas.",
      "mulheres normalmente devem falar baixo.",
      "casais se encontram para ouvir jazz.",
      "mulheres podem ter voz própria."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto", "Detalhes Específicos"],
...
createQuestion({
    ...
    options: [
      "both Woolf and the coffee shop founder share deep admiration for feminist writers such as Beauvoir and Atwood.",
      "Virginia Woolf is very admired by young hipsters in Seoul.",
      "the artist is present in a number of elements incorporated in the shop's concept and design.",
      "both Virginia Woolf and Kim Jina praised economic autonomy and freedom of thought.",
      "the statement phrase written above the bar was actually uttered by Virginia Woolf."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "a Coreia foi a última entre as nações mais ricas a garantir equidade salarial entre os gêneros.",
      "a misoginia ainda é uma característica muito presente na sociedade coreana.",
      "a mulher coreana ainda se inspira em modelos ocidentais no que diz respeito à emancipação.",
      "a sociedade coreana mantém rigor quanto a padrões de beleza e comportamento das mulheres.",
      "as expectativas sobre os papéis tradicionais atribuídos aos diferentes gêneros permanecem."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto", "Detalhes Negativos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a postura da mídia com relação à misoginia em geral.",
      "a prática de filmarem clandestinamente mulheres em banheiros e vestiários.",
      "a revolta das mulheres com relação à motivação de um assassinato em local público.",
      "o assassinato de uma mulher em uma área empobrecida de Seul.",
      "o assédio sofrido por parte das mulheres em diversas comunidades on-line."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto", "Causas e Efeitos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Álgebra Linear (Matrizes, Sistemas Lineares)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Trigonometria (Funções Trigonométricas Inversas, Identidades Trigonométricas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Combinatória (Princípio da Casa dos Pombos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Polinômios (Soma das Raízes, Relações de Girard)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Polinômios (Raízes de Polinômios, Progressão Geométrica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Cilindros)", "Progressão Geométrica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana (Áreas, Teoremas de Ceva e Menelau ou Proporções de Áreas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Números Complexos (Potenciação, Forma Polar)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica (Reta, Ângulos, Bissetriz)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica (Elipse, Círculo, Excentricidade, Posição Relativa)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Estequiometria", "Termoquímica (Combustão, Entalpia)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Química Ambiental (Ciclo do Nitrogênio)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Cristalização de cloreto de sódio a partir do sal puro fundido.",
      "Corrosão de uma placa de ferro.",
      "Neutralização de uma solução aquosa de um ácido forte com uma solução aquosa de uma base fraca.",
      "Decomposição de uma solução aquosa de peróxido de hidrogênio 40 volumes na presença de um catalisador.",
      "Formação de cal virgem por decomposição de calcário."
    ],
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Termoquímica (Reações Endotérmicas e Exotérmicas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Estrutura Atômica (Modelos Atômicos)", "Reações Químicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Química Geral (Misturas, Métodos de Separação de Misturas, Curvas de Aquecimento)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Orgânica (Acidez e Basicidade, pKa)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Reações Inorgânicas (Reações de Oxirredução, Halogênios)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Físico-Química (pH, Soluções Tampão, Reações Ácido-Base)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Química Orgânica (Reações Orgânicas, Nomenclatura, Reatividade)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Físico-Química (Propriedades Coligativas, Ebuliometria, Equilíbrio Químico)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Eletroquímica (Células Eletroquímicas, Potencial de Eletrodo, Energia Livre de Gibbs)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Termoquímica (Entalpia de Ligação, Entalpia de Formação)"],
    imageNames: []
})