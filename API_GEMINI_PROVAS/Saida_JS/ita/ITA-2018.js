createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Análise Dimensional", "Gravitação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Estática", "Equilíbrio Rotacional", "Momento de Força"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Conservação de Energia Mecânica", "Dinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Ondas Sonoras", "Efeito Doppler"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Hidrodinâmica", "Estática dos Fluidos", "Equação de Bernoulli"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Cinemática", "Lançamento de Projéteis", "Resistência do Ar"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Cinemática", "Análise Gráfica", "Velocidade Média"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Campo Magnético", "Movimento Circular Uniforme"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Conservação de Energia Mecânica", "Movimento Circular", "Sistemas de Referência"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Colisões Elásticas", "Conservação do Momento Linear", "Movimento Circular Uniforme"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletrostática", "Lei de Coulomb", "Interação de Dipolos Elétricos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Gravitação Universal", "Movimento Circular Uniforme", "Dinâmica Circular"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Óptica Geométrica", "Espelhos Esféricos", "Formação de Imagens"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Física Moderna", "Difração de Raios X", "Difração de Elétrons", "Dualidade Onda-Partícula"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Dinâmica", "Lei de Hooke", "Equilíbrio de Forças", "Associação de Molas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Segunda Lei da Termodinâmica", "Demônio de Maxwell"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Gráfico que oscila entre K e -K, com F=K em 2ωt=0 e 2π, F=0 em π/2, 3π/2 e F=-K em π.",
      "Gráfico que oscila entre K e -K, com F=0 em 2ωt=0, π, 2π e F=K em π/2, F=-K em 3π/2.",
      "Gráfico que oscila entre K e -K, com F=0 em 2ωt=0, π, 2π e F=K em π/2, F=-K em 3π/2 (começando em K em 0).",
      "Gráfico que oscila entre K e -K, com F=0 em 2ωt=π/2, 3π/2 e F=K em 0, π, 2π.",
      "Gráfico que oscila entre K e -K, com F=K em 2ωt=0, π, 2π e F=-K em π/2, 3π/2."
    ],
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Força Magnética entre Correntes", "Movimento Rotacional"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Conservação de Energia", "Pêndulo Simples", "Ondas Sonoras", "Acústica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Gás Ideal", "Mistura de Gases"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Funções Orgânicas", "Aminoácidos", "Polaridade de Moléculas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Estrutura Atômica", "Orbitais Atômicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "D() CH4éa de maior força de interação intermolecular.",
      "E() quatro destas moléculas são apolares."
    ],
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Forças Intermoleculares", "Propriedades Físicas dos Compostos Orgânicos", "Polaridade de Moléculas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Gases Ideais", "Leis dos Gases", "Estequiometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Calorimetria", "Física Moderna", "Fótons"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Gases Ideais", "Leis dos Gases", "Misturas Gasosas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "D() Produção de água a partir de H2(g) e O2(g)",
      "E() Produção de cloreto de sódio a partir de Na(s) e Cl2(g)"
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Cinética Química", "Reações Elementares"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Radioatividade", "Reações Nucleares", "Fissão Nuclear"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Biocombustíveis", "Reações Orgânicas", "Indústria Química"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Petróleo", "Craqueamento", "Indústria Química"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Reações Orgânicas", "Alcenos", "Álcoois", "Cetona", "Oxidação e Redução Orgânica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Termodinâmica", "Entalpia", "Energia Interna", "Entropia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Propriedades Coligativas", "Pressão Osmótica", "Criometria", "Ebuliometria", "Tonometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Solubilidade", "Reações de Precipitação", "Sais", "Metais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Equilíbrio Iônico", "Ácidos e Bases", "pH", "Fenóis", "Aminas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Indicadores de pH", "Ácidos e Bases", "Equilíbrio Químico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Eletroquímica", "Pilhas", "Potenciais de Eletrodo", "Termodinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Termoquímica", "Entalpia de Combustão", "Cálculo de Entalpia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Física Moderna", "Radiação de Corpo Negro", "Lei de Wien"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "D. Tonica planeja casar-se com ele a qualquer custo.",
      "Palha pretende desfazer os negócios que tem com ele.",
      "Sofia deseja casá-lo com Maria Benedita.",
      "Sofia e Carlos Maria são amantes.",
      "Maria Benedita e Carlos Maria namoram em segredo."
    ],
    correctAnswer: 3,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "expor as razões pelas quais desconfiava da fidelidade de Madalena.",
      "mostrar como as atitudes de Madalena eram interesseiras e materialistas.",
      "criticar as ideias políticas de Madalena, que ele julgava subversivas.",
      "provar que Madalena era uma mãe displicente e pouco carinhosa.",
      "entender as motivações que levaram Madalena a um fim tão trágico."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "fortalece a ideia de que a infância está cada vez mais curta.",
      "restringe a vida humana a apenas três fases.",
      "advoga em favor dos idosos que tentam se manter jovens.",
      "condena a manutenção da rivalidade entre jovens e velhos.",
      "alerta para a necessidade de adaptar-se a cada fase da vida."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "apavora a homens e mulheres.",
      "desfaz a ilusão de eterna juventude.",
      "requer tratamentos de rejuvenescimento.",
      "descortina valores dantes ignorados.",
      "traz aceitação das diferenças."
    ],
    correctAnswer: 2,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "retrata a velhice como a melhor fase da vida.",
      "compara juventude e velhice como processos naturais e contínuos.",
      "diferencia estar velho fisicamente e sentir-se velho.",
      "caracteriza a velhice com a fase de maior busca religiosa.",
      "critica determinada visão acerca do fim da juventude."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "sombra que nos acompanha (parágrafo 2)",
      "período áureo (parágrafo 5)",
      "dores sem analgesia (parágrafo 7)",
      "a mais temível das criaturas (parágrafo 7)",
      "editora autoritária (parágrafo 9)"
    ],
    correctAnswer: 2,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "busca conciliar elementos de épocas distintas.",
      "acredita que a velhice seja apenas uma construção social.",
      "necessita estar acompanhado de tecnologias modernas.",
      "cria diversas formas de lidar bem com a velhice.",
      "atribui características humanas ao não humano."
    ],
    correctAnswer: 0,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "inconformismo diante do processo de envelhecimento.",
      "medo de se tornar inútil quando a velhice chegar.",
      "anseio por uma vida plena de coisas boas.",
      "crença na ideia de que querer é poder.",
      "boa receptividade para a chegada da velhice."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "realçar a escrita formal em contraste à escrita informal.",
      "separar um termo complementar da oração principal.",
      "marcar a sobreposição de várias informações intercaladas.",
      "indicar o deslocamento da informação secundária em relação à principal.",
      "antecipar o tempo e o espaço físico da informação principal."
    ],
    correctAnswer: 3,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "ambiguidade e conformidade.",
      "eventualidade e gradação.",
...
createQuestion({
    ...
    options: [
      "afirmam que o homem é capaz de superar todas as limitações da velhice.",
      "concordam que o envelhecimento não aflige mais a geração atual.",
      "julgam que as pessoas ainda sonham ser eternamente jovens.",
      "transmitem uma visão idealizada do envelhecimento nos dias atuais.",
      "focalizam aspectos diferentes do idoso em relação ao seu espaço na sociedade."
    ],
    correctAnswer: 4,
    materia: [],
    conteudo: [],
...
createQuestion({
    ...
    options: [
      "queria vendê-los quando chegasse à velhice.",
      "costumava julgar as pessoas pelos carros que possuíam.",
      "queria desfrutar deles sem se preocupar com o futuro.",
      "acreditava que as posses aumentariam a sua autoestima e felicidade.",
      "desejava impressionar a mulher que amava por meio de suas posses."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "a mudança para o novo apartamento fez com que suas reservas financeiras aumentassem.",
      "seu antigo apartamento era tão bagunçado que ele não podia sequer receber a namorada.",
      "desperdiçava tempo e não conseguia manter o foco, antes de aderir ao minimalismo.",
      "orgulhava-se de ter um salário mais alto do que todos os seus amigos.",
      "era alcoólatra e violento com as pessoas, antes de mudar o estilo de vida."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "The rent is cheaper, (linha 3)",
      "...you reduce your possessions to the least possible. (linha 9)",
      "...the more we have, the happier we will be. (linha 13)",
      "I feel more content now than I ever did in the past. (linha 19)",
      "But by having fewer things around, (linha 36)"
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Gramática"],
...
createQuestion({
    ...
    options: [
      "o número de propostas feitas por mulheres representava um terço do total de pedidos de investimento.",
      "em virtude dos estereótipos de gênero, somente 16 das candidatas receberam financiamento.",
      "as empreendedoras que foram aprovadas receberam somente 53% do total que requereram.",
      "os homens conseguiram mais do que o dobro de financiamento se comparados às mulheres.",
      "52% dos requerentes do gênero masculino tiveram seus pedidos de financiamento aprovados."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "na Suécia, as mulheres possuem cerca de um terço das empresas e, proporcionalmente, conseguem financiamento correspondente ao concedido a empreendedores do sexo masculino.",
      "foram observadas, pelo período de um ano, as reuniões decisórias para a escolha de quais empreendedores receberiam investimento de capital de risco pelo governo sueco.",
      "a análise do potencial de mercado ou do produto é primordial na tomada de decisão sempre que há dúvidas em relação ao potencial do empreendedor.",
      "tendo em vista que os bancos não podem assumir determinados riscos, o aporte de capital por parte do governo desempenha um papel importante no incentivo à inovação e ao crescimento.",
      "a forma como os investidores (VCs) descrevem os empreendedores desempenha um papel muito claro e inquestionável na decisão de como os recursos financeiros são distribuídos."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "excesso de entusiasmo causa desconfiança em relação a controle emocional, no caso de mulheres.",
      "cautela é positiva quando se trata de homens; porém, no caso de mulheres, significa medo de arriscar.",
      "juventude é vista como um aspecto promissor tanto para mulheres quanto para homens.",
      "agressividade e arrogância são consideradas características negativas para ambos os gêneros.",
      "experiência, conhecimento e competência são características marcantes das mulheres."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "Experiência, cautela, juventude e liderança.",
      "Potencial para inovação, competência, assertividade e entusiasmo.",
      "Entusiasmo, potencial de crescimento, confiabilidade e competitividade.",
      "Assertividade, conhecimento de mercado, competência e determinação.",
      "Conhecimento, credibilidade, experiência e confiabilidade."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "acha que ele não dá atenção a sua filha.",
      "repara que ele trata Helga de forma rude.",
      "percebe que Helga está chateada com ele.",
      "suspeita que ele trate o cão melhor do que Helga.",
      "observa que ele é um homem folgado."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "ela vê quão bem Hägar trata Snert.",
      "ela constata que Hägar trata Snert como se fosse um serviçal.",
      "Snert pode comer junto com a família.",
      "Hägar passou a noite inteira ensinando truques para Snert.",
      "Hägar permite que Snert fique dentro da casa."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "Due to, as well as, by, also",
      "Because, and, through, too",
      "Owing to, including, beyond, moreover",
      "In view of, plus, over, additionally",
      "Thanks to, together with, by way, likewise"
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "devem-se aos avanços que foram conquistados no campo das Neurociências.",
      "são realizados tanto na esfera computacional quanto no domínio experimental.",
      "são realizados por cientistas de diferentes áreas.",
      "ainda estão apenas no campo da ficção científica.",
      "englobam questões de natureza ética e filosófica."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto"],
