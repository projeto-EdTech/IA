...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Cinemática", "Movimento Vertical", "Movimento Retilíneo Uniformemente Variado"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Dinâmica do Movimento Circular", "Atrito", "Estabilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Gravitação Universal", "Leis de Kepler", "Centro de Massa"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Dilatação Térmica", "Pêndulo Simples", "Oscilações"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Dinâmica do Movimento Circular", "Pêndulo Simples", "Conservação de Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Força Magnética", "Indução Eletromagnética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Dinâmica dos Fluidos", "Equação de Bernoulli", "Tubo de Pitot"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Gases Ideais", "Empuxo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Hidrostática", "Flutuação", "Empuxo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Estática", "Atrito", "Torque"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Ondas em Cordas", "Velocidade de Ondas", "Frequência Fundamental"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Óptica", "Reflexão Total Interna", "Fibras Ópticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Eletricidade", "Circuitos RC", "Capacitores"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Lei de Faraday-Lenz", "Indução Eletromagnética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Relatividade Restrita", "Efeito Doppler Relativístico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Funções Logarítmicas", "Equações Exponenciais", "Equações Algébricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Aritmética", "Propriedades de Números Inteiros"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Sequências Numéricas", "Logaritmos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Triângulos", "Circunferências"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "a ≠ 6 e b = 4.",
      "a = 6 e b = 4.",
      "a é arbitrário e b ≠ 4."
    ],
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Álgebra Linear", "Sistemas Lineares"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Círculos", "Trigonometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Trigonometria", "Geometria Plana", "Triângulos Retângulos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Círculos", "Tangentes", "Áreas de Triângulos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Áreas", "Quadriláteros"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Triângulos Equiláteros", "Trigonometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial", "Cones", "Esferas", "Volume"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Polinômios", "Números Complexos", "Raízes de Polinômios"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Análise Combinatória", "Permutações", "Geometria Espacial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Triângulos Equiláteros", "Bissetriz"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Quando LiCl(s) é adicionado à água, a solução permanece neutra.",
      "Uma solução aquosa de CH3OH a 0,10 mol·L¯¹ pode ser considerada essencialmente neutra."
    ],
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Ácidos e Bases", "Propriedades de Soluções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Cinética Química (Equação de Arrhenius)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Forças Intermoleculares", "Pressão de Vapor"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O número de massa, A, de um isótopo é um número inteiro positivo adimensional que corresponde à soma do número de prótons e de nêutrons no núcleo daquele isótopo.",
      "Massa atômica refere-se à massa de um único átomo, e é invariante para átomos de um mesmo isótopo. Quando medida em unidades padrão de massa atômica, ela nunca é um número inteiro exceto para o átomo de 12C.",
      "A soma do número de prótons e nêutrons em qualquer amostra de matéria cuja massa é exatamente 1 g vale exatamente 1 mol.",
      "A massa molar de um dado elemento químico pode variar em diferentes pontos do sistema solar.",
      "Multiplicando-se a unidade padrão de massa atômica pela constante de Avogadro, obtém-se exatamente 1 g·mol¯¹."
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Estrutura Atômica", "Mol e Massa Molar"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Eletroquímica (Equação de Nernst)", "pH"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Gases (Equação dos Gases Ideais)", "Massa Específica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Eletroquímica (Potencial de Pilha)", "Energia Livre de Gibbs"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Equilíbrio Químico (Constante de Equilíbrio)", "Pressões Parciais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "O pH da solução em torno do Ea diminui."
    ],
    correctAnswer: 0,
    materia: ["Química"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Estequiometria (Rendimento)", "Pureza"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Termoquímica (Entalpia de Reação)", "Capacidade Calorífica", "Entalpia de Vaporização"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Gráfico mostrando Ec crescendo linearmente a partir da origem (0,0).",
      "Gráfico mostrando Ec crescendo linearmente, mas partindo de um valor positivo para Ec quando T=0.",
      "Gráfico mostrando Ec crescendo linearmente a partir da origem (0,0).",
      "Gráfico mostrando Ec crescendo de forma não linear (curva côncava para cima) a partir da origem (0,0).",
      "Gráfico mostrando Ec crescendo de forma não linear (curva convexa para cima) a partir da origem (0,0)."
    ],
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Termodinâmica (Teoria Cinética dos Gases)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Termodinâmica (Primeira Lei da Termodinâmica)", "Transformações Gasosas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Cinética Química (Mecanismos de Reação)", "Leis de Velocidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Cinética Química (Ordem de Reação)", "Leis de Velocidade Integradas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Eletroquímica (Eletrólise)", "Reações em Solução"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "da energia do orbital 1s do átomo de hélio é menor que 13,6 eV.",
      "da energia da molécula de H2, no seu estado de mínima energia, é menor do que o valor absoluto da soma das energias de dois átomos de hidrogênio infinitamente separados.",
      "da afinidade eletrônica do átomo de hidrogênio é igual a 13,6 eV.",
...
createQuestion({
    ...
    options: [
      "a escolha certa do curso universitário é a garantia de sucesso profissional.",
      "é aconselhável que o universitário concilie o curso superior com uma formação alternativa.",
      "é imprescindível mais de uma formação universitária como garantia de futuro bem sucedido.",
      "é recomendável que as universidades ofereçam cursos para formação de trabalhadores manuais.",
      "o diploma universitário, aliado a cursos de curta duração, possibilita o amadurecimento do jovem."
    ],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: [
      "contrário à realização dos vestibulares atuais.",
      "otimista quanto à realidade educacional brasileira.",
      "simpático às atividades informais não assalariadas.",
      "realista quanto à oferta limitada de emprego para os diplomados.",
      "contrário aos critérios de seleção de instituições privadas de ensino."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "Há profissionais diplomados sem emprego.",
      "Há diplomados descontentes com a carreira que escolheram.",
      "As melhores opções de carreira são as oferecidas pelas universidades.",
      "Existem ofícios mais rentáveis que algumas carreiras de nível superior.",
      "Há quem tenha trocado a profissão em que se diplomou por outro ofício."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "Vou confessar um pecado: às vezes, faço maldades. (linha 1)",
      "O conselho é este: salvem-se enquanto é tempo! (linha 8)",
      "Aí o sinal fica verde e eu continuo. (linhas 8 e 9)",
      "Acabaram de chegar ao último patamar. (linhas 13 e 14)",
      "O diploma era mais que garantia de emprego. (linha 24)"
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variedades Linguísticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[...] às vezes, faço maldades. Mas não faço por mal. (linha 1) Paradoxo",
      "[...] configura-se um mercado imenso, mas imenso mesmo, (linha 42) Gradação",
      "Alegria na entrada. Tristeza ao sair. (linha 45) Antítese",
      "E ele tremia de medo de fazer discursos. (linhas 54 e 55) Ironia",
      "É motorista de um caminhão gigantesco que cruza o país! (linha 57) Hipérbole"
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "As celebrações têm o mesmo sentido que os eventos iniciáticos [...]. (linha 14)",
      "[...] as provas a que têm de se submeter os jovens que passaram pela puberdade. (linha 15)",
      "[...] como os mecânicos, pedreiros e carpinteiros, que tinham as mãos rudes e sujas. (linhas 25 e 26)",
      "Profissão honrosa é profissão que tem diploma universitário. (linha 34)",
      "Tive um amigo professor que foi guindado, contra a sua vontade, à posição de reitor [...] (linha 53)"
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Semântica"],
...
createQuestion({
    ...
    year: 2016,
    text: {
      principal: "No Texto 2, há predominância do tom",
      subItens: []
    },
    options: [
      "saudosista.",
...
createQuestion({
    ...
    options: [
      "ascensão dos centros urbanos, precipitada grandemente pela vinda, em 1808, (linhas 1 e 2)",
      "semelhantes ocupações venham a caber, em primeiro lugar, à gente principal (linhas 5 e 6)",
      "o simples exercício da inteligência, em contraste com as atividades (linha 14)",
      "O trabalho mental, que não suja as mãos e não fatiga o corpo, pode constituir (linha 16)",
      "a verdade é que, embora presumindo o contrário, dedicamos, de modo geral, (linhas 18 e 19)"
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Sintaxe"],
...
createQuestion({
    ...
    options: [
      "à postura desobediente de Mafalda diante da mãe.",
      "à resposta autoritária da mãe de Mafalda à pergunta da filha.",
      "ao uso de palavras em negrito e cada vez maior do 2º ao 4º quadrinho.",
      "ao fato de aparecer apenas a fala da mãe de Mafalda e não sua imagem.",
      "aos sentidos atribuídos por Mafalda para as palavras “títulos” e “diplomamos”."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "destaca, no período de sua adolescência, a paixão por Marcela.",
      "se mostra melancólico no negativo balanço final de suas lembranças.",
      "relata com franqueza e sem autocomplacência as experiências que viveu.",
      "narra o envolvimento adúltero que teve com Virgília, esposa de Lobo Neves.",
      "confessa que a passagem mais triste de sua vida foi a morte precoce de Eulália."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      ...
      "uma total ruptura com a representação realista do homem do campo."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Análise Poética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Textuais", "Análise Poética"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "devido à crise financeira, as indústrias têxtil e agrícola deixaram de fazer parte das empresas brasileiras mais bem sucedidas no cenário mundial.",
      "“Belindia” é o termo usado pelo economista Edmar Bacha para comparar a produtividade empresarial do Brasil com a da Bélgica e a da Índia.",
      "a pesquisa de Van Reenen diz que empresas familiares brasileiras são prejudicadas por escolher parentes ao invés de profissionais mais qualificados como gestores.",
      "reuniões entre empresários brasileiros e políticos contribuem para a inovação automotiva e a redução dos impostos.",
      "as revistas Fortune e Forbes revelam ascensão das empresas brasileiras no ranking mundial de 2013 para 2014."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto"],
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto", "Interpretação de Autor"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Gramática", "Vocabulário", "Gramática"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "inter-personal existential intra-personal linguistic",
      "inter-personal linguistic intra-personal existential",
      "intra-personal linguistic inter-personal existential",
      "intra-personal inter-personal existential linguistic",
      "existential linguistic inter-personal intra-personal"
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "pessoas capazes de visualizar objetos mentalmente de vários ângulos são dotadas de inteligência espacial.",
      "pessoas dotadas de inteligência lógico-matemática são capazes de comprovar teoremas complexos.",
      "pessoas preocupadas com o equilíbrio entre mente e corpo e com a boa postura corporal são dotadas de inteligência corporal-cinestésica.",
      "pessoas dotadas de inteligência musical conseguem identificar ritmos e notas musicais e tocam qualquer instrumento.",
      "pessoas dotadas de inteligência naturalista são leitores vorazes de textos sobre a natureza."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Gramática", "Gramática", "Gramática"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "é doutor em química orgânica e foi responsável pela descoberta de substâncias tóxicas em sistemas de refrigeração.",
      "começou a atuar na empresa DuPont juntamente com Jack Rebok em Nova Jersey em 1938.",
      "foi responsável pela descoberta de uma resina não corrosiva chamada PTFE.",
      "provocou um acidente na empresa DuPont ao armazenar o gás TFE em cilindros pequenos.",
      "foi transferido para o Departamento Central de Pesquisa da empresa a fim de se dedicar exclusivamente ao estudo do PTFE."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto"],
...
createQuestion({
    ...
    options: [
      "desde 1938, a empresa DuPont realiza estudos para expandir o uso comercial da resina PTFE.",
      "a comercialização do Teflon teve início em 1960, após duas décadas de testes em diversos segmentos industriais.",
      "a descoberta da nova resina levou a DuPont a instituir novo departamento na empresa para focar neste estudo.",
      "a descoberta do Teflon ocorreu por acaso, quando Plunkett e Rebok buscavam desenvolver compostos químicos para sistemas de refrigeração.",
      "a preocupação inicial da empresa DuPont era desenvolver equipamentos de baixo custo e menos agressivos ao meio ambiente."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto"],
...
createQuestion({
    ...
    options: [
      "são relatados os resultados de quatro pesquisas realizadas por neurocientistas ligados a empresas de recursos humanos.",
      "todos os estudos utilizaram o mesmo método para analisar as fotos, mas os resultados são distintos.",
      "as pesquisas foram encomendadas por gerenciadores de redes sociais como o Facebook e o LinkedIn.",
      "as pesquisas mostram que as pessoas avaliam a confiabilidade observando as expressões faciais do indivíduo.",
      "os quatro estudos apresentam resultados totalmente distintos no que se refere à afetuosidade."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto"],
...
createQuestion({
    ...
    options: [
      "fotos postadas em redes sociais determinam as habilidades e competências de um candidato a emprego.",
      "fotos digitais postadas nas redes sociais causam as mesmas impressões sobre um indivíduo que fotos analógicas.",
      "a Universidade de Nova York pretende publicar as pesquisas relatadas na reportagem para divulgar características de competência e confiabilidade.",
      "além de credibilidade e competência profissional, a análise das faces revelou dados sobre força física e condição socioeconômica.",
      "a percepção da força física de um indivíduo está relacionada à estrutura óssea da face e não à expressão facial do indivíduo."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto"],
...
createQuestion({
    ...
    options: [
      "rostos mais largos sinalizam pessoas mais felizes.",
      "rostos mais finos indicam pessoas mais competentes.",
      "rostos mais compridos indicam pessoas mais afetuosas.",
      "rostos mais finos sinalizam pessoas mais confiáveis.",
      "rostos mais largos indicam pessoas mais fortes fisicamente."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Compreensão de Texto"],
