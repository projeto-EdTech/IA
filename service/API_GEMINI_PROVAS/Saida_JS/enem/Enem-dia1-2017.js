...
createQuestion({
    ...
    options: [
      "enfrentará a guerra vigente e deliberada contra a\npropriedade intelectual no Reino Unido.",
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Interpretação de texto", "Linguagem publicitária"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "responsabilizar o irmão da vítima pelo incidente\nocorrido.",
...
createQuestion({
    ...
    options: [
      "descreve a história desse local para que turistas\nvalorizem seus costumes milenares.",
      "informa hábitos religiosos para auxiliar turistas a\nentenderem as diferenças culturais.",
      "divulga os principais pontos turísticos para ajudar\nturistas a planejarem sua viagem.",
      "recomenda medidas de segurança para alertar\nturistas sobre possíveis riscos locais.",
      "apresenta aspectos gerais da cultura do país para\ncontinuar a atrair turistas estrangeiros."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Interpretação de texto"],
...
createQuestion({
    ...
    options: [
      ...
      "prazer da personagem em relação ao sofrimento\nalheio.",
      "superação do ciúme pela comoção decorrente da\nmorte."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Elementos da narrativa", "Ponto de vista"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de texto", "Novas tecnologias"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "assegura a existência de pensamentos contrários à\nordem vigente.",
      "mantém a heterogeneidade das formas de relações\nsociais.",
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Intertextualidade", "Linguagem e sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Recursos linguísticos", "Progressão temática"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de infográfico", "Consumo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "configura um ideal de nacionalidade pela integração\nregional.",
      "remonta ao colonialismo assente sob um viés\niconoclasta.",
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Modernismo", "Gêneros poéticos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "difusão do pensamento e das preferências das\ngrandes massas.",
      "imposição das ideias e posições de grupos específicos.",
      "decisão consciente do consumidor a respeito de sua\ncompra.",
      "identificação dos interesses do responsável pelo\nproduto divulgado."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Linguagem e argumentação", "Propaganda"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "valorizar usos informais caracterizadores da norma\nnacional.",
      "confirmar o uso da norma-padrão em contexto da\nlinguagem poética.",
      "enfatizar um processo recorrente na transformação\nda língua portuguesa.",
      "registrar a diversidade étnica e linguística presente no\nterritório brasileiro.",
      "reafirmar discursivamente a forte relação do falante\ncom seu lugar de origem."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação linguística", "Linguagem poética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Linguagem publicitária", "Intertextualidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "está repleta de informações confiáveis que constituem\nfonte única para a aprendizagem dos alunos.",
      "exige dos pais e professores que proíbam seu uso\nabusivo para evitar que se torne um vício.",
      "tende a se tornar um agente negativo na aprendizagem\ne na socialização de crianças e jovens.",
      "possibilita maior ampliação do conhecimento de\nmundo quando a aprendizagem é direcionada.",
      "eleva ao isolamento do mundo real e ao uso exclusivo\ndo computador se a navegação for desmedida."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de texto", "Novas tecnologias"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gênero lírico", "Figuras de linguagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "despreparo dos jogadores de futebol para ajudarem\nsuas famílias a superar a miséria.",
      "garantia de ascensão social dos jovens pela carreira\nde jogador de futebol.",
      "falta de investimento dos clubes para que os atletas\npossam atuar profissionalmente e viver do futebol.",
      "investimento reduzido dos atletas profissionais em\nsua formação escolar, gerando frustração e desilusão\nprofissional no esporte.",
      "despreocupação dos sujeitos com uma formação\nparalela à esportiva, para habilitá-los a atuar em\noutros setores da vida."
    ],
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Desigualdade social", "Mobilidade social"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "(Imagem de uma gravura em preto e branco de Alfred Kubin, intitulada \"Sonho e desarranjo\", retratando figuras distorcidas e sombrias)\nAlfred Kubin,\nrepresentante do\nExpressionismo.\nSonho e desarranjo,\nAlfred Kubin.",
      "(Imagem de uma pintura de Henri Matisse, intitulada \"Bailarina deitada\", retratando uma mulher deitada com cores vibrantes e formas simplificadas)\nHenri Matisse,\nrepresentante do\nFauvismo.\nBailarina deitada, Henri\nMatisse",
      "(Imagem de uma pintura de Diego Rivera, intitulada \"Mineiro\", retratando um trabalhador com formas volumosas e cores fortes)\nDiego Rivera,\nrepresentante do\nMuralismo.\nMineiro, Diego Rivera.",
      "(Imagem de uma pintura de Pablo Picasso, intitulada \"Retrato de Igor Stravinsky\", retratando um rosto com formas geométricas e fragmentadas)\nPablo Picasso,\nrepresentante do\nCubismo.\nRetrato de Igor\nStravinsky, Pablo Picasso.",
      "(Imagem de uma pintura de René Magritte, intitulada \"Os amantes\", retratando duas pessoas se beijando com os rostos cobertos por panos)\nRené Magritte,\nrepresentante do\nSurrealismo.\nOs amantes, René\nMagritte."
    ],
    correctAnswer: 0,
    materia: ["Arte"],
    conteudo: ["Movimentos artísticos", "Expressionismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "fato de motivarem o desaparecimento de línguas\nminoritárias."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Diversidade linguística", "Variação linguística"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "“Tomavam banho/ Na minha frente/ Para sair com\noutro cara”.",
      "“Surgiram outras/ Naturalmente/ Sem nem olhar a\nminha cara”.",
      "“Escolhia qualquer um/ Lançava olhares/ Debaixo do\nmeu nariz”.",
      "“É natural que toda atriz/ Presentemente represente/\nMuito para mim”."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros poéticos", "Funções da linguagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "barulho excessivo produzido pelo ranger das cadeiras\ndo teatro.",
      "indicação da neutralidade como a melhor opção\nideológica naquele momento.",
      "constatação da censura em função do engajamento\nsocial do texto dramático.",
      "correlação entre o alinhamento político e a posição\ncorporal dos espectadores.",
      "interrupção do espetáculo em virtude do\ncomportamento inadequado do público."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros dramáticos", "Contexto histórico"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "caracterizações de personalidades do contexto\nmusical brasileiro dos anos 1960.",
      "questões polêmicas direcionadas à produção musical\nbrasileira nos anos 1960.",
      "relatos de experiências de artistas sobre os festivais\nde música de 1967.",
      "explicações sobre o quadro cultural do Brasil durante\na década de 1960.",
      "opiniões a respeito de uma obra sobre a cena musical\nde 1967."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais", "Análise de resenha"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "noção de beleza globalizada veiculada pela\nindústria cultural.",
      "influência da mídia para a adoção de um estilo de vida\nsalutar pelas mulheres.",
      "relação entre a alimentação saudável e o padrão de\ncorpo instituído pela boneca.",
      "proporcionalidade entre a representação do corpo da\nboneca e a do corpo humano.",
      "influência mercadológica na construção de uma\nautoimagem positiva do corpo feminino."
    ],
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Padrões de beleza", "Indústria cultural"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Semântica", "Adequação vocabular"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "alertar os homens agressores sobre as\nconsequências de seus atos.",
      ...
      "exigir das autoridades ações preventivas contra a\nviolência doméstica."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Linguagem publicitária", "Campanhas sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "coloca o foco no “com o quê” se constrói a mensagem,\nsendo o código utilizado o seu próprio objeto.",
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Funções da linguagem", "Variação linguística"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "percepção da empatia como fator de\nautoconhecimento.",
      "impossibilidade de vivenciar experiências de\npertencimento."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros poéticos", "Identidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "nos Jogos Olímpicos, uma vez que reúnem diversos\npaíses na disputa de diferentes modalidades\nesportivas.",
      "nas competições de esportes individuais, uma vez que\no sucesso de um indivíduo incentiva a participação\ndos demais.",
      "nos campeonatos oficiais de futebol, regionais e\nnacionais, por se tratar de uma modalidade esportiva\nmuito popular no país.",
      "nas competições promovidas pelas federações\ne confederações, cujo objetivo é a formação e a\ndescoberta de talentos.",
      "nas modalidades esportivas adaptadas, cujo objetivo\né o maior engajamento dos cidadãos."
    ],
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Esporte e sociedade", "Lazer"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "denunciar a escassez de recursos públicos nas\nprefeituras do interior.",
      "censurar a falta de domínio da língua padrão em\neventos sociais.",
      "despertar a preocupação da plateia com a expectativa\nde vida dos cidadãos.",
      "questionar o apoio irrestrito de agentes públicos aos\ngestores governamentais."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros dramáticos", "Sátira"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O emprego do verbo haver, em vez de ter, em “há\n20 anos atrás foi humilhado”.",
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais", "Recursos linguísticos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "as escolas desenvolverem campanhas a favor da\nleitura."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Linguagem publicitária", "Incentivo à leitura"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "fusão de elementos da cultura brasileira com a arte\neuropeia.",
      "alusão aos símbolos cívicos presentes na bandeira\nnacional.",
      "composição simétrica de elementos relativos à\nmiscigenação racial."
    ],
    correctAnswer: 2,
    materia: ["Arte"],
    conteudo: ["Arte brasileira", "Modernismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "composição da verossimilhança do ambiente\nretratado.",
      "restrição do papel do narrador à observação das\ncenas relatadas.",
      "construção mística das personagens femininas pelo\nautor do texto.",
      "caracterização das preferências linguísticas da\npersonagem masculina."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação linguística", "Regionalismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "predomínio dos estigmas de classe e de raça sobre a\nintimidade da convivência.",
      "discurso da manutenção de uma ética doméstica\ncontra a subversão dos valores.",
      "desejo de superação do passado de escassez em\nprol do presente de abastança.",
      "sentimento de insubordinação à autoridade\nrepresentada pela matriarca da família.",
      "rancor com a ingratidão e a hipocrisia geradas pelas\nmudanças nas regras da casa."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Relações sociais", "Estilo literário"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Arte"],
    conteudo: ["Arte urbana", "Cultura brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Estilo literário", "Pontuação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Arte"],
    conteudo: ["Arte contemporânea", "Movimentos artísticos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["África pré-colonial", "Comércio"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ataque feito pelos japoneses à base militar americana\nde Pearl Harbor.",
      "desencadeamento da Guerra Fria e de novas\nrivalidades entre nações.",
      "morte de milhões de soldados nos combates da\nSegunda Guerra Mundial.",
      "execução de judeus e eslavos presos em guetos e\ncampos de concentração nazistas.",
      "lançamento de bombas atômicas em Hiroshima e\nNagasaki pelas forças norte-americanas."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Segunda Guerra Mundial", "Direitos Humanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Iluminismo", "Revolução Francesa"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Povos indígenas", "Direitos sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Escravidão no Brasil", "Relações sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Urbanização", "Segregação socioespacial"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "reduzir a fiscalização alfandegária para incentivar o\nconsumo."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Blocos econômicos", "Integração regional"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Pedologia", "Degradação ambiental"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "isenção de impostos de transportes.",
      "construção de terminais atracadouros.",
      "diversificação dos parceiros comerciais.",
      "contratação de trabalhadores portuários.",
      "intensificação do policiamento das rodovias."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Globalização", "Divisão internacional do trabalho"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "padronização da cultura e repressão aos\nparticularismos."
    ],
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Diversidade cultural", "Democracia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Cidade do Cabo (África do Sul), marcado pela\nreduzida amplitude térmica anual.",
      "Sydney (Austrália), caracterizado por precipitações\nabundantes no decorrer do ano.",
      "Mumbai (Índia), definido pelas chuvas monçônicas\ntorrenciais.",
      "Barcelona (Espanha), afetado por massas de ar seco.",
      "Moscou (Rússia), influenciado pela localização\ngeográfica em alta latitude."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Climatologia", "Cartografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "incremento da indústria e atuação no mercado\nfinanceiro.",
      "criação de programas assistencialistas e controle de\npreços.",
    ...
    conteudo: ["Ética", "Desenvolvimento humano"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "poder de suas bases militares espalhadas ao redor do\nmundo.",
      "alinhamento geopolítico da Rússia em relação aos EUA.",
      "política de expansionismo territorial exercida sobre Cuba.",
      "aliança estratégica com países produtores de\npetróleo, como Kuwait e Irã.",
      "incorporação da China à Organização do Tratado\ndo Atlântico Norte (Otan)."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Relações internacionais", "Geopolítica pós-Guerra Fria"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "racionalizar os custos da automação industrial\nmediante negociação sindical.",
      "recompor os mecanismos de acumulação econômica\npor meio da intervenção estatal."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Crise de 1929", "Intervenção estatal"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Arte"],
    conteudo: ["Vanguardas europeias", "Futurismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "A convenção entre cidadãos e soberano do\nAbsolutismo.",
      "A dialética entre indivíduo e governo autocrata do\nIdealismo.",
      "A contraposição entre bondade e condição selvagem\ndo Naturalismo."
    ],
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["Filosofia política", "Justiça"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "água, que expressa a causa material da origem\ndo universo.",
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Filosofia"],
    conteudo: ["Filosofia antiga", "Sócrates"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Estado", "Poder Judiciário"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Biogeografia", "Impactos ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Industrialização", "Fatores locacionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Idade Média", "Economia feudal"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "reduzido espaço relativo inundado.",
      "acentuado desnível do relevo local.",
      "elevado índice de urbanização regional.",
      "presença dos grandes parques industriais.",
      "proximidade de fronteiras internacionais estratégicas."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Fontes de energia", "Impactos ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Impactos ambientais", "Degradação do solo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Dinâmica populacional", "Migração interna"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Gênero", "Participação política"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "apoio da comunidade internacional à demanda\nnacional.",
      "equiparação da condição política com a dos demais\npaíses."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Conflitos contemporâneos", "Relações internacionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Escravidão no Brasil", "Resistência à escravidão"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Climatologia", "Fenômenos atmosféricos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Era Vargas", "Propaganda política"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "discussão de preceitos formais estabeleceu a\ndemocracia.",
      "invenção de códigos jurídicos desarticulou as\naristocracias.",
      "formulação de regulamentos oficiais instituiu as\nsociedades.",
      "definição de princípios morais encerrou os conflitos\nde interesses.",
      "criação de normas coletivas diminuiu as\ndesigualdades de tratamento."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Direito antigo", "Legislação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Brasil Imperial", "Questão agrária"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["República populista", "Era Vargas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Brasil Colônia", "Inconfidência Mineira"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "manipulação ideológica é favorecida pela privação\nmaterial."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Ditadura Militar", "Igreja e política"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Filosofia"],
    conteudo: ["Filosofia contemporânea", "Democracia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "assegura que a ação seja aceita por todos a partir da\nlivre discussão participativa.",
      "garante que os efeitos das ações não destruam a\npossibilidade da vida futura na terra.",
      "opõe-se ao princípio de que toda ação do homem\npossa valer como norma universal.",
      "materializa-se no entendimento de que os fins da\nação humana podem justificar os meios.",
      "permite que a ação individual produza a mais ampla\nfelicidade para as pessoas envolvidas."
    ],
    correctAnswer: 2,
    materia: ["Filosofia"],
    conteudo: ["Ética", "Immanuel Kant"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "áreas vulcânicas, onde o material magmático se\neleva, formando cordilheiras.",
      "faixas costeiras, onde o assoalho oceânico recebe\nsedimentos, provocando tsunamis.",
      "estreitas faixas de intensidade sísmica, no contato das\nplacas tectônicas, próximas a dobramentos modernos.",
      "escudos cristalinos, onde as rochas são submetidas\naos processos de intemperismo, com alterações\nbruscas de temperatura.",
      "áreas de bacias sedimentares antigas, localizadas no\ncentro das placas tectônicas, em regiões conhecidas\ncomo pontos quentes."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      ...
      "Continentalidade, que influencia na amplitude\nda temperatura."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "o bem dos indivíduos consiste em cada um perseguir\nseus interesses.",
      "o sumo bem é dado pela fé de que os deuses são os\nportadores da verdade.",
      "a política é a ciência que precede todas as demais na\norganização da cidade.",
      "a educação visa formar a consciência de cada pessoa\npara agir corretamente.",
      "a democracia protege as atividades políticas\nnecessárias para o bem comum."
    ],
    correctAnswer: 2,
    materia: ["Filosofia"],
    conteudo: ["Filosofia antiga", "Aristóteles"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "atuação dos consumidores como fiscalizadores da\nprodução.",
      "exigência de consumidores conscientes de seus\ndireitos.",
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Consumo", "Novas tecnologias"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "valorização de uma representação tradicional da\nmulher.",
      "descaracterização de referências do folclore\nnordestino.",
    ...
    correctAnswer: 4,
    materia: ["Arte"],
    conteudo: ["Arte brasileira", "Estética da resistência"],
    imageNames: []
})