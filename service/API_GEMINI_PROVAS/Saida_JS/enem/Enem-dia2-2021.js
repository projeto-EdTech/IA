...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Lançamento de Projéteis"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[IMAGEM DE DIAGRAMA DE CIRCUITO A]",
      "[IMAGEM DE DIAGRAMA DE CIRCUITO B]",
      "[IMAGEM DE DIAGRAMA DE CIRCUITO C]",
      "[IMAGEM DE DIAGRAMA DE CIRCUITO D]",
      "[IMAGEM DE DIAGRAMA DE CIRCUITO E]"
    ],
    correctAnswer: 1,
    materia: ["Física"],
...
createQuestion({
    ...
    options: [
      "[IMAGEM DE DIAGRAMA DE FORÇAS A]",
      "[IMAGEM DE DIAGRAMA DE FORÇAS B]",
      "[IMAGEM DE DIAGRAMA DE FORÇAS C]",
      "[IMAGEM DE DIAGRAMA DE FORÇAS D]",
      "[IMAGEM DE DIAGRAMA DE FORÇAS E]"
    ],
    correctAnswer: 0,
    materia: ["Física"],
...
createQuestion({
    ...
    options: [
      "[IMAGEM DA ESTRUTURA DE POLÍMERO A]",
      "[IMAGEM DA ESTRUTURA DE POLÍMERO B]",
      "[IMAGEM DA ESTRUTURA DE POLÍMERO C]",
      "[IMAGEM DA ESTRUTURA DE POLÍMERO D]",
      "[IMAGEM DA ESTRUTURA DE POLÍMERO E]"
    ],
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Polímeros"],
...
createQuestion({
    ...
    options: [
      "[IMAGEM DE PROJEÇÃO ORTOGONAL A]",
      "[IMAGEM DE PROJEÇÃO ORTOGONAL B]",
      "[IMAGEM DE PROJEÇÃO ORTOGONAL C]",
      "[IMAGEM DE PROJEÇÃO ORTOGONAL D]",
      "[IMAGEM DE PROJEÇÃO ORTOGONAL E]"
    ],
    correctAnswer: 4,
    materia: ["Matemática"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Leitura de Gráficos", "Cálculos Percentuais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Criptografia", "Estatística"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Ondas", "Movimento Harmônico Simples"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[GRÁFICO DE FUNÇÃO QUADRÁTICA A]",
      "[GRÁFICO DE FUNÇÃO QUADRÁTICA B]",
      "[GRÁFICO DE FUNÇÃO QUADRÁTICA C]",
      "[GRÁFICO DE FUNÇÃO QUADRÁTICA D]",
      "[GRÁFICO DE FUNÇÃO QUADRÁTICA E]"
    ],
    correctAnswer: 4,
    materia: ["Matemática"],
...
createQuestion({
    ...
    options: [
      "[GRÁFICO DE FUNÇÃO DEFINIDA POR PARTES A]",
      "[GRÁFICO DE FUNÇÃO DEFINIDA POR PARTES B]",
      "[GRÁFICO DE FUNÇÃO DEFINIDA POR PARTES C]",
      "[GRÁFICO DE FUNÇÃO DEFINIDA POR PARTES D]",
      "[GRÁFICO DE FUNÇÃO DEFINIDA POR PARTES E]"
    ],
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Funções Definidas por Partes", "Análise de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Grandezas e Medidas", "Aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Finanças", "Análise de Custos"],
    imageNames: []
})