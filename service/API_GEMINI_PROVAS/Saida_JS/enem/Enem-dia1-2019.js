...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Letra de Música"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Gêneros Textuais (Campanha Publicitária)", "Direitos Humanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Análise de Letra de Canção", "Relações de Gênero"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Gêneros Textuais (Carta)", "Coerência e Coesão"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Mídia e Sociedade", "Esporte e Cultura"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "chamamento de diferentes atores sociais pelo uso recorrente de estruturas injuntivas.",
      "variedade linguística caracterizadora do português europeu.",
      "restrição a um grupo específico de vítimas ao apresentar marcas gráficas de identificação de gênero como “o(a)”.",
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Linguagem Publicitária", "Funções da Linguagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Cultura Indígena", "Globalização e Tradição"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Linguagem das Artes Visuais (Quadrinhos)", "Inclusão Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Modernismo Brasileiro", "Vanguarda Europeia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Poesia", "Interpretação de Texto Poético"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Funções da Linguagem", "Gêneros Textuais (Notícia)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Textuais (Crônica)", "Elementos Narrativos"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Cultura Digital e Comportamento", "Leitura de Infográfico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Tecnologia e Sociedade", "Conhecimento e Acesso"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Impactos Sociais da Internet", "Privacidade Digital"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Tecnologia da Informação Geográfica", "Economia Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Narrativos (Crônica)", "Análise de Personagens"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Poesia Concreta", "Interpretação de Poema"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Linguagem Publicitária", "Questões Humanitárias"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Textuais (Canção)", "Funções da Linguagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Arte"],
    conteudo: ["Cultura Brasileira (Carnaval)", "Música Regional"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Direitos Humanos e Cidadania", "Demografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Narrativos (Prosa)", "Análise de Texto Literário"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Tecnologia e Conhecimento", "Redes Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Arte"],
    conteudo: ["Escultura Moderna", "Materialidade na Arte"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Fisiologia Humana", "Argumentação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Prosa Poética", "Estilos Literários"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Roma Antiga", "Etimologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Distúrbios Alimentares", "Corpo e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Arte"],
    conteudo: ["Arte Contemporânea", "Linguagens Artísticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Movimentos Sociais Digitais", "Redes Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Produção Textual", "Inteligência Artificial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Poesia Contemporânea", "Interpretação de Texto Poético"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Vanguarda Europeia (Futurismo)", "Movimentos Literários"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Narrativos (Conto)", "Alegoria"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Estratégias Argumentativas", "Zoologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Textuais (Carta de Jogo)", "Intertextualidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Morfossintaxe", "Análise de Poema"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa", "Arte"],
    conteudo: ["Variação Linguística (Regionalismo)", "Música Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Impactos Ambientais", "Geologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Climatologia", "Sensoriamento Remoto"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Racionalismo", "Iluminismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Filosofia", "Sociologia"],
    conteudo: ["Teoria do Direito", "Organização Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Colonização do Brasil", "Comércio Colonial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Independência do Brasil", "Gênero e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Economia Global", "Indústria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Filosofia"],
    conteudo: ["Ética", "Filosofia Medieval"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Idade Média", "Urbanização Histórica"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Relação Sociedade-Natureza", "Análise de Textos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Diversidade Cultural e Religiosa", "Direitos Humanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Economia Moderna", "Liberalismo Econômico"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Filosofia da Ciência", "História da Física"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Política Moderna", "Maquiavel"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Políticas Públicas", "Cidadania"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História", "Geografia"],
    conteudo: ["Quilombos", "Organização Espacial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Dinâmica Rural e Urbana", "Ocupação da Amazônia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Mídia e Estereótipos", "Corpo e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia", "Geografia"],
    conteudo: ["Mundo do Trabalho", "Economia Global"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Primeiro Império (Brasil)", "Cidadania no Império"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Cristianismo Medieval", "Sincretismo Cultural"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Contemporânea", "Michel Foucault"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia", "Geografia"],
    conteudo: ["Filosofia da Ciência", "Questão Ambiental"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Filosofia", "História"],
    conteudo: ["Teoria Política (Totalitarismo)", "Segunda Guerra Mundial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Arte", "Sociologia"],
    conteudo: ["Arte Urbana", "Espaço Urbano"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Filosofia Moderna (Kant)", "Intertextualidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["Antiguidade Clássica", "Cidadania"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["República Oligárquica", "Movimentos Urbanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Geografia"],
    conteudo: ["Brasil República (Juscelino Kubitschek)", "Migrações Internas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História", "Sociologia"],
    conteudo: ["Direitos Humanos", "Cidadania Global"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Arte", "Sociologia"],
    conteudo: ["Patrimônio Cultural", "Indústria Cultural"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Expansão Marítima", "Período Moderno"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Trabalho Escravo Contemporâneo", "Políticas Públicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Demografia", "Políticas Públicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Coordenadas Geográficas", "Climatologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia", "Sociologia"],
    conteudo: ["Problemas Socioeconômicos", "Desigualdade Social"],
    imageNames: []
})