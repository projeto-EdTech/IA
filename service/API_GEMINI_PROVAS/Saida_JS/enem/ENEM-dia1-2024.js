...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Vocabulário e Interpretação textual"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Interpretação de imagem e texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "recusar o recebimento de seu manuscrito.",
    ...
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Gêneros textuais e propósito comunicativo"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Variação Linguística", "Cultura"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Música", "Cultura e Migração"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Variação Linguística", "Cultura Afro-Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Desigualdade Social", "Saúde"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Tecnologia e Sociedade", "Saúde Pública"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Arte", "História"],
    conteudo: ["Artes Visuais", "Cultura Afro-Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Racismo e Mídias Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Saúde e Desigualdade Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Literatura Brasileira", "Desigualdade Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais", "Semântica"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Artes Indígenas", "Cultura Indígena"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Gêneros textuais", "Violência Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação Linguística", "Linguagem Literária"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais", "Argumentação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Família e Relações Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Literatura Brasileira", "Teoria da Arte"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa", "História"],
    conteudo: ["Literatura Brasileira", "Império no Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais", "Análise Textual"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais", "Linguagem Não Verbal"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação Linguística", "Tecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Arte"],
    conteudo: ["História da Arte", "Artes Visuais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais", "Metáfora"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação Linguística", "Cultura Popular"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Arte", "Sociologia"],
    conteudo: ["Cultura Popular", "Manifestações Culturais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros textuais", "Linguagem poética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Arte"],
    conteudo: ["Fotografia", "Tecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Esporte e Cultura", "Mudança Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa", "Sociologia"],
    conteudo: ["Comunicação e Mídias Digitais", "Educação e Mídias Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Saúde Pública", "Organização Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Impactos Ambientais", "Desastres e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Modernização no Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Colonização da América", "Ética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Arte", "História"],
    conteudo: ["Dança", "Sociedade e Costumes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Hidrografia", "Climatologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Preconceito e Desigualdade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["Cultura Afro-Brasileira", "Religião e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Espaço Urbano", "Democracia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia", "Sociologia"],
    conteudo: ["Meio Ambiente e Sociedade", "Movimentos Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Abolicionismo", "Música e Literatura"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Globalização e Cultura"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "O enrijecimento das doutrinas religiosas sobre a organização da vida doméstica."
    ],
    correctAnswer: 2,
    materia: ["História", "Sociologia"],
    conteudo: ["Saúde Pública", "Gênero e Família"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Tecnologia e Povos Tradicionais", "Economia e Meio Ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Filosofia Política", "Gênero e Educação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Rede e Fluxos", "Organização do Espaço"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia", "Sociologia"],
    conteudo: ["Geopolítica Ambiental", "Sustentabilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Arte"],
    conteudo: ["Artes Visuais", "Cultura Popular"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História", "Sociologia"],
    conteudo: ["Cultura Brasileira", "Manifestações Culturais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Filosofia"],
    conteudo: ["Iluminismo", "Teoria Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["História do Brasil", "Mídia e Propaganda"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["Globalização Cultural", "Mídia e Cultura"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Cultura Afro-Brasileira", "Territórios"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Indutivo, porque observa eventos particulares e infere leis universais.",
      "Demonstrativo, porque encadeia premissas e extrai conclusões indubitáveis.",
      "Analógico, porque compara diferentes situações e detecta elementos semelhantes."
    ],
    correctAnswer: 2,
    materia: ["Filosofia"],
    conteudo: ["Lógica", "Epistemologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Cartografia", "Poder e Território"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História", "Geografia"],
    conteudo: ["Economia e Sociedade", "Região Amazônica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["América Latina", "Direitos Humanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Urbanização", "Impactos Ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia", "Sociologia"],
    conteudo: ["Filosofia Política", "Cidadania"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Clima e Meio Ambiente Urbano", "Ecologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História", "Sociologia"],
    conteudo: ["Organizações Internacionais", "Relações Internacionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia", "Filosofia"],
    conteudo: ["Trabalho e Capitalismo", "Crítica Social"],
    imageNames: []
})