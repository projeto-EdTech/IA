...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Morfossintaxe", "Coesão e Coerência"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Filosofia Política", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Realismo Português"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "seu enredo é marcado por intenso e trágico sofrimento amoroso cujo desfecho concretiza um final feliz, com a união conjugal e ascensão social dos personagens.",
      "sua linguagem é marcada pela oralidade e coloquialidade, em tom de crônica jornalística, ilustrando a prática de que se deve escrever como se fala.",
      "obra caracterizada pela ausência do tom açucarado e idealizador da literatura romântica, visto que as relações sentimentais não se dão nem pela grandeza no sofrimento, nem pela redenção pela dor.",
      "a caracterização dos personagens ou fere a descrição sempre idealizada do perfil feminino ou configura traços de um herói pelo avesso mais marcado por defeitos que por virtudes."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Romantismo Brasileiro"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Realismo Brasileiro"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "às lembranças vividas pelo autor, em sua relação direta com a população da cidade do Rio de Janeiro, no final do século XIX.",
      "aos fatos narrados ao autor por um companheiro de redação, ex-militar português que vivera no Brasil os tempos descritos no romance.",
      "às situações vividas e relatadas pelo Major Vidigal, único personagem rigorosamente histórico do romance, conhecedor da sociedade de seu tempo.",
      "aos relatos feitos pelo sargento de milícias, das peripécias de toda sorte, em especial as amorosas, vividas por ele ao longo da narrativa."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Romantismo Brasileiro"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Realismo Brasileiro", "Funções da Linguagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Mas irou-se com a comparação, deu murradas na parede. Era bruto, sim senhor, nunca havia aprendido, não sabia explicar-se. Estava preso por isso? Como era? Então mete-se um homem na cadeia porque ele não sabe falar direito? Que mal fazia a brutalidade dele?",
      "Sinha Vitória, distraída, aludiu vagamente a certo lugar ruim demais, e como o filho exigisse uma descrição, encolheu os ombros.",
      ...
      "Fabiano dizia que na serra havia tocas de suçuaranas. E nos bancos de macambira, rendilhados de espinhos, surgiam cabeças chatas de jararacas."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Modernismo (2ª Geração)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Apresenta-se mais humanizada que os membros da família de Fabiano, apesar de ser um personagem não-humano.",
      "Marca-se por espontaneidade e vivacidade e é capaz de vencer as barreiras da incomunicabilidade ao relacionar-se com outros personagens da história.",
      "É acometida por uma doença incurável e acaba morrendo de forma natural, sob o olhar das crianças e de Fabiano, fantasiando em seus momentos de delírio as caçadas que fazia aos preás.",
      "Acumula importantes funções na narrativa quais sejam as de ser guia, a de ser a responsável pela sobrevivência do grupo e a de acompanhar as crianças nas folganças e os adultos no trabalho."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Modernismo (2ª Geração)"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Figuras de Linguagem", "Literatura Brasileira"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "gatos de estimação deveriam tomar Prozac quando deprimidos.",
      "alguns cientistas estão considerando a possibilidade de animais terem doenças antes só atribuídas a humanos.",
      "animais de estimação que tomam Prozac não parecem ser eles mesmos durante algum tempo.",
      "alguns cientistas estão começando a investigar vidas passadas dos animais de estimação."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "It does not immediately spring to mind",
      "Human race to reach Mars",
...
createQuestion({
    ...
    options: [
      "cães têm glândulas sudoríparas nas patas.",
      "deve-se levar os cães para passear, o que evita o problema.",
      "em caso de suspeita de insolação, deve-se colocar o cão em uma banheira com gelo.",
      "tais cuidados com os cães devem ser mantidos ao longo de todo o verão."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Reading Comprehension"],
...
createQuestion({
    ...
    options: [
      "peso excessivo, gengivas vermelhas, inquietação",
      "inquietação, salivação excessiva, respiração ofegante",
      "respiração ofegante, sobrepeso, pelos escuros",
      "diarreia, vômito, braquicefalia"
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Vocabulary"],
...
createQuestion({
    ...
    options: [
      "As evidências apontam para uma conjunção de fatores que levaram à extinção dos dinossauros.",
      "Um asteroide matou animais marinhos e vulcões mataram animais terrestres.",
      "Um asteroide causou a morte de animais marinhos e dinossauros.",
      "As evidências apresentadas pelos geólogos de Berkeley não são convincentes."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Reading Comprehension"],
...
createQuestion({
    ...
    options: [
      "os beneficiados aumentaram suas despesas com itens desnecessários.",
      "os quenianos investiram em criação de animais e aquisição de terras.",
      "os quenianos desapontaram os órgãos de ajuda internacional.",
      "a doação de bens e alimentos é sempre mais eficiente do que ajuda em dinheiro."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Reading Comprehension"],
...
createQuestion({
    ...
    options: [
      "os moradores dos vilarejos pobres do Quênia ficavam perplexos por ver estudantes de Harvard passar seus verões entre eles.",
      "especialistas em desenvolvimento apoiaram o projeto incondicionalmente, desde o princípio.",
      "o Sr. Ackman aconselhou os moradores a investir em criação de animais e compra de terras.",
      "os resultados do projeto surpreenderam os organismos de ajuda internacional."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Reading Comprehension"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História do Brasil Colônia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "o crescimento futuro do uso de combustíveis fósseis é certo, pois as novas tecnologias de prospecção estão nos informando sobre reservas inesgotáveis.",
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia Ambiental", "Ambientalismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "do movimento de oscilação da placa tectônica sul-americana, que na escala de tempo da natureza sofre eventuais soerguimentos.",
      "de um processo erosivo acelerado produzido pelo aumento do volume das águas da bacia do Rio S. Francisco, em consequência de mudanças climáticas na região.",
      "de um processo de erosão ou denudação muito lento ou, melhor dizendo, dentro de uma temporalidade que é a da natureza, cuja escala torna o tempo humano irrisório.",
      "do desmatamento realizado pelo ser humano nos vales da bacia do Rio S. Francisco que facilitou a aceleração do processo de denudação."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia da População", "Indicadores Socioeconômicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o mapa nos indica uma nítida relação entre o crescimento econômico dos chamados países emergentes e o investimento em educação.",
      "nem todos os países que aparecem com os percentuais mais elevados de investimentos são desenvolvidos, aliás, alguns são tidos como subdesenvolvidos.",
      "o continente com os maiores Índices de Desenvolvimento Humano (IDH) é aquele no qual a totalidade dos países tem os maiores percentuais do PIB de investimentos.",
      "o mapa mostra o esperado, uma relação bem clara entre a falta de investimentos em educação e os baixos níveis de desenvolvimento."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geografia Econômica", "Indicadores Socioeconômicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a automobilização de São Paulo é um elemento chave de sua mobilidade urbana, algo comprovado por um número de habitantes por veículo menos elevado do que em muitas cidades de países mais ricos.",
      "essa automobilização de São Paulo é muito específica em comparação com as outras metrópoles brasileiras, que, em razão de dificuldades econômicas, possuem índices desprezíveis de automobilização.",
      "a diminuição do número de habitantes por veículo, como mostra o gráfico, foi uma evolução constante, produto do desenvolvimento econômico do país e da cidade e também do aumento da igualdade econômica.",
      "São Paulo, apesar de seus problemas, exemplifica a possibilidade eficiente de usar o automóvel como modal relevante na mobilidade urbana e sua harmonia com o transporte coletivo nas ruas da cidade."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geografia Urbana", "Mobilidade Urbana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Sequências"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Números Complexos", "Polinômios"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Funções Quadráticas", "Porcentagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Tripsina, que atua no estômago.",
      "Tripsina, que atua no duodeno.",
      "Pepsina, que atua no estômago.",
      "Pepsina, que atua no duodeno."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana", "Enzimas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ao mesmo filo e à mesma classe.",
      "ao mesmo filo, porém a diferentes classes.",
      "à mesma ordem e à mesma classe.",
      "à mesma ordem, porém, a diferentes classes."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana", "Sistema Sanguíneo ABO"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Citologia", "Divisão Celular"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "acarretaria modificação em parte da sequência de aminoácidos da proteína a ser sintetizada.",
      "acarretaria modificação em todos os códons subsequentes no trecho do RNA mensageiro correspondente.",
...
createQuestion({
    ...
    options: [
      "gás carbônico e água, e produção de substâncias orgânicas, que são transportadas da folha para o caule e para a raiz pelo floema.",
      "oxigênio e água, e produção de substâncias orgânicas, que são transportadas da folha para o caule e para a raiz pelo floema.",
      "gás carbônico e água, e produção de substâncias orgânicas, que são transportadas da folha para o caule e para a raiz pelo xilema.",
      "oxigênio e água, e produção de substâncias orgânicas, que são transportadas da folha para o caule e para a raiz pelo xilema."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "endotérmica, absorvendo 306 kJ a cada mol de NO2 decomposto.",
      "endotérmica, absorvendo 441 kJ a cada mol de NO2 decomposto.",
      "exotérmica, absorvendo 306 kJ a cada mol de NO2 decomposto.",
      "exotérmica, liberando 441 kJ a cada mol de NO2 decomposto."
    ],
    correctAnswer: 0,
    materia: ["Química"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Química Inorgânica", "Estequiometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "132 pm 110 pm 154 pm 97 pm 123 pm",
      "110 pm 154 pm 132 pm 123pm 97 pm",
      "123pm 97 pm 110 pm 154 pm 132 pm",
      "97 pm 132 pm 123 pm 110 pm 154pm"
    ],
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Ligações Químicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a meia vida do ²¹²Bi é de 60 minutos.",
      "após aproximadamente 25 minutos do início do experimento, a relação entre a massa de ²¹²Bi e a massa de ²¹²Po é igual a 3.",
      "no decaimento do ²¹⁴Bi forma-se o isótopo ²¹⁰Tl.",
      "após 4 horas do início do experimento, ainda restam 12,5 mg de ²¹²Bi sem sofrer desintegração radioativa."
    ],
    correctAnswer: 3,
    materia: ["Química"],
...
createQuestion({
    ...
    conteudo: ["Química Geral", "Estrutura Atômica", "Ondulatória", "Eletromagnetismo"],
    imageNames: []
})