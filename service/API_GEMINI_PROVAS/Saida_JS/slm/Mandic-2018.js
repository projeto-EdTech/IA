createQuestion({
    ...
    conteudo: ["Interpretação Textual", "Elementos Linguísticos"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "Leia o texto.\nUM HOMEM DE LETRAS\nEm janeiro de 2002 recebi uma carta de Howard Engel, escritor canadense conhecido pela série de histórias do detetive Benny Cooperman, em que descrevia um estranho problema. Contou que acordou certa manhã sentindo-se bem e foi pegar o jornal, que parecia ter sofrido uma transformação impressionante: \"O Globe and Mail de 31 de julho de 2001 parecia o mesmo de sempre. A única diferença era que eu não conseguia mais ler o que estava escrito ali. Eu podia ver que as letras que o compunham eram as 26 do alfabeto inglês com as quais eu estava habituado. Só que agora, quando eu as focalizava, ora pareciam cirílico, ora coreano. Olhei os classificados e os quadrinhos. Também não consegui ler nada. /.../ 'Só posso ter sofrido um derrame”.\nFoi submetido a uma série de exames, e sua suspeita confirmou-se: tivera mesmo um derrame. Mas espantou-se ao constatar que ainda era capaz de escrever. Howard ficou pasmo. Ora, ler e escrever andam juntos; como é que ele podia perder uma coisa e não a outra? A enfermeira sugeriu que tentasse fazer sua assinatura; ele hesitou, mas assim que começou, a escrita pareceu fluir por conta própria; logo em seguida à assinatura, ele redigiu duas ou três frases. O ato de escrever pareceu-lhe absolutamente normal, automático, sem esforço, como andar ou falar. A enfermeira leu sem problemas o que ele escrevera, mas ele não conseguiu ler uma só palavra.\nO termo médico para o fato é \"alexia sem agrafia\". A alexia é uma forma específica de agnosia visual, uma incapacidade de reconhecer linguagem escrita, uma “cegueira para palavras\". Existem duas formas: uma grave, que impede o reconhecimento até das letras individualmente, e outra mais branda, que permite reconhecer letras, mas apenas uma por uma, não simultaneamente como palavras.\n(SACKS, Oliver. O olhar da mente. Trad. de Laura Teixeira Motta. São Paulo: Companhia das Letras, 2010, p. 58 a 64. Adaptado.)\nA formulação que mais adequadamente relaciona o tema do texto ao gênero no qual o redigiu o célebre neurologista anglo-americano aparece em:",
      subItens: []
    },
    options: [
      "O médico conta, sob a forma de narrativa em primeira pessoa, uma experiência clínica vivida em seu consultório: um paciente conseguia falar sobre seu distúrbio neurológico, embora não fosse mais capaz de exercer o ofício de escritor, já que se tornara subitamente ágrafo.",
      "Ficcionalizando, sob a forma de um diário, a patologia que o vitimou, um cientista simula o diálogo epistolar entre paciente e médico: discutem o tratamento para a agnosia visual, síndrome que ocasiona incapacidade linguística transitória, podendo evoluir para a forma grave.",
      "Partindo do relato mnêmico feito por um paciente, o médico descreve e comenta o caso num ensaio, nomeando a doença para diagnosticá-la: a alexia, surgida após um acidente vascular cerebral, impede de ler, contudo não priva o doente da capacidade de expressão escrita.",
      "Embora aléxico, um autor de histórias de detetive envia pelo correio um texto ao médico que o acompanharia no tratamento: uma reportagem científica sobre caso similar, reproduzindo o depoimento de um homem que deixara de exercer a profissão graças à cegueira para palavras.",
      "A fim de responder publicamente a uma correspondência recebida, o médico publica um relatório técnico sobre a sintomatologia da Síndrome de Howard: uma sequela do derrame cerebral caracterizada pela incapacidade de reconhecer imagens e decodificar textos impressos."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 5\nEm 1906, o francês Félix Fénéon publicou sintéticas notícias sobre a sociedade da sua época, em textos jornalísticos marcados por refinados jogos de linguagem. A seguir, transcreve-se uma delas:\n\"A caixa de ofertas de Antônio de Pádua foi quebrada em Saint-Germain-l'Auxerrois. O santo procura seu assaltante.\"\n(In FÉNÉON, Félix. Notícias em três linhas. Trad. de Adriano Lacerda e Marcos Siscar. Rio de Janeiro: Rocco, 2018.)\nNo texto, a ironia advém",
      subItens: []
    },
    options: [
      "da atribuição de uma ação, expressa pelo verbo no Presente do Indicativo, a quem não poderia praticá-la.",
      "da causa do principal do acontecimento relatado, condensado na combinação de um substantivo seguido por um adjetivo.",
      "do adjetivo que destaca uma qualificação inesperada, atribuída pela própria vítima à ação sofrida.",
      "da primeira oração que traz como predicado um eufemismo.",
      "da construção do parágrafo que concentra o inusitado na segunda oração, isolado por adjunto adverbial."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 6\nUma pessoa pretende elaborar uma senha bancária composta por quatro elementos distintos, sendo números de 1 a 9 ou letras, dentre as 26 letras do nosso alfabeto, sabendo que o sistema do banco faz distinção entre letras em caixa alta (maiúsculas) e letras em caixa baixa (minúsculas). O primeiro elemento será um número múltiplo de 3; o segundo elemento, uma vogal; o terceiro elemento será um número ímpar; e o último elemento, uma letra qualquer. O número total de possibilidades diferentes para essa pessoa elaborar a senha é",
      subItens: []
    },
    options: [
      "7 800.",
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 11\nA média e a moda das idades inteiras de 5 amigos são, respectivamente, 20 anos e 18 anos. Sabendo-se que o amigo mais velho nasceu 13 anos antes que o mais novo, e que excluindo as idades dos amigos mais velho e mais novo a média das três outras idades é 19 anos, a diferença das idades do amigo mais velho e do amigo que nasceu imediatamente após ele é de",
      subItens: []
    },
    options: [
      "6 anos.",
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Análise de Gráficos e Tabelas", "Porcentagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Séries Geométricas", "Equações de Segundo Grau"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 19\nConsidere a figura a seguir:\n\nGrá$fico/Tabela$: Gráfico com duas curvas e uma região hachurada. Uma curva é uma reta decrescente e a outra é uma parábola com concavidade para cima, passando pela origem.\n\nA região hachurada corresponde à resolução do sistema",
      subItens: []
    },
    options: [
      "{x + 2 - y > 0\ny-x² < 0",
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 20\nSabendo que Imf = {y ∈ R| − 1 < y < 1 } é o conjunto imagem da função f: R → R dada por y = f(x) = $\\sin$(x), o conjunto imagem da função g: R → R dada por y = g(x) = 5 – 2 · $\\sin$(x) é",
      subItens: []
    },
    options: [
      "Img = {y ∈ R|4 < y < 8 }",
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Cinemática", "Lançamento de Projéteis"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "F = 3,2.10-19 N e E = 2,0 $N/C$",
      "F = 1,8.10-20 N e E = 1,2. 10-1 $N/C$",
      "F = 1,8.10-25 N e E = 1,2.10-5 $N/C$",
      "F = 3,2.10-22 N e E = 2,0.10-3 $N/C$",
      "F = 3,2.10-25 N e E = 2,0.10-6 $N/C$"
    ],
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica", "Campo Elétrico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Física Moderna", "Eletromagnetismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo", "Eletrodinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 36\nA eritromicina é um antibiótico obtido a partir de culturas do fungo Streptomyces erythreus. Esse antibiótico foi muito utilizado no tratamento de infecções bacterianas em pessoas com história de alergia às penicilinas. A eritromicina age pela inibição do movimento dos ribossomos ao longo do RNAm da célula procarionte. De acordo com esse mecanismo de ação, a eritromicina afeta",
      subItens: []
    },
    options: [
      "a duplicação do DNA.",
      "a transcrição do DNA para o RNAm.",
      "a inibição da síntese de aminoácidos.",
      "o acoplamento do aminoácido ao RNAt.",
      "o emparelhamento do anticódon ao códon."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Biologia Celular", "Genética Molecular"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 37\nUma das características morfofuncionais relevantes das bactérias é a presença de parede celular.\nSobre a parede celular bacteriana são feitas as seguintes afirmações:\nI. é um local de ação de alguns antibióticos.\nII. impede que a célula seja fagocitada.\nIII. seu arranjo bioquímico pode ser usado para classificar as bactérias.\nÉ correto o que se afirma em",
      subItens: []
    },
    options: [
      "II, apenas.",
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 38\nConsidere a seguinte árvore filogenética hipotética arrolando a espécie humana e espécies viventes de macacos do velho mundo e dos grandes macacos:\n\nGrá$fico/Tabela$: Árvore filogenética mostrando as relações de parentesco entre macacos do velho mundo, gibão, gorila, chimpanzé, bonobo, homem e orangotango.\n\nA interpretação dessa árvore filogenética permite afirmar que",
      subItens: []
    },
    options: [
      "chimpanzés e bonobos são ancestrais do homem.",
      "macacos do velho mundo e gibões não são relacionados.",
      "o grupo que se diversificou mais recentemente é o humano.",
      "chimpanzés e humanos são mais relacionados do que gorilas e chimpanzés.",
      "o orangotango é o macaco antropoide que tem o maior parentesco com o homem."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Evolução"],
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 40\nConsidere a seguinte árvore genealógica:\n\nGrá$fico/Tabela$: Árvore genealógica com João e Maria como pais, Pedro e Ana (filhos de João e Maria), Lucas, Paula (filhos de Pedro e Ana), Gabriel, Helena (filhos de Lucas e Paula), Mateus (filho de Gabriel e Helena), Daniel e Flávio (filhos de Mateus).\n\nNa situação apresentada, há várias pessoas que são portadoras do mesmo DNA mitocondrial. Entre elas estão",
      subItens: []
    },
    options: [
      "JOÃO e MARIA.",
      "PAULA, MATEUS e GABRIEL.",
      "PEDRO, LUCAS e GABRIEL.",
      "MATEUS, DANIEL e FLÁVIO.",
      "MARIA, HELENA, PAULA e ANA."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Genética"],
...
createQuestion({
    ...
    options: [
      "H-C-C-C-H (com OH em cada C)",
      "Estrutura de um álcool, com CH2OH-CH2OH, e OH",
      "Estrutura com anel benzeno, NH2, C, CH3, OH",
      "Estrutura de um fosfolipídio com cadeia de CH2 e grupos fosfato",
      "Cadeia longa de carbonos com H e OH"
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Bioquímica", "Metabolismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 42\nObserve as imagens de dois organismos:\n\nGrá$fico/Tabela$: Imagens de \"Armadillidium vulgare\" (tatu-bolinha) e \"Tolypeutes tricinctus\" (tatu-bola).\n\nEm termos de classificação biológica, pode-se afirmar que o",
      subItens: []
    },
    options: [
      "tatu-bola e o tatu-bolinha são, ambos, animais cordados.",
      "tatu-bolinha e o tatu-bola pertencem a classes diferentes, mas são do mesmo filo.",
      "tatu-bolinha e o tatu-bola pertencem a ordens diferentes, mas são da mesma classe.",
      "tatu-bola é um mamífero terrestre e o tatu-bolinha é um equinoderma com hábitos terrestres.",
      "tatu-bolinha pertence ao mesmo filo das borboletas, enquanto o tatu-bola pertence à mesma classe dos morcegos."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Taxonomia"],
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 43\nA circulação do sangue pelas cavidades do coração e grandes vasos adjacentes gera sons (ou batidas) que podem ser facilmente captados por meio de um estetoscópio. O padrão (duração, intensidade etc) dos sons auscultados pode servir de referência para identificar situações de normalidade ou de anormalidade estrutural e funcional do coração. Os sons em questão são usualmente referidos como \"lub\" e \"dub\".\nA primeira batida, ou seja, o “lub”, corresponde ao som produzido pelo impacto do sangue contra",
      subItens: []
    },
    options: [
      "os nodos sinoatrial e atrioventricular.",
      "as valvas semilunares aórtica e pulmonar.",
      "as valvas atrioventriculares direita e esquerda.",
      "a valva atrioventricular direita e a valva semilunar pulmonar.",
      "a valva atrioventricular esquerda e a valva semilunar aórtica."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana", "Sistema Cardiovascular"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 44\nO sangue é um tecido líquido que desempenha funções importantíssimas, entre as quais o transporte de gases respiratórios e a defesa do organismo. Para fins de estudo, o sangue é basicamente dividido em plasma e elementos figurados. Um dos elementos figurados do sangue é o neutrófilo.\nSobre o neutrófilo, são feitas as seguintes afirmações:\nI. é uma célula agranulócita.\nII. é formado na medula espinhal.\nIII. é o elemento figurado mais abundante em termos de número de células por milímetro cúbico de sangue.\nIV. é a célula que, ao se diferenciar em plasmócito, produz anticorpos.\nEm relação aos conceitos expressos em I, II, III e IV, pode-se afirmar que",
      subItens: []
    },
    options: [
      ...
      "apenas um é correto.",
      "apenas dois estão corretos.",
      "três dos quatro estão corretos."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana", "Sistema Imunológico"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 45\nEm sua viagem exploratória a bordo do Beagle, Charles Darwin talvez tenha feito algumas das mais importantes observações que subsidiariam sua teoria ao ter visitado, em 1835, as Ilhas Galápagos, no Oceano Pacífico. Assim como Galápagos, as ilhas oceânicas são consideradas verdadeiros laboratórios naturais para estudos sobre evolução. Tal distinção pode ser atribuída ao fato de que",
      subItens: []
    },
    options: [
      "nas ilhas oceânicas, as relações entre os organismos e entre eles e o ambiente são muito similares e reproduzíveis.",
      "do ponto de vista geológico, as ilhas oceânicas são muito recentes e, portanto, ecologicamente instáveis.",
      "há um pequeno e controlado número de espécies vivendo numa ilha oceânica.",
      "a taxa de especiação é praticamente nula numa ilha oceânica.",
      "as ilhas oceânicas estão isoladas de terras continentais."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Evolução", "Ecologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ao órgão doado por linfócitos B do receptor.",
      "ao órgão doado por linfócitos T do receptor.",
      "ao órgão doado por linfócitos de memória do receptor.",
      "aos linfócitos do receptor por macrófagos do órgão transplantado.",
      "aos anticorpos do receptor por anticorpos do órgão transplantado."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana", "Sistema Imunológico"],
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 47\nNo esquema abaixo, I, II e III são substâncias produzidas pela oxidação da glicose. Os processos Y e Z ocorrem, respectivamente, em leveduras e células animais, nas situações em que há limitação de O2.\n\nGrá$fico/Tabela$: Esquema de via metabólica. Glicose passa por Processo X, produzindo I. I pode ir para Processo Y (produzindo II) ou Processo Z (produzindo III).\n\nNas vias metabólicas representadas, o processo X ocorre",
      subItens: []
    },
    options: [
      "no citoplasma; e I, II e III identificam, respectivamente, o etanol, o ácido pirúvico e o ácido lático.",
      "no citoplasma; e I, II e III identificam, respectivamente, o ácido lático, o etanol e o ácido pirúvico.",
      "no citoplasma; e I, II e III identificam, respectivamente, o ácido pirúvico, o etanol e o ácido lático.",
      "na mitocôndria; e I, II e III identificam, respectivamente, o etanol, o ácido lático e o ácido pirúvico.",
      "na mitocondria; e I, II e III identificam, respectivamente, o ácido lático, o ácido pirúvico e o etanol."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 48\nConsidere a seguinte sequência de bases que codifica um peptídeo com 10 aminoácidos:\nCAAGAGUCUGAGGAGGGUUCUCAAGAGUCU\nQuando o peptídeo é completamente hidrolisado, obtém-se o seguinte:\n\nGrá$fico/Tabela$: Tabela de Aminoácido e Quantidade (símbolos para aminoácidos: quadrado, losango, triângulo, círculo, estrela, e suas respectivas quantidades: 1, 2, 3, 4).\n\nA sequência correta dos aminoácidos no peptídeo é:",
      subItens: []
    },
    options: [
      "Quadrado-Losango-Triângulo-Estrela-Círculo-Círculo-Losango-Triângulo-Círculo-Losango",
      "Triângulo-Estrela-Losango-Círculo-Círculo-Triângulo-Quadrado-Triângulo-Quadrado-Círculo",
      "Estrela-Triângulo-Losango-Quadrado-Estrela-Losango-Círculo-Círculo-Triângulo-Triângulo",
      "Losango-Círculo-Estrela-Triângulo-Quadrado-Quadrado-Estrela-Círculo-Triângulo-Círculo",
      "Triângulo-Círculo-Estrela-Losango-Quadrado-Losango-Triângulo-Círculo-Círculo-Estrela"
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Biologia Molecular", "Genética Molecular"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 49\nA figura abaixo tem relação com a representação de um reflexo medular típico de mamíferos:\n\nGrá$fico/Tabela$: Imagem esquemática de um arco reflexo medular, mostrando o impulso sensitivo entrando pela raiz dorsal e o impulso motor saindo pela raiz ventral da medula espinhal.\n\nNesse mecanismo, fundamental na proteção do organismo,",
      subItens: []
    },
    options: [
      "o impulso nervoso sensitivo chega à medula pela raiz dorsal e o impulso nervoso motor deixa a medula pela raiz ventral.",
      "o impulso nervoso sensitivo chega à medula pela raiz ventral e o impulso nervoso motor deixa a medula pela raiz dorsal.",
      "o impulso nervoso sensitivo deixa a medula pela raiz dorsal e o impulso nervoso motor deixa a medula pela raiz ventral.",
      "o impulso nervoso motor chega à medula pela raiz ventral e o impulso nervoso sensitivo deixa a medula pela raiz dorsal.",
      "tanto o impulso nervoso motor quanto o sensitivo chegam à medula pela raiz dorsal e dela saem pela raiz ventral."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 50\nO esquema ilustra de maneira simplificada a reprodução dos dois grandes grupos de plantas criptógamas:\n\nGrá$fico/Tabela$: Esquema do ciclo de vida de plantas criptógamas. Caminhos de Esporófito para Gametófitos (passando por Esporângio e Esporo, via 1) e de Esporófito para Prótalo (passando por Esporângio e Esporo, via 2).\n\nNo ciclo de vida dessas plantas, os esporos originam",
      subItens: []
    },
    options: [
      "estruturas haploides tanto nas briófitas quanto nas pteridófitas.",
      "estruturas diploides tanto nas briófitas quanto nas pteridófitas.",
      "uma estrutura haploide nas briófitas e outra diploide nas pteridófitas.",
      "uma estrutura diploide nas briófitas e outra haploide nas pteridófitas.",
      "os esporófitos, tanto em briófitas quanto em pteridófitas."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Botânica"],
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 51\nAnalise o seguinte idiograma:\n\nGrá$fico/Tabela$: Idiograma de um cariótipo, mostrando cromossomos sexuais XX para A, B, C, D, E, F e G. Em cada letra (A a G) há representações de cromossomos XX.\n\nA pessoa à qual pertence o cariótipo representado acima possui um alelo ligado ao cromossomo X. Essa pessoa transmitirá tal alelo, na geração F1,",
      subItens: []
    },
    options: [
      "a todos os seus descendentes do sexo masculino e do sexo feminino.",
      "a todos os seus descendentes do sexo masculino.",
      "a todos os seus descendentes do sexo feminino.",
      "à metade dos seus descendentes do sexo masculino.",
      "à metade dos seus descendentes do sexo feminino."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Genética"],
...
createQuestion({
    ...
    options: [
      ...
      "fase G1, fase S, fase G2 e citocinese.",
      "fase G1, fase S, fase G2 e meiose.",
      "interfase, mitose e citocinese.",
      "meiose e mitose."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 55\nA coloração das asas de certa espécie de borboleta decorre de uma herança monogênica. O alelo que condiciona a cor vermelha das asas é completamente dominante em relação ao alelo que condiciona a cor branca.\nNuma população de 1500 borboletas em equilíbrio de Hardy-Weinberg, 240 têm asas brancas. A frequência de indivíduos heterozigotos nessa população é",
      subItens: []
    },
    options: [
      "0,4",
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Genética Populacional"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Ligações Químicas", "Condutibilidade Elétrica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Titulometria", "Estequiometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Estequiometria", "Fórmulas Químicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Equilíbrio Químico", "pH"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Equilíbrio Iônico", "Solubilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 68\nO composto de carbono produzido na oxidação do ácido oxálico (ácido etanodioico) com permanganato de potássio, em meio ácido, é o",
      subItens: []
    },
    options: [
      "dióxido de carbono.",
...
createQuestion({
    ...
    options: [
      "cristalização, -1,+1 e zero.",
      "cristalização, zero, -1 e +1.",
      "eletrólise, -1,+1 e zero.",
      "eletrólise, zero, -1 e +1.",
      "eletrólise, zero, +1 e -1."
    ],
    correctAnswer: 3,
    materia: ["Química"],
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 71\nLeia os textos.\nTEXTO 1\nDesde 1980, está em curso no país um processo gradativo de vitimização letal da juventude, em que os mortos são jovens cada vez mais jovens. Apesar de esse fenômeno ser denunciado há anos por organizações não governamentais de direitos humanos e movimentos sociais, e de recentemente ter entrado na agenda estatal com a Comissão Parlamentar de Inquérito no Senado sobre o assassinato de jovens, o Estado brasileiro ainda não foi capaz de formular e implementar um plano nacional de redução de homicídios.\n(Disponível em: http://www.ipea.gov.br/atlasviolencia/download/2/2017. Acesso: 13 maio 2018.)\nTEXTO 2\n\nGrá$fico/Tabela$: Gráfico de barras \"Segundo o Mapa da Violência, entre 2002 e 2012,\", mostrando que \"o número de homicídios contra jovens negros teve alta de 32,4%\" e \"o de brancos caiu 32,3%\" entre 2002 e 2012.\n\nO quadro social, descrito no texto e representado no gráfico, encontra sua justificativa em problemas crônicos passíveis de constatação na sociedade brasileira. Que situações estão relacionadas a esse quadro de violência?",
      subItens: []
    },
    options: [
      "A corresponsabilidade do Estado, em parceria com as famílias, no sentido de promover a educação formal de crianças e jovens, garantindo assim perspectivas promissoras de futuro à população jovem.",
      "A identificação de que jovens negros estão, na sua maioria, localizados em regiões periféricas das grandes cidades, vivendo em condições precárias em relação à segurança e educação de qualidade.",
      "As condições de pobreza que dificultam a permanência do jovem na escola estão identificadas como um quadro que atinge, de forma igualitária, jovens, independente da sua origem étnica.",
      "A sociedade atual garante, inclusive do ponto de vista da Constituição, o direito à escolarização de qualidade, o que coloca a responsabilidade de ser bem-sucedido no desejo e esforço individual do jovem.",
      "As políticas públicas do Estado Brasileiro têm atuado de forma eficaz para, além de reduzir as desigualdades sociais que derivam em violência, proporcionar condições equitativas de formação aos jovens."
    ],
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Problemas Sociais", "Desigualdades Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "pelo uso de dados de usuários e seus amigos, por meio de um teste psicológico que circulava nas redes sociais, demonstrando a vulnerabilidade relativa à segurança dos usuários.",
      "pelo uso de dados e informações de usuários das redes sociais, realizado inadvertidamente pela consultoria, engajada politicamente na campanha de Donald Trump.",
      "por ser Fake News, na medida em que não existe possibilidade de uma rede social como o Facebook captar e negociar dados de seus usuários com finalidade comercial ou política.",
      "por demonstrar a inexistência de legislação que proteja usuários de redes sociais quanto à privacidade de seus dados pessoais, já que o Congresso Americano não se responsabilizou pelo uso desses dados.",
      "como uma ocorrência fortuita a que estão sujeitos todos os usuários de redes sociais, na medida em que, voluntariamente, disponibilizam seus dados e aceitam termos de responsabilidade ao ingressar na rede social."
    ],
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Sociedade da Informação", "Privacidade de Dados"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 73\nLeia os textos.\nTEXTO 1\nUm levantamento feito em 2017 pelo Pew Research Center mostra que cerca de 40% dos estadunidenses afirmam ter, ao menos, uma arma em casa. Os Estados Unidos registraram em 2016 mais de 11 mil assassinatos por arma de fogo. Uma pesquisa, realizada em 2015 para a Escola de Direito de Stanford sobre \"A Epidemiologia do uso de arma como autodefesa\", ouviu 14 mil cidadãos norte-americanos que foram vítimas de criminosos entre 2007 e 2011, apenas 0,9% das vítimas usou uma arma para se defender.\n(Disponível em: https://noticias.uol.com.br/internacional/ultimas-noticias/2018/02/22/armas-de-fogo-sao-instrumentos-de-autodefesa-eficientes-eua-buscam-respostas.htm Publicado 22-02-2018. Acesso: 13 maio 2018. Adaptado.)\nTEXTO 2\nCom 59 mortos e mais de 500 feridos, o assassinato em massa em Las Vegas trouxe à tona novamente o debate sobre o controle da posse e do porte de armas nos Estados Unidos, num movimento similar ao que aconteceu em outros massacres no país.\n(Disponível em: http://www.dw.$com/pt$-$br/lobby$-das-armas-tem-grande-poder-no-governo-$trump/a$-799965 Publicado 04-10-2017. Acesso 13 maio 2018. Fragmento.)\nA leitura dos textos permite compreender que a posse de armas nos EUA é um tema polêmico relacionado à segurança do cidadão. Em 1993, foi criada a Lei Brady Handgun Violence Prevention, regulando parcialmente o setor. No entanto, as informações apresentadas ao banco de dados nacional são vulneráveis, o que contribui para que o cidadão nos EUA acabe tendo ampla liberdade de decidir a respeito da posse de armas. Ao se analisar o tema, a controvérsia deve considerar que a questão",
      subItens: []
    },
    options: [
      "independe de uma política de Estado, pois o cidadão, nos EUA, apesar de ter plena liberdade de decidir a respeito da posse de armas, também tem discernimento para utilizá-la.",
      "revela que a maioria absoluta de americanos utiliza armamentos como recurso de segurança e a realidade cotidiana demonstra sua eficiência na prevenção da violência em defesa do cidadão.",
      "acerca da ocorrência do massacre de Las Vegas é um episódio isolado na sociedade estadunidense, portanto, não é um exemplo a ser considerado em se tratando de segurança pública.",
      "envolvendo a liberação do comércio mostra-se pouco eficaz para a proteção do cidadão, já que os dados demonstram a prevalência da violência relacionada ao uso das armas de fogo no país.",
      "encontra apoio do governo americano atual, com ações que buscam coibir de forma enérgica o porte de armas, evitando o aumento da violência urbana e prevenindo a possibilidade de novos eventos de violência coletiva."
    ],
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Problemas Sociais", "Violência"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "aos lobbies das grandes empresas petrolíferas que dominam o mercado mundial e à necessidade crescente de geração de energia em larga escala para atender demandas econômicas.",
      "à precariedade tecnológica que torna o uso de fontes renováveis inviáveis na atualidade, principalmente considerando a demanda e ausência de distribuição equitativas desses recursos no mundo.",
      "ao desinteresse de governos em investir em fontes limpas com retorno em longo prazo, pois o setor é responsável pela geração e distribuição de energia nas escalas nacionais e global.",
      "à necessidade de investir prioritariamente na produção de alimentos, restringindo a produção de biocombustíveis, fontes mais limpas, mas que não atendem à frota existente.",
      "à dificuldade de se encontrar fontes energéticas limpas, o que desestimula a busca de alternativas mais eficazes, pois até agora a produção é eminentemente solar e eólica."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 76\nO gráfico, a seguir, obtido por meio da Pesquisa Nacional sobre o uso do crack, realizada pela Fiocruz, retrata o perfil étnico do usuário de crack no Brasil.\n\nGrá$fico/Tabela$: Gráfico de barras \"$Cor/ra$ça dos usuários de crack $e/ou$ similares, Brasil, 2012\", mostrando Brancos com 20,85% e Não Brancos com 79,15%.\n\nA população da pesquisa é constituída por pessoas brasileiras de 18 anos ou mais, que usaram crack $e/ou$ similares, pelo menos 25 dias, nos últimos seis meses. O universo da pesquisa categorizou usuários brancos e não brancos. Os dados do gráfico permitem que realizemos a seguinte analogia entre os usuários pesquisados e o contexto sócio-histórico da população brasileira:",
      subItens: []
    },
    options: [
      "O consumo de crack é um problema de saúde pública de grande abrangência que não pode ser balizado por aspectos étnicos, pois isso se caracterizaria como preconceito.",
      "Os dados que relacionam o consumo de crack com etnia desconsideram as condições socioeconômicas, já que a maioria dos usuários possui emprego fixo.",
      "O predomínio do uso da substância pela população de afrodescendentes explica a correlação entre exclusão social e quadros de violência versus consumo de crack no Brasil.",
      "Os consumidores de crack são, em sua maioria, trabalhadores com endereço fixo e residentes em grandes cidades e, portanto, não há relação entre consumo, etnia e condição social.",
      "Os dados sobre a distribuição de renda no Brasil desconsideram a relação entre pobreza e origem étnica, o que torna os resultados da pesquisa pouco confiáveis."
    ],
    correctAnswer: 2,
    materia: ["Sociologia", "Geografia"],
    conteudo: ["Problemas Sociais", "População"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 77\nO Relatório Mundial do Câncer 2014, divulgado pela Organização Mundial da Saúde (OMS), estima que o número de novos casos de câncer aumente de 14 milhões em 2012 para 22 milhões em 2030. Isso significa que as políticas públicas deveriam focar em medidas preventivas, atuando na detecção precoce da doença, ou mesmo interferindo diretamente em fatores ambientais relacionados à ocorrência da doença. O câncer colorretal é um dos mais frequentes na população brasileira. O mapa a seguir contém dados a respeito dessa doença.\n\nGrá$fico/Tabela$: Mapa do Brasil com incidência de câncer colorretal por 100 mil habitantes, diferenciado por homens e mulheres, em diversas regiões (Sudeste, Nordeste, Sul, Norte, Centro-Oeste).\n\nOs dados contidos no mapa, relativos à ocorrência de câncer colorretal na população brasileira e às características culturais regionais, podem ser assim compreendidos:",
      subItens: []
    },
    options: [
      "Estados do Norte e Nordeste possuem alta incidência do problema, já que o IDH dessas regiões demonstra farto acesso à comida industrializada, o que também seria considerado fator de risco.",
      "O Sudeste possui baixa incidência da doença, pois a influência de culinárias diversificadas favorece a adoção de padrões alimentares saudáveis pela maioria da população urbana.",
      "A forte influência da cultura europeia no sul do Brasil e a adoção de alimentação mediterrânea explicam os baixos índices da doença nos estados do Sul, fazendo da região um modelo alimentar.",
      "A doença, no território brasileiro, ocorre predominantemente na população masculina, o que demonstra que os homens cuidam menos do que as mulheres da alimentação e saúde.",
      "O Sul e o Sudeste do Brasil, regiões que possuem maior consumo de carnes e gorduras, têm alta incidência da doença, o que significa que os hábitos alimentares têm relação direta com o problema."
    ],
    correctAnswer: 4,
    materia: ["Geografia", "Biologia"],
    conteudo: ["População", "Saúde Pública"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "estratégia de guerra, portanto, de livre escolha.",
      "guerra tecnológica, portanto, forma moderna de confronto.",
      "crime de guerra, portanto, passível de sanções.",
      "ação de choque, portanto, forma paralisante de guerra.",
      "ponto de estrangulamento, portanto, limitante de locomoção."
    ],
    correctAnswer: 2,
    materia: ["História", "Sociologia"],
    conteudo: ["Conflitos Armados", "Direito Internacional"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "QUESTÃO 79\nLeia os textos.\nTEXTO 1\nDe acordo com o levantamento da ONU, intitulado “Panorama da Segurança Alimentar e Nutricional na América Latina e Caribe\", mais da metade da população brasileira está com sobrepeso, e a obesidade já atinge 20% das pessoas adultas, enquanto 58% da população latino-americana e caribenha estão com sobrepeso, num total de 360 milhões de pessoas, e a obesidade afeta 140 milhões, ou 23% da população regional.\n(Disponível em: https://oglobo.globo.com/sociedade/saude/sobrepeso-obesidade-em-alta-no-brasil-diz-onu-20819122 Publicado 24-01-2017. Acesso: 13 maio 2018.)\nTEXTO 2\n\nGrá$fico/Tabela$: Charge \"Obesidade está se espalhando pelo país. Quando será que ela vai chegar por aqui?\". Mostra duas pessoas, uma obesa e outra magra.\n\nA análise dos textos permite as seguintes correlações:",
      subItens: []
    },
    options: [
      "A charge nega os dados contidos no texto 1, na medida em que as crianças brasileiras são subnutridas.",
      "As desigualdades sociais na América Latina são suficientes para justificar quadros de sobrepeso e obesidade.",
      "Os números contidos no texto 1 não preocupam do ponto de vista da saúde, pois o problema da subnutrição se sobrepõe.",
      "Em um mesmo contexto socioeconômico, obesidade e subnutrição convivem de forma paradoxal.",
      "Políticas públicas no Brasil mostram-se eficazes tanto no combate da subnutrição quanto da obesidade."
    ],
    correctAnswer: 3,
    materia: ["Sociologia", "Geografia"],
    conteudo: ["Problemas Sociais", "População"],
...
createQuestion({
    ...
    options: [
      "necessário, que visa ajustar condutas individuais, repreensíveis em determinado momento histórico e social.",
      "que retrata o avanço da medicina, capaz de moldar os indivíduos para o desenvolvimento produtivo da sociedade.",
      "de inclusão, capaz de promover a integração social de indivíduos antes desajustados, como loucos e criminosos.",
      "que interfere nos comportamentos sociais, transformando a percepção do mundo, os valores e a conduta dos indivíduos.",
      "de tratamento, que visa proporcionar liberdade a indivíduos com comportamentos antissociais."
    ],
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Comportamento Social", "Medicalização"],
    imageNames: []
})