...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Elementos Visuais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Semântica (Ambiguidade)", "Funções da Linguagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Coesão e Coerência (Pressuposição)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "enfatizar seu conteúdo",
      "corrigir sua construção",
      "enumerar seus detalhes",
      "contrapor-se a sua simplicidade"
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Aspectos Discursivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Semântica (Ambiguidade)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Figuras de Linguagem (Antítese)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática (Artigos)", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gêneros Textuais (Crônica)", "Linguagem Informal"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Subentendido"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Semântica (Denotação e Conotação)", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Figuras de Linguagem (Metáfora)", "Gêneros Textuais (Poema)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Elementos do Poema"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Morfologia (Diminutivo)", "Semântica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Elementos Narrativos (Pessoa Gramatical)", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Espanhol"],
    conteudo: ["Interpretação de Texto", "Vocabulário (Sinônimos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Espanhol"],
    conteudo: ["Gramática (Anáfora)", "Coesão Textual"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Espanhol"],
    conteudo: ["Interpretação de Texto", "Aspectos Culturais e Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Espanhol"],
    conteudo: ["Pontuação (Aspas)", "Intertextualidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "l'insatisfaction populaire générale et la grande diversité des revendications",
      "le peu d'intérêt porté aux services publiques et les forts investissements en sport",
      "l'adhésion de la population aux manifestations et les protestations sur tout le pays",
      "la situation chaotique du transport public et la qualité des services de santé ou d'éducation"
    ],
    correctAnswer: 1,
    materia: ["Francês"],
    conteudo: ["Interpretação de Texto", "Vocabulário"],
...
createQuestion({
    ...
    options: [
      "que ce soit cette situation",
      "quelle que soit la situation",
      "quelque soit cette situation-là",
      "quoique la situation soit celle-là"
    ],
    correctAnswer: 1,
    materia: ["Francês"],
    conteudo: ["Gramática (Conectores)", "Vocabulário (Sinônimos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "un emploi métalinguistique"
    ],
    correctAnswer: 0,
    materia: ["Francês"],
    conteudo: ["Pontuação (Aspas)", "Sentido Figurado"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "la mairie s'est vue forcée par une décision de justice (l. 4)",
      "une grande partie de la population ne se sent pas représentée par les partis politiques (l. 13-14)",
      "Certains journalistes en sont même venus à faire des excuses. (l. 30)",
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Francês"],
    conteudo: ["Gramática (Conectores de Concessão)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto", "Gêneros Textuais (Artigo de Opinião)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Coesão e Coerência", "Estratégias Argumentativas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Expressões Idiomáticas", "Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Volumes de Cone e Cilindro)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Múltiplos e Divisores", "Aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Sistemas de Numeração (Binário-Decimal)", "Interpretação de Dados"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Funções Logarítmicas", "Escala"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "cutícula, sementes, tecidos vasculares",
      "embriões multicelulares, esporófito dominante, frutos",
      "esporófito dominante, embriões multicelulares, frutos",
      "gametângios multicelulares, tecidos vasculares, sementes"
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Botânica (Classificação e Evolução Vegetal)", "Cladogramas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Ambiental (Efeito Estufa)", "Reações Químicas (Combustão)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Cinemática (Queda Livre)", "Gravitação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Química Orgânica (Funções Orgânicas)", "Reações Orgânicas (Redução)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Dinâmica (Energia Cinética)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Animal (Osmo-regulação)", "Ecologia (Adaptação Ambiental)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Ligações Químicas (Ligações de Hidrogênio)", "Bioquímica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Eletricidade (Eletrólise)", "Forças Fundamentais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Biologia Celular (Organelas)", "Embriologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Atomística (Isótopos)", "Partículas Subatômicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Genética (Mutação)", "Código Genético"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Estequiometria", "Sais Hidratados"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Termodinâmica (Gases Ideais)", "Pressão"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Atomística (Isótopos, Massa Atômica Média)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Demografia (Migrações)", "Globalização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Brasil Império", "Revoltas Populares"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[Imagem de mapa com projeção de Gall-Peters]",
      "[Imagem de mapa com projeção de Mercator]",
      "[Imagem de mapa com projeção de Robinson]",
      "[Imagem de mapa com projeção de Dymaxion]"
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Arte"],
    conteudo: ["História da Arte Brasileira (Modernismo)", "Leitura de Imagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "instauração da ordem democrática",
      "diversificação dos espaços culturais",
      "integração do setor financeiro europeu",
      "internacionalização do desenvolvimento econômico"
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História Contemporânea (Revolução dos Cravos)", "Regimes Políticos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "limitação da tecnologia moderna",
      "dimensão da interferência humana",
      "recorrência do desmatamento intenso",
      "insuficiência do abastecimento alimentar"
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "poluição de ecossistemas fluviais – coleta seletiva",
      "aumento da emissão de gases – remodelação de áreas de risco",
      "destruição de reservas florestais – reciclagem de resíduos tóxicos",
      "diminuição dos reservatórios de água – redistribuição de núcleos populacionais"
    ],
    correctAnswer: 0,
    materia: ["Sociologia", "Geografia"],
    conteudo: ["Problemas Urbanos", "Meio Ambiente", "Gestão de Resíduos Sólidos"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Guerra de Canudos", "Determinismo", "Intertextualidade (Literatura e Música)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "superar o pan-eslavismo – reduzir a diversidade étnica",
      "estimular a economia – ampliar a produção energética",
      "combater a corrupção – reconstruir a geopolítica global",
      "reforçar o nacionalismo – consolidar a geoestratégia militar"
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Geopolítica (Conflitos Contemporâneos)", "Nacionalismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geografia Industrial", "Modelos de Produção (Fordismo e Pós-Fordismo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "sítio urbano e polarização política",
      "morfologia urbana e controle social",
      "hierarquia urbana e segurança pública",
      "centro urbano e marginalização econômica"
    ],
    correctAnswer: 1,
    materia: ["Geografia", "Sociologia"],
    conteudo: ["Geografia Urbana", "Planejamento Urbano", "Controle Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Brasil República (Regime Militar)", "Cidadania e Direitos Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "redução da pobreza e estabilização do deficit público",
    ...
    conteudo: ["Economia Brasileira", "Desigualdade Social", "Brasil República (Governos Militares)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "aculturação de áreas periféricas",
      "metropolização de regiões rurais",
      "globalização de países desenvolvidos",
      "conurbação de aglomerações populacionais"
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Globalização", "Redes de Transporte", "Geopolítica"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Regimes Políticos (Totalitarismo)", "Literatura e Sociedade", "Teoria Política"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Economia Global", "Mercado de Trabalho", "Demografia (População Jovem)"],
    imageNames: []
})