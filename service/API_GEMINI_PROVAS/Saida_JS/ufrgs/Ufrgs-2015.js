createQuestion({
    ...
    options: [
      "B12, que atua na formação de células vermelhas do sangue.",
      "B12, que é encontrada nos pigmentos visuais.",
      "D, que auxilia na formação do tecido conjuntivo.",
      "E, que é responsável pela absorção de cálcio.",
      "E, que participa da formação de nucleotídeos."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Nutrição e Metabolismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "animal, porque se observa a ausência de centríolos.",
      "animal, porque apresenta a estrutura de número 1.",
      "vegetal, porque apresenta a estrutura de número 2.",
      "vegetal, porque se observa a ausência de vacúolos.",
      "vegetal, porque apresenta a estrutura de número 3."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Citologia"],
...
createQuestion({
    ...
    options: [
      ...
      "o hidrogênio resultante da quebra da água é eliminado da célula durante a fotólise.",
      "as reações dependentes de luz ocorrem no estroma do cloroplasto.",
      "o oxigênio produzido na fotossíntese é resultante das reações independentes da luz.",
      "os seres autótrofos utilizam o CO2 durante as reações dependentes de luz."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "transporte ativo – soluto – hipertônico",
      "osmose – solvente – hipertônico",
      "difusão – solvente – isotônico",
      "difusão – solvente – hipotônico",
      "osmose – soluto – hipertônico"
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Citologia"],
...
createQuestion({
    ...
    options: [
      "os compostos minerais do tecido ósseo são responsáveis por sua flexibilidade.",
      "o disco epifisiário é a estrutura a partir da qual ocorre o crescimento dos ossos longos.",
      "o osso não apresenta sensibilidade devido à ausência de fibras nervosas.",
      "os osteoblastos são estimulados por um hormônio das glândulas paratireoides para a remoção de cálcio do sangue.",
      "os osteoclastos formam osso novo para preencher o espaço deixado pelos osteoblastos."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "folhas com parênquima clorofiliano desenvolvido.",
      "tricomas secretores de enzimas digestivas.",
      "caules armazenadores de substâncias de reserva.",
      "gavinhas como órgãos de fixação.",
      "corpo vegetativo reduzido."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      ...
      "Caixa torácica com costelas unidas ao esterno.",
      "Corpo recoberto por escamas e placas córneas.",
      "Fecundação externa.",
      "Ausência de dentes nos maxilares."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Zoologia"],
...
createQuestion({
    ...
    options: [
      "O alimento ingerido passa direto ao estômago químico.",
      "As enzimas digestivas começam a agir no papo.",
      "A moela tem uma ação mecânica que tritura o alimento ingerido.",
      "Algumas espécies regurgitam o conteúdo da moela para alimentar os filhotes.",
      "A dieta alimentar inclui somente animais como insetos e vertebrados."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Zoologia"],
...
createQuestion({
    ...
    options: [
      "O cruzamento entre cães KK ayaw X Kk ayaw somente resulta cães com cor do pelo preta.",
...
createQuestion({
    ...
    options: [
      "O caramujo, o peixe, o rato e a cobra formam o segundo nível trófico.",
      "A garça e a cobra são consumidores terciários.",
      "Uma onça-pintada pode ocupar o lugar do rato na cadeia acima.",
      "A garça e o gavião ocupam o quarto nível trófico.",
      "Uma planta carnívora pode ocupar o lugar da cobra."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Ecologia"],
...
createQuestion({
    ...
    options: [
      "coleta seletiva – deposição em tonéis",
      "impermeabilização do solo – introdução de bactérias decompositoras",
      "coleta seletiva – compostagem",
      "aterros sanitários – incineração",
      "recolhimento do chorume – compostagem"
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Ecologia"],
...
createQuestion({
    ...
    options: [
      ...
      "o Feα é formado pelos isótopos 54Fe e 56Fe, enquanto o Feγ é formado pelos isótopos 57Fe e 58Fe.",
      "os cátions Fe2+ ou Fe3+ são originados de átomos de ferro com diferentes números atômicos.",
      "o Feα origina os cátions Fe2+, e o Feγ origina os cátions Fe3+.",
      "os diferentes isótopos do ferro podem ser encontrados tanto no Feα como no Feγ."
    ],
    correctAnswer: 4,
    materia: ["Química"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Ligações Químicas", "Físico-Química"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Polímeros", "Equilíbrio Químico"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Holanda, Argentina e Argélia",
      "Rússia, Alemanha e Croácia",
      "Colômbia, México e Austrália",
      "Chile, Gana e Costa do Marfim",
      "Argentina, Camarões e Coreia do Sul"
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "às 22 horas do dia anterior.",
      "às 10 horas do dia anterior.",
      "às 10 horas do mesmo dia.",
      "às 10 horas do dia seguinte.",
      "às 22 horas do dia seguinte."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "norte, pois assim terá Sol na maior parte do ano.",
      "oeste, pois terá sempre o Sol da manhã nas estações de inverno e verão.",
      "sul, pois terá sempre o Sol na estação do inverno, mas não no verão.",
      "norte, pois terá sempre o Sol na estação do inverno, mas não no verão.",
      "leste, pois sempre terá o Sol da manhã nas estações de inverno e verão."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Climatologia"],
...
createQuestion({
    ...
    options: [
      "massa de ar polar pacífica; Chile",
      "massa de ar polar atlântica; Paraguai",
      "massa de ar polar pacífica; Colômbia",
      "massa de ar tropical continental; Uruguai",
      "massa de ar tropical atlântica; Argentina"
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Climatologia"],
...
createQuestion({
    ...
    options: [
      "1 – Nepal – alta densidade demográfica",
      "2 – Catar – baixa densidade demográfica",
      "1 – Paquistão – alta densidade demográfica",
      "3 – Indonésia.–.baixa.densidade demográfica",
      "2 – Arábia.Saudita.–.baixa.densidade.demográfica"
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Demografia"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia da População"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "à ampliação da atividade pastoril no Norte do Brasil e à silvicultura de eucalipto no Sul, que acarreta a degradação dos biomas.",
      "às queimadas no Noroeste do país e à recuperação da vegetação original para uso farmacêutico.",
      "à biopirataria e ao plantio de pínus nas áreas desmatadas para utilização comercial.",
      "ao agronegócio que se expande no Norte e ao reflorestamento de áreas de Mata Atlântica para uso na indústria de cosméticos.",
...
createQuestion({
    ...
    options: [
      "da diminuição – natalidade – transição demográfica – menor",
      "da manutenção – mortalidade – declínio demográfico – igual",
      "da diminuição – fecundidade – transição demográfica – maior",
      "da manutenção – natalidade – estabilidade demográfica – maior",
      "do aumento – fecundidade – transição demográfica – menor"
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Demografia"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Demografia", "Geografia Urbana"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Demografia", "Geografia Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia Econômica", "Geografia Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Geografia Política", "História do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Região Sul – pecuária – melhoria genética – chapadões",
      "Região Centro-oeste – agricultura comercial – irrigação – chapadões",
      "Região Nordeste – pecuária extensiva – melhoria genética – planície costeira",
      "Região Centro-oeste – agricultura de subsistência – sementes modificadas – serras",
      "Região Sul – agricultura comercial – terraceamento – planície costeira"
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "Fumo e soja",
      "Hortigranjeiros e arroz",
      "Uva e cana de açúcar",
      "Aves e algodão",
      "Suínos e leite"
    ],
    correctAnswer: 4,
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Hidrografia", "Geografia Ambiental"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "O maior volume de chuva no norte do estado explica-se pela altitude do planalto sul-rio grandense associado à trajetória das frentes polares no sentido SW-NE.",
