createQuestion({
    ...
    options: [
      "A construção social do processo civilizador comprova que este é um fenômeno sem características evolutivas, dadas as sucessivas rupturas e descontinuidades observadas, por exemplo, em relação aos controles das funções corporais.",
      "Os estudos do processo civilizador comprovam que as emoções são inatas, com origem primitiva, o que garante a empatia entre indivíduos de diversas sociedades e culturas, bem como de diferentes classes sociais.",
      ...
      "O modo de se alimentar, o cuidado de si, a relação com o corpo e as emoções em resposta às funções corporais são produtos de um processo civilizador, de longa duração, por meio do qual se transmitem aos indivíduos as regras sociais.",
      "O processo civilizador propiciou sucessivas aproximações sociais entre o mundo dos adultos e o das crianças, favorecendo a transição entre etapas geracionais e reduzindo o embaraço com temas relativos à sexualidade."
    ],
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Processo Civilizador"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Filosofia"],
    conteudo: ["Epistemologia: Causa e Efeito em David Hume"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Reciclagem e Impactos Ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Arte"],
    conteudo: ["Impressionismo: Edgar Degas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Filosofia"],
    conteudo: ["Estética: Mímesis em Aristóteles"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Funções Exponenciais e Logarítmicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Evolução: Mimetismo Batesiano"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Ecologia: Ciclo do Carbono"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Misturas e Propriedades Físico-Químicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "corrente elétrica que passa por ela é menor que a corrente que passa pela de 60 W.",
      "diferença de potencial (ddp) aferida na de 40 W é menor que na de 60 W.",
      "resistência à passagem de corrente elétrica é maior na de 60 W.",
      "resistência à passagem de corrente elétrica é maior na de 40 W.",
      "resistência e a corrente elétrica que passa por ela são menores que na de 60 W."
    ],
    correctAnswer: 0,
    materia: ["Física"],
...
createQuestion({
    ...
    options: [
      "A Ag(s) possui maior tendência a sofrer oxidação que o Fe(s). Portanto, o emprego de Ag(s) é adequado como ânodo de sacrifício se a rosca for revestida com esse metal.",
      "Como o Cu(s) possui maior potencial padrão de oxidação que o Fe(s), sofre corrosão com maior intensidade, sendo inadequado para a confecção da rosca.",
      "Por possuir menor potencial padrão de oxidação que o Fe(s), o Mg(s) atua como protetor catódico quando lascas desse metal revestem parte da rosca.",
      "O Sn(s), por apresentar maior tendência a sofrer oxidação que o Fe(s), pode atuar como ânodo de sacrifício se a rosca for revestida com esse metal.",
      "O Zn(s) tem maior tendência a sofrer oxidação que o Fe(s), podendo proteger a rosca da ferrugem quando ela for revestida com esse metal."
    ],
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Eletroquímica: Oxidação e Redução"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "da cuia de cristal é menor que a do líquido.",
      "da cuia de cristal e a do amianto são iguais.",
      "do amianto é menor que a da cuia de cristal.",
      "do amianto é maior que a da cuia de cristal.",
      "do amianto é maior que a do líquido."
    ],
    correctAnswer: 2,
    materia: ["Física"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana: Sistema Nervoso e Receptores Sensoriais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Economia do Mate no Paraná", "Colonização do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Dinâmica: Peso e Massa"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A função do metabolismo é transformar moléculas grandes e complexas em pequenas, simples e solúveis, assim, o amido é convertido em ácidos graxos, as proteínas, em aminoácidos, e os lipídios, em moléculas de glicose.",
      "As substâncias reguladoras, por possuírem a função de suprir as necessidades energéticas, garantem um metabolismo normal e devem ser ingeridas em todas as refeições.",
      "O catabolismo é a etapa na qual os nutrientes são assimilados e utilizados para formar novas substâncias indispensáveis ao crescimento, à manutenção e à regeneração do organismo.",
      "O anabolismo é a etapa na qual ocorre a quebra de moléculas complexas em outras mais simples, com liberação de energia e eliminação de substâncias de excreção.",
      "O pâncreas produz o glucagon, que age no fígado e estimula a glicogenólise, reação que transforma o glicogênio em glicose, e a insulina, que tem por função reduzir a concentração de glicose no sangue."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Funções e Inequações: Gráficos de IMC"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Sociologia do Corpo e Poder"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Roma Antiga: Hedonismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Arte"],
    conteudo: ["Arte Contemporânea: Corpo e Identidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Álgebra: Número de Ouro e Progressão Geométrica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A sociologia weberiana, quando analisa as modernas sociedades ocidentais, demonstra que os fatores econômicos e os antagonismos entre as classes determinam as hierarquias de poder e os tipos de dominação.",
      "As análises de Marx defendem a ideia de que as mudanças mais recentes na ordem mundial capitalista alteraram a preeminência das classes na explicação das assimetrias sociais e diversidades culturais.",
      "Na sociologia de Bourdieu, os fatores econômicos, simbólicos e culturais, a exemplo da renda, do prestígio e dos saberes, incorporados pelos agentes em seu cotidiano e em sua trajetória de vida, são responsáveis pela diferenciação de posições nos campos sociais.",
      "No pensamento funcionalista, a origem da desigualdade social encontra-se nas contradições econômicas e políticas entre os agrupamentos, que mantêm relações uns com os outros para produzir e reproduzir a estrutura social.",
      "Para os pensadores críticos do neoliberalismo, a mobilidade dos indivíduos de um estrato social para outro, no Brasil, é acompanhada igualmente por mudanças na estrutura de classes sociais, na medida em que pobres e ricos se aproximam."
    ],
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Desigualdade e Estratificação Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "O ibuprofeno é comercializado na forma de racemato.",
      "Os dois isômeros são diasteroisômeros.",
      "Os dois isômeros apresentam isomeria de posição.",
      "Os dois isômeros possuem pontos de fusão iguais."
    ],
    correctAnswer: 1,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "Os Estados Unidos da América iniciaram a expansão para o Oriente, comercializando o ópio monopolizado pelos chineses, o que provocou uma guerra entre eles, encerrada com o acordo de divisão igualitária das cotas comerciais.",
      "O Japão, em suas conquistas imperialistas no continente asiático, travou uma guerra com a China pelo domínio do comércio do ópio na região; nesse processo, estabeleceram o Tratado de Pequim, no qual Hong Kong passou ao domínio japonês.",
      "O império russo, parceiro da China no comércio do ópio, transportava-o para os portos de Xangai com maior agilidade e altas taxas aduaneiras, o que fez com que exigisse a franquia desse produto.",
      "A Inglaterra, que dominava a comercialização do ópio na China, impôs aos chineses uma indenização por eles terem, a pretexto de proteger a saúde de sua população, confiscado e destruído uma grande carga de ópio.",
      "A França teve uma de suas colônias, o Afeganistão, como um grande produtor de ópio e concorrente comercial dos chineses, que monopolizavam essa atividade com elevados lucros; visando quebrar tal monopólio, os franceses bloquearam os portos chineses."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Guerra do Ópio"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Estatística e Probabilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As perguntas sobre por que as pessoas violam as normas, como, por exemplo, comprar e consumir drogas ilícitas, a reiteração de vícios e como fazer para que as pessoas abandonem práticas delituosas são típicas dos estudos do interacionismo simbólico.",
      "Os estudos de Loïc Wacquant demonstram a tendência de ampliação dos direitos e benefícios sociais, com consequente redução do chamado capitalismo de pilhagem de abrangência internacional e diminuição do denominado Estado penal.",
      "Políticas, como as de choque de ordem e da tolerância zero, têm resultados positivos em termos de respeito e de reconhecimento dos direitos humanos das populações pobres e residentes de áreas de vulnerabilidade social.",
      "De acordo com Howard Becker, todos os grupos sociais fazem regras e tentam impô-las, mas o rotulado como desviante pode ter uma opinião diferente sobre a questão, assim como aquele que infringe a regra pode pensar que quem o julga é que é um outsider.",
      "Os estudos positivistas preocupam-se com questões como quem define as regras sobre que tipos de atividades são considerados normais e que tipos são considerados desviantes ou ilícitos e de que forma os agentes definem tais regras."
    ],
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Desvio e Controle Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Arte"],
    conteudo: ["Modernismo Brasileiro: Di Cavalcanti"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Modernismo Brasileiro: Macunaíma"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Arte"],
    conteudo: ["Dança Contemporânea: Grupo Corpo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Demografia: Fluxos Migratórios"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geopolítica: Conflitos Globais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "O tempo é uma representação relativa subjacente às intuições.",
      "O tempo é um conceito discursivo, ou seja, um conceito universal.",
      "O tempo é um conceito empírico que pode ser abstraído de qualquer experiência.",
      "O tempo, concebido a partir da soma dos instantes, é infinito."
    ],
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["Epistemologia: Tempo em Kant"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O intervalo de tempo medido em um referencial em que se empregam dois cronômetros e dois observadores é menor do que o intervalo de tempo próprio no referencial em que a medida é feita por um único observador com um único cronômetro.",
      "Considerando uma nave que se movimenta próximo à velocidade da luz, o tripulante verifica que, chegando ao seu destino, o seu relógio está adiantado em relação ao relógio da estação espacial da qual ele partiu.",
      "As leis da Física são diferentes para dois observadores posicionados em sistemas de referência inerciais, que se deslocam com velocidade média constante.",
      "A dilatação do tempo é uma consequência direta do princípio da constância da velocidade da luz e da cinemática elementar.",
      "A velocidade da luz no vácuo tem valores diferentes para observadores em referenciais privilegiados."
    ],
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Física Moderna: Relatividade Especial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Arte"],
    conteudo: ["Arte Contemporânea: Arte e Memória"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Uma vez que, a cada geração, sobrevivem os mais aptos, eles tendem a transmitir aos descendentes as características relacionadas a essa maior aptidão para sobreviver.",
      "Os indivíduos que sobrevivem e se reproduzem, a cada geração, são os que apresentam determinadas características relacionadas com a adaptação às condições ambientais.",
      "Algumas características conferem a seus portadores vantagens para explorar o meio ambiente de forma a tornar a sobrevivência e a reprodução mais eficientes.",
      "A variação casual apresenta-se em primeiro lugar e a atividade ordenada do meio ambiente vem posteriormente, ou seja, a variação independe do meio.",
      "A adaptação é o inevitável produto final de processos fisiológicos requeridos pelas necessidades dos organismos de fazer face às mudanças de seu meio ambiente."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "Para Zigmunt Bauman, na modernidade líquida, a intensa interatividade e a multiplicação das relações em rede criam vínculos sociais duradouros e quadros de referência e de identificação permanentes.",
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Mídia e Sociedade: Tecnologias de Informação"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "A superficialização da personalidade e o esvaziamento do sentido da experiência são efeitos secundários da Indústria Cultural, decorrentes dos exageros da publicidade.",
      ...
      "O esvaziamento do sentido da experiência criado pela Indústria Cultural atesta a superficialidade inerente à personalidade na medida em que ela é uma abstração.",
      "O poder de reificação exercido pela Indústria Cultural sobre a personalidade consiste em criar um equilíbrio entre sensibilidade (emoções) e pensamento (máxima abstração)."
    ],
    correctAnswer: 2,
    materia: ["Filosofia"],
    conteudo: ["Teoria Crítica: Indústria Cultural"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Sociedade de Consumo: Bauman"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Misturas Homogêneas e Heterogêneas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Economia Brasileira: Telecomunicações"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Se o indivíduo designado pela letra F, que está lendo o livro, também faz uso de celular, então este elemento comporta-se como um gás nobre.",
      "Se os indivíduos designados pelas letras G e D representam, respectivamente, Cl (Z = 17) e Br (Z = 35), então D é maior e possui menor eletronegatividade que G.",
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Arte"],
    conteudo: ["Arte Pública: Alex Flemming"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Não-Lugares: Marc Augé"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica: Elipse"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Durante a fase de clivagem.",
      "Durante a formação da blástula.",
      "Na gastrulação.",
      "Na histogênese.",
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Embriologia: Fases Embrionárias"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Filosofia"],
    conteudo: ["Ética e Política: Platão"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Fazer uso do próprio entendimento implica a destruição da tradição, na medida em que o poder da tradição impede a liberdade do pensamento.",
      "A superação da condição de menoridade resulta do uso privado da razão, em que o indivíduo faz uso restrito do próprio entendimento.",
      "A saída da menoridade instaura uma situação duradoura, pois as verdadeiras conquistas do Esclarecimento se afiguram como irreversíveis.",
      "A menoridade é uma tendência decorrente da natureza humana, sendo, por esse motivo, superada no Esclarecimento, com muito esforço.",
    ...
    correctAnswer: 4,
    materia: ["Filosofia"],
    conteudo: ["Iluminismo: Kant e o Esclarecimento"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Roma Antiga: Império e Otávio Augusto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana e Estatística"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As ações coletivas em rede podem ser comparadas aos movimentos sindicais brasileiros da década de 1970, por adotarem práticas de organização e de mobilização em defesa da esfera privada contra a opressão estatal.",
      "As manifestações políticas organizadas em redes de movimentos caracterizam-se pela participação de diversos grupos e de múltiplos atores imersos na vida cotidiana, com militância parcial e efêmera.",
      "O atual ativismo político no Brasil, a exemplo do mundo, mobiliza entidades e organizações ideologicamente unificadas e com práticas comuns no mercado, a fim de obter vantagens coletivas trabalhistas e salariais.",
      "O ciberativismo, na contemporaneidade, envolve, como no passado, a mobilização das grandes classes e a afirmação do movimento operário como principal protagonista das transformações socioeconômicas.",
      "Os sujeitos dos movimentos favoráveis às políticas neoliberais, na atualidade brasileira, organizam-se em rede para a defesa da intervenção e da regulação da economia e das relações de trabalho, pelo Estado."
    ],
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Movimentos Sociais: Ciberativismo"],
    imageNames: []
})