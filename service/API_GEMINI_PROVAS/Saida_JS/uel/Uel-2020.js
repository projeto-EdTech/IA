createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Arte"],
    conteudo: ["História da Arte", "Arquitetura"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A lama que cobriu a bacia hidrográfica do rio Paraopeba, rica em matéria orgânica, ajuda no crescimento de espécies vegetais aquáticas, o que contribui para a recuperação do ecossistema da área atingida.",
      "O rompimento da barragem poderia ter sido evitado se o sistema de alerta utilizado pela empresa responsável tivesse funcionado, avisando a população da área a montante.",
      "Os rejeitos de mineração provocaram a mutação em diversas espécies da fauna que habitam a bacia do rio Paraopeba, tornando-as resistentes a esse tipo de material.",
      "O rio Paraopeba pode ser recuperado utilizando-se medidas como o desassoreamento do leito e a biorremediação, mesmo sabendo que a recomposição da fauna e da flora será lenta.",
      "O ciclo de vetores, responsável pela disseminação de doenças foi pouco alterado, o que, para a população, é benéfico, pois impossibilita o surto de doenças como a dengue e a febre amarela."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Impactos Socioambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O etileno estimula o amadurecimento de frutos, atua na queda natural de folhas e frutos e é produzido nas mais diversas partes da planta.",
      "A citocinina estimula o alongamento celular, atua na dominância apical e no desenvolvimento dos frutos e é produzida em sementes em desenvolvimento, no meristema apical do caule e em folhas jovens e frutos.",
      "A quitinase, produzida em diferentes partes da planta, promove a germinação de sementes, o desenvolvimento de brotos e frutos, estimula a floração e o alongamento do caule e das folhas.",
      "A giberelina estimula as divisões celulares, o desenvolvimento das gemas, participa da diferenciação dos tecidos, retarda o envelhecimento dos órgãos e tem a sua produção concentrada nas folhas.",
      "A quinase promove a dormência de gemas e de sementes, induz o envelhecimento de folhas, flores e frutos, induz o fechamento dos estômatos e é produzida nas gemas apicais da raiz."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Vegetal", "Fitormônios"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "23h de sexta-feira; 21h de segunda-feira; 20h de quinta-feira.",
      "23h de sexta-feira; 21h de domingo; 23h de quarta-feira.",
      "3h de sábado; 15h de segunda-feira; 22h de quinta-feira.",
      "3h de sábado; 18h de segunda-feira; 20h de quarta-feira.",
      "3h de sábado; 19h de segunda-feira; 1h de sexta-feira."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Diversidade dos Seres Vivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Uma das principais vantagens da organização segmentada da musculatura, chamada de metameria, é a de conferir aos animais que a possuem uma versatilidade muito grande na movimentação corporal.",
      ...
      "As esponjas são animais filtradores que captam partículas alimentares da água por meio das células flageladas que as conduzem para a boca, indicando, em termos evolutivos, que esses animais possuem tecidos corporais e um sistema digestório incompleto.",
      "As anêmonas, por serem triblásticos, apresentam na escala evolutiva zoológica um sistema digestório completo, ou seja, uma abertura por onde o alimento entra e outra por onde saem os resíduos da digestão."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Zoologia", "Evolução Animal"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Sequências Numéricas", "Diversidade dos Seres Vivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Arte"],
    conteudo: ["Vanguardas Artísticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Probabilidade e Combinatória"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A produção petrolífera no Brasil é insuficiente para o consumo interno e, mesmo com a descoberta do pré-sal, o país depende da importação de petróleo pesado.",
      "O petróleo encontrado no pré-sal localiza-se em bacias sedimentares, sendo as três principais a do Espírito Santo (ES), a de Campos (RJ) e a de Santos (SP).",
      "As formações do pré-sal no Brasil datam do período Quaternário da Era Mesozoica, mesmo período em que surgem os peixes e a vegetação nos continentes.",
      "A extração de petróleo do pré-sal tem se mostrado ineficiente, sendo pequeno o volume extraído, em função das limitações técnicas e do elevado custo de exploração.",
      "A profundidade em que se encontram as reservas do pré-sal impossibilita o risco de vazamentos e desastres ambientais, evitando prejuízos à biodiversidade."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Filosofia"],
    conteudo: ["Teoria do Conhecimento", "Platão"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Taxonomia e Classificação"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A saúde pública é uma discussão iminente, pois a tendência de aumento do número de idosos nos próximos anos pressionará a demanda por cuidados, qualidade de vida, tratamentos e hospitais.",
      "O aspecto triangular da pirâmide etária na projeção para 2020 mostra um decréscimo percentual do bônus demográfico de homens e mulheres.",
      "As mudanças ocorridas no Brasil em relação à transição demográfica demonstram que à população idosa na década de 1980 era superior à população jovem em 2020.",
      "As mulheres de 70 anos ou mais, em 1980, representavam em média 6 milhões de habitantes, enquanto que em 2020 representará, em média, 2 milhões.",
      "O crescimento vegetativo brasileiro apresentou aumento, já que parcela significativa de mão de obra feminina foi dispensada influenciando no aumento do número de crianças de 0 a 4 anos."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Demografia"],
...
createQuestion({
    ...
    options: [
      "Como fonte histórica, a pintura é considerada produção estética destituída de articulações com a sociedade do período.",
      "Essa pintura representa, da perspectiva política, símbolos do Absolutismo, ao tornar reconhecida a figura do rei.",
      "O monarca Luís XIV dispunha de autoridade limitada, recordando a divisão iluminista do poder em três esferas.",
      "A extensão de direitos de cidadania ao Terceiro Estado foi um dos principais traços políticos do período.",
      "A característica política do reinado de Luís XIV foi a separação entre a instituição religiosa e o Estado."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Idade Moderna", "Absolutismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Política", "Rousseau"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Modos de Produção", "Karl Marx"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a luta de estratos sociais em defesa da igualdade jurídica e pela conquista dos direitos de cidadania.",
      "a primeira tentativa de revolução social do proletariado moderno contra a burguesia.",
      "a participação popular na luta pelo direito de voto pelas mulheres e contra o trabalho infantil.",
      "o repúdio ao caráter sangrento das revoluções populares, produtoras de regimes ditatoriais.",
      "a democracia, que atinge a plenitude quando homens, mulheres e jovens pegam em armas."
    ],
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Estratificação Social", "Movimentos Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Weber, em A Ética Protestante e o Espírito do Capitalismo, demonstrou que o capitalismo depende da religião para existir, pois, sem ela, não haveria acúmulo de capital.",
      "Para Durkheim, a divisão do trabalho social na sociedade capitalista isolou cada vez mais os indivíduos, restringindo, assim, a possibilidade de existência de harmonia social.",
      "Weber, contrariamente a Marx, negou a existência das classes sociais, as quais foram suplantadas pelos grupos de status.",
      "Marx e Durkheim compreenderam que o fim da sociedade capitalista se tornou possível porque o homem alienado se desencantou com o mundo existente.",
      "Para Marx, o dinheiro recebido sob a forma de salário é diferente daquele existente sob a forma de capital, pois consiste em trabalho social não pago."
    ],
    correctAnswer: 4,
    materia: ["Sociologia"],
    conteudo: ["Teoria Sociológica", "Capitalismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Teoria da História", "Memória e Patrimônio", "Análise de Charges e Tirinhas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Teoria Sociológica", "Pierre Bourdieu"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Arte"],
    conteudo: ["Escultura", "História da Arte"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Contemporânea", "Economia", "Patrimônio Cultural"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Cultura", "Indústria Cultural", "História da Arte"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Os primeiros componentes da cadeia alimentar são os consumidores, que, por possuírem muita energia armazenada, transferem a biomassa necessária para os demais seres vivos do próximo nível trófico.",
      "A luminosidade do sol é convertida em energia e entra na biosfera por meio dos seres decompositores, os quais, durante os processos de decomposição, reciclam moléculas orgânicas em compostos inorgânicos (H₂O, O2 e CO2).",
      "Quanto mais níveis tróficos uma cadeia alimentar possuir, menor será a sua dissipação energética, uma vez que as menores perdas de energia ocorrem quando a matéria orgânica é transferida de um nível trófico para outro.",
      "A porcentagem de energia efetivamente transferida de um nível trófico para o nível seguinte varia de acordo com os organismos envolvidos na cadeia, situando-se entre 5% e 20%.",
      "No nível dos consumidores terciários, exemplificado por um herbívoro, considera-se a produtividade primária líquida como a quantidade total de biomassa que esse animal, efetivamente, absorve dos alimentos que ingere."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      ...
      "A menção em certas circunstâncias, ser legitimada moralmente quando dela resulta uma ação benéfica ou impede o prejuízo a outrem.",
...
createQuestion({
    ...
    options: [
      ...
      "A ciência busca alcançar o conhecimento de tipo essencial, pois ele garante a verdade de uma teoria científica, permitindo o desenvolvimento em direção à verdade objetiva visada pela ciência.",
      "Uma teoria científica é verdadeira se suas proposições são empiricamente falsificáveis via testes, permitindo que sejam autocorrigidas e desenvolvidas na direção de uma verdade objetiva.",
      "Os testes empíricos nas ciências humanas, tais como psicologia e sociologia, visam confirmar seu valor de cientificidade, pois suas teorias são falsificáveis.",
      "A concepção de ciência que Popper sustenta é a passivista ou receptacular, na qual as teorias científicas são elaboradas por meio dos sentidos e o erro surge ao interferirmos nos dados obtidos da experiência."
    ],
    correctAnswer: 2,
    materia: ["Filosofia"],
    conteudo: ["Teoria do Conhecimento", "Karl Popper"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "No caso de Luzia, o percentual r no momento de sua datação se encontrava entre 20% e 30%.",
      "A medida que o tempo passa, o percentual r de um fóssil humano paleoamericano cresce em relação a um ser vivo de características semelhantes.",
      "Um fóssil humano paleoamericano, datado entre 2949 e 4223 anos, apresenta percentual r de, no máximo, 50%.",
      "O percentual r apresentado por Luzia, imediatamente após sua morte se encontrava entre 80% e 90%.",
    ...
    conteudo: ["Evolução Humana", "Análise de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "A reação 2, com valor de AG igual a -967,2 kJ, possui menor espontaneidade que a reação 1.",
      "A reação 1 possui maior valor de variação de entalpia (AH) que a reação 2 e, por isso, libera mais calor.",
      "A reação 2, com valor de AG igual a -2393,5 kJ, possui maior espontaneidade que a reação 1.",
      "A reação 2 é endotérmica e possui menor valor de variação de entropia(AS) que a reação 1."
    ],
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Termoquímica", "Cinética Química"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Economia Brasileira", "História da Geografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Após a desestruturação da República, os imperadores romanos legitimaram sua posição sobre fundamentos políticos laicos.",
      "Com o término da República e a ascensão do Império ao longo do primeiro século a.C., os imperadores passaram a ser considerados como escolhidos pelos deuses.",
      "Durante o colapso da República, ocorreu inexpressiva participação popular, tendo em vista que a escravidão tinha sido abolida no período de Espártaco.",
      "No Império, Roma iniciou sua expansão territorial para regiões mediterrânicas da atual Europa, do Oriente Médio e do norte da África.",
      "No final da República, os atores históricos ligados aos triunviratos buscaram legitimar seu poder por intermédio do fortalecimento da liberdade do Senado."
    ],
    correctAnswer: 1,
    materia: ["História"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Movimento Harmônico Simples (MHS)", "Termodinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Tem por equação y + x² + 5x = 0",
      "Tem concavidade voltada para cima.",
      "Tem por vértice um ponto na região do ombro retratado.",
      "Tem por equação 2y + x² + 10x = 0",
      "Admita três raízes reais distintas, todas localizadas no turbante."
    ],
    correctAnswer: 3,
    materia: ["Matemática"],
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Evolução Biológica", "Paleontologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A carteira \"verde e amarela\", legalizada pelo atual governo federal, alinha-se aos esforços no âmbito do poder de Estado para ampliar a segurança jurídica dos trabalhadores, reduzindo a flexibilização e a terceirização.",
      "A atual reforma trabalhista, pretendida desde o governo Lula, busca alinhar o capitalismo brasileiro à dinâmica do capitalismo globalizado.",
      "Diante do desemprego mundial, a atual tendência do capitalismo tem sido fortalecer direitos sociais em detrimento da matriz neoliberal formulada por Keynes.",
      "Instrumentos normativos, como as constituições federais, perderam sua importância econômica na medida em que os novos governantes mundiais são as empresas e não mais o poder dos Estados Nacionais.",
      "As reformulações no campo dos direitos trabalhistas no Brasil têm sido realizadas para se adequarem a acordos assinados pelo atual governo federal com a Organização Internacional do Trabalho (OIT)."
    ],
    correctAnswer: 1,
...
createQuestion({
    ...
    options: [
      "O valor de exposição da obra de arte reforça os laços sociais, na medida em que a exposição intensifica a coesão social, possibilitando, democraticamente, o acesso à obra.",
      ...
      "O valor de culto da obra de arte expressa a gradativa desvinculação entre o humano e o sagrado, considerando que a obra substitui a relação direta do humano com o sagrado.",
      "O valor material atribuído a uma obra de arte é constituído pela persistência de um valor de culto na exposição, evidenciado na \"aura\" que paira sobre as grandes obras, as chamadas obras clássicas.",
      "O elemento comum entre o valor de culto e o valor de exposição da obra de arte é o reconhecimento de que a função \"artística” é a sua dimensão mais importante."
    ],
    correctAnswer: 1,
    materia: ["Filosofia"],
    conteudo: ["Estética", "Walter Benjamin"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A temperatura de solidificação da solução aquosa é maior que a do solvente puro.",
      "A temperatura de ebulição da solução aquosa é maior que a do solvente puro.",
      "A densidade da solução é menor que a do solvente puro.",
      "A pressão de vapor do solvente na solução é maior que da água pura, sob mesma temperatura.",
      "A elevação da temperatura de solidificação da solução depende da natureza química do soluto não volátil."
    ],
    correctAnswer: 1,
    materia: ["Química"],
...
createQuestion({
    ...
    options: [
      "A arte egípcia antiga possui como principais características as paisagens de fundo, as figuras humanas e o uso de cores próximas da realidade, por meio da tinta a óleo, a centralização das imagens e a ilusão de profundidade.",
      "A arte contemporânea surgiu na França e nela a cor reflete a qualidade e a intensidade da luz, sem a utilização do contorno-linha. As sombras são luminosas e coloridas e as misturas, feitas diretamente na pintura.",
      "A arte medieval foi marcada por uma forte influência da Igreja Católica. As pinturas são plenas em luminosidade e em cores puras, além do ouro, da prata e do branco.",
      "A arte impressionista surgiu no pós-primeira guerra e, neste contexto, a cor remete as expressões artísticas originais a partir de técnicas inovadoras, priorizando acima do objeto artístico a ideia e o conceito.",
      "A arte renascentista caracterizava-se pelo racionalismo na qual a maior parte das suas esculturas e pinturas eram coloridas e presentes no interior dos templos. Nela as cores apresentavam não apenas uma função decorativa, mas eram carregadas de simbolismo."
    ],
    correctAnswer: 2,
    materia: ["Arte"],
    conteudo: ["História da Arte", "Teoria da Arte"],
    imageNames: []
})