createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Arte"],
    conteudo: ["Arte Contemporânea", "Multiculturalismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Mundo da Modernidade: a conquista e a colonização da América e do Brasil", "A escravidão e demais formas de trabalho compulsório no Brasil e na América"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Ligações Químicas", "Estudo Geral dos Líquidos e Sólidos", "Sistemas Heterogêneos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Genética e Evolução: estrutura e duplicação do DNA, transcrição e tradução", "Heranças genéticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Estrutura e Estratificação Social", "As Desigualdades Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Os processos sociais e culturais e suas expressões territoriais: produção de conhecimento, transformações tecnológicas e o mundo do trabalho", "A leitura de diferentes linguagens e a produção de conhecimentos geográficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Filosofia"],
    conteudo: ["Problemas Políticos e Éticos na Filosofia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Conjuntos Numéricos: números naturais e números inteiros: operações e propriedades", "Funções, Equações e Inequações: relações e funções: domínio"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Filosofia"],
    conteudo: ["Problemas Epistemológicos na Filosofia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Mecânica", "Leis de Newton", "Colisões"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Conjuntos Numéricos: números naturais e números inteiros", "Números racionais e noções elementares de números reais: operações e propriedades", "Noções Elementares de Números Complexos: operações simples", "Funções, Equações e Inequações: Função logarítmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Conjuntos Numéricos: Razão, Proporção, regra de três e porcentagem", "Geometria plana: Figuras Geométricas: reta, semirreta, segmento, ângulo plano, polígonos planos, circunferência e círculo", "Relações métricas nos triângulos, polígonos regulares e círculos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Mecânica", "Leis de Newton", "Impulso de uma força"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["O mundo na Antiguidade", "Constituição e desenvolvimento da pólis grega"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Substâncias Puras e Misturas: Métodos de separação de misturas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Mundo Contemporâneo: Os impasses sociais do século XX: guerras, revoluções, totalitarismo, populismos e autoritarismos", "Culturas de massa e vanguardas artísticas: as relações entre o erudito e o popular", "Brasil contemporâneo: os dilemas nacionais no pós-64"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["Tema Introdutório Básico (A passagem do Mito para o Logos no surgimento da Filosofia)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Filosofia"],
    conteudo: ["Problemas Estéticos na Filosofia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Substâncias puras e misturas: quantidade de Matéria (mol)", "número de Avogadro"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "hipermetropia é caracterizado pela formação da imagem num ponto antes da retina.",
      "miopia é semelhante a uma lente de vidro plano-côncavo mergulhada em meio aquoso.",
      "hipermetropia é semelhante a uma lente de vidro côncavo-convexo mergulhada em meio aquoso.",
      "miopia tem a imagem formada depois da retina, e sua correção deve ser feita com lentes convergentes.",
      "miopia é caracterizado por apresentar uma convergência acentuada do cristalino."
    ],
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Óptica e Ondas: lentes e instrumentos ópticos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Diversidade dos Seres Vivos", "Classificação e características morfológicas dos seres vivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Biodiversidade: compreensão dos conceitos de variabilidade genética e de biodiversidade", "conhecimento das relações ecológicas estabelecidas entre os seres vivos e o ambiente", "conhecimento de como se originam as características e os mecanismos biológicos", "compreensão da natureza viva, seus fenômenos, componentes e interações", "compreensão da complexidade das interações bióticas e abióticas", "Mecanismos biológicos: conhecer os processos celulares e os fenômenos físicos e químicos neles envolvidos", "reconhecer os processos de divisão celular para a manutenção dos seres vivos", "caracterizar as funções vitais básicas, realizadas por diferentes estruturas, órgãos e sistemas, bem como reconhecer as características dos organismos que permitem sua adaptação aos diferentes ambientes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Funções, Equações e Inequações: Produto cartesiano", "Relações e funções: domínio, contradomínio, imagem e gráficos, crescimento e decrescimento", "Função injetora, sobrejetora e bijetora, composta e inversa", "Função exponencial", "Equações exponenciais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Equilíbrio químico: aspectos gerais", "Compostos de carbono: aspectos gerais", "Substâncias Puras e Misturas: Quantidade de matéria (mol)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Funções, Equações e Inequações: Relações e funções: domínio, contradomínio e imagem", "Função exponencial", "Equações exponenciais", "Polinômios e Equações Algébricas: definição, conceito de raiz"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Diversidade dos seres vivos: Características morfológicas e fisiológicas dos grupos de seres vivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A revolução tecnológica atual originou-se da resistência social à reestruturação global do capitalismo e moldou- -se pela lógica da liberdade em oposição aos interesses mercantis.",
      "O novo das redes sociais é que, diferentemente das mídias tradicionais, são empreendimentos anticapitalistas por não cobrarem dos usuários o acesso aos serviços de informação.",
      "As interações via redes sociais tornam mais fluidas as fronteiras entre as esferas pública e privada no mundo contemporâneo.",
      "A força política das fake news, nas recentes eleições presidenciais nos EUA, teve como motor a ausência de medidas estatais e privadas para regular os termos de uso das redes sociais.",
      "Os sistemas de comunicações digitais, ao criarem novos espaços de diálogo sobre os problemas sociais, retiram do Estado sua principal função: o uso do monopólio legítimo da violência."
    ],
    correctAnswer: 2,
    materia: ["Sociologia"],
...
createQuestion({
    ...
    options: [
      "John Tuberville Needham defendeu a abiogênese por meio de experimentos que demonstraram o surgimento de microrganismos em um caldo de carne aquecido e mantido em recipientes fechados.",
      "Jean-Baptiste van Helmont defendeu a biogênese por meio de experimentos que demonstraram o surgimento de larvas em pedaços de carne em putrefação.",
      "Lazzaro Spallanzani defendeu a biogênese por meio de estudos que demonstraram a origem da matéria que permitia o crescimento das plantas em vasos.",
      "Felix Pouchet defendeu a biogênese por meio de experimentos a partir dos quais surgiam microrganismos pela fervura de um caldo nutritivo em frascos de vidro.",
      "Louis Pasteur defendeu a abiogênese por meio de experimentos com uma mistura aquecida de água, feno e gás oxigênio (O2), a partir da qual surgiam microrganismos."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["O Mundo Contemporâneo: A consolidação do capitalismo: dominação, conflitos e resistências", "Os impasses sociais do século XX: guerras, revoluções, totalitarismos, populismos e autoritarismos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Termoquímica: Aditividade dos calores de reação e Lei de Hess"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "instável, pois o momento de força atuante na pedra superior varia com o tempo.",
      "estável, pois a resultante das forças que atuam sobre a última pedra é positiva.",
      "instável, pois a resultante das forças que atuam sobre o conjunto das pedras é nula.",
      "estável, pois a resultante das forças que atuam sobre a primeira pedra é positiva.",
      "instável, pois a resultante das forças que atuam sobre o conjunto das pedras é negativa."
    ],
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Mecânica: Equilíbrio estático: forças em equilíbrio"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["A apropriação e exploração dos diferentes elementos da natureza, a partir de conceitos básicos relativos a: características, dinâmicas e interações climáticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As práticas toyotistas foram incorporadas pelo modelo econômico neoliberal para potencializar a produtividade do trabalho.",
      "A política econômica de Hegel de estatização da economia impediu os trabalhadores de escolherem livremente seus empregos.",
      "O Plano Marshall foi implementado pelos EUA para reconstruir sua infraestrutura econômica de indústria nacional devastada pela Segunda Guerra Mundial.",
      "A Glasnost, criada por Gorbatchev na U.R.S.S., representou a salvação da bancarrota da economia soviética.",
      "Mahatma Gandhi, ao fiar o algodão para produzir seu próprio tecido, incentivou os indianos a participarem do mercado britânico."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["O Mundo Contemporâneo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Análise Combinatória: Princípios de contagem", "Noções de Estatística e Probabilidade: conceituação de probabilidade", "Probabilidade da União de Eventos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Fluidos e Termodinâmica", "Termodinâmica: Lei zero, processos termodinâmicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Conjuntos Numéricos: números naturais e números inteiros: operações e propriedades, divisibilidade", "Noções Elementares de Números Complexos: operações simples"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["O Conhecimento em Ciências Sociais: introdução ao estudo da sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a transgenia aplicada na produção agrícola permitiu aos produtores rurais a geração de suas próprias sementes transgênicas, dando-lhes autonomia produtiva.",
      "a biopirataria praticada pelos povos nativos prejudicou os lucros das corporações transnacionais envolvidas diretamente nos direitos sobre as patentes de suas pesquisas tecno-científicas.",
      "a partir do desenvolvimento científico da biotecnologia, os profissionais vinculados a essa área se tornaram responsáveis a cumprir os preceitos da bioética.",
      "o projeto de pesquisa científico e tecnológico de mapeamento genético denominado Genoma Humano foi desenvolvido pela Bayer e teve sua patente reconhecida pela ONU.",
      "o patrimônio genético dos povos nativos e seus conhecimentos de práticas milenares de cultivo e de relação com seu habitat gerou-lhes rendimentos lucrativos no Banco Mundial."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["O Mundo Contemporâneo: globalização, neoliberalismos, a questão ambiental e a sociedade do conhecimento"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["A apropriação e exploração dos diferentes elementos da natureza, a partir de conceitos básicos", "Os processos sociais e culturais e suas expressões territoriais", "A dimensão política do espaço geográfico", "A leitura de diferentes linguagens e a produção de conhecimentos geográficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["O Mundo contemporâneo: os Impassses sociais do século XX: guerras, revoluções, totalitarismos, populismos e autoritarismos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A bomba de fissão nuclear, conhecida como bomba H, libera energia quando ocorre o processo de fragmentação de núcleos de U238.",
      "A bomba de fissão nuclear, conhecida como bomba A, libera energia quando ocorre o processo de fragmentação de núcleos de U235.",
      "A bomba de fissão nuclear, conhecida como bomba H, absorve energia quando ocorre o processo de fragmentação de núcleos de U238.",
      "A bomba de fusão nuclear, conhecida como bomba A, libera energia quando ocorre o processo de fragmentação de núcleos de U238.",
      "A bomba de fusão nuclear, conhecida como bomba H, absorve energia quando ocorre o processo de fragmentação de núcleos de U235."
    ],
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Física, Cosmos e Vida: transformações dos materiais e radioatividade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["A dimensão política do espaço geográfico: a constituição dos blocos de poder e as transformações territoriais", "Regionalização do espaço mundial", "A leitura de diferentes linguagens e a produção de conhecimentos Geográficos", "Análise e interpretação de mapas, gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Do vapor da água oriundo de áreas continentais, mais de 90% origina-se da evaporação diretamente do solo e o restante se dá pela respiração das plantas.",
      "A região bentônica dos ecossistemas marinhos caracteriza-se pela intensa penetração de luz, alta atividade fotossintética, grande disponibilidade de nutrientes e muitos animais.",
      "O acúmulo de partículas na água de rios e lagos aumenta a penetração de luz, o que implica aumento da biodiversidade de espécies fotossintetizantes aquáticas.",
      "A eutrofização indica que um determinado ambiente aquático alcançou o seu clímax, porque nele são encontradas situações favoráveis para o desenvolvimento dos mais diferentes tipos de seres vivos.",
      "Os néctons constituem um grupo de organismos aquáticos, do qual fazem parte os animais com capacidade de deslocamento e natação, como moluscos, cefalópodes, peixes, golfinhos, tartarugas e baleias."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Diversidade dos seres vivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["A apropriação e exploração dos diferentes elementos da natureza, a partir de conceitos básicos relativos: à gênese e transformação do relevo", "dinâmica das bacias hidrográficas e sua utilização", "impactos ambientais e suas implicações no mundo moderno"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Os processos sociais e culturais e suas expressões territoriais: atividades econômicas e dinâmicas populacionais", "Urbanização"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Uma característica da Taenia é a presença de tubo digestório, uma vez que esses parasitas precisam digerir o alimento retirado do intestino do hospedeiro.",
      "O hospedeiro intermediário da Taenia solium é o boi e o da Taenia saginata é o porco e, em ambos os casos, a tênia adulta vive presa à parede do intestino grosso desses animais, de onde são eliminados os ovos produzidos por reprodução sexuada.",
      "Uma parte importante do ciclo da teníase é quando as fezes do porco ou do boi, contaminadas por cisticercos, acidentalmente caem na água e são ingeridas pelos humanos.",
      "O ser humano contamina-se ao ingerir carne crua ou mal cozida que contém cisticercos, os quais, no intestino delgado, sofrem algumas alterações e prendem-se à mucosa intestinal através do escólex.",
      "A teníase, quando comparada com a cisticercose humana, é a forma mais grave da parasitose, porque neste caso, o ser humano fica por muito tempo liberando ovos de Taenia saginata no ambiente, podendo contaminar outras pessoas."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Diversidade dos seres vivos", "Ecologia: Desequilíbrios ambientais (poluição)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As regiões Sul e Nordeste possuem uma cobertura de esgotamento (coletado e tratado) que atinge 87% das pessoas demonstrando a redução das desigualdades inter-regionais da infraestrutura urbana.",
      "O esgoto coletado e tratado, juntamente com os da solução individual, nas regiões Norte (63%) e Nordeste (52%), demonstram que a existência dos rios de grande volume de água serve para diluir os esgotos, diminuindo o impacto nos canais, nos rios urbanos e na saúde da população.",
      "A modernização do território nacional e o padrão de desenvolvimento econômico concentrador contribuem para a baixíssima remoção de carga orgânica advinda do tratamento do esgoto doméstico com atendimento adequado presente nas regiões Sudeste e Centro-Oeste, correspondendo a 33% e 48%, respectivamente.",
      "O panorama geral da coleta e do tratamento de esgotos das macrorregiões brasileiras indica que 57% da população nacional convive com uma paisagem urbana com esgotos a céu aberto e despejado nos córregos e nos rios.",
      "O atendimento precário ou inexistente de coleta e tratamento de esgoto ocorre de forma heterogênea, no território inter-regional, afetando 43% da população brasileira."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["A apropriação e exploração dos diferentes elementos da natureza, a partir de conceitos básicos relativos: à dinâmica das bacias hidrográficas e sua utilização", "impactos ambientais e suas implicações no mundo moderno", "dimensão política do espaço geográfico: Desigualdades regionais", "A leitura de diferentes linguagens e a produção de conhecimentos geográficos: análise e interpretação de mapas, gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "em solos agrícolas é menor porque a concentração de íons H⁺ na água do solo é maior se comparada à água do solo urbano.",
      "em solos urbanos é maior porque o solo retém mais cádmio na forma de Cd²⁺ e porque a concentração de H⁺ na água do solo é baixa se comparada ao solo agrícola.",
      "em solos urbanos é maior porque a concentração de cádmio na forma Cd²⁺ na água do solo é elevada se comparada ao solo agrícola.",
      "em solos agrícolas é menor porque usualmente esses solos são tratados com ureia (fertilizante com caráter básico), o que pode reduzir o pH da água do solo e, por consequência, tornar os íons Cd²⁺ mais móveis na água do solo.",
      "em solos agrícolas é menor porque usualmente esses solos são tratados com CaCO₃, o que pode elevar o pH da água do solo e, por consequência, precipitar os íons Cd²⁺ na forma de Cd(OH)₂(s), tornando-os menos móveis."
    ],
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Equilíbrio Químico: aspectos gerais", "Sistemas Heterogêneos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Na Reação 1, Fe²⁺ é o agente oxidante e H2O2 é o agente redutor.",
      "A eficiência do processo Fenton é maior em meio básico (alcalino).",
      "O excesso de H2O2 em relação a Fe²⁺ diminui a eficiência do processo Fenton.",
      "Sendo a Reação 1 de segunda ordem, e a concentração de Fe²⁺ e de H2O2 iguais a 2,0 mol L⁻¹, a velocidade será de 504 mol L⁻¹ s⁻¹.",
      "A molecularidade de cada uma das equações químicas, reações 1 e 2, é 4."
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Equilíbrio químico: aspectos gerais", "Cinética química", "Oxidação e Redução"],
    imageNames: []
})