createQuestion({
    ...
    options: [
      "Superbactérias causadoras de doenças em seres humanos apresentam alterações em seu DNA, provocadas por antibióticos utilizados indiscriminadamente por nossa população.",
      "Lactobacilos, utilizados em larga escala na indústria de alimentos como queijos e iogurtes, realizam o processo de glicólise, sendo capazes de produzir ácido lático.",
      "Certas bactérias, juntamente com fungos, são, em um ecossistema, responsáveis pela decomposição de organismos mortos.",
      "Bactérias nitrificantes, presentes no solo, são responsáveis pela produção de nitritos e nitratos; estes últimos são absorvidos pelas plantas para a produção de compostos orgânicos nitrogenados. Por outro lado, as cianobactérias realizam fotossíntese, produzindo glicose e liberando oxigênio para o ambiente."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "Os diversos tipos de aminoácidos livres no citosol.",
      "A existência de transporte ativo de íons através da membrana plasmática.",
      "A sequência de aminoácidos que constituem os citocromos presentes na mitocôndria.",
      "As sequências de anticódons das moléculas de RNA transportador presentes no citosol."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Biologia Celular", "Bioquímica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a entrada de sangue rico em oxigênio se dá pelas veias cavas.",
      "a entrada de sangue pobre em oxigênio se dá pela artéria pulmonar.",
      "a saída de sangue rico em oxigênio se dá pela artéria aorta.",
      "a saída de sangue pobre em oxigênio se dá pelas veias pulmonares."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "amarela, devido à liberação de gás carbônico pela folha e a do lote B roxa, devido ao consumo de gás carbônico pela folha.",
      "roxa, devido ao consumo de gás carbônico pela folha e a do lote B amarela, devido à liberação de gás carbônico pela folha.",
      "amarela, devido ao consumo de oxigênio pela folha e a do lote B roxa, devido à liberação de gás carbônico pela folha.",
      "roxa, devido à liberação de oxigênio pela folha e a do lote B amarela, devido à liberação de gás carbônico pela folha."
    ],
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Fenômenos Físico-Químicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "real, direita e do mesmo tamanho do objeto.",
      "virtual, invertida lateralmente e maior que o objeto.",
      "virtual, direita e do mesmo tamanho do objeto.",
      "real, invertida lateralmente e do mesmo tamanho do objeto."
    ],
    correctAnswer: 2,
    materia: ["Física"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica (Potência e Resistência Elétrica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "com o café plantado em linha, inclusive no morro, preservaram-se os solos, o que facilitou a recuperação do ambiente depois que a onda cafeeira passou.",
      "no primeiro plano, o lavrador lavra o morro, cujo destino será o do morro de fundo com plantações no seu topo, algo condenável nos dias de hoje.",
      "a ausência de curvas de nível na lavoura, tal como se percebe no morro, impedia o processo erosivo, pois, exposta a isso, a plantação seria prejudicada.",
      "lavouras a perder de vista como a retratada, sem nenhuma mancha de mata anterior, de fato não ocorreram; trata-se de uma liberdade do artista."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "o valor econômico é duvidoso, pois se sua área e formação vegetal dominante são propícias para a exploração da pecuária, o mesmo não pode ser dito para a agricultura, que não vingará nesses solos pobres e secos.",
      "os segredos do cerrado são mais força de expressão literária do que reais, pois estamos diante de um bioma marcado por certa homogeneidade biológica que se repete monotonamente por vastas extensões.",
      "trata-se de uma formação de dominância herbácea o que no passado a ligava ao risco da devastação pela pecuária excessiva, mas que atualmente está razoavelmente preservada pelo seu baixo uso econômico.",
      "essa é uma formação savânica, cuja marca é a presença dos três estratos vegetais (arbóreo, arbustivo e herbáceo), sem predomínio de nenhum deles, e também a presença de uma biodiversidade notável."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Biomas Brasileiros (Cerrado)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "mantendo a curva ascendente, mas sempre encontrando obstáculos relacionados à grande desigualdade econômica e regional do país.",
      "lentamente, quase que estagnou, visto que, nessa década e meia do país, o recuo econômico implicou a diminuição dos fluxos intraterritoriais.",
      "de modo acelerado, integrando cidades grandes, médias e pequenas, o que se comprova com a saúde financeira das companhias aéreas nacionais.",
      "significativamente nas regiões mais pobres do país, nas quais grandes investimentos de infraestrutura para o transporte aéreo foram feitos."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Brasil Império (Independência)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "à propaganda do governo Vargas, que buscava promover as manifestações cívicas e apresentava a figura do presidente como \"pai da nação\".",
      "à implantação, pelo governo Vargas, do ensino público e gratuito para todos os brasileiros menores de 21 anos.",
      "à política, desenvolvida pelo governo Vargas, de estimular o trabalho infantil nas áreas urbanas e rurais do país.",
      "à crítica dos cafeicultores ao governo Vargas, a quem chamavam de \"pai dos pobres\", acusando-o de não governar para todos os brasileiros."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Era Vargas"],
...
createQuestion({
    ...
    options: [
      "ampliavam a legislação trabalhista, fechavam o mercado interno aos produtos estrangeiros, estatizavam os setores estratégicos da economia e promoviam reforma agrária.",
      "estabeleciam mecanismos de controle cambial, suprimiam benefícios e vantagens fiscais, estatizavam o setor bancário e desenvolviam programas de apoio às pequenas e médias empresas.",
      "celebravam pactos sociais com os setores sindicais, eliminavam barreiras alfandegárias, apoiavam os programas internacionais de proteção ambiental e defendiam aumentos reais dos salários dos trabalhadores.",
      "reduziam drasticamente os encargos fiscais, estimulavam as atividades e os lucros das grandes empresas, realizavam privatizações e promoviam desregulamentação dos mercados."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História Contemporânea (Neoliberalismo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Ina Garten e Eli Zabar moraram na Madison Avenue em NY.",
      "a confecção de pães artesanais evoluiu para versões mais saudáveis.",
      "receitas familiares para confecção de pães caíram em desuso.",
      "Eli Zabar uniu-se recentemente a Dan Barber e Blue Hill para a produção de pães artesanais."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "A cidade de New York pode eventualmente ficar sob forte seca e calor.",
      "Os níveis de chuva neste verão estão abaixo do esperado para o padrão nos EUA.",
      "O furacão Hermine poderia vir a ser exatamente aquilo de que o estado de New York precisa.",
      "Os níveis de chuva e de calor foram mais altos do que a média de outros anos."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Compreensão Textual"],
...
createQuestion({
    ...
    options: [
      "O Protocolo de Montreal pedia a eliminação do uso de CFC na indústria.",
      "O tamanho do buraco da camada de ozônio tem diminuído regularmente desde 2000.",
      "O Protocolo de Montreal, de 1987, visava a reduzir a fabricação de produtos químicos nocivos à camada de ozônio.",
      "Um estudo mostra que a camada de ozônio da Antártica começa a apresentar sinais de recuperação."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Compreensão Textual"],
...
createQuestion({
    ...
    options: [
      "trocar mensagens de texto interfere negativamente nas aulas.",
      "estudos parecem comprovar que trocas de mensagens relacionadas ou não à aula não prejudicam o resultado da aprendizagem.",
      "um estudo feito na Universidade de Miami mostra que universitários não deveriam trocar mensagens durante as aulas.",
      "a troca de mensagens de texto sobre assuntos não relacionados à aula pode prejudicar os resultados obtidos pelos alunos."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "a garota preocupada tenta convencer o colega a estudar mais para melhorar suas notas.",
      "o garoto tenta justificar a falta da lição de casa por causa do braço quebrado.",
      "o garoto e a garota não usam a palavra “place” com o mesmo significado.",
      "a garota fica consternada ao perceber que o garoto quebrou o braço e terá de mudar de lugar."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto (Charge)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Mínimo Múltiplo Comum (MMC)", "Proporcionalidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Funções (Composição de Funções)", "Gráficos de Funções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Pirâmides)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Razão e Proporção", "Problemas de Trabalho"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Polinômios (Raízes e Relações de Girard)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "X: Ag e Cu; Y: Ni e Fe",
      "X: Ag e Cu; Y: Ni, Fe, Zn e Mg",
      "X: Zn e Mg; Y: Ni, Fe, Zn e Mg",
      "X: Zn e Mg; Y: Ag e Cu"
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Eletroquímica (Corrosão e Proteção Catódica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "bromociclobutano e bromocicloexano.",
      "1,4-dibromobutano e bromocicloexano.",
      "bromociclobutano e 1,6-dibromoexano.",
      "1,4-dibromobutano e 1,6-dibromoexano."
    ],
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Orgânica (Reações de Cicloalcanos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Termoquímica", "Bioquímica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "sente uma efusão patriótica por Tormes, sua terra natal, de onde lhe provêm as rendas para seu sustento.",
      "está plenamente convencido de que apenas no contato com a natureza e com o clima das serras poderá encontrar a felicidade.",
      "vê-se compelido a acompanhar a reforma de sua casa em terras portuguesas, bem como assistir à trasladação dos restos mortais dos avós, particularmente os do avô Galeão.",
      "está farto da vida elegante e tecnológica de Paris e, por isso, prazerosamente, busca uma experiência nova que, infelizmente lhe resulta frustrante."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (Realismo Português)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (Realismo Brasileiro)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A hora e vez de Augusto Matraga, que narra a violência como instrumento de redenção, materializada na morte de Joãozinho Bem-Bem e do jagunço protagonista.",
      "Corpo Fechado, história de valentões e de espertos, de violência e de mágica, protagonizado por Manuel Fulô.",
      "São Marcos, que relata a desavença entre o narrador e um feiticeiro que o deixa cego por força de uma bruxaria.",
      "Minha Gente, em que se relata a situação vivida por um moço da cidade que vai passar uma temporada no campo e vive amores desencontrados."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "construir proposta interventiva inicial para posterior aperfeiçoamento e adoção em maiores proporções.",
      "promover debate para discutir as providências que podem enfrentar a violência contra profissionais da saúde.",
      "discutir com os profissionais da saúde quais seriam as melhores ações interventivas.",
      "intervir retroativamente com base nos registros de ameaças ou de truculência a que foram submetidos médicos e enfermeiros."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Compreensão Textual"],
...
createQuestion({
    ...
    options: [
      "dizem respeito ao descaso quanto ao que implica ser médico, o que está detalhado no sétimo parágrafo.",
      "decorrem dos altos tributos que os brasileiros pagam sem o devido retorno, como está no quinto parágrafo.",
      "extrapolam a relação direta entre pacientes e profissionais da saúde, e algumas delas se encontram no quarto parágrafo.",
      "concentram-se restritivamente à forma como a relação médico-paciente se desenvolve na saúde brasileira."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Compreensão Textual"],
...
createQuestion({
    ...
    options: [
      "refere-se a profissionais da saúde, pois esse é o tema do texto.",
      "antecipa a informação nova que está no parágrafo subsequente.",
      "retoma informação já apresentada, dando-lhe um valor enfático.",
      "introduz informação nova relacionada ao tema do texto."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática (Coesão Referencial)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Concessão, condição, contraste e contradição.",
      "Finalidade, oposição, concessão e explicação.",
      "Concomitância, condição, oposição e explicação.",
      "Finalidade, concomitância, condição e oposição."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
