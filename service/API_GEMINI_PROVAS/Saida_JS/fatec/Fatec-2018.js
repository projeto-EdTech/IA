createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Teoria da Hierarquia das Necessidades Humanas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "mascarar o desejo de que Dilbert tente se livrar da própria personalidade.",
      "exaltar a necessidade da comunicação como afirmação da individualidade.",
      "criticar a timidez de Dilbert que, segundo o chefe, não é uma pessoa comunicativa.",
      "promover melhorias das relações com os empregados, por meio da comunicabilidade.",
      "incentivar o pensamento e a discussão por meio do questionamento e da comunicação."
    ],
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Humor e Comunicação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Porcentagem e Média Aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "no período 1995–2006, houve aumento tanto da renda média dos adultos como da taxa de atividade dos jovens, o que resultou declínio na taxa de participação dos jovens que só trabalham, além de redução da proporção dos que são economicamente ativos e estudam simultaneamente.",
      "no período 2002-2003, a renda média dos adultos ficou estagnada e a taxa de atividade dos jovens aumentou, o que resultou declínio da taxa dos jovens que não estudam nem trabalham e aumento do número de jovens que só trabalham.",
      "no período 2009–2012, houve aumento da renda média dos adultos e diminuição da taxa de atividade dos jovens, o que resultou declínio da taxa de participação dos jovens na População Economicamente Ativa, além do aumento da participação dos jovens que só estudam.",
      "no período 1992-1995, a renda média dos adultos aumentou e a taxa de atividade dos jovens diminuiu, o que resultou aumento dos jovens que não estudam nem trabalham, bem como redução tanto dos jovens que estudam e trabalham, quanto dos que só estudam.",
      "no período 1995–1998, a renda média dos adultos diminuiu e a taxa de atividade dos jovens aumentou, o que resultou elevação da proporção tanto dos jovens que não estudam nem trabalham, quanto dos jovens que só trabalham."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Análise de Dados Socioeconômicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Sociedade de Consumo e Pensamento Sociológico"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Conversão de Unidades e Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "retirar duas esferas do prato A.",
      "retirar dois cubos do prato B.",
      "colocar um cubo no prato A.",
      "colocar três esferas no prato A.",
      "colocar dois cubos no prato B."
    ],
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Equações e Lógica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana e Áreas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Princípio da Casa dos Pombos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "pela promulgação de um novo Código Civil que, entre outras determinações, separou Igreja e Estado, legalizou o divórcio e consolidou a abolição dos direitos feudais da nobreza e do clero.",
      "pela manutenção dos laços de cooperação entre França e Inglaterra e pelo Tratado de Versalhes, que estabeleceu o princípio de autodeterminação dos povos.",
      "pela adoção do pluralismo religioso, ocasionado pela chegada à França de imigrantes oriundos das colônias francesas no Oriente Médio e na África.",
      "pela guerra contra os Estados Unidos e pela conquista dos territórios indígenas do oeste da América do Norte.",
      "pela criação da União Europeia, que unificou econômica e politicamente todos os países do continente."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Era Napoleônica e Revolução Francesa"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "os deuses gregos eram considerados infalíveis e representavam um modelo de perfeição a ser seguido pelos humanos.",
      "as divindades gregas, na concepção dos filósofos da época, eram a personificação da terra, da água, do fogo e do ar, os quatro elementos naturais.",
      "os deuses gregos, segundo a tradição oral, escolhiam as cidades que iriam proteger a partir da apreciação estética das construções a eles devotadas.",
      "os deuses gregos, embora fossem imortais, apresentavam características de personalidade que os assemelhavam aos humanos, como maldade, egoísmo e fraqueza.",
      "a legislação determinava que os templos fossem construídos a partir das orientações dos oráculos dos deuses, que estabeleciam a forma, as dimensões e os materiais usados na construção."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Grécia Antiga e Religião"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "edição de material filosófico crítico à fé cristã.",
      "criação do primeiro jornal evangélico diário.",
      "publicação de novelas religiosas populares.",
      "divulgação de produtos e serviços bíblicos.",
      "impressão da Bíblia em alemão."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Reforma Protestante e Revolução da Imprensa"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O número de filiados ao Partido Nazista no ano de 1932 pode ser explicado pela aliança estabelecida entre Hitler e Stálin, já que o comunismo era uma doutrina popular na Alemanha.",
      "O número de filiados ao Partido Nazista aumentou em 1930 como consequência da grave crise econômica mundial iniciada no ano anterior, a qual provocou o colapso da economia alemã.",
      "Em 1925, satisfeitos com a assinatura dos tratados de paz que puseram fim à Primeira Guerra Mundial, os alemães aderiram às ideias pacifistas do Partido Nazista.",
      "Em 1927, o Partido Nazista sofreu uma queda brusca no número de filiados, devido ao sucesso da política econômica implantada pela República de Weimar.",
      "O ano de 1928 foi marcado pela prosperidade econômica ocorrida na Alemanha após a Primeira Guerra Mundial, o que explica o número de filiados ao partido."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Nazismo e Crise de 1929"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Inconfidência Mineira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Nox (Número de Oxidação)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Propriedades de Compostos Orgânicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Termoquímica e Entalpia de Combustão"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O termo fake news se aplica aos websites que difundem notícias falsas.",
      "A existência de fake news contribuiu para o desenvolvimento do universo digital.",
      "As eleições americanas foram as responsáveis pelo início da divulgação de fake news.",
      "O termo fake news é usado para designar toda informação que se baseia em fatos reais.",
      "O resultado das eleições americanas foi, inegavelmente, uma consequência de fake news."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "A recusa em aceitar comentários negativos, atitude comum aos usuários de redes sociais que produz efeitos profundos no universo digital.",
      "A característica que as plataformas de social media (mídia social) apresentam de difundir informações sem verificá-las, a pretexto de facilitar a comunicação.",
      "A postura do Facebook, única plataforma de social media (mídia social) que se opõe veementemente à censura de qualquer tipo de informação postada.",
      "A facilidade de criação de websites e de histórias que, apesar de serem falsos, são capazes de convencer todos os usuários, indistintamente, de sua veracidade.",
      "A tranquilidade com a qual tais notícias são disseminadas, de maneira a serem consideradas verdadeiras simplesmente pelo fato de serem reproduzidas repetidamente."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Compreensão Textual"],
...
createQuestion({
    ...
    options: [
      "o Facebook, apesar de possibilitar a liberdade de expressão, não serviu como meio de divulgação de fake news pelo fato de ter muitos usuários.",
      "a diminuição do número de usuários do Facebook, fato explicado pelo surgimento de outras companhias de mídia tão grandes ou até maiores, fez da rede uma fonte de fake news.",
      "o Facebook, mesmo tendo assumido uma postura inicialmente positiva com relação a fake news, viu-se forçado a mudar de estratégia, exercendo a censura explícita de conteúdos.",
      "cerca de 2 bilhões de usuários por mês participam, mesmo que indiretamente, da disseminação de fake news em virtude da tendência humana de se comprazer com tragédias.",
      "o Facebook, por ter um elevado número de usuários, tornou-se a maior companhia de mídia a hospedar fake news, contribuindo, para isso, a política de liberdade de expressão do site."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Compreensão Textual"],
...
createQuestion({
    ...
    options: [
      "afetam positivamente a companhia, promovendo um maior interesse do público pela plataforma digital.",
      "afetam positivamente a companhia, que se beneficiou financeiramente dos resultados da eleição americana.",
      "não repercutem sobre a companhia, que já estava preparada para tal ameaça, tendo desenvolvido ferramentas eficientes de rastreio de fake news.",
      "trazem, certamente, repercussões de caráter econômico para o Facebook, considerado um agente essencial no processo de criação de fake news.",
      "podem afetar negativamente a companhia, fazendo com que os anunciantes deixem de se interessar pelo Facebook, por ele ser menos confiável para as marcas do que era antes."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Compreensão Textual"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Vocabulário e Formação de Palavras"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Probabilidade e Análise de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "R$ 1.140,00 e R$ 2.000,00",
      "R$ 1.240,00 e R$ 1.140,00",
      "R$ 1.240,00 e R$ 2.000,00",
      "R$ 2.000,00 e R$ 1.140,00",
      "R$ 2.000,00 e R$ 1.240,00"
    ],
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Sistemas de Equações Lineares e Porcentagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Volumes de Pirâmides)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Áreas e Custos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Áreas de Superfície)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Cinemática e Conversão de Unidades"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Óptica Geométrica (Lentes e Vergência)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Termodinâmica e Gases Ideais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletromagnetismo e Unidades de Medida"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "expansão da criação de gado bovino de leite.",
      "expansão da criação de gado ovino para lã.",
      "extração e processamento do pau-brasil.",
      "expansão do cultivo mecanizado de soja.",
      "expansão do cultivo extensivo de cacau."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Impactos Ambientais e Atividades Econômicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "projeção cilíndrica conforme, que distorce as dimensões territoriais e preserva a forma dos continentes.",
      "projeção cônica, que é ideal para representação de grandes áreas cujas distorções são menores na altura da linha do Equador.",
      "projeção cilíndrica equivalente, que preserva as dimensões territoriais e distorce as formas dos continentes.",
      "projeção plana ou azimutal, que preserva as dimensões territoriais nas áreas equatoriais, distorcendo-as nas regiões tropicais.",
      "projeção cilíndrica equatorial, que preserva as dimensões territoriais nas regiões polares, distorcendo-as próximo à linha do Equador."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "a preocupação com o crescimento da economia global e, ao mesmo tempo, um reconhecimento da importância de ações em defesa do meio ambiente.",
      "a sintonia do presidente da nação mais poderosa do mundo com os seus eleitores e com o que pensa a maioria dos europeus tanto sobre temas econômicos como ambientais.",
      "a posição isolacionista do atual governo estadunidense no mundo em que os interesses econômicos locais se sobrepõem às preocupações ambientais da comunidade internacional.",
      "a sincronia com o governo chinês, líder na emissão de gases estufa, que defende a tese de que o combate ao aquecimento global só será reduzido com crescimento econômico.",
      "a preocupação do principal ocupante da Casa Branca em manter os Estados Unidos alinhados aos interesses econômicos de grandes empresas de energias renováveis."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geopolítica e Questões Ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Conflitos e Geopolítica do Oriente Médio"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "resulta da decomposição parcial dos tecidos não esqueléticos de dinossauros, cujos esqueletos ficam próximos aos depósitos petrolíferos.",
      "pode se formar a partir do esqueleto de fósseis de coloração escura, cuja sedimentação depende parcialmente de ação vulcânica.",
      "fica aderido a rochas metamórficas, formadas por minérios e por animais que sofrem metamorfose, como anfíbios e insetos.",
      "pode ser mais facilmente encontrado próximo a camadas geológicas identificáveis por microfósseis.",
      "é um tipo de óleo biológico que foi secretado por determinados seres vivos em um passado remoto."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Paleontologia e Formação de Combustíveis Fósseis"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Ciclos de Vida e Meiose"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Genética Molecular e Síntese Proteica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Genética e Grupos Sanguíneos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "permitiria que a empresa obtivesse o certificado, já que a madeira apresenta alburno típico do crescimento primário de fanerógamas temperadas, que são nativas do Tocantins.",
      "permitiria que a empresa obtivesse o certificado, já que a madeira apresenta alburno típico do crescimento secundário de briófitas temperadas, que são nativas do Tocantins.",
      "permitiria que a empresa obtivesse o certificado, já que a madeira apresenta anéis típicos do crescimento secundário de briófitas tropicais, que são nativas do Tocantins.",
      "impediria a empresa de obter o certificado, já que a madeira apresenta alburno típico do crescimento primário de fanerógamas tropicais, que não são nativas do Tocantins.",
      "impediria a empresa de obter o certificado, já que a madeira apresenta anéis típicos do crescimento secundário de fanerógamas temperadas, que não são nativas do Tocantins."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Botânica e Sustentabilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Análise Literária e Estilística"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Figuras de Linguagem (Sinestesia)"],
    imageNames: []
}),
