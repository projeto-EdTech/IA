createQuestion({
    ...
    conteudo: ["Semântica", "Ambiguidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Figuras de Linguagem"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "“Ai mãe, está tão escuro no meu sonho!\" (9º parágrafo)",
      "“A mãe, então, se afligia: roía o dedo e deixava a unha intacta.\" (1º parágrafo)",
      "\"A senhora ficou espreitando a noite, na ilusão de escutar a voz de um pássaro.\" (6º parágrafo)",
      "\"Pode-se morrer assim com tanta leveza, que nem se nota a retirada da vida?\" (16º parágrafo)",
      "“- Morta, a minha menina? Mas, assim...?\" (14º parágrafo)"
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
...
createQuestion({
    ...
    options: [
      "\"Quando acorda, manhã alta, encontra flores que a mãe depositou ao pé da cama.\" (21º parágrafo)",
      "\"O médico corrigiu os óculos como se entendesse rectificar a própria visão.\" (12º parágrafo)",
      "\"A mãe regressou à casa e encontrou a filha entoando danças, cantarolando canções que nem existem.\" (18º parágrafo)",
      "\"Ao fim da tarde, as duas, mãe e filha, passeiam pela praça e os velhos descobrem a cabeça em sinal de respeito.\" (21º parágrafo)",
      "\"A mãe se ergueu, pé descalço pelo corredor.\" (4º parágrafo)"
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Figuras de Linguagem (Paradoxo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Estilos Literários"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "\"inexistisse\" (18º parágrafo).",
      "\"derradeiragem\" (7º parágrafo).",
      "\"intacta\" (1º parágrafo).",
      "\"descobrem\" (21º parágrafo).",
      "\"imobilidade\" (7º parágrafo)."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Formação de Palavras", "Sufixação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira (Barroco)", "Gêneros Líricos (Sátira)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Referência Textual", "Pronomes"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "em \"vizinha”/“esquadrinha\" (2ª estrofe) e em \"nobres\"/\n\"pobres\" (3ª/4ª estrofes).",
      "em \"vinha”/“cozinha” (1ª estrofe) e em “olheiro”/“terreiro”\n(2ª estrofe).",
      "em \"conselheiro\"/\"inteiro\" (1ª estrofe) e em “olheiro\"/\n\"terreiro\" (2ª estrofe).",
      "em \"conselheiro”/“inteiro” (1ª estrofe) e em “vizinha\"/\n\"esquadrinha” (2ª estrofe).",
      "em \"desavergonhados”/“mercados\" (3ª/4ª estrofes) e em\n\"nobres\"/\"pobres\" (3ª/4ª estrofes)."
    ],
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Morfologia (Classes de Palavras)", "Estilística (Rima)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "os solstícios e os equinócios seriam consequência de\numa espécie de disputa entre o pai e a mãe da Terra.",
      "a Lua permaneceria imóvel no céu, quando vista da su-\nperfície da Terra.",
      "o dia e a noite seriam consequência de uma espécie de\ndisputa entre o pai e a mãe da Terra.",
      "as quatro estações seriam consequência de uma espécie\nde disputa entre o pai e a mãe da Terra.",
      "o Sol permaneceria imóvel no céu, quando visto da su-\nperfície da Terra."
    ],
    correctAnswer: 2,
    materia: ["Arte", "Geografia"],
    conteudo: ["Interpretação de Tirinhas", "Movimentos da Terra"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Moderna (Montaigne)", "Comportamento Humano"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "\"Sou um homem; não considero alheio a mim nada do\nque é humano.\" (Terêncio, 185-159 a.C.)",
      "\"Não se deve indagar sobre tudo: é melhor que muitas\ncoisas permaneçam ocultas.” (Sófocles, 486-406 a.C.)",
      "\"Nunca acontece algo que, por natureza, não sejamos\ncapazes de suportar.\" (Marco Aurélio, 121-180 d.C.)",
      "“O hábito é o melhor mestre em todas as coisas.” (Plínio,\n23-79 d.C.)",
      "“E amanhã não seremos o que fomos, nem o que somos.\"\n(Ovídio, 43 a.C.-18 d.C.)"
    ],
    correctAnswer: 4,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Moderna (Montaigne)", "Pensamento Filosófico"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "adulterar a própria história de vida.",
      "manipular a biografia de um homem.",
      "enaltecer a própria história de vida.",
      "depreciar a própria história de vida.",
      "subestimar a biografia de um homem."
    ],
    correctAnswer: 1,
    materia: ["Filosofia"],
    conteudo: ["Interpretação de Texto Filosófico", "Teoria do Conhecimento"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "sabedoria e contradição.",
      "sabedoria e intemperança.",
      "ignorância e temperança.",
      "ignorância e inconstância.",
      "vício e constância."
    ],
    correctAnswer: 3,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Moderna (Montaigne)", "Ética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Sintaxe", "Pontuação (Vírgula)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto", "Períodos Literários"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "there was a heatwave in Antarctica and temperature rose\nwell above average.",
      "the temperature in eastern Antarctica was 17.7 °C warmer\nthan usual.",
      "the South Pole reached the unusual temperature of 40 °C\nfor one day in some areas.",
      "both Vostok and Concordia stations experienced low\ntemperatures above zero.",
      "the minimum temperature reached -25 °C, as usual."
    ],
    correctAnswer: 0,
    materia: ["Inglês", "Geografia"],
    conteudo: ["Interpretação de Texto", "Climatologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Gráficos", "Relação Texto-Gráfico"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "is claimed to be a territory by countries such as Brazil,\nArgentina, Russia, United States and Australia.",
      "has a permanent native population as well as a population\nof thousands of scientists.",
      "is the native habitat of penguins, the only bird species in\nthe continent.",
      "is a continent that does not belong to any country and has\nno government.",
      "is also called the boreal hemisphere due to its location."
    ],
    correctAnswer: 3,
    materia: ["Inglês", "Geografia"],
    conteudo: ["Interpretação de Texto", "Geografia Polar", "Geopolítica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "subiram devido ao fim de verão.",
      "aumentaram acima da média.",
      "voltaram a ficar mais baixas.",
      "chegaram a -17,7 °C.",
      "retornaram à faixa de 4,5 °C."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto", "Vocabulário (Tradução Implícita)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a cycle of temperature peaks that happen every 65 years.",
      "the melting of the snow, which creates temporary rivers\nacross the continent.",
      "an unusually hot summer in Australia.",
      "the inflow of warm and damp winds coming from the\nocean.",
      "the abrupt weather changes in the Southern Ocean."
    ],
    correctAnswer: 3,
    materia: ["Inglês", "Geografia"],
    conteudo: ["Interpretação de Texto", "Meteorologia", "Clima"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Meio Ambiente", "Acordos Ambientais Internacionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "defines \"enjoyment of life\" as the most significant feeling\nthat contributes to happiness.",
      "is unreliable since it collected subjective data without\nscientifically established criteria.",
      "showed that Finland is a surprisingly happy country\nalthough its score is not so high.",
      "ranks countries based on global survey information on\nhow people appraise their lives according to some key\nvariables.",
      "identified a slight increase in happiness among the 150\ncountries surveyed."
    ],
    correctAnswer: 3,
    materia: ["Inglês", "Sociologia"],
    conteudo: ["Interpretação de Texto", "Indicadores de Qualidade de Vida"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de Texto", "Economia e Sociedade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "could not be a transitory state of mind.",
      "should be strongly sought.",
      "should not be compulsory.",
      "might be unbearable.",
      "comes and goes naturally in life."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      "a dimensão material dos sentimentos e das ações políti-\ncas dos homens, sustentada pela filosofia clássica.",
      "a centralidade do mito na sociedade antiga grega e o vín-\nculo desse mito com manifestações de caráter público.",
      "a fragilidade do politeísmo perante a lógica e a inca-\npacidade desse politeísmo de mobilizar politicamente a\nsociedade.",
      "as origens filosóficas da piedade e do sentimento de cul-\npa posteriormente apropriados pelo cristianismo.",
      "as matrizes religiosas da democracia grega e o reconhe-\ncimento por essa democracia da igualdade entre os ho-\nmens livres."
    ],
    correctAnswer: 1,
    materia: ["História", "Filosofia", "Arte"],
    conteudo: ["Grécia Antiga", "Filosofia Grega", "Cultura Grega"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "relacionadas prioritariamente à exploração científica dos\ncorpos humanos.",
      "diversificadas do ponto de vista das linguagens expressi-\nvas empregadas.",
      "circunscritas aos espaços de culto popular oriundos do\ncristianismo romano.",
      "caracterizadas pela repetição de conteúdos culturais\nimpostos pelo mecenato.",
      "limitadas às imitações rigorosas de padrões estéticos da\nAntiguidade clássica."
    ],
    correctAnswer: 1,
    materia: ["Arte", "História"],
    conteudo: ["Arte Medieval", "Idade Média"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "os sacrifícios humanos realizados por alguns povos nati-\nvos da América eram destituídos de significado religioso.",
      "a influência do catolicismo europeu na colonização da\nAmérica facilitou a preservação de elementos religiosos\nnativos.",
      "a carência da noção de mal nas culturas originárias da\nAmérica indica a ingenuidade e a pureza dos povos\nnativos.",
      "os povos nativos americanos tinham uma visão religiosa\nbinária e incompleta das forças que os afetavam.",
      "a presença de representações do diabo no imaginário\namericano derivou do processo colonizador."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["História da América Pré-Colombiana", "Colonização da América", "Sincretismo Religioso"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a funcionalidade dupla da peça, que podia ser utilizada\ncomo objeto de culto nas igrejas e como porta-moedas\nno cotidiano.",
      "a conjugação entre apuro artístico de inspiração barroca\ne estratégia para contrabando de riquezas.",
      "o emprego exclusivo de padrões artísticos renascentistas\nna produção das imagens religiosas brasileiras.",
      "a atitude herética dos artistas, que frequentemente con-\ntrariavam a proibição de representar figuras religiosas\nfemininas.",
      "a representação apenas de elementos da natureza na\ncomposição de peças de cunho religioso."
    ],
    correctAnswer: 1,
    materia: ["História", "Arte"],
    conteudo: ["Brasil Colônia (Ciclo do Ouro)", "Barroco Brasileiro"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "propõe conjugar a fé com a razão e aplica os princípios\nda escolástica à análise da condição dos escravos.",
      "confirma a predominância dos valores morais cristãos\ncomo baliza para a definição da política colonial.",
      "reproduz princípios do pensamento de Voltaire e sustenta\no valor universal da liberdade de natureza.",
      "estabelece uma diferenciação entre o respeito à liberda-\nde no território francês e nas possessões coloniais.",
      "endossa a crítica de Rousseau às desigualdades de ori-\ngem e defende a abolição da escravidão em todo o im-\npério francês."
    ],
    correctAnswer: 3,
    materia: ["História"],
...
createQuestion({
    ...
    options: [
      "o caráter processual da emancipação, que resultou de\ndiversas articulações e ações políticas.",
      "a negociação entre colônia e metrópole, que assegurou o\ncaráter pacífico da emancipação.",
      "o esforço do príncipe regente, que visava promover a\nconsolidação da emancipação política brasileira.",
      "o imediatismo do gesto ruptural, que provocou surpresa\nna população de toda a colônia.",
      "a percepção imediata da importância dos eventos ocor-\nridos às margens do riacho do Ipiranga, que mudaram\npoliticamente o país."
    ],
    correctAnswer: 0,
    materia: ["História"],
...
createQuestion({
    ...
    options: [
      "o esforço britânico de obter apoio político, por meio da\noferta de alimentos às populações africanas carentes.",
      "a exploração imperialista britânica, que retirava minérios\ne frutas tropicais das possessões coloniais na África e\nna Ásia.",
      "a ausência de recursos sanitários nas áreas mais afasta-\ndas do Império britânico, o qual promoveu ações de estí-\nmulo à higiene pessoal.",
      "o sentido religioso impresso na conquista britânica da\nÁfrica, gerado pela crença nativa de que os colonizado-\nres teriam origem divina.",
      "a dimensão mercantil da expansão imperialista britânica,\nque implicava a expansão do comércio com regiões da\nÁsia e da África."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Imperialismo", "Neocolonialismo na África e Ásia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o esforço nacional de construção de mercados regionais\ne a unificação, no plano internacional, do mercado global.",
      "a opção industrialista do regime varguista e a aceleração\nda demanda, no mercado internacional, de exportação\nde alimentos.",
      "o prevalecimento de ideologias de esquerda no cenário\nmundial e a guinada à direita, no plano interno, do regime\nditatorial.",
      "a vitória externa da defesa da democracia liberal e a per-\nsistência, no âmbito interno, de um regime ditatorial.",
      "a militarização dos Estados estrangeiros e a defesa\nintransigente, pelo governo varguista, de uma política\nexterna pacifista."
    ],
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Segunda Guerra Mundial", "Era Vargas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "dos Estados e das empresas transnacionais, organi-\nzações interessadas em acordos supranacionais pró-\n-economia.",
      "da publicidade e do marketing, estratégias corporativas\nque influenciam a nossa organização social.",
      "das instituições financeiras e das ONGs, agentes corpo-\nrativos pautados pela socialização de capitais.",
      "da didática e da neurociência, elementos empregados\npelas empresas para criação de novos produtos.",
      "da ciência e da tecnologia, campos de estudo dedicados\nà erradicação das diferenças socioeconômicas."
    ],
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Consumismo", "Globalização"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a libertação curda, região com fortes represálias econô-\nmicas e políticas.",
      "as alterações na fronteira da Romênia, país com objeti-\nvos expansionistas.",
      "a autonomia da Catalunha, região com grande desenvol-\nvimento econômico.",
      "a formação da Liga da Lombardia, região com movimen-\ntos separatistas.",
      "a dissolução da Iugoslávia, país com grande diversidade\nétnica e religiosa."
    ],
    correctAnswer: 4,
    materia: ["História", "Geografia"],
    conteudo: ["História Contemporânea (Guerras Iugoslavas)", "Geopolítica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "5 correspondem à concentração de indústrias.",
      "4 correspondem à prática de agropecuária extensiva.",
      "3 correspondem à prática de livre comércio.",
      "2 correspondem às transações de capital especulativo.",
      "1 correspondem aos acordos de caráter protecionista."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geografia Econômica", "Industrialização"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ao MERCOSUL, bloco econômico que integrou infraes-\ntruturas de transporte regionais.",
      "ao G8, bloco econômico que modernizou setores de ciên-\ncia, educação e inovação.",
      "ao USCMA, grupo que descentralizou a produção para\nganhar competitividade no mercado global.",
      "ao BRICS, grupo que articulou projetos em áreas de tec-\nnologia, saúde e energia.",
      "ao G20, coletivo que estabeleceu metas para o fortaleci-\nmento de seus setores agrícola e extrativista."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geopolítica", "Blocos Econômicos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o monitoramento das reservas extrativistas.",
      "a fiscalização dos territórios de povos isolados.",
      "a fiscalização da biopirataria florestal.",
      "a vigilância das áreas de conservação ambiental.",
      "a promoção de pesquisa científica."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geografia Humana", "Questões Socioambientais na Amazônia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a política econômica desenvolvimentista e a formação de\náreas de união aduaneira.",
      "a escalada de discursos nacionalistas e a ocupação de\náreas de fronteira.",
      "a independência em relação a Portugal e a proibição do\ntráfico de escravizados.",
      "a concessão de terras para projetos industriais e a incor-\nporação de mão de obra fabril qualificada.",
      "a superação da segregação racial e a melhora dos ele-\nmentos que compõem o IDH."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Brasil Império", "Imigração no Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a forte nebulosidade, resultado do encontro de massas\nde ar quentes e úmidas da Amazônia e do Atlântico Sul.",
      "a baixa umidade, resultado de movimentos verticais des-\ncendentes de ar frio no centro de um cavado.",
      "a formação dos anticiclones, resultado da interação entre\nos ventos alíseos de nordeste e uma frente polar.",
      "a formação de frente fria, resultado do avanço de uma\nmassa de ar frio sob uma massa de ar quente.",
      "a formação dos ciclones tropicais, resultado dos movi-\nmentos turbilhonares do ar ao redor de um centro de bai-\nxa pressão."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Climatologia", "Sistemas Atmosféricos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a construção de terraços, pois permite aplainar superfí-\ncies inclinadas.",
      "a correção da acidez do solo, pois mantém a vegetação\nperene.",
      "a obstrução da laterização, pois promove intensa lixiviação.",
      "a recuperação de áreas degradadas, pois diminui os\nprocessos erosivos.",
      "a interrupção da ação de microrganismos, pois o material\nutilizado é biodegradável."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geomorfologia", "Meio Ambiente (Degradação e Recuperação de Solos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "à incorporação da água de afluentes.",
      "ao assoreamento dos rios.",
      "à transposição de rios.",
      "aos reservatórios das usinas hidrelétricas."
    ],
    correctAnswer: 4,
    materia: ["Geografia", "Química"],
    conteudo: ["Impactos Ambientais", "Gases de Efeito Estufa"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Meio Ambiente", "Ecologia (Desenvolvimento Sustentável)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a indiferença dos habitantes à toponímia dos rios que\nmarcaram a construção da cidade.",
      "o modelo de urbanização que segregou a população dos\nrios que a cercam.",
      "o desconhecimento da população sobre as áreas de risco\nna cidade que habita.",
      "a dificuldade de se delimitar uma bacia hidrográfica\nperante o crescimento urbano.",
      "a irrelevância dos recursos hídricos na regulação do cli-\nma urbano."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geografia Urbana", "Hidrografia Urbana"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "do sistema de informações geográficas, que permite\nequilibrar as ações motivadoras da relação sociedade-\n-natureza.",
      "da realidade aumentada, que explora uma rede de sa-\ntélites para monitorar hotspots de interesse estratégico.",
      "do sistema de posicionamento global, que oferece dados\ndinâmicos sobre as transformações da cobertura vegetal.",
      "da cartografia digital, que amplia as possibilidades de\nprodução e de uso das informações geográficas.",
      "do sensoriamento remoto, que propõe planos de manejo\nadaptados às realidades de cada porção territorial."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geotecnologias", "Cartografia Digital"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Filosofia"],
    conteudo: ["Teoria do Conhecimento", "Natureza da Filosofia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Moderna (Descartes)", "Ética e Meio Ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia"],
    conteudo: ["Filosofia Política (Contratualismo)", "Hobbes"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Filosofia", "Sociologia"],
    conteudo: ["Ética", "Desigualdade Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "ao estabelecimento de uma ética pluralista.",
      "à recusa de instituições políticas.",
      "ao reconhecimento de um eurocentrismo epistêmico.",
      "à negação de hierarquias sociais.",
      "à reconstrução de discursos representativos."
    ],
    correctAnswer: 4,
    materia: ["Sociologia", "Filosofia"],
    conteudo: ["Teoria Social Contemporânea", "Feminismo", "Epistemologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "comunidade e competição interespecífica.",
      "potencial biótico e resistência do meio.",
      "adaptação e princípio do fundador.",
      "sucessão ecológica primária e sucessão ecológica\nsecundária."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Evolução Biológica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Biotecnologia (Produção de Vacinas)", "Embriologia Animal"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Rogério, Marcelo e Fábio.",
      "Fábio, Rogério e Marcelo.",
      "Fábio, Marcelo e Rogério.",
      "Marcelo, Rogério e Fábio.",
      "Marcelo, Fábio e Rogério."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Humana (Sistema Sanguíneo)", "Doenças (Leucemia)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Micologia", "Nutrição dos Seres Vivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Físico-Química (Solubilidade)", "Reações Químicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Termodinâmica (Gases Ideais)", "Leis dos Gases"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Estequiometria", "Química Ambiental (Tratamento de Água)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica (Potência)", "Termodinâmica (Energia)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Físico-Química (Equilíbrio Ácido-Base)", "pH"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Inorgânica (Número de Oxidação)", "Reações de Oxirredução"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Orgânica (Polímeros)", "Funções Orgânicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "para uma mesma temperatura, a diferença de potencial\nlida pelo voltímetro é menor para o termopar do tipo E do\nque para o termopar do tipo K.",
      "o termopar do tipo E apresenta uma sensibilidade me-\nnor do que o termopar do tipo K para qualquer faixa de\ntemperatura.",
      "para uma mesma diferença de potencial lida pelo voltíme-\ntro, o termopar do tipo N indica uma temperatura maior\ndo que o termopar do tipo E.",
      "na faixa de 600 °C a 1200 °C, a sensibilidade do termo-\npar do tipo K é maior do que a sensibilidade do termopar\ndo tipo N.",
      "dos três tipos de termopares, o do tipo N é o que apre-\nsenta maior sensibilidade."
    ],
    correctAnswer: 2,
    materia: ["Física", "Matemática"],
    conteudo: ["Termologia (Termometria)", "Eletricidade (Circuitos Elétricos)", "Análise de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Cinemática (Movimento Relativo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Mecânica (Conservação do Momento Linear)", "Colisões Inelásticas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física", "Matemática"],
    conteudo: ["Mecânica (Energia Cinética)", "Análise de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Óptica (Refração)", "Química Orgânica (Funções Orgânicas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Ondulatória (Ondas em Cordas)", "Acústica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica (Circuitos Elétricos)", "Leis de Ohm"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Funções", "Análise de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Proporção"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Porcentagem", "Interpretação de Dados"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Cinemática (Movimento Uniformemente Variado)", "Aceleração Escalar"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "nas propriedades 1 e 4, apenas.",
      "nas propriedades 3 e 4, apenas.",
      "na propriedade 4, apenas.",
      "na propriedade 1, apenas.",
      "na propriedade 3, apenas."
    ],
    correctAnswer: 2,
    materia: ["Química", "Física"],
    conteudo: ["Propriedades dos Materiais", "Gráficos e Diagramas"],
    imageNames: []
}),
