createQuestion({
    ...
    conteudo: ["Estrangeirismos e Formação de Palavras"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Semântica e Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto e Gêneros Textuais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de Texto e Variação Linguística"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Sociologia"],
    conteudo: ["Desigualdades Sociais e Meritocracia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira (Érico Veríssimo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira (Jorge de Lima)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Portuguesa (Classicismo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Formação de Palavras e Literatura"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira (Teatro)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Progressões Geométricas ou Juros Compostos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Texto e Vocabulário"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Interpretação de Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Compreensão de Texto", "Escravidão"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de Texto", "Ética e Mídias Digitais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "branqueamento das esponjas calcáreas pela exalação de suas algas simbiontes; acidificação marinha em virtude da elevação do nível do mar; e menor taxa fotossintética pelo aumento do CO2 nos oceanos.",
      "bloqueio das conchas dos cnidários pela expulsão de suas algas parasíticas; acidificação marinha em virtude dos maiores níveis de CO2 no ar; e maior incidência de luz solar por causa do degelo das calotas polares.",
      "branqueamento dos pólipos de cnidários pela expulsão de suas algas simbiontes; acidificação marinha em virtude dos maiores níveis de CO2 no ar; e menor taxa fotossintética em razão dos níveis oceânicos elevados.",
      "bloqueio das esponjas calcáreas pela aquisição de algas comensalistas; acidificação marinha em virtude dos maiores níveis de CO2 no ar; e maior incidência de luz solar por causa do degelo das calotas polares."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Ecologia e Impactos Ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Estática", "Geometria Plana"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Cinemática", "Astronomia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Eletricidade", "Termodinâmica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O movimento iluminista defendia a liberdade e a igualdade de todos os indivíduos perante a lei, e foi responsável pela elaboração da Declaração dos Direitos do Homem e do Cidadão, que legitimou o Antigo Regime.",
      "A Revolução Francesa favoreceu cientistas e intelectuais franceses independentemente de suas posições ideológicas e das questões de gênero. É o caso de Marie Lavoisier e de Antoine Lavoisier, este último famoso pela frase \"na natureza nada se cria, nada se perde, tudo se transforma\", conhecida como a lei de conservação das massas.",
      "No século XVIII, as mulheres participavam da produção do conhecimento científico. Marie Lavoisier registrou e publicou muitos dos experimentos feitos pela equipe de seu marido, Antoine Lavoisier, famoso pela frase \"na natureza nada se cria, nada se perde, tudo se transforma\", conhecida como a lei de conservação das massas.",
      "A Revolução Francesa garantiu às mulheres a cidadania e a participação na produção do conhecimento científico. Marie Lavoisier registrou e publicou muitos dos experimentos feitos pela equipe de seu marido, Antoine Lavoisier, famoso pela frase \"na natureza nada se cria, nada se perde, tudo se transforma\", conhecida como a lei de conservação da quantidade de matéria."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Iluminismo e Revolução Francesa"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História dos Direitos e Movimentos Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Movimentos Sociais no Século XX"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Brasil República (Governo JK)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A fotografia registra o ato de resistência de atletas negros que defendiam as propostas de Martin Luther King e a ação pacifista como caminho para a constituição da igualdade racial.",
      "A fotografia registra a manifestação política de três atletas que defendiam a Nação Islã e a implementação da Ku Klux Klan em todo o território nacional.",
      ...
      "A fotografia registra a resistência de atletas e do Comitê Olímpico Internacional, que combatiam o sistema de discriminação racial existente nos Estados Unidos da América."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Movimentos Sociais e Direitos Civis"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Ditaduras Latino-Americanas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "No século XVIII, Marie Lavoisier, como outras mulheres, não participava da produção do conhecimento científico. Por outro lado, seu marido, Antoine Lavoisier, ficou famoso pela frase \"na natureza nada se cria, nada se perde, tudo se transforma\", conhecida como a lei de conservação da quantidade de matéria.",
      "A Revolução Francesa favoreceu cientistas e intelectuais franceses independentemente de suas posições ideológicas e das questões de gênero. É o caso de Marie Lavoisier e de Antoine Lavoisier, este último famoso pela frase \"na natureza nada se cria, nada se perde, tudo se transforma\", conhecida como a lei de conservação das massas.",
      "No século XVIII, as mulheres participavam da produção do conhecimento científico. Marie Lavoisier registrou e publicou muitos dos experimentos feitos pela equipe de seu marido, Antoine Lavoisier, famoso pela frase \"na natureza nada se cria, nada se perde, tudo se transforma\", conhecida como a lei de conservação das massas.",
      "A Revolução Francesa garantiu às mulheres a cidadania e a participação na produção do conhecimento científico. Marie Lavoisier registrou e publicou muitos dos experimentos feitos pela equipe de seu marido, Antoine Lavoisier, famoso pela frase \"na natureza nada se cria, nada se perde, tudo se transforma\", conhecida como a lei de conservação da quantidade de matéria."
    ],
    ...
    conteudo: ["História da Química", "História da Ciência"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A independência do Haiti foi decisiva para que o Império Brasileiro, que projetava a construção de um Estado Nação reconhecido internacionalmente, reprimisse movimentos como a Revolta Malês, em Salvador (1835).",
      "A declaração do Pastor é pautada em preconceitos em relação às práticas religiosas dos afrodescendentes no Haiti. A conquista espiritual, parte dos projetos imperialistas, garantiu a eliminação de religiões consideradas pagās nas Américas.",
      "Colônia francesa nas Antilhas, Saint Domingue tornou-se responsável por 40% da produção mundial de cacau no século XVIII. A mão de obra empregada era majoritariamente escrava, com a exploração de africanos ou de seus descendentes.",
      "O processo de independência do Haiti foi apoiado por outras colônias, interrompendo o projeto imperialista europeu no Novo Mundo. Após 1804, os EUA conduzem as ações imperialistas na América, tornando-se a principal referência cultural no continente."
    ],
    correctAnswer: 0,
    materia: ["História", "Sociologia"],
    conteudo: ["História do Haiti", "Religião e Preconceito"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "duas transformações químicas, uma transformação física e não mais que três tipos de energia.",
      "uma transformação química, uma transformação física e não mais que dois tipos de energia.",
      "duas transformações químicas, duas transformações físicas e pelo menos dois tipos de energia.",
      "uma transformação química, duas transformações físicas e pelo menos três tipos de energia."
    ],
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Geração de Energia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Termodinâmica", "Mudanças de Estado"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Fe2O3 + 2AI → 2Fe + Al2O3; ΔH = + 852 kJ·mol⁻¹.",
      "FeO3 + Al → Fe + AlO3; ΔH = – 852 kJ·mol⁻¹.",
      "FeO3 + Al → Fe + AlO3; ΔH = + 852 kJ·mol⁻¹.",
      "Fe2O3 + 2AI → 2Fe + Al2O3; ΔH = – 852 kJ·mol⁻¹."
    ],
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Reações Químicas", "Termoquímica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Eletroquímica", "Reações de Oxirredução"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "uma diminuição do pH, e o sulfato de cobre(II), por sua vez, um aumento do pH da água devido à reação SO4²⁻ + H2O →HSO4⁻ + OH⁻.",
      "um aumento do pH, e o sulfato de cobre(II), por sua vez, uma diminuição do pH da água devido à reação Cu²⁺ + H2O → Cu(OH)⁺ + H⁺.",
      "uma diminuição do pH, e o sulfato de cobre(II), por sua vez, um aumento do pH da água devido à reação Cu²⁺ + H2O → Cu(OH)⁺ + H⁺.",
      "um aumento do pH, e o sulfato de cobre(II), por sua vez, uma diminuição do pH da água devido à reação SO4²⁻ + H2O → HSO4⁻ + OH⁻."
    ],
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Ácidos e Bases"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia Física (Relevo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o pedido da Irlanda do Norte por um novo referendo para decidir sua permanência no Reino Unido e a continuidade da livre circulação da moeda europeia, o euro, no Reino Unido.",
      "o pedido da Inglaterra por um novo referendo para decidir sua permanência no Reino Unido e a continuidade da livre circulação da moeda europeia, o euro, no Reino Unido.",
      "o pedido da Escócia por um novo referendo para decidir sua permanência no Reino Unido e o comprometimento da livre circulação de cidadãos europeus no Reino Unido.",
      "o pedido do País de Gales por um novo referendo para decidir sua permanência no Reino Unido e o comprometimento da livre circulação de cidadãos europeus no Reino Unido."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "são medidas deliberativas e os países signatários pagarão multas pelo descumprimento das metas; os EUA não aceitam o papel da ONU na função de agente fiscalizador.",
      "são medidas propositivas e os países signatários deverão definir metas para os próximos anos; os EUA não concordam com o controle externo sobre suas fontes poluidoras.",
      "são medidas restritivas e os países signatários sofrerão punições políticas e econômicas se não atingirem as metas; os EUA não aprovam a presença da Rússia no acordo.",
      "são medidas normativas e os países signatários deverão definir as estratégias a serem adotadas; os EUA não aceitam assumir as mesmas responsabilidades da Índia, o maior poluidor do planeta."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Questões Ambientais Globais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "ascensão do regime de acumulação flexível; liberalização econômica e concorrência com capitais asiáticos; deslocamento de indústrias para outros países."
    ],
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia Urbana", "Indústria e Economia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Relevo de Mares de Morro; solos de tipo latossolos; grande concentração da população ao longo dos cursos d'água da região.",
      "Relevo de Altiplanos Basálticos; solos de tipo podzólicos; grande dispersão da população pelos diversos ecossistemas regionais.",
      "Relevo Residual de Colinas com afloramento rochoso; solos de tipo litólicos; grande dispersão da população pelo espaço regional.",
      "Relevo de Terras Baixas; solos de tipo gleissolos; grande concentração da população nas áreas inundáveis sazonalmente."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Domínios Morfoclimáticos Brasileiros"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Está em curso a formação de uma cidade-região no Estado, impulsionando profundas transformações na rede urbana, o que justificou a criação das onze RMs para viabilizar o planejamento e a gestão territorial.",
      "O real processo de metropolização em Santa Catarina, dinamizado nas últimas décadas, não abrange a totalidade do Estado, permitindo concluir que a criação das onze RMs obedeceu a critérios mais políticos do que técnicos.",
      "O adensamento populacional, com a formação de grandes cidades conurbadas em todas as regiões do Estado, levou ao diagnóstico de que há um processo generalizado de metropolização e justificou a criação das onze RMs.",
      "Em função de intensa urbanização regional foi criada a RM de Florianópolis nos anos 1970; já as demais RMs somente se justificaram a partir das mudanças demográficas e econômicas da década passada."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "subtropical, onde as temperaturas mais altas estão concentradas no verão e as precipitações estão concentradas no outono.",
      "polar, onde as temperaturas mais baixas estão concentradas no inverno e as precipitações estão bem distribuídas ao longo do ano.",
      "tropical, onde as altas temperaturas estão bem distribuídas ao longo de todo o ano e as precipitações estão concentradas no verão.",
      "temperada, onde as temperaturas médias mantêm-se ao longo de todo o ano e as precipitações estão concentradas no inverno."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "O uso de agrotóxicos e sementes transgênicas associa-se à busca de maior produtividade, sobretudo em áreas de fronteira agrícola.",
      "As sementes transgênicas e o uso de agrotóxicos adequados ampliaram o interesse de países da União Europeia pelos produtos agrícolas brasileiros.",
      "O uso de agrotóxicos no Brasil reduziu a necessidade de aproveitamento das sementes transgênicas nos cultivos agrícolas de grãos no país.",
      "Por ser signatário de acordos internacionais, o Brasil reduziu o uso de agrotóxicos e sementes transgênicas em áreas próximas a mananciais."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Agricultura e Meio Ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Terrorismo e Criminalidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "as latitudes 24º e 25° Sul.",
      "as latitudes 21º e 22° Sul.",
      "as longitudes 46º e 48° Oeste.",
      "as longitudes 50° e 52° Oeste."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Indústria e Meio Ambiente"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "a curva A, sendo que o eixo horizontal representa a temperatura externa e o eixo vertical, o consumo de O2.",
      "a curva A, sendo que o eixo horizontal representa a temperatura interna e o eixo vertical, o consumo de O2.",
      "a curva B, sendo que o eixo horizontal representa a temperatura externa e o eixo vertical, a liberação de CO2.",
      "a curva B, sendo que o eixo horizontal representa a temperatura interna e o eixo vertical, a liberação de CO2."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
...
createQuestion({
    ...
    options: [
      "hábitos aquáticos, que os tornam suscetíveis a predadores.",
      "pulmões bem desenvolvidos, que acumulam impurezas e fungos.",
      "sangue frio, que diminui a atividade de enzimas hepáticas.",
      "pele úmida e permeável, que possibilita a respiração cutânea."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Zoologia (Anfíbios)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "microrganismos (bactérias ou vírus), que passaram dos macacos para o ser humano há muitos anos, levando ao surgimento de epidemias e pandemias.",
      "bactérias, que podem se tornar resistentes a antibióticos, se utilizados em excesso ou de forma inapropriada, dificultando o tratamento.",
      "bactérias, que podem ser tratadas e eliminadas pelo uso diligente de preservativos (masculinos ou femininos) durante as relações sexuais.",
      "protozoários, que podem ser tratados e eliminados pelo uso diligente de preservativos (masculinos ou femininos) durante as relações sexuais."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Saúde Humana (Doenças Sexualmente Transmissíveis)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "simetria bilateral, com eixo ântero-posterior bem definido, características não encontradas em cnidários, poríferos e equinodermos.",
      "simetria radial, com eixo dorsoventral bem definido, características não encontradas em cnidários, moluscos e equinodermos.",
      "simetria dorsoventral, com eixo ântero-posterior bem definido, características não encontradas em cordados, poríferos e cnidários.",
      "simetria pentarradial, com eixo dorsoventral bem definido, características não encontradas em cnidários, cordados e equinodermos."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Biologia Evolutiva"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "o canal do Panamá permitiu que camarões-pistola migrassem de A para B, adaptando-se ao novo ambiente, diferenciando-se e originando novas espécies semelhantes às do lado A.",
      "vulcões expeliram substâncias mutagênicas durante o Terciário, o que aumentou a variabilidade genética dos camarão-pistola, originando espécies-irmãs nas áreas oceânicas A e B.",
      "o istmo do Panamá interpôs uma barreira geográfica, formando dois grupos isolados para cada espécie ancestral, que puderam então se diferenciar, originando espécies-irmãs nos oceanos A e B.",
      "o impacto de um asteroide no final do Cretáceo levou a uma extinção em massa, fornecendo as condições para a radiação adaptativa dos camarões-pistola, com consequente formação de espécies-irmãs."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Evolução e Biogeografia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Metais pesados, como o urânio, são encontrados em maiores concentrações em herbívoros longevos ou do meio da teia alimentar, como tartarugas marinhas e peixes de fundo de rio.",
      "Metais pesados, como o mercúrio, são encontrados em maiores concentrações em carnívoros do meio da teia alimentar, como aves de rapina e peixes predatórios.",
      "Metais pesados, como o ferro, são encontrados em maiores concentrações em herbívoros e carnívoros do topo da teia alimentar, como aves de rapina e peixes predatórios.",
      "Metais pesados, como o chumbo, são encontrados em maiores concentrações em predadores longevos ou do topo da teia alimentar, como aves de rapina e peixes predatórios."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Ecologia (Cadeias Alimentares e Poluição)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "respiram e fotossintetizam apenas durante o período diurno.",
      "respiram e fotossintetizam apenas durante o período noturno.",
      "respiram o dia todo e fotossintetizam apenas durante o período diurno.",
