createQuestion({
    ...
    options: [
      "pelo livre-arbítrio dos indivíduos.",
      "pelos sentimentos próprios dos indivíduos e independem do meio social.",
      "pelo direito e pelos costumes, que são, por sua vez, definidos livremente pelos indivíduos.",
      "pela própria sociedade, que constitui uma realidade objetiva que exerce coerção sobre o indivíduo."
    ],
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Fatos sociais e Durkheim"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "Texto 1\nENQUANTO HOUVER RACISMO NÃO HAVERÁ DEMOCRACIA\nManifesto de lançamento da \"Coalizão Negra Por Direitos”, reunião de entidades e coletivos do movimento negro brasileiro, 2020.\nTexto 2\nO sociólogo Octavio Ianni afirmou que democracia e cidadania são processos políticos marcados por dificuldades e retrocessos, pois a participação social - especialmente a de grupos como mulheres, negros, indígenas é uma luta penosa e que, no Brasil, vem sendo realizada precariamente ao longo da história. (Adaptado de: \"Entrevista com Octavio Ianni: Comunicação e Globalização\". Revista Novos Olhares, n. 4, p. 25, 1999.)\nDe acordo com os textos 1 e 2, é possível dizer que, no caso brasileiro, os conceitos de democracia e de cidadania",
      subItens: []
    },
    options: [
      "são limitados pela persistência histórica do racismo, pois os movimentos sociais pouco se ocupam dessa temática, reduzindo a possibilidade da conquista de igualdade.",
      "podem ser tomados como conceitos relacionados, relativos à esfera do indivíduo, e marcados por processos lineares de conquistas de direitos sociais.",
      "podem ser tomados como conceitos relacionados, próprios da esfera coletiva, e marcados por processos não lineares de conquistas e perdas de direitos sociais.",
      "são marcados por disputas sociais e históricas, e influenciam, de modo secundário, o exercício da igualdade, especialmente para grupos como mulheres, negros e indígenas."
    ],
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Democracia, cidadania e racismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "divisões sociais de classe, gênero e raça permitem que todas as pessoas tenham acesso às mesmas oportunidades e possam igualmente desenvolver suas habilidades e aptidões.",
      "condições de competição individual são marcadas por divisões de classe, gênero e raça, e são influenciadas pelo contexto social, político e econômico.",
      "o mérito e o esforço individual podem ser isolados das divisões de classe, gênero e raça e considerados como parâmetros justos para a dinâmica da vida social.",
      "divisões de classe, gênero e raça estão presentes na vida em sociedade e têm relação marginal com o fenômeno da desigualdade."
    ],
    correctAnswer: 1,
    materia: ["Sociologia"],
    conteudo: ["Desigualdades sociais e interseccionalidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Filosofia"],
    conteudo: ["Ética grega (Aristóteles e Epicuro)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A realização da liberdade e da igualdade independe da supressão de desigualdades profundas.",
      "A articulação entre liberdade e igualdade é um ideal que não contrasta com regimes políticos antidemocráticos.",
      "A articulação entre liberdade e igualdade é complexa porque exige tanto a supressão de desigualdades extremas quanto a possibilidade da afirmação das diferenças individuais.",
      "O desenvolvimento pleno do capitalismo e da livre concorrência são condições suficientes para a concretização da liberdade e da igualdade."
    ],
    correctAnswer: 2,
    materia: ["Filosofia", "Sociologia"],
    conteudo: ["Teoria política (Liberdade e Igualdade)", "Desigualdades sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria plana (Área do círculo)", "Proporcionalidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria plana (Condição de existência de triângulo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Inequações", "Conjuntos numéricos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Funções", "Progressão aritmética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria plana (Área de trapézio e triângulo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Funções (Função composta)", "Geometria analítica (Ponto médio)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria plana (Propriedades de losango)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O texto 2 apresenta uma consequência social advinda do fato de que o \"sonho” mencionado no texto 1 tornou-se realidade.",
      "Os textos 1 e 2 são complementares porque usam diferentes linguagens para ilustrar a natureza velada do racismo.",
      "O texto 2 funciona como um indício de que aquilo que se almejava em 1 ainda não se tornou realidade em todos os contextos.",
      "Os textos 1 e 2 são contraditórios porque empregam diferentes recursos de linguagem para tratar do racismo."
    ],
    correctAnswer: 2,
    materia: ["Inglês", "Sociologia"],
    conteudo: ["Interpretação de texto", "Racismo e movimentos sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Inglês", "Arte"],
    conteudo: ["Interpretação de texto", "Arte indígena"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Alternativas economicamente viáveis dentro da agricultura tradicional.",
      "Desafios éticos e ambientais da pecuária.",
      "Sustentabilidade na pesquisa de novos protocolos para agricultura tradicional.",
      "Agricultura celular de diversas fontes de proteína."
    ],
    correctAnswer: 3,
    materia: ["Inglês", "Biologia"],
    conteudo: ["Interpretação de texto", "Biotecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "pelo uso de linguagem agressiva, pois se apoia em expressões violentas para tentar extorquir o usuário.",
      "por reproduzir a sintaxe da comunicação humana à medida que recorre ao humor para acusar o usuário.",
      "pelo emprego de um tom sarcástico, pois se apoia em linguagem informal para ameaçar o usuário.",
      "por infringir questões éticas, uma vez que informa ter tornado públicas informações privadas do usuário."
    ],
    correctAnswer: 2,
    materia: ["Inglês"],
    conteudo: ["Análise de linguagem e tom"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "paralelos entre ficção e realidade para discutir como a existência de grupos marginalizados tem sido historicamente apagada dos livros de história.",
      "elementos fictícios presentes na série para aludir ao modo como a desumanização da alteridade é um processo histórico e violento.",
      "fatos históricos para traçar a origem da exploração de povos indígenas e o modo como foram violentamente desumanizados na série.",
      "comparações históricas sobre os conflitos entre colonizadores e peregrinos para criticar o modo como esse conflito é retratado na série."
    ],
    correctAnswer: 1,
    materia: ["Inglês", "Sociologia"],
    conteudo: ["Interpretação de texto", "Exclusão social e representação"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "na coragem do roteiro em dar destaque à polêmica de experimentação em animais para testes.",
      "no ineditismo da abordagem do tema em produções de grande alcance, como os filmes da Marvel.",
      "no retrato das emoções de animais usados em experimentos em laboratórios.",
      "no impacto da abordagem do tema para órgãos de grande repercussão, como a PETA."
    ],
    correctAnswer: 0,
    materia: ["Inglês", "Arte"],
    conteudo: ["Interpretação de texto", "Cinema e crítica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Cinemática (Movimento uniformemente variado)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Trabalho e energia (Teorema da Energia Cinética)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Dinâmica (Forças e velocidade terminal)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Mecânica (Lei de Hooke)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A pele é seca e completamente impermeável, recoberta por uma espessa camada, em forma de espículas, composta da proteína quitina.",
      "Os alvéolos com grande superfície de troca gasosa permitem a respiração pulmonar e cutânea mesmo nas espécies aquáticas.",
      "A principal excreta nitrogenada liberada é a ureia, que se caracteriza por ser pouco tóxica e que requer mínima quantidade de água para ser eliminada.",
      "A fecundação é interna e há formação de ovo amniótico; esse ovo possui uma bolsa contendo líquido que envolve o embrião."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Zoologia (Répteis)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "no humano e no lagarto são consideradas análogas; trata-se de um caso de evolução convergente.",
      "na baleia e no pássaro são consideradas homólogas; trata-se de um caso de evolução divergente.",
      "no lagarto e no pássaro são consideradas homólogas; trata-se de um caso de evolução convergente.",
      "no humano e na baleia são consideradas análogas; trata-se de um caso de evolução divergente."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Evolução (Homologia e Analogia)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "(i) próstata; (ii) maturação dos ossos; (iii) do colesterol; (iv) fígado.",
      "(i) vesícula seminal; (ii) maturação dos ossos; (iii) da creatina; (iv) fígado.",
      "(i) próstata; (ii) produção de esperma; (iii) da creatina; (iv) pâncreas.",
      "(i) vesícula seminal; (ii) produção de esperma; (iii) do colesterol; (iv) pâncreas."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Fisiologia humana (Sistema endócrino e reprodutor)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Heterofagia por pinocitose, o que permite à célula degradar fragmentos de microrganismos, fragmentos esses importantes na apresentação de antígenos.",
      "Autofagia, que permite à célula empacotar, modificar e exportar proteínas sintetizadas no lúmen das cisternas do retículo endoplasmático.",
      "Autofagia, que permite à célula eliminar porções envelhecidas ou danificadas do citoplasma, incluindo organelas e moléculas.",
      "Heterofagia por fagocitose, o que permite à célula capturar macromoléculas, utilizando-as nas diferentes vias biossintéticas."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Biologia celular (Lisossomos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Genética", "Reprodução (Haplodiploidia)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "competem por recursos e apresentam diferenças na eficiência de utilização do alimento disponível.",
      "ocupam nichos ecológicos distintos e têm crescimento populacional até o limite imposto pela resistência ambiental.",
      "são generalistas e assim têm nichos ecológicos mais restritos, o que diminui a competição entre elas.",
      "apresentam uma relação de cooperação, facilitando o crescimento populacional na ausência da resistência ambiental."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Ecologia (Dinâmica de populações, Nicho ecológico)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Figura A, floema e endoderme.",
      "Figura B, floema e periciclo.",
      "Figura A, xilema e endoderme.",
      "Figura B, xilema e periciclo."
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Botânica (Histologia vegetal)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "foi sempre superior à recomendada pela OMS, o que pode indicar uma baixa conscientização da população sobre o consumo de açúcar.",
      "foi sempre inferior à recomendada pela OMS, o que pode indicar uma alta conscientização da população sobre o consumo de açúcar.",
      "foi superior; porém, mais recentemente, tornou-se inferior à recomendada pela OMS, o que pode indicar uma melhora na conscientização da população sobre o consumo de açúcar.",
      "foi inferior; porém, mais recentemente, tornou-se superior à recomendada pela OMS, o que pode indicar uma piora na conscientização da população sobre o consumo de açúcar."
    ],
    correctAnswer: 2,
    materia: ["Biologia", "Matemática"],
    conteudo: ["Alimentação e saúde", "Análise de gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Metabolismo", "Alimentação e saúde"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "pequena e seu pKa deve estar abaixo da faixa de pH do refrigerante.",
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Ácidos e bases", "Equilíbrio químico"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "descarte adequado; reciclagem; prevenção.",
      "prevenção; descarte adequado; reciclagem.",
      "descarte adequado; prevenção; reciclagem.",
      "prevenção; reciclagem; descarte adequado."
    ],
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Química ambiental (Gestão de resíduos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "16% e que 1 kg do sólido é capaz de absorver até 110 g de gás carbônico.",
      "32% e que 1 kg do sólido é capaz de absorver até 110 g de gás carbônico.",
      "16% e que 1 kg do sólido é capaz de absorver até 220 g de gás carbônico.",
      "32% e que 1 kg do sólido é capaz de absorver até 220 g de gás carbônico."
    ],
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Estequiometria", "Química inorgânica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "de combustão interna uma bateria com as características da curva X e da curva l; para o carro elétrico, qualquer combinação serviria.",
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica (Baterias)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[Graphs showing: (i) E. coli - combined curcumin reduces survival significantly, free curcumin less so; (ii) S. aureus - combined curcumin reduces survival significantly, free curcumin less so.]",
      "[Graphs showing: (i) E. coli - free curcumin reduces survival significantly, combined curcumin less so; (ii) S. aureus - combined curcumin reduces survival significantly, free curcumin less so.]",
      "[Graphs showing: (i) E. coli - combined curcumin reduces survival significantly, free curcumin less so; (ii) S. aureus - free curcumin reduces survival significantly, combined curcumin less so.]",
      "[Graphs showing: (i) E. coli - both curcumins reduce survival similarly; (ii) S. aureus - both curcumins reduce survival similarly.]"
    ],
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Microbiologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Geraizeiros da região da Amazônia Ocidental se beneficiam dos rios para a pesca e praticam o extrativismo de frutos utilizados na culinária regional e transformados em produtos alimentícios.",
      "Caiçaras da região litorânea do Ceará praticam a pesca artesanal, utilizam as riquezas naturais da Mata Atlântica para o extrativismo de frutos e fazem uso dos roçados para atividades agrícolas de subsistência.",
      "Faxinalenses do norte de Minas Gerais usufruem dos campos para o desenvolvimento do extrativismo vegetal da erva mate e do pinhão, do cultivo agrícola em pequena escala e da criação de animais soltos."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Populações tradicionais do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Os campos de dunas associam-se aos depósitos argilosos e arenosos, fixados por vegetação pioneira.",
      "As falésias ativas evoluem de processos continentais e marinhos, com ausência de vegetação na sua base.",
      "Os deltas são formados por sedimentos fluviais e cobertos por espécies arbóreas de grande porte."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geomorfologia costeira do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Geografia urbana (Problemas urbanos, segregação)", "Questão social"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Nigéria e EUA têm trajetórias demográficas distintas, ainda que ambos apresentem taxas de natalidade semelhantes. Isso afetará seus sistemas de saúde.",
      "Os EUA, ao contrário da Nigéria, apresentam, pela primeira vez, crescimento vegetativo negativo. Isso afetará a oferta de mão-de-obra no território norte-americano.",
      "A Nigéria, ao contrário dos EUA, manterá elevada a taxa de fecundidade. Haverá maior pressão sobre as políticas públicas de educação e de saúde.",
      "Nigéria e EUA enfrentam expressiva redução da população em idade adulta ativa. Ambos os países terão problemas com a seguridade social."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Demografia"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Globalização", "Regionalização"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Euroasiática e Arábica; o sentido de deslocamento das placas forma falhas transcorrentes.",
      "Indiana e Africana; o sentido de deslocamento forma falhas normais.",
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geologia (Tectônica de placas, Terremotos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Os símbolos pontuais se prestam a representar fenômenos não hierárquicos, a exemplo da rede urbana e da tipologia de cidades.",
      "As representações lineares qualificam os fenômenos, não permitindo a sua hierarquização, a exemplo da tipologia dos sistemas de transportes.",
      "O uso do gradiente de cores serve para diferenciar fenômenos espaciais com variação contínua, a exemplo da altitude e da profundidade.",
      "Um mesmo fenômeno pode ser representado por meio de diferentes formas e de variadas cores, a exemplo dos cursos e corpos de água."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Coesão textual (Referência)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Tecnologia e sociedade (Algoritmos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2024,
    text: {
      principal: "O anúncio (Texto 1) reproduzido a seguir foi postado nas redes sociais da Portela, escola de samba carioca, para divulgar uma festa literária. A escola, que traz a águia como símbolo em todos os seus desfiles (Texto 2), completou 100 anos em 2023.\nTexto 1\n[Image description: A promotional poster for 'FLIPORTELA FESTA LITERÁRIA DA PORTELA', with dates '28, 29 e 30 de abril'. It also says 'Centenário' and 'POR TELA 100 ANOS 1923.2023'. The logo features an eagle spreading its wings, with the word 'POR TELA' integrated into the eagle's body.]\nTexto 2\n[Image description: A photograph of a large eagle sculpture or float, part of a carnival parade, with colorful details.]\nConsiderando a imagem no texto 2, podemos afirmar que o texto 1 promove uma",
      subItens: []
    },
    options: [
    ...
    conteudo: ["Semiótica e design", "Intertextualidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Análise textual (Coesão)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Análise textual (Poesia)", "Recursos expressivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (Epígrafe)", "Intertextualidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "\"Os mais velhos, acumulados de tanto sofrimento, olhavam para trás e do passado nada reconheciam no presente. Suas lutas, seu fazer e saber, tudo parecia ter se perdido no tempo (...) Deram de clamar pela morte. E a todo instante eles partiam\" (p. 112).",
      "\"Vi só lágrimas e lágrimas. Entretanto, ela sorria feliz. Mas eram tantas lágrimas, que eu me perguntei se minha mãe tinha olhos ou rios caudalosos sobre a face. E só então compreendi. Minha mãe trazia, serenamente em si, águas correntezas (...). Águas de Mamãe Oxum!\" (p. 18-19).",
      "\"Os assaltantes desceram rápido. Maria olhou saudosa e desesperada para o primeiro. (...) Alguém gritou que aquela puta safada lá da frente conhecia os assaltantes (...). A primeira voz, a que acordou a coragem de todos, (...) levantou e se encaminhou em direção à Maria (...)\" (p. 41-42).",
      "\"Nos últimos tempos na favela, os tiroteios aconteciam com frequência e a qualquer hora. Os componentes dos grupos rivais brigavam para garantir seus espaços e freguesias. Havia ainda o confronto constante com os policiais que invadiam a área\" (p. 76)."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (Intertextualidade)", "Gêneros textuais (Notícia e conto)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (Machado de Assis)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Brasil Colônia (Carta de Pero Vaz de Caminha)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (Parnasianismo, Modernismo, Crítica literária)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura (Realismo-Naturalismo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["História Antiga", "Climatologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "A independência era entendida pelos indígenas como uma ameaça a Dom João VI, símbolo da nação brasileira.",
      "A diversidade da ação indígena se relacionava à distribuição de terras e títulos estabelecidos pela Corte portuguesa."
    ],
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["Brasil Império (Independência do Brasil)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["História da fotografia", "Século XIX"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "foi produzida durante a Guerra Fria e documenta o sequestro, no sudeste asiático, da parte dos soldados norte-americanos, de mulheres. O estupro e a prostituição forçada são aceitos pelas cortes internacionais como estratégia de guerra, já que os crimes de guerra referem-se apenas às armas usadas nos campos.",
      "comprova a ação dos soldados norte-americanos, durante a Guerra do Vietnã, em relação às mulheres e às crianças fotografadas. A prostituição consensual era usada como estratégia de criação de novos laços sociais e o povoamento dos territórios conquistados.",
      "traz a imagem de mulheres enfileiradas, capturadas e obrigadas a se prostituírem durante a II Guerra Mundial. A violação sexual tem sido usada historicamente como arma para fragilizar os supostos inimigos, já que as vítimas da violência sexual trazem marcas da humilhação e da limpeza étnica e tem os laços sociais destruídos.",
      "registra mulheres que, durante a Guerra das Coreias, escolheram se casar e migrar com os soldados japoneses. A violação sexual é uma das marcas dos conflitos entre nações, atingindo em especial mulheres e crianças que, entendidas como vulneráveis, se tornam vítimas do domínio masculino."
    ],
    correctAnswer: 2,
    materia: ["História"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Brasil República (Ditadura Militar)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "as campanhas de desinformação podem ser encontradas em diferentes contextos, como visto no uso do panfleto da rainha pela coroa francesa com o objetivo de defender a monarquia - e na imagem do Papa - que explora a contradição entre a riqueza do Vaticano e os excluídos defendidos por ele.",
      "no século XVIII e no século XXI, a produção e a circulação de fake news e desinformação são controladas pelos aparelhos de censura que revisam conteúdos orais e impressos, ainda que estruturados a partir de tecnologias diferenciadas.",
      "na era digital, a ruptura causada pelo uso de Inteligência Artificial e seu potencial na produção de desinformação está ao alcance do público, na instantaneidade e no realismo da imagem. No início da contemporaneidade, as manipulações em imagens e em notícias eram acessadas pelo público através de jornais e panfletos.",
      "os dispositivos de Inteligência Artificial representam uma ruptura no combate à desinformação ao possibilitar o rastreio e a eliminação instantânea de fake news. No século XVIII, o público era refém de notícias falsas pela ausência desta tecnologia."
    ],
    correctAnswer: 2,
    materia: ["Sociologia", "Arte", "História"],
    conteudo: ["Desinformação", "Mídias digitais", "Revolução Francesa"],
    imageNames: []
})