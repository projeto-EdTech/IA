...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática (Concordância)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática (Pontuação)", "Compreensão e Interpretação de Texto"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O texto de 1791 estabelece direitos e obrigações detalhados e separados para homens e mulheres na política e nos negócios, conforme o projeto burguês de sociedade, enquanto o texto de 1789 defende um ideal universalista, sem distinção social.",
      "O texto de 1789 defende direitos universais, sem explicitar a questão de gênero, enquanto o texto de 1791 defende a igualdade de direitos entre os gêneros, reivindicando a atuação feminina em assuntos considerados masculinos, como a política e os negócios.",
      "O texto de 1791 defende a luta contra a opressão das mulheres após séculos de dominação monárquica na França, enquanto o texto de 1789 é contra a opressão masculina causada pela predominância do clero e da nobreza sobre o terceiro estado.",
      "O texto de 1789 utiliza o termo \"homem\" para designar a todo o conjunto de cidadãos, sem distinção de classe e origem, enquanto o texto de 1791 substitui \"homem\" por \"mulher\", a fim de reivindicar direitos exclusivos para as cidadãs da classe burguesa.",
      "O texto de 1789 defende que nenhum direito é válido se não incluir todos os cidadãos, enquanto o texto de 1791 contradiz esse princípio ao privilegiar as mulheres, que reivindicavam maior espaço na sociedade após a morte da Rainha Maria Antonieta."
    ],
    correctAnswer: 1,
    materia: ["História"],
...
createQuestion({
    ...
    options: [
      "assistência aos negros que fugiam de seus senhores, providenciando alojamento e laços de solidariedade para arrecadar fundos para sua alforria, através da realização de festas de devoção aos seus santos padroeiros.",
      "congregação de negros, indígenas e brancos pobres, constituindo sociedades de auxílio mútuo para garantir um enterro digno aos seus membros e familiares, além de proteger seus membros das visitações da Inquisição.",
      "resistência ao catolicismo do regime de padroado, permitindo que os negros mantivessem seus cultos originais africanos após conquistarem sua alforria, proibindo a entrada de membros brancos e indígenas.",
      "auxílio mútuo, em caso de doença, enterro e assistência a órfãos e viúvas, e de arrecadação de recursos para alforria, servindo também para manter traços das culturas africanas, como forma de resistência à sociedade escravocrata.",
      "sociabilidade dos negros escravizados e libertos, compreendendo debates políticos de resistência à escravização, por meio da preservação das culturas e devoções africanas, o que gerou o primeiro ideário abolicionista."
    ],
    correctAnswer: 3,
    materia: ["História"],
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Relações Internacionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Ao lutar pela democracia e contra os fascismos na Europa com a FEB, o governo de Vargas perdeu apoio interno ao manter regime autoritário.",
      "Ao lutar pela democracia e derrotar os fascismos na Europa, os pracinhas conquistaram apoio popular para derrubar a ditadura de Vargas.",
      "Ao derrubar o regime franquista na Espanha, os soldados brasileiros inspiraram a população a lutar por eleições, após 15 anos de Estado Novo.",
      "Ao derrotar os fascistas na Batalha de Monte Castelo na Itália, a FEB conquistou o apoio norte-americano para derrubar a ditadura de Vargas.",
      "Ao lutar pela libertação dos povos europeus, o governo brasileiro esgotou seus recursos financeiros no Exército, precipitando a queda de Vargas."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Era Vargas", "Segunda Guerra Mundial"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["História Contemporânea", "Cidadania e Movimentos Sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Estática", "Fluidos", "Leis de Hooke"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "lago com área de 30.000 m², áreas úmidas com área de 50.000 m² e rios com largura de 200 m.",
      "lago com área de 5.000 m², áreas úmidas com área de 30.000 m² e rios com largura de 30 m.",
      "lago com área de 50.000 m², áreas úmidas com área de 300.000 m² e rios com largura de 100 m.",
      "lago com área de 5.000 m², áreas úmidas com área de 80.000 m² e rios com largura de 30 m.",
      "lago com área de 30.000 m², áreas úmidas com área de 50.000 m² e rios com largura de 50 m."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "Migração diz respeito a um fenômeno de deslocamento populacional, não importando a escala em que ocorre: desde o campo para cidade, dentro de um mesmo município, à escala internacional.",
      "Os variados tipos de deslocamento populacional podem ser classificados segundo suas motivações, que podem ser de ordem política, econômica, cultural e até mesmo ambiental.",
      "A comunidade internacional, representada pela ONU, e os países diretamente envolvidos com as migrações noticiadas no texto têm buscado uma política internacional de segurança baseada no fechamento das fronteiras, como forma de diminuir esse problema.",
      "O reconhecimento do status de refugiado concede, ao indivíduo, um conjunto de direitos assegurados por Convenção Internacional, desde que o país de destino seja signatário desse documento.",
      "Ainda não há um consenso, entre todos os países, sobre como definir o que são migrações voluntárias, forçadas ou obrigatórias, o que dificulta a prática de políticas internacionais para o estabelecimento de padrões humanitários mínimos aos migrantes."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["População", "Relações Internacionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Na atualidade, o aumento expressivo do desmatamento na Amazônia Legal brasileira decorre da falta de políticas públicas voltadas à contenção dessa prática ilegal, associada ao avanço da mineração e da agropecuária.",
      "O aumento na mudança do uso do solo, de floresta para outros usos, tem impactado com mais intensidade o aumento da temperatura global, superando o impacto causado pela queima de combustíveis fósseis.",
      "Dos biomas brasileiros, o cerrado tem como característica um ambiente seco com pouca diversidade de espécies, sendo um espaço adequado para ampliação agropecuária, haja vista o baixo impacto na biodiversidade brasileira.",
      "Nas relações internacionais contemporâneas, a questão ambiental é um assunto que diz respeito a cada Estado Nacional, fato que se traduz na ausência desse tema na construção da geopolítica global.",
      "O desmatamento se inscreve nos problemas ambientais em escala global, sendo um exemplo de exploração intensiva de recursos naturais, que tem impactado a dinâmica da natureza."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia do Brasil", "Formação Territorial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Geografia Urbana", "Redes Urbanas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As regiões menos desenvolvidas apresentam PIB relativamente pequeno, motivo pelo qual os investimentos feitos nessas regiões elevam suas taxas de crescimento acima da taxa nacional.",
      "Na década de 1960, o economista Celso Furtado constatou que a reforma agrária encetada pela Sudene havia levado o Nordeste a ampliar sua participação no PIB nacional, mas o regime de 1964 abortou esse desenvolvimento.",
      "A Zona Franca de Manaus foi instituída com o objetivo de industrializar a Amazônia, mas levou a um resultado contrário, por atrair \"maquiladoras\".",
      "Norte e Nordeste têm crescimento superior ao nacional nas conjunturas em que as commodities exportadas pelo Brasil alcançam bom preço no mercado externo.",
      "O desenvolvimento da periferia nacional é inibido pela sua dependência em relação a São Paulo, de modo que Norte e Nordeste crescem mais rápido quando alavancam capitais próprios para investir."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "O número reduzido de famílias que reivindica reforma agrária, no Paraná, é decorrente da característica fundiária do Estado, onde o latifúndio não é representativo em extensão territorial.",
      "Problemas fundiários, como o demonstrado no Paraná, são diferentes dos encontrados em outras partes do território nacional, por envolver um número maior de atores: indígenas, quilombolas e sem-terra, entre outros.",
      "A resolução da questão fundiária é uma questão jurídica, cabendo decidir quais terras são de domínio público e quais são de domínio privado.",
      "Os conflitos fundiários são resultado da demanda, por parte da sociedade, de lotes para reforma agrária.",
      "Políticas fundiárias, a exemplo da reforma agrária, opõem diferentes visões sobre a função da terra: a do latifúndio improdutivo, a do agronegócio produtivo e a de grupos sociais como os sem-terra."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
...
createQuestion({
    ...
    options: [
      "Guarapuava (Latitude: 25,37° S e Longitude: 51,49° W.Gr.) – Londrina (Latitude: 23,51° S e Longitude: 51,11° W.Gr.) – Maringá (Latitude: 23,40° S e Longitude: 51,96° W.Gr.) – Cascavel (Latitude: 25,02° S e Longitude: 53,37° W.Gr.).",
      "Guarapuava (Latitude: 25,87° S e Longitude: 53,69° W.Gr.) – Londrina (Latitude: 23,51° S e Longitude: 51,11° W.Gr.) – Maringá (Latitude: 23,40° S e Longitude: 51,96° W.Gr.) – Cascavel (Latitude: 25,92° S e Longitude: 53,37° W.Gr.).",
      "Guarapuava (Latitude: 25,37° S e Longitude: 51,49° W.Gr.) – Londrina (Latitude: 23,51° S e Longitude: 53,51° W.Gr.) – Maringá (Latitude: 26,40° S e Longitude: 51,96° W.Gr.) – Cascavel (Latitude: 20,20° S e Longitude: 53,37° W.Gr.).",
      "Guarapuava (Latitude: 25,37° S e Longitude: 51,49° W.Gr.) – Londrina (Latitude: 23,51° S e Longitude: 53,51° W.Gr.) – Maringá (Latitude: 23,40° S e Longitude: 51,96° W.Gr.) – Cascavel (Latitude: 20,20° S e Longitude: 53,37° W.Gr.).",
      "Guarapuava (Latitude: 25,87° S e Longitude: 53,49° W.Gr.) – Londrina (Latitude: 23,51° S e Longitude: 51,11° W.Gr.) – Maringá (Latitude: 26,40° S e Longitude: 51,96° W.Gr.) – Cascavel (Latitude: 25,92° S e Longitude: 53,37° W.Gr.)."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Eletroquímica", "Bioquímica"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Amigo 1: utilizou o líquido A sobre uma moeda de 10 centavos.",
      "Amigo 2: utilizou o líquido B sobre uma moeda de 5 centavos.",
      "Amigo 3: utilizou o líquido C sobre uma moeda de 10 centavos.",
      "Amigo 4: utilizou o líquido A sobre uma moeda de 5 centavos.",
      "Amigo 5: utilizou o líquido B sobre uma moeda de 10 centavos."
    ],
    correctAnswer: 4,
    materia: ["Química"],
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Alimentos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Funções (Logarítmicas)", "Geometria Analítica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Funções (Exponenciais)", "Matemática Financeira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Doenças", "Epidemiologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Grau de especialização da interação entre a espécie extinta e a espécie em risco: Baixo; Resposta evolutiva da espécie em risco: Lenta; Grau de dependência entre a espécie extinta e a espécie em risco: Baixo",
      "Grau de especialização da interação entre a espécie extinta e a espécie em risco: Alto; Resposta evolutiva da espécie em risco: Lenta; Grau de dependência entre a espécie extinta e a espécie em risco: Alto",
      "Grau de especialização da interação entre a espécie extinta e a espécie em risco: Baixo; Resposta evolutiva da espécie em risco: Rápida; Grau de dependência entre a espécie extinta e a espécie em risco: Baixo",
      "Grau de especialização da interação entre a espécie extinta e a espécie em risco: Alto; Resposta evolutiva da espécie em risco: Rápida; Grau de dependência entre a espécie extinta e a espécie em risco: Alto",
      "Grau de especialização da interação entre a espécie extinta e a espécie em risco: Baixo; Resposta evolutiva da espécie em risco: Lenta; Grau de dependência entre a espécie extinta e a espécie em risco: Alto"
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
...
createQuestion({
    ...
    conteudo: ["Bioquímica", "Reações Orgânicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "plasma sanguíneo – filtrado glomerular – urina.",
      "plasma sanguíneo - urina - filtrado glomerular.",
      "urina - filtrado glomerular - plasma sanguíneo.",
      "filtrado glomerular - urina - plasma sanguíneo.",
      "urina - plasma sanguíneo - filtrado glomerular."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Classificação dos Seres Vivos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "nas espermátides.",
      "nas espermatogônias.",
      "nos espermiócitos II.",
      "nos espermiócitos I."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Genética", "Radioatividade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "offrire uno sconto del 30% nell'acquisto della frutta e della verdura al supermercato Coop.",
      "incentivare tra i soci Coop l'acquisto on line dei biglietti per un'esposizione.",
      "divulgare l'inaugurazione di un lunapark la cui tematica è l'alimentazione.",
      "informare sul periodo nel quale i soci avranno lo sconto presso i supermercati Coop.",
      "avvisare i clienti Coop che l'acquisto on line del biglietto per Expo gli dà diritto a una carta di credito."
    ],
    correctAnswer: 1,
    materia: ["Italiano"],
...
createQuestion({
    ...
    options: [
      "soltanto la frase 1.",
      "soltanto la frase 2.",
      "soltanto le frasi 1 e 3.",
      "soltanto le frasi 2 e 3.",
      "le frasi 1, 2 e 3."
    ],
    correctAnswer: 3,
    materia: ["Italiano"],
...
createQuestion({
    ...
    options: [
      "quello che ci sarà nei vari padiglioni dell'Expo.",
      "quello che Marco sta proggettando per la sua vita futura.",
      "quello che i milanesi faranno nei momenti liberi durante l'Expo.",
      "i vari eventi che Marco organizza nell'appartamento della nonna.",
      "le situazioni in cui si sente parlare di come far soldi con l'Expo."
    ],
    correctAnswer: 4,
    materia: ["Italiano"],
...
createQuestion({
    ...
    options: [
      "crea nuovi posti di lavoro nel settore alberghiero.",
      "si occupa di affittare immobili propri o di terzi.",
      "si occupa di promuovere il turismo in Italia.",
      "fa la manutenzione degli immobili in affitto.",
      "gestisce siti internet dedicati al mercato immobiliare."
    ],
    correctAnswer: 1,
    materia: ["Italiano"],
    conteudo: ["Compreensão de Texto"],
...
createQuestion({
    ...
    options: [
      "non ha voglia di affittare la propria casa per un periodo breve.",
      "è uno studente disoccupato alla ricerca di un'opportunità di lavoro all'Expo.",
      "è molto attento a non violare nessuna legge e a non evadere le tasse.",
      "si propone come intermediario nella locazione di case per periodi brevi.",
      "ha creato un sito web per far concorrenza a Airbnb durante l'Expo."
    ],
    correctAnswer: 3,
    materia: ["Italiano"],
    conteudo: ["Compreensão de Texto"],
