...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Pontuação (Uso de Aspas)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Variação Linguística (Oralidade e Escrita)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O nacionalismo romântico se expressa no antológico poema \"Canção do exílio”, que abre o livro com um tom laudatório: \"Nosso céu tem mais estrelas, / Nossas várzeas têm mais flores, / Nossos bosques têm mais vida, / Nossa vida mais amores\".",
      "O embate entre tribos indígenas, com a consequente prisão de um guerreiro, é narrado em \"I-Juca-Pirama\", poema marcado por variedade métrica: \"O prisioneiro, cuja morte anseiam, / Sentado está, / O prisioneiro, que outro sol no ocaso / Jamais verá!\".",
      "A pureza racial dos indígenas brasileiros é exaltada no poema \"Marabá\" por meio da descrição da personagem-título: \"- Meus olhos são garços, são cor das safiras, / - Têm luz das estrelas, têm meigo brilhar; / - Imitam as nuvens de um céu anilado, / - As cores imitam das vagas do mar!\".",
      "O aspecto fúnebre das lendas românticas é representado no poema \"O gigante de pedra\", em que se destaca a monstruosidade do personagem: \"Gigante orgulhoso, de fero semblante, / Num leito de pedra lá jaz a dormir! / Em duro granito repousa o gigante, / Que os raios somente puderam fundir\".",
      "O lirismo romântico prefere temas delicados, como as brincadeiras inocentes da criança em \"Mãe-d'água”: “Minha mãe, olha aqui dentro, / Olha a bela criatura, / Que dentro d'água se vê! / São d'ouro os longos cabelos, / Gentil a doce figura, / Airosa leve a estatura; / Olha, vê no fundo d'água / Que bela moça não é!”."
    ],
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira (Romantismo - Gonçalves Dias)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira (Pré-Modernismo - Lima Barreto)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A escolha de um samba como trilha sonora diminuiu a contundência da crítica social pretendida pelo autor da peça, Gianfrancesco Guarnieri.",
      "A diferença entre o amor \"mais gostoso\" e o amor de quem usa \"bleque-tais\", com vantagem para o primeiro, dilui o efeito da oposição entre interesses coletivos e individuais, tema central da peça.",
      "O samba, entoado na peça pelo personagem Chiquinho, colabora para a representação e valorização da cultura popular.",
      "Tião, que usa \"black-tie\" (smoking e gravata), representa na peça o opressor, cujo poder é empregado para reprimir a greve organizada pelos moradores do morro.",
      "A valorização da vida simples e a consequente rejeição da possibilidade de ascensão social conduzem aos finais trágicos de Tião e de Otávio."
    ],
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira (Teatro e Música)", "Cultura Popular"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira (Pós-Modernismo - Ana Miranda)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "(1) cenoura, abóbora e fígado como fontes de vitamina D. - (2) frutas cítricas como fontes de vitamina C. - (3) peixe como fonte de vitamina A. - (4) vegetais com folhas verdes como fontes de vitamina K.",
      "(1) peixe, leite e gema de ovo como fontes de vitamina D. - (2) frutas cítricas como fontes de vitamina C. - (3) vegetais com folhas verdes como fonte de vitamina K. - (4) abóbora, fígado e cenoura como fontes de vitamina A.",
      "(1) peixe, leite e gema de ovo como fonte de vitamina K. – (2) frutas cítricas como fontes de vitamina A. - (3) vegetais com folhas verdes como fonte de vitamina D. - (4) cenoura, abóbora e fígado como fonte de vitamina C.",
      "(1) cenoura, abóbora e fígado como fontes de vitamina D. - (2) peixe, leite e gema de ovo como fontes de vitamina K. - (3) vegetais com folhas verdes como fonte de vitamina A. – (4) frutas cítricas como fontes de vitamina C.",
      "(1) vegetais com folhas verdes como fonte de vitamina D. - (2) cenoura, abóbora e fígado como fontes de vitamina C. - (3) frutas cítricas como fontes de vitamina K. - (4) peixe, leite e gema de ovo como fontes de vitamina A."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Nutrição e Vitaminas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Ciclos de Vida (Reprodução Sexuada)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Genética (Herança de Genes Não Ligados)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Celular (Transporte Ativo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Bioenergética (Fotossíntese e Respiração Celular)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "gera mutações específicas para os ambientes ao norte e ao sul do rio.",
      ...
      "promove a cooperação entre roedores brancos e castanhos.",
      "favorece diferentes fenótipos ao norte e ao sul do rio."
    ],
    correctAnswer: 4,
    materia: ["Biologia"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Ambiental (Gases de Efeito Estufa)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Reações Químicas", "Balanceamento de Equações"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Eletroquímica (Potencial de Oxirredução)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Ligações Intermoleculares"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "[Gráfico com linha reta decrescente, indicando lei de ordem zero]",
      "[Gráfico com curva decrescente exponencialmente, indicando lei de ordem diferente de 1 ou 0]",
      "[Gráfico com concentração constante]",
      "[Gráfico com curva decrescente, com taxa de decaimento diminuindo com o tempo, típico de 1ª ordem]",
      "[Gráfico com curva decrescente, com taxa de decaimento constante, típico de ordem 1 para ln[A] vs. tempo]"
    ],
    correctAnswer: 4,
    materia: ["Química"],
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Grandezas Físicas e Unidades"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Termodinâmica (Processos Termodinâmicos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Física"],
    conteudo: ["Cinemática (Gráficos de Movimento)", "Dinâmica (Força)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Cinemática (Movimento Retilíneo Uniforme)", "Dinâmica (Energia e Quantidade de Movimento)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Raciocínio Lógico", "Problemas de Otimização"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica (Área de Polígonos)", "Funções"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Aritmética (Cálculo de Tempo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial (Volume de Pirâmides)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["Brasil República (Era Vargas - Estado Novo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História Contemporânea (Movimento pelos Direitos Civis nos EUA)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História da América (Independência da América Espanhola)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["Brasil Colônia e Império (Resistência Escravista - Quilombos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    year: 2018,
    text: {
      principal: "O texto a seguir é referência para a questão 60.\n\nPara muitos pesquisadores, é correto assinalar que durante a Idade Média foram os árabes, não os cristãos, os herdeiros e sucessores da ciência helênica, uma herança que fez com que toda a extensão dos seus domínios, da Espanha ao Afeganistão, o mundo $\\mu$çulmano, fosse cenário de uma atividade intelectual intensa, não só em filosofia, mas também em matemática, astronomia e medicina. Nem sempre conhecida ou traduzida no Ocidente, essa produção está preservada em uma grande quantidade de manuscritos.\n(BISSIO, Beatriz. O mundo falava árabe. A civilização árabe-islâmica clássica através da obra de Ibn Khaldun e Ibn Battuta. Rio de Janeiro: Civilização Brasileira, 2012, p. 36.)\n\nCom base no texto acima e nos conhecimentos sobre o mundo $\\mu$çulmano na Idade Média, assinale a alternativa correta.",
      subItens: []
    },
    options: [
      "Foi justamente em função do seu caráter religioso fragmentado que o mundo $\\mu$çulmano e a sua civilização distinguiram-se mais vigorosamente do Ocidente cristão, fortemente homogêneo. A existência, no seio do Império $\\mu$çulmano, de numerosas tendências religiosas teve consequências consideráveis na produção de manuscritos.",
      "Apesar da sua hegemonia nas ciências durante o período medieval, a civilização $\\mu$çulmana era, afinal, um simples conjunto díspar de empréstimos culturais, o qual não conseguia refletir o novo universalismo e a nova ordem social que se instaurou com o surgimento do Islã.",
      ...
      "A Idade Média foi um período caraterizado pelo domínio efetivo, militar e político, dos países $\\mu$çulmanos sobre os países cristãos. Um domínio caracterizado, entre outras coisas, pela presença hegemônica da língua árabe nos espaços comerciais, políticos e acadêmicos da Europa.",
      "Existe consenso entre a maioria dos historiadores que estudam o período de que a emergência do horizonte renascentista deve muito ao trabalho dos sábios e acadêmicos $\\mu$çulmanos, conhecidos pelo mundo cristão, sobretudo, através da Península Ibérica."
    ],
    correctAnswer: 4,
    materia: ["História"],
    conteudo: ["Idade Média (Civilização Islâmica)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História Contemporânea (Revolução Russa e URSS)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["Brasil República (Primeira República - Movimento Operário)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Foi um movimento impulsionado pelos partidos verdes da Europa na segunda metade do século XX. Apontava ao aprimoramento, via mecanização, da produção agrícola e ao uso generalizado de sementes geneticamente modificadas. Ambas as medidas buscavam acabar com a fome no mundo.",
      "Foi um movimento impulsionado em meados dos anos 80 do século XX por alguns países agrícolas, como a Índia, o Brasil e a Rússia, entre os mais importantes. Apontava ao redirecionamento da produção interna de alimentos para os países industrializados, para, assim, melhorar a balança comercial e aumentar o produto interno bruto.",
      ...
      "Foi organizada pelos partidos verdes europeus e sua organização global, o Greenpeace. Iniciada no último terço do século XX, visava a transformação dos modos de produção agrícola em cultivos orgânicos que respeitassem o meio ambiente.",
      "O maior impacto da revolução verde foi obtido na África, na década de 1960, onde, por haver uma população eminentemente agrária, combinaram-se técnicas industriais e tradições de cultivo, melhorando e diversificando a produção de maneira que os excedentes fossem exportados para o resto do mundo."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geografia Agrária (Revolução Verde)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geopolítica (Fronteiras e Migrações)"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Trabalho e Tecnologia (Revolução Industrial)", "Geografia Industrial"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Geografia Urbana (Urbanização Brasileira)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As fortes desigualdades no país, fruto das diferenças de gênero, justificam a necessidade de os homens terem uma vivência mais ampla do espaço total da cidade.",
      "O aumento de famílias monoparentais femininas contribui com a democratização da cidade como espaço de lazer.",
      "As mulheres que possuem filhos sob seu encargo ampliam sua vivência do espaço total da cidade, por somarem seus interesses aos dos filhos.",
      "O controle masculino da espacialidade do cotidiano feminino exerce-se a partir da própria mulher.",
      "O uso do espaço urbano por homens e mulheres de baixa renda é regido pelas mesmas regras sociais, restringindo os deslocamentos de ambos ao cuidado dos filhos."
    ],
    correctAnswer: 3,
    materia: ["Sociologia"],
    conteudo: ["Gênero e Espaço Social"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia", "Geografia"],
    conteudo: ["Religião e Sociedade", "Demografia (Dados Populacionais)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geografia Ambiental (Recursos Hídricos)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Na referida projeção, a partir da seleção de um ponto de interesse, próximo do qual haverá as maiores distorções no mapa, o cartógrafo representa os demais locais de interesse. Com o distanciamento do ponto central, que tangencia a superfície de referência terrestre, as distorções são cada vez menores.",
      "Essa projeção, comumente utilizada para navegação, guarda ângulos de azimutes e seus meridianos passam pelo centro da projeção, sendo representados como retas.",
      "É uma projeção classificada como plano-polar quando tangencia médias latitudes.",
      "É uma projeção adequada para representar zonas de baixas latitudes e com poucas variações altimétricas, sendo evitada em regiões com altas latitudes.",
      "É uma projeção classificada como plano-oblíqua quando tangente à linha do Equador."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Geografia"],
    conteudo: ["Geografia Ambiental (Mudanças Climáticas e Acordos Internacionais)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Only affirmatives 2 and 3 are correct.",
      "Only affirmatives 2 and 4 are correct.",
      "Only affirmatives 1, 2 and 4 are correct.",
      "Only affirmatives 1, 3 and 4 are correct."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Compreensão e Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "a variety of ways of expressing immediacy in Spanish.",
      "the non-interference of the diminutive in communication among Spanish speakers.",
      "different forms of expressing periods of time in Spanish.",
      "the importance of language accuracy in communicating in Spanish.",
      "the variations of the use of the diminutive in different Spanish speaking countries."
    ],
    correctAnswer: 3,
    materia: ["Inglês"],
    conteudo: ["Compreensão e Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "Mexicans tend to feel lack of respect when talks or lectures go beyond the destined time frames.",
      "Dr Company believes that negative feelings from different audiences in talks are due to lack of language comprehension.",
      "People in different countries react differently to going over time in talks based on cultural backgrounds.",
      "In the US or the UK, it is customary for the audiences to stay over the allotted times of talks and lectures.",
      "The interpretation of time by Mexicans and people from different nationalities is a language barrier."
    ],
    correctAnswer: 0,
    materia: ["Inglês"],
...
createQuestion({
    ...
    options: [
      ...
      "Only affirmatives 1 and 3 are correct.",
      "Only affirmatives 2 and 3 are correct.",
      "Affirmatives 1, 2 and 3 are correct."
    ],
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Compreensão e Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "The number of cars sold in the UK have turned Great Britain into the most profitable car market in Europe.",
      "German manufacturers of cars are interested in banning diesel vehicles form German towns and cities, despite financial concerns.",
      "British government is willing to spend over 1,4 billion pounds in order to have only clean energy cars by 2050.",
      "France has set the year 2030 as its deadline to stop selling petrol and diesel cars.",
      "British government expects to reach zero emissions over twenty years after the 2040 deadline."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Compreensão e Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "The plan to ban the sales of internal combustion engine cars in Britain.",
      "France, Germany and India's plans to ban the sales of electric cars.",
      "The concerns doctors have with the amount of air pollution produced by combustion engine cars.",
      "The British government concerns with the reduction of car sales.",
      "The concerns car manufacturing companies have in relation to the drops in sales."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Compreensão e Interpretação de Texto"],
...
createQuestion({
    ...
    options: [
      "In 2015, British clean energy car manufacturers dominated the automobile market.",
      "The search for plug-in hybrid cars is not as large as for electric and fuel cell cars.",
      "40% of the cars sold in Britain in 2015 use clean energy.",
      "Only 3% of the car sales in the market refer to petrol energy vehicles.",
      "In 2015, the majority of the cars sold in Britain were internal combustion energy vehicles."
    ],
    correctAnswer: 4,
    materia: ["Inglês"],
    conteudo: ["Vocabulário e Semântica"],
