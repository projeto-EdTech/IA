createQuestion({
    ...
    conteudo: ["Interpretação de texto", "Intencionalidade do autor"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Coesão textual", "Referência anafórica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática", "Regência nominal", "Regência verbal"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Língua Portuguesa"],
    conteudo: ["Ortografia", "Morfologia", "Acentuação gráfica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Interpretação de texto", "Figuras de linguagem (metáfora)", "Barroco"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Gramática Histórica", "Sintaxe", "Morfologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Língua Portuguesa", "Sociologia", "Geografia"],
    conteudo: ["Interpretação de texto", "Cultura e Identidade", "Regionalização do Brasil"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "As manifestações artísticas do Sul são uma novidade em termos de identidade cultural e, para serem representativas,\nprecisam ser estudadas daqui para a frente.",
      "A característica mais arredia do povo sulista impossibilita uma participação harmônica da região nesse tipo de\napresentação.",
      "A escolha de que manifestações culturais serão consideradas representativas da brasilidade depende de quem está no\npoder.",
      "O Sul, em especial o Rio Grande do Sul, sempre se mostrou resistente aos elementos culturais vistos como representativos\nda brasilidade."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa", "Sociologia", "História"],
    conteudo: ["Interpretação de texto", "Conflitos culturais", "Formação da identidade nacional"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Organização textual", "Gêneros textuais", "Discurso direto e indireto"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Interpretação de texto", "Cultura", "Conhecimento"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Língua Portuguesa", "Sociologia", "Filosofia"],
    conteudo: ["Interpretação de texto", "Cultura", "Subjetividade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Por ser um texto teatral, do qual a figura do narrador é ausente, não há espaço na sua estrutura formal para descrição de\nambientes ou de personagens.",
      "As ações das personagens são mostradas ou relatadas na peça, mas seus pensamentos não, de modo que o leitor ou o\nespectador ignora quais terão sido suas emoções e reflexões.",
      "As inovações técnicas apresentadas pelo inglês são bem recebidas pelos personagens brasileiros, que não emitem sinais\nde desconfiança, por admiração ao estrangeiro.",
      "Por tratar de um tema tecnológico, a peça não conta com personagens femininas, já que as mulheres estavam\ndesinteressadas do universo produtivo no século XIX.",
      "A ação se passa num momento em que o tráfico de escravos já não era permitido, mas ainda assim sua venda ilegal é\npraticada e discutida na peça."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Romantismo (Teatro)", "Martins Pena"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Brasileira", "Romantismo (Poesia)", "Gonçalves Dias"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "Depois de ser lançado ao mar pelos homens, Santo Antonio foi reconduzido à praia pelos peixes, tornando-se exemplo da\nconduta cristã.",
      "O sal da terra é a palavra de Cristo e, segundo a parábola citada no sermão, ele preferiu pregar para os peixes a pregar\npara os homens.",
      "A terra, mesmo infértil, poderia ser melhor cultivada, caso houvesse pregadores que soubessem semear a boa palavra."
    ],
    correctAnswer: 4,
    materia: ["Língua Portuguesa"],
    conteudo: ["Literatura Portuguesa", "Barroco", "Padre Antônio Vieira"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["História"],
    conteudo: ["História Moderna", "Revoluções Atlânticas", "Independência do Haiti"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A conferência condenou o racismo e o colonialismo como formas de opressão que atentam contra os direitos humanos\ncontidos na carta das Nações Unidas; defendeu a autodeterminação dos povos e uma política de não alinhamento perante\na polarização que enfrentava o mundo pós-guerra.",
      "A conferência manteve uma política de não alinhamento perante o conflito da Palestina, assim como exigiu a participação\nde cada nação em um dos blocos em formação durante o período como forma de sair do subdesenvolvimento e da\ndependência.",
      "A conferência acordou respeitar as políticas de direitos humanos de cada país mediante um acordo de não interferência e\nde não alinhamento, garantindo a autodeterminação política e econômica dos blocos em formação.",
      "Cada país participante manifestou sua orientação política em relação aos blocos em formação, exigindo o respeito a suas\ndiferenças culturais e à preferência em relação ao modelo de desenvolvimento econômico que cada um escolheu. Tudo\nisso foi possível pelo acordo de não alinhamento assinado por todos.",
      "Para a conferência, os acordos de intercâmbio econômico e cultural foram prioritários na perspectiva de sair da\ndependência e promover a autodeterminação política."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História Contemporânea", "Descolonização", "Guerra Fria", "Conferência de Bandung"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Sociologia"],
    conteudo: ["Desigualdade social", "Criminalidade", "Sistema prisional"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "consistiu na invasão armada dos portugueses em territórios indígenas, com o objetivo de capturar o maior número de\npessoas, incluindo mulheres e crianças, com a finalidade de escravizá-los.",
      "foi um conflito bélico protagonizado pelos holandeses após a ocupação de Pernambuco por esses últimos.",
      "tratava-se de guerras por conquistas de território realizadas entre os diversos grupos indígenas e nas quais os portugueses\nparticipavam, apoiando um grupo ou outro, dependendo dos seus interesses.",
      "consistiu na invasão armada dos grupos indígenas aos assentamentos portugueses, com a finalidade de capturar\ninvasores para serem comidos ritualmente.",
      "foram guerras de retaliação que os portugueses realizavam em territórios ocupados pelos holandeses após serem\natacados por eles."
    ],
    correctAnswer: 0,
    materia: ["História"],
    conteudo: ["História do Brasil Colonial", "Relações entre colonos e indígenas", "Escravidão indígena"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["História"],
    conteudo: ["História Contemporânea", "Revolução Industrial", "Movimentos sociais (Ludismo)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "cristã protestante e alto poder do clero, com grande perseguição contra os considerados heréticos.",
      "cristã protestante e alto poder do clero, além de pouca mobilidade social e grande perseguição contra os considerados\nvassalos.",
      "católica e alto poder do clero, além de pouca mobilidade social e grande perseguição contra os considerados heréticos.",
      "católica e alto poder dos nobres, além de grande mobilidade social e perseguição contra protestantes, considerados\nheréticos.",
      "católica e alto poder do clero, além de grande mobilidade social e perseguição contra os considerados vassalos."
    ],
    correctAnswer: 2,
    materia: ["História"],
    conteudo: ["História Medieval", "Sociedade Medieval", "Igreja Católica na Idade Média", "Papel da mulher na Idade Média"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Historicamente, os dois tipos de jogos ocorreram de forma simultânea, porém, com os feridos decorrentes da Primeira\nGuerra Mundial, os Jogos Paralímpicos ganharam um novo impulso, devido ao financiamento internacional pela paz.",
      "Nos Jogos Paralímpicos, foi autorizada a competição entre diversos competidores portadores de capacidades funcionais\ndistintas, com exceção da deficiência mental.",
      "Os Jogos Olímpicos tiveram sua inauguração em Esparta, cerca de 650 a.C., local conhecido por seu militarismo e forte\ndisciplina, características até hoje praticadas pelos atletas.",
      "Os Jogos Paralímpicos foram realizados pela primeira vez nos anos 1960 na Europa, como uma forma de reintegrar\nmilitares feridos na Segunda Guerra Mundial.",
      "Os Jogos Olímpicos tiveram suas origens em Olímpia, na Grécia, em 650 a.C., e seu local só foi alterado no início do\nséculo XX."
    ],
    correctAnswer: 3,
    materia: ["História", "Sociologia"],
    conteudo: ["História Contemporânea", "Eventos Esportivos", "Inclusão social"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["História do Brasil (República Velha)", "Movimento do Contestado", "Conflitos agrários"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Projetos como a construção das hidrelétricas de Itaipu e de Tucuruí, no rio Tocantins, impulsionaram o desenvolvimento\neconômico de várias comunidades indígenas, graças aos projetos executados pela FUNAI.",
      "Apesar das mortes contabilizadas no relatório da CNV, após o golpe civil-militar, os indígenas passaram a ser valorizados\nno novo período econômico que se iniciou no Brasil.",
      "No período da Ditadura Militar, foi criada a Guarda Nacional Indígena, uma milícia armada integrada exclusivamente por\nresponsáveis pelo policiamento nas áreas indígenas para manutenção de sua cultura.",
      "Com o golpe civil-militar, devido às construções de grandes obras, a mão de obra indígena começou a ser parcialmente\nvalorizada pelo governo Figueiredo, que percebeu a aptidão dos indígenas para a manufatura.",
      "Após o golpe civil-militar, um novo período econômico se iniciou no Brasil, com construções de grandes obras nas quais\nos indígenas passaram a ser tratados como obstáculos para o desenvolvimento nacional."
    ],
    correctAnswer: 4,
    materia: ["História", "Sociologia"],
    conteudo: ["História do Brasil (Ditadura Militar)", "Questão Indígena", "Direitos Humanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A formação geográfica e social semelhante dos países da América do Sul proporciona a construção de políticas e acordos\nfronteiriços coesos e convergentes entre os países que a compõem.",
      "Os investimentos em estruturas físicas, a exemplo de ferrovias e hidrovias, além de tratados como o MERCOSUL e o\nPacto Andino, propiciaram a integração dos países sul-americanos, abrindo as fronteiras entre eles.",
      "A palavra fronteira teve seu conceito modificado com o advento da globalização, sendo hoje usada para compreender\nrelações de abertura entre Estados Nacionais, como no caso dos pactos econômicos sul-americanos.",
      "Nos países da América do Sul, as relações transfronteiriças, como a circulação de pessoas, capitais, mercadorias e\nserviços, são, atualmente, subordinadas à política de segurança de cada estado nacional.",
      "Fronteira remete a espaços peculiares, onde se defrontam comunidades político-geográficas diferentes, e se caracteriza\npor interações e conflitos de múltiplas ordens."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Geografia Política", "Fronteiras", "Integração regional"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Geopolítica", "Conflitos contemporâneos", "Oriente Médio", "Movimentos sociais"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Cartografia", "Sensoriamento Remoto", "Geotecnologias"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Cartografia", "Guerras Napoleônicas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Geografia Urbana", "Problemas urbanos", "Questão da moradia", "Movimentos sociais urbanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Instrumentos de políticas regionais foram estratégias usadas pelo Estado brasileiro para instituir políticas econômicas,\nvisando estimular o desenvolvimento e diminuir as disparidades regionais.",
      "O crescimento econômico das regiões periféricas supera a média nacional nos períodos de crise da indústria do Sudeste,\npois isso leva as empresas industriais a investir onde a mão de obra é barata.",
      "Não ocorreu o desenvolvimento do Nordeste, nas décadas de 70 e 80, porque os trabalhadores da região eram atraídos\npelos salários pagos na indústria paulista.",
      "A expansão do PIB da região Norte na última década se deveu à elevação dos preços internacionais dos produtos\nindustrializados, pois isso aumentou o valor das exportações da Zona Franca de Manaus.",
      "O PIB do Nordeste cresce a taxas superiores às do PIB nacional nos períodos em que o Estado amplia seus investimentos\nem obras contra a seca, como no caso da transposição do rio São Francisco."
    ],
    correctAnswer: 0,
    materia: ["Geografia"],
    conteudo: ["Geografia Econômica", "Desenvolvimento Regional do Brasil", "Disparidades regionais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "A agroecologia é uma técnica agrícola própria dos agricultores africanos, motivo pelo qual aquele continente é sempre\nusado como exemplo nesse tipo de produção.",
      "A integração de práticas produtivas locais com cultivos geneticamente modificados faz com que a agroecologia tenha uma\nvisão ecológica do meio ambiente.",
      "A agroecologia está se revelando como uma opção para a produção de alimentos saudáveis, mas sua produção ainda é\ninferior à produção convencional.",
      "A forma agroecológica de produzir foi introduzida no Brasil na década de 70 do sec. XX, quando a modernização da\nagricultura promoveu o que se denominou de \"revolução verde\".",
      "Um dos aspectos negativos da produção agroecológica são os problemas sociais e ambientais, pois esse modelo de\nprodução ocupa pouca mão de obra em grandes extensões e consome muitos recursos naturais."
    ],
    correctAnswer: 2,
    materia: ["Geografia"],
    conteudo: ["Geografia Agrária", "Agroecologia", "Sustentabilidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "As anomalias que produzem o El Niño são decorrentes de atividades humanas, principalmente devido às emissões de\nGEE (gases de efeito estufa) provenientes da queima de combustíveis fósseis industriais e veiculares.",
      "É considerado uma variabilidade natural existente há milhares de anos, com relatos históricos de ocorrência nas\ncivilizações pré-colombianas, e que pode ter seus efeitos intensificados devido às mudanças climáticas.",
      "Está associado ao aumento de atividade sísmica no oceano Pacífico equatorial, que emite grande quantidade de calor no\nassoalho oceânico, provocando o aquecimento das águas superficiais.",
      "Tem relação direta com o aumento do fluxo de raios cósmicos durante os períodos de baixa atividade solar, permitindo\nmaior entrada desse tipo de radiação em nosso sistema e alterando a dinâmica atmosférica.",
      "É o responsável pela existência do clima semiárido no sertão nordestino, principalmente devido ao ramo divergente da\ncélula de Walker que ocorre sobre a região."
    ],
    correctAnswer: 1,
    materia: ["Geografia"],
    conteudo: ["Climatologia", "Fenômenos Climáticos (El Niño)"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "O percentual de crescimento populacional indicado mostra que a teoria malthusiana tinha razão, isto é, que a população\nestá crescendo em progressão geométrica e a de alimentos, em ritmo aritmético.",
      "A taxa de natalidade caiu de forma significativa nas últimas duas décadas e a percentagem de crescimento atual é\nexplicada pela vinda de migrantes e refugiados de outros países.",
      "Em termos absolutos, a expressiva diferença no montante da população entre um ano e outro indica que as políticas\npúblicas de controle de natalidade da última década não conseguiram diminuir o crescimento populacional.",
      "O aumento da densidade demográfica nas regiões Norte e Centro-Oeste, que equilibrou a distribuição da população\nnacional, tem sido um fator relevante no crescimento populacional.",
      "Embora apresente essa taxa de crescimento, há uma tendência de diminuição da representatividade da população jovem\nno Brasil em relação à população em processo de envelhecimento, confirmando a mudança da estrutura etária brasileira."
    ],
    correctAnswer: 4,
    materia: ["Geografia"],
    conteudo: ["Geografia da População", "Demografia Brasileira", "Transição demográfica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Embriologia", "Genética", "Biotecnologia"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      ...
      "saturados de hidrogênios.",
      "majoritariamente hidrofóbicos.",
      "componentes das membranas."
    ],
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Bioquímica", "Carboidratos", "Lipídios"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Condições de insolação de Manaus: O2 dissolvido começa alto, cai, sobe levemente, depois cai. Condições de insolação de Buenos Aires: O2 dissolvido começa alto, cai, sobe, depois cai.",
      "Condições de insolação de Manaus: O2 dissolvido começa baixo, sobe, cai, sobe. Condições de insolação de Buenos Aires: O2 dissolvido começa alto, cai, sobe, cai.",
      "Condições de insolação de Manaus: O2 dissolvido começa baixo, sobe com pico ao meio dia, cai. Condições de insolação de Buenos Aires: O2 dissolvido começa baixo, sobe com pico ao meio dia, cai mais acentuadamente.",
      "Condições de insolação de Manaus: O2 dissolvido começa alto, cai, sobe, depois cai. Condições de insolação de Buenos Aires: O2 dissolvido começa alto, sobe, cai, sobe.",
      "Condições de insolação de Manaus: O2 dissolvido começa baixo, sobe com pico, cai. Condições de insolação de Buenos Aires: O2 dissolvido começa baixo, sobe com pico mais alto, cai."
    ],
    correctAnswer: 2,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Fotossíntese", "Fatores ambientais"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "direcional a favor da pelagem escura, o que pode levar à extinção da população I.",
      "disruptiva, desfavorecendo os heterozigotos, o que pode levar à especiação.",
      "direcional, favorecendo apenas os homozigotos FF nas duas populações.",
      "estabilizadora, com os heterozigotos (Ff) igualmente adaptados aos dois ambientes.",
      "disruptiva, o que pode levar à extinção de ambas as populações."
    ],
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Evolução", "Seleção Natural", "Genética de Populações"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Biologia"],
    conteudo: ["Biotecnologia", "Genética", "Engenharia Genética"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Zoologia", "Metamorfose", "Fisiologia Comparada"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Biologia"],
    conteudo: ["Fisiologia Animal", "Sistema Endócrino", "Homeostase", "Osmorregulação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Biologia"],
    conteudo: ["Ecologia", "Relações Ecológicas", "Mutualismo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Física"],
    conteudo: ["Mecânica", "Leis de Newton", "Força Elástica", "Equilíbrio de Forças"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Ondulatória", "Ondas Eletromagnéticas", "Grandezas e Medidas"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Física"],
    conteudo: ["Eletrodinâmica", "Circuitos Elétricos", "Resistência Elétrica", "Lei de Ohm"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Física"],
    conteudo: ["Hidrostática", "Termodinâmica", "Gás ideal"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Óptica Geométrica", "Refração da luz", "Lentes Esféricas"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Termologia", "Estados Físicos da Matéria", "Estados Físicos da Matéria"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Trata-se da possibilidade de a luz incidir em um material e torná-lo condutor, desde que a intensidade da energia da\nradiação luminosa seja superior a um valor limite.",
      "É o princípio de funcionamento das lâmpadas incandescentes, nas quais, por ação da corrente elétrica que percorre o seu\nfilamento, é produzida luz.",
      "Ocorre quando a luz atinge um metal e a carga elétrica do fóton é absorvida pelo metal, produzindo corrente elétrica.",
      "É o efeito que explica o fenômeno da faísca observado quando existe uma diferença de potencial elétrico suficientemente\ngrande entre dois fios metálicos próximos.",
      "Corresponde à ocorrência da emissão de elétrons quando a frequência da radiação luminosa incidente no metal for maior\nque um determinado valor, o qual depende do tipo de metal em que a luz incidiu."
    ],
    correctAnswer: 4,
    materia: ["Física"],
    conteudo: ["Física Moderna", "Efeito Fotoelétrico", "Teoria Quântica"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Funções Inorgânicas (Ácidos e Bases)", "Indicadores Ácido-Base", "Reações Químicas", "Estequiometria"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Química Geral", "Estrutura Atômica", "Distribuição Eletrônica", "Tabela Periódica", "Íons"],
    imageNames: []
}),
...
createQuestion({
    ...
    conteudo: ["Química Inorgânica", "Metalurgia", "Eletroquímica", "Regra de Três"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Funções Orgânicas", "Massa Molar"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Oxirredução", "Número de Oxidação"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Geral", "Reações Químicas", "Estequiometria", "Gases", "Físico-Química"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Química"],
    conteudo: ["Físico-Química", "Eletroquímica", "Potenciais de Eletrodo"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Funções Orgânicas (Cetonas, Álcoois)"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Química"],
    conteudo: ["Química Orgânica", "Nomenclatura IUPAC", "Alcanos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Geometria Plana", "Triângulos Retângulos", "Área de figuras planas"],
    imageNames: []
}),
...
createQuestion({
    ...
    options: [
      "Gráfico a: 4°T 13%, 3°T 25%, 2°T 22%, 1°T 40%.",
      "Gráfico b: 4°T 13%, 3°T 22%, 2°T 20%, 1°T 45%.",
      "Gráfico c: 4°T 17%, 3°T 27%, 2°T 23%, 1°T 33%.",
      "Gráfico d: 4°T 19%, 3°T 24%, 2°T 22%, 1°T 35%.",
      "Gráfico e: 4°T 11%, 3°T 24%, 2°T 23%, 1°T 42%."
    ],
    correctAnswer: 3,
    materia: ["Matemática"],
    conteudo: ["Estatística", "Interpretação de Dados", "Gráficos"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Geometria Espacial", "Volume de Sólidos", "Conversão de Unidades"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Matemática"],
    conteudo: ["Funções", "Interpretação de Gráficos", "Proporcionalidade"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 4,
    materia: ["Matemática"],
    conteudo: ["Geometria Analítica", "Equação da Reta", "Retas Perpendiculares"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 2,
    materia: ["Matemática"],
    conteudo: ["Probabilidade", "Equações do Segundo Grau"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Matemática"],
    conteudo: ["Funções Exponenciais", "Funções Logarítmicas", "Equações"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 0,
    materia: ["Inglês"],
    conteudo: ["Reading Comprehension", "Pronoun Reference"],
    imageNames: []
}),
...
createQuestion({
    ...
    correctAnswer: 1,
    materia: ["Inglês"],
    conteudo: ["Reading Comprehension", "Author's Opinion"],
    imageNames: []
})