createQuestion({
    ...
    options: [
      "No verso \"Que Inês morreu\", a palavra \"que\" poderia ser substituída pelo termo \"pois\", sem prejuízo do entendimento do texto.",
      "O verso \"Desata o pranto\" pode ser entendido como um pedido do eu-lírico para que o amado de Inês enxugue as lágrimas e esqueça a falecida.",
...
createQuestion({
    ...
    options: [
      "No verso \"Porque a perdeu\", a palavra \"porque\" poderia ser substituída pela expressão \"por qual razão\", sem prejuízo ao entendimento do texto.",
      "A forma verbal morrei (\"Morrei, Amores,\") é utilizada para transmitir uma ideia de ordem ou comando aos amores a quem se dirige o eu-lírico.",
...
createQuestion({
    ...
    options: [
      "Na oração “O ex-presidente do Chile, Ricardo Lagos, ficou conhecido internacionalmente”, as vírgulas poderiam ser substituídas por travessões, sem prejuízo para a adequação gramatical do texto.",
      "Na oração \"O ex-presidente do Chile, Ricardo Lagos, ficou conhecido internacionalmente\", as vírgulas poderiam ser substituídas por parênteses, sem prejuízo para a adequação gramatical do texto.",
...
createQuestion({
    ...
    options: [
      "O reconhecimento internacional de Ricardo Lagos se deve à posição que ele assumiu em relação a um plebiscito que aconteceu no Chile no século passado.",
      "Podemos compreender, a partir da leitura do texto, que a sucessora de Lagos, Michelle Bachelet, também não é mais mandatária da nação chilena.",
...
createQuestion({
    ...
    options: [
      "Em O Auto de São Lourenço (1583), José de Anchieta traz a antiga disputa do bem contra o mal, enaltecendo a figura do mártir São Lourenço, que é queimado no ato I, em detrimento de três diabos (Guaixará, Aimbirê e Saravaia) que querem perverter a aldeia com seus pecados e vícios, como beber, fumar e dançar embriagado, adornado e com as penas tingidas. Diz Guaixará: \"Quem bom costume é bailar! / Adornar-se, andar pintado, / tingir pernas, empenado / fumar e curandeirar, /andar de negro pintado. / [...] Para isso / com os índios convivi. / Vêm os tais padres agora / com regras fora de hora / pra que duvidem de mim. / Lei de Deus que não vigora\" (ANCHIETA, 2003, p. 06). Na peça, vemos o embate entre o catolicismo dos portugueses (personagens do bem – santos e anjos) e os hábitos dos indígenas, representados como sendo \"do mal\" (personagens dos três demônios e dos seus companheiros malvados – Tataurana, Ububu e Jaguaruçu).",
      "Os Sonetos e Outros Poemas, do poeta português Manuel Maria Barbosa du Bocage (1765-1805), trazem uma mescla entre as ideias do Arcadismo e do Romantismo, por meio de uma poesia em que o bucolismo convencional se atrela aos dramas sentimentais românticos, angústias, desesperos, medo e morte. Isso pode ser percebido no seguinte trecho de um de seus sonetos: \"Consola-me este horror, esta tristeza; / Porque a meus olhos se afigura a morte / No silêncio total da Natureza\" (BOCAGE, 1994, p. 02).",
...
createQuestion({
    ...
    options: [
      "Nas artes indígenas, o desenho é decorativo, mas também é simbólico. Os símbolos podem ser representados com padrões abstratos, como é o caso dos grafismos usados em tecidos, cestarias, cerâmicas e nas pinturas corporais, inspirados na pele da jiboia ou anaconda – animal considerado um ser sobrenatural primordial por muitos grupos indígenas da Amazônia.",
      "Para as diferentes etnias indígenas, arte, cotidiano e religião se misturam, integrando a sua forma de ver, entender e estar no mundo; diferente do padrão eurocêntrico pelo qual se costuma compreender e qualificar a arte.",
...
createQuestion({
    ...
    options: [
      "O matemático Pitágoras é considerado um grande teórico da música da Grécia Antiga, devido ao conhecimento que desenvolveu sobre a relação física entre as diferentes frequências sonoras (notas musicais) e os efeitos de suas vibrações (harmonia).",
      "A música Barroca europeia é marcada pela invenção de formas musicais como a ópera, a fuga e o concerto, cujos grandes compositores foram Johann Sebastian Bach e Georg Friedrich Händel.",
...
createQuestion({
    ...
    options: [
      "A farsa é um gênero teatral muito encenado desde a Idade Média que faz uso do humor. Esse gênero tem personagens caricatos e falas curtas, simples e inteligentes que ridicularizam situações do cotidiano.",
      "As tragédias e comédias gregas eram encenações espetaculares, apresentadas para um público de milhares de cidadãos. Essas encenações ocorriam em grandes teatros fechados, com assentos dispostos em fileiras diante de um palco elevado.",
...
createQuestion({
    ...
    options: [
      "Os templos são importantes construções da arquitetura grega da Antiguidade e seus elementos mais característicos são: a simetria dos pórticos frontal e posterior, as colunas construídas segundo os modelos da ordem dórica, jônica ou coríntia e o frontão triangular.",
      "As construções altas e com torres em pontas agulhadas, arcos ogivais, rosáceas e grandes vitrais são elementos arquitetônicos característicos do estilo Romano.",
...
createQuestion({
    ...
    options: [
      "No círculo cromático, as cores localizadas em lados opostos são chamadas análogas. Elas são usadas para passar a impressão de contraste.",
      "Timbre é a variação de força na execução musical que resulta em sons com volumes fortes, médios ou fracos e determina expressividade à música.",
...
createQuestion({
    ...
    options: [
      "O jogador que realiza o saque é aquele que ocupa a posição 6.",
      "É proibido bloquear o saque do adversário.",
...
createQuestion({
    ...
    options: [
      "Na partida de uma corrida, todos os atletas têm direito a uma saída falsa.",
      "Há competições de provas combinadas como o heptatlo e decatlo.",
...
createQuestion({
    ...
    options: [
      "O percentual da frequência cardíaca máxima é um indicador de intensidade de treinamento.",
      "Uma das fórmulas mais usadas é a frequência cardíaca de reserva, que leva em consideração a frequência cardíaca máxima e de repouso.",
...
createQuestion({
    ...
    options: [
      "Muitas especialidades circenses inspiraram o desenvolvimento da Ginástica moderna.",
      "A Ginástica de Trampolim nasceu do circo.",
...
createQuestion({
    ...
    options: [
      "A aptidão cardiorrespiratória é importante para o desempenho em exercícios físicos aeróbios.",
      "A hipertrofia muscular é um dos fatores que influencia para o ganho de força.",
...
createQuestion({
    ...
    options: [
      ...
      "Um dos eventos mais notáveis que pode ocorrer na prófase é a permutação ou crossing over fenômeno que se caracteriza pela \"troca de pedaços\" (genes) entre os cromossomos homólogos.",
...
createQuestion({
    ...
    options: [
      "A figura representa um esquema da membrana plasmática, segundo o modelo do mosaico fluido.",
      "A letra A indica os glicídios (açúcares) que constituem o glicocálice na face externa da membrana.",
...
createQuestion({
    ...
    options: [
      "O sangue, além de transportar gás oxigênio e nutrientes, também transporta hormônios produzidos pelas glândulas endócrinas.",
      "As imunoglobulinas são glicoproteínas presentes no plasma que atuam na defesa do nosso corpo contra a presença de antígenos.",
...
createQuestion({
    ...
    options: [
      "Nos ovários acontece o processo de formação de gametas femininos que tem início na puberdade.",
      "O epididimo é local onde os espermatozoides ficam armazenados até o momento da sua eliminação.",
...
createQuestion({
    ...
    options: [
      "I representa a fase de clivagens.",
      "II representa o estágio embrionário de mórula.",
...
createQuestion({
    ...
    options: [
      "Na queda livre, os espaços percorridos na vertical são diretamente proporcionais aos tempos de percurso.",
      "A tangente do ângulo (medido no sentido anti-horário), que o eixo do tempo faz com a reta que representa a equação horária do móvel em Movimento Retilíneo Uniforme, é numericamente igual à velocidade escalar desse móvel.",
...
createQuestion({
    ...
    options: [
      "O Movimento Circular Uniforme é desprovido de aceleração.",
      "A equação dimensional da velocidade angular é dada por [W] = T-1.",
...
createQuestion({
    ...
    options: [
      "A sua unidade pode ser expressa em N.cm.",
...
createQuestion({
    ...
    options: [
      "A NH3 é uma substância simples.",
      "O NH4Cl é uma substância composta.",
...
createQuestion({
    ...
    options: [
      "O NaBr é o bromato de sódio.",
      "O Na2SO3 é o sulfato de sódio.",
...
createQuestion({
    ...
    options: [
      "O ferro transforma-se em ferrugem na presença de ar e umidade.",
...
createQuestion({
    ...
    options: [
      "O plano A tem menor custo do que o B.",
      "O custo total no plano C é menor do que R$ 2.650,00.",
...
createQuestion({
    ...
    options: [
      "A religiosidade, a sexualidade, a gastronomia são exemplos de práticas ou atividades humanas que não dizem respeito ao campo de estudo da História.",
      "A História, compreendida como ciência e campo de estudos, nasceu com os gregos na Antiguidade.",
...
createQuestion({
    ...
    options: [
      "Estudos apontam para a existência de povos primitivos que habitaram o Brasil, onde atualmente se localiza o estado do Piauí, na região de São Raimundo Nonato.",
      "Os Maias baseavam sua economia na agricultura, construíram pirâmides e possuíam uma forma de escrita baseada em símbolos.",
...
createQuestion({
    ...
    options: [
      "Os gregos deram origem aos Jogos Olímpicos. Entre os gregos, os Jogos eram uma forma de homenagear aos deuses.",
      "A Filosofia foi utilizada pelos gregos para pensar sobre as questões humanas. Sócrates e Platão figuram como importantes filósofos da Antiguidade.",
...
createQuestion({
    ...
    options: [
      "Apenas as negras escravizadas serviam aos seus senhores nas casas-grandes. Aos homens escravizados restava apenas o trabalho braçal nas lavouras.",
      "Capitão do mato foi o termo empregado para identificar os negros que, durante o período colonial, lideraram as fugas dos africanos escravizados.",
...
createQuestion({
    ...
    options: [
      "O Porto de Paranaguá foi uma das portas de entrada de negros escravizados no Paraná.",
      "Na região dos Campos Gerais, os negros escravizados atuaram como mão de obra nas atividades agropastoris.",
...
createQuestion({
    ...
    options: [
      "Uma paisagem pode ser cultural, aquela com influência humana, ou pode ser natural.",
      "Paisagem é definida como o espaço com relações de posse ou poder.",
...
createQuestion({
    ...
    options: [
      "A Terra possui uma história geológica que remonta somente há poucos milhares de anos.",
      "O mármore é um tipo de rocha utilizado para fazer esculturas.",
...
createQuestion({
    ...
    options: [
      "China, Índia e Brasil estão entre os 10 países mais populosos do planeta.",
      "As pirâmides etárias em países subdesenvolvidos possuem, na sua maioria, o topo mais largo que a base.",
...
createQuestion({
    ...
    options: [
      "O gás ozônio tem a capacidade de filtrar os raios ultravioleta (UV), provenientes do Sol.",
      "O CFC é um gás produzido pela indústria que afeta sobremaneira a camada de ozônio.",
...
createQuestion({
    ...
    options: [
      "Em geral, quanto maior a latitude, menores as temperaturas. As regiões polares estão localizadas em altas latitudes.",
      "A forma do relevo pode auxiliar ou dificultar as trocas de calor e umidade na superfície.",
...
createQuestion({
    ...
    options: [
      "A Filosofia proporciona um conhecimento objetivo, baseado no método da observação.",
      "A Ciência é a primeira forma da compreensão do mundo obtida pelo homem, entendida, assim, como resultado do conhecimento espontâneo (experiências cotidianas).",
...
createQuestion({
    ...
    options: [
      "A lógica aceita apenas como argumentação válida os sofismas que as pessoas aceitam comumente como argumentação correta.",
      "Raciocinar é obter conclusões a partir de premissas.",
...
createQuestion({
    ...
    options: [
      "Considera-se que Pitágoras (c.570 a.C.) teria sido o primeiro filósofo a usar as palavras filósofo e Filosofia.",
      "Sócrates e Platão utilizam as palavras Filosofia e filósofo para designar a posse pelo saber (donos da sabedoria).",
...
createQuestion({
    ...
    options: [
      "A teoria do conhecimento pode ser compreendida como a investigação acerca das condições do conhecimento.",
      "O problema do conhecimento reside na questão apresentada pela relação entre sujeito e objeto.",
...
createQuestion({
    ...
    options: [
      "A primeira característica da atitude filosófica é negativa, no sentido de dizer \"não\" àquilo que todo mundo diz acreditar como verdade.",
      "A atitude de questionar é uma ação fundamental para o exercício da atitude filosófica.",
...
createQuestion({
    ...
    options: [
      "Augusto Comte foi um importante precursor do surgimento de uma ciência da sociedade.",
      "As revoluções do século XVIII e suas consequências sociais não se relacionam com o surgimento da Sociologia.",
...
createQuestion({
    ...
    options: [
      "Cultura diz respeito às normas, valores, saberes e práticas sociais.",
      "As diferenças de comportamento entre os humanos são marcadas por diferenças culturais.",
...
createQuestion({
    ...
    options: [
      "O fim da escravidão formal no século XIX e os avanços legais no Brasil contra o racismo não garantiram o seu fim no cotidiano social.",
      "A desigualdade econômica brasileira é marcada pela desigualdade étnico-racial.",
...
createQuestion({
    ...
    options: [
      "Max Weber: tipo ideal e ação social.",
      "Émile Durkheim: violência simbólica e emancipação humana.",
...
createQuestion({
    ...
    options: [
      "Por meio da interação e das relações sociais o indivíduo (biológico) se insere no mundo da cultura.",
      "A socialização pode ser dividida em primária e secundária.",
...
createQuestion({
    ...
    options: [
      "Ulisses era um herói grego, rei de Ítaca.",
      "Após a guerra, Ulisses ficou ausente por três anos.",
...
createQuestion({
    ...
    options: [
      "Todos os dias ela olhava para o horizonte sem fim e chorava.",
      "Para manter seus pretendentes sob controle, ela lhes disse que escolheria um deles quando terminasse de tecer um manto para Laertes.",
...
createQuestion({
    ...
    options: [
      "O verbo está no presente contínuo.",
      "Sua tradução é \"mas nunca teve esperança\".",
...
createQuestion({
    ...
    options: [
      "Em ambos os casos, o \"s\" é a forma contraída de \"is\".",
      "Sua tradução é \"o pai de Ulisses\" e \"a volta de seu amor\".",
...
createQuestion({
    ...
    options: [
      "Durante a ausência de Ulisses, alguns chefes de Ítaca e de ilhas próximas passaram a cortejar Penélope.",
      "Ulisses desapareceu após a Guerra de Troia.",
